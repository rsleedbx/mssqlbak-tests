...
**137 fixtures · 137 pass · 0 xfail (known gap) · 0 fail**

**Tables:** 415/415 pass · **Columns:** 4043/4043 pass
...
|--------|---------|--------|-----------|
| `alias_types_full.bak` | 0.061s | 0.037s | 0.098s |
| `archive_columnstore_partition_full.bak` | 0.977s | 0.895s | 1.872s |
| `archive_columnstore_types_full.bak` | 0.357s | 0.682s | 1.039s |
| `archive_columnstore_types_random_full.bak` | 0.356s | 0.645s | 1.001s |
| `archive_single_chunk_full.bak` | 0.056s | 0.039s | 0.095s |
| `archive_single_chunk_random_full.bak` | 0.059s | 0.039s | 0.098s |
| `archivenull_full.bak` | 0.142s | 0.212s | 0.354s |
| `backup_blocksize_full.bak` | 0.052s | 0.036s | 0.088s |
| `boundarycoverage_datetime_full.bak` | 0.078s | 0.183s | 0.261s |
| `boundarycoverage_full.bak` | 0.074s | 0.095s | 0.169s |
| `cci_binary_varbinary_compare_full.bak` | 0.056s | 0.037s | 0.093s |
| `cci_bitpack_probe_bigint_full.bak` | 1.267s | 3.589s | 4.856s |
| `cci_bitpack_probe_full.bak` | 0.144s | 0.801s | 0.945s |
| `cci_bitpack_probe_highbase_full.bak` | 0.12s | 0.549s | 0.669s |
| `cci_btree_nci_full.bak` | 0.071s | 0.048s | 0.119s |
| `cci_computed_full.bak` | 0.058s | 0.038s | 0.096s |
| `cci_enc5_largepool_full.bak` | 0.382s | 0.483s | 0.865s |
| `cci_enc5_largepool_matrix_full.bak` | 7.07s | 1.365s | 8.435s |
| `cci_extended_full.bak` | 0.069s | 0.05s | 0.119s |
| `cci_lob_full.bak` | 0.063s | 0.043s | 0.106s |
| `cci_reorganize_full.bak` | 0.071s | 0.045s | 0.116s |
| `cci_string_dict_regression_full.bak` | 0.337s | 0.146s | 0.483s |
| `cci_string_minmax_full.bak` | 0.059s | 0.039s | 0.098s |
| `cci_switch_full.bak` | 0.055s | 0.038s | 0.093s |
| `cci_types_large_full.bak` | 0.077s | 0.048s | 0.125s |
| `cci_varbinary_micro_full.bak` | 0.057s | 0.036s | 0.093s |
| `cci_varbinary_probe_full.bak` | 0.082s | 0.045s | 0.127s |
| `columnstore_minimal.bak` | 0.131s | 0.781s | 0.912s |
| `compressed_nvarchar_full.bak` | 0.055s | 0.038s | 0.093s |
| `compressioncoverage_full.bak` | 0.105s | 0.187s | 0.292s |
| `computedcoverage_full.bak` | 0.054s | 0.037s | 0.091s |
| `constraintcoverage_full.bak` | 0.063s | 0.046s | 0.109s |
| `covering_index_full.bak` | 0.055s | 0.046s | 0.101s |
| `cs_lob_preamble.bak` | 0.108s | 0.064s | 0.172s |
| `delta_rowgroup_full.bak` | 0.068s | 0.036s | 0.104s |
| `dirtycoverage_aborted_xact.bak` | 0.075s | 0.04s | 0.115s |
| `dirtycoverage_addcol.bak` | 0.066s | 0.042s | 0.108s |
| `dirtycoverage_addnotnull.bak` | 0.057s | 0.036s | 0.093s |
| `dirtycoverage_alldirty.bak` | 0.086s | 0.039s | 0.125s |
| `dirtycoverage_altercol.bak` | 0.052s | 0.039s | 0.091s |
| `dirtycoverage_altercol_rewrite.bak` | 0.052s | 0.036s | 0.088s |
| `dirtycoverage_alterdb.bak` | 0.056s | 0.044s | 0.1s |
| `dirtycoverage_cci_delete.bak` | 0.087s | 0.094s | 0.181s |
| `dirtycoverage_cci_update.bak` | 0.12s | 0.09s | 0.21s |
| `dirtycoverage_committed_delete.bak` | 0.058s | 0.04s | 0.098s |
| `dirtycoverage_committed_delete_v2.bak` | 0.054s | 0.042s | 0.096s |
| `dirtycoverage_committed_delete_v3.bak` | 0.056s | 0.065s | 0.121s |
| `dirtycoverage_committed_delete_v4.bak` | 0.168s | 0.12s | 0.288s |
| `dirtycoverage_committed_update.bak` | 0.05s | 0.042s | 0.092s |
| `dirtycoverage_committed_update_v2.bak` | 0.063s | 0.042s | 0.105s |
| `dirtycoverage_committed_update_v3.bak` | 0.07s | 0.082s | 0.152s |
| `dirtycoverage_committed_update_v4.bak` | 0.065s | 0.138s | 0.203s |
| `dirtycoverage_concurrent.bak` | 0.056s | 0.045s | 0.101s |
| `dirtycoverage_createidx.bak` | 0.068s | 0.042s | 0.11s |
| `dirtycoverage_createtable.bak` | 0.055s | 0.036s | 0.091s |
| `dirtycoverage_delete.bak` | 0.091s | 0.039s | 0.13s |
| `dirtycoverage_dropcol.bak` | 0.055s | 0.035s | 0.09s |
| `dirtycoverage_dropidx.bak` | 0.062s | 0.038s | 0.1s |
| `dirtycoverage_droptable.bak` | 0.057s | 0.038s | 0.095s |
| `dirtycoverage_heap_forward.bak` | 0.077s | 0.037s | 0.114s |
| `dirtycoverage_large_dirty.bak` | 0.351s | 0.04s | 0.391s |
| `dirtycoverage_lob_update.bak` | 0.102s | 0.035s | 0.137s |
| `dirtycoverage_maxrow.bak` | 0.049s | 0.034s | 0.083s |
| `dirtycoverage_nchar_delete.bak` | 0.08s | 0.041s | 0.121s |
| `dirtycoverage_nested.bak` | 0.085s | 0.042s | 0.127s |
| `dirtycoverage_null_update.bak` | 0.082s | 0.038s | 0.12s |
| `dirtycoverage_rebuildidx.bak` | 0.062s | 0.038s | 0.1s |
| `dirtycoverage_rich_insert.bak` | 0.106s | 0.036s | 0.142s |
| `dirtycoverage_rich_update.bak` | 0.078s | 0.041s | 0.119s |
| `dirtycoverage_savepoint.bak` | 0.085s | 0.039s | 0.124s |
| `dirtycoverage_snapshot_update.bak` | 0.081s | 0.034s | 0.115s |
| `dirtycoverage_switch.bak` | 0.066s | 0.044s | 0.11s |
| `dirtycoverage_temporal_update.bak` | 0.083s | 0.038s | 0.121s |
| `dirtycoverage_truncate.bak` | 0.075s | 0.041s | 0.116s |
| `dirtycoverage_two_tx.bak` | 0.098s | 0.039s | 0.137s |
| `dirtycoverage_uncommitted.bak` | 0.09s | 0.044s | 0.134s |
| `dirtycoverage_update.bak` | 0.084s | 0.035s | 0.119s |
| `featurecoverage_full.bak` | 0.154s | 0.064s | 0.218s |
| `filtered_ncci_full.bak` | 0.06s | 0.044s | 0.104s |
| `float_extreme_full.bak` | 0.066s | 0.035s | 0.101s |
| `forwarded_records_full.bak` | 0.368s | 0.084s | 0.452s |
| `ghost_records_full.bak` | 0.055s | 0.043s | 0.098s |
| `heapcoverage_large.bak` | 0.057s | 0.046s | 0.103s |
| `heapcoverage_large_50000.bak` | 0.289s | 0.472s | 0.761s |
| `hierarchyid_extract_full.bak` | 0.05s | 0.035s | 0.085s |
| `high_slot_density_full.bak` | 0.085s | 0.238s | 0.323s |
| `incrementalcoverage_diff_01.bak` | 0.055s | 0.019s | 0.074s |
| `incrementalcoverage_diff_02.bak` | 0.052s | 0.019s | 0.071s |
| `incrementalcoverage_diff_03.bak` | 0.051s | 0.019s | 0.07s |
| `incrementalcoverage_diff_04.bak` | 0.053s | 0.021s | 0.074s |
| `incrementalcoverage_diff_05.bak` | 0.054s | 0.021s | 0.075s |
| `incrementalcoverage_diff_06.bak` | 0.052s | 0.017s | 0.069s |
| `incrementalcoverage_full.bak` | 0.049s | 0.036s | 0.085s |
| `layoutcoverage_full.bak` | 0.233s | 0.226s | 0.459s |
| `max_row_width_full.bak` | 0.046s | 0.035s | 0.081s |
| `mixed_collation_full.bak` | 0.056s | 0.037s | 0.093s |
| `multi_rowgroup_full.bak` | 0.056s | 0.039s | 0.095s |
| `native_json_full.bak` | 0.07s | 0.041s | 0.111s |
| `ncci_heap_full.bak` | 0.054s | 0.034s | 0.088s |
| `ncci_types_full.bak` | 0.127s | 0.232s | 0.359s |
| `ndfcoverage_full.bak` | 0.06s | 0.055s | 0.115s |
| `nvarchar_max_u21_full.bak` | 0.067s | 0.037s | 0.104s |
| `ordered_cci_full.bak` | 0.059s | 0.043s | 0.102s |
| `pagecomp_anchor_full.bak` | 0.144s | 0.15s | 0.294s |
| `pagecomp_long_prefix_full.bak` | 0.051s | 0.035s | 0.086s |
| `pfor_columnstore_full.bak` | 0.146s | 1.103s | 1.249s |
| `pfor_columnstore_random_full.bak` | 0.149s | 1.09s | 1.239s |
| `realworld_numeric_digest_full.bak` | 0.064s | 0.102s | 0.166s |
| `rowboundary_full.bak` | 0.063s | 0.043s | 0.106s |
| `rowstore_hash_pii_full.bak` | 0.066s | 0.04s | 0.106s |
| `rowstore_lob_image_full.bak` | 0.072s | 0.041s | 0.113s |
| `rowstore_lob_markup_full.bak` | 0.051s | 0.034s | 0.085s |
| `rowversion_extract_full.bak` | 0.07s | 0.039s | 0.109s |
| `sparse_full.bak` | 0.107s | 0.139s | 0.246s |
| `spatial_edge_full.bak` | 0.063s | 0.042s | 0.105s |
| `spatial_index_full.bak` | 0.056s | 0.038s | 0.094s |
| `sql_variant_extract_full.bak` | 0.051s | 0.037s | 0.088s |
| `striped_full_1.bak` | 0.06s | 0.022s | 0.082s |
| `striped_single.bak` | 0.086s | 0.049s | 0.135s |
| `surrogate_pairs_full.bak` | 0.047s | 0.034s | 0.081s |
| `tabletype_cci_large_full.bak` | 0.081s | 0.049s | 0.13s |
| `tabletypecoverage_diff.bak` | 0.102s | 0.062s | 0.164s |
| `tabletypecoverage_full.bak` | 0.184s | 0.098s | 0.282s |
| `temporal_hidden_full.bak` | 0.059s | 0.036s | 0.095s |
| `torn_page_full.bak` | 0.069s | 0.038s | 0.107s |
| `typecoverage_full.bak` | 0.122s | 0.084s | 0.206s |
| `typed_xml_full.bak` | 0.055s | 0.039s | 0.094s |
| `unicode_codepage_coverage.bak` | 0.086s | 0.056s | 0.142s |
| `utf8_collation_full.bak` | 0.049s | 0.036s | 0.085s |
| `vector_full.bak` | 0.067s | 0.038s | 0.105s |
| `xml_index_full.bak` | 0.073s | 0.039s | 0.112s |
| `xmlcoverage_full.bak` | 0.065s | 0.036s | 0.101s |
| `xmlheap_full.bak` | 0.11s | 0.065s | 0.175s |
| `xtp_checkpoint_straddle_full.bak` | 1.815s | 0.407s | 2.222s |
| `xtp_probe_full.bak` | 0.135s | 0.038s | 0.173s |
| `xtp_rich_full.bak` | 0.123s | 0.041s | 0.164s |
| `xtp_simple_full.bak` | 0.114s | 0.049s | 0.163s |
...
_Generated 2026-07-11 · 137 fixtures · 137 pass · 0 xfail · 0 fail_
