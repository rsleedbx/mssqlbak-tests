...
| Backup | Wall time |
|--------|-------------|
| `alias_types_full.bak` | 0.132s |
| `archive_columnstore_partition_full.bak` | 2.501s |
| `archive_columnstore_types_full.bak` | 1.399s |
| `archive_columnstore_types_random_full.bak` | 1.528s |
| `archive_single_chunk_full.bak` | 0.114s |
| `archive_single_chunk_random_full.bak` | 0.119s |
| `archivenull_full.bak` | 0.497s |
| `backup_blocksize_full.bak` | 0.124s |
| `boundarycoverage_datetime_full.bak` | 0.46s |
| `boundarycoverage_full.bak` | 0.253s |
| `cci_binary_varbinary_compare_full.bak` | 0.113s |
| `cci_bitpack_probe_bigint_full.bak` | 9.19s |
| `cci_bitpack_probe_full.bak` | 2.125s |
| `cci_bitpack_probe_highbase_full.bak` | 1.352s |
| `cci_btree_nci_full.bak` | 0.143s |
| `cci_computed_full.bak` | 0.119s |
| `cci_enc5_largepool_full.bak` | 1.214s |
| `cci_enc5_largepool_matrix_full.bak` | 9.934s |
| `cci_extended_full.bak` | 0.171s |
| `cci_lob_full.bak` | 0.145s |
| `cci_reorganize_full.bak` | 0.124s |
| `cci_string_dict_regression_full.bak` | 0.568s |
| `cci_string_minmax_full.bak` | 0.128s |
| `cci_switch_full.bak` | 0.127s |
| `cci_types_large_full.bak` | 0.156s |
| `cci_varbinary_micro_full.bak` | 0.127s |
| `cci_varbinary_probe_full.bak` | 0.167s |
| `columnstore_minimal.bak` | 1.18s |
| `compressed_nvarchar_full.bak` | 0.097s |
| `compressioncoverage_full.bak` | 0.395s |
| `computedcoverage_full.bak` | 0.114s |
| `constraintcoverage_full.bak` | 0.124s |
| `covering_index_full.bak` | 0.125s |
| `cs_lob_preamble.bak` | 0.201s |
| `delta_rowgroup_full.bak` | 0.124s |
| `dirtycoverage_aborted_xact.bak` | 0.119s |
| `dirtycoverage_addcol.bak` | 0.106s |
| `dirtycoverage_addnotnull.bak` | 0.108s |
| `dirtycoverage_alldirty.bak` | 0.139s |
| `dirtycoverage_altercol.bak` | 0.108s |
| `dirtycoverage_altercol_rewrite.bak` | 0.105s |
| `dirtycoverage_alterdb.bak` | 0.16s |
| `dirtycoverage_cci_delete.bak` | 0.232s |
| `dirtycoverage_cci_update.bak` | 0.259s |
| `dirtycoverage_committed_delete.bak` | 0.113s |
| `dirtycoverage_committed_delete_v2.bak` | 0.122s |
| `dirtycoverage_committed_delete_v3.bak` | 0.174s |
| `dirtycoverage_committed_delete_v4.bak` | 0.365s |
| `dirtycoverage_committed_update.bak` | 0.108s |
| `dirtycoverage_committed_update_v2.bak` | 0.121s |
| `dirtycoverage_committed_update_v3.bak` | 0.2s |
| `dirtycoverage_committed_update_v4.bak` | 0.294s |
| `dirtycoverage_concurrent.bak` | 0.113s |
| `dirtycoverage_createidx.bak` | 0.116s |
| `dirtycoverage_createtable.bak` | 0.126s |
| `dirtycoverage_delete.bak` | 0.133s |
| `dirtycoverage_dropcol.bak` | 0.112s |
| `dirtycoverage_dropidx.bak` | 0.111s |
| `dirtycoverage_droptable.bak` | 0.152s |
| `dirtycoverage_heap_forward.bak` | 0.14s |
| `dirtycoverage_large_dirty.bak` | 0.402s |
| `dirtycoverage_lob_update.bak` | 0.164s |
| `dirtycoverage_maxrow.bak` | 0.138s |
| `dirtycoverage_nchar_delete.bak` | 0.141s |
| `dirtycoverage_nested.bak` | 0.141s |
| `dirtycoverage_null_update.bak` | 0.146s |
| `dirtycoverage_rebuildidx.bak` | 0.113s |
| `dirtycoverage_rich_insert.bak` | 0.162s |
| `dirtycoverage_rich_update.bak` | 0.125s |
| `dirtycoverage_savepoint.bak` | 0.145s |
| `dirtycoverage_snapshot_update.bak` | 0.132s |
| `dirtycoverage_switch.bak` | 0.117s |
| `dirtycoverage_temporal_update.bak` | 0.131s |
| `dirtycoverage_truncate.bak` | 0.118s |
| `dirtycoverage_two_tx.bak` | 0.136s |
| `dirtycoverage_uncommitted.bak` | 0.137s |
| `dirtycoverage_update.bak` | 0.143s |
| `featurecoverage_full.bak` | 0.21s |
| `filtered_ncci_full.bak` | 0.117s |
| `float_extreme_full.bak` | 0.123s |
| `forwarded_records_full.bak` | 0.226s |
| `ghost_records_full.bak` | 0.105s |
| `heapcoverage_large.bak` | 0.127s |
| `heapcoverage_large_50000.bak` | 1.066s |
| `hierarchyid_extract_full.bak` | 0.109s |
| `high_slot_density_full.bak` | 0.609s |
| `incrementalcoverage_diff_01.bak` | 0.111s |
| `incrementalcoverage_diff_02.bak` | 0.093s |
| `incrementalcoverage_diff_03.bak` | 0.095s |
| `incrementalcoverage_diff_04.bak` | 0.122s |
| `incrementalcoverage_diff_05.bak` | 0.104s |
| `incrementalcoverage_diff_06.bak` | 0.108s |
| `incrementalcoverage_full.bak` | 0.096s |
| `layoutcoverage_full.bak` | 0.441s |
| `max_row_width_full.bak` | 0.089s |
| `mixed_collation_full.bak` | 0.115s |
| `multi_rowgroup_full.bak` | 0.13s |
| `native_json_full.bak` | 0.111s |
| `ncci_heap_full.bak` | 0.107s |
| `ncci_types_full.bak` | 0.535s |
| `ndfcoverage_full.bak` | 0.103s |
| `nvarchar_max_u21_full.bak` | 0.105s |
| `ordered_cci_full.bak` | 0.125s |
| `pagecomp_anchor_full.bak` | 0.426s |
| `pagecomp_long_prefix_full.bak` | 0.102s |
| `pfor_columnstore_full.bak` | 2.56s |
| `pfor_columnstore_random_full.bak` | 2.396s |
| `realworld_numeric_digest_full.bak` | 0.224s |
| `rowboundary_full.bak` | 0.129s |
| `rowstore_hash_pii_full.bak` | 0.109s |
| `rowstore_lob_image_full.bak` | 0.129s |
| `rowstore_lob_markup_full.bak` | 0.113s |
| `rowversion_extract_full.bak` | 0.133s |
| `sparse_full.bak` | 0.329s |
| `spatial_edge_full.bak` | 0.116s |
| `spatial_index_full.bak` | 0.13s |
| `sql_variant_extract_full.bak` | 0.106s |
| `striped_full_1.bak` | 0.12s |
| `striped_single.bak` | 0.158s |
| `surrogate_pairs_full.bak` | 0.104s |
| `tabletype_cci_large_full.bak` | 0.158s |
| `tabletypecoverage_diff.bak` | 0.223s |
| `tabletypecoverage_full.bak` | 0.226s |
| `temporal_hidden_full.bak` | 0.111s |
| `torn_page_full.bak` | 0.124s |
| `typecoverage_full.bak` | 0.185s |
| `typed_xml_full.bak` | 0.104s |
| `unicode_codepage_coverage.bak` | 0.137s |
| `utf8_collation_full.bak` | 0.117s |
| `vector_full.bak` | 0.107s |
| `xml_index_full.bak` | 0.122s |
| `xmlcoverage_full.bak` | 0.109s |
| `xmlheap_full.bak` | 0.144s |
| `xtp_checkpoint_straddle_full.bak` | 3.461s |
| `xtp_probe_full.bak` | 0.186s |
| `xtp_rich_full.bak` | 0.164s |
| `xtp_simple_full.bak` | 0.164s |
