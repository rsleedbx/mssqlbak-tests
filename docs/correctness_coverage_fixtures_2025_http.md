...
|--------|---------|--------|-----------|
| `alias_types_full.bak` | 0.057s | 0.034s | 0.091s |
| `archive_columnstore_partition_full.bak` | 1.0s | 0.639s | 1.639s |
| `archive_columnstore_types_full.bak` | 0.365s | 0.719s | 1.084s |
| `archive_columnstore_types_random_full.bak` | 0.367s | 0.711s | 1.078s |
| `archive_single_chunk_full.bak` | 0.057s | 0.042s | 0.099s |
| `archive_single_chunk_random_full.bak` | 0.062s | 0.043s | 0.105s |
| `archivenull_full.bak` | 0.143s | 0.212s | 0.355s |
| `backup_blocksize_full.bak` | 0.064s | 0.036s | 0.1s |
| `boundarycoverage_datetime_full.bak` | 0.078s | 0.148s | 0.226s |
| `boundarycoverage_full.bak` | 0.085s | 0.071s | 0.156s |
| `cci_binary_varbinary_compare_full.bak` | 0.06s | 0.037s | 0.097s |
| `cci_bitpack_probe_bigint_full.bak` | 1.276s | 3.777s | 5.053s |
| `cci_bitpack_probe_full.bak` | 0.148s | 0.672s | 0.82s |
| `cci_bitpack_probe_highbase_full.bak` | 0.121s | 0.424s | 0.545s |
| `cci_btree_nci_full.bak` | 0.076s | 0.044s | 0.12s |
| `cci_computed_full.bak` | 0.06s | 0.039s | 0.099s |
| `cci_enc5_largepool_full.bak` | 0.383s | 0.464s | 0.847s |
| `cci_enc5_largepool_matrix_full.bak` | 7.211s | 1.282s | 8.493s |
| `cci_extended_full.bak` | 0.072s | 0.046s | 0.118s |
| `cci_lob_full.bak` | 0.064s | 0.043s | 0.107s |
| `cci_reorganize_full.bak` | 0.057s | 0.041s | 0.098s |
| `cci_string_dict_regression_full.bak` | 0.348s | 0.151s | 0.499s |
| `cci_string_minmax_full.bak` | 0.061s | 0.039s | 0.1s |
| `cci_switch_full.bak` | 0.07s | 0.038s | 0.108s |
| `cci_types_large_full.bak` | 0.072s | 0.051s | 0.123s |
| `cci_varbinary_micro_full.bak` | 0.068s | 0.036s | 0.104s |
| `cci_varbinary_probe_full.bak` | 0.081s | 0.052s | 0.133s |
| `columnstore_minimal.bak` | 0.125s | 0.995s | 1.12s |
| `compressed_nvarchar_full.bak` | 0.053s | 0.033s | 0.086s |
| `compressioncoverage_full.bak` | 0.102s | 0.182s | 0.284s |
| `computedcoverage_full.bak` | 0.061s | 0.039s | 0.1s |
| `constraintcoverage_full.bak` | 0.063s | 0.044s | 0.107s |
| `covering_index_full.bak` | 0.067s | 0.04s | 0.107s |
| `cs_lob_preamble.bak` | 0.116s | 0.059s | 0.175s |
| `delta_rowgroup_full.bak` | 0.062s | 0.037s | 0.099s |
| `dirtycoverage_aborted_xact.bak` | 0.077s | 0.036s | 0.113s |
| `dirtycoverage_addcol.bak` | 0.059s | 0.036s | 0.095s |
| `dirtycoverage_addnotnull.bak` | 0.06s | 0.039s | 0.099s |
| `dirtycoverage_alldirty.bak` | 0.087s | 0.033s | 0.12s |
| `dirtycoverage_altercol.bak` | 0.06s | 0.036s | 0.096s |
| `dirtycoverage_altercol_rewrite.bak` | 0.058s | 0.038s | 0.096s |
| `dirtycoverage_alterdb.bak` | 0.059s | 0.036s | 0.095s |
| `dirtycoverage_cci_delete.bak` | 0.094s | 0.095s | 0.189s |
| `dirtycoverage_cci_update.bak` | 0.119s | 0.095s | 0.214s |
| `dirtycoverage_committed_delete.bak` | 0.054s | 0.038s | 0.092s |
| `dirtycoverage_committed_delete_v2.bak` | 0.056s | 0.04s | 0.096s |
| `dirtycoverage_committed_delete_v3.bak` | 0.06s | 0.061s | 0.121s |
| `dirtycoverage_committed_delete_v4.bak` | 0.173s | 0.101s | 0.274s |
| `dirtycoverage_committed_update.bak` | 0.048s | 0.038s | 0.086s |
| `dirtycoverage_committed_update_v2.bak` | 0.062s | 0.038s | 0.1s |
| `dirtycoverage_committed_update_v3.bak` | 0.07s | 0.069s | 0.139s |
| `dirtycoverage_committed_update_v4.bak` | 0.073s | 0.081s | 0.154s |
| `dirtycoverage_concurrent.bak` | 0.063s | 0.041s | 0.104s |
| `dirtycoverage_createidx.bak` | 0.061s | 0.041s | 0.102s |
| `dirtycoverage_createtable.bak` | 0.062s | 0.035s | 0.097s |
| `dirtycoverage_delete.bak` | 0.085s | 0.035s | 0.12s |
| `dirtycoverage_dropcol.bak` | 0.058s | 0.036s | 0.094s |
| `dirtycoverage_dropidx.bak` | 0.058s | 0.037s | 0.095s |
| `dirtycoverage_droptable.bak` | 0.059s | 0.037s | 0.096s |
| `dirtycoverage_heap_forward.bak` | 0.076s | 0.035s | 0.111s |
| `dirtycoverage_large_dirty.bak` | 0.375s | 0.042s | 0.417s |
| `dirtycoverage_lob_update.bak` | 0.098s | 0.042s | 0.14s |
| `dirtycoverage_maxrow.bak` | 0.057s | 0.038s | 0.095s |
| `dirtycoverage_nchar_delete.bak` | 0.078s | 0.039s | 0.117s |
| `dirtycoverage_nested.bak` | 0.089s | 0.044s | 0.133s |
| `dirtycoverage_null_update.bak` | 0.087s | 0.036s | 0.123s |
| `dirtycoverage_rebuildidx.bak` | 0.062s | 0.036s | 0.098s |
| `dirtycoverage_rich_insert.bak` | 0.098s | 0.041s | 0.139s |
| `dirtycoverage_rich_update.bak` | 0.083s | 0.036s | 0.119s |
| `dirtycoverage_savepoint.bak` | 0.087s | 0.042s | 0.129s |
| `dirtycoverage_snapshot_update.bak` | 0.078s | 0.034s | 0.112s |
| `dirtycoverage_switch.bak` | 0.06s | 0.041s | 0.101s |
| `dirtycoverage_temporal_update.bak` | 0.083s | 0.046s | 0.129s |
| `dirtycoverage_truncate.bak` | 0.062s | 0.037s | 0.099s |
| `dirtycoverage_two_tx.bak` | 0.092s | 0.039s | 0.131s |
| `dirtycoverage_uncommitted.bak` | 0.089s | 0.037s | 0.126s |
| `dirtycoverage_update.bak` | 0.088s | 0.039s | 0.127s |
| `featurecoverage_full.bak` | 0.152s | 0.064s | 0.216s |
| `filtered_ncci_full.bak` | 0.058s | 0.038s | 0.096s |
| `float_extreme_full.bak` | 0.053s | 0.035s | 0.088s |
| `forwarded_records_full.bak` | 0.376s | 0.076s | 0.452s |
| `ghost_records_full.bak` | 0.062s | 0.039s | 0.101s |
| `heapcoverage_large.bak` | 0.061s | 0.051s | 0.112s |
| `heapcoverage_large_50000.bak` | 0.302s | 0.33s | 0.632s |
| `hierarchyid_extract_full.bak` | 0.054s | 0.034s | 0.088s |
| `high_slot_density_full.bak` | 0.08s | 0.23s | 0.31s |
| `identity_coverage_full.bak` | 0.069s | 0.04s | 0.109s |
| `incrementalcoverage_diff_01.bak` | 0.049s | 0.013s | 0.062s |
| `incrementalcoverage_diff_02.bak` | 0.054s | 0.013s | 0.067s |
| `incrementalcoverage_diff_03.bak` | 0.066s | 0.013s | 0.079s |
| `incrementalcoverage_diff_04.bak` | 0.049s | 0.012s | 0.061s |
| `incrementalcoverage_diff_05.bak` | 0.049s | 0.013s | 0.062s |
| `incrementalcoverage_diff_06.bak` | 0.055s | 0.018s | 0.073s |
| `incrementalcoverage_full.bak` | 0.047s | 0.034s | 0.081s |
| `layoutcoverage_full.bak` | 0.23s | 0.372s | 0.602s |
| `max_row_width_full.bak` | 0.05s | 0.035s | 0.085s |
| `mixed_collation_full.bak` | 0.048s | 0.035s | 0.083s |
| `multi_rowgroup_full.bak` | 0.058s | 0.04s | 0.098s |
| `native_json_full.bak` | 0.059s | 0.035s | 0.094s |
| `ncci_heap_full.bak` | 0.064s | 0.036s | 0.1s |
| `ncci_types_full.bak` | 0.12s | 0.176s | 0.296s |
| `ndfcoverage_full.bak` | 0.064s | 0.042s | 0.106s |
| `nvarchar_max_u21_full.bak` | 0.05s | 0.043s | 0.093s |
| `ordered_cci_full.bak` | 0.063s | 0.04s | 0.103s |
| `pagecomp_anchor_full.bak` | 0.149s | 0.124s | 0.273s |
| `pagecomp_long_prefix_full.bak` | 0.059s | 0.039s | 0.098s |
| `pfor_columnstore_full.bak` | 0.14s | 0.845s | 0.985s |
| `pfor_columnstore_random_full.bak` | 0.149s | 0.833s | 0.982s |
| `realworld_numeric_digest_full.bak` | 0.07s | 0.085s | 0.155s |
| `rowboundary_full.bak` | 0.062s | 0.039s | 0.101s |
| `rowstore_hash_pii_full.bak` | 0.057s | 0.035s | 0.092s |
| `rowstore_lob_image_full.bak` | 0.06s | 0.036s | 0.096s |
| `rowstore_lob_markup_full.bak` | 0.057s | 0.039s | 0.096s |
| `rowversion_extract_full.bak` | 0.061s | 0.041s | 0.102s |
| `sparse_full.bak` | 0.111s | 0.093s | 0.204s |
| `spatial_edge_full.bak` | 0.063s | 0.036s | 0.099s |
| `spatial_index_full.bak` | 0.061s | 0.038s | 0.099s |
| `sql_variant_extract_full.bak` | 0.052s | 0.034s | 0.086s |
| `striped_full_1.bak` | 0.055s | 0.015s | 0.07s |
| `striped_single.bak` | 0.088s | 0.059s | 0.147s |
| `surrogate_pairs_full.bak` | 0.05s | 0.039s | 0.089s |
| `tabletype_cci_large_full.bak` | 0.082s | 0.047s | 0.129s |
| `tabletypecoverage_diff.bak` | 0.103s | 0.068s | 0.171s |
| `tabletypecoverage_full.bak` | 0.183s | 0.101s | 0.284s |
| `temporal_hidden_full.bak` | 0.054s | 0.036s | 0.09s |
| `torn_page_full.bak` | 0.059s | 0.038s | 0.097s |
| `typecoverage_full.bak` | 0.133s | 0.075s | 0.208s |
| `typed_xml_full.bak` | 0.056s | 0.039s | 0.095s |
| `unicode_codepage_coverage.bak` | 0.087s | 0.061s | 0.148s |
| `utf8_collation_full.bak` | 0.053s | 0.035s | 0.088s |
| `vector_full.bak` | 0.061s | 0.039s | 0.1s |
| `xml_index_full.bak` | 0.063s | 0.038s | 0.101s |
| `xmlcoverage_full.bak` | 0.05s | 0.033s | 0.083s |
| `xmlheap_full.bak` | 0.113s | 0.057s | 0.17s |
| `xtp_checkpoint_straddle_full.bak` | 1.897s | 0.383s | 2.28s |
| `xtp_probe_full.bak` | 0.134s | 0.038s | 0.172s |
| `xtp_rich_full.bak` | 0.128s | 0.042s | 0.17s |
| `xtp_simple_full.bak` | 0.116s | 0.046s | 0.162s |
...
_Generated 2026-07-13 · 138 fixtures · 138 pass · 0 xfail · 0 fail_
