...
|--------|---------|--------|-----------|
| `alias_types_full.bak` | 0.064s | 0.037s | 0.101s |
| `archive_columnstore_partition_full.bak` | 0.987s | 0.616s | 1.603s |
| `archive_columnstore_types_full.bak` | 0.367s | 0.705s | 1.072s |
| `archive_columnstore_types_random_full.bak` | 0.372s | 0.698s | 1.07s |
| `archive_single_chunk_full.bak` | 0.067s | 0.043s | 0.11s |
| `archive_single_chunk_random_full.bak` | 0.058s | 0.043s | 0.101s |
| `archivenull_full.bak` | 0.141s | 0.214s | 0.355s |
| `backup_blocksize_full.bak` | 0.054s | 0.04s | 0.094s |
| `boundarycoverage_datetime_full.bak` | 0.09s | 0.157s | 0.247s |
| `boundarycoverage_full.bak` | 0.083s | 0.067s | 0.15s |
| `cci_binary_varbinary_compare_full.bak` | 0.061s | 0.048s | 0.109s |
| `cci_bitpack_probe_bigint_full.bak` | 1.284s | 3.665s | 4.949s |
| `cci_bitpack_probe_full.bak` | 0.138s | 0.654s | 0.792s |
| `cci_bitpack_probe_highbase_full.bak` | 0.131s | 0.418s | 0.549s |
| `cci_btree_nci_full.bak` | 0.073s | 0.051s | 0.124s |
| `cci_computed_full.bak` | 0.059s | 0.037s | 0.096s |
| `cci_enc5_largepool_full.bak` | 0.381s | 0.439s | 0.82s |
| `cci_enc5_largepool_matrix_full.bak` | 7.124s | 1.267s | 8.391s |
| `cci_extended_full.bak` | 0.076s | 0.063s | 0.139s |
| `cci_lob_full.bak` | 0.066s | 0.049s | 0.115s |
| `cci_reorganize_full.bak` | 0.069s | 0.043s | 0.112s |
| `cci_string_dict_regression_full.bak` | 0.353s | 0.144s | 0.497s |
| `cci_string_minmax_full.bak` | 0.072s | 0.044s | 0.116s |
| `cci_switch_full.bak` | 0.059s | 0.043s | 0.102s |
| `cci_types_large_full.bak` | 0.076s | 0.046s | 0.122s |
| `cci_varbinary_micro_full.bak` | 0.063s | 0.038s | 0.101s |
| `cci_varbinary_probe_full.bak` | 0.075s | 0.049s | 0.124s |
| `columnstore_minimal.bak` | 0.127s | 0.911s | 1.038s |
| `compressed_nvarchar_full.bak` | 0.058s | 0.036s | 0.094s |
| `compressioncoverage_full.bak` | 0.108s | 0.191s | 0.299s |
| `computedcoverage_full.bak` | 0.052s | 0.037s | 0.089s |
| `constraintcoverage_full.bak` | 0.068s | 0.048s | 0.116s |
| `covering_index_full.bak` | 0.058s | 0.043s | 0.101s |
| `cs_lob_preamble.bak` | 0.113s | 0.065s | 0.178s |
| `delta_rowgroup_full.bak` | 0.062s | 0.036s | 0.098s |
| `dirtycoverage_aborted_xact.bak` | 0.076s | 0.045s | 0.121s |
| `dirtycoverage_addcol.bak` | 0.053s | 0.036s | 0.089s |
| `dirtycoverage_addnotnull.bak` | 0.066s | 0.036s | 0.102s |
| `dirtycoverage_alldirty.bak` | 0.092s | 0.04s | 0.132s |
| `dirtycoverage_altercol.bak` | 0.062s | 0.036s | 0.098s |
| `dirtycoverage_altercol_rewrite.bak` | 0.056s | 0.036s | 0.092s |
| `dirtycoverage_alterdb.bak` | 0.058s | 0.038s | 0.096s |
| `dirtycoverage_cci_delete.bak` | 0.089s | 0.092s | 0.181s |
| `dirtycoverage_cci_update.bak` | 0.122s | 0.098s | 0.22s |
| `dirtycoverage_committed_delete.bak` | 0.048s | 0.037s | 0.085s |
| `dirtycoverage_committed_delete_v2.bak` | 0.056s | 0.042s | 0.098s |
| `dirtycoverage_committed_delete_v3.bak` | 0.064s | 0.065s | 0.129s |
| `dirtycoverage_committed_delete_v4.bak` | 0.184s | 0.072s | 0.256s |
| `dirtycoverage_committed_update.bak` | 0.049s | 0.034s | 0.083s |
| `dirtycoverage_committed_update_v2.bak` | 0.065s | 0.042s | 0.107s |
| `dirtycoverage_committed_update_v3.bak` | 0.069s | 0.071s | 0.14s |
| `dirtycoverage_committed_update_v4.bak` | 0.07s | 0.074s | 0.144s |
| `dirtycoverage_concurrent.bak` | 0.06s | 0.038s | 0.098s |
| `dirtycoverage_createidx.bak` | 0.06s | 0.045s | 0.105s |
| `dirtycoverage_createtable.bak` | 0.062s | 0.046s | 0.108s |
| `dirtycoverage_delete.bak` | 0.089s | 0.048s | 0.137s |
| `dirtycoverage_dropcol.bak` | 0.053s | 0.035s | 0.088s |
| `dirtycoverage_dropidx.bak` | 0.059s | 0.037s | 0.096s |
| `dirtycoverage_droptable.bak` | 0.055s | 0.037s | 0.092s |
| `dirtycoverage_heap_forward.bak` | 0.08s | 0.041s | 0.121s |
| `dirtycoverage_large_dirty.bak` | 0.352s | 0.042s | 0.394s |
| `dirtycoverage_lob_update.bak` | 0.099s | 0.035s | 0.134s |
| `dirtycoverage_maxrow.bak` | 0.051s | 0.035s | 0.086s |
| `dirtycoverage_nchar_delete.bak` | 0.079s | 0.039s | 0.118s |
| `dirtycoverage_nested.bak` | 0.095s | 0.046s | 0.141s |
| `dirtycoverage_null_update.bak` | 0.095s | 0.045s | 0.14s |
| `dirtycoverage_rebuildidx.bak` | 0.06s | 0.037s | 0.097s |
| `dirtycoverage_rich_insert.bak` | 0.098s | 0.04s | 0.138s |
| `dirtycoverage_rich_update.bak` | 0.085s | 0.041s | 0.126s |
| `dirtycoverage_savepoint.bak` | 0.093s | 0.046s | 0.139s |
| `dirtycoverage_snapshot_update.bak` | 0.075s | 0.038s | 0.113s |
| `dirtycoverage_switch.bak` | 0.06s | 0.036s | 0.096s |
| `dirtycoverage_temporal_update.bak` | 0.095s | 0.044s | 0.139s |
| `dirtycoverage_truncate.bak` | 0.057s | 0.037s | 0.094s |
| `dirtycoverage_two_tx.bak` | 0.092s | 0.036s | 0.128s |
| `dirtycoverage_uncommitted.bak` | 0.09s | 0.037s | 0.127s |
| `dirtycoverage_update.bak` | 0.089s | 0.045s | 0.134s |
| `featurecoverage_full.bak` | 0.158s | 0.063s | 0.221s |
| `filtered_ncci_full.bak` | 0.059s | 0.041s | 0.1s |
| `float_extreme_full.bak` | 0.052s | 0.035s | 0.087s |
| `forwarded_records_full.bak` | 0.373s | 0.078s | 0.451s |
| `ghost_records_full.bak` | 0.055s | 0.04s | 0.095s |
| `heapcoverage_large.bak` | 0.058s | 0.046s | 0.104s |
| `heapcoverage_large_50000.bak` | 0.302s | 0.325s | 0.627s |
| `hierarchyid_extract_full.bak` | 0.054s | 0.038s | 0.092s |
| `high_slot_density_full.bak` | 0.079s | 0.189s | 0.268s |
| `identity_coverage_full.bak` | 0.063s | 0.038s | 0.101s |
| `incrementalcoverage_diff_01.bak` | 0.051s | 0.013s | 0.064s |
| `incrementalcoverage_diff_02.bak` | 0.049s | 0.014s | 0.063s |
| `incrementalcoverage_diff_03.bak` | 0.049s | 0.013s | 0.062s |
| `incrementalcoverage_diff_04.bak` | 0.048s | 0.014s | 0.062s |
| `incrementalcoverage_diff_05.bak` | 0.048s | 0.012s | 0.06s |
| `incrementalcoverage_diff_06.bak` | 0.05s | 0.014s | 0.064s |
| `incrementalcoverage_full.bak` | 0.05s | 0.036s | 0.086s |
| `layoutcoverage_full.bak` | 0.238s | 0.328s | 0.566s |
| `max_row_width_full.bak` | 0.053s | 0.039s | 0.092s |
| `mixed_collation_full.bak` | 0.048s | 0.035s | 0.083s |
| `multi_rowgroup_full.bak` | 0.057s | 0.04s | 0.097s |
| `native_json_full.bak` | 0.054s | 0.04s | 0.094s |
| `ncci_heap_full.bak` | 0.059s | 0.036s | 0.095s |
| `ncci_types_full.bak` | 0.127s | 0.185s | 0.312s |
| `ndfcoverage_full.bak` | 0.061s | 0.038s | 0.099s |
| `nvarchar_max_u21_full.bak` | 0.053s | 0.037s | 0.09s |
| `ordered_cci_full.bak` | 0.071s | 0.043s | 0.114s |
| `pagecomp_anchor_full.bak` | 0.15s | 0.1s | 0.25s |
| `pagecomp_long_prefix_full.bak` | 0.054s | 0.036s | 0.09s |
| `pfor_columnstore_full.bak` | 0.146s | 0.83s | 0.976s |
| `pfor_columnstore_random_full.bak` | 0.146s | 0.824s | 0.97s |
| `realworld_numeric_digest_full.bak` | 0.096s | 0.09s | 0.186s |
| `rowboundary_full.bak` | 0.057s | 0.037s | 0.094s |
| `rowstore_hash_pii_full.bak` | 0.068s | 0.034s | 0.102s |
| `rowstore_lob_image_full.bak` | 0.063s | 0.035s | 0.098s |
| `rowstore_lob_markup_full.bak` | 0.051s | 0.036s | 0.087s |
| `rowversion_extract_full.bak` | 0.054s | 0.035s | 0.089s |
| `sparse_full.bak` | 0.107s | 0.094s | 0.201s |
| `spatial_edge_full.bak` | 0.053s | 0.049s | 0.102s |
| `spatial_index_full.bak` | 0.065s | 0.041s | 0.106s |
| `sql_variant_extract_full.bak` | 0.051s | 0.035s | 0.086s |
| `striped_full_1.bak` | 0.056s | 0.015s | 0.071s |
| `striped_single.bak` | 0.089s | 0.05s | 0.139s |
| `surrogate_pairs_full.bak` | 0.047s | 0.04s | 0.087s |
| `tabletype_cci_large_full.bak` | 0.079s | 0.048s | 0.127s |
| `tabletypecoverage_diff.bak` | 0.113s | 0.074s | 0.187s |
| `tabletypecoverage_full.bak` | 0.188s | 0.108s | 0.296s |
| `temporal_hidden_full.bak` | 0.056s | 0.053s | 0.109s |
| `torn_page_full.bak` | 0.053s | 0.036s | 0.089s |
| `typecoverage_full.bak` | 0.118s | 0.067s | 0.185s |
| `typed_xml_full.bak` | 0.051s | 0.035s | 0.086s |
| `unicode_codepage_coverage.bak` | 0.088s | 0.049s | 0.137s |
| `utf8_collation_full.bak` | 0.059s | 0.047s | 0.106s |
| `vector_full.bak` | 0.053s | 0.037s | 0.09s |
| `xml_index_full.bak` | 0.066s | 0.038s | 0.104s |
| `xmlcoverage_full.bak` | 0.051s | 0.034s | 0.085s |
| `xmlheap_full.bak` | 0.117s | 0.062s | 0.179s |
| `xtp_checkpoint_straddle_full.bak` | 1.854s | 0.366s | 2.22s |
| `xtp_probe_full.bak` | 0.136s | 0.038s | 0.174s |
| `xtp_rich_full.bak` | 0.144s | 0.041s | 0.185s |
| `xtp_simple_full.bak` | 0.158s | 0.04s | 0.198s |
