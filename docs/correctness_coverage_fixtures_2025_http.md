...
| Backup | Wall time |
|--------|-------------|
| `alias_types_full.bak` | 0.101s |
| `archive_columnstore_partition_full.bak` | 2.678s |
| `archive_columnstore_types_full.bak` | 1.472s |
| `archive_columnstore_types_random_full.bak` | 1.441s |
| `archive_single_chunk_full.bak` | 0.113s |
| `archive_single_chunk_random_full.bak` | 0.12s |
| `archivenull_full.bak` | 0.463s |
| `backup_blocksize_full.bak` | 0.109s |
| `boundarycoverage_datetime_full.bak` | 0.5s |
| `boundarycoverage_full.bak` | 0.262s |
| `cci_binary_varbinary_compare_full.bak` | 0.12s |
| `cci_bitpack_probe_bigint_full.bak` | 9.118s |
| `cci_bitpack_probe_full.bak` | 1.837s |
| `cci_bitpack_probe_highbase_full.bak` | 1.356s |
| `cci_btree_nci_full.bak` | 0.142s |
| `cci_computed_full.bak` | 0.126s |
| `cci_enc5_largepool_full.bak` | 1.237s |
| `cci_enc5_largepool_matrix_full.bak` | 9.885s |
| `cci_extended_full.bak` | 0.213s |
| `cci_lob_full.bak` | 0.134s |
| `cci_reorganize_full.bak` | 0.139s |
| `cci_string_dict_regression_full.bak` | 0.549s |
| `cci_string_minmax_full.bak` | 0.125s |
| `cci_switch_full.bak` | 0.127s |
| `cci_types_large_full.bak` | 0.23s |
| `cci_varbinary_micro_full.bak` | 0.13s |
| `cci_varbinary_probe_full.bak` | 0.154s |
| `columnstore_minimal.bak` | 1.093s |
| `compressed_nvarchar_full.bak` | 0.105s |
| `compressioncoverage_full.bak` | 0.423s |
| `computedcoverage_full.bak` | 0.118s |
| `constraintcoverage_full.bak` | 0.128s |
| `covering_index_full.bak` | 0.125s |
| `cs_lob_preamble.bak` | 0.202s |
| `delta_rowgroup_full.bak` | 0.122s |
| `dirtycoverage_aborted_xact.bak` | 0.134s |
| `dirtycoverage_addcol.bak` | 0.107s |
| `dirtycoverage_addnotnull.bak` | 0.096s |
| `dirtycoverage_alldirty.bak` | 0.127s |
| `dirtycoverage_altercol.bak` | 0.101s |
| `dirtycoverage_altercol_rewrite.bak` | 0.098s |
| `dirtycoverage_alterdb.bak` | 0.108s |
| `dirtycoverage_cci_delete.bak` | 0.222s |
| `dirtycoverage_cci_update.bak` | 0.248s |
| `dirtycoverage_committed_delete.bak` | 0.111s |
| `dirtycoverage_committed_delete_v2.bak` | 0.128s |
| `dirtycoverage_committed_delete_v3.bak` | 0.161s |
| `dirtycoverage_committed_delete_v4.bak` | 0.363s |
| `dirtycoverage_committed_update.bak` | 0.097s |
| `dirtycoverage_committed_update_v2.bak` | 0.186s |
| `dirtycoverage_committed_update_v3.bak` | 0.211s |
| `dirtycoverage_committed_update_v4.bak` | 0.292s |
| `dirtycoverage_concurrent.bak` | 0.102s |
| `dirtycoverage_createidx.bak` | 0.122s |
| `dirtycoverage_createtable.bak` | 0.106s |
| `dirtycoverage_delete.bak` | 0.126s |
| `dirtycoverage_dropcol.bak` | 0.097s |
| `dirtycoverage_dropidx.bak` | 0.106s |
| `dirtycoverage_droptable.bak` | 0.158s |
| `dirtycoverage_heap_forward.bak` | 0.129s |
| `dirtycoverage_large_dirty.bak` | 0.412s |
| `dirtycoverage_lob_update.bak` | 0.135s |
| `dirtycoverage_maxrow.bak` | 0.091s |
| `dirtycoverage_nchar_delete.bak` | 0.13s |
| `dirtycoverage_nested.bak` | 0.137s |
| `dirtycoverage_null_update.bak` | 0.13s |
| `dirtycoverage_rebuildidx.bak` | 0.113s |
| `dirtycoverage_rich_insert.bak` | 0.155s |
| `dirtycoverage_rich_update.bak` | 0.13s |
| `dirtycoverage_savepoint.bak` | 0.147s |
| `dirtycoverage_snapshot_update.bak` | 0.128s |
| `dirtycoverage_switch.bak` | 0.117s |
| `dirtycoverage_temporal_update.bak` | 0.184s |
| `dirtycoverage_truncate.bak` | 0.11s |
| `dirtycoverage_two_tx.bak` | 0.196s |
| `dirtycoverage_uncommitted.bak` | 0.14s |
| `dirtycoverage_update.bak` | 0.132s |
| `featurecoverage_full.bak` | 0.232s |
| `filtered_ncci_full.bak` | 0.137s |
| `float_extreme_full.bak` | 0.101s |
| `forwarded_records_full.bak` | 0.227s |
| `ghost_records_full.bak` | 0.101s |
| `heapcoverage_large.bak` | 0.125s |
| `heapcoverage_large_50000.bak` | 1.04s |
| `hierarchyid_extract_full.bak` | 0.102s |
| `high_slot_density_full.bak` | 0.606s |
| `incrementalcoverage_diff_01.bak` | 0.104s |
| `incrementalcoverage_diff_02.bak` | 0.103s |
| `incrementalcoverage_diff_03.bak` | 0.094s |
| `incrementalcoverage_diff_04.bak` | 0.116s |
| `incrementalcoverage_diff_05.bak` | 0.099s |
| `incrementalcoverage_diff_06.bak` | 0.103s |
| `incrementalcoverage_full.bak` | 0.103s |
| `layoutcoverage_full.bak` | 0.404s |
| `max_row_width_full.bak` | 0.095s |
| `mixed_collation_full.bak` | 0.092s |
| `multi_rowgroup_full.bak` | 0.126s |
| `native_json_full.bak` | 0.103s |
| `ncci_heap_full.bak` | 0.108s |
| `ncci_types_full.bak` | 0.521s |
| `ndfcoverage_full.bak` | 0.114s |
| `nvarchar_max_u21_full.bak` | 0.098s |
| `ordered_cci_full.bak` | 0.132s |
| `pagecomp_anchor_full.bak` | 0.388s |
| `pagecomp_long_prefix_full.bak` | 0.112s |
| `pfor_columnstore_full.bak` | 2.338s |
| `pfor_columnstore_random_full.bak` | 2.536s |
| `realworld_numeric_digest_full.bak` | 0.222s |
| `rowboundary_full.bak` | 0.101s |
| `rowstore_hash_pii_full.bak` | 0.095s |
| `rowstore_lob_image_full.bak` | 0.098s |
| `rowstore_lob_markup_full.bak` | 0.104s |
| `rowversion_extract_full.bak` | 0.094s |
| `sparse_full.bak` | 0.358s |
| `spatial_edge_full.bak` | 0.104s |
| `spatial_index_full.bak` | 0.116s |
| `sql_variant_extract_full.bak` | 0.099s |
| `striped_full_1.bak` | 0.11s |
| `striped_single.bak` | 0.21s |
| `surrogate_pairs_full.bak` | 0.096s |
| `tabletype_cci_large_full.bak` | 0.144s |
| `tabletypecoverage_diff.bak` | 0.249s |
| `tabletypecoverage_full.bak` | 0.231s |
| `temporal_hidden_full.bak` | 0.121s |
| `torn_page_full.bak` | 0.095s |
| `typecoverage_full.bak` | 0.17s |
| `typed_xml_full.bak` | 0.115s |
| `unicode_codepage_coverage.bak` | 0.134s |
| `utf8_collation_full.bak` | 0.1s |
| `vector_full.bak` | 0.107s |
| `xml_index_full.bak` | 0.109s |
| `xmlcoverage_full.bak` | 0.093s |
| `xmlheap_full.bak` | 0.148s |
| `xtp_checkpoint_straddle_full.bak` | 3.456s |
| `xtp_probe_full.bak` | 0.199s |
| `xtp_rich_full.bak` | 0.184s |
| `xtp_simple_full.bak` | 0.165s |
