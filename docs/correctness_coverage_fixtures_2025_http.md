...
|--------|---------|--------|-----------|
| `alias_types_full.bak` | 0.054s | 0.035s | 0.089s |
| `archive_columnstore_partition_full.bak` | 0.995s | 0.686s | 1.681s |
| `archive_columnstore_types_full.bak` | 0.364s | 0.734s | 1.098s |
| `archive_columnstore_types_random_full.bak` | 0.374s | 0.699s | 1.073s |
| `archive_single_chunk_full.bak` | 0.071s | 0.047s | 0.118s |
| `archive_single_chunk_random_full.bak` | 0.062s | 0.047s | 0.109s |
| `archivenull_full.bak` | 0.142s | 0.216s | 0.358s |
| `backup_blocksize_full.bak` | 0.056s | 0.039s | 0.095s |
| `boundarycoverage_datetime_full.bak` | 0.098s | 0.164s | 0.262s |
| `boundarycoverage_full.bak` | 0.071s | 0.07s | 0.141s |
| `cci_binary_varbinary_compare_full.bak` | 0.069s | 0.04s | 0.109s |
| `cci_bitpack_probe_bigint_full.bak` | 1.312s | 3.855s | 5.167s |
| `cci_bitpack_probe_full.bak` | 0.167s | 0.688s | 0.855s |
| `cci_bitpack_probe_highbase_full.bak` | 0.128s | 0.435s | 0.563s |
| `cci_btree_nci_full.bak` | 0.069s | 0.045s | 0.114s |
| `cci_computed_full.bak` | 0.06s | 0.044s | 0.104s |
| `cci_enc5_largepool_full.bak` | 0.39s | 0.49s | 0.88s |
| `cci_enc5_largepool_matrix_full.bak` | 7.294s | 1.278s | 8.572s |
| `cci_extended_full.bak` | 0.075s | 0.061s | 0.136s |
| `cci_lob_full.bak` | 0.064s | 0.054s | 0.118s |
| `cci_reorganize_full.bak` | 0.063s | 0.039s | 0.102s |
| `cci_string_dict_regression_full.bak` | 0.371s | 0.153s | 0.524s |
| `cci_string_minmax_full.bak` | 0.062s | 0.053s | 0.115s |
| `cci_switch_full.bak` | 0.057s | 0.042s | 0.099s |
| `cci_types_large_full.bak` | 0.072s | 0.052s | 0.124s |
| `cci_varbinary_micro_full.bak` | 0.055s | 0.037s | 0.092s |
| `cci_varbinary_probe_full.bak` | 0.076s | 0.055s | 0.131s |
| `columnstore_minimal.bak` | 0.125s | 0.889s | 1.014s |
| `compressed_nvarchar_full.bak` | 0.057s | 0.04s | 0.097s |
| `compressioncoverage_full.bak` | 0.102s | 0.183s | 0.285s |
| `computedcoverage_full.bak` | 0.056s | 0.041s | 0.097s |
| `constraintcoverage_full.bak` | 0.063s | 0.049s | 0.112s |
| `covering_index_full.bak` | 0.056s | 0.044s | 0.1s |
| `cs_lob_preamble.bak` | 0.111s | 0.064s | 0.175s |
| `delta_rowgroup_full.bak` | 0.061s | 0.04s | 0.101s |
| `dirtycoverage_aborted_xact.bak` | 0.077s | 0.036s | 0.113s |
| `dirtycoverage_addcol.bak` | 0.054s | 0.04s | 0.094s |
| `dirtycoverage_addnotnull.bak` | 0.059s | 0.04s | 0.099s |
| `dirtycoverage_alldirty.bak` | 0.084s | 0.039s | 0.123s |
| `dirtycoverage_altercol.bak` | 0.064s | 0.04s | 0.104s |
| `dirtycoverage_altercol_rewrite.bak` | 0.055s | 0.043s | 0.098s |
| `dirtycoverage_alterdb.bak` | 0.055s | 0.042s | 0.097s |
| `dirtycoverage_cci_delete.bak` | 0.087s | 0.095s | 0.182s |
| `dirtycoverage_cci_update.bak` | 0.12s | 0.098s | 0.218s |
| `dirtycoverage_committed_delete.bak` | 0.052s | 0.035s | 0.087s |
| `dirtycoverage_committed_delete_v2.bak` | 0.059s | 0.044s | 0.103s |
| `dirtycoverage_committed_delete_v3.bak` | 0.06s | 0.057s | 0.117s |
| `dirtycoverage_committed_delete_v4.bak` | 0.186s | 0.072s | 0.258s |
| `dirtycoverage_committed_update.bak` | 0.048s | 0.039s | 0.087s |
| `dirtycoverage_committed_update_v2.bak` | 0.066s | 0.041s | 0.107s |
| `dirtycoverage_committed_update_v3.bak` | 0.065s | 0.07s | 0.135s |
| `dirtycoverage_committed_update_v4.bak` | 0.068s | 0.08s | 0.148s |
| `dirtycoverage_concurrent.bak` | 0.06s | 0.038s | 0.098s |
| `dirtycoverage_createidx.bak` | 0.076s | 0.042s | 0.118s |
| `dirtycoverage_createtable.bak` | 0.057s | 0.05s | 0.107s |
| `dirtycoverage_delete.bak` | 0.087s | 0.041s | 0.128s |
| `dirtycoverage_dropcol.bak` | 0.054s | 0.037s | 0.091s |
| `dirtycoverage_dropidx.bak` | 0.058s | 0.044s | 0.102s |
| `dirtycoverage_droptable.bak` | 0.058s | 0.037s | 0.095s |
| `dirtycoverage_heap_forward.bak` | 0.075s | 0.035s | 0.11s |
| `dirtycoverage_large_dirty.bak` | 0.353s | 0.04s | 0.393s |
| `dirtycoverage_lob_update.bak` | 0.096s | 0.039s | 0.135s |
| `dirtycoverage_maxrow.bak` | 0.055s | 0.035s | 0.09s |
| `dirtycoverage_nchar_delete.bak` | 0.08s | 0.036s | 0.116s |
| `dirtycoverage_nested.bak` | 0.084s | 0.036s | 0.12s |
| `dirtycoverage_null_update.bak` | 0.082s | 0.037s | 0.119s |
| `dirtycoverage_rebuildidx.bak` | 0.055s | 0.043s | 0.098s |
| `dirtycoverage_rich_insert.bak` | 0.097s | 0.036s | 0.133s |
| `dirtycoverage_rich_update.bak` | 0.079s | 0.038s | 0.117s |
| `dirtycoverage_savepoint.bak` | 0.088s | 0.039s | 0.127s |
| `dirtycoverage_snapshot_update.bak` | 0.076s | 0.035s | 0.111s |
| `dirtycoverage_switch.bak` | 0.059s | 0.043s | 0.102s |
| `dirtycoverage_temporal_update.bak` | 0.084s | 0.041s | 0.125s |
| `dirtycoverage_truncate.bak` | 0.054s | 0.037s | 0.091s |
| `dirtycoverage_two_tx.bak` | 0.091s | 0.053s | 0.144s |
| `dirtycoverage_uncommitted.bak` | 0.086s | 0.043s | 0.129s |
| `dirtycoverage_update.bak` | 0.087s | 0.039s | 0.126s |
| `featurecoverage_full.bak` | 0.152s | 0.066s | 0.218s |
| `filtered_ncci_full.bak` | 0.058s | 0.043s | 0.101s |
| `float_extreme_full.bak` | 0.055s | 0.04s | 0.095s |
| `forwarded_records_full.bak` | 0.423s | 0.084s | 0.507s |
| `ghost_records_full.bak` | 0.054s | 0.039s | 0.093s |
| `heapcoverage_large.bak` | 0.059s | 0.044s | 0.103s |
| `heapcoverage_large_50000.bak` | 0.294s | 0.341s | 0.635s |
| `hierarchyid_extract_full.bak` | 0.053s | 0.039s | 0.092s |
| `high_slot_density_full.bak` | 0.081s | 0.194s | 0.275s |
| `identity_coverage_full.bak` | 0.058s | 0.039s | 0.097s |
| `incrementalcoverage_diff_01.bak` | 0.056s | 0.023s | 0.079s |
| `incrementalcoverage_diff_02.bak` | 0.051s | 0.026s | 0.077s |
| `incrementalcoverage_diff_03.bak` | 0.054s | 0.023s | 0.077s |
| `incrementalcoverage_diff_04.bak` | 0.052s | 0.036s | 0.088s |
| `incrementalcoverage_diff_05.bak` | 0.053s | 0.013s | 0.066s |
| `incrementalcoverage_diff_06.bak` | 0.052s | 0.016s | 0.068s |
| `incrementalcoverage_full.bak` | 0.051s | 0.045s | 0.096s |
| `layoutcoverage_full.bak` | 0.23s | 0.401s | 0.631s |
| `max_row_width_full.bak` | 0.048s | 0.04s | 0.088s |
| `mixed_collation_full.bak` | 0.05s | 0.047s | 0.097s |
| `multi_rowgroup_full.bak` | 0.059s | 0.041s | 0.1s |
| `native_json_full.bak` | 0.056s | 0.043s | 0.099s |
| `ncci_heap_full.bak` | 0.067s | 0.044s | 0.111s |
| `ncci_types_full.bak` | 0.117s | 0.185s | 0.302s |
| `ndfcoverage_full.bak` | 0.063s | 0.045s | 0.108s |
| `nvarchar_max_u21_full.bak` | 0.054s | 0.04s | 0.094s |
| `ordered_cci_full.bak` | 0.058s | 0.046s | 0.104s |
| `pagecomp_anchor_full.bak` | 0.159s | 0.103s | 0.262s |
| `pagecomp_long_prefix_full.bak` | 0.055s | 0.038s | 0.093s |
| `pfor_columnstore_full.bak` | 0.139s | 0.847s | 0.986s |
| `pfor_columnstore_random_full.bak` | 0.145s | 0.861s | 1.006s |
| `realworld_numeric_digest_full.bak` | 0.069s | 0.091s | 0.16s |
| `rowboundary_full.bak` | 0.055s | 0.043s | 0.098s |
| `rowstore_hash_pii_full.bak` | 0.053s | 0.049s | 0.102s |
| `rowstore_lob_image_full.bak` | 0.055s | 0.039s | 0.094s |
| `rowstore_lob_markup_full.bak` | 0.052s | 0.038s | 0.09s |
| `rowversion_extract_full.bak` | 0.055s | 0.038s | 0.093s |
| `sparse_full.bak` | 0.105s | 0.096s | 0.201s |
| `spatial_edge_full.bak` | 0.055s | 0.038s | 0.093s |
| `spatial_index_full.bak` | 0.063s | 0.038s | 0.101s |
| `sql_variant_extract_full.bak` | 0.057s | 0.041s | 0.098s |
| `striped_full_1.bak` | 0.058s | 0.014s | 0.072s |
| `striped_single.bak` | 0.088s | 0.051s | 0.139s |
| `surrogate_pairs_full.bak` | 0.049s | 0.035s | 0.084s |
| `tabletype_cci_large_full.bak` | 0.084s | 0.064s | 0.148s |
| `tabletypecoverage_diff.bak` | 0.107s | 0.079s | 0.186s |
| `tabletypecoverage_full.bak` | 0.186s | 0.112s | 0.298s |
| `temporal_hidden_full.bak` | 0.064s | 0.053s | 0.117s |
| `torn_page_full.bak` | 0.059s | 0.035s | 0.094s |
| `typecoverage_full.bak` | 0.127s | 0.065s | 0.192s |
| `typed_xml_full.bak` | 0.055s | 0.037s | 0.092s |
| `unicode_codepage_coverage.bak` | 0.093s | 0.046s | 0.139s |
| `utf8_collation_full.bak` | 0.052s | 0.039s | 0.091s |
| `vector_full.bak` | 0.06s | 0.048s | 0.108s |
| `xml_index_full.bak` | 0.057s | 0.037s | 0.094s |
| `xmlcoverage_full.bak` | 0.049s | 0.049s | 0.098s |
| `xmlheap_full.bak` | 0.118s | 0.07s | 0.188s |
| `xtp_checkpoint_straddle_full.bak` | 1.924s | 0.373s | 2.297s |
| `xtp_probe_full.bak` | 0.136s | 0.044s | 0.18s |
| `xtp_rich_full.bak` | 0.127s | 0.056s | 0.183s |
| `xtp_simple_full.bak` | 0.118s | 0.049s | 0.167s |
