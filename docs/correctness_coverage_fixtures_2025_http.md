...
|--------|---------|--------|-----------|
| `alias_types_full.bak` | 0.062s | 0.039s | 0.101s |
| `archive_columnstore_partition_full.bak` | 0.981s | 0.63s | 1.611s |
| `archive_columnstore_types_full.bak` | 0.361s | 0.703s | 1.064s |
| `archive_columnstore_types_random_full.bak` | 0.37s | 0.682s | 1.052s |
| `archive_single_chunk_full.bak` | 0.069s | 0.039s | 0.108s |
| `archive_single_chunk_random_full.bak` | 0.076s | 0.039s | 0.115s |
| `archivenull_full.bak` | 0.142s | 0.218s | 0.36s |
| `backup_blocksize_full.bak` | 0.061s | 0.034s | 0.095s |
| `boundarycoverage_datetime_full.bak` | 0.092s | 0.173s | 0.265s |
| `boundarycoverage_full.bak` | 0.075s | 0.066s | 0.141s |
| `cci_binary_varbinary_compare_full.bak` | 0.073s | 0.04s | 0.113s |
| `cci_bitpack_probe_bigint_full.bak` | 1.28s | 3.661s | 4.941s |
| `cci_bitpack_probe_full.bak` | 0.14s | 0.676s | 0.816s |
| `cci_bitpack_probe_highbase_full.bak` | 0.121s | 0.425s | 0.546s |
| `cci_btree_nci_full.bak` | 0.075s | 0.04s | 0.115s |
| `cci_computed_full.bak` | 0.064s | 0.048s | 0.112s |
| `cci_enc5_largepool_full.bak` | 0.385s | 0.428s | 0.813s |
| `cci_enc5_largepool_matrix_full.bak` | 7.15s | 1.234s | 8.384s |
| `cci_extended_full.bak` | 0.078s | 0.045s | 0.123s |
| `cci_lob_full.bak` | 0.067s | 0.043s | 0.11s |
| `cci_reorganize_full.bak` | 0.066s | 0.039s | 0.105s |
| `cci_string_dict_regression_full.bak` | 0.347s | 0.146s | 0.493s |
| `cci_string_minmax_full.bak` | 0.077s | 0.04s | 0.117s |
| `cci_switch_full.bak` | 0.06s | 0.036s | 0.096s |
| `cci_types_large_full.bak` | 0.083s | 0.047s | 0.13s |
| `cci_varbinary_micro_full.bak` | 0.067s | 0.036s | 0.103s |
| `cci_varbinary_probe_full.bak` | 0.079s | 0.047s | 0.126s |
| `columnstore_minimal.bak` | 0.123s | 0.88s | 1.003s |
| `compressed_nvarchar_full.bak` | 0.056s | 0.047s | 0.103s |
| `compressioncoverage_full.bak` | 0.106s | 0.183s | 0.289s |
| `computedcoverage_full.bak` | 0.058s | 0.035s | 0.093s |
| `constraintcoverage_full.bak` | 0.074s | 0.041s | 0.115s |
| `covering_index_full.bak` | 0.065s | 0.039s | 0.104s |
| `cs_lob_preamble.bak` | 0.115s | 0.058s | 0.173s |
| `delta_rowgroup_full.bak` | 0.06s | 0.039s | 0.099s |
| `dirtycoverage_aborted_xact.bak` | 0.077s | 0.034s | 0.111s |
| `dirtycoverage_addcol.bak` | 0.056s | 0.039s | 0.095s |
| `dirtycoverage_addnotnull.bak` | 0.059s | 0.036s | 0.095s |
| `dirtycoverage_alldirty.bak` | 0.084s | 0.035s | 0.119s |
| `dirtycoverage_altercol.bak` | 0.063s | 0.035s | 0.098s |
| `dirtycoverage_altercol_rewrite.bak` | 0.062s | 0.035s | 0.097s |
| `dirtycoverage_alterdb.bak` | 0.065s | 0.043s | 0.108s |
| `dirtycoverage_cci_delete.bak` | 0.084s | 0.091s | 0.175s |
| `dirtycoverage_cci_update.bak` | 0.118s | 0.095s | 0.213s |
| `dirtycoverage_committed_delete.bak` | 0.051s | 0.034s | 0.085s |
| `dirtycoverage_committed_delete_v2.bak` | 0.071s | 0.043s | 0.114s |
| `dirtycoverage_committed_delete_v3.bak` | 0.063s | 0.064s | 0.127s |
| `dirtycoverage_committed_delete_v4.bak` | 0.19s | 0.069s | 0.259s |
| `dirtycoverage_committed_update.bak` | 0.052s | 0.035s | 0.087s |
| `dirtycoverage_committed_update_v2.bak` | 0.064s | 0.038s | 0.102s |
| `dirtycoverage_committed_update_v3.bak` | 0.065s | 0.072s | 0.137s |
| `dirtycoverage_committed_update_v4.bak` | 0.069s | 0.075s | 0.144s |
| `dirtycoverage_concurrent.bak` | 0.07s | 0.037s | 0.107s |
| `dirtycoverage_createidx.bak` | 0.072s | 0.039s | 0.111s |
| `dirtycoverage_createtable.bak` | 0.064s | 0.038s | 0.102s |
| `dirtycoverage_delete.bak` | 0.095s | 0.035s | 0.13s |
| `dirtycoverage_dropcol.bak` | 0.052s | 0.035s | 0.087s |
| `dirtycoverage_dropidx.bak` | 0.066s | 0.041s | 0.107s |
| `dirtycoverage_droptable.bak` | 0.059s | 0.038s | 0.097s |
| `dirtycoverage_heap_forward.bak` | 0.09s | 0.038s | 0.128s |
| `dirtycoverage_large_dirty.bak` | 0.351s | 0.04s | 0.391s |
| `dirtycoverage_lob_update.bak` | 0.095s | 0.041s | 0.136s |
| `dirtycoverage_maxrow.bak` | 0.065s | 0.033s | 0.098s |
| `dirtycoverage_nchar_delete.bak` | 0.079s | 0.033s | 0.112s |
| `dirtycoverage_nested.bak` | 0.083s | 0.036s | 0.119s |
| `dirtycoverage_null_update.bak` | 0.084s | 0.035s | 0.119s |
| `dirtycoverage_rebuildidx.bak` | 0.068s | 0.036s | 0.104s |
| `dirtycoverage_rich_insert.bak` | 0.096s | 0.037s | 0.133s |
| `dirtycoverage_rich_update.bak` | 0.078s | 0.037s | 0.115s |
| `dirtycoverage_savepoint.bak` | 0.085s | 0.035s | 0.12s |
| `dirtycoverage_snapshot_update.bak` | 0.08s | 0.034s | 0.114s |
| `dirtycoverage_switch.bak` | 0.059s | 0.036s | 0.095s |
| `dirtycoverage_temporal_update.bak` | 0.083s | 0.035s | 0.118s |
| `dirtycoverage_truncate.bak` | 0.057s | 0.037s | 0.094s |
| `dirtycoverage_two_tx.bak` | 0.094s | 0.038s | 0.132s |
| `dirtycoverage_uncommitted.bak` | 0.087s | 0.043s | 0.13s |
| `dirtycoverage_update.bak` | 0.086s | 0.035s | 0.121s |
| `featurecoverage_full.bak` | 0.153s | 0.063s | 0.216s |
| `filtered_ncci_full.bak` | 0.061s | 0.037s | 0.098s |
| `float_extreme_full.bak` | 0.063s | 0.034s | 0.097s |
| `forwarded_records_full.bak` | 0.375s | 0.075s | 0.45s |
| `ghost_records_full.bak` | 0.063s | 0.041s | 0.104s |
| `heapcoverage_large.bak` | 0.064s | 0.04s | 0.104s |
| `heapcoverage_large_50000.bak` | 0.323s | 0.328s | 0.651s |
| `hierarchyid_extract_full.bak` | 0.064s | 0.034s | 0.098s |
| `high_slot_density_full.bak` | 0.083s | 0.197s | 0.28s |
| `identity_coverage_full.bak` | 0.058s | 0.037s | 0.095s |
| `incrementalcoverage_diff_01.bak` | 0.048s | 0.013s | 0.061s |
| `incrementalcoverage_diff_02.bak` | 0.049s | 0.016s | 0.065s |
| `incrementalcoverage_diff_03.bak` | 0.05s | 0.017s | 0.067s |
| `incrementalcoverage_diff_04.bak` | 0.048s | 0.012s | 0.06s |
| `incrementalcoverage_diff_05.bak` | 0.047s | 0.013s | 0.06s |
| `incrementalcoverage_diff_06.bak` | 0.049s | 0.017s | 0.066s |
| `incrementalcoverage_full.bak` | 0.06s | 0.034s | 0.094s |
| `layoutcoverage_full.bak` | 0.231s | 0.364s | 0.595s |
| `max_row_width_full.bak` | 0.06s | 0.04s | 0.1s |
| `mixed_collation_full.bak` | 0.048s | 0.038s | 0.086s |
| `multi_rowgroup_full.bak` | 0.064s | 0.039s | 0.103s |
| `native_json_full.bak` | 0.055s | 0.034s | 0.089s |
| `ncci_heap_full.bak` | 0.063s | 0.035s | 0.098s |
| `ncci_types_full.bak` | 0.127s | 0.186s | 0.313s |
| `ndfcoverage_full.bak` | 0.062s | 0.035s | 0.097s |
| `nvarchar_max_u21_full.bak` | 0.062s | 0.034s | 0.096s |
| `ordered_cci_full.bak` | 0.065s | 0.04s | 0.105s |
| `pagecomp_anchor_full.bak` | 0.167s | 0.101s | 0.268s |
| `pagecomp_long_prefix_full.bak` | 0.061s | 0.043s | 0.104s |
| `pfor_columnstore_full.bak` | 0.148s | 0.826s | 0.974s |
| `pfor_columnstore_random_full.bak` | 0.152s | 0.812s | 0.964s |
| `realworld_numeric_digest_full.bak` | 0.074s | 0.089s | 0.163s |
| `rowboundary_full.bak` | 0.059s | 0.036s | 0.095s |
| `rowstore_hash_pii_full.bak` | 0.053s | 0.034s | 0.087s |
| `rowstore_lob_image_full.bak` | 0.062s | 0.038s | 0.1s |
| `rowstore_lob_markup_full.bak` | 0.055s | 0.034s | 0.089s |
| `rowversion_extract_full.bak` | 0.057s | 0.035s | 0.092s |
| `sparse_full.bak` | 0.107s | 0.09s | 0.197s |
| `spatial_edge_full.bak` | 0.059s | 0.035s | 0.094s |
| `spatial_index_full.bak` | 0.067s | 0.039s | 0.106s |
| `sql_variant_extract_full.bak` | 0.063s | 0.034s | 0.097s |
| `striped_full_1.bak` | 0.056s | 0.014s | 0.07s |
| `striped_single.bak` | 0.088s | 0.05s | 0.138s |
| `surrogate_pairs_full.bak` | 0.058s | 0.033s | 0.091s |
| `tabletype_cci_large_full.bak` | 0.088s | 0.048s | 0.136s |
| `tabletypecoverage_diff.bak` | 0.106s | 0.066s | 0.172s |
| `tabletypecoverage_full.bak` | 0.193s | 0.105s | 0.298s |
| `temporal_hidden_full.bak` | 0.066s | 0.044s | 0.11s |
| `torn_page_full.bak` | 0.061s | 0.034s | 0.095s |
| `typecoverage_full.bak` | 0.126s | 0.072s | 0.198s |
| `typed_xml_full.bak` | 0.057s | 0.034s | 0.091s |
| `unicode_codepage_coverage.bak` | 0.085s | 0.044s | 0.129s |
| `utf8_collation_full.bak` | 0.062s | 0.04s | 0.102s |
| `vector_full.bak` | 0.057s | 0.034s | 0.091s |
| `xml_index_full.bak` | 0.064s | 0.036s | 0.1s |
| `xmlcoverage_full.bak` | 0.057s | 0.035s | 0.092s |
| `xmlheap_full.bak` | 0.119s | 0.054s | 0.173s |
| `xtp_checkpoint_straddle_full.bak` | 1.847s | 0.369s | 2.216s |
| `xtp_probe_full.bak` | 0.139s | 0.039s | 0.178s |
| `xtp_rich_full.bak` | 0.12s | 0.05s | 0.17s |
| `xtp_simple_full.bak` | 0.122s | 0.045s | 0.167s |
