...
|--------|---------|--------|-----------|
| `alias_types_full.bak` | 0.059s | 0.035s | 0.094s |
| `archive_columnstore_partition_full.bak` | 0.993s | 0.623s | 1.616s |
| `archive_columnstore_types_full.bak` | 0.358s | 0.708s | 1.066s |
| `archive_columnstore_types_random_full.bak` | 0.37s | 0.688s | 1.058s |
| `archive_single_chunk_full.bak` | 0.058s | 0.044s | 0.102s |
| `archive_single_chunk_random_full.bak` | 0.061s | 0.039s | 0.1s |
| `archivenull_full.bak` | 0.139s | 0.215s | 0.354s |
| `backup_blocksize_full.bak` | 0.056s | 0.035s | 0.091s |
| `boundarycoverage_datetime_full.bak` | 0.077s | 0.161s | 0.238s |
| `boundarycoverage_full.bak` | 0.078s | 0.073s | 0.151s |
| `cci_binary_varbinary_compare_full.bak` | 0.061s | 0.038s | 0.099s |
| `cci_bitpack_probe_bigint_full.bak` | 1.256s | 3.649s | 4.905s |
| `cci_bitpack_probe_full.bak` | 0.134s | 0.641s | 0.775s |
| `cci_bitpack_probe_highbase_full.bak` | 0.118s | 0.414s | 0.532s |
| `cci_btree_nci_full.bak` | 0.071s | 0.046s | 0.117s |
| `cci_computed_full.bak` | 0.052s | 0.036s | 0.088s |
| `cci_enc5_largepool_full.bak` | 0.387s | 0.431s | 0.818s |
| `cci_enc5_largepool_matrix_full.bak` | 7.125s | 1.24s | 8.365s |
| `cci_extended_full.bak` | 0.081s | 0.047s | 0.128s |
| `cci_lob_full.bak` | 0.064s | 0.047s | 0.111s |
| `cci_reorganize_full.bak` | 0.056s | 0.037s | 0.093s |
| `cci_string_dict_regression_full.bak` | 0.345s | 0.145s | 0.49s |
| `cci_string_minmax_full.bak` | 0.061s | 0.043s | 0.104s |
| `cci_switch_full.bak` | 0.057s | 0.037s | 0.094s |
| `cci_types_large_full.bak` | 0.077s | 0.049s | 0.126s |
| `cci_varbinary_micro_full.bak` | 0.062s | 0.037s | 0.099s |
| `cci_varbinary_probe_full.bak` | 0.077s | 0.051s | 0.128s |
| `columnstore_minimal.bak` | 0.125s | 0.879s | 1.004s |
| `compressed_nvarchar_full.bak` | 0.051s | 0.036s | 0.087s |
| `compressioncoverage_full.bak` | 0.099s | 0.205s | 0.304s |
| `computedcoverage_full.bak` | 0.053s | 0.037s | 0.09s |
| `constraintcoverage_full.bak` | 0.063s | 0.04s | 0.103s |
| `covering_index_full.bak` | 0.054s | 0.039s | 0.093s |
| `cs_lob_preamble.bak` | 0.11s | 0.058s | 0.168s |
| `delta_rowgroup_full.bak` | 0.055s | 0.036s | 0.091s |
| `dirtycoverage_aborted_xact.bak` | 0.077s | 0.037s | 0.114s |
| `dirtycoverage_addcol.bak` | 0.058s | 0.036s | 0.094s |
| `dirtycoverage_addnotnull.bak` | 0.056s | 0.036s | 0.092s |
| `dirtycoverage_alldirty.bak` | 0.089s | 0.034s | 0.123s |
| `dirtycoverage_altercol.bak` | 0.053s | 0.036s | 0.089s |
| `dirtycoverage_altercol_rewrite.bak` | 0.054s | 0.035s | 0.089s |
| `dirtycoverage_alterdb.bak` | 0.054s | 0.036s | 0.09s |
| `dirtycoverage_cci_delete.bak` | 0.101s | 0.094s | 0.195s |
| `dirtycoverage_cci_update.bak` | 0.117s | 0.091s | 0.208s |
| `dirtycoverage_committed_delete.bak` | 0.061s | 0.035s | 0.096s |
| `dirtycoverage_committed_delete_v2.bak` | 0.052s | 0.042s | 0.094s |
| `dirtycoverage_committed_delete_v3.bak` | 0.063s | 0.064s | 0.127s |
| `dirtycoverage_committed_delete_v4.bak` | 0.167s | 0.074s | 0.241s |
| `dirtycoverage_committed_update.bak` | 0.061s | 0.035s | 0.096s |
| `dirtycoverage_committed_update_v2.bak` | 0.073s | 0.039s | 0.112s |
| `dirtycoverage_committed_update_v3.bak` | 0.082s | 0.07s | 0.152s |
| `dirtycoverage_committed_update_v4.bak` | 0.073s | 0.079s | 0.152s |
| `dirtycoverage_concurrent.bak` | 0.059s | 0.035s | 0.094s |
| `dirtycoverage_createidx.bak` | 0.06s | 0.041s | 0.101s |
| `dirtycoverage_createtable.bak` | 0.053s | 0.036s | 0.089s |
| `dirtycoverage_delete.bak` | 0.085s | 0.04s | 0.125s |
| `dirtycoverage_dropcol.bak` | 0.066s | 0.034s | 0.1s |
| `dirtycoverage_dropidx.bak` | 0.053s | 0.036s | 0.089s |
| `dirtycoverage_droptable.bak` | 0.055s | 0.041s | 0.096s |
| `dirtycoverage_heap_forward.bak` | 0.075s | 0.035s | 0.11s |
| `dirtycoverage_large_dirty.bak` | 0.348s | 0.039s | 0.387s |
| `dirtycoverage_lob_update.bak` | 0.103s | 0.035s | 0.138s |
| `dirtycoverage_maxrow.bak` | 0.056s | 0.034s | 0.09s |
| `dirtycoverage_nchar_delete.bak` | 0.08s | 0.034s | 0.114s |
| `dirtycoverage_nested.bak` | 0.085s | 0.037s | 0.122s |
| `dirtycoverage_null_update.bak` | 0.082s | 0.039s | 0.121s |
| `dirtycoverage_rebuildidx.bak` | 0.054s | 0.04s | 0.094s |
| `dirtycoverage_rich_insert.bak` | 0.102s | 0.039s | 0.141s |
| `dirtycoverage_rich_update.bak` | 0.082s | 0.037s | 0.119s |
| `dirtycoverage_savepoint.bak` | 0.086s | 0.037s | 0.123s |
| `dirtycoverage_snapshot_update.bak` | 0.074s | 0.036s | 0.11s |
| `dirtycoverage_switch.bak` | 0.056s | 0.035s | 0.091s |
| `dirtycoverage_temporal_update.bak` | 0.083s | 0.035s | 0.118s |
| `dirtycoverage_truncate.bak` | 0.059s | 0.037s | 0.096s |
| `dirtycoverage_two_tx.bak` | 0.092s | 0.036s | 0.128s |
| `dirtycoverage_uncommitted.bak` | 0.091s | 0.036s | 0.127s |
| `dirtycoverage_update.bak` | 0.085s | 0.034s | 0.119s |
| `featurecoverage_full.bak` | 0.154s | 0.055s | 0.209s |
| `filtered_ncci_full.bak` | 0.054s | 0.038s | 0.092s |
| `float_extreme_full.bak` | 0.052s | 0.034s | 0.086s |
| `forwarded_records_full.bak` | 0.366s | 0.075s | 0.441s |
| `ghost_records_full.bak` | 0.063s | 0.037s | 0.1s |
| `heapcoverage_large.bak` | 0.053s | 0.042s | 0.095s |
| `heapcoverage_large_50000.bak` | 0.295s | 0.317s | 0.612s |
| `hierarchyid_extract_full.bak` | 0.059s | 0.035s | 0.094s |
| `high_slot_density_full.bak` | 0.079s | 0.209s | 0.288s |
| `identity_coverage_full.bak` | 0.06s | 0.037s | 0.097s |
| `incrementalcoverage_diff_01.bak` | 0.06s | 0.012s | 0.072s |
| `incrementalcoverage_diff_02.bak` | 0.049s | 0.013s | 0.062s |
| `incrementalcoverage_diff_03.bak` | 0.05s | 0.013s | 0.063s |
| `incrementalcoverage_diff_04.bak` | 0.054s | 0.012s | 0.066s |
| `incrementalcoverage_diff_05.bak` | 0.049s | 0.015s | 0.064s |
| `incrementalcoverage_diff_06.bak` | 0.05s | 0.013s | 0.063s |
| `incrementalcoverage_full.bak` | 0.051s | 0.036s | 0.087s |
| `layoutcoverage_full.bak` | 0.232s | 0.328s | 0.56s |
| `max_row_width_full.bak` | 0.053s | 0.035s | 0.088s |
| `mixed_collation_full.bak` | 0.046s | 0.034s | 0.08s |
| `multi_rowgroup_full.bak` | 0.055s | 0.039s | 0.094s |
| `native_json_full.bak` | 0.052s | 0.045s | 0.097s |
| `ncci_heap_full.bak` | 0.06s | 0.047s | 0.107s |
| `ncci_types_full.bak` | 0.118s | 0.203s | 0.321s |
| `ndfcoverage_full.bak` | 0.067s | 0.039s | 0.106s |
| `nvarchar_max_u21_full.bak` | 0.056s | 0.032s | 0.088s |
| `ordered_cci_full.bak` | 0.056s | 0.04s | 0.096s |
| `pagecomp_anchor_full.bak` | 0.145s | 0.097s | 0.242s |
| `pagecomp_long_prefix_full.bak` | 0.062s | 0.034s | 0.096s |
| `pfor_columnstore_full.bak` | 0.145s | 0.821s | 0.966s |
| `pfor_columnstore_random_full.bak` | 0.153s | 0.835s | 0.988s |
| `realworld_numeric_digest_full.bak` | 0.075s | 0.081s | 0.156s |
| `rowboundary_full.bak` | 0.057s | 0.041s | 0.098s |
| `rowstore_hash_pii_full.bak` | 0.049s | 0.034s | 0.083s |
| `rowstore_lob_image_full.bak` | 0.065s | 0.036s | 0.101s |
| `rowstore_lob_markup_full.bak` | 0.059s | 0.036s | 0.095s |
| `rowversion_extract_full.bak` | 0.056s | 0.035s | 0.091s |
| `sparse_full.bak` | 0.103s | 0.088s | 0.191s |
| `spatial_edge_full.bak` | 0.06s | 0.037s | 0.097s |
| `spatial_index_full.bak` | 0.064s | 0.037s | 0.101s |
| `sql_variant_extract_full.bak` | 0.053s | 0.035s | 0.088s |
| `striped_full_1.bak` | 0.055s | 0.013s | 0.068s |
| `striped_single.bak` | 0.088s | 0.052s | 0.14s |
| `surrogate_pairs_full.bak` | 0.061s | 0.035s | 0.096s |
| `tabletype_cci_large_full.bak` | 0.08s | 0.047s | 0.127s |
| `tabletypecoverage_diff.bak` | 0.103s | 0.074s | 0.177s |
| `tabletypecoverage_full.bak` | 0.181s | 0.14s | 0.321s |
| `temporal_hidden_full.bak` | 0.058s | 0.037s | 0.095s |
| `torn_page_full.bak` | 0.054s | 0.034s | 0.088s |
| `typecoverage_full.bak` | 0.123s | 0.071s | 0.194s |
| `typed_xml_full.bak` | 0.059s | 0.035s | 0.094s |
| `unicode_codepage_coverage.bak` | 0.092s | 0.049s | 0.141s |
| `utf8_collation_full.bak` | 0.054s | 0.035s | 0.089s |
| `vector_full.bak` | 0.057s | 0.036s | 0.093s |
| `xml_index_full.bak` | 0.065s | 0.037s | 0.102s |
| `xmlcoverage_full.bak` | 0.048s | 0.04s | 0.088s |
| `xmlheap_full.bak` | 0.112s | 0.054s | 0.166s |
| `xtp_checkpoint_straddle_full.bak` | 1.846s | 0.371s | 2.217s |
| `xtp_probe_full.bak` | 0.143s | 0.04s | 0.183s |
| `xtp_rich_full.bak` | 0.135s | 0.046s | 0.181s |
| `xtp_simple_full.bak` | 0.126s | 0.041s | 0.167s |
...
_Generated 2026-07-11 · 138 fixtures · 138 pass · 0 xfail · 0 fail_
