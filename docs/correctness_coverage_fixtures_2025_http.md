...
| Backup | Wall time |
|--------|-------------|
| `alias_types_full.bak` | 0.133s |
| `archive_columnstore_partition_full.bak` | 2.478s |
| `archive_columnstore_types_full.bak` | 1.378s |
| `archive_columnstore_types_random_full.bak` | 1.377s |
| `archive_single_chunk_full.bak` | 0.239s |
| `archive_single_chunk_random_full.bak` | 0.234s |
| `archivenull_full.bak` | 0.472s |
| `backup_blocksize_full.bak` | 0.227s |
| `boundarycoverage_datetime_full.bak` | 0.377s |
| `boundarycoverage_full.bak` | 0.232s |
| `cci_binary_varbinary_compare_full.bak` | 0.217s |
| `cci_bitpack_probe_bigint_full.bak` | 8.685s |
| `cci_bitpack_probe_full.bak` | 1.814s |
| `cci_bitpack_probe_highbase_full.bak` | 1.301s |
| `cci_btree_nci_full.bak` | 0.241s |
| `cci_computed_full.bak` | 0.207s |
| `cci_enc5_largepool_full.bak` | 1.185s |
| `cci_enc5_largepool_matrix_full.bak` | 9.681s |
| `cci_extended_full.bak` | 0.192s |
| `cci_lob_full.bak` | 0.319s |
| `cci_reorganize_full.bak` | 0.202s |
| `cci_string_dict_regression_full.bak` | 0.546s |
| `cci_string_minmax_full.bak` | 0.236s |
| `cci_switch_full.bak` | 0.195s |
| `cci_types_large_full.bak` | 0.209s |
| `cci_varbinary_micro_full.bak` | 0.16s |
| `cci_varbinary_probe_full.bak` | 0.249s |
| `columnstore_minimal.bak` | 1.103s |
| `compressed_nvarchar_full.bak` | 0.128s |
| `compressioncoverage_full.bak` | 0.366s |
| `computedcoverage_full.bak` | 0.213s |
| `constraintcoverage_full.bak` | 0.215s |
| `covering_index_full.bak` | 0.185s |
| `cs_lob_preamble.bak` | 0.343s |
| `delta_rowgroup_full.bak` | 0.173s |
| `dirtycoverage_aborted_xact.bak` | 0.243s |
| `dirtycoverage_addcol.bak` | 0.157s |
| `dirtycoverage_addnotnull.bak` | 0.155s |
| `dirtycoverage_alldirty.bak` | 0.179s |
| `dirtycoverage_altercol.bak` | 0.137s |
| `dirtycoverage_altercol_rewrite.bak` | 0.148s |
| `dirtycoverage_alterdb.bak` | 0.126s |
| `dirtycoverage_cci_delete.bak` | 0.235s |
| `dirtycoverage_cci_update.bak` | 0.261s |
| `dirtycoverage_committed_delete.bak` | 0.156s |
| `dirtycoverage_committed_delete_v2.bak` | 0.258s |
| `dirtycoverage_committed_delete_v3.bak` | 0.237s |
| `dirtycoverage_committed_delete_v4.bak` | 0.385s |
| `dirtycoverage_committed_update.bak` | 0.125s |
| `dirtycoverage_committed_update_v2.bak` | 0.189s |
| `dirtycoverage_committed_update_v3.bak` | 0.333s |
| `dirtycoverage_committed_update_v4.bak` | 0.321s |
| `dirtycoverage_concurrent.bak` | 0.14s |
| `dirtycoverage_createidx.bak` | 0.503s |
| `dirtycoverage_createtable.bak` | 0.157s |
| `dirtycoverage_delete.bak` | 0.198s |
| `dirtycoverage_dropcol.bak` | 0.121s |
| `dirtycoverage_dropidx.bak` | 0.126s |
| `dirtycoverage_droptable.bak` | 0.162s |
| `dirtycoverage_heap_forward.bak` | 0.16s |
| `dirtycoverage_large_dirty.bak` | 0.409s |
| `dirtycoverage_lob_update.bak` | 0.24s |
| `dirtycoverage_maxrow.bak` | 0.138s |
| `dirtycoverage_nchar_delete.bak` | 0.214s |
| `dirtycoverage_nested.bak` | 0.189s |
| `dirtycoverage_null_update.bak` | 0.314s |
| `dirtycoverage_rebuildidx.bak` | 0.166s |
| `dirtycoverage_rich_insert.bak` | 0.181s |
| `dirtycoverage_rich_update.bak` | 0.177s |
| `dirtycoverage_savepoint.bak` | 0.259s |
| `dirtycoverage_snapshot_update.bak` | 0.15s |
| `dirtycoverage_switch.bak` | 0.318s |
| `dirtycoverage_temporal_update.bak` | 0.149s |
| `dirtycoverage_truncate.bak` | 0.249s |
| `dirtycoverage_two_tx.bak` | 0.185s |
| `dirtycoverage_uncommitted.bak` | 0.202s |
| `dirtycoverage_update.bak` | 0.243s |
| `featurecoverage_full.bak` | 0.298s |
| `filtered_ncci_full.bak` | 0.284s |
| `float_extreme_full.bak` | 0.26s |
| `forwarded_records_full.bak` | 0.258s |
| `ghost_records_full.bak` | 0.146s |
| `heapcoverage_large.bak` | 0.171s |
| `heapcoverage_large_50000.bak` | 1.007s |
| `hierarchyid_extract_full.bak` | 0.176s |
| `high_slot_density_full.bak` | 0.574s |
| `incrementalcoverage_diff_01.bak` | 0.13s |
| `incrementalcoverage_diff_02.bak` | 0.145s |
| `incrementalcoverage_diff_03.bak` | 0.143s |
| `incrementalcoverage_diff_04.bak` | 0.178s |
| `incrementalcoverage_diff_05.bak` | 0.127s |
| `incrementalcoverage_diff_06.bak` | 0.141s |
| `incrementalcoverage_full.bak` | 0.109s |
| `layoutcoverage_full.bak` | 0.447s |
| `max_row_width_full.bak` | 0.131s |
| `mixed_collation_full.bak` | 0.219s |
| `multi_rowgroup_full.bak` | 0.149s |
| `native_json_full.bak` | 0.122s |
| `ncci_heap_full.bak` | 0.165s |
| `ncci_types_full.bak` | 0.497s |
| `ndfcoverage_full.bak` | 0.186s |
| `nvarchar_max_u21_full.bak` | 0.126s |
| `ordered_cci_full.bak` | 0.19s |
| `pagecomp_anchor_full.bak` | 0.392s |
| `pagecomp_long_prefix_full.bak` | 0.172s |
| `pfor_columnstore_full.bak` | 2.538s |
| `pfor_columnstore_random_full.bak` | 2.329s |
| `realworld_numeric_digest_full.bak` | 0.318s |
| `rowboundary_full.bak` | 0.148s |
| `rowstore_hash_pii_full.bak` | 0.132s |
| `rowstore_lob_image_full.bak` | 0.189s |
| `rowstore_lob_markup_full.bak` | 0.113s |
| `rowversion_extract_full.bak` | 0.152s |
| `sparse_full.bak` | 0.352s |
| `spatial_edge_full.bak` | 0.367s |
| `spatial_index_full.bak` | 0.154s |
| `sql_variant_extract_full.bak` | 0.155s |
| `striped_full_1.bak` | 0.155s |
| `striped_single.bak` | 0.164s |
| `surrogate_pairs_full.bak` | 0.127s |
| `tabletype_cci_large_full.bak` | 0.172s |
| `tabletypecoverage_diff.bak` | 21.357s |
| `tabletypecoverage_full.bak` | 18.569s |
| `temporal_hidden_full.bak` | 0.136s |
| `torn_page_full.bak` | 0.198s |
| `typecoverage_full.bak` | 0.414s |
| `typed_xml_full.bak` | 0.13s |
| `unicode_codepage_coverage.bak` | 0.271s |
| `utf8_collation_full.bak` | 0.348s |
| `vector_full.bak` | 0.153s |
| `xml_index_full.bak` | 0.131s |
| `xmlcoverage_full.bak` | 0.137s |
| `xmlheap_full.bak` | 0.336s |
| `xtp_checkpoint_straddle_full.bak` | 3.595s |
| `xtp_probe_full.bak` | 0.355s |
| `xtp_rich_full.bak` | 0.209s |
| `xtp_simple_full.bak` | 0.208s |

---

_Generated 2026-07-09 · 137 fixtures · 137 pass · 0 xfail · 0 fail_
