...
|--------|---------|--------|-----------|
| `alias_types_full.bak` | 0.069s | 0.055s | 0.124s |
| `archive_columnstore_partition_full.bak` | 1.031s | 0.912s | 1.943s |
| `archive_columnstore_types_full.bak` | 0.365s | 0.671s | 1.036s |
| `archive_columnstore_types_random_full.bak` | 0.378s | 0.731s | 1.109s |
| `archive_single_chunk_full.bak` | 0.063s | 0.046s | 0.109s |
| `archive_single_chunk_random_full.bak` | 0.064s | 0.042s | 0.106s |
| `archivenull_full.bak` | 0.149s | 0.228s | 0.377s |
| `backup_blocksize_full.bak` | 0.057s | 0.049s | 0.106s |
| `boundarycoverage_datetime_full.bak` | 0.16s | 0.31s | 0.47s |
| `boundarycoverage_full.bak` | 0.073s | 0.13s | 0.203s |
| `cci_binary_varbinary_compare_full.bak` | 0.068s | 0.051s | 0.119s |
| `cci_bitpack_probe_bigint_full.bak` | 1.32s | 4.293s | 5.613s |
| `cci_bitpack_probe_full.bak` | 0.145s | 0.858s | 1.003s |
| `cci_bitpack_probe_highbase_full.bak` | 0.186s | 0.743s | 0.929s |
| `cci_btree_nci_full.bak` | 0.082s | 0.066s | 0.148s |
| `cci_computed_full.bak` | 0.055s | 0.052s | 0.107s |
| `cci_enc5_largepool_full.bak` | 0.448s | 0.741s | 1.189s |
| `cci_enc5_largepool_matrix_full.bak` | 8.253s | 1.819s | 10.072s |
| `cci_extended_full.bak` | 0.107s | 0.055s | 0.162s |
| `cci_lob_full.bak` | 0.079s | 0.066s | 0.145s |
| `cci_reorganize_full.bak` | 0.06s | 0.053s | 0.113s |
| `cci_string_dict_regression_full.bak` | 0.402s | 0.232s | 0.634s |
| `cci_string_minmax_full.bak` | 0.064s | 0.045s | 0.109s |
| `cci_switch_full.bak` | 0.06s | 0.044s | 0.104s |
| `cci_types_large_full.bak` | 0.078s | 0.06s | 0.138s |
| `cci_varbinary_micro_full.bak` | 0.077s | 0.047s | 0.124s |
| `cci_varbinary_probe_full.bak` | 0.088s | 0.055s | 0.143s |
| `columnstore_minimal.bak` | 0.201s | 1.386s | 1.587s |
| `compressed_nvarchar_full.bak` | 0.058s | 0.048s | 0.106s |
| `compressioncoverage_full.bak` | 0.112s | 0.301s | 0.413s |
| `computedcoverage_full.bak` | 0.062s | 0.05s | 0.112s |
| `constraintcoverage_full.bak` | 0.065s | 0.045s | 0.11s |
| `covering_index_full.bak` | 0.131s | 0.087s | 0.218s |
| `cs_lob_preamble.bak` | 0.115s | 0.069s | 0.184s |
| `delta_rowgroup_full.bak` | 0.062s | 0.065s | 0.127s |
| `dirtycoverage_aborted_xact.bak` | 0.109s | 0.05s | 0.159s |
| `dirtycoverage_addcol.bak` | 0.067s | 0.041s | 0.108s |
| `dirtycoverage_addnotnull.bak` | 0.067s | 0.042s | 0.109s |
| `dirtycoverage_alldirty.bak` | 0.177s | 0.062s | 0.239s |
| `dirtycoverage_altercol.bak` | 0.059s | 0.064s | 0.123s |
| `dirtycoverage_altercol_rewrite.bak` | 0.06s | 0.047s | 0.107s |
| `dirtycoverage_alterdb.bak` | 0.071s | 0.059s | 0.13s |
| `dirtycoverage_cci_delete.bak` | 0.112s | 0.131s | 0.243s |
| `dirtycoverage_cci_update.bak` | 0.131s | 0.118s | 0.249s |
| `dirtycoverage_committed_delete.bak` | 0.057s | 0.047s | 0.104s |
| `dirtycoverage_committed_delete_v2.bak` | 0.058s | 0.048s | 0.106s |
| `dirtycoverage_committed_delete_v3.bak` | 0.071s | 0.082s | 0.153s |
| `dirtycoverage_committed_delete_v4.bak` | 0.184s | 0.261s | 0.445s |
| `dirtycoverage_committed_update.bak` | 0.055s | 0.047s | 0.102s |
| `dirtycoverage_committed_update_v2.bak` | 0.069s | 0.048s | 0.117s |
| `dirtycoverage_committed_update_v3.bak` | 0.076s | 0.099s | 0.175s |
| `dirtycoverage_committed_update_v4.bak` | 0.086s | 0.163s | 0.249s |
| `dirtycoverage_concurrent.bak` | 0.072s | 0.057s | 0.129s |
| `dirtycoverage_createidx.bak` | 0.065s | 0.048s | 0.113s |
| `dirtycoverage_createtable.bak` | 0.07s | 0.056s | 0.126s |
| `dirtycoverage_delete.bak` | 0.087s | 0.043s | 0.13s |
| `dirtycoverage_dropcol.bak` | 0.057s | 0.06s | 0.117s |
| `dirtycoverage_dropidx.bak` | 0.06s | 0.054s | 0.114s |
| `dirtycoverage_droptable.bak` | 0.06s | 0.049s | 0.109s |
| `dirtycoverage_heap_forward.bak` | 0.084s | 0.043s | 0.127s |
| `dirtycoverage_large_dirty.bak` | 0.419s | 0.042s | 0.461s |
| `dirtycoverage_lob_update.bak` | 0.112s | 0.046s | 0.158s |
| `dirtycoverage_maxrow.bak` | 0.058s | 0.045s | 0.103s |
| `dirtycoverage_nchar_delete.bak` | 0.13s | 0.072s | 0.202s |
| `dirtycoverage_nested.bak` | 0.115s | 0.053s | 0.168s |
| `dirtycoverage_null_update.bak` | 0.087s | 0.042s | 0.129s |
| `dirtycoverage_rebuildidx.bak` | 0.062s | 0.05s | 0.112s |
| `dirtycoverage_rich_insert.bak` | 0.105s | 0.05s | 0.155s |
| `dirtycoverage_rich_update.bak` | 0.09s | 0.069s | 0.159s |
| `dirtycoverage_savepoint.bak` | 0.094s | 0.049s | 0.143s |
| `dirtycoverage_snapshot_update.bak` | 0.087s | 0.049s | 0.136s |
| `dirtycoverage_switch.bak` | 0.061s | 0.05s | 0.111s |
| `dirtycoverage_temporal_update.bak` | 0.157s | 0.077s | 0.234s |
| `dirtycoverage_truncate.bak` | 0.058s | 0.043s | 0.101s |
| `dirtycoverage_two_tx.bak` | 0.113s | 0.047s | 0.16s |
| `dirtycoverage_uncommitted.bak` | 0.118s | 0.041s | 0.159s |
| `dirtycoverage_update.bak` | 0.096s | 0.046s | 0.142s |
| `featurecoverage_full.bak` | 0.149s | 0.074s | 0.223s |
| `filtered_ncci_full.bak` | 0.06s | 0.054s | 0.114s |
| `float_extreme_full.bak` | 0.061s | 0.041s | 0.102s |
| `forwarded_records_full.bak` | 0.481s | 0.113s | 0.594s |
| `ghost_records_full.bak` | 0.056s | 0.047s | 0.103s |
| `heapcoverage_large.bak` | 0.127s | 0.099s | 0.226s |
| `heapcoverage_large_50000.bak` | 0.455s | 0.687s | 1.142s |
| `hierarchyid_extract_full.bak` | 0.052s | 0.057s | 0.109s |
| `high_slot_density_full.bak` | 0.085s | 0.337s | 0.422s |
| `incrementalcoverage_diff_01.bak` | 0.062s | 0.022s | 0.084s |
| `incrementalcoverage_diff_02.bak` | 0.049s | 0.02s | 0.069s |
| `incrementalcoverage_diff_03.bak` | 0.059s | 0.021s | 0.08s |
| `incrementalcoverage_diff_04.bak` | 0.058s | 0.016s | 0.074s |
| `incrementalcoverage_diff_05.bak` | 0.057s | 0.018s | 0.075s |
| `incrementalcoverage_diff_06.bak` | 0.059s | 0.026s | 0.085s |
| `incrementalcoverage_full.bak` | 0.057s | 0.043s | 0.1s |
| `layoutcoverage_full.bak` | 0.226s | 0.248s | 0.474s |
| `max_row_width_full.bak` | 0.066s | 0.047s | 0.113s |
| `mixed_collation_full.bak` | 0.058s | 0.039s | 0.097s |
| `multi_rowgroup_full.bak` | 0.059s | 0.047s | 0.106s |
| `native_json_full.bak` | 0.061s | 0.047s | 0.108s |
| `ncci_heap_full.bak` | 0.059s | 0.045s | 0.104s |
| `ncci_types_full.bak` | 0.149s | 0.338s | 0.487s |
| `ndfcoverage_full.bak` | 0.058s | 0.045s | 0.103s |
| `nvarchar_max_u21_full.bak` | 0.059s | 0.043s | 0.102s |
| `ordered_cci_full.bak` | 0.057s | 0.048s | 0.105s |
| `pagecomp_anchor_full.bak` | 0.17s | 0.169s | 0.339s |
| `pagecomp_long_prefix_full.bak` | 0.056s | 0.044s | 0.1s |
| `pfor_columnstore_full.bak` | 0.218s | 1.377s | 1.595s |
| `pfor_columnstore_random_full.bak` | 0.231s | 1.422s | 1.653s |
| `realworld_numeric_digest_full.bak` | 0.068s | 0.135s | 0.203s |
| `rowboundary_full.bak` | 0.066s | 0.049s | 0.115s |
| `rowstore_hash_pii_full.bak` | 0.062s | 0.067s | 0.129s |
| `rowstore_lob_image_full.bak` | 0.057s | 0.042s | 0.099s |
| `rowstore_lob_markup_full.bak` | 0.057s | 0.046s | 0.103s |
| `rowversion_extract_full.bak` | 0.059s | 0.052s | 0.111s |
| `sparse_full.bak` | 0.144s | 0.219s | 0.363s |
| `spatial_edge_full.bak` | 0.055s | 0.044s | 0.099s |
| `spatial_index_full.bak` | 0.085s | 0.05s | 0.135s |
| `sql_variant_extract_full.bak` | 0.058s | 0.043s | 0.101s |
| `striped_full_1.bak` | 0.066s | 0.025s | 0.091s |
| `striped_single.bak` | 0.103s | 0.061s | 0.164s |
| `surrogate_pairs_full.bak` | 0.059s | 0.063s | 0.122s |
| `tabletype_cci_large_full.bak` | 0.098s | 0.068s | 0.166s |
| `tabletypecoverage_diff.bak` | 0.157s | 0.121s | 0.278s |
| `tabletypecoverage_full.bak` | 0.234s | 0.158s | 0.392s |
| `temporal_hidden_full.bak` | 0.063s | 0.056s | 0.119s |
| `torn_page_full.bak` | 0.055s | 0.037s | 0.092s |
| `typecoverage_full.bak` | 0.159s | 0.096s | 0.255s |
| `typed_xml_full.bak` | 0.059s | 0.045s | 0.104s |
| `unicode_codepage_coverage.bak` | 0.101s | 0.063s | 0.164s |
| `utf8_collation_full.bak` | 0.055s | 0.045s | 0.1s |
| `vector_full.bak` | 0.066s | 0.059s | 0.125s |
| `xml_index_full.bak` | 0.07s | 0.046s | 0.116s |
| `xmlcoverage_full.bak` | 0.052s | 0.061s | 0.113s |
| `xmlheap_full.bak` | 0.208s | 0.1s | 0.308s |
| `xtp_checkpoint_straddle_full.bak` | 1.882s | 0.513s | 2.395s |
| `xtp_probe_full.bak` | 0.243s | 0.062s | 0.305s |
| `xtp_rich_full.bak` | 0.136s | 0.094s | 0.23s |
| `xtp_simple_full.bak` | 0.128s | 0.063s | 0.191s |
