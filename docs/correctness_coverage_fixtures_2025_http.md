...
|--------|---------|--------|-----------|
| `alias_types_full.bak` | 0.06s | 0.04s | 0.1s |
| `archive_columnstore_partition_full.bak` | 1.018s | 0.633s | 1.651s |
| `archive_columnstore_types_full.bak` | 0.371s | 0.739s | 1.11s |
| `archive_columnstore_types_random_full.bak` | 0.397s | 0.698s | 1.095s |
| `archive_single_chunk_full.bak` | 0.106s | 0.07s | 0.176s |
| `archive_single_chunk_random_full.bak` | 0.066s | 0.04s | 0.106s |
| `archivenull_full.bak` | 0.144s | 0.214s | 0.358s |
| `backup_blocksize_full.bak` | 0.056s | 0.036s | 0.092s |
| `boundarycoverage_datetime_full.bak` | 0.08s | 0.145s | 0.225s |
| `boundarycoverage_full.bak` | 0.079s | 0.073s | 0.152s |
| `cci_binary_varbinary_compare_full.bak` | 0.06s | 0.047s | 0.107s |
| `cci_bitpack_probe_bigint_full.bak` | 1.308s | 3.808s | 5.116s |
| `cci_bitpack_probe_full.bak` | 0.14s | 0.659s | 0.799s |
| `cci_bitpack_probe_highbase_full.bak` | 0.124s | 0.431s | 0.555s |
| `cci_btree_nci_full.bak` | 0.077s | 0.043s | 0.12s |
| `cci_computed_full.bak` | 0.055s | 0.049s | 0.104s |
| `cci_enc5_largepool_full.bak` | 0.387s | 0.449s | 0.836s |
| `cci_enc5_largepool_matrix_full.bak` | 7.219s | 1.288s | 8.507s |
| `cci_extended_full.bak` | 0.072s | 0.045s | 0.117s |
| `cci_lob_full.bak` | 0.065s | 0.044s | 0.109s |
| `cci_reorganize_full.bak` | 0.06s | 0.043s | 0.103s |
| `cci_string_dict_regression_full.bak` | 0.351s | 0.144s | 0.495s |
| `cci_string_minmax_full.bak` | 0.073s | 0.049s | 0.122s |
| `cci_switch_full.bak` | 0.059s | 0.039s | 0.098s |
| `cci_types_large_full.bak` | 0.087s | 0.046s | 0.133s |
| `cci_varbinary_micro_full.bak` | 0.064s | 0.037s | 0.101s |
| `cci_varbinary_probe_full.bak` | 0.083s | 0.055s | 0.138s |
| `columnstore_minimal.bak` | 0.142s | 0.883s | 1.025s |
| `compressed_nvarchar_full.bak` | 0.052s | 0.034s | 0.086s |
| `compressioncoverage_full.bak` | 0.11s | 0.189s | 0.299s |
| `computedcoverage_full.bak` | 0.056s | 0.037s | 0.093s |
| `constraintcoverage_full.bak` | 0.071s | 0.047s | 0.118s |
| `covering_index_full.bak` | 0.062s | 0.044s | 0.106s |
| `cs_lob_preamble.bak` | 0.111s | 0.059s | 0.17s |
| `delta_rowgroup_full.bak` | 0.059s | 0.052s | 0.111s |
| `dirtycoverage_aborted_xact.bak` | 0.077s | 0.036s | 0.113s |
| `dirtycoverage_addcol.bak` | 0.054s | 0.035s | 0.089s |
| `dirtycoverage_addnotnull.bak` | 0.056s | 0.039s | 0.095s |
| `dirtycoverage_alldirty.bak` | 0.083s | 0.037s | 0.12s |
| `dirtycoverage_altercol.bak` | 0.053s | 0.035s | 0.088s |
| `dirtycoverage_altercol_rewrite.bak` | 0.055s | 0.037s | 0.092s |
| `dirtycoverage_alterdb.bak` | 0.062s | 0.036s | 0.098s |
| `dirtycoverage_cci_delete.bak` | 0.09s | 0.097s | 0.187s |
| `dirtycoverage_cci_update.bak` | 0.125s | 0.093s | 0.218s |
| `dirtycoverage_committed_delete.bak` | 0.051s | 0.035s | 0.086s |
| `dirtycoverage_committed_delete_v2.bak` | 0.057s | 0.038s | 0.095s |
| `dirtycoverage_committed_delete_v3.bak` | 0.064s | 0.06s | 0.124s |
| `dirtycoverage_committed_delete_v4.bak` | 0.169s | 0.073s | 0.242s |
| `dirtycoverage_committed_update.bak` | 0.051s | 0.035s | 0.086s |
| `dirtycoverage_committed_update_v2.bak` | 0.119s | 0.071s | 0.19s |
| `dirtycoverage_committed_update_v3.bak` | 0.066s | 0.075s | 0.141s |
| `dirtycoverage_committed_update_v4.bak` | 0.075s | 0.074s | 0.149s |
| `dirtycoverage_concurrent.bak` | 0.069s | 0.038s | 0.107s |
| `dirtycoverage_createidx.bak` | 0.066s | 0.039s | 0.105s |
| `dirtycoverage_createtable.bak` | 0.055s | 0.044s | 0.099s |
| `dirtycoverage_delete.bak` | 0.085s | 0.034s | 0.119s |
| `dirtycoverage_dropcol.bak` | 0.052s | 0.035s | 0.087s |
| `dirtycoverage_dropidx.bak` | 0.058s | 0.038s | 0.096s |
| `dirtycoverage_droptable.bak` | 0.059s | 0.036s | 0.095s |
| `dirtycoverage_heap_forward.bak` | 0.078s | 0.039s | 0.117s |
| `dirtycoverage_large_dirty.bak` | 0.368s | 0.04s | 0.408s |
| `dirtycoverage_lob_update.bak` | 0.1s | 0.035s | 0.135s |
| `dirtycoverage_maxrow.bak` | 0.057s | 0.036s | 0.093s |
| `dirtycoverage_nchar_delete.bak` | 0.083s | 0.039s | 0.122s |
| `dirtycoverage_nested.bak` | 0.093s | 0.037s | 0.13s |
| `dirtycoverage_null_update.bak` | 0.085s | 0.033s | 0.118s |
| `dirtycoverage_rebuildidx.bak` | 0.056s | 0.051s | 0.107s |
| `dirtycoverage_rich_insert.bak` | 0.117s | 0.041s | 0.158s |
| `dirtycoverage_rich_update.bak` | 0.079s | 0.035s | 0.114s |
| `dirtycoverage_savepoint.bak` | 0.094s | 0.05s | 0.144s |
| `dirtycoverage_snapshot_update.bak` | 0.076s | 0.035s | 0.111s |
| `dirtycoverage_switch.bak` | 0.063s | 0.038s | 0.101s |
| `dirtycoverage_temporal_update.bak` | 0.091s | 0.035s | 0.126s |
| `dirtycoverage_truncate.bak` | 0.056s | 0.037s | 0.093s |
| `dirtycoverage_two_tx.bak` | 0.092s | 0.042s | 0.134s |
| `dirtycoverage_uncommitted.bak` | 0.1s | 0.038s | 0.138s |
| `dirtycoverage_update.bak` | 0.102s | 0.037s | 0.139s |
| `featurecoverage_full.bak` | 0.165s | 0.062s | 0.227s |
| `filtered_ncci_full.bak` | 0.057s | 0.037s | 0.094s |
| `float_extreme_full.bak` | 0.056s | 0.035s | 0.091s |
| `forwarded_records_full.bak` | 0.373s | 0.072s | 0.445s |
| `ghost_records_full.bak` | 0.058s | 0.04s | 0.098s |
| `heapcoverage_large.bak` | 0.056s | 0.041s | 0.097s |
| `heapcoverage_large_50000.bak` | 0.3s | 0.331s | 0.631s |
| `hierarchyid_extract_full.bak` | 0.054s | 0.04s | 0.094s |
| `high_slot_density_full.bak` | 0.082s | 0.193s | 0.275s |
| `identity_coverage_full.bak` | 0.061s | 0.039s | 0.1s |
| `incrementalcoverage_diff_01.bak` | 0.05s | 0.014s | 0.064s |
| `incrementalcoverage_diff_02.bak` | 0.05s | 0.017s | 0.067s |
| `incrementalcoverage_diff_03.bak` | 0.05s | 0.017s | 0.067s |
| `incrementalcoverage_diff_04.bak` | 0.048s | 0.012s | 0.06s |
| `incrementalcoverage_diff_05.bak` | 0.048s | 0.013s | 0.061s |
| `incrementalcoverage_diff_06.bak` | 0.05s | 0.014s | 0.064s |
| `incrementalcoverage_full.bak` | 0.049s | 0.041s | 0.09s |
| `layoutcoverage_full.bak` | 0.237s | 0.348s | 0.585s |
| `max_row_width_full.bak` | 0.051s | 0.038s | 0.089s |
| `mixed_collation_full.bak` | 0.048s | 0.034s | 0.082s |
| `multi_rowgroup_full.bak` | 0.066s | 0.043s | 0.109s |
| `native_json_full.bak` | 0.061s | 0.037s | 0.098s |
| `ncci_heap_full.bak` | 0.104s | 0.09s | 0.194s |
| `ncci_types_full.bak` | 0.138s | 0.204s | 0.342s |
| `ndfcoverage_full.bak` | 0.068s | 0.039s | 0.107s |
| `nvarchar_max_u21_full.bak` | 0.059s | 0.035s | 0.094s |
| `ordered_cci_full.bak` | 0.062s | 0.041s | 0.103s |
| `pagecomp_anchor_full.bak` | 0.148s | 0.1s | 0.248s |
| `pagecomp_long_prefix_full.bak` | 0.062s | 0.035s | 0.097s |
| `pfor_columnstore_full.bak` | 0.14s | 0.832s | 0.972s |
| `pfor_columnstore_random_full.bak` | 0.155s | 0.838s | 0.993s |
| `realworld_numeric_digest_full.bak` | 0.073s | 0.088s | 0.161s |
| `rowboundary_full.bak` | 0.061s | 0.039s | 0.1s |
| `rowstore_hash_pii_full.bak` | 0.053s | 0.034s | 0.087s |
| `rowstore_lob_image_full.bak` | 0.06s | 0.042s | 0.102s |
| `rowstore_lob_markup_full.bak` | 0.061s | 0.038s | 0.099s |
| `rowversion_extract_full.bak` | 0.053s | 0.035s | 0.088s |
| `sparse_full.bak` | 0.112s | 0.096s | 0.208s |
| `spatial_edge_full.bak` | 0.056s | 0.041s | 0.097s |
| `spatial_index_full.bak` | 0.058s | 0.043s | 0.101s |
| `sql_variant_extract_full.bak` | 0.055s | 0.038s | 0.093s |
| `striped_full_1.bak` | 0.058s | 0.014s | 0.072s |
| `striped_single.bak` | 0.09s | 0.054s | 0.144s |
| `surrogate_pairs_full.bak` | 0.053s | 0.034s | 0.087s |
| `tabletype_cci_large_full.bak` | 0.089s | 0.052s | 0.141s |
| `tabletypecoverage_diff.bak` | 0.109s | 0.069s | 0.178s |
| `tabletypecoverage_full.bak` | 0.196s | 0.107s | 0.303s |
| `temporal_hidden_full.bak` | 0.063s | 0.044s | 0.107s |
| `torn_page_full.bak` | 0.053s | 0.038s | 0.091s |
| `typecoverage_full.bak` | 0.124s | 0.066s | 0.19s |
| `typed_xml_full.bak` | 0.055s | 0.039s | 0.094s |
| `unicode_codepage_coverage.bak` | 0.088s | 0.049s | 0.137s |
| `utf8_collation_full.bak` | 0.052s | 0.036s | 0.088s |
| `vector_full.bak` | 0.093s | 0.086s | 0.179s |
| `xml_index_full.bak` | 0.056s | 0.036s | 0.092s |
| `xmlcoverage_full.bak` | 0.051s | 0.039s | 0.09s |
| `xmlheap_full.bak` | 0.118s | 0.058s | 0.176s |
| `xtp_checkpoint_straddle_full.bak` | 1.895s | 0.374s | 2.269s |
| `xtp_probe_full.bak` | 0.136s | 0.047s | 0.183s |
| `xtp_rich_full.bak` | 0.13s | 0.051s | 0.181s |
| `xtp_simple_full.bak` | 0.128s | 0.05s | 0.178s |
