...
| Backup | Wall time |
|--------|-------------|
| `alias_types_full.bak` | 0.075s |
| `archive_columnstore_partition_full.bak` | 2.433s |
| `archive_columnstore_types_full.bak` | 1.269s |
| `archive_columnstore_types_random_full.bak` | 2.011s |
| `archive_single_chunk_full.bak` | 0.07s |
| `archive_single_chunk_random_full.bak` | 0.077s |
| `archivenull_full.bak` | 0.433s |
| `backup_blocksize_full.bak` | 0.058s |
| `boundarycoverage_datetime_full.bak` | 0.408s |
| `boundarycoverage_full.bak` | 0.204s |
| `cci_binary_varbinary_compare_full.bak` | 0.066s |
| `cci_bitpack_probe_bigint_full.bak` | 6.493s |
| `cci_bitpack_probe_full.bak` | 0.806s |
| `cci_bitpack_probe_highbase_full.bak` | 0.779s |
| `cci_btree_nci_full.bak` | 0.074s |
| `cci_computed_full.bak` | 0.093s |
| `cci_enc5_largepool_full.bak` | 1.159s |
| `cci_enc5_largepool_matrix_full.bak` | 9.348s |
| `cci_extended_full.bak` | 0.101s |
| `cci_lob_full.bak` | 0.111s |
| `cci_reorganize_full.bak` | 0.094s |
| `cci_string_dict_regression_full.bak` | 0.516s |
| `cci_string_minmax_full.bak` | 0.075s |
| `cci_switch_full.bak` | 0.092s |
| `cci_types_large_full.bak` | 0.102s |
| `cci_varbinary_micro_full.bak` | 0.088s |
| `cci_varbinary_probe_full.bak` | 0.102s |
| `columnstore_minimal.bak` | 1.044s |
| `compressed_nvarchar_full.bak` | 0.06s |
| `compressioncoverage_full.bak` | 0.33s |
| `computedcoverage_full.bak` | 0.062s |
| `constraintcoverage_full.bak` | 0.065s |
| `covering_index_full.bak` | 0.098s |
| `cs_lob_preamble.bak` | 0.127s |
| `delta_rowgroup_full.bak` | 0.065s |
| `dirtycoverage_aborted_xact.bak` | 0.077s |
| `dirtycoverage_addcol.bak` | 0.084s |
| `dirtycoverage_addnotnull.bak` | 0.071s |
| `dirtycoverage_alldirty.bak` | 0.074s |
| `dirtycoverage_altercol.bak` | 0.057s |
| `dirtycoverage_altercol_rewrite.bak` | 0.071s |
| `dirtycoverage_alterdb.bak` | 0.074s |
| `dirtycoverage_cci_delete.bak` | 0.206s |
| `dirtycoverage_cci_update.bak` | 0.202s |
| `dirtycoverage_committed_delete.bak` | 0.059s |
| `dirtycoverage_committed_delete_v2.bak` | 0.097s |
| `dirtycoverage_committed_delete_v3.bak` | 0.129s |
| `dirtycoverage_committed_delete_v4.bak` | 0.322s |
| `dirtycoverage_committed_update.bak` | 0.061s |
| `dirtycoverage_committed_update_v2.bak` | 0.067s |
| `dirtycoverage_committed_update_v3.bak` | 0.156s |
| `dirtycoverage_committed_update_v4.bak` | 0.373s |
| `dirtycoverage_concurrent.bak` | 0.109s |
| `dirtycoverage_createidx.bak` | 0.076s |
| `dirtycoverage_createtable.bak` | 0.082s |
| `dirtycoverage_delete.bak` | 0.079s |
| `dirtycoverage_dropcol.bak` | 0.071s |
| `dirtycoverage_dropidx.bak` | 0.076s |
| `dirtycoverage_droptable.bak` | 0.089s |
| `dirtycoverage_heap_forward.bak` | 0.074s |
| `dirtycoverage_large_dirty.bak` | 0.354s |
| `dirtycoverage_lob_update.bak` | 0.105s |
| `dirtycoverage_maxrow.bak` | 0.057s |
| `dirtycoverage_nchar_delete.bak` | 0.096s |
| `dirtycoverage_nested.bak` | 0.079s |
| `dirtycoverage_null_update.bak` | 0.073s |
| `dirtycoverage_rebuildidx.bak` | 0.076s |
| `dirtycoverage_rich_insert.bak` | 0.076s |
| `dirtycoverage_rich_update.bak` | 0.082s |
| `dirtycoverage_savepoint.bak` | 0.078s |
| `dirtycoverage_snapshot_update.bak` | 0.07s |
| `dirtycoverage_switch.bak` | 0.085s |
| `dirtycoverage_temporal_update.bak` | 0.117s |
| `dirtycoverage_truncate.bak` | 0.079s |
| `dirtycoverage_two_tx.bak` | 0.075s |
| `dirtycoverage_uncommitted.bak` | 0.075s |
| `dirtycoverage_update.bak` | 0.081s |
| `filtered_ncci_full.bak` | 0.087s |
| `float_extreme_full.bak` | 0.057s |
| `forwarded_records_full.bak` | 0.143s |
| `ghost_records_full.bak` | 0.066s |
| `heapcoverage_large.bak` | 0.081s |
| `heapcoverage_large_50000.bak` | 0.946s |
| `hierarchyid_extract_full.bak` | 0.06s |
| `high_slot_density_full.bak` | 0.612s |
| `incrementalcoverage_diff_01.bak` | 0.042s |
| `incrementalcoverage_diff_02.bak` | 0.042s |
| `incrementalcoverage_diff_03.bak` | 0.042s |
| `incrementalcoverage_diff_04.bak` | 0.047s |
| `incrementalcoverage_diff_05.bak` | 0.044s |
| `incrementalcoverage_diff_06.bak` | 0.046s |
| `incrementalcoverage_full.bak` | 0.061s |
| `layoutcoverage_full.bak` | 0.339s |
| `max_row_width_full.bak` | 0.061s |
| `mixed_collation_full.bak` | 0.062s |
| `multi_rowgroup_full.bak` | 0.073s |
| `ncci_heap_full.bak` | 0.076s |
| `ncci_types_full.bak` | 0.447s |
| `ndfcoverage_full.bak` | 0.067s |
| `nvarchar_max_u21_full.bak` | 0.062s |
| `pagecomp_anchor_full.bak` | 0.34s |
| `pagecomp_long_prefix_full.bak` | 0.057s |
| `pfor_columnstore_full.bak` | 2.383s |
| `pfor_columnstore_random_full.bak` | 2.217s |
| `realworld_numeric_digest_full.bak` | 0.2s |
| `rowboundary_full.bak` | 0.068s |
| `rowstore_hash_pii_full.bak` | 0.063s |
| `rowstore_lob_image_full.bak` | 0.062s |
| `rowstore_lob_markup_full.bak` | 0.059s |
| `rowversion_extract_full.bak` | 0.068s |
| `sparse_full.bak` | 0.274s |
| `spatial_edge_full.bak` | 0.064s |
| `spatial_index_full.bak` | 0.077s |
| `sql_variant_extract_full.bak` | 0.062s |
| `striped_full_1.bak` | 0.056s |
| `striped_single.bak` | 0.083s |
| `surrogate_pairs_full.bak` | 0.059s |
| `tabletype_cci_large_full.bak` | 0.09s |
| `tabletypecoverage_diff.bak` | 0.185s |
| `tabletypecoverage_full.bak` | 0.175s |
| `temporal_hidden_full.bak` | 0.063s |
| `torn_page_full.bak` | 0.068s |
| `typecoverage_full.bak` | 0.115s |
| `typed_xml_full.bak` | 0.059s |
| `unicode_codepage_coverage.bak` | 0.088s |
| `xml_index_full.bak` | 0.077s |
| `xmlcoverage_full.bak` | 0.056s |
| `xmlheap_full.bak` | 0.108s |
| `xtp_checkpoint_straddle_full.bak` | 0.423s |
| `xtp_probe_full.bak` | 0.108s |
| `xtp_rich_full.bak` | 0.09s |
| `xtp_simple_full.bak` | 0.085s |

---

_Generated 2026-07-08 · 132 fixtures · 132 pass · 0 xfail · 0 fail_
