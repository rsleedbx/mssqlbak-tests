...
| Backup | Wall time |
|--------|-------------|
| `alias_types_full.bak` | 0.065s |
| `archive_columnstore_partition_full.bak` | 2.491s |
| `archive_columnstore_types_full.bak` | 1.397s |
| `archive_columnstore_types_random_full.bak` | 1.349s |
| `archive_single_chunk_full.bak` | 0.075s |
| `archive_single_chunk_random_full.bak` | 0.077s |
| `archivenull_full.bak` | 0.441s |
| `backup_blocksize_full.bak` | 0.06s |
| `boundarycoverage_datetime_full.bak` | 0.447s |
| `boundarycoverage_full.bak` | 0.207s |
| `cci_binary_varbinary_compare_full.bak` | 0.075s |
| `cci_bitpack_probe_bigint_full.bak` | 6.655s |
| `cci_bitpack_probe_full.bak` | 0.79s |
| `cci_bitpack_probe_highbase_full.bak` | 0.705s |
| `cci_btree_nci_full.bak` | 0.08s |
| `cci_computed_full.bak` | 0.096s |
| `cci_enc5_largepool_full.bak` | 1.245s |
| `cci_enc5_largepool_matrix_full.bak` | 9.77s |
| `cci_extended_full.bak` | 0.112s |
| `cci_lob_full.bak` | 0.117s |
| `cci_reorganize_full.bak` | 0.104s |
| `cci_string_dict_regression_full.bak` | 0.558s |
| `cci_string_minmax_full.bak` | 0.082s |
| `cci_switch_full.bak` | 0.098s |
| `cci_types_large_full.bak` | 0.106s |
| `cci_varbinary_micro_full.bak` | 0.093s |
| `cci_varbinary_probe_full.bak` | 0.112s |
| `columnstore_minimal.bak` | 1.233s |
| `compressed_nvarchar_full.bak` | 0.066s |
| `compressioncoverage_full.bak` | 0.39s |
| `computedcoverage_full.bak` | 0.07s |
| `constraintcoverage_full.bak` | 0.074s |
| `covering_index_full.bak` | 0.102s |
| `cs_lob_preamble.bak` | 0.14s |
...
| `dirtycoverage_altercol.bak` | 0.059s |
| `dirtycoverage_altercol_rewrite.bak` | 0.079s |
| `dirtycoverage_alterdb.bak` | 0.076s |
| `dirtycoverage_cci_delete.bak` | 0.218s |
| `dirtycoverage_cci_update.bak` | 0.216s |
| `dirtycoverage_committed_delete.bak` | 0.062s |
| `dirtycoverage_committed_delete_v2.bak` | 0.08s |
| `dirtycoverage_committed_delete_v3.bak` | 0.129s |
| `dirtycoverage_committed_delete_v4.bak` | 0.338s |
| `dirtycoverage_committed_update.bak` | 0.072s |
| `dirtycoverage_committed_update_v2.bak` | 0.078s |
| `dirtycoverage_committed_update_v3.bak` | 0.157s |
| `dirtycoverage_committed_update_v4.bak` | 0.399s |
| `dirtycoverage_concurrent.bak` | 0.082s |
| `dirtycoverage_createidx.bak` | 0.079s |
| `dirtycoverage_createtable.bak` | 0.08s |
| `dirtycoverage_delete.bak` | 0.077s |
| `dirtycoverage_dropcol.bak` | 0.075s |
| `dirtycoverage_dropidx.bak` | 0.081s |
| `dirtycoverage_droptable.bak` | 0.086s |
| `dirtycoverage_heap_forward.bak` | 0.076s |
| `dirtycoverage_large_dirty.bak` | 0.385s |
| `dirtycoverage_lob_update.bak` | 0.097s |
| `dirtycoverage_maxrow.bak` | 0.061s |
| `dirtycoverage_nchar_delete.bak` | 0.082s |
| `dirtycoverage_nested.bak` | 0.077s |
| `dirtycoverage_null_update.bak` | 0.076s |
| `dirtycoverage_rebuildidx.bak` | 0.077s |
| `dirtycoverage_rich_insert.bak` | 0.08s |
| `dirtycoverage_rich_update.bak` | 0.08s |
| `dirtycoverage_savepoint.bak` | 0.081s |
| `dirtycoverage_snapshot_update.bak` | 0.075s |
| `dirtycoverage_switch.bak` | 0.089s |
| `dirtycoverage_temporal_update.bak` | 0.093s |
| `dirtycoverage_truncate.bak` | 0.081s |
| `dirtycoverage_two_tx.bak` | 0.085s |
| `dirtycoverage_uncommitted.bak` | 0.083s |
| `dirtycoverage_update.bak` | 0.08s |
| `filtered_ncci_full.bak` | 0.09s |
| `float_extreme_full.bak` | 0.058s |
| `forwarded_records_full.bak` | 0.153s |
| `ghost_records_full.bak` | 0.062s |
| `heapcoverage_large.bak` | 0.079s |
| `heapcoverage_large_50000.bak` | 1.044s |
| `hierarchyid_extract_full.bak` | 0.063s |
| `high_slot_density_full.bak` | 0.631s |
| `incrementalcoverage_diff_01.bak` | 0.045s |
| `incrementalcoverage_diff_02.bak` | 0.044s |
| `incrementalcoverage_diff_03.bak` | 0.044s |
| `incrementalcoverage_diff_04.bak` | 0.047s |
| `incrementalcoverage_diff_05.bak` | 0.046s |
| `incrementalcoverage_diff_06.bak` | 0.045s |
| `incrementalcoverage_full.bak` | 0.066s |
| `layoutcoverage_full.bak` | 0.403s |
| `max_row_width_full.bak` | 0.058s |
| `mixed_collation_full.bak` | 0.067s |
| `multi_rowgroup_full.bak` | 0.076s |
| `ncci_heap_full.bak` | 0.088s |
| `ncci_types_full.bak` | 0.613s |
| `ndfcoverage_full.bak` | 0.062s |
| `nvarchar_max_u21_full.bak` | 0.065s |
| `pagecomp_anchor_full.bak` | 0.377s |
| `pagecomp_long_prefix_full.bak` | 0.057s |
| `pfor_columnstore_full.bak` | 2.351s |
| `pfor_columnstore_random_full.bak` | 2.357s |
| `realworld_numeric_digest_full.bak` | 0.216s |
| `rowboundary_full.bak` | 0.063s |
| `rowstore_hash_pii_full.bak` | 0.063s |
| `rowstore_lob_image_full.bak` | 0.063s |
| `rowstore_lob_markup_full.bak` | 0.059s |
| `rowversion_extract_full.bak` | 0.061s |
| `sparse_full.bak` | 0.292s |
| `spatial_edge_full.bak` | 0.067s |
| `spatial_index_full.bak` | 0.083s |
| `sql_variant_extract_full.bak` | 0.062s |
| `striped_full_1.bak` | 0.058s |
| `striped_single.bak` | 0.091s |
| `surrogate_pairs_full.bak` | 0.058s |
| `tabletype_cci_large_full.bak` | 0.095s |
| `tabletypecoverage_diff.bak` | 0.202s |
| `tabletypecoverage_full.bak` | 0.179s |
| `temporal_hidden_full.bak` | 0.066s |
| `torn_page_full.bak` | 0.065s |
| `typecoverage_full.bak` | 0.145s |
| `typed_xml_full.bak` | 0.059s |
| `unicode_codepage_coverage.bak` | 0.094s |
| `xml_index_full.bak` | 0.08s |
| `xmlcoverage_full.bak` | 0.059s |
| `xmlheap_full.bak` | 0.115s |
| `xtp_checkpoint_straddle_full.bak` | 0.429s |
| `xtp_probe_full.bak` | 0.114s |
| `xtp_rich_full.bak` | 0.092s |
| `xtp_simple_full.bak` | 0.1s |
