...
|--------|---------|--------|-----------|
| `alias_types_full.bak` | 0.027s | 0.028s | 0.055s |
| `archive_columnstore_partition_full.bak` | 0.87s | 0.62s | 1.49s |
| `archive_columnstore_types_full.bak` | 0.314s | 0.687s | 1.001s |
| `archive_columnstore_types_random_full.bak` | 0.309s | 0.68s | 0.989s |
| `archive_single_chunk_full.bak` | 0.032s | 0.035s | 0.067s |
| `archive_single_chunk_random_full.bak` | 0.038s | 0.032s | 0.07s |
| `archivenull_full.bak` | 0.124s | 0.209s | 0.333s |
| `backup_blocksize_full.bak` | 0.028s | 0.032s | 0.06s |
| `boundarycoverage_datetime_full.bak` | 0.067s | 0.156s | 0.223s |
| `boundarycoverage_full.bak` | 0.044s | 0.074s | 0.118s |
| `cci_binary_varbinary_compare_full.bak` | 0.033s | 0.039s | 0.072s |
| `cci_bitpack_probe_bigint_full.bak` | 0.261s | 3.725s | 3.986s |
| `cci_bitpack_probe_full.bak` | 0.08s | 0.644s | 0.724s |
| `cci_bitpack_probe_highbase_full.bak` | 0.063s | 0.42s | 0.483s |
| `cci_btree_nci_full.bak` | 0.037s | 0.035s | 0.072s |
| `cci_computed_full.bak` | 0.049s | 0.033s | 0.082s |
| `cci_enc5_largepool_full.bak` | 0.315s | 0.434s | 0.749s |
| `cci_enc5_largepool_matrix_full.bak` | 6.982s | 1.249s | 8.231s |
| `cci_extended_full.bak` | 0.047s | 0.041s | 0.088s |
| `cci_lob_full.bak` | 0.059s | 0.035s | 0.094s |
| `cci_reorganize_full.bak` | 0.057s | 0.037s | 0.094s |
| `cci_string_dict_regression_full.bak` | 0.281s | 0.135s | 0.416s |
| `cci_string_minmax_full.bak` | 0.036s | 0.031s | 0.067s |
| `cci_switch_full.bak` | 0.046s | 0.035s | 0.081s |
| `cci_types_large_full.bak` | 0.038s | 0.041s | 0.079s |
| `cci_varbinary_micro_full.bak` | 0.05s | 0.03s | 0.08s |
| `cci_varbinary_probe_full.bak` | 0.059s | 0.043s | 0.102s |
| `columnstore_minimal.bak` | 0.124s | 0.875s | 0.999s |
| `compressed_nvarchar_full.bak` | 0.035s | 0.035s | 0.07s |
| `compressioncoverage_full.bak` | 0.086s | 0.163s | 0.249s |
| `computedcoverage_full.bak` | 0.028s | 0.034s | 0.062s |
| `constraintcoverage_full.bak` | 0.032s | 0.036s | 0.068s |
| `covering_index_full.bak` | 0.054s | 0.042s | 0.096s |
| `cs_lob_preamble.bak` | 0.071s | 0.053s | 0.124s |
| `delta_rowgroup_full.bak` | 0.031s | 0.033s | 0.064s |
| `dirtycoverage_aborted_xact.bak` | 0.046s | 0.036s | 0.082s |
| `dirtycoverage_addcol.bak` | 0.043s | 0.035s | 0.078s |
| `dirtycoverage_addnotnull.bak` | 0.051s | 0.027s | 0.078s |
| `dirtycoverage_alldirty.bak` | 0.048s | 0.028s | 0.076s |
| `dirtycoverage_altercol.bak` | 0.036s | 0.031s | 0.067s |
| `dirtycoverage_altercol_rewrite.bak` | 0.043s | 0.032s | 0.075s |
| `dirtycoverage_alterdb.bak` | 0.043s | 0.029s | 0.072s |
| `dirtycoverage_cci_delete.bak` | 0.075s | 0.089s | 0.164s |
| `dirtycoverage_cci_update.bak` | 0.091s | 0.097s | 0.188s |
| `dirtycoverage_committed_delete.bak` | 0.027s | 0.03s | 0.057s |
| `dirtycoverage_committed_delete_v2.bak` | 0.029s | 0.033s | 0.062s |
| `dirtycoverage_committed_delete_v3.bak` | 0.036s | 0.056s | 0.092s |
| `dirtycoverage_committed_delete_v4.bak` | 0.153s | 0.066s | 0.219s |
| `dirtycoverage_committed_update.bak` | 0.037s | 0.031s | 0.068s |
| `dirtycoverage_committed_update_v2.bak` | 0.029s | 0.032s | 0.061s |
| `dirtycoverage_committed_update_v3.bak` | 0.039s | 0.072s | 0.111s |
| `dirtycoverage_committed_update_v4.bak` | 0.163s | 0.074s | 0.237s |
| `dirtycoverage_concurrent.bak` | 0.046s | 0.029s | 0.075s |
| `dirtycoverage_createidx.bak` | 0.044s | 0.028s | 0.072s |
| `dirtycoverage_createtable.bak` | 0.047s | 0.036s | 0.083s |
| `dirtycoverage_delete.bak` | 0.047s | 0.029s | 0.076s |
| `dirtycoverage_dropcol.bak` | 0.044s | 0.033s | 0.077s |
| `dirtycoverage_dropidx.bak` | 0.044s | 0.032s | 0.076s |
| `dirtycoverage_droptable.bak` | 0.046s | 0.032s | 0.078s |
| `dirtycoverage_heap_forward.bak` | 0.054s | 0.034s | 0.088s |
| `dirtycoverage_large_dirty.bak` | 0.32s | 0.035s | 0.355s |
| `dirtycoverage_lob_update.bak` | 0.075s | 0.031s | 0.106s |
| `dirtycoverage_maxrow.bak` | 0.028s | 0.028s | 0.056s |
| `dirtycoverage_nchar_delete.bak` | 0.046s | 0.028s | 0.074s |
| `dirtycoverage_nested.bak` | 0.046s | 0.032s | 0.078s |
| `dirtycoverage_null_update.bak` | 0.048s | 0.028s | 0.076s |
| `dirtycoverage_rebuildidx.bak` | 0.044s | 0.029s | 0.073s |
| `dirtycoverage_rich_insert.bak` | 0.046s | 0.033s | 0.079s |
| `dirtycoverage_rich_update.bak` | 0.049s | 0.029s | 0.078s |
| `dirtycoverage_savepoint.bak` | 0.049s | 0.03s | 0.079s |
| `dirtycoverage_snapshot_update.bak` | 0.044s | 0.029s | 0.073s |
| `dirtycoverage_switch.bak` | 0.05s | 0.034s | 0.084s |
| `dirtycoverage_temporal_update.bak` | 0.05s | 0.03s | 0.08s |
| `dirtycoverage_truncate.bak` | 0.044s | 0.036s | 0.08s |
| `dirtycoverage_two_tx.bak` | 0.048s | 0.029s | 0.077s |
| `dirtycoverage_uncommitted.bak` | 0.047s | 0.035s | 0.082s |
| `dirtycoverage_update.bak` | 0.058s | 0.029s | 0.087s |
| `filtered_ncci_full.bak` | 0.049s | 0.034s | 0.083s |
| `float_extreme_full.bak` | 0.028s | 0.03s | 0.058s |
| `forwarded_records_full.bak` | 0.078s | 0.073s | 0.151s |
| `ghost_records_full.bak` | 0.04s | 0.035s | 0.075s |
| `heapcoverage_large.bak` | 0.029s | 0.035s | 0.064s |
| `heapcoverage_large_50000.bak` | 0.081s | 0.312s | 0.393s |
| `hierarchyid_extract_full.bak` | 0.028s | 0.029s | 0.057s |
| `high_slot_density_full.bak` | 0.043s | 0.187s | 0.23s |
| `identity_coverage_full.bak` | 0.046s | 0.033s | 0.079s |
| `incrementalcoverage_diff_01.bak` | 0.033s | 0.011s | 0.044s |
| `incrementalcoverage_diff_02.bak` | 0.033s | 0.025s | 0.058s |
| `incrementalcoverage_diff_03.bak` | 0.031s | 0.011s | 0.042s |
| `incrementalcoverage_diff_04.bak` | 0.044s | 0.02s | 0.064s |
| `incrementalcoverage_diff_05.bak` | 0.038s | 0.014s | 0.052s |
| `incrementalcoverage_diff_06.bak` | 0.033s | 0.01s | 0.043s |
| `incrementalcoverage_full.bak` | 0.028s | 0.025s | 0.053s |
| `layoutcoverage_full.bak` | 0.145s | 0.309s | 0.454s |
| `max_row_width_full.bak` | 0.028s | 0.029s | 0.057s |
| `mixed_collation_full.bak` | 0.028s | 0.03s | 0.058s |
| `multi_rowgroup_full.bak` | 0.033s | 0.044s | 0.077s |
| `ncci_heap_full.bak` | 0.051s | 0.034s | 0.085s |
| `ncci_types_full.bak` | 0.072s | 0.184s | 0.256s |
| `ndfcoverage_full.bak` | 0.028s | 0.03s | 0.058s |
| `nvarchar_max_u21_full.bak` | 0.028s | 0.03s | 0.058s |
| `pagecomp_anchor_full.bak` | 0.135s | 0.096s | 0.231s |
| `pagecomp_long_prefix_full.bak` | 0.034s | 0.031s | 0.065s |
| `pfor_columnstore_full.bak` | 0.09s | 0.828s | 0.918s |
| `pfor_columnstore_random_full.bak` | 0.1s | 0.826s | 0.926s |
| `realworld_numeric_digest_full.bak` | 0.061s | 0.089s | 0.15s |
| `rowboundary_full.bak` | 0.03s | 0.031s | 0.061s |
| `rowstore_hash_pii_full.bak` | 0.028s | 0.029s | 0.057s |
| `rowstore_lob_image_full.bak` | 0.028s | 0.029s | 0.057s |
| `rowstore_lob_markup_full.bak` | 0.035s | 0.031s | 0.066s |
| `rowversion_extract_full.bak` | 0.028s | 0.031s | 0.059s |
| `sparse_full.bak` | 0.079s | 0.086s | 0.165s |
| `spatial_edge_full.bak` | 0.029s | 0.025s | 0.054s |
| `spatial_index_full.bak` | 0.05s | 0.031s | 0.081s |
| `sql_variant_extract_full.bak` | 0.028s | 0.028s | 0.056s |
| `striped_full_1.bak` | 0.041s | 0.013s | 0.054s |
| `striped_single.bak` | 0.044s | 0.041s | 0.085s |
| `surrogate_pairs_full.bak` | 0.028s | 0.028s | 0.056s |
| `tabletype_cci_large_full.bak` | 0.049s | 0.045s | 0.094s |
| `tabletypecoverage_diff.bak` | 0.128s | 0.068s | 0.196s |
| `tabletypecoverage_full.bak` | 0.09s | 0.086s | 0.176s |
| `temporal_hidden_full.bak` | 0.029s | 0.033s | 0.062s |
| `torn_page_full.bak` | 0.028s | 0.031s | 0.059s |
| `typecoverage_full.bak` | 0.078s | 0.066s | 0.144s |
| `typed_xml_full.bak` | 0.033s | 0.033s | 0.066s |
| `unicode_codepage_coverage.bak` | 0.047s | 0.041s | 0.088s |
| `xml_index_full.bak` | 0.044s | 0.032s | 0.076s |
| `xmlcoverage_full.bak` | 0.027s | 0.038s | 0.065s |
| `xmlheap_full.bak` | 0.047s | 0.047s | 0.094s |
| `xtp_checkpoint_straddle_full.bak` | 1.701s | 0.357s | 2.058s |
| `xtp_probe_full.bak` | 0.083s | 0.037s | 0.12s |
| `xtp_rich_full.bak` | 0.06s | 0.034s | 0.094s |
| `xtp_simple_full.bak` | 0.061s | 0.031s | 0.092s |
