...
| `archive_columnstore_partition_full.bak` | 2.692s |
| `archive_columnstore_types_full.bak` | 1.358s |
| `archive_columnstore_types_random_full.bak` | 1.366s |
| `archive_single_chunk_full.bak` | 0.085s |
| `archive_single_chunk_random_full.bak` | 0.075s |
| `archivenull_full.bak` | 0.412s |
| `backup_blocksize_full.bak` | 0.059s |
| `boundarycoverage_datetime_full.bak` | 0.383s |
| `boundarycoverage_full.bak` | 0.193s |
| `cci_binary_varbinary_compare_full.bak` | 0.07s |
| `cci_bitpack_probe_bigint_full.bak` | 6.231s |
| `cci_bitpack_probe_full.bak` | 0.79s |
| `cci_bitpack_probe_highbase_full.bak` | 0.714s |
| `cci_btree_nci_full.bak` | 0.072s |
| `cci_computed_full.bak` | 0.089s |
| `cci_enc5_largepool_full.bak` | 1.154s |
| `cci_enc5_largepool_matrix_full.bak` | 9.478s |
| `cci_extended_full.bak` | 0.109s |
| `cci_lob_full.bak` | 0.106s |
| `cci_reorganize_full.bak` | 0.091s |
| `cci_string_dict_regression_full.bak` | 0.477s |
| `cci_string_minmax_full.bak` | 0.092s |
| `cci_switch_full.bak` | 0.089s |
| `cci_types_large_full.bak` | 0.113s |
| `cci_varbinary_micro_full.bak` | 0.105s |
| `cci_varbinary_probe_full.bak` | 0.109s |
| `columnstore_minimal.bak` | 0.998s |
| `compressed_nvarchar_full.bak` | 0.054s |
| `compressioncoverage_full.bak` | 0.324s |
| `computedcoverage_full.bak` | 0.057s |
| `constraintcoverage_full.bak` | 0.07s |
| `covering_index_full.bak` | 0.095s |
| `cs_lob_preamble.bak` | 0.124s |
| `delta_rowgroup_full.bak` | 0.066s |
| `dirtycoverage_aborted_xact.bak` | 0.076s |
| `dirtycoverage_addcol.bak` | 0.083s |
| `dirtycoverage_addnotnull.bak` | 0.074s |
| `dirtycoverage_alldirty.bak` | 0.086s |
| `dirtycoverage_altercol.bak` | 0.055s |
| `dirtycoverage_altercol_rewrite.bak` | 0.074s |
| `dirtycoverage_alterdb.bak` | 0.094s |
| `dirtycoverage_cci_delete.bak` | 0.203s |
| `dirtycoverage_cci_update.bak` | 0.196s |
| `dirtycoverage_committed_delete.bak` | 0.059s |
| `dirtycoverage_committed_delete_v2.bak` | 0.081s |
| `dirtycoverage_committed_delete_v3.bak` | 0.12s |
| `dirtycoverage_committed_delete_v4.bak` | 0.314s |
| `dirtycoverage_committed_update.bak` | 0.058s |
| `dirtycoverage_committed_update_v2.bak` | 0.08s |
| `dirtycoverage_committed_update_v3.bak` | 0.147s |
| `dirtycoverage_committed_update_v4.bak` | 0.365s |
| `dirtycoverage_concurrent.bak` | 0.082s |
| `dirtycoverage_createidx.bak` | 0.077s |
| `dirtycoverage_createtable.bak` | 0.081s |
| `dirtycoverage_delete.bak` | 0.096s |
| `dirtycoverage_dropcol.bak` | 0.075s |
| `dirtycoverage_dropidx.bak` | 0.092s |
| `dirtycoverage_droptable.bak` | 0.1s |
| `dirtycoverage_heap_forward.bak` | 0.088s |
| `dirtycoverage_large_dirty.bak` | 0.345s |
| `dirtycoverage_lob_update.bak` | 0.098s |
| `dirtycoverage_maxrow.bak` | 0.055s |
| `dirtycoverage_nchar_delete.bak` | 0.083s |
| `dirtycoverage_nested.bak` | 0.094s |
| `dirtycoverage_null_update.bak` | 0.071s |
| `dirtycoverage_rebuildidx.bak` | 0.077s |
| `dirtycoverage_rich_insert.bak` | 0.077s |
| `dirtycoverage_rich_update.bak` | 0.079s |
| `dirtycoverage_savepoint.bak` | 0.08s |
| `dirtycoverage_snapshot_update.bak` | 0.075s |
| `dirtycoverage_switch.bak` | 0.097s |
| `dirtycoverage_temporal_update.bak` | 0.083s |
| `dirtycoverage_truncate.bak` | 0.079s |
| `dirtycoverage_two_tx.bak` | 0.084s |
| `dirtycoverage_uncommitted.bak` | 0.076s |
| `dirtycoverage_update.bak` | 0.1s |
| `filtered_ncci_full.bak` | 0.1s |
| `float_extreme_full.bak` | 0.053s |
| `forwarded_records_full.bak` | 0.146s |
| `ghost_records_full.bak` | 0.065s |
| `heapcoverage_large.bak` | 0.09s |
| `heapcoverage_large_50000.bak` | 0.946s |
| `hierarchyid_extract_full.bak` | 0.058s |
| `high_slot_density_full.bak` | 0.558s |
| `incrementalcoverage_diff_01.bak` | 0.041s |
| `incrementalcoverage_diff_02.bak` | 0.041s |
| `incrementalcoverage_diff_03.bak` | 0.043s |
| `incrementalcoverage_diff_04.bak` | 0.048s |
| `incrementalcoverage_diff_05.bak` | 0.044s |
| `incrementalcoverage_diff_06.bak` | 0.043s |
| `incrementalcoverage_full.bak` | 0.052s |
| `layoutcoverage_full.bak` | 0.329s |
| `max_row_width_full.bak` | 0.056s |
| `mixed_collation_full.bak` | 0.054s |
| `multi_rowgroup_full.bak` | 0.075s |
| `ncci_heap_full.bak` | 0.094s |
| `ncci_types_full.bak` | 0.434s |
| `ndfcoverage_full.bak` | 0.065s |
| `nvarchar_max_u21_full.bak` | 0.054s |
| `pagecomp_anchor_full.bak` | 0.336s |
| `pagecomp_long_prefix_full.bak` | 0.061s |
| `pfor_columnstore_full.bak` | 2.566s |
| `pfor_columnstore_random_full.bak` | 2.557s |
| `realworld_numeric_digest_full.bak` | 0.196s |
| `rowboundary_full.bak` | 0.062s |
| `rowstore_hash_pii_full.bak` | 0.055s |
| `rowstore_lob_image_full.bak` | 0.057s |
| `rowstore_lob_markup_full.bak` | 0.055s |
| `rowversion_extract_full.bak` | 0.057s |
| `sparse_full.bak` | 0.276s |
| `spatial_edge_full.bak` | 0.056s |
| `spatial_index_full.bak` | 0.085s |
| `sql_variant_extract_full.bak` | 0.054s |
| `striped_full_1.bak` | 0.051s |
| `striped_single.bak` | 0.098s |
| `surrogate_pairs_full.bak` | 0.055s |
| `tabletype_cci_large_full.bak` | 0.087s |
| `tabletypecoverage_diff.bak` | 0.183s |
| `tabletypecoverage_full.bak` | 0.161s |
| `temporal_hidden_full.bak` | 0.065s |
| `torn_page_full.bak` | 0.057s |
| `typecoverage_full.bak` | 0.119s |
| `typed_xml_full.bak` | 0.055s |
| `unicode_codepage_coverage.bak` | 0.142s |
| `xml_index_full.bak` | 0.089s |
| `xmlcoverage_full.bak` | 0.058s |
| `xmlheap_full.bak` | 0.101s |
| `xtp_checkpoint_straddle_full.bak` | 0.417s |
| `xtp_probe_full.bak` | 0.107s |
| `xtp_rich_full.bak` | 0.091s |
| `xtp_simple_full.bak` | 0.086s |

---

_Generated 2026-07-06 · 132 fixtures · 132 pass · 0 xfail · 0 fail_
