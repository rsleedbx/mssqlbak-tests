...
|--------|---------|--------|-----------|
| `alias_types_full.bak` | 0.028s | 0.028s | 0.056s |
| `archive_columnstore_partition_full.bak` | 0.849s | 0.891s | 1.74s |
| `archive_columnstore_types_full.bak` | 0.297s | 0.646s | 0.943s |
| `archive_columnstore_types_random_full.bak` | 0.292s | 0.628s | 0.92s |
| `archive_single_chunk_full.bak` | 0.043s | 0.04s | 0.083s |
| `archive_single_chunk_random_full.bak` | 0.041s | 0.043s | 0.084s |
| `archivenull_full.bak` | 0.118s | 0.207s | 0.325s |
| `backup_blocksize_full.bak` | 0.028s | 0.029s | 0.057s |
| `boundarycoverage_datetime_full.bak` | 0.056s | 0.165s | 0.221s |
| `boundarycoverage_full.bak` | 0.038s | 0.087s | 0.125s |
| `cci_binary_varbinary_compare_full.bak` | 0.032s | 0.035s | 0.067s |
| `cci_bitpack_probe_bigint_full.bak` | 0s | 5.726s | 5.726s |
| `cci_bitpack_probe_full.bak` | 0s | 0.617s | 0.617s |
| `cci_bitpack_probe_highbase_full.bak` | 0s | 0.555s | 0.555s |
| `cci_btree_nci_full.bak` | 0.032s | 0.035s | 0.067s |
| `cci_computed_full.bak` | 0.052s | 0.033s | 0.085s |
| `cci_enc5_largepool_full.bak` | 0.304s | 0.446s | 0.75s |
| `cci_enc5_largepool_matrix_full.bak` | 6.843s | 1.362s | 8.205s |
| `cci_extended_full.bak` | 0.048s | 0.051s | 0.099s |
| `cci_lob_full.bak` | 0.054s | 0.035s | 0.089s |
| `cci_reorganize_full.bak` | 0.059s | 0.04s | 0.099s |
| `cci_string_dict_regression_full.bak` | 0.27s | 0.134s | 0.404s |
| `cci_string_minmax_full.bak` | 0.043s | 0.038s | 0.081s |
| `cci_switch_full.bak` | 0.051s | 0.04s | 0.091s |
| `cci_types_large_full.bak` | 0.051s | 0.051s | 0.102s |
| `cci_varbinary_micro_full.bak` | 0.049s | 0.029s | 0.078s |
| `cci_varbinary_probe_full.bak` | 0.052s | 0.038s | 0.09s |
| `columnstore_minimal.bak` | 0.111s | 0.784s | 0.895s |
| `compressed_nvarchar_full.bak` | 0.027s | 0.03s | 0.057s |
| `compressioncoverage_full.bak` | 0.091s | 0.179s | 0.27s |
| `computedcoverage_full.bak` | 0.028s | 0.029s | 0.057s |
| `constraintcoverage_full.bak` | 0.045s | 0.044s | 0.089s |
| `covering_index_full.bak` | 0.046s | 0.04s | 0.086s |
| `cs_lob_preamble.bak` | 0.06s | 0.054s | 0.114s |
| `delta_rowgroup_full.bak` | 0.03s | 0.03s | 0.06s |
| `dirtycoverage_aborted_xact.bak` | 0.048s | 0.03s | 0.078s |
| `dirtycoverage_addcol.bak` | 0.049s | 0.025s | 0.074s |
| `dirtycoverage_addnotnull.bak` | 0.043s | 0.028s | 0.071s |
| `dirtycoverage_alldirty.bak` | 0.054s | 0.033s | 0.087s |
| `dirtycoverage_altercol.bak` | 0.027s | 0.035s | 0.062s |
| `dirtycoverage_altercol_rewrite.bak` | 0.043s | 0.024s | 0.067s |
| `dirtycoverage_alterdb.bak` | 0.043s | 0.029s | 0.072s |
| `dirtycoverage_cci_delete.bak` | 0.078s | 0.085s | 0.163s |
| `dirtycoverage_cci_update.bak` | 0.074s | 0.083s | 0.157s |
| `dirtycoverage_committed_delete.bak` | 0.027s | 0.03s | 0.057s |
| `dirtycoverage_committed_delete_v2.bak` | 0.043s | 0.042s | 0.085s |
| `dirtycoverage_committed_delete_v3.bak` | 0.043s | 0.063s | 0.106s |
| `dirtycoverage_committed_delete_v4.bak` | 0.143s | 0.109s | 0.252s |
| `dirtycoverage_committed_update.bak` | 0.028s | 0.03s | 0.058s |
| `dirtycoverage_committed_update_v2.bak` | 0.028s | 0.05s | 0.078s |
| `dirtycoverage_committed_update_v3.bak` | 0.038s | 0.077s | 0.115s |
| `dirtycoverage_committed_update_v4.bak` | 0.16s | 0.157s | 0.317s |
| `dirtycoverage_concurrent.bak` | 0.045s | 0.029s | 0.074s |
| `dirtycoverage_createidx.bak` | 0.043s | 0.026s | 0.069s |
| `dirtycoverage_createtable.bak` | 0.043s | 0.029s | 0.072s |
| `dirtycoverage_delete.bak` | 0.046s | 0.027s | 0.073s |
| `dirtycoverage_dropcol.bak` | 0.043s | 0.028s | 0.071s |
| `dirtycoverage_dropidx.bak` | 0.043s | 0.031s | 0.074s |
| `dirtycoverage_droptable.bak` | 0.045s | 0.028s | 0.073s |
| `dirtycoverage_heap_forward.bak` | 0.044s | 0.023s | 0.067s |
| `dirtycoverage_large_dirty.bak` | 0.326s | 0.036s | 0.362s |
| `dirtycoverage_lob_update.bak` | 0.063s | 0.029s | 0.092s |
| `dirtycoverage_maxrow.bak` | 0.027s | 0.032s | 0.059s |
| `dirtycoverage_nchar_delete.bak` | 0.047s | 0.033s | 0.08s |
| `dirtycoverage_nested.bak` | 0.046s | 0.036s | 0.082s |
| `dirtycoverage_null_update.bak` | 0.046s | 0.033s | 0.079s |
| `dirtycoverage_rebuildidx.bak` | 0.043s | 0.03s | 0.073s |
| `dirtycoverage_rich_insert.bak` | 0.051s | 0.038s | 0.089s |
| `dirtycoverage_rich_update.bak` | 0.049s | 0.037s | 0.086s |
| `dirtycoverage_savepoint.bak` | 0.047s | 0.031s | 0.078s |
| `dirtycoverage_snapshot_update.bak` | 0.044s | 0.029s | 0.073s |
| `dirtycoverage_switch.bak` | 0.059s | 0.038s | 0.097s |
| `dirtycoverage_temporal_update.bak` | 0.058s | 0.033s | 0.091s |
| `dirtycoverage_truncate.bak` | 0.048s | 0.031s | 0.079s |
| `dirtycoverage_two_tx.bak` | 0.059s | 0.043s | 0.102s |
| `dirtycoverage_uncommitted.bak` | 0.054s | 0.036s | 0.09s |
| `dirtycoverage_update.bak` | 0.048s | 0.028s | 0.076s |
| `filtered_ncci_full.bak` | 0.057s | 0.041s | 0.098s |
| `float_extreme_full.bak` | 0.027s | 0.029s | 0.056s |
| `forwarded_records_full.bak` | 0.062s | 0.081s | 0.143s |
| `ghost_records_full.bak` | 0.028s | 0.03s | 0.058s |
| `heapcoverage_large.bak` | 0.028s | 0.039s | 0.067s |
| `heapcoverage_large_50000.bak` | 0.074s | 0.445s | 0.519s |
| `hierarchyid_extract_full.bak` | 0.027s | 0.028s | 0.055s |
| `high_slot_density_full.bak` | 0.036s | 0.229s | 0.265s |
| `incrementalcoverage_diff_01.bak` | 0.032s | 0.01s | 0.042s |
| `incrementalcoverage_diff_02.bak` | 0.032s | 0.01s | 0.042s |
| `incrementalcoverage_diff_03.bak` | 0.033s | 0.011s | 0.044s |
| `incrementalcoverage_diff_04.bak` | 0.035s | 0.01s | 0.045s |
| `incrementalcoverage_diff_05.bak` | 0.036s | 0.011s | 0.047s |
| `incrementalcoverage_diff_06.bak` | 0.033s | 0.009s | 0.042s |
| `incrementalcoverage_full.bak` | 0.027s | 0.03s | 0.057s |
| `layoutcoverage_full.bak` | 0.152s | 0.231s | 0.383s |
| `max_row_width_full.bak` | 0.027s | 0.03s | 0.057s |
| `mixed_collation_full.bak` | 0.028s | 0.028s | 0.056s |
| `multi_rowgroup_full.bak` | 0.037s | 0.041s | 0.078s |
| `ncci_heap_full.bak` | 0.053s | 0.034s | 0.087s |
| `ncci_types_full.bak` | 0.064s | 0.232s | 0.296s |
| `ndfcoverage_full.bak` | 0.028s | 0.029s | 0.057s |
| `nvarchar_max_u21_full.bak` | 0.028s | 0.039s | 0.067s |
| `pagecomp_anchor_full.bak` | 0.118s | 0.144s | 0.262s |
| `pagecomp_long_prefix_full.bak` | 0.027s | 0.029s | 0.056s |
| `pfor_columnstore_full.bak` | 0.086s | 1.069s | 1.155s |
| `pfor_columnstore_random_full.bak` | 0.11s | 1.099s | 1.209s |
| `realworld_numeric_digest_full.bak` | 0.064s | 0.098s | 0.162s |
| `rowboundary_full.bak` | 0.029s | 0.032s | 0.061s |
| `rowstore_hash_pii_full.bak` | 0.036s | 0.032s | 0.068s |
| `rowstore_lob_image_full.bak` | 0.028s | 0.029s | 0.057s |
| `rowstore_lob_markup_full.bak` | 0.028s | 0.028s | 0.056s |
| `rowversion_extract_full.bak` | 0.028s | 0.029s | 0.057s |
| `sparse_full.bak` | 0.076s | 0.133s | 0.209s |
| `spatial_edge_full.bak` | 0.028s | 0.029s | 0.057s |
| `spatial_index_full.bak` | 0.044s | 0.032s | 0.076s |
| `sql_variant_extract_full.bak` | 0.028s | 0.028s | 0.056s |
| `striped_full_1.bak` | 0.041s | 0.012s | 0.053s |
| `striped_single.bak` | 0.039s | 0.041s | 0.08s |
| `surrogate_pairs_full.bak` | 0.036s | 0.034s | 0.07s |
| `tabletype_cci_large_full.bak` | 0.055s | 0.044s | 0.099s |
| `tabletypecoverage_diff.bak` | 0.107s | 0.059s | 0.166s |
| `tabletypecoverage_full.bak` | 0.082s | 0.073s | 0.155s |
| `temporal_hidden_full.bak` | 0.04s | 0.032s | 0.072s |
| `torn_page_full.bak` | 0.027s | 0.043s | 0.07s |
| `typecoverage_full.bak` | 0.059s | 0.077s | 0.136s |
| `typed_xml_full.bak` | 0.027s | 0.029s | 0.056s |
| `unicode_codepage_coverage.bak` | 0.056s | 0.04s | 0.096s |
| `xml_index_full.bak` | 0.052s | 0.035s | 0.087s |
| `xmlcoverage_full.bak` | 0.027s | 0.031s | 0.058s |
| `xmlheap_full.bak` | 0.045s | 0.055s | 0.1s |
| `xtp_checkpoint_straddle_full.bak` | 0s | 0.392s | 0.392s |
| `xtp_probe_full.bak` | 0.073s | 0.032s | 0.105s |
| `xtp_rich_full.bak` | 0.057s | 0.034s | 0.091s |
| `xtp_simple_full.bak` | 0.056s | 0.035s | 0.091s |
