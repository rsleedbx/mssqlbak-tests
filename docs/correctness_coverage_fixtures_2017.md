...
|--------|---------|--------|-----------|
| `alias_types_full.bak` | 0.041s | 0.032s | 0.073s |
| `archive_columnstore_partition_full.bak` | 0.892s | 0.672s | 1.564s |
| `archive_columnstore_types_full.bak` | 0.398s | 0.835s | 1.233s |
| `archive_columnstore_types_random_full.bak` | 0.317s | 0.661s | 0.978s |
| `archive_single_chunk_full.bak` | 0.034s | 0.031s | 0.065s |
| `archive_single_chunk_random_full.bak` | 0.033s | 0.038s | 0.071s |
| `archivenull_full.bak` | 0.114s | 0.206s | 0.32s |
| `backup_blocksize_full.bak` | 0.055s | 0.04s | 0.095s |
| `boundarycoverage_datetime_full.bak` | 0.075s | 0.167s | 0.242s |
| `boundarycoverage_full.bak` | 0.04s | 0.063s | 0.103s |
| `cci_binary_varbinary_compare_full.bak` | 0.039s | 0.043s | 0.082s |
| `cci_bitpack_probe_bigint_full.bak` | 0.258s | 4.087s | 4.345s |
| `cci_bitpack_probe_full.bak` | 0.077s | 0.624s | 0.701s |
| `cci_bitpack_probe_highbase_full.bak` | 0.062s | 0.404s | 0.466s |
| `cci_btree_nci_full.bak` | 0.041s | 0.04s | 0.081s |
| `cci_computed_full.bak` | 0.048s | 0.033s | 0.081s |
| `cci_enc5_largepool_full.bak` | 0.302s | 0.418s | 0.72s |
| `cci_enc5_largepool_matrix_full.bak` | 7.149s | 1.288s | 8.437s |
| `cci_extended_full.bak` | 0.039s | 0.04s | 0.079s |
| `cci_lob_full.bak` | 0.054s | 0.034s | 0.088s |
| `cci_reorganize_full.bak` | 0.047s | 0.033s | 0.08s |
| `cci_string_dict_regression_full.bak` | 0.275s | 0.127s | 0.402s |
| `cci_string_minmax_full.bak` | 0.035s | 0.031s | 0.066s |
| `cci_switch_full.bak` | 0.045s | 0.032s | 0.077s |
| `cci_types_large_full.bak` | 0.039s | 0.038s | 0.077s |
| `cci_varbinary_micro_full.bak` | 0.052s | 0.031s | 0.083s |
| `cci_varbinary_probe_full.bak` | 0.05s | 0.04s | 0.09s |
| `columnstore_minimal.bak` | 0.125s | 1.407s | 1.532s |
| `compressed_nvarchar_full.bak` | 0.03s | 0.029s | 0.059s |
| `compressioncoverage_full.bak` | 0.081s | 0.168s | 0.249s |
| `computedcoverage_full.bak` | 0.031s | 0.038s | 0.069s |
| `constraintcoverage_full.bak` | 0.04s | 0.035s | 0.075s |
| `covering_index_full.bak` | 0.05s | 0.034s | 0.084s |
| `cs_lob_preamble.bak` | 0.061s | 0.058s | 0.119s |
| `delta_rowgroup_full.bak` | 0.034s | 0.036s | 0.07s |
| `dirtycoverage_aborted_xact.bak` | 0.044s | 0.029s | 0.073s |
| `dirtycoverage_addcol.bak` | 0.044s | 0.027s | 0.071s |
| `dirtycoverage_addnotnull.bak` | 0.048s | 0.03s | 0.078s |
| `dirtycoverage_alldirty.bak` | 0.047s | 0.033s | 0.08s |
| `dirtycoverage_altercol.bak` | 0.033s | 0.04s | 0.073s |
| `dirtycoverage_altercol_rewrite.bak` | 0.047s | 0.028s | 0.075s |
| `dirtycoverage_alterdb.bak` | 0.043s | 0.028s | 0.071s |
| `dirtycoverage_cci_delete.bak` | 0.073s | 0.09s | 0.163s |
| `dirtycoverage_cci_update.bak` | 0.073s | 0.087s | 0.16s |
| `dirtycoverage_committed_delete.bak` | 0.028s | 0.03s | 0.058s |
| `dirtycoverage_committed_delete_v2.bak` | 0.04s | 0.037s | 0.077s |
| `dirtycoverage_committed_delete_v3.bak` | 0.036s | 0.053s | 0.089s |
| `dirtycoverage_committed_delete_v4.bak` | 0.141s | 0.061s | 0.202s |
| `dirtycoverage_committed_update.bak` | 0.028s | 0.03s | 0.058s |
| `dirtycoverage_committed_update_v2.bak` | 0.037s | 0.03s | 0.067s |
| `dirtycoverage_committed_update_v3.bak` | 0.039s | 0.066s | 0.105s |
| `dirtycoverage_committed_update_v4.bak` | 0.158s | 0.071s | 0.229s |
| `dirtycoverage_concurrent.bak` | 0.045s | 0.031s | 0.076s |
| `dirtycoverage_createidx.bak` | 0.047s | 0.036s | 0.083s |
| `dirtycoverage_createtable.bak` | 0.052s | 0.034s | 0.086s |
| `dirtycoverage_delete.bak` | 0.054s | 0.032s | 0.086s |
| `dirtycoverage_dropcol.bak` | 0.043s | 0.028s | 0.071s |
| `dirtycoverage_dropidx.bak` | 0.044s | 0.028s | 0.072s |
| `dirtycoverage_droptable.bak` | 0.045s | 0.038s | 0.083s |
| `dirtycoverage_heap_forward.bak` | 0.045s | 0.029s | 0.074s |
| `dirtycoverage_large_dirty.bak` | 0.314s | 0.031s | 0.345s |
| `dirtycoverage_lob_update.bak` | 0.063s | 0.03s | 0.093s |
| `dirtycoverage_maxrow.bak` | 0.037s | 0.041s | 0.078s |
| `dirtycoverage_nchar_delete.bak` | 0.047s | 0.033s | 0.08s |
| `dirtycoverage_nested.bak` | 0.055s | 0.027s | 0.082s |
| `dirtycoverage_null_update.bak` | 0.044s | 0.029s | 0.073s |
| `dirtycoverage_rebuildidx.bak` | 0.044s | 0.029s | 0.073s |
| `dirtycoverage_rich_insert.bak` | 0.046s | 0.03s | 0.076s |
| `dirtycoverage_rich_update.bak` | 0.047s | 0.031s | 0.078s |
| `dirtycoverage_savepoint.bak` | 0.048s | 0.028s | 0.076s |
| `dirtycoverage_snapshot_update.bak` | 0.051s | 0.033s | 0.084s |
| `dirtycoverage_switch.bak` | 0.051s | 0.031s | 0.082s |
| `dirtycoverage_temporal_update.bak` | 0.049s | 0.031s | 0.08s |
| `dirtycoverage_truncate.bak` | 0.044s | 0.029s | 0.073s |
| `dirtycoverage_two_tx.bak` | 0.05s | 0.031s | 0.081s |
| `dirtycoverage_uncommitted.bak` | 0.046s | 0.036s | 0.082s |
| `dirtycoverage_update.bak` | 0.049s | 0.031s | 0.08s |
| `filtered_ncci_full.bak` | 0.048s | 0.032s | 0.08s |
| `float_extreme_full.bak` | 0.038s | 0.039s | 0.077s |
| `forwarded_records_full.bak` | 0.075s | 0.064s | 0.139s |
| `ghost_records_full.bak` | 0.035s | 0.033s | 0.068s |
| `heapcoverage_large.bak` | 0.041s | 0.063s | 0.104s |
| `heapcoverage_large_50000.bak` | 0.079s | 0.307s | 0.386s |
| `hierarchyid_extract_full.bak` | 0.027s | 0.03s | 0.057s |
| `high_slot_density_full.bak` | 0.04s | 0.187s | 0.227s |
| `identity_coverage_full.bak` | 0.045s | 0.032s | 0.077s |
| `incrementalcoverage_diff_01.bak` | 0.055s | 0.012s | 0.067s |
...
| `incrementalcoverage_diff_05.bak` | 0.045s | 0.014s | 0.059s |
| `incrementalcoverage_diff_06.bak` | 0.05s | 0.018s | 0.068s |
| `incrementalcoverage_full.bak` | 0.031s | 0.029s | 0.06s |
| `layoutcoverage_full.bak` | 0.136s | 0.305s | 0.441s |
| `max_row_width_full.bak` | 0.027s | 0.029s | 0.056s |
| `mixed_collation_full.bak` | 0.028s | 0.036s | 0.064s |
| `multi_rowgroup_full.bak` | 0.03s | 0.036s | 0.066s |
| `ncci_heap_full.bak` | 0.045s | 0.031s | 0.076s |
| `ncci_types_full.bak` | 0.067s | 0.169s | 0.236s |
| `ndfcoverage_full.bak` | 0.029s | 0.031s | 0.06s |
| `nvarchar_max_u21_full.bak` | 0.042s | 0.028s | 0.07s |
| `pagecomp_anchor_full.bak` | 0.115s | 0.09s | 0.205s |
| `pagecomp_long_prefix_full.bak` | 0.028s | 0.029s | 0.057s |
| `pfor_columnstore_full.bak` | 0.101s | 0.831s | 0.932s |
| `pfor_columnstore_random_full.bak` | 0.092s | 0.83s | 0.922s |
| `realworld_numeric_digest_full.bak` | 0.066s | 0.078s | 0.144s |
| `rowboundary_full.bak` | 0.039s | 0.057s | 0.096s |
| `rowstore_hash_pii_full.bak` | 0.039s | 0.032s | 0.071s |
| `rowstore_lob_image_full.bak` | 0.028s | 0.035s | 0.063s |
| `rowstore_lob_markup_full.bak` | 0.028s | 0.028s | 0.056s |
| `rowversion_extract_full.bak` | 0.027s | 0.03s | 0.057s |
| `sparse_full.bak` | 0.076s | 0.084s | 0.16s |
| `spatial_edge_full.bak` | 0.029s | 0.031s | 0.06s |
| `spatial_index_full.bak` | 0.043s | 0.031s | 0.074s |
| `sql_variant_extract_full.bak` | 0.027s | 0.029s | 0.056s |
| `striped_full_1.bak` | 0.041s | 0.021s | 0.062s |
| `striped_single.bak` | 0.039s | 0.043s | 0.082s |
| `surrogate_pairs_full.bak` | 0.029s | 0.028s | 0.057s |
| `tabletype_cci_large_full.bak` | 0.046s | 0.048s | 0.094s |
| `tabletypecoverage_diff.bak` | 0.121s | 0.066s | 0.187s |
| `tabletypecoverage_full.bak` | 0.085s | 0.097s | 0.182s |
| `temporal_hidden_full.bak` | 0.036s | 0.04s | 0.076s |
| `torn_page_full.bak` | 0.052s | 0.041s | 0.093s |
| `typecoverage_full.bak` | 0.06s | 0.066s | 0.126s |
| `typed_xml_full.bak` | 0.033s | 0.027s | 0.06s |
| `unicode_codepage_coverage.bak` | 0.051s | 0.041s | 0.092s |
| `xml_index_full.bak` | 0.043s | 0.03s | 0.073s |
| `xmlcoverage_full.bak` | 0.027s | 0.03s | 0.057s |
| `xmlheap_full.bak` | 0.045s | 0.048s | 0.093s |
| `xtp_checkpoint_straddle_full.bak` | 1.719s | 0.386s | 2.105s |
| `xtp_probe_full.bak` | 0.075s | 0.034s | 0.109s |
| `xtp_rich_full.bak` | 0.055s | 0.033s | 0.088s |
| `xtp_simple_full.bak` | 0.054s | 0.034s | 0.088s |
