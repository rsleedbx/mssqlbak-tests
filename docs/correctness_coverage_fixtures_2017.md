...
|--------|---------|--------|-----------|
| `alias_types_full.bak` | 0.027s | 0.029s | 0.056s |
| `archive_columnstore_partition_full.bak` | 0.878s | 0.937s | 1.815s |
| `archive_columnstore_types_full.bak` | 0.295s | 0.656s | 0.951s |
| `archive_columnstore_types_random_full.bak` | 0.308s | 0.664s | 0.972s |
| `archive_single_chunk_full.bak` | 0.032s | 0.033s | 0.065s |
| `archive_single_chunk_random_full.bak` | 0.032s | 0.042s | 0.074s |
| `archivenull_full.bak` | 0.123s | 0.211s | 0.334s |
| `backup_blocksize_full.bak` | 0.028s | 0.035s | 0.063s |
| `boundarycoverage_datetime_full.bak` | 0.071s | 0.17s | 0.241s |
| `boundarycoverage_full.bak` | 0.053s | 0.087s | 0.14s |
| `cci_binary_varbinary_compare_full.bak` | 0.033s | 0.031s | 0.064s |
| `cci_bitpack_probe_bigint_full.bak` | 0s | 5.961s | 5.961s |
| `cci_bitpack_probe_full.bak` | 0s | 0.625s | 0.625s |
| `cci_bitpack_probe_highbase_full.bak` | 0s | 0.564s | 0.564s |
| `cci_btree_nci_full.bak` | 0.032s | 0.036s | 0.068s |
| `cci_computed_full.bak` | 0.05s | 0.037s | 0.087s |
| `cci_enc5_largepool_full.bak` | 0.311s | 0.474s | 0.785s |
| `cci_enc5_largepool_matrix_full.bak` | 6.949s | 1.391s | 8.34s |
| `cci_extended_full.bak` | 0.042s | 0.046s | 0.088s |
| `cci_lob_full.bak` | 0.06s | 0.041s | 0.101s |
| `cci_reorganize_full.bak` | 0.051s | 0.037s | 0.088s |
| `cci_string_dict_regression_full.bak` | 0.301s | 0.142s | 0.443s |
| `cci_string_minmax_full.bak` | 0.034s | 0.038s | 0.072s |
| `cci_switch_full.bak` | 0.05s | 0.037s | 0.087s |
| `cci_types_large_full.bak` | 0.038s | 0.046s | 0.084s |
| `cci_varbinary_micro_full.bak` | 0.049s | 0.036s | 0.085s |
| `cci_varbinary_probe_full.bak` | 0.05s | 0.04s | 0.09s |
| `columnstore_minimal.bak` | 0.11s | 0.782s | 0.892s |
| `compressed_nvarchar_full.bak` | 0.031s | 0.028s | 0.059s |
| `compressioncoverage_full.bak` | 0.085s | 0.171s | 0.256s |
| `computedcoverage_full.bak` | 0.028s | 0.034s | 0.062s |
| `constraintcoverage_full.bak` | 0.039s | 0.036s | 0.075s |
| `covering_index_full.bak` | 0.043s | 0.041s | 0.084s |
| `cs_lob_preamble.bak` | 0.063s | 0.061s | 0.124s |
| `delta_rowgroup_full.bak` | 0.03s | 0.045s | 0.075s |
| `dirtycoverage_aborted_xact.bak` | 0.045s | 0.029s | 0.074s |
| `dirtycoverage_addcol.bak` | 0.043s | 0.034s | 0.077s |
| `dirtycoverage_addnotnull.bak` | 0.043s | 0.031s | 0.074s |
| `dirtycoverage_alldirty.bak` | 0.048s | 0.027s | 0.075s |
| `dirtycoverage_altercol.bak` | 0.031s | 0.029s | 0.06s |
| `dirtycoverage_altercol_rewrite.bak` | 0.043s | 0.034s | 0.077s |
| `dirtycoverage_alterdb.bak` | 0.043s | 0.03s | 0.073s |
| `dirtycoverage_cci_delete.bak` | 0.077s | 0.085s | 0.162s |
| `dirtycoverage_cci_update.bak` | 0.085s | 0.087s | 0.172s |
| `dirtycoverage_committed_delete.bak` | 0.028s | 0.029s | 0.057s |
| `dirtycoverage_committed_delete_v2.bak` | 0.032s | 0.033s | 0.065s |
| `dirtycoverage_committed_delete_v3.bak` | 0.039s | 0.062s | 0.101s |
| `dirtycoverage_committed_delete_v4.bak` | 0.139s | 0.11s | 0.249s |
| `dirtycoverage_committed_update.bak` | 0.028s | 0.029s | 0.057s |
| `dirtycoverage_committed_update_v2.bak` | 0.029s | 0.036s | 0.065s |
| `dirtycoverage_committed_update_v3.bak` | 0.039s | 0.104s | 0.143s |
| `dirtycoverage_committed_update_v4.bak` | 0.159s | 0.144s | 0.303s |
| `dirtycoverage_concurrent.bak` | 0.046s | 0.029s | 0.075s |
| `dirtycoverage_createidx.bak` | 0.044s | 0.034s | 0.078s |
| `dirtycoverage_createtable.bak` | 0.043s | 0.032s | 0.075s |
| `dirtycoverage_delete.bak` | 0.047s | 0.028s | 0.075s |
| `dirtycoverage_dropcol.bak` | 0.043s | 0.03s | 0.073s |
| `dirtycoverage_dropidx.bak` | 0.043s | 0.03s | 0.073s |
| `dirtycoverage_droptable.bak` | 0.045s | 0.034s | 0.079s |
| `dirtycoverage_heap_forward.bak` | 0.045s | 0.032s | 0.077s |
| `dirtycoverage_large_dirty.bak` | 0.324s | 0.034s | 0.358s |
| `dirtycoverage_lob_update.bak` | 0.072s | 0.035s | 0.107s |
| `dirtycoverage_maxrow.bak` | 0.027s | 0.032s | 0.059s |
| `dirtycoverage_nchar_delete.bak` | 0.047s | 0.029s | 0.076s |
| `dirtycoverage_nested.bak` | 0.046s | 0.029s | 0.075s |
| `dirtycoverage_null_update.bak` | 0.044s | 0.028s | 0.072s |
| `dirtycoverage_rebuildidx.bak` | 0.044s | 0.029s | 0.073s |
| `dirtycoverage_rich_insert.bak` | 0.046s | 0.034s | 0.08s |
| `dirtycoverage_rich_update.bak` | 0.045s | 0.029s | 0.074s |
| `dirtycoverage_savepoint.bak` | 0.049s | 0.033s | 0.082s |
| `dirtycoverage_snapshot_update.bak` | 0.043s | 0.027s | 0.07s |
| `dirtycoverage_switch.bak` | 0.055s | 0.041s | 0.096s |
| `dirtycoverage_temporal_update.bak` | 0.055s | 0.034s | 0.089s |
| `dirtycoverage_truncate.bak` | 0.044s | 0.033s | 0.077s |
| `dirtycoverage_two_tx.bak` | 0.056s | 0.028s | 0.084s |
| `dirtycoverage_uncommitted.bak` | 0.047s | 0.036s | 0.083s |
| `dirtycoverage_update.bak` | 0.048s | 0.032s | 0.08s |
| `filtered_ncci_full.bak` | 0.048s | 0.036s | 0.084s |
| `float_extreme_full.bak` | 0.031s | 0.029s | 0.06s |
| `forwarded_records_full.bak` | 0.063s | 0.086s | 0.149s |
| `ghost_records_full.bak` | 0.027s | 0.034s | 0.061s |
| `heapcoverage_large.bak` | 0.028s | 0.038s | 0.066s |
| `heapcoverage_large_50000.bak` | 0.077s | 0.466s | 0.543s |
| `hierarchyid_extract_full.bak` | 0.028s | 0.03s | 0.058s |
| `high_slot_density_full.bak` | 0.044s | 0.27s | 0.314s |
| `incrementalcoverage_diff_01.bak` | 0.045s | 0.01s | 0.055s |
| `incrementalcoverage_diff_02.bak` | 0.036s | 0.017s | 0.053s |
| `incrementalcoverage_diff_03.bak` | 0.044s | 0.01s | 0.054s |
| `incrementalcoverage_diff_04.bak` | 0.04s | 0.014s | 0.054s |
| `incrementalcoverage_diff_05.bak` | 0.046s | 0.013s | 0.059s |
| `incrementalcoverage_diff_06.bak` | 0.038s | 0.026s | 0.064s |
| `incrementalcoverage_full.bak` | 0.031s | 0.031s | 0.062s |
| `layoutcoverage_full.bak` | 0.147s | 0.283s | 0.43s |
| `max_row_width_full.bak` | 0.026s | 0.033s | 0.059s |
| `mixed_collation_full.bak` | 0.027s | 0.028s | 0.055s |
| `multi_rowgroup_full.bak` | 0.03s | 0.04s | 0.07s |
| `ncci_heap_full.bak` | 0.046s | 0.03s | 0.076s |
| `ncci_types_full.bak` | 0.064s | 0.249s | 0.313s |
| `ndfcoverage_full.bak` | 0.028s | 0.03s | 0.058s |
| `nvarchar_max_u21_full.bak` | 0.031s | 0.031s | 0.062s |
| `pagecomp_anchor_full.bak` | 0.116s | 0.144s | 0.26s |
| `pagecomp_long_prefix_full.bak` | 0.027s | 0.029s | 0.056s |
| `pfor_columnstore_full.bak` | 0.096s | 1.113s | 1.209s |
| `pfor_columnstore_random_full.bak` | 0.105s | 1.114s | 1.219s |
| `realworld_numeric_digest_full.bak` | 0.058s | 0.094s | 0.152s |
| `rowboundary_full.bak` | 0.03s | 0.033s | 0.063s |
| `rowstore_hash_pii_full.bak` | 0.032s | 0.037s | 0.069s |
| `rowstore_lob_image_full.bak` | 0.028s | 0.033s | 0.061s |
| `rowstore_lob_markup_full.bak` | 0.028s | 0.03s | 0.058s |
| `rowversion_extract_full.bak` | 0.028s | 0.031s | 0.059s |
| `sparse_full.bak` | 0.081s | 0.14s | 0.221s |
| `spatial_edge_full.bak` | 0.028s | 0.033s | 0.061s |
| `spatial_index_full.bak` | 0.044s | 0.037s | 0.081s |
| `sql_variant_extract_full.bak` | 0.032s | 0.03s | 0.062s |
| `striped_full_1.bak` | 0.041s | 0.014s | 0.055s |
| `striped_single.bak` | 0.039s | 0.041s | 0.08s |
| `surrogate_pairs_full.bak` | 0.039s | 0.029s | 0.068s |
| `tabletype_cci_large_full.bak` | 0.049s | 0.053s | 0.102s |
| `tabletypecoverage_diff.bak` | 0.132s | 0.072s | 0.204s |
| `tabletypecoverage_full.bak` | 0.09s | 0.092s | 0.182s |
| `temporal_hidden_full.bak` | 0.032s | 0.033s | 0.065s |
| `torn_page_full.bak` | 0.027s | 0.03s | 0.057s |
| `typecoverage_full.bak` | 0.066s | 0.074s | 0.14s |
| `typed_xml_full.bak` | 0.028s | 0.033s | 0.061s |
| `unicode_codepage_coverage.bak` | 0.049s | 0.048s | 0.097s |
| `xml_index_full.bak` | 0.043s | 0.033s | 0.076s |
| `xmlcoverage_full.bak` | 0.033s | 0.03s | 0.063s |
| `xmlheap_full.bak` | 0.045s | 0.06s | 0.105s |
| `xtp_checkpoint_straddle_full.bak` | 0s | 0.419s | 0.419s |
| `xtp_probe_full.bak` | 0.074s | 0.046s | 0.12s |
| `xtp_rich_full.bak` | 0.059s | 0.042s | 0.101s |
| `xtp_simple_full.bak` | 0.055s | 0.033s | 0.088s |
