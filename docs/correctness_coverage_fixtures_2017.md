...
| `archive_columnstore_partition_full.bak` | 2.345s |
| `archive_columnstore_types_full.bak` | 1.326s |
| `archive_columnstore_types_random_full.bak` | 1.298s |
| `archive_single_chunk_full.bak` | 0.07s |
| `archive_single_chunk_random_full.bak` | 0.075s |
| `archivenull_full.bak` | 0.427s |
| `backup_blocksize_full.bak` | 0.201s |
| `boundarycoverage_datetime_full.bak` | 0.354s |
| `boundarycoverage_full.bak` | 0.177s |
| `cci_binary_varbinary_compare_full.bak` | 0.07s |
| `cci_bitpack_probe_bigint_full.bak` | 5.818s |
| `cci_bitpack_probe_full.bak` | 0.689s |
| `cci_bitpack_probe_highbase_full.bak` | 0.65s |
| `cci_btree_nci_full.bak` | 0.084s |
| `cci_computed_full.bak` | 0.124s |
| `cci_enc5_largepool_full.bak` | 1.136s |
| `cci_enc5_largepool_matrix_full.bak` | 9.414s |
| `cci_extended_full.bak` | 0.12s |
| `cci_lob_full.bak` | 0.128s |
| `cci_reorganize_full.bak` | 0.117s |
| `cci_string_dict_regression_full.bak` | 0.489s |
| `cci_string_minmax_full.bak` | 0.098s |
| `cci_switch_full.bak` | 0.113s |
| `cci_types_large_full.bak` | 0.112s |
| `cci_varbinary_micro_full.bak` | 0.159s |
| `cci_varbinary_probe_full.bak` | 0.132s |
| `columnstore_minimal.bak` | 1.041s |
| `compressed_nvarchar_full.bak` | 0.061s |
| `compressioncoverage_full.bak` | 0.335s |
| `computedcoverage_full.bak` | 0.059s |
| `constraintcoverage_full.bak` | 0.082s |
| `covering_index_full.bak` | 0.123s |
| `cs_lob_preamble.bak` | 0.174s |
| `delta_rowgroup_full.bak` | 0.063s |
| `dirtycoverage_aborted_xact.bak` | 0.081s |
| `dirtycoverage_addcol.bak` | 0.085s |
| `dirtycoverage_addnotnull.bak` | 0.088s |
| `dirtycoverage_alldirty.bak` | 0.079s |
| `dirtycoverage_altercol.bak` | 0.111s |
| `dirtycoverage_altercol_rewrite.bak` | 0.074s |
| `dirtycoverage_alterdb.bak` | 0.081s |
| `dirtycoverage_cci_delete.bak` | 0.219s |
| `dirtycoverage_cci_update.bak` | 0.219s |
| `dirtycoverage_committed_delete.bak` | 0.061s |
| `dirtycoverage_committed_delete_v2.bak` | 0.072s |
| `dirtycoverage_committed_delete_v3.bak` | 0.211s |
| `dirtycoverage_committed_delete_v4.bak` | 0.329s |
| `dirtycoverage_committed_update.bak` | 0.065s |
| `dirtycoverage_committed_update_v2.bak` | 0.074s |
| `dirtycoverage_committed_update_v3.bak` | 0.217s |
| `dirtycoverage_committed_update_v4.bak` | 0.382s |
| `dirtycoverage_concurrent.bak` | 0.1s |
| `dirtycoverage_createidx.bak` | 0.084s |
| `dirtycoverage_createtable.bak` | 0.085s |
| `dirtycoverage_delete.bak` | 0.087s |
| `dirtycoverage_dropcol.bak` | 0.078s |
| `dirtycoverage_dropidx.bak` | 0.086s |
| `dirtycoverage_droptable.bak` | 0.105s |
| `dirtycoverage_heap_forward.bak` | 0.079s |
| `dirtycoverage_large_dirty.bak` | 0.362s |
| `dirtycoverage_lob_update.bak` | 0.128s |
| `dirtycoverage_maxrow.bak` | 0.203s |
| `dirtycoverage_nchar_delete.bak` | 0.1s |
| `dirtycoverage_nested.bak` | 0.086s |
| `dirtycoverage_null_update.bak` | 0.077s |
| `dirtycoverage_rebuildidx.bak` | 0.09s |
| `dirtycoverage_rich_insert.bak` | 0.08s |
| `dirtycoverage_rich_update.bak` | 0.08s |
| `dirtycoverage_savepoint.bak` | 0.084s |
| `dirtycoverage_snapshot_update.bak` | 0.076s |
| `dirtycoverage_switch.bak` | 0.129s |
| `dirtycoverage_temporal_update.bak` | 0.211s |
| `dirtycoverage_truncate.bak` | 0.083s |
| `dirtycoverage_two_tx.bak` | 0.092s |
| `dirtycoverage_uncommitted.bak` | 0.095s |
| `dirtycoverage_update.bak` | 0.081s |
| `filtered_ncci_full.bak` | 0.147s |
| `float_extreme_full.bak` | 0.069s |
| `forwarded_records_full.bak` | 0.284s |
| `ghost_records_full.bak` | 0.062s |
| `heapcoverage_large.bak` | 0.077s |
| `heapcoverage_large_50000.bak` | 0.925s |
...
| `incrementalcoverage_diff_04.bak` | 0.06s |
| `incrementalcoverage_diff_05.bak` | 0.068s |
| `incrementalcoverage_diff_06.bak` | 0.047s |
| `incrementalcoverage_full.bak` | 0.06s |
| `layoutcoverage_full.bak` | 0.394s |
| `max_row_width_full.bak` | 0.058s |
| `mixed_collation_full.bak` | 0.058s |
| `multi_rowgroup_full.bak` | 0.071s |
| `ncci_heap_full.bak` | 0.105s |
| `ncci_types_full.bak` | 0.482s |
| `ndfcoverage_full.bak` | 0.065s |
| `nvarchar_max_u21_full.bak` | 0.058s |
| `pagecomp_anchor_full.bak` | 0.353s |
| `pagecomp_long_prefix_full.bak` | 0.065s |
| `pfor_columnstore_full.bak` | 2.206s |
| `pfor_columnstore_random_full.bak` | 2.234s |
| `realworld_numeric_digest_full.bak` | 0.211s |
| `rowboundary_full.bak` | 0.066s |
| `rowstore_hash_pii_full.bak` | 0.065s |
| `rowstore_lob_image_full.bak` | 0.059s |
| `rowstore_lob_markup_full.bak` | 0.061s |
| `rowversion_extract_full.bak` | 0.205s |
| `sparse_full.bak` | 0.3s |
| `spatial_edge_full.bak` | 0.06s |
| `spatial_index_full.bak` | 0.102s |
| `sql_variant_extract_full.bak` | 0.148s |
| `striped_full_1.bak` | 0.056s |
| `striped_single.bak` | 0.122s |
| `surrogate_pairs_full.bak` | 0.068s |
| `tabletype_cci_large_full.bak` | 0.173s |
| `tabletypecoverage_diff.bak` | 1.972s |
| `tabletypecoverage_full.bak` | 0.264s |
| `temporal_hidden_full.bak` | 0.066s |
| `torn_page_full.bak` | 0.062s |
| `typecoverage_full.bak` | 0.308s |
| `typed_xml_full.bak` | 0.062s |
| `unicode_codepage_coverage.bak` | 0.24s |
| `xml_index_full.bak` | 0.083s |
| `xmlcoverage_full.bak` | 0.059s |
| `xmlheap_full.bak` | 0.137s |
| `xtp_checkpoint_straddle_full.bak` | 0.409s |
| `xtp_probe_full.bak` | 0.138s |
| `xtp_rich_full.bak` | 0.215s |
| `xtp_simple_full.bak` | 0.153s |
