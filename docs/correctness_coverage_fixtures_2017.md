...
|--------|---------|--------|-----------|
| `alias_types_full.bak` | 0.032s | 0.034s | 0.066s |
| `archive_columnstore_partition_full.bak` | 0.869s | 0.598s | 1.467s |
| `archive_columnstore_types_full.bak` | 0.316s | 0.67s | 0.986s |
| `archive_columnstore_types_random_full.bak` | 0.304s | 0.661s | 0.965s |
| `archive_single_chunk_full.bak` | 0.032s | 0.033s | 0.065s |
| `archive_single_chunk_random_full.bak` | 0.032s | 0.032s | 0.064s |
| `archivenull_full.bak` | 0.122s | 0.222s | 0.344s |
| `backup_blocksize_full.bak` | 0.035s | 0.025s | 0.06s |
| `boundarycoverage_datetime_full.bak` | 0.06s | 0.143s | 0.203s |
| `boundarycoverage_full.bak` | 0.048s | 0.062s | 0.11s |
| `cci_binary_varbinary_compare_full.bak` | 0.033s | 0.032s | 0.065s |
| `cci_bitpack_probe_bigint_full.bak` | 0.264s | 3.698s | 3.962s |
| `cci_bitpack_probe_full.bak` | 0.074s | 0.63s | 0.704s |
| `cci_bitpack_probe_highbase_full.bak` | 0.062s | 0.409s | 0.471s |
| `cci_btree_nci_full.bak` | 0.032s | 0.036s | 0.068s |
| `cci_computed_full.bak` | 0.048s | 0.033s | 0.081s |
| `cci_enc5_largepool_full.bak` | 0.305s | 0.413s | 0.718s |
| `cci_enc5_largepool_matrix_full.bak` | 6.882s | 1.237s | 8.119s |
| `cci_extended_full.bak` | 0.04s | 0.042s | 0.082s |
| `cci_lob_full.bak` | 0.059s | 0.036s | 0.095s |
| `cci_reorganize_full.bak` | 0.047s | 0.035s | 0.082s |
| `cci_string_dict_regression_full.bak` | 0.279s | 0.122s | 0.401s |
| `cci_string_minmax_full.bak` | 0.034s | 0.032s | 0.066s |
| `cci_switch_full.bak` | 0.046s | 0.035s | 0.081s |
| `cci_types_large_full.bak` | 0.041s | 0.039s | 0.08s |
| `cci_varbinary_micro_full.bak` | 0.049s | 0.039s | 0.088s |
| `cci_varbinary_probe_full.bak` | 0.05s | 0.054s | 0.104s |
| `columnstore_minimal.bak` | 0.117s | 0.948s | 1.065s |
| `compressed_nvarchar_full.bak` | 0.029s | 0.03s | 0.059s |
| `compressioncoverage_full.bak` | 0.084s | 0.166s | 0.25s |
| `computedcoverage_full.bak` | 0.028s | 0.029s | 0.057s |
| `constraintcoverage_full.bak` | 0.031s | 0.039s | 0.07s |
| `covering_index_full.bak` | 0.05s | 0.038s | 0.088s |
| `cs_lob_preamble.bak` | 0.062s | 0.052s | 0.114s |
| `delta_rowgroup_full.bak` | 0.03s | 0.029s | 0.059s |
| `dirtycoverage_aborted_xact.bak` | 0.048s | 0.03s | 0.078s |
| `dirtycoverage_addcol.bak` | 0.043s | 0.028s | 0.071s |
| `dirtycoverage_addnotnull.bak` | 0.044s | 0.03s | 0.074s |
| `dirtycoverage_alldirty.bak` | 0.047s | 0.027s | 0.074s |
| `dirtycoverage_altercol.bak` | 0.027s | 0.036s | 0.063s |
| `dirtycoverage_altercol_rewrite.bak` | 0.043s | 0.027s | 0.07s |
| `dirtycoverage_alterdb.bak` | 0.043s | 0.027s | 0.07s |
| `dirtycoverage_cci_delete.bak` | 0.081s | 0.085s | 0.166s |
| `dirtycoverage_cci_update.bak` | 0.074s | 0.086s | 0.16s |
| `dirtycoverage_committed_delete.bak` | 0.028s | 0.028s | 0.056s |
| `dirtycoverage_committed_delete_v2.bak` | 0.028s | 0.03s | 0.058s |
| `dirtycoverage_committed_delete_v3.bak` | 0.04s | 0.058s | 0.098s |
| `dirtycoverage_committed_delete_v4.bak` | 0.139s | 0.065s | 0.204s |
| `dirtycoverage_committed_update.bak` | 0.028s | 0.028s | 0.056s |
| `dirtycoverage_committed_update_v2.bak` | 0.028s | 0.029s | 0.057s |
| `dirtycoverage_committed_update_v3.bak` | 0.038s | 0.064s | 0.102s |
| `dirtycoverage_committed_update_v4.bak` | 0.154s | 0.074s | 0.228s |
| `dirtycoverage_concurrent.bak` | 0.046s | 0.034s | 0.08s |
| `dirtycoverage_createidx.bak` | 0.046s | 0.033s | 0.079s |
| `dirtycoverage_createtable.bak` | 0.043s | 0.036s | 0.079s |
| `dirtycoverage_delete.bak` | 0.046s | 0.028s | 0.074s |
| `dirtycoverage_dropcol.bak` | 0.042s | 0.029s | 0.071s |
| `dirtycoverage_dropidx.bak` | 0.052s | 0.029s | 0.081s |
| `dirtycoverage_droptable.bak` | 0.047s | 0.03s | 0.077s |
| `dirtycoverage_heap_forward.bak` | 0.044s | 0.03s | 0.074s |
| `dirtycoverage_large_dirty.bak` | 0.319s | 0.03s | 0.349s |
| `dirtycoverage_lob_update.bak` | 0.071s | 0.029s | 0.1s |
| `dirtycoverage_maxrow.bak` | 0.028s | 0.034s | 0.062s |
| `dirtycoverage_nchar_delete.bak` | 0.046s | 0.029s | 0.075s |
| `dirtycoverage_nested.bak` | 0.046s | 0.029s | 0.075s |
| `dirtycoverage_null_update.bak` | 0.045s | 0.033s | 0.078s |
| `dirtycoverage_rebuildidx.bak` | 0.043s | 0.033s | 0.076s |
| `dirtycoverage_rich_insert.bak` | 0.047s | 0.033s | 0.08s |
| `dirtycoverage_rich_update.bak` | 0.045s | 0.035s | 0.08s |
| `dirtycoverage_savepoint.bak` | 0.052s | 0.03s | 0.082s |
| `dirtycoverage_snapshot_update.bak` | 0.043s | 0.043s | 0.086s |
| `dirtycoverage_switch.bak` | 0.05s | 0.031s | 0.081s |
| `dirtycoverage_temporal_update.bak` | 0.049s | 0.028s | 0.077s |
| `dirtycoverage_truncate.bak` | 0.045s | 0.028s | 0.073s |
| `dirtycoverage_two_tx.bak` | 0.047s | 0.032s | 0.079s |
| `dirtycoverage_uncommitted.bak` | 0.045s | 0.029s | 0.074s |
| `dirtycoverage_update.bak` | 0.048s | 0.028s | 0.076s |
| `filtered_ncci_full.bak` | 0.054s | 0.033s | 0.087s |
| `float_extreme_full.bak` | 0.027s | 0.028s | 0.055s |
| `forwarded_records_full.bak` | 0.063s | 0.065s | 0.128s |
| `ghost_records_full.bak` | 0.027s | 0.029s | 0.056s |
| `heapcoverage_large.bak` | 0.028s | 0.035s | 0.063s |
| `heapcoverage_large_50000.bak` | 0.089s | 0.293s | 0.382s |
| `hierarchyid_extract_full.bak` | 0.028s | 0.027s | 0.055s |
| `high_slot_density_full.bak` | 0.036s | 0.185s | 0.221s |
| `identity_coverage_full.bak` | 0.046s | 0.043s | 0.089s |
| `incrementalcoverage_diff_01.bak` | 0.032s | 0.009s | 0.041s |
| `incrementalcoverage_diff_02.bak` | 0.036s | 0.01s | 0.046s |
| `incrementalcoverage_diff_03.bak` | 0.032s | 0.009s | 0.041s |
| `incrementalcoverage_diff_04.bak` | 0.032s | 0.01s | 0.042s |
| `incrementalcoverage_diff_05.bak` | 0.033s | 0.01s | 0.043s |
| `incrementalcoverage_diff_06.bak` | 0.032s | 0.01s | 0.042s |
| `incrementalcoverage_full.bak` | 0.027s | 0.025s | 0.052s |
| `layoutcoverage_full.bak` | 0.142s | 0.33s | 0.472s |
| `max_row_width_full.bak` | 0.027s | 0.027s | 0.054s |
| `mixed_collation_full.bak` | 0.028s | 0.028s | 0.056s |
| `multi_rowgroup_full.bak` | 0.031s | 0.036s | 0.067s |
| `ncci_heap_full.bak` | 0.045s | 0.033s | 0.078s |
| `ncci_types_full.bak` | 0.063s | 0.155s | 0.218s |
| `ndfcoverage_full.bak` | 0.028s | 0.029s | 0.057s |
| `nvarchar_max_u21_full.bak` | 0.027s | 0.028s | 0.055s |
| `pagecomp_anchor_full.bak` | 0.117s | 0.093s | 0.21s |
| `pagecomp_long_prefix_full.bak` | 0.026s | 0.028s | 0.054s |
| `pfor_columnstore_full.bak` | 0.089s | 0.814s | 0.903s |
| `pfor_columnstore_random_full.bak` | 0.089s | 0.8s | 0.889s |
| `realworld_numeric_digest_full.bak` | 0.059s | 0.074s | 0.133s |
| `rowboundary_full.bak` | 0.029s | 0.027s | 0.056s |
| `rowstore_hash_pii_full.bak` | 0.028s | 0.029s | 0.057s |
| `rowstore_lob_image_full.bak` | 0.027s | 0.029s | 0.056s |
| `rowstore_lob_markup_full.bak` | 0.027s | 0.031s | 0.058s |
| `rowversion_extract_full.bak` | 0.027s | 0.032s | 0.059s |
| `sparse_full.bak` | 0.075s | 0.084s | 0.159s |
| `spatial_edge_full.bak` | 0.03s | 0.034s | 0.064s |
| `spatial_index_full.bak` | 0.043s | 0.032s | 0.075s |
| `sql_variant_extract_full.bak` | 0.038s | 0.03s | 0.068s |
| `striped_full_1.bak` | 0.041s | 0.012s | 0.053s |
| `striped_single.bak` | 0.039s | 0.04s | 0.079s |
| `surrogate_pairs_full.bak` | 0.027s | 0.03s | 0.057s |
| `tabletype_cci_large_full.bak` | 0.056s | 0.059s | 0.115s |
| `tabletypecoverage_diff.bak` | 0.112s | 0.066s | 0.178s |
| `tabletypecoverage_full.bak` | 0.09s | 0.072s | 0.162s |
| `temporal_hidden_full.bak` | 0.028s | 0.033s | 0.061s |
| `torn_page_full.bak` | 0.034s | 0.031s | 0.065s |
| `typecoverage_full.bak` | 0.064s | 0.07s | 0.134s |
| `typed_xml_full.bak` | 0.029s | 0.033s | 0.062s |
| `unicode_codepage_coverage.bak` | 0.051s | 0.049s | 0.1s |
| `xml_index_full.bak` | 0.044s | 0.041s | 0.085s |
| `xmlcoverage_full.bak` | 0.027s | 0.031s | 0.058s |
| `xmlheap_full.bak` | 0.049s | 0.058s | 0.107s |
| `xtp_checkpoint_straddle_full.bak` | 1.7s | 0.363s | 2.063s |
| `xtp_probe_full.bak` | 0.073s | 0.032s | 0.105s |
| `xtp_rich_full.bak` | 0.064s | 0.039s | 0.103s |
| `xtp_simple_full.bak` | 0.057s | 0.04s | 0.097s |
