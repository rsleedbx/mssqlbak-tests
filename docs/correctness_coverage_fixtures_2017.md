...
|--------|---------|--------|-----------|
| `alias_types_full.bak` | 0.029s | 0.029s | 0.058s |
| `archive_columnstore_partition_full.bak` | 0.918s | 0.712s | 1.63s |
| `archive_columnstore_types_full.bak` | 0.332s | 0.72s | 1.052s |
| `archive_columnstore_types_random_full.bak` | 0.334s | 0.704s | 1.038s |
| `archive_single_chunk_full.bak` | 0.036s | 0.036s | 0.072s |
| `archive_single_chunk_random_full.bak` | 0.038s | 0.033s | 0.071s |
| `archivenull_full.bak` | 0.123s | 0.213s | 0.336s |
| `backup_blocksize_full.bak` | 0.04s | 0.037s | 0.077s |
| `boundarycoverage_datetime_full.bak` | 0.061s | 0.156s | 0.217s |
| `boundarycoverage_full.bak` | 0.044s | 0.068s | 0.112s |
| `cci_binary_varbinary_compare_full.bak` | 0.04s | 0.037s | 0.077s |
| `cci_bitpack_probe_bigint_full.bak` | 0.275s | 3.988s | 4.263s |
| `cci_bitpack_probe_full.bak` | 0.071s | 0.68s | 0.751s |
| `cci_bitpack_probe_highbase_full.bak` | 0.061s | 0.428s | 0.489s |
| `cci_btree_nci_full.bak` | 0.038s | 0.039s | 0.077s |
| `cci_computed_full.bak` | 0.051s | 0.044s | 0.095s |
| `cci_enc5_largepool_full.bak` | 0.343s | 0.453s | 0.796s |
| `cci_enc5_largepool_matrix_full.bak` | 7.351s | 1.315s | 8.666s |
| `cci_extended_full.bak` | 0.062s | 0.046s | 0.108s |
| `cci_lob_full.bak` | 0.057s | 0.038s | 0.095s |
| `cci_reorganize_full.bak` | 0.052s | 0.042s | 0.094s |
| `cci_string_dict_regression_full.bak` | 0.319s | 0.146s | 0.465s |
| `cci_string_minmax_full.bak` | 0.051s | 0.037s | 0.088s |
| `cci_switch_full.bak` | 0.049s | 0.043s | 0.092s |
| `cci_types_large_full.bak` | 0.042s | 0.044s | 0.086s |
| `cci_varbinary_micro_full.bak` | 0.052s | 0.03s | 0.082s |
| `cci_varbinary_probe_full.bak` | 0.063s | 0.044s | 0.107s |
| `columnstore_minimal.bak` | 0.142s | 1.052s | 1.194s |
| `compressed_nvarchar_full.bak` | 0.033s | 0.033s | 0.066s |
| `compressioncoverage_full.bak` | 0.095s | 0.175s | 0.27s |
| `computedcoverage_full.bak` | 0.037s | 0.038s | 0.075s |
| `constraintcoverage_full.bak` | 0.034s | 0.041s | 0.075s |
| `covering_index_full.bak` | 0.044s | 0.033s | 0.077s |
| `cs_lob_preamble.bak` | 0.065s | 0.058s | 0.123s |
| `delta_rowgroup_full.bak` | 0.038s | 0.036s | 0.074s |
| `dirtycoverage_aborted_xact.bak` | 0.048s | 0.034s | 0.082s |
| `dirtycoverage_addcol.bak` | 0.044s | 0.028s | 0.072s |
| `dirtycoverage_addnotnull.bak` | 0.044s | 0.039s | 0.083s |
| `dirtycoverage_alldirty.bak` | 0.049s | 0.028s | 0.077s |
| `dirtycoverage_altercol.bak` | 0.032s | 0.035s | 0.067s |
| `dirtycoverage_altercol_rewrite.bak` | 0.048s | 0.032s | 0.08s |
| `dirtycoverage_alterdb.bak` | 0.045s | 0.031s | 0.076s |
| `dirtycoverage_cci_delete.bak` | 0.08s | 0.095s | 0.175s |
| `dirtycoverage_cci_update.bak` | 0.088s | 0.094s | 0.182s |
| `dirtycoverage_committed_delete.bak` | 0.036s | 0.035s | 0.071s |
| `dirtycoverage_committed_delete_v2.bak` | 0.036s | 0.033s | 0.069s |
| `dirtycoverage_committed_delete_v3.bak` | 0.036s | 0.059s | 0.095s |
| `dirtycoverage_committed_delete_v4.bak` | 0.146s | 0.064s | 0.21s |
| `dirtycoverage_committed_update.bak` | 0.046s | 0.04s | 0.086s |
| `dirtycoverage_committed_update_v2.bak` | 0.038s | 0.038s | 0.076s |
| `dirtycoverage_committed_update_v3.bak` | 0.048s | 0.067s | 0.115s |
| `dirtycoverage_committed_update_v4.bak` | 0.168s | 0.071s | 0.239s |
| `dirtycoverage_concurrent.bak` | 0.05s | 0.034s | 0.084s |
| `dirtycoverage_createidx.bak` | 0.046s | 0.031s | 0.077s |
| `dirtycoverage_createtable.bak` | 0.046s | 0.033s | 0.079s |
| `dirtycoverage_delete.bak` | 0.048s | 0.03s | 0.078s |
| `dirtycoverage_dropcol.bak` | 0.045s | 0.028s | 0.073s |
| `dirtycoverage_dropidx.bak` | 0.046s | 0.035s | 0.081s |
| `dirtycoverage_droptable.bak` | 0.049s | 0.031s | 0.08s |
| `dirtycoverage_heap_forward.bak` | 0.046s | 0.03s | 0.076s |
| `dirtycoverage_large_dirty.bak` | 0.334s | 0.03s | 0.364s |
| `dirtycoverage_lob_update.bak` | 0.07s | 0.03s | 0.1s |
| `dirtycoverage_maxrow.bak` | 0.036s | 0.035s | 0.071s |
| `dirtycoverage_nchar_delete.bak` | 0.048s | 0.032s | 0.08s |
| `dirtycoverage_nested.bak` | 0.049s | 0.032s | 0.081s |
| `dirtycoverage_null_update.bak` | 0.046s | 0.034s | 0.08s |
| `dirtycoverage_rebuildidx.bak` | 0.046s | 0.029s | 0.075s |
| `dirtycoverage_rich_insert.bak` | 0.049s | 0.033s | 0.082s |
| `dirtycoverage_rich_update.bak` | 0.049s | 0.033s | 0.082s |
| `dirtycoverage_savepoint.bak` | 0.052s | 0.038s | 0.09s |
| `dirtycoverage_snapshot_update.bak` | 0.054s | 0.034s | 0.088s |
| `dirtycoverage_switch.bak` | 0.056s | 0.036s | 0.092s |
| `dirtycoverage_temporal_update.bak` | 0.052s | 0.031s | 0.083s |
| `dirtycoverage_truncate.bak` | 0.046s | 0.031s | 0.077s |
| `dirtycoverage_two_tx.bak` | 0.052s | 0.031s | 0.083s |
| `dirtycoverage_uncommitted.bak` | 0.047s | 0.03s | 0.077s |
| `dirtycoverage_update.bak` | 0.05s | 0.032s | 0.082s |
| `filtered_ncci_full.bak` | 0.06s | 0.033s | 0.093s |
| `float_extreme_full.bak` | 0.036s | 0.03s | 0.066s |
| `forwarded_records_full.bak` | 0.076s | 0.073s | 0.149s |
| `ghost_records_full.bak` | 0.036s | 0.037s | 0.073s |
| `heapcoverage_large.bak` | 0.039s | 0.042s | 0.081s |
| `heapcoverage_large_50000.bak` | 0.089s | 0.324s | 0.413s |
| `hierarchyid_extract_full.bak` | 0.032s | 0.033s | 0.065s |
| `high_slot_density_full.bak` | 0.037s | 0.194s | 0.231s |
| `identity_coverage_full.bak` | 0.047s | 0.033s | 0.08s |
| `incrementalcoverage_diff_01.bak` | 0.06s | 0.017s | 0.077s |
| `incrementalcoverage_diff_02.bak` | 0.045s | 0.012s | 0.057s |
| `incrementalcoverage_diff_03.bak` | 0.045s | 0.017s | 0.062s |
| `incrementalcoverage_diff_04.bak` | 0.054s | 0.018s | 0.072s |
| `incrementalcoverage_diff_05.bak` | 0.056s | 0.016s | 0.072s |
| `incrementalcoverage_diff_06.bak` | 0.058s | 0.016s | 0.074s |
| `incrementalcoverage_full.bak` | 0.03s | 0.032s | 0.062s |
| `layoutcoverage_full.bak` | 0.149s | 0.356s | 0.505s |
| `max_row_width_full.bak` | 0.032s | 0.031s | 0.063s |
| `mixed_collation_full.bak` | 0.04s | 0.038s | 0.078s |
| `multi_rowgroup_full.bak` | 0.033s | 0.038s | 0.071s |
| `ncci_heap_full.bak` | 0.049s | 0.034s | 0.083s |
| `ncci_types_full.bak` | 0.067s | 0.195s | 0.262s |
| `ndfcoverage_full.bak` | 0.041s | 0.035s | 0.076s |
| `nvarchar_max_u21_full.bak` | 0.035s | 0.033s | 0.068s |
| `pagecomp_anchor_full.bak` | 0.125s | 0.096s | 0.221s |
| `pagecomp_long_prefix_full.bak` | 0.031s | 0.032s | 0.063s |
| `pfor_columnstore_full.bak` | 0.099s | 0.862s | 0.961s |
| `pfor_columnstore_random_full.bak` | 0.09s | 0.814s | 0.904s |
| `realworld_numeric_digest_full.bak` | 0.063s | 0.088s | 0.151s |
| `rowboundary_full.bak` | 0.034s | 0.04s | 0.074s |
| `rowstore_hash_pii_full.bak` | 0.038s | 0.04s | 0.078s |
| `rowstore_lob_image_full.bak` | 0.033s | 0.036s | 0.069s |
| `rowstore_lob_markup_full.bak` | 0.042s | 0.035s | 0.077s |
| `rowversion_extract_full.bak` | 0.032s | 0.038s | 0.07s |
| `sparse_full.bak` | 0.084s | 0.09s | 0.174s |
| `spatial_edge_full.bak` | 0.039s | 0.035s | 0.074s |
| `spatial_index_full.bak` | 0.046s | 0.032s | 0.078s |
| `sql_variant_extract_full.bak` | 0.032s | 0.032s | 0.064s |
| `striped_full_1.bak` | 0.054s | 0.023s | 0.077s |
| `striped_single.bak` | 0.049s | 0.042s | 0.091s |
| `surrogate_pairs_full.bak` | 0.038s | 0.049s | 0.087s |
| `tabletype_cci_large_full.bak` | 0.053s | 0.043s | 0.096s |
| `tabletypecoverage_diff.bak` | 0.121s | 0.07s | 0.191s |
| `tabletypecoverage_full.bak` | 0.098s | 0.086s | 0.184s |
| `temporal_hidden_full.bak` | 0.037s | 0.038s | 0.075s |
| `torn_page_full.bak` | 0.035s | 0.035s | 0.07s |
| `typecoverage_full.bak` | 0.067s | 0.062s | 0.129s |
| `typed_xml_full.bak` | 0.037s | 0.037s | 0.074s |
| `unicode_codepage_coverage.bak` | 0.046s | 0.042s | 0.088s |
| `xml_index_full.bak` | 0.052s | 0.031s | 0.083s |
| `xmlcoverage_full.bak` | 0.036s | 0.038s | 0.074s |
| `xmlheap_full.bak` | 0.054s | 0.049s | 0.103s |
| `xtp_checkpoint_straddle_full.bak` | 1.893s | 0.366s | 2.259s |
| `xtp_probe_full.bak` | 0.076s | 0.036s | 0.112s |
| `xtp_rich_full.bak` | 0.06s | 0.036s | 0.096s |
| `xtp_simple_full.bak` | 0.058s | 0.034s | 0.092s |
