...
| `archive_columnstore_partition_full.bak` | 0.854s | 0.604s | 1.458s |
| `archive_columnstore_types_full.bak` | 0.301s | 0.714s | 1.015s |
| `archive_columnstore_types_random_full.bak` | 0.308s | 0.702s | 1.01s |
| `archive_single_chunk_full.bak` | 0.033s | 0.031s | 0.064s |
| `archive_single_chunk_random_full.bak` | 0.033s | 0.033s | 0.066s |
| `archivenull_full.bak` | 0.146s | 0.238s | 0.384s |
| `backup_blocksize_full.bak` | 0.033s | 0.038s | 0.071s |
| `boundarycoverage_datetime_full.bak` | 0.068s | 0.146s | 0.214s |
| `boundarycoverage_full.bak` | 0.049s | 0.072s | 0.121s |
| `cci_binary_varbinary_compare_full.bak` | 0.035s | 0.033s | 0.068s |
| `cci_bitpack_probe_bigint_full.bak` | 0.253s | 3.747s | 4.0s |
| `cci_bitpack_probe_full.bak` | 0.081s | 0.668s | 0.749s |
| `cci_bitpack_probe_highbase_full.bak` | 0.064s | 0.445s | 0.509s |
| `cci_btree_nci_full.bak` | 0.037s | 0.035s | 0.072s |
| `cci_computed_full.bak` | 0.056s | 0.038s | 0.094s |
| `cci_enc5_largepool_full.bak` | 0.317s | 0.447s | 0.764s |
| `cci_enc5_largepool_matrix_full.bak` | 7.168s | 1.271s | 8.439s |
| `cci_extended_full.bak` | 0.058s | 0.045s | 0.103s |
| `cci_lob_full.bak` | 0.056s | 0.037s | 0.093s |
| `cci_reorganize_full.bak` | 0.056s | 0.032s | 0.088s |
| `cci_string_dict_regression_full.bak` | 0.304s | 0.236s | 0.54s |
| `cci_string_minmax_full.bak` | 0.037s | 0.045s | 0.082s |
| `cci_switch_full.bak` | 0.047s | 0.04s | 0.087s |
| `cci_types_large_full.bak` | 0.047s | 0.046s | 0.093s |
| `cci_varbinary_micro_full.bak` | 0.049s | 0.031s | 0.08s |
| `cci_varbinary_probe_full.bak` | 0.062s | 0.048s | 0.11s |
| `columnstore_minimal.bak` | 0.118s | 0.944s | 1.062s |
| `compressed_nvarchar_full.bak` | 0.027s | 0.03s | 0.057s |
| `compressioncoverage_full.bak` | 0.094s | 0.193s | 0.287s |
| `computedcoverage_full.bak` | 0.028s | 0.039s | 0.067s |
| `constraintcoverage_full.bak` | 0.035s | 0.039s | 0.074s |
| `covering_index_full.bak` | 0.052s | 0.042s | 0.094s |
| `cs_lob_preamble.bak` | 0.087s | 0.064s | 0.151s |
| `delta_rowgroup_full.bak` | 0.03s | 0.036s | 0.066s |
| `dirtycoverage_aborted_xact.bak` | 0.055s | 0.029s | 0.084s |
| `dirtycoverage_addcol.bak` | 0.045s | 0.036s | 0.081s |
| `dirtycoverage_addnotnull.bak` | 0.046s | 0.028s | 0.074s |
| `dirtycoverage_alldirty.bak` | 0.048s | 0.03s | 0.078s |
| `dirtycoverage_altercol.bak` | 0.035s | 0.033s | 0.068s |
| `dirtycoverage_altercol_rewrite.bak` | 0.043s | 0.032s | 0.075s |
| `dirtycoverage_alterdb.bak` | 0.053s | 0.032s | 0.085s |
| `dirtycoverage_cci_delete.bak` | 0.085s | 0.094s | 0.179s |
| `dirtycoverage_cci_update.bak` | 0.077s | 0.098s | 0.175s |
| `dirtycoverage_committed_delete.bak` | 0.036s | 0.028s | 0.064s |
| `dirtycoverage_committed_delete_v2.bak` | 0.037s | 0.035s | 0.072s |
| `dirtycoverage_committed_delete_v3.bak` | 0.04s | 0.056s | 0.096s |
| `dirtycoverage_committed_delete_v4.bak` | 0.163s | 0.073s | 0.236s |
| `dirtycoverage_committed_update.bak` | 0.028s | 0.032s | 0.06s |
| `dirtycoverage_committed_update_v2.bak` | 0.032s | 0.031s | 0.063s |
| `dirtycoverage_committed_update_v3.bak` | 0.051s | 0.068s | 0.119s |
| `dirtycoverage_committed_update_v4.bak` | 0.162s | 0.079s | 0.241s |
| `dirtycoverage_concurrent.bak` | 0.054s | 0.029s | 0.083s |
| `dirtycoverage_createidx.bak` | 0.044s | 0.034s | 0.078s |
| `dirtycoverage_createtable.bak` | 0.045s | 0.028s | 0.073s |
| `dirtycoverage_delete.bak` | 0.046s | 0.028s | 0.074s |
| `dirtycoverage_dropcol.bak` | 0.047s | 0.029s | 0.076s |
| `dirtycoverage_dropidx.bak` | 0.051s | 0.034s | 0.085s |
| `dirtycoverage_droptable.bak` | 0.045s | 0.038s | 0.083s |
| `dirtycoverage_heap_forward.bak` | 0.047s | 0.038s | 0.085s |
| `dirtycoverage_large_dirty.bak` | 0.356s | 0.052s | 0.408s |
| `dirtycoverage_lob_update.bak` | 0.075s | 0.035s | 0.11s |
| `dirtycoverage_maxrow.bak` | 0.027s | 0.028s | 0.055s |
| `dirtycoverage_nchar_delete.bak` | 0.055s | 0.029s | 0.084s |
| `dirtycoverage_nested.bak` | 0.05s | 0.029s | 0.079s |
| `dirtycoverage_null_update.bak` | 0.051s | 0.033s | 0.084s |
| `dirtycoverage_rebuildidx.bak` | 0.048s | 0.029s | 0.077s |
| `dirtycoverage_rich_insert.bak` | 0.054s | 0.034s | 0.088s |
| `dirtycoverage_rich_update.bak` | 0.045s | 0.031s | 0.076s |
| `dirtycoverage_savepoint.bak` | 0.055s | 0.034s | 0.089s |
| `dirtycoverage_snapshot_update.bak` | 0.044s | 0.029s | 0.073s |
| `dirtycoverage_switch.bak` | 0.058s | 0.038s | 0.096s |
| `dirtycoverage_temporal_update.bak` | 0.052s | 0.032s | 0.084s |
| `dirtycoverage_truncate.bak` | 0.057s | 0.032s | 0.089s |
| `dirtycoverage_two_tx.bak` | 0.061s | 0.029s | 0.09s |
| `dirtycoverage_uncommitted.bak` | 0.052s | 0.03s | 0.082s |
| `dirtycoverage_update.bak` | 0.048s | 0.031s | 0.079s |
| `filtered_ncci_full.bak` | 0.049s | 0.037s | 0.086s |
| `float_extreme_full.bak` | 0.027s | 0.03s | 0.057s |
| `forwarded_records_full.bak` | 0.074s | 0.075s | 0.149s |
| `ghost_records_full.bak` | 0.032s | 0.041s | 0.073s |
| `heapcoverage_large.bak` | 0.031s | 0.039s | 0.07s |
| `heapcoverage_large_50000.bak` | 0.108s | 0.454s | 0.562s |
| `hierarchyid_extract_full.bak` | 0.027s | 0.033s | 0.06s |
| `high_slot_density_full.bak` | 0.039s | 0.199s | 0.238s |
| `identity_coverage_full.bak` | 0.046s | 0.035s | 0.081s |
| `incrementalcoverage_diff_01.bak` | 0.048s | 0.009s | 0.057s |
| `incrementalcoverage_diff_02.bak` | 0.032s | 0.011s | 0.043s |
| `incrementalcoverage_diff_03.bak` | 0.033s | 0.019s | 0.052s |
| `incrementalcoverage_diff_04.bak` | 0.054s | 0.02s | 0.074s |
| `incrementalcoverage_diff_05.bak` | 0.033s | 0.009s | 0.042s |
| `incrementalcoverage_diff_06.bak` | 0.044s | 0.01s | 0.054s |
| `incrementalcoverage_full.bak` | 0.042s | 0.024s | 0.066s |
| `layoutcoverage_full.bak` | 0.154s | 0.39s | 0.544s |
| `max_row_width_full.bak` | 0.026s | 0.034s | 0.06s |
| `mixed_collation_full.bak` | 0.028s | 0.033s | 0.061s |
| `multi_rowgroup_full.bak` | 0.043s | 0.039s | 0.082s |
| `ncci_heap_full.bak` | 0.05s | 0.031s | 0.081s |
| `ncci_types_full.bak` | 0.076s | 0.174s | 0.25s |
| `ndfcoverage_full.bak` | 0.028s | 0.036s | 0.064s |
| `nvarchar_max_u21_full.bak` | 0.032s | 0.03s | 0.062s |
| `pagecomp_anchor_full.bak` | 0.242s | 0.1s | 0.342s |
| `pagecomp_long_prefix_full.bak` | 0.035s | 0.027s | 0.062s |
| `pfor_columnstore_full.bak` | 0.093s | 0.838s | 0.931s |
| `pfor_columnstore_random_full.bak` | 0.09s | 0.839s | 0.929s |
| `realworld_numeric_digest_full.bak` | 0.066s | 0.076s | 0.142s |
| `rowboundary_full.bak` | 0.034s | 0.036s | 0.07s |
| `rowstore_hash_pii_full.bak` | 0.027s | 0.029s | 0.056s |
| `rowstore_lob_image_full.bak` | 0.03s | 0.031s | 0.061s |
| `rowstore_lob_markup_full.bak` | 0.031s | 0.029s | 0.06s |
| `rowversion_extract_full.bak` | 0.04s | 0.049s | 0.089s |
| `sparse_full.bak` | 0.085s | 0.094s | 0.179s |
| `spatial_edge_full.bak` | 0.038s | 0.038s | 0.076s |
| `spatial_index_full.bak` | 0.044s | 0.031s | 0.075s |
| `sql_variant_extract_full.bak` | 0.034s | 0.027s | 0.061s |
| `striped_full_1.bak` | 0.041s | 0.012s | 0.053s |
| `striped_single.bak` | 0.06s | 0.043s | 0.103s |
| `surrogate_pairs_full.bak` | 0.027s | 0.039s | 0.066s |
| `tabletype_cci_large_full.bak` | 0.064s | 0.057s | 0.121s |
| `tabletypecoverage_diff.bak` | 0.127s | 0.067s | 0.194s |
| `tabletypecoverage_full.bak` | 0.094s | 0.117s | 0.211s |
| `temporal_hidden_full.bak` | 0.033s | 0.041s | 0.074s |
| `torn_page_full.bak` | 0.035s | 0.036s | 0.071s |
| `typecoverage_full.bak` | 0.085s | 0.077s | 0.162s |
| `typed_xml_full.bak` | 0.03s | 0.033s | 0.063s |
| `unicode_codepage_coverage.bak` | 0.052s | 0.062s | 0.114s |
| `xml_index_full.bak` | 0.043s | 0.032s | 0.075s |
| `xmlcoverage_full.bak` | 0.032s | 0.032s | 0.064s |
| `xmlheap_full.bak` | 0.057s | 0.06s | 0.117s |
| `xtp_checkpoint_straddle_full.bak` | 1.687s | 0.354s | 2.041s |
| `xtp_probe_full.bak` | 0.076s | 0.041s | 0.117s |
| `xtp_rich_full.bak` | 0.055s | 0.04s | 0.095s |
| `xtp_simple_full.bak` | 0.055s | 0.035s | 0.09s |
