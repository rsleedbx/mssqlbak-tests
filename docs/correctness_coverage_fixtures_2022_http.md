...
|--------|---------|--------|-----------|
| `alias_types_full.bak` | 0.052s | 0.035s | 0.087s |
| `archive_columnstore_partition_full.bak` | 0.991s | 0.624s | 1.615s |
| `archive_columnstore_types_full.bak` | 0.366s | 0.718s | 1.084s |
| `archive_columnstore_types_random_full.bak` | 0.379s | 0.718s | 1.097s |
| `archive_single_chunk_full.bak` | 0.062s | 0.048s | 0.11s |
| `archive_single_chunk_random_full.bak` | 0.058s | 0.037s | 0.095s |
| `archivenull_full.bak` | 0.145s | 0.106s | 0.251s |
| `backup_blocksize_full.bak` | 0.051s | 0.038s | 0.089s |
| `boundarycoverage_datetime_full.bak` | 0.083s | 0.166s | 0.249s |
| `boundarycoverage_full.bak` | 0.066s | 0.075s | 0.141s |
| `catalog_ss2022.bak` | 0.047s | 0.034s | 0.081s |
| `cci_binary_varbinary_compare_full.bak` | 0.055s | 0.043s | 0.098s |
| `cci_bitpack_probe_bigint_full.bak` | 1.368s | 3.918s | 5.286s |
| `cci_bitpack_probe_full.bak` | 0.139s | 0.689s | 0.828s |
| `cci_bitpack_probe_highbase_full.bak` | 0.131s | 0.454s | 0.585s |
| `cci_btree_nci_full.bak` | 0.07s | 0.055s | 0.125s |
| `cci_computed_full.bak` | 0.061s | 0.041s | 0.102s |
| `cci_enc5_largepool_full.bak` | 0.4s | 0.459s | 0.859s |
| `cci_enc5_largepool_matrix_full.bak` | 7.484s | 1.342s | 8.826s |
| `cci_extended_full.bak` | 0.068s | 0.048s | 0.116s |
| `cci_lob_full.bak` | 0.072s | 0.057s | 0.129s |
| `cci_reorganize_full.bak` | 0.068s | 0.057s | 0.125s |
| `cci_string_dict_regression_full.bak` | 0.372s | 0.146s | 0.518s |
| `cci_string_minmax_full.bak` | 0.072s | 0.044s | 0.116s |
| `cci_switch_full.bak` | 0.055s | 0.037s | 0.092s |
| `cci_types_large_full.bak` | 0.07s | 0.05s | 0.12s |
| `cci_varbinary_micro_full.bak` | 0.055s | 0.044s | 0.099s |
| `cci_varbinary_probe_full.bak` | 0.057s | 0.046s | 0.103s |
| `columnstore_minimal.bak` | 0.14s | 1.062s | 1.202s |
| `compressed_nvarchar_full.bak` | 0.05s | 0.035s | 0.085s |
| `compressioncoverage_full.bak` | 0.106s | 0.196s | 0.302s |
| `computedcoverage_full.bak` | 0.055s | 0.034s | 0.089s |
| `constraintcoverage_full.bak` | 0.059s | 0.043s | 0.102s |
| `corrupt_metadata_confidence_full.bak` | 0s | 0.002s | 0.002s |
| `covering_index_full.bak` | 0.048s | 0.046s | 0.094s |
| `cs_lob_preamble.bak` | 0.162s | 0.085s | 0.247s |
| `cs_lob_preamble2.bak` | 0.104s | 0.058s | 0.162s |
| `delta_rowgroup_full.bak` | 0.049s | 0.035s | 0.084s |
| `dirtycoverage_aborted_xact.bak` | 0.076s | 0.035s | 0.111s |
| `dirtycoverage_addcol.bak` | 0.06s | 0.047s | 0.107s |
| `dirtycoverage_addnotnull.bak` | 0.053s | 0.044s | 0.097s |
| `dirtycoverage_alldirty.bak` | 0.078s | 0.033s | 0.111s |
| `dirtycoverage_altercol.bak` | 0.053s | 0.033s | 0.086s |
| `dirtycoverage_altercol_rewrite.bak` | 0.052s | 0.039s | 0.091s |
| `dirtycoverage_alterdb.bak` | 0.072s | 0.044s | 0.116s |
| `dirtycoverage_cci_delete.bak` | 0.117s | 0.093s | 0.21s |
| `dirtycoverage_cci_update.bak` | 0.236s | 0.101s | 0.337s |
| `dirtycoverage_committed_delete.bak` | 0.049s | 0.035s | 0.084s |
| `dirtycoverage_committed_delete_v2.bak` | 3.478s | 0.601s | 4.079s |
| `dirtycoverage_committed_delete_v3.bak` | 0.065s | 0.063s | 0.128s |
| `dirtycoverage_committed_delete_v4.bak` | 0.167s | 0.072s | 0.239s |
| `dirtycoverage_committed_update.bak` | 0.047s | 0.034s | 0.081s |
| `dirtycoverage_committed_update_v2.bak` | 12.688s | 0.888s | 13.576s |
| `dirtycoverage_committed_update_v3.bak` | 0.064s | 0.077s | 0.141s |
| `dirtycoverage_committed_update_v4.bak` | 0.118s | 0.078s | 0.196s |
| `dirtycoverage_compress_update.bak` | 0.087s | 0.035s | 0.122s |
| `dirtycoverage_concurrent.bak` | 0.055s | 0.037s | 0.092s |
| `dirtycoverage_createidx.bak` | 0.058s | 0.044s | 0.102s |
| `dirtycoverage_createtable.bak` | 0.053s | 0.041s | 0.094s |
| `dirtycoverage_delete.bak` | 0.087s | 0.036s | 0.123s |
| `dirtycoverage_dropcol.bak` | 0.054s | 0.045s | 0.099s |
| `dirtycoverage_dropidx.bak` | 0.056s | 0.041s | 0.097s |
| `dirtycoverage_droptable.bak` | 0.056s | 0.044s | 0.1s |
| `dirtycoverage_heap_forward.bak` | 0.07s | 0.035s | 0.105s |
| `dirtycoverage_insert_update.bak` | 0.086s | 0.039s | 0.125s |
| `dirtycoverage_large_dirty.bak` | 0.364s | 0.037s | 0.401s |
| `dirtycoverage_lob_update.bak` | 0.096s | 0.033s | 0.129s |
| `dirtycoverage_maxrow.bak` | 0.047s | 0.033s | 0.08s |
| `dirtycoverage_multi_update.bak` | 0.085s | 0.036s | 0.121s |
| `dirtycoverage_nchar_delete.bak` | 0.082s | 0.047s | 0.129s |
| `dirtycoverage_nested.bak` | 0.088s | 0.036s | 0.124s |
| `dirtycoverage_null_update.bak` | 0.077s | 0.035s | 0.112s |
| `dirtycoverage_rebuildidx.bak` | 0.052s | 0.04s | 0.092s |
| `dirtycoverage_rich_insert.bak` | 0.077s | 0.037s | 0.114s |
| `dirtycoverage_rich_update.bak` | 0.081s | 0.038s | 0.119s |
| `dirtycoverage_savepoint.bak` | 0.088s | 0.035s | 0.123s |
| `dirtycoverage_snapshot_update.bak` | 0.077s | 0.04s | 0.117s |
| `dirtycoverage_switch.bak` | 0.055s | 0.04s | 0.095s |
| `dirtycoverage_temporal_update.bak` | 0.076s | 0.037s | 0.113s |
| `dirtycoverage_truncate.bak` | 0.052s | 0.04s | 0.092s |
| `dirtycoverage_two_tx.bak` | 0.076s | 0.041s | 0.117s |
| `dirtycoverage_uncommitted.bak` | 0.084s | 0.036s | 0.12s |
| `dirtycoverage_update.bak` | 0.086s | 0.043s | 0.129s |
| `dirtycoverage_wide.bak` | 0.079s | 0.049s | 0.128s |
| `featurecoverage_full.bak` | 0.145s | 0.062s | 0.207s |
| `filtered_ncci_full.bak` | 0.054s | 0.036s | 0.09s |
| `float_extreme_full.bak` | 0.044s | 0.039s | 0.083s |
| `forwarded_records_full.bak` | 0.382s | 0.081s | 0.463s |
| `geocoverage_full.bak` | 0.066s | 0.046s | 0.112s |
| `geotest.bak` | 0.062s | 0.043s | 0.105s |
| `ghost_records_full.bak` | 0.046s | 0.036s | 0.082s |
| `heapcoverage_large.bak` | 0.05s | 0.041s | 0.091s |
| `heapcoverage_large_50000.bak` | 0.223s | 0.339s | 0.562s |
| `hierarchyid_extract_full.bak` | 0.054s | 0.037s | 0.091s |
| `high_slot_density_full.bak` | 0.08s | 0.202s | 0.282s |
| `identity_coverage_full.bak` | 0.056s | 0.042s | 0.098s |
| `incrementalcoverage_diff_01.bak` | 0.053s | 0.025s | 0.078s |
| `incrementalcoverage_diff_02.bak` | 0.052s | 0.013s | 0.065s |
| `incrementalcoverage_diff_03.bak` | 0.045s | 0.017s | 0.062s |
| `incrementalcoverage_diff_04.bak` | 0.054s | 0.015s | 0.069s |
| `incrementalcoverage_diff_05.bak` | 0.047s | 0.017s | 0.064s |
| `incrementalcoverage_diff_06.bak` | 0.051s | 0.018s | 0.069s |
| `incrementalcoverage_full.bak` | 0.045s | 0.033s | 0.078s |
| `layoutcoverage_full.bak` | 0.202s | 0.397s | 0.599s |
| `legacytext.bak` | 0.086s | 0.047s | 0.133s |
| `max_row_width_full.bak` | 0.048s | 0.035s | 0.083s |
| `mixed_collation_full.bak` | 0.05s | 0.035s | 0.085s |
| `multi_rowgroup_full.bak` | 0.054s | 0.048s | 0.102s |
| `ncci_heap_full.bak` | 0.054s | 0.037s | 0.091s |
| `ncci_types_full.bak` | 0.129s | 0.201s | 0.33s |
| `ndfcoverage_full.bak` | 0.06s | 0.041s | 0.101s |
| `nvarchar_max_u21_full.bak` | 0.046s | 0.033s | 0.079s |
| `ordered_cci_full.bak` | 0.055s | 0.051s | 0.106s |
| `pagecomp_anchor_full.bak` | 0.154s | 0.101s | 0.255s |
| `pagecomp_long_prefix_full.bak` | 0.052s | 0.039s | 0.091s |
| `pfor_columnstore_full.bak` | 0.153s | 0.864s | 1.017s |
| `pfor_columnstore_random_full.bak` | 0.147s | 0.884s | 1.031s |
| `realworld_numeric_digest_full.bak` | 0.075s | 0.088s | 0.163s |
| `rowboundary_full.bak` | 0.049s | 0.037s | 0.086s |
| `rowstore_hash_pii_full.bak` | 0.047s | 0.032s | 0.079s |
| `rowstore_lob_image_full.bak` | 0.049s | 0.041s | 0.09s |
| `rowstore_lob_markup_full.bak` | 0.05s | 0.038s | 0.088s |
| `rowversion_extract_full.bak` | 0.048s | 0.042s | 0.09s |
| `sparse_full.bak` | 0.105s | 0.093s | 0.198s |
| `spatial_edge_full.bak` | 0.052s | 0.043s | 0.095s |
| `spatial_index_full.bak` | 0.058s | 0.043s | 0.101s |
| `sql_variant_extract_full.bak` | 0.054s | 0.038s | 0.092s |
| `striped_full_1.bak` | 0.055s | 0.015s | 0.07s |
| `striped_single.bak` | 0.084s | 0.05s | 0.134s |
| `surrogate_pairs_full.bak` | 0.045s | 0.033s | 0.078s |
| `tabletype_cci_large_full.bak` | 0.083s | 0.05s | 0.133s |
| `tabletypecoverage_diff.bak` | 0.103s | 0.069s | 0.172s |
| `tabletypecoverage_full.bak` | 0.205s | 0.116s | 0.321s |
| `temporal_hidden_full.bak` | 0.052s | 0.043s | 0.095s |
| `torn_page_full.bak` | 0.044s | 0.035s | 0.079s |
| `typecoverage_full.bak` | 0.124s | 0.065s | 0.189s |
| `typecoverage_full_compressed.bak` | 0.178s | 0.109s | 0.287s |
| `typed_xml_full.bak` | 0.052s | 0.036s | 0.088s |
| `unicode_codepage_coverage.bak` | 0.072s | 0.051s | 0.123s |
| `utf8_collation_full.bak` | 0.047s | 0.035s | 0.082s |
| `xml_index_full.bak` | 0.058s | 0.048s | 0.106s |
| `xmlcoverage_full.bak` | 0.053s | 0.041s | 0.094s |
| `xmlheap_full.bak` | 0.117s | 0.057s | 0.174s |
| `xtp_checkpoint_straddle_full.bak` | 1.448s | 0.35s | 1.798s |
| `xtp_probe_full.bak` | 0.126s | 0.042s | 0.168s |
| `xtp_rich_full.bak` | 0.116s | 0.047s | 0.163s |
| `xtp_simple_full.bak` | 0.111s | 0.038s | 0.149s |
...
_Generated 2026-07-13 · 147 fixtures · 146 pass · 0 xfail · 1 fail_
