...
|--------|---------|--------|-----------|
| `alias_types_full.bak` | 0.083s | 0.053s | 0.136s |
| `archive_columnstore_partition_full.bak` | 0.953s | 0.87s | 1.823s |
| `archive_columnstore_types_full.bak` | 0.351s | 0.643s | 0.994s |
| `archive_columnstore_types_random_full.bak` | 0.355s | 0.646s | 1.001s |
| `archive_single_chunk_full.bak` | 0.056s | 0.044s | 0.1s |
| `archive_single_chunk_random_full.bak` | 0.057s | 0.038s | 0.095s |
| `archivenull_full.bak` | 0.145s | 0.117s | 0.262s |
| `backup_blocksize_full.bak` | 0.049s | 0.034s | 0.083s |
| `boundarycoverage_datetime_full.bak` | 0.077s | 0.177s | 0.254s |
| `boundarycoverage_full.bak` | 0.075s | 0.096s | 0.171s |
| `catalog_ss2022.bak` | 0.045s | 0.033s | 0.078s |
| `cci_binary_varbinary_compare_full.bak` | 0.054s | 0.036s | 0.09s |
| `cci_bitpack_probe_bigint_full.bak` | 1.255s | 3.525s | 4.78s |
| `cci_bitpack_probe_full.bak` | 0.146s | 0.767s | 0.913s |
| `cci_bitpack_probe_highbase_full.bak` | 0.117s | 0.523s | 0.64s |
| `cci_btree_nci_full.bak` | 0.063s | 0.042s | 0.105s |
| `cci_computed_full.bak` | 0.054s | 0.037s | 0.091s |
| `cci_enc5_largepool_full.bak` | 0.375s | 0.475s | 0.85s |
| `cci_enc5_largepool_matrix_full.bak` | 7.027s | 1.345s | 8.372s |
| `cci_extended_full.bak` | 0.071s | 0.046s | 0.117s |
| `cci_lob_full.bak` | 0.071s | 0.045s | 0.116s |
| `cci_reorganize_full.bak` | 0.054s | 0.037s | 0.091s |
| `cci_string_dict_regression_full.bak` | 0.344s | 0.145s | 0.489s |
| `cci_string_minmax_full.bak` | 0.057s | 0.038s | 0.095s |
| `cci_switch_full.bak` | 0.055s | 0.037s | 0.092s |
| `cci_types_large_full.bak` | 0.074s | 0.053s | 0.127s |
| `cci_varbinary_micro_full.bak` | 0.052s | 0.034s | 0.086s |
| `cci_varbinary_probe_full.bak` | 0.06s | 0.049s | 0.109s |
| `columnstore_minimal.bak` | 0.129s | 0.769s | 0.898s |
| `compressed_nvarchar_full.bak` | 0.06s | 0.036s | 0.096s |
| `compressioncoverage_full.bak` | 0.11s | 0.19s | 0.3s |
| `computedcoverage_full.bak` | 0.053s | 0.04s | 0.093s |
| `constraintcoverage_full.bak` | 0.058s | 0.042s | 0.1s |
| `corrupt_metadata_confidence_full.bak` | 0s | 0.001s | 0.001s |
| `covering_index_full.bak` | 0.051s | 0.047s | 0.098s |
| `cs_lob_preamble.bak` | 0.158s | 0.09s | 0.248s |
| `cs_lob_preamble2.bak` | 0.104s | 0.064s | 0.168s |
| `delta_rowgroup_full.bak` | 0.082s | 0.044s | 0.126s |
| `dirtycoverage_aborted_xact.bak` | 0.08s | 0.034s | 0.114s |
| `dirtycoverage_addcol.bak` | 0.05s | 0.045s | 0.095s |
| `dirtycoverage_addnotnull.bak` | 0.056s | 0.035s | 0.091s |
| `dirtycoverage_alldirty.bak` | 0.076s | 0.038s | 0.114s |
| `dirtycoverage_altercol.bak` | 0.051s | 0.035s | 0.086s |
| `dirtycoverage_altercol_rewrite.bak` | 0.052s | 0.046s | 0.098s |
| `dirtycoverage_alterdb.bak` | 0.052s | 0.039s | 0.091s |
| `dirtycoverage_cci_delete.bak` | 0.124s | 0.095s | 0.219s |
| `dirtycoverage_cci_update.bak` | 0.228s | 0.13s | 0.358s |
| `dirtycoverage_committed_delete.bak` | 0.047s | 0.038s | 0.085s |
| `dirtycoverage_committed_delete_v2.bak` | 3.244s | 1.16s | 4.404s |
| `dirtycoverage_committed_delete_v3.bak` | 0.061s | 0.073s | 0.134s |
| `dirtycoverage_committed_delete_v4.bak` | 0.161s | 0.14s | 0.301s |
| `dirtycoverage_committed_update.bak` | 0.046s | 0.035s | 0.081s |
| `dirtycoverage_committed_update_v2.bak` | 12.223s | 1.96s | 14.183s |
| `dirtycoverage_committed_update_v3.bak` | 0.063s | 0.085s | 0.148s |
| `dirtycoverage_committed_update_v4.bak` | 0.118s | 0.137s | 0.255s |
| `dirtycoverage_compress_update.bak` | 0.084s | 0.039s | 0.123s |
| `dirtycoverage_concurrent.bak` | 0.053s | 0.036s | 0.089s |
| `dirtycoverage_createidx.bak` | 0.051s | 0.035s | 0.086s |
| `dirtycoverage_createtable.bak` | 0.051s | 0.041s | 0.092s |
| `dirtycoverage_delete.bak` | 0.095s | 0.037s | 0.132s |
| `dirtycoverage_dropcol.bak` | 0.103s | 0.063s | 0.166s |
| `dirtycoverage_dropidx.bak` | 0.054s | 0.036s | 0.09s |
| `dirtycoverage_droptable.bak` | 0.06s | 0.043s | 0.103s |
| `dirtycoverage_heap_forward.bak` | 0.083s | 0.034s | 0.117s |
| `dirtycoverage_insert_update.bak` | 0.086s | 0.034s | 0.12s |
| `dirtycoverage_large_dirty.bak` | 0.342s | 0.033s | 0.375s |
| `dirtycoverage_lob_update.bak` | 0.094s | 0.035s | 0.129s |
| `dirtycoverage_maxrow.bak` | 0.049s | 0.035s | 0.084s |
| `dirtycoverage_multi_update.bak` | 0.087s | 0.039s | 0.126s |
| `dirtycoverage_nchar_delete.bak` | 0.08s | 0.036s | 0.116s |
| `dirtycoverage_nested.bak` | 0.079s | 0.034s | 0.113s |
| `dirtycoverage_null_update.bak` | 0.078s | 0.035s | 0.113s |
| `dirtycoverage_rebuildidx.bak` | 0.056s | 0.038s | 0.094s |
| `dirtycoverage_rich_insert.bak` | 0.08s | 0.037s | 0.117s |
| `dirtycoverage_rich_update.bak` | 0.078s | 0.033s | 0.111s |
| `dirtycoverage_savepoint.bak` | 0.084s | 0.039s | 0.123s |
| `dirtycoverage_snapshot_update.bak` | 0.08s | 0.038s | 0.118s |
| `dirtycoverage_switch.bak` | 0.056s | 0.04s | 0.096s |
| `dirtycoverage_temporal_update.bak` | 0.08s | 0.035s | 0.115s |
| `dirtycoverage_truncate.bak` | 0.059s | 0.067s | 0.126s |
| `dirtycoverage_two_tx.bak` | 0.078s | 0.042s | 0.12s |
| `dirtycoverage_uncommitted.bak` | 0.085s | 0.04s | 0.125s |
| `dirtycoverage_update.bak` | 0.085s | 0.035s | 0.12s |
| `dirtycoverage_wide.bak` | 0.081s | 0.038s | 0.119s |
| `featurecoverage_full.bak` | 0.145s | 0.068s | 0.213s |
| `filtered_ncci_full.bak` | 0.055s | 0.037s | 0.092s |
| `float_extreme_full.bak` | 0.047s | 0.033s | 0.08s |
| `forwarded_records_full.bak` | 0.362s | 0.08s | 0.442s |
| `geocoverage_full.bak` | 0.07s | 0.057s | 0.127s |
| `geotest.bak` | 0.052s | 0.038s | 0.09s |
| `ghost_records_full.bak` | 0.047s | 0.035s | 0.082s |
| `heapcoverage_large.bak` | 0.056s | 0.045s | 0.101s |
| `heapcoverage_large_50000.bak` | 0.199s | 0.453s | 0.652s |
| `hierarchyid_extract_full.bak` | 0.047s | 0.038s | 0.085s |
| `high_slot_density_full.bak` | 0.08s | 0.299s | 0.379s |
| `incrementalcoverage_diff_01.bak` | 0.049s | 0.013s | 0.062s |
| `incrementalcoverage_diff_02.bak` | 0.05s | 0.012s | 0.062s |
| `incrementalcoverage_diff_03.bak` | 0.047s | 0.017s | 0.064s |
...
| `incrementalcoverage_full.bak` | 0.049s | 0.038s | 0.087s |
| `layoutcoverage_full.bak` | 0.185s | 0.204s | 0.389s |
| `legacytext.bak` | 0.085s | 0.053s | 0.138s |
| `max_row_width_full.bak` | 0.047s | 0.049s | 0.096s |
| `mixed_collation_full.bak` | 0.101s | 0.076s | 0.177s |
| `multi_rowgroup_full.bak` | 0.06s | 0.039s | 0.099s |
| `ncci_heap_full.bak` | 0.053s | 0.038s | 0.091s |
| `ncci_types_full.bak` | 0.119s | 0.234s | 0.353s |
| `ndfcoverage_full.bak` | 0.054s | 0.037s | 0.091s |
| `nvarchar_max_u21_full.bak` | 0.048s | 0.032s | 0.08s |
| `ordered_cci_full.bak` | 0.055s | 0.041s | 0.096s |
| `pagecomp_anchor_full.bak` | 0.155s | 0.194s | 0.349s |
| `pagecomp_long_prefix_full.bak` | 0.064s | 0.039s | 0.103s |
| `pfor_columnstore_full.bak` | 0.148s | 1.069s | 1.217s |
| `pfor_columnstore_random_full.bak` | 0.15s | 1.08s | 1.23s |
| `realworld_numeric_digest_full.bak` | 0.074s | 0.112s | 0.186s |
| `rowboundary_full.bak` | 0.077s | 0.075s | 0.152s |
| `rowstore_hash_pii_full.bak` | 0.045s | 0.034s | 0.079s |
| `rowstore_lob_image_full.bak` | 0.06s | 0.034s | 0.094s |
| `rowstore_lob_markup_full.bak` | 0.047s | 0.033s | 0.08s |
| `rowversion_extract_full.bak` | 0.049s | 0.034s | 0.083s |
| `sparse_full.bak` | 0.11s | 0.146s | 0.256s |
| `spatial_edge_full.bak` | 0.054s | 0.038s | 0.092s |
| `spatial_index_full.bak` | 0.063s | 0.045s | 0.108s |
| `sql_variant_extract_full.bak` | 0.074s | 0.069s | 0.143s |
| `striped_full_1.bak` | 0.054s | 0.016s | 0.07s |
| `striped_single.bak` | 0.087s | 0.047s | 0.134s |
| `surrogate_pairs_full.bak` | 0.047s | 0.034s | 0.081s |
| `tabletype_cci_large_full.bak` | 0.074s | 0.05s | 0.124s |
| `tabletypecoverage_diff.bak` | 0.099s | 0.069s | 0.168s |
| `tabletypecoverage_full.bak` | 0.19s | 0.121s | 0.311s |
| `temporal_hidden_full.bak` | 0.055s | 0.038s | 0.093s |
| `torn_page_full.bak` | 0.043s | 0.032s | 0.075s |
| `typecoverage_full.bak` | 0.133s | 0.077s | 0.21s |
| `typecoverage_full_compressed.bak` | 0.162s | 0.108s | 0.27s |
| `typed_xml_full.bak` | 0.064s | 0.032s | 0.096s |
| `unicode_codepage_coverage.bak` | 0.081s | 0.044s | 0.125s |
| `utf8_collation_full.bak` | 0.048s | 0.038s | 0.086s |
| `xml_index_full.bak` | 0.057s | 0.036s | 0.093s |
| `xmlcoverage_full.bak` | 0.051s | 0.036s | 0.087s |
| `xmlheap_full.bak` | 0.109s | 0.064s | 0.173s |
| `xtp_checkpoint_straddle_full.bak` | 1.381s | 0.374s | 1.755s |
| `xtp_probe_full.bak` | 0.123s | 0.041s | 0.164s |
| `xtp_rich_full.bak` | 0.117s | 0.045s | 0.162s |
| `xtp_simple_full.bak` | 0.113s | 0.037s | 0.15s |
