...
**147 fixtures · 146 pass · 0 xfail (known gap) · 1 fail**
...
|--------|---------|--------|-----------|
| `alias_types_full.bak` | 0.048s | 0.032s | 0.08s |
| `archive_columnstore_partition_full.bak` | 0.944s | 0.596s | 1.54s |
| `archive_columnstore_types_full.bak` | 0.358s | 0.671s | 1.029s |
| `archive_columnstore_types_random_full.bak` | 0.354s | 0.672s | 1.026s |
| `archive_single_chunk_full.bak` | 0.061s | 0.042s | 0.103s |
| `archive_single_chunk_random_full.bak` | 0.063s | 0.04s | 0.103s |
| `archivenull_full.bak` | 0.141s | 0.089s | 0.23s |
| `backup_blocksize_full.bak` | 0.063s | 0.034s | 0.097s |
| `boundarycoverage_datetime_full.bak` | 0.074s | 0.171s | 0.245s |
| `boundarycoverage_full.bak` | 0.067s | 0.066s | 0.133s |
| `catalog_ss2022.bak` | 0.045s | 0.032s | 0.077s |
| `cci_binary_varbinary_compare_full.bak` | 0.059s | 0.036s | 0.095s |
| `cci_bitpack_probe_bigint_full.bak` | 1.259s | 3.659s | 4.918s |
| `cci_bitpack_probe_full.bak` | 0.143s | 0.635s | 0.778s |
| `cci_bitpack_probe_highbase_full.bak` | 0.125s | 0.421s | 0.546s |
| `cci_btree_nci_full.bak` | 0.07s | 0.037s | 0.107s |
| `cci_computed_full.bak` | 0.065s | 0.038s | 0.103s |
| `cci_enc5_largepool_full.bak` | 0.377s | 0.431s | 0.808s |
| `cci_enc5_largepool_matrix_full.bak` | 7.062s | 1.232s | 8.294s |
| `cci_extended_full.bak` | 0.069s | 0.045s | 0.114s |
| `cci_lob_full.bak` | 0.071s | 0.047s | 0.118s |
| `cci_reorganize_full.bak` | 0.058s | 0.039s | 0.097s |
| `cci_string_dict_regression_full.bak` | 0.327s | 0.142s | 0.469s |
| `cci_string_minmax_full.bak` | 0.064s | 0.042s | 0.106s |
| `cci_switch_full.bak` | 0.056s | 0.037s | 0.093s |
| `cci_types_large_full.bak` | 0.07s | 0.055s | 0.125s |
| `cci_varbinary_micro_full.bak` | 0.051s | 0.036s | 0.087s |
| `cci_varbinary_probe_full.bak` | 0.053s | 0.045s | 0.098s |
| `columnstore_minimal.bak` | 0.134s | 0.814s | 0.948s |
| `compressed_nvarchar_full.bak` | 0.049s | 0.032s | 0.081s |
| `compressioncoverage_full.bak` | 0.105s | 0.176s | 0.281s |
| `computedcoverage_full.bak` | 0.047s | 0.04s | 0.087s |
| `constraintcoverage_full.bak` | 0.055s | 0.038s | 0.093s |
| `corrupt_metadata_confidence_full.bak` | 0s | 0.004s | 0.004s |
| `covering_index_full.bak` | 0.054s | 0.038s | 0.092s |
| `cs_lob_preamble.bak` | 0.158s | 0.079s | 0.237s |
| `cs_lob_preamble2.bak` | 0.102s | 0.056s | 0.158s |
| `delta_rowgroup_full.bak` | 0.05s | 0.038s | 0.088s |
| `dirtycoverage_aborted_xact.bak` | 0.074s | 0.032s | 0.106s |
| `dirtycoverage_addcol.bak` | 0.055s | 0.034s | 0.089s |
| `dirtycoverage_addnotnull.bak` | 0.053s | 0.035s | 0.088s |
| `dirtycoverage_alldirty.bak` | 0.077s | 0.032s | 0.109s |
| `dirtycoverage_altercol.bak` | 0.051s | 0.038s | 0.089s |
| `dirtycoverage_altercol_rewrite.bak` | 0.053s | 0.038s | 0.091s |
| `dirtycoverage_alterdb.bak` | 0.055s | 0.035s | 0.09s |
| `dirtycoverage_cci_delete.bak` | 0.112s | 0.09s | 0.202s |
| `dirtycoverage_cci_update.bak` | 0.216s | 0.097s | 0.313s |
| `dirtycoverage_committed_delete.bak` | 0.046s | 0.033s | 0.079s |
| `dirtycoverage_committed_delete_v2.bak` | 3.224s | 0.539s | 3.763s |
| `dirtycoverage_committed_delete_v3.bak` | 0.06s | 0.058s | 0.118s |
| `dirtycoverage_committed_delete_v4.bak` | 0.163s | 0.07s | 0.233s |
| `dirtycoverage_committed_update.bak` | 0.047s | 0.033s | 0.08s |
| `dirtycoverage_committed_update_v2.bak` | 12.083s | 0.868s | 12.951s |
| `dirtycoverage_committed_update_v3.bak` | 0.068s | 0.08s | 0.148s |
| `dirtycoverage_committed_update_v4.bak` | 0.13s | 0.072s | 0.202s |
| `dirtycoverage_compress_update.bak` | 0.083s | 0.034s | 0.117s |
| `dirtycoverage_concurrent.bak` | 0.05s | 0.034s | 0.084s |
| `dirtycoverage_createidx.bak` | 0.054s | 0.047s | 0.101s |
| `dirtycoverage_createtable.bak` | 0.053s | 0.034s | 0.087s |
| `dirtycoverage_delete.bak` | 0.079s | 0.034s | 0.113s |
| `dirtycoverage_dropcol.bak` | 0.054s | 0.034s | 0.088s |
| `dirtycoverage_dropidx.bak` | 0.05s | 0.034s | 0.084s |
| `dirtycoverage_droptable.bak` | 0.056s | 0.036s | 0.092s |
| `dirtycoverage_heap_forward.bak` | 0.072s | 0.032s | 0.104s |
| `dirtycoverage_insert_update.bak` | 0.091s | 0.034s | 0.125s |
| `dirtycoverage_large_dirty.bak` | 0.344s | 0.034s | 0.378s |
| `dirtycoverage_lob_update.bak` | 0.105s | 0.034s | 0.139s |
| `dirtycoverage_maxrow.bak` | 0.047s | 0.034s | 0.081s |
| `dirtycoverage_multi_update.bak` | 0.081s | 0.033s | 0.114s |
| `dirtycoverage_nchar_delete.bak` | 0.078s | 0.033s | 0.111s |
| `dirtycoverage_nested.bak` | 0.083s | 0.033s | 0.116s |
| `dirtycoverage_null_update.bak` | 0.084s | 0.035s | 0.119s |
| `dirtycoverage_rebuildidx.bak` | 0.05s | 0.035s | 0.085s |
| `dirtycoverage_rich_insert.bak` | 0.079s | 0.035s | 0.114s |
| `dirtycoverage_rich_update.bak` | 0.086s | 0.036s | 0.122s |
| `dirtycoverage_savepoint.bak` | 0.083s | 0.035s | 0.118s |
| `dirtycoverage_snapshot_update.bak` | 0.076s | 0.033s | 0.109s |
| `dirtycoverage_switch.bak` | 0.058s | 0.041s | 0.099s |
| `dirtycoverage_temporal_update.bak` | 0.076s | 0.035s | 0.111s |
| `dirtycoverage_truncate.bak` | 0.053s | 0.035s | 0.088s |
| `dirtycoverage_two_tx.bak` | 0.076s | 0.036s | 0.112s |
| `dirtycoverage_uncommitted.bak` | 0.087s | 0.043s | 0.13s |
| `dirtycoverage_update.bak` | 0.083s | 0.034s | 0.117s |
| `dirtycoverage_wide.bak` | 0.077s | 0.033s | 0.11s |
| `featurecoverage_full.bak` | 0.142s | 0.054s | 0.196s |
| `filtered_ncci_full.bak` | 0.063s | 0.036s | 0.099s |
| `float_extreme_full.bak` | 0.045s | 0.033s | 0.078s |
| `forwarded_records_full.bak` | 0.368s | 0.07s | 0.438s |
| `geocoverage_full.bak` | 0.065s | 0.054s | 0.119s |
| `geotest.bak` | 0.054s | 0.04s | 0.094s |
| `ghost_records_full.bak` | 0.046s | 0.035s | 0.081s |
| `heapcoverage_large.bak` | 0.052s | 0.043s | 0.095s |
| `heapcoverage_large_50000.bak` | 0.21s | 0.318s | 0.528s |
| `hierarchyid_extract_full.bak` | 0.047s | 0.032s | 0.079s |
| `high_slot_density_full.bak` | 0.077s | 0.196s | 0.273s |
| `identity_coverage_full.bak` | 0.062s | 0.04s | 0.102s |
| `incrementalcoverage_diff_01.bak` | 0.048s | 0.016s | 0.064s |
| `incrementalcoverage_diff_02.bak` | 0.045s | 0.016s | 0.061s |
| `incrementalcoverage_diff_03.bak` | 0.046s | 0.013s | 0.059s |
| `incrementalcoverage_diff_04.bak` | 0.046s | 0.015s | 0.061s |
| `incrementalcoverage_diff_05.bak` | 0.045s | 0.016s | 0.061s |
| `incrementalcoverage_diff_06.bak` | 0.047s | 0.016s | 0.063s |
| `incrementalcoverage_full.bak` | 0.044s | 0.029s | 0.073s |
| `layoutcoverage_full.bak` | 0.184s | 0.301s | 0.485s |
| `legacytext.bak` | 0.088s | 0.047s | 0.135s |
| `max_row_width_full.bak` | 0.044s | 0.033s | 0.077s |
| `mixed_collation_full.bak` | 0.048s | 0.031s | 0.079s |
| `multi_rowgroup_full.bak` | 0.057s | 0.042s | 0.099s |
| `ncci_heap_full.bak` | 0.048s | 0.038s | 0.086s |
| `ncci_types_full.bak` | 0.114s | 0.189s | 0.303s |
| `ndfcoverage_full.bak` | 0.056s | 0.047s | 0.103s |
| `nvarchar_max_u21_full.bak` | 0.047s | 0.032s | 0.079s |
| `ordered_cci_full.bak` | 0.054s | 0.043s | 0.097s |
| `pagecomp_anchor_full.bak` | 0.14s | 0.092s | 0.232s |
| `pagecomp_long_prefix_full.bak` | 0.049s | 0.037s | 0.086s |
| `pfor_columnstore_full.bak` | 0.145s | 0.816s | 0.961s |
| `pfor_columnstore_random_full.bak` | 0.148s | 0.813s | 0.961s |
| `realworld_numeric_digest_full.bak` | 0.074s | 0.081s | 0.155s |
| `rowboundary_full.bak` | 0.052s | 0.038s | 0.09s |
| `rowstore_hash_pii_full.bak` | 0.045s | 0.032s | 0.077s |
| `rowstore_lob_image_full.bak` | 0.047s | 0.034s | 0.081s |
| `rowstore_lob_markup_full.bak` | 0.048s | 0.033s | 0.081s |
| `rowversion_extract_full.bak` | 0.055s | 0.034s | 0.089s |
| `sparse_full.bak` | 0.104s | 0.089s | 0.193s |
| `spatial_edge_full.bak` | 0.056s | 0.035s | 0.091s |
| `spatial_index_full.bak` | 0.062s | 0.052s | 0.114s |
| `sql_variant_extract_full.bak` | 0.049s | 0.033s | 0.082s |
| `striped_full_1.bak` | 0.053s | 0.019s | 0.072s |
| `striped_single.bak` | 0.084s | 0.047s | 0.131s |
| `surrogate_pairs_full.bak` | 0.043s | 0.037s | 0.08s |
| `tabletype_cci_large_full.bak` | 0.081s | 0.051s | 0.132s |
| `tabletypecoverage_diff.bak` | 0.106s | 0.058s | 0.164s |
| `tabletypecoverage_full.bak` | 0.192s | 0.09s | 0.282s |
| `temporal_hidden_full.bak` | 0.057s | 0.037s | 0.094s |
| `torn_page_full.bak` | 0.041s | 0.029s | 0.07s |
| `typecoverage_full.bak` | 0.123s | 0.063s | 0.186s |
| `typecoverage_full_compressed.bak` | 0.161s | 0.106s | 0.267s |
| `typed_xml_full.bak` | 0.05s | 0.032s | 0.082s |
| `unicode_codepage_coverage.bak` | 0.071s | 0.048s | 0.119s |
| `utf8_collation_full.bak` | 0.047s | 0.034s | 0.081s |
| `xml_index_full.bak` | 0.054s | 0.043s | 0.097s |
| `xmlcoverage_full.bak` | 0.057s | 0.034s | 0.091s |
| `xmlheap_full.bak` | 0.113s | 0.05s | 0.163s |
| `xtp_checkpoint_straddle_full.bak` | 1.382s | 0.354s | 1.736s |
| `xtp_probe_full.bak` | 0.12s | 0.041s | 0.161s |
| `xtp_rich_full.bak` | 0.12s | 0.039s | 0.159s |
| `xtp_simple_full.bak` | 0.109s | 0.036s | 0.145s |
...
_Generated 2026-07-11 · 147 fixtures · 146 pass · 0 xfail · 1 fail_
