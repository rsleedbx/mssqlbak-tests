...
|--------|---------|--------|-----------|
| `alias_types_full.bak` | 0.052s | 0.034s | 0.086s |
| `archive_columnstore_partition_full.bak` | 0.948s | 0.598s | 1.546s |
| `archive_columnstore_types_full.bak` | 0.352s | 0.686s | 1.038s |
| `archive_columnstore_types_random_full.bak` | 0.365s | 0.68s | 1.045s |
| `archive_single_chunk_full.bak` | 0.06s | 0.037s | 0.097s |
| `archive_single_chunk_random_full.bak` | 0.055s | 0.037s | 0.092s |
| `archivenull_full.bak` | 0.139s | 0.096s | 0.235s |
| `backup_blocksize_full.bak` | 0.051s | 0.039s | 0.09s |
| `boundarycoverage_datetime_full.bak` | 0.08s | 0.154s | 0.234s |
| `boundarycoverage_full.bak` | 0.072s | 0.072s | 0.144s |
| `catalog_ss2022.bak` | 0.046s | 0.033s | 0.079s |
| `cci_binary_varbinary_compare_full.bak` | 0.064s | 0.039s | 0.103s |
| `cci_bitpack_probe_bigint_full.bak` | 1.259s | 3.677s | 4.936s |
| `cci_bitpack_probe_full.bak` | 0.136s | 0.646s | 0.782s |
| `cci_bitpack_probe_highbase_full.bak` | 0.123s | 0.429s | 0.552s |
| `cci_btree_nci_full.bak` | 0.069s | 0.04s | 0.109s |
| `cci_computed_full.bak` | 0.056s | 0.037s | 0.093s |
| `cci_enc5_largepool_full.bak` | 0.394s | 0.432s | 0.826s |
| `cci_enc5_largepool_matrix_full.bak` | 7.037s | 1.241s | 8.278s |
| `cci_extended_full.bak` | 0.072s | 0.048s | 0.12s |
| `cci_lob_full.bak` | 0.064s | 0.045s | 0.109s |
| `cci_reorganize_full.bak` | 0.065s | 0.044s | 0.109s |
| `cci_string_dict_regression_full.bak` | 0.347s | 0.145s | 0.492s |
| `cci_string_minmax_full.bak` | 0.071s | 0.038s | 0.109s |
| `cci_switch_full.bak` | 0.057s | 0.041s | 0.098s |
| `cci_types_large_full.bak` | 0.073s | 0.047s | 0.12s |
| `cci_varbinary_micro_full.bak` | 0.062s | 0.041s | 0.103s |
| `cci_varbinary_probe_full.bak` | 0.062s | 0.052s | 0.114s |
| `columnstore_minimal.bak` | 0.135s | 0.945s | 1.08s |
| `compressed_nvarchar_full.bak` | 0.053s | 0.038s | 0.091s |
| `compressioncoverage_full.bak` | 0.107s | 0.189s | 0.296s |
| `computedcoverage_full.bak` | 0.093s | 0.047s | 0.14s |
| `constraintcoverage_full.bak` | 0.06s | 0.053s | 0.113s |
| `corrupt_metadata_confidence_full.bak` | 0s | 0.001s | 0.001s |
| `covering_index_full.bak` | 0.053s | 0.054s | 0.107s |
| `cs_lob_preamble.bak` | 0.157s | 0.078s | 0.235s |
| `cs_lob_preamble2.bak` | 0.112s | 0.062s | 0.174s |
| `delta_rowgroup_full.bak` | 0.061s | 0.038s | 0.099s |
| `dirtycoverage_aborted_xact.bak` | 0.077s | 0.035s | 0.112s |
| `dirtycoverage_addcol.bak` | 0.061s | 0.044s | 0.105s |
| `dirtycoverage_addnotnull.bak` | 0.061s | 0.042s | 0.103s |
| `dirtycoverage_alldirty.bak` | 0.084s | 0.034s | 0.118s |
| `dirtycoverage_altercol.bak` | 0.063s | 0.041s | 0.104s |
| `dirtycoverage_altercol_rewrite.bak` | 0.051s | 0.037s | 0.088s |
| `dirtycoverage_alterdb.bak` | 0.062s | 0.039s | 0.101s |
| `dirtycoverage_cci_delete.bak` | 0.113s | 0.089s | 0.202s |
| `dirtycoverage_cci_update.bak` | 0.218s | 0.099s | 0.317s |
| `dirtycoverage_committed_delete.bak` | 0.048s | 0.034s | 0.082s |
| `dirtycoverage_committed_delete_v2.bak` | 3.229s | 0.578s | 3.807s |
| `dirtycoverage_committed_delete_v3.bak` | 0.071s | 0.06s | 0.131s |
| `dirtycoverage_committed_delete_v4.bak` | 0.167s | 0.066s | 0.233s |
| `dirtycoverage_committed_update.bak` | 0.047s | 0.033s | 0.08s |
| `dirtycoverage_committed_update_v2.bak` | 12.052s | 0.896s | 12.948s |
| `dirtycoverage_committed_update_v3.bak` | 0.06s | 0.07s | 0.13s |
| `dirtycoverage_committed_update_v4.bak` | 0.112s | 0.072s | 0.184s |
| `dirtycoverage_compress_update.bak` | 0.088s | 0.036s | 0.124s |
| `dirtycoverage_concurrent.bak` | 0.058s | 0.055s | 0.113s |
| `dirtycoverage_createidx.bak` | 0.059s | 0.038s | 0.097s |
| `dirtycoverage_createtable.bak` | 0.11s | 0.041s | 0.151s |
| `dirtycoverage_delete.bak` | 0.082s | 0.035s | 0.117s |
| `dirtycoverage_dropcol.bak` | 0.062s | 0.041s | 0.103s |
| `dirtycoverage_dropidx.bak` | 0.058s | 0.053s | 0.111s |
| `dirtycoverage_droptable.bak` | 0.058s | 0.047s | 0.105s |
| `dirtycoverage_heap_forward.bak` | 0.072s | 0.032s | 0.104s |
| `dirtycoverage_insert_update.bak` | 0.083s | 0.035s | 0.118s |
| `dirtycoverage_large_dirty.bak` | 0.347s | 0.038s | 0.385s |
| `dirtycoverage_lob_update.bak` | 0.093s | 0.039s | 0.132s |
| `dirtycoverage_maxrow.bak` | 0.052s | 0.034s | 0.086s |
| `dirtycoverage_multi_update.bak` | 0.087s | 0.038s | 0.125s |
| `dirtycoverage_nchar_delete.bak` | 0.083s | 0.034s | 0.117s |
| `dirtycoverage_nested.bak` | 0.081s | 0.037s | 0.118s |
| `dirtycoverage_null_update.bak` | 0.078s | 0.045s | 0.123s |
| `dirtycoverage_rebuildidx.bak` | 0.054s | 0.052s | 0.106s |
| `dirtycoverage_rich_insert.bak` | 0.08s | 0.036s | 0.116s |
| `dirtycoverage_rich_update.bak` | 0.08s | 0.035s | 0.115s |
| `dirtycoverage_savepoint.bak` | 0.086s | 0.037s | 0.123s |
| `dirtycoverage_snapshot_update.bak` | 0.098s | 0.035s | 0.133s |
| `dirtycoverage_switch.bak` | 0.056s | 0.036s | 0.092s |
| `dirtycoverage_temporal_update.bak` | 0.088s | 0.043s | 0.131s |
| `dirtycoverage_truncate.bak` | 0.065s | 0.041s | 0.106s |
| `dirtycoverage_two_tx.bak` | 0.079s | 0.034s | 0.113s |
| `dirtycoverage_uncommitted.bak` | 0.084s | 0.036s | 0.12s |
| `dirtycoverage_update.bak` | 0.082s | 0.04s | 0.122s |
| `dirtycoverage_wide.bak` | 0.093s | 0.036s | 0.129s |
| `featurecoverage_full.bak` | 0.15s | 0.06s | 0.21s |
| `filtered_ncci_full.bak` | 0.061s | 0.048s | 0.109s |
| `float_extreme_full.bak` | 0.045s | 0.033s | 0.078s |
| `forwarded_records_full.bak` | 0.368s | 0.079s | 0.447s |
| `geocoverage_full.bak` | 0.063s | 0.048s | 0.111s |
| `geotest.bak` | 0.057s | 0.048s | 0.105s |
| `ghost_records_full.bak` | 0.052s | 0.035s | 0.087s |
| `heapcoverage_large.bak` | 0.062s | 0.052s | 0.114s |
| `heapcoverage_large_50000.bak` | 0.212s | 0.324s | 0.536s |
| `hierarchyid_extract_full.bak` | 0.061s | 0.032s | 0.093s |
| `high_slot_density_full.bak` | 0.08s | 0.198s | 0.278s |
| `identity_coverage_full.bak` | 0.058s | 0.041s | 0.099s |
| `incrementalcoverage_diff_01.bak` | 0.047s | 0.013s | 0.06s |
| `incrementalcoverage_diff_02.bak` | 0.048s | 0.012s | 0.06s |
| `incrementalcoverage_diff_03.bak` | 0.044s | 0.013s | 0.057s |
| `incrementalcoverage_diff_04.bak` | 0.048s | 0.012s | 0.06s |
| `incrementalcoverage_diff_05.bak` | 0.046s | 0.012s | 0.058s |
| `incrementalcoverage_diff_06.bak` | 0.049s | 0.012s | 0.061s |
| `incrementalcoverage_full.bak` | 0.045s | 0.032s | 0.077s |
| `layoutcoverage_full.bak` | 0.183s | 0.303s | 0.486s |
| `legacytext.bak` | 0.09s | 0.057s | 0.147s |
| `max_row_width_full.bak` | 0.045s | 0.036s | 0.081s |
| `mixed_collation_full.bak` | 0.047s | 0.032s | 0.079s |
| `multi_rowgroup_full.bak` | 0.062s | 0.045s | 0.107s |
| `ncci_heap_full.bak` | 0.103s | 0.041s | 0.144s |
| `ncci_types_full.bak` | 0.12s | 0.202s | 0.322s |
| `ndfcoverage_full.bak` | 0.062s | 0.044s | 0.106s |
| `nvarchar_max_u21_full.bak` | 0.045s | 0.032s | 0.077s |
| `ordered_cci_full.bak` | 0.06s | 0.042s | 0.102s |
| `pagecomp_anchor_full.bak` | 0.141s | 0.103s | 0.244s |
| `pagecomp_long_prefix_full.bak` | 0.099s | 0.041s | 0.14s |
| `pfor_columnstore_full.bak` | 0.146s | 0.82s | 0.966s |
| `pfor_columnstore_random_full.bak` | 0.143s | 0.865s | 1.008s |
| `realworld_numeric_digest_full.bak` | 0.065s | 0.085s | 0.15s |
| `rowboundary_full.bak` | 0.058s | 0.04s | 0.098s |
| `rowstore_hash_pii_full.bak` | 0.044s | 0.032s | 0.076s |
| `rowstore_lob_image_full.bak` | 0.047s | 0.032s | 0.079s |
| `rowstore_lob_markup_full.bak` | 0.048s | 0.034s | 0.082s |
| `rowversion_extract_full.bak` | 0.068s | 0.04s | 0.108s |
| `sparse_full.bak` | 0.105s | 0.089s | 0.194s |
| `spatial_edge_full.bak` | 0.062s | 0.045s | 0.107s |
| `spatial_index_full.bak` | 0.057s | 0.037s | 0.094s |
| `sql_variant_extract_full.bak` | 0.052s | 0.046s | 0.098s |
| `striped_full_1.bak` | 0.054s | 0.014s | 0.068s |
| `striped_single.bak` | 0.084s | 0.049s | 0.133s |
| `surrogate_pairs_full.bak` | 0.045s | 0.033s | 0.078s |
| `tabletype_cci_large_full.bak` | 0.08s | 0.051s | 0.131s |
| `tabletypecoverage_diff.bak` | 0.107s | 0.061s | 0.168s |
| `tabletypecoverage_full.bak` | 0.207s | 0.111s | 0.318s |
| `temporal_hidden_full.bak` | 0.057s | 0.047s | 0.104s |
| `torn_page_full.bak` | 0.044s | 0.03s | 0.074s |
| `typecoverage_full.bak` | 0.122s | 0.072s | 0.194s |
| `typecoverage_full_compressed.bak` | 0.162s | 0.099s | 0.261s |
| `typed_xml_full.bak` | 0.049s | 0.038s | 0.087s |
| `unicode_codepage_coverage.bak` | 0.078s | 0.048s | 0.126s |
| `utf8_collation_full.bak` | 0.051s | 0.034s | 0.085s |
| `xml_index_full.bak` | 0.062s | 0.036s | 0.098s |
| `xmlcoverage_full.bak` | 0.058s | 0.039s | 0.097s |
| `xmlheap_full.bak` | 0.119s | 0.061s | 0.18s |
| `xtp_checkpoint_straddle_full.bak` | 1.382s | 0.336s | 1.718s |
| `xtp_probe_full.bak` | 0.128s | 0.05s | 0.178s |
| `xtp_rich_full.bak` | 0.113s | 0.045s | 0.158s |
| `xtp_simple_full.bak` | 0.101s | 0.043s | 0.144s |
