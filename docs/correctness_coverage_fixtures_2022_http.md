...
|--------|---------|--------|-----------|
| `alias_types_full.bak` | 0.05s | 0.042s | 0.092s |
| `archive_columnstore_partition_full.bak` | 0.972s | 0.883s | 1.855s |
| `archive_columnstore_types_full.bak` | 0.354s | 0.647s | 1.001s |
| `archive_columnstore_types_random_full.bak` | 0.359s | 0.666s | 1.025s |
| `archive_single_chunk_full.bak` | 0.054s | 0.043s | 0.097s |
| `archive_single_chunk_random_full.bak` | 0.057s | 0.05s | 0.107s |
| `archivenull_full.bak` | 0.139s | 0.116s | 0.255s |
| `backup_blocksize_full.bak` | 0.051s | 0.037s | 0.088s |
| `boundarycoverage_datetime_full.bak` | 0.088s | 0.186s | 0.274s |
| `boundarycoverage_full.bak` | 0.072s | 0.094s | 0.166s |
| `catalog_ss2022.bak` | 0.047s | 0.044s | 0.091s |
| `cci_binary_varbinary_compare_full.bak` | 0.054s | 0.036s | 0.09s |
| `cci_bitpack_probe_bigint_full.bak` | 1.288s | 3.654s | 4.942s |
| `cci_bitpack_probe_full.bak` | 0.138s | 0.824s | 0.962s |
| `cci_bitpack_probe_highbase_full.bak` | 0.113s | 0.559s | 0.672s |
| `cci_btree_nci_full.bak` | 0.07s | 0.058s | 0.128s |
| `cci_computed_full.bak` | 0.053s | 0.042s | 0.095s |
| `cci_enc5_largepool_full.bak` | 0.378s | 0.481s | 0.859s |
| `cci_enc5_largepool_matrix_full.bak` | 7.26s | 1.412s | 8.672s |
| `cci_extended_full.bak` | 0.067s | 0.046s | 0.113s |
| `cci_lob_full.bak` | 0.064s | 0.057s | 0.121s |
| `cci_reorganize_full.bak` | 0.056s | 0.042s | 0.098s |
| `cci_string_dict_regression_full.bak` | 0.326s | 0.147s | 0.473s |
| `cci_string_minmax_full.bak` | 0.057s | 0.043s | 0.1s |
| `cci_switch_full.bak` | 0.056s | 0.04s | 0.096s |
| `cci_types_large_full.bak` | 0.077s | 0.056s | 0.133s |
| `cci_varbinary_micro_full.bak` | 0.052s | 0.038s | 0.09s |
| `cci_varbinary_probe_full.bak` | 0.068s | 0.069s | 0.137s |
| `columnstore_minimal.bak` | 0.125s | 1.088s | 1.213s |
| `compressed_nvarchar_full.bak` | 0.054s | 0.041s | 0.095s |
| `compressioncoverage_full.bak` | 0.1s | 0.19s | 0.29s |
| `computedcoverage_full.bak` | 0.048s | 0.046s | 0.094s |
| `constraintcoverage_full.bak` | 0.054s | 0.046s | 0.1s |
| `corrupt_metadata_confidence_full.bak` | 0s | 0.006s | 0.006s |
| `covering_index_full.bak` | 0.114s | 0.102s | 0.216s |
| `cs_lob_preamble.bak` | 0.162s | 0.103s | 0.265s |
| `cs_lob_preamble2.bak` | 0.106s | 0.063s | 0.169s |
| `delta_rowgroup_full.bak` | 0.064s | 0.04s | 0.104s |
| `dirtycoverage_aborted_xact.bak` | 0.08s | 0.04s | 0.12s |
| `dirtycoverage_addcol.bak` | 0.05s | 0.041s | 0.091s |
| `dirtycoverage_addnotnull.bak` | 0.05s | 0.034s | 0.084s |
| `dirtycoverage_alldirty.bak` | 0.079s | 0.036s | 0.115s |
| `dirtycoverage_altercol.bak` | 0.051s | 0.045s | 0.096s |
| `dirtycoverage_altercol_rewrite.bak` | 0.051s | 0.044s | 0.095s |
| `dirtycoverage_alterdb.bak` | 0.055s | 0.04s | 0.095s |
| `dirtycoverage_cci_delete.bak` | 0.122s | 0.095s | 0.217s |
| `dirtycoverage_cci_update.bak` | 0.216s | 0.097s | 0.313s |
| `dirtycoverage_committed_delete.bak` | 0.049s | 0.04s | 0.089s |
| `dirtycoverage_committed_delete_v2.bak` | 3.292s | 1.201s | 4.493s |
| `dirtycoverage_committed_delete_v3.bak` | 0.062s | 0.072s | 0.134s |
| `dirtycoverage_committed_delete_v4.bak` | 0.164s | 0.13s | 0.294s |
| `dirtycoverage_committed_update.bak` | 0.05s | 0.044s | 0.094s |
| `dirtycoverage_committed_update_v2.bak` | 12.424s | 2.146s | 14.57s |
| `dirtycoverage_committed_update_v3.bak` | 0.062s | 0.087s | 0.149s |
| `dirtycoverage_committed_update_v4.bak` | 0.112s | 0.142s | 0.254s |
| `dirtycoverage_compress_update.bak` | 0.083s | 0.041s | 0.124s |
| `dirtycoverage_concurrent.bak` | 0.055s | 0.047s | 0.102s |
| `dirtycoverage_createidx.bak` | 0.055s | 0.046s | 0.101s |
| `dirtycoverage_createtable.bak` | 0.057s | 0.041s | 0.098s |
| `dirtycoverage_delete.bak` | 0.081s | 0.042s | 0.123s |
| `dirtycoverage_dropcol.bak` | 0.053s | 0.057s | 0.11s |
| `dirtycoverage_dropidx.bak` | 0.05s | 0.035s | 0.085s |
| `dirtycoverage_droptable.bak` | 0.052s | 0.041s | 0.093s |
| `dirtycoverage_heap_forward.bak` | 0.156s | 0.069s | 0.225s |
| `dirtycoverage_insert_update.bak` | 0.083s | 0.043s | 0.126s |
| `dirtycoverage_large_dirty.bak` | 0.35s | 0.042s | 0.392s |
| `dirtycoverage_lob_update.bak` | 0.092s | 0.039s | 0.131s |
| `dirtycoverage_maxrow.bak` | 0.047s | 0.058s | 0.105s |
| `dirtycoverage_multi_update.bak` | 0.085s | 0.039s | 0.124s |
| `dirtycoverage_nchar_delete.bak` | 0.078s | 0.044s | 0.122s |
| `dirtycoverage_nested.bak` | 0.091s | 0.04s | 0.131s |
| `dirtycoverage_null_update.bak` | 0.104s | 0.054s | 0.158s |
| `dirtycoverage_rebuildidx.bak` | 0.052s | 0.042s | 0.094s |
| `dirtycoverage_rich_insert.bak` | 0.085s | 0.045s | 0.13s |
| `dirtycoverage_rich_update.bak` | 0.092s | 0.045s | 0.137s |
| `dirtycoverage_savepoint.bak` | 0.08s | 0.04s | 0.12s |
| `dirtycoverage_snapshot_update.bak` | 0.085s | 0.042s | 0.127s |
| `dirtycoverage_switch.bak` | 0.052s | 0.036s | 0.088s |
| `dirtycoverage_temporal_update.bak` | 0.085s | 0.039s | 0.124s |
| `dirtycoverage_truncate.bak` | 0.054s | 0.037s | 0.091s |
| `dirtycoverage_two_tx.bak` | 0.163s | 0.075s | 0.238s |
| `dirtycoverage_uncommitted.bak` | 0.081s | 0.036s | 0.117s |
| `dirtycoverage_update.bak` | 0.086s | 0.047s | 0.133s |
| `dirtycoverage_wide.bak` | 0.091s | 0.044s | 0.135s |
| `featurecoverage_full.bak` | 0.138s | 0.071s | 0.209s |
| `filtered_ncci_full.bak` | 0.053s | 0.045s | 0.098s |
| `float_extreme_full.bak` | 0.048s | 0.048s | 0.096s |
| `forwarded_records_full.bak` | 0.373s | 0.088s | 0.461s |
| `geocoverage_full.bak` | 0.069s | 0.053s | 0.122s |
| `geotest.bak` | 0.051s | 0.041s | 0.092s |
| `ghost_records_full.bak` | 0.048s | 0.045s | 0.093s |
| `heapcoverage_large.bak` | 0.061s | 0.043s | 0.104s |
| `heapcoverage_large_50000.bak` | 0.194s | 0.469s | 0.663s |
| `hierarchyid_extract_full.bak` | 0.047s | 0.04s | 0.087s |
| `high_slot_density_full.bak` | 0.08s | 0.248s | 0.328s |
| `incrementalcoverage_diff_01.bak` | 0.047s | 0.018s | 0.065s |
| `incrementalcoverage_diff_02.bak` | 0.048s | 0.02s | 0.068s |
| `incrementalcoverage_diff_03.bak` | 0.048s | 0.023s | 0.071s |
| `incrementalcoverage_diff_04.bak` | 0.05s | 0.019s | 0.069s |
| `incrementalcoverage_diff_05.bak` | 0.046s | 0.017s | 0.063s |
| `incrementalcoverage_diff_06.bak` | 0.064s | 0.018s | 0.082s |
| `incrementalcoverage_full.bak` | 0.046s | 0.039s | 0.085s |
| `layoutcoverage_full.bak` | 0.178s | 0.221s | 0.399s |
| `legacytext.bak` | 0.091s | 0.052s | 0.143s |
| `max_row_width_full.bak` | 0.05s | 0.038s | 0.088s |
| `mixed_collation_full.bak` | 0.047s | 0.043s | 0.09s |
| `multi_rowgroup_full.bak` | 0.059s | 0.045s | 0.104s |
| `ncci_heap_full.bak` | 0.054s | 0.038s | 0.092s |
| `ncci_types_full.bak` | 0.132s | 0.236s | 0.368s |
| `ndfcoverage_full.bak` | 0.052s | 0.04s | 0.092s |
| `nvarchar_max_u21_full.bak` | 0.048s | 0.039s | 0.087s |
| `ordered_cci_full.bak` | 0.051s | 0.044s | 0.095s |
| `pagecomp_anchor_full.bak` | 0.146s | 0.154s | 0.3s |
| `pagecomp_long_prefix_full.bak` | 0.05s | 0.059s | 0.109s |
| `pfor_columnstore_full.bak` | 0.138s | 1.141s | 1.279s |
| `pfor_columnstore_random_full.bak` | 0.151s | 1.13s | 1.281s |
| `realworld_numeric_digest_full.bak` | 0.067s | 0.109s | 0.176s |
| `rowboundary_full.bak` | 0.055s | 0.044s | 0.099s |
| `rowstore_hash_pii_full.bak` | 0.048s | 0.043s | 0.091s |
| `rowstore_lob_image_full.bak` | 0.047s | 0.033s | 0.08s |
| `rowstore_lob_markup_full.bak` | 0.048s | 0.04s | 0.088s |
| `rowversion_extract_full.bak` | 0.052s | 0.052s | 0.104s |
| `sparse_full.bak` | 0.102s | 0.146s | 0.248s |
| `spatial_edge_full.bak` | 0.057s | 0.046s | 0.103s |
| `spatial_index_full.bak` | 0.056s | 0.044s | 0.1s |
| `sql_variant_extract_full.bak` | 0.055s | 0.034s | 0.089s |
| `striped_full_1.bak` | 0.055s | 0.027s | 0.082s |
| `striped_single.bak` | 0.096s | 0.054s | 0.15s |
| `surrogate_pairs_full.bak` | 0.048s | 0.048s | 0.096s |
| `tabletype_cci_large_full.bak` | 0.073s | 0.06s | 0.133s |
| `tabletypecoverage_diff.bak` | 0.105s | 0.082s | 0.187s |
| `tabletypecoverage_full.bak` | 0.189s | 0.108s | 0.297s |
| `temporal_hidden_full.bak` | 0.054s | 0.038s | 0.092s |
| `torn_page_full.bak` | 0.041s | 0.041s | 0.082s |
| `typecoverage_full.bak` | 0.121s | 0.088s | 0.209s |
| `typecoverage_full_compressed.bak` | 0.163s | 0.115s | 0.278s |
| `typed_xml_full.bak` | 0.048s | 0.042s | 0.09s |
| `unicode_codepage_coverage.bak` | 0.085s | 0.059s | 0.144s |
| `utf8_collation_full.bak` | 0.05s | 0.039s | 0.089s |
| `xml_index_full.bak` | 0.054s | 0.039s | 0.093s |
| `xmlcoverage_full.bak` | 0.052s | 0.048s | 0.1s |
| `xmlheap_full.bak` | 0.111s | 0.073s | 0.184s |
| `xtp_checkpoint_straddle_full.bak` | 1.476s | 0.378s | 1.854s |
| `xtp_probe_full.bak` | 0.12s | 0.038s | 0.158s |
| `xtp_rich_full.bak` | 0.111s | 0.04s | 0.151s |
| `xtp_simple_full.bak` | 0.103s | 0.043s | 0.146s |
