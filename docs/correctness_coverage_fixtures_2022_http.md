...
| `archive_columnstore_partition_full.bak` | 2.626s |
| `archive_columnstore_types_full.bak` | 1.407s |
| `archive_columnstore_types_random_full.bak` | 1.411s |
| `archive_single_chunk_full.bak` | 0.126s |
| `archive_single_chunk_random_full.bak` | 0.109s |
| `archivenull_full.bak` | 0.32s |
| `backup_blocksize_full.bak` | 0.1s |
| `boundarycoverage_datetime_full.bak` | 0.461s |
| `boundarycoverage_full.bak` | 0.253s |
| `catalog_ss2022.bak` | 0.093s |
| `cci_binary_varbinary_compare_full.bak` | 0.111s |
| `cci_bitpack_probe_bigint_full.bak` | 9.064s |
| `cci_bitpack_probe_full.bak` | 1.852s |
| `cci_bitpack_probe_highbase_full.bak` | 1.389s |
| `cci_btree_nci_full.bak` | 0.123s |
| `cci_computed_full.bak` | 0.116s |
| `cci_enc5_largepool_full.bak` | 1.256s |
| `cci_enc5_largepool_matrix_full.bak` | 9.878s |
| `cci_extended_full.bak` | 0.181s |
| `cci_lob_full.bak` | 0.151s |
| `cci_reorganize_full.bak` | 0.134s |
| `cci_string_dict_regression_full.bak` | 0.557s |
| `cci_string_minmax_full.bak` | 0.117s |
| `cci_switch_full.bak` | 0.116s |
| `cci_types_large_full.bak` | 0.171s |
| `cci_varbinary_micro_full.bak` | 0.109s |
| `cci_varbinary_probe_full.bak` | 0.138s |
| `columnstore_minimal.bak` | 1.14s |
| `compressed_nvarchar_full.bak` | 0.118s |
| `compressioncoverage_full.bak` | 0.364s |
| `computedcoverage_full.bak` | 0.102s |
| `constraintcoverage_full.bak` | 0.104s |
| `corrupt_metadata_confidence_full.bak` | 0.004s |
| `covering_index_full.bak` | 0.115s |
| `cs_lob_preamble.bak` | 0.295s |
| `cs_lob_preamble2.bak` | 0.2s |
| `delta_rowgroup_full.bak` | 0.109s |
| `dirtycoverage_aborted_xact.bak` | 0.182s |
| `dirtycoverage_addcol.bak` | 0.091s |
| `dirtycoverage_addnotnull.bak` | 0.103s |
| `dirtycoverage_alldirty.bak` | 0.14s |
| `dirtycoverage_altercol.bak` | 0.1s |
| `dirtycoverage_altercol_rewrite.bak` | 0.098s |
| `dirtycoverage_alterdb.bak` | 0.096s |
| `dirtycoverage_cci_delete.bak` | 0.245s |
| `dirtycoverage_cci_update.bak` | 0.371s |
| `dirtycoverage_committed_delete.bak` | 0.1s |
| `dirtycoverage_committed_delete_v2.bak` | 3.241s |
| `dirtycoverage_committed_delete_v3.bak` | 0.165s |
| `dirtycoverage_committed_delete_v4.bak` | 0.369s |
| `dirtycoverage_committed_update.bak` | 0.104s |
| `dirtycoverage_committed_update_v2.bak` | 13.669s |
| `dirtycoverage_committed_update_v3.bak` | 0.192s |
| `dirtycoverage_committed_update_v4.bak` | 0.361s |
| `dirtycoverage_compress_update.bak` | 0.131s |
| `dirtycoverage_concurrent.bak` | 0.098s |
| `dirtycoverage_createidx.bak` | 0.106s |
| `dirtycoverage_createtable.bak` | 0.118s |
| `dirtycoverage_delete.bak` | 0.134s |
| `dirtycoverage_dropcol.bak` | 0.097s |
| `dirtycoverage_dropidx.bak` | 0.103s |
| `dirtycoverage_droptable.bak` | 0.111s |
| `dirtycoverage_heap_forward.bak` | 0.13s |
| `dirtycoverage_insert_update.bak` | 0.134s |
| `dirtycoverage_large_dirty.bak` | 0.415s |
| `dirtycoverage_lob_update.bak` | 0.14s |
| `dirtycoverage_maxrow.bak` | 0.108s |
| `dirtycoverage_multi_update.bak` | 0.139s |
| `dirtycoverage_nchar_delete.bak` | 0.153s |
| `dirtycoverage_nested.bak` | 0.132s |
| `dirtycoverage_null_update.bak` | 0.124s |
| `dirtycoverage_rebuildidx.bak` | 0.113s |
| `dirtycoverage_rich_insert.bak` | 0.131s |
| `dirtycoverage_rich_update.bak` | 0.126s |
| `dirtycoverage_savepoint.bak` | 0.144s |
| `dirtycoverage_snapshot_update.bak` | 0.172s |
| `dirtycoverage_switch.bak` | 0.095s |
| `dirtycoverage_temporal_update.bak` | 0.164s |
| `dirtycoverage_truncate.bak` | 0.104s |
| `dirtycoverage_two_tx.bak` | 0.172s |
| `dirtycoverage_uncommitted.bak` | 0.128s |
| `dirtycoverage_update.bak` | 0.137s |
| `dirtycoverage_wide.bak` | 0.132s |
| `featurecoverage_full.bak` | 0.226s |
| `filtered_ncci_full.bak` | 0.112s |
| `float_extreme_full.bak` | 0.092s |
| `forwarded_records_full.bak` | 0.28s |
| `geocoverage_full.bak` | 0.123s |
| `geotest.bak` | 0.106s |
| `ghost_records_full.bak` | 0.106s |
| `heapcoverage_large.bak` | 0.124s |
| `heapcoverage_large_50000.bak` | 1.057s |
| `hierarchyid_extract_full.bak` | 0.093s |
| `high_slot_density_full.bak` | 0.601s |
| `incrementalcoverage_diff_01.bak` | 0.116s |
| `incrementalcoverage_diff_02.bak` | 0.106s |
| `incrementalcoverage_diff_03.bak` | 0.091s |
| `incrementalcoverage_diff_04.bak` | 0.1s |
| `incrementalcoverage_diff_05.bak` | 0.111s |
| `incrementalcoverage_diff_06.bak` | 0.111s |
| `incrementalcoverage_full.bak` | 0.14s |
| `layoutcoverage_full.bak` | 0.394s |
| `legacytext.bak` | 0.16s |
| `max_row_width_full.bak` | 0.101s |
| `mixed_collation_full.bak` | 0.111s |
| `multi_rowgroup_full.bak` | 0.112s |
| `ncci_heap_full.bak` | 0.099s |
| `ncci_types_full.bak` | 0.547s |
| `ndfcoverage_full.bak` | 0.1s |
| `nvarchar_max_u21_full.bak` | 0.095s |
| `ordered_cci_full.bak` | 0.11s |
| `pagecomp_anchor_full.bak` | 0.391s |
| `pagecomp_long_prefix_full.bak` | 0.139s |
| `pfor_columnstore_full.bak` | 2.348s |
| `pfor_columnstore_random_full.bak` | 2.363s |
| `realworld_numeric_digest_full.bak` | 0.282s |
| `rowboundary_full.bak` | 0.097s |
| `rowstore_hash_pii_full.bak` | 0.104s |
| `rowstore_lob_image_full.bak` | 0.109s |
| `rowstore_lob_markup_full.bak` | 0.112s |
| `rowversion_extract_full.bak` | 0.113s |
| `sparse_full.bak` | 0.319s |
| `spatial_edge_full.bak` | 0.097s |
| `spatial_index_full.bak` | 0.104s |
| `sql_variant_extract_full.bak` | 0.109s |
| `striped_full_1.bak` | 0.111s |
| `striped_single.bak` | 0.158s |
| `surrogate_pairs_full.bak` | 0.084s |
| `tabletype_cci_large_full.bak` | 0.138s |
| `tabletypecoverage_diff.bak` | 0.258s |
| `tabletypecoverage_full.bak` | 0.258s |
| `temporal_hidden_full.bak` | 0.107s |
| `torn_page_full.bak` | 0.087s |
| `typecoverage_full.bak` | 0.194s |
| `typecoverage_full_compressed.bak` | 0.253s |
| `typed_xml_full.bak` | 0.111s |
| `unicode_codepage_coverage.bak` | 0.135s |
| `utf8_collation_full.bak` | 0.131s |
| `xml_index_full.bak` | 0.102s |
| `xmlcoverage_full.bak` | 0.11s |
| `xmlheap_full.bak` | 0.172s |
| `xtp_checkpoint_straddle_full.bak` | 3.136s |
| `xtp_probe_full.bak` | 0.158s |
| `xtp_rich_full.bak` | 0.164s |
| `xtp_simple_full.bak` | 0.162s |

---

_Generated 2026-07-08 · 146 fixtures · 145 pass · 0 xfail · 1 fail_
