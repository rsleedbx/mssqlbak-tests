...
| Backup | Wall time |
|--------|-------------|
| `alias_types_full.bak` | 0.092s |
| `archive_columnstore_partition_full.bak` | 2.424s |
| `archive_columnstore_types_full.bak` | 1.381s |
| `archive_columnstore_types_random_full.bak` | 1.377s |
| `archive_single_chunk_full.bak` | 0.112s |
| `archive_single_chunk_random_full.bak` | 0.116s |
| `archivenull_full.bak` | 0.342s |
| `backup_blocksize_full.bak` | 0.109s |
| `boundarycoverage_datetime_full.bak` | 0.448s |
| `boundarycoverage_full.bak` | 0.234s |
| `catalog_ss2022.bak` | 0.095s |
| `cci_binary_varbinary_compare_full.bak` | 0.108s |
| `cci_bitpack_probe_bigint_full.bak` | 8.728s |
| `cci_bitpack_probe_full.bak` | 1.831s |
| `cci_bitpack_probe_highbase_full.bak` | 1.297s |
| `cci_btree_nci_full.bak` | 0.128s |
| `cci_computed_full.bak` | 0.149s |
| `cci_enc5_largepool_full.bak` | 1.174s |
| `cci_enc5_largepool_matrix_full.bak` | 9.444s |
| `cci_extended_full.bak` | 0.178s |
| `cci_lob_full.bak` | 0.18s |
| `cci_reorganize_full.bak` | 0.126s |
| `cci_string_dict_regression_full.bak` | 0.538s |
| `cci_string_minmax_full.bak` | 0.116s |
| `cci_switch_full.bak` | 0.116s |
| `cci_types_large_full.bak` | 0.195s |
| `cci_varbinary_micro_full.bak` | 0.117s |
| `cci_varbinary_probe_full.bak` | 0.119s |
| `columnstore_minimal.bak` | 1.098s |
| `compressed_nvarchar_full.bak` | 0.093s |
| `compressioncoverage_full.bak` | 0.374s |
| `computedcoverage_full.bak` | 0.092s |
| `constraintcoverage_full.bak` | 0.112s |
| `corrupt_metadata_confidence_full.bak` | 0.007s |
| `covering_index_full.bak` | 0.118s |
| `cs_lob_preamble.bak` | 0.28s |
| `cs_lob_preamble2.bak` | 0.206s |
| `delta_rowgroup_full.bak` | 0.108s |
| `dirtycoverage_aborted_xact.bak` | 0.121s |
| `dirtycoverage_addcol.bak` | 0.099s |
| `dirtycoverage_addnotnull.bak` | 0.095s |
| `dirtycoverage_alldirty.bak` | 0.145s |
| `dirtycoverage_altercol.bak` | 0.091s |
| `dirtycoverage_altercol_rewrite.bak` | 0.114s |
| `dirtycoverage_alterdb.bak` | 0.109s |
| `dirtycoverage_cci_delete.bak` | 0.323s |
| `dirtycoverage_cci_update.bak` | 0.355s |
| `dirtycoverage_committed_delete.bak` | 0.1s |
| `dirtycoverage_committed_delete_v2.bak` | 3.235s |
| `dirtycoverage_committed_delete_v3.bak` | 0.16s |
| `dirtycoverage_committed_delete_v4.bak` | 0.381s |
| `dirtycoverage_committed_update.bak` | 0.12s |
| `dirtycoverage_committed_update_v2.bak` | 13.087s |
| `dirtycoverage_committed_update_v3.bak` | 0.187s |
| `dirtycoverage_committed_update_v4.bak` | 0.381s |
| `dirtycoverage_compress_update.bak` | 0.127s |
| `dirtycoverage_concurrent.bak` | 0.093s |
| `dirtycoverage_createidx.bak` | 0.099s |
| `dirtycoverage_createtable.bak` | 0.117s |
| `dirtycoverage_delete.bak` | 0.123s |
| `dirtycoverage_dropcol.bak` | 0.106s |
| `dirtycoverage_dropidx.bak` | 0.113s |
| `dirtycoverage_droptable.bak` | 0.107s |
| `dirtycoverage_heap_forward.bak` | 0.131s |
| `dirtycoverage_insert_update.bak` | 0.122s |
| `dirtycoverage_large_dirty.bak` | 0.398s |
| `dirtycoverage_lob_update.bak` | 0.148s |
| `dirtycoverage_maxrow.bak` | 0.1s |
| `dirtycoverage_multi_update.bak` | 0.126s |
| `dirtycoverage_nchar_delete.bak` | 0.125s |
| `dirtycoverage_nested.bak` | 0.14s |
| `dirtycoverage_null_update.bak` | 0.136s |
| `dirtycoverage_rebuildidx.bak` | 0.103s |
| `dirtycoverage_rich_insert.bak` | 0.116s |
| `dirtycoverage_rich_update.bak` | 0.133s |
| `dirtycoverage_savepoint.bak` | 0.124s |
| `dirtycoverage_snapshot_update.bak` | 0.117s |
| `dirtycoverage_switch.bak` | 0.1s |
| `dirtycoverage_temporal_update.bak` | 0.124s |
| `dirtycoverage_truncate.bak` | 0.124s |
| `dirtycoverage_two_tx.bak` | 0.117s |
| `dirtycoverage_uncommitted.bak` | 0.13s |
| `dirtycoverage_update.bak` | 0.123s |
| `dirtycoverage_wide.bak` | 0.124s |
| `featurecoverage_full.bak` | 0.199s |
| `filtered_ncci_full.bak` | 0.109s |
| `float_extreme_full.bak` | 0.094s |
| `forwarded_records_full.bak` | 0.232s |
| `geocoverage_full.bak` | 0.13s |
| `geotest.bak` | 0.101s |
| `ghost_records_full.bak` | 0.099s |
| `heapcoverage_large.bak` | 0.133s |
| `heapcoverage_large_50000.bak` | 0.988s |
| `hierarchyid_extract_full.bak` | 0.093s |
| `high_slot_density_full.bak` | 0.577s |
| `incrementalcoverage_diff_01.bak` | 0.12s |
| `incrementalcoverage_diff_02.bak` | 0.091s |
| `incrementalcoverage_diff_03.bak` | 0.09s |
| `incrementalcoverage_diff_04.bak` | 0.115s |
| `incrementalcoverage_diff_05.bak` | 0.096s |
| `incrementalcoverage_diff_06.bak` | 0.122s |
| `incrementalcoverage_full.bak` | 0.088s |
| `layoutcoverage_full.bak` | 0.39s |
| `legacytext.bak` | 0.217s |
| `max_row_width_full.bak` | 0.098s |
| `mixed_collation_full.bak` | 0.104s |
| `multi_rowgroup_full.bak` | 0.182s |
| `ncci_heap_full.bak` | 0.099s |
| `ncci_types_full.bak` | 0.529s |
| `ndfcoverage_full.bak` | 0.113s |
| `nvarchar_max_u21_full.bak` | 0.107s |
| `ordered_cci_full.bak` | 0.119s |
| `pagecomp_anchor_full.bak` | 0.374s |
| `pagecomp_long_prefix_full.bak` | 0.095s |
| `pfor_columnstore_full.bak` | 2.284s |
| `pfor_columnstore_random_full.bak` | 2.28s |
| `realworld_numeric_digest_full.bak` | 0.235s |
| `rowboundary_full.bak` | 0.094s |
| `rowstore_hash_pii_full.bak` | 0.086s |
| `rowstore_lob_image_full.bak` | 0.104s |
| `rowstore_lob_markup_full.bak` | 0.1s |
| `rowversion_extract_full.bak` | 0.124s |
| `sparse_full.bak` | 0.333s |
| `spatial_edge_full.bak` | 0.098s |
| `spatial_index_full.bak` | 0.108s |
| `sql_variant_extract_full.bak` | 0.093s |
| `striped_full_1.bak` | 0.114s |
| `striped_single.bak` | 0.154s |
| `surrogate_pairs_full.bak` | 0.087s |
| `tabletype_cci_large_full.bak` | 0.149s |
| `tabletypecoverage_diff.bak` | 0.24s |
| `tabletypecoverage_full.bak` | 0.222s |
| `temporal_hidden_full.bak` | 0.105s |
| `torn_page_full.bak` | 0.082s |
| `typecoverage_full.bak` | 0.221s |
| `typecoverage_full_compressed.bak` | 0.269s |
| `typed_xml_full.bak` | 0.103s |
| `unicode_codepage_coverage.bak` | 0.144s |
| `utf8_collation_full.bak` | 0.092s |
| `xml_index_full.bak` | 0.107s |
| `xmlcoverage_full.bak` | 0.109s |
| `xmlheap_full.bak` | 0.17s |
| `xtp_checkpoint_straddle_full.bak` | 2.942s |
| `xtp_probe_full.bak` | 0.178s |
| `xtp_rich_full.bak` | 0.162s |
| `xtp_simple_full.bak` | 0.155s |
