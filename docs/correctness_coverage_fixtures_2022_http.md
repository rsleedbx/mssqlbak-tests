...
|--------|---------|--------|-----------|
| `alias_types_full.bak` | 0.05s | 0.041s | 0.091s |
| `archive_columnstore_partition_full.bak` | 0.957s | 0.615s | 1.572s |
| `archive_columnstore_types_full.bak` | 0.355s | 0.693s | 1.048s |
| `archive_columnstore_types_random_full.bak` | 0.359s | 0.692s | 1.051s |
| `archive_single_chunk_full.bak` | 0.057s | 0.039s | 0.096s |
| `archive_single_chunk_random_full.bak` | 0.057s | 0.037s | 0.094s |
| `archivenull_full.bak` | 0.14s | 0.098s | 0.238s |
| `backup_blocksize_full.bak` | 0.05s | 0.037s | 0.087s |
| `boundarycoverage_datetime_full.bak` | 0.075s | 0.154s | 0.229s |
| `boundarycoverage_full.bak` | 0.065s | 0.071s | 0.136s |
| `catalog_ss2022.bak` | 0.045s | 0.042s | 0.087s |
| `cci_binary_varbinary_compare_full.bak` | 0.057s | 0.042s | 0.099s |
| `cci_bitpack_probe_bigint_full.bak` | 1.3s | 3.863s | 5.163s |
| `cci_bitpack_probe_full.bak` | 0.131s | 0.673s | 0.804s |
| `cci_bitpack_probe_highbase_full.bak` | 0.12s | 0.44s | 0.56s |
| `cci_btree_nci_full.bak` | 0.06s | 0.042s | 0.102s |
| `cci_computed_full.bak` | 0.056s | 0.042s | 0.098s |
| `cci_enc5_largepool_full.bak` | 0.376s | 0.446s | 0.822s |
| `cci_enc5_largepool_matrix_full.bak` | 7.24s | 1.258s | 8.498s |
| `cci_extended_full.bak` | 0.069s | 0.046s | 0.115s |
| `cci_lob_full.bak` | 0.065s | 0.045s | 0.11s |
| `cci_reorganize_full.bak` | 0.054s | 0.038s | 0.092s |
| `cci_string_dict_regression_full.bak` | 0.339s | 0.158s | 0.497s |
| `cci_string_minmax_full.bak` | 0.06s | 0.049s | 0.109s |
| `cci_switch_full.bak` | 0.059s | 0.044s | 0.103s |
| `cci_types_large_full.bak` | 0.071s | 0.046s | 0.117s |
| `cci_varbinary_micro_full.bak` | 0.054s | 0.036s | 0.09s |
| `cci_varbinary_probe_full.bak` | 0.053s | 0.05s | 0.103s |
| `columnstore_minimal.bak` | 0.132s | 1.045s | 1.177s |
| `compressed_nvarchar_full.bak` | 0.051s | 0.033s | 0.084s |
| `compressioncoverage_full.bak` | 0.105s | 0.184s | 0.289s |
| `computedcoverage_full.bak` | 0.049s | 0.036s | 0.085s |
| `constraintcoverage_full.bak` | 0.053s | 0.046s | 0.099s |
| `corrupt_metadata_confidence_full.bak` | 0s | 0.001s | 0.001s |
| `covering_index_full.bak` | 0.051s | 0.043s | 0.094s |
| `cs_lob_preamble.bak` | 0.16s | 0.088s | 0.248s |
| `cs_lob_preamble2.bak` | 0.171s | 0.062s | 0.233s |
| `delta_rowgroup_full.bak` | 0.051s | 0.039s | 0.09s |
| `dirtycoverage_aborted_xact.bak` | 0.073s | 0.046s | 0.119s |
| `dirtycoverage_addcol.bak` | 0.052s | 0.041s | 0.093s |
| `dirtycoverage_addnotnull.bak` | 0.05s | 0.041s | 0.091s |
| `dirtycoverage_alldirty.bak` | 0.073s | 0.038s | 0.111s |
| `dirtycoverage_altercol.bak` | 0.052s | 0.034s | 0.086s |
| `dirtycoverage_altercol_rewrite.bak` | 0.052s | 0.041s | 0.093s |
| `dirtycoverage_alterdb.bak` | 0.055s | 0.043s | 0.098s |
| `dirtycoverage_cci_delete.bak` | 0.146s | 0.135s | 0.281s |
| `dirtycoverage_cci_update.bak` | 0.22s | 0.094s | 0.314s |
| `dirtycoverage_committed_delete.bak` | 0.046s | 0.037s | 0.083s |
| `dirtycoverage_committed_delete_v2.bak` | 3.323s | 0.615s | 3.938s |
| `dirtycoverage_committed_delete_v3.bak` | 0.062s | 0.058s | 0.12s |
| `dirtycoverage_committed_delete_v4.bak` | 0.177s | 0.08s | 0.257s |
| `dirtycoverage_committed_update.bak` | 0.05s | 0.036s | 0.086s |
| `dirtycoverage_committed_update_v2.bak` | 12.499s | 0.921s | 13.42s |
| `dirtycoverage_committed_update_v3.bak` | 0.061s | 0.066s | 0.127s |
| `dirtycoverage_committed_update_v4.bak` | 0.116s | 0.083s | 0.199s |
| `dirtycoverage_compress_update.bak` | 0.091s | 0.039s | 0.13s |
| `dirtycoverage_concurrent.bak` | 0.054s | 0.034s | 0.088s |
| `dirtycoverage_createidx.bak` | 0.067s | 0.038s | 0.105s |
| `dirtycoverage_createtable.bak` | 0.05s | 0.041s | 0.091s |
| `dirtycoverage_delete.bak` | 0.079s | 0.041s | 0.12s |
| `dirtycoverage_dropcol.bak` | 0.053s | 0.044s | 0.097s |
| `dirtycoverage_dropidx.bak` | 0.051s | 0.035s | 0.086s |
| `dirtycoverage_droptable.bak` | 0.055s | 0.036s | 0.091s |
| `dirtycoverage_heap_forward.bak` | 0.072s | 0.042s | 0.114s |
| `dirtycoverage_insert_update.bak` | 0.082s | 0.051s | 0.133s |
| `dirtycoverage_large_dirty.bak` | 0.348s | 0.034s | 0.382s |
| `dirtycoverage_lob_update.bak` | 0.096s | 0.038s | 0.134s |
| `dirtycoverage_maxrow.bak` | 0.051s | 0.035s | 0.086s |
| `dirtycoverage_multi_update.bak` | 0.085s | 0.036s | 0.121s |
| `dirtycoverage_nchar_delete.bak` | 0.077s | 0.036s | 0.113s |
| `dirtycoverage_nested.bak` | 0.082s | 0.036s | 0.118s |
| `dirtycoverage_null_update.bak` | 0.091s | 0.042s | 0.133s |
| `dirtycoverage_rebuildidx.bak` | 0.056s | 0.043s | 0.099s |
| `dirtycoverage_rich_insert.bak` | 0.074s | 0.037s | 0.111s |
| `dirtycoverage_rich_update.bak` | 0.09s | 0.042s | 0.132s |
| `dirtycoverage_savepoint.bak` | 0.083s | 0.044s | 0.127s |
| `dirtycoverage_snapshot_update.bak` | 0.077s | 0.044s | 0.121s |
| `dirtycoverage_switch.bak` | 0.057s | 0.04s | 0.097s |
| `dirtycoverage_temporal_update.bak` | 0.075s | 0.047s | 0.122s |
| `dirtycoverage_truncate.bak` | 0.052s | 0.035s | 0.087s |
| `dirtycoverage_two_tx.bak` | 0.085s | 0.041s | 0.126s |
| `dirtycoverage_uncommitted.bak` | 0.084s | 0.045s | 0.129s |
| `dirtycoverage_update.bak` | 0.084s | 0.035s | 0.119s |
| `dirtycoverage_wide.bak` | 0.09s | 0.036s | 0.126s |
| `featurecoverage_full.bak` | 0.172s | 0.116s | 0.288s |
| `filtered_ncci_full.bak` | 0.055s | 0.039s | 0.094s |
| `float_extreme_full.bak` | 0.047s | 0.034s | 0.081s |
| `forwarded_records_full.bak` | 0.364s | 0.075s | 0.439s |
| `geocoverage_full.bak` | 0.061s | 0.044s | 0.105s |
| `geotest.bak` | 0.054s | 0.041s | 0.095s |
| `ghost_records_full.bak` | 0.048s | 0.043s | 0.091s |
| `heapcoverage_large.bak` | 0.051s | 0.042s | 0.093s |
| `heapcoverage_large_50000.bak` | 0.201s | 0.331s | 0.532s |
| `hierarchyid_extract_full.bak` | 0.047s | 0.034s | 0.081s |
| `high_slot_density_full.bak` | 0.075s | 0.194s | 0.269s |
| `identity_coverage_full.bak` | 0.06s | 0.05s | 0.11s |
| `incrementalcoverage_diff_01.bak` | 0.049s | 0.014s | 0.063s |
| `incrementalcoverage_diff_02.bak` | 0.052s | 0.013s | 0.065s |
| `incrementalcoverage_diff_03.bak` | 0.049s | 0.029s | 0.078s |
| `incrementalcoverage_diff_04.bak` | 0.051s | 0.019s | 0.07s |
| `incrementalcoverage_diff_05.bak` | 0.048s | 0.014s | 0.062s |
| `incrementalcoverage_diff_06.bak` | 0.048s | 0.013s | 0.061s |
| `incrementalcoverage_full.bak` | 0.045s | 0.033s | 0.078s |
| `layoutcoverage_full.bak` | 0.175s | 0.358s | 0.533s |
| `legacytext.bak` | 0.086s | 0.054s | 0.14s |
| `max_row_width_full.bak` | 0.047s | 0.034s | 0.081s |
| `mixed_collation_full.bak` | 0.046s | 0.035s | 0.081s |
| `multi_rowgroup_full.bak` | 0.06s | 0.039s | 0.099s |
| `ncci_heap_full.bak` | 0.05s | 0.037s | 0.087s |
| `ncci_types_full.bak` | 0.118s | 0.183s | 0.301s |
| `ndfcoverage_full.bak` | 0.056s | 0.048s | 0.104s |
| `nvarchar_max_u21_full.bak` | 0.05s | 0.034s | 0.084s |
| `ordered_cci_full.bak` | 0.052s | 0.044s | 0.096s |
| `pagecomp_anchor_full.bak` | 0.139s | 0.102s | 0.241s |
| `pagecomp_long_prefix_full.bak` | 0.05s | 0.034s | 0.084s |
| `pfor_columnstore_full.bak` | 0.142s | 0.849s | 0.991s |
| `pfor_columnstore_random_full.bak` | 0.143s | 0.856s | 0.999s |
| `realworld_numeric_digest_full.bak` | 0.064s | 0.089s | 0.153s |
| `rowboundary_full.bak` | 0.051s | 0.043s | 0.094s |
| `rowstore_hash_pii_full.bak` | 0.051s | 0.033s | 0.084s |
| `rowstore_lob_image_full.bak` | 0.047s | 0.034s | 0.081s |
| `rowstore_lob_markup_full.bak` | 0.047s | 0.04s | 0.087s |
| `rowversion_extract_full.bak` | 0.051s | 0.041s | 0.092s |
| `sparse_full.bak` | 0.108s | 0.097s | 0.205s |
| `spatial_edge_full.bak` | 0.053s | 0.041s | 0.094s |
| `spatial_index_full.bak` | 0.056s | 0.039s | 0.095s |
| `sql_variant_extract_full.bak` | 0.05s | 0.035s | 0.085s |
| `striped_full_1.bak` | 0.057s | 0.016s | 0.073s |
| `striped_single.bak` | 0.085s | 0.052s | 0.137s |
| `surrogate_pairs_full.bak` | 0.045s | 0.039s | 0.084s |
| `tabletype_cci_large_full.bak` | 0.075s | 0.055s | 0.13s |
| `tabletypecoverage_diff.bak` | 0.107s | 0.076s | 0.183s |
| `tabletypecoverage_full.bak` | 0.19s | 0.125s | 0.315s |
| `temporal_hidden_full.bak` | 0.054s | 0.044s | 0.098s |
| `torn_page_full.bak` | 0.043s | 0.031s | 0.074s |
| `typecoverage_full.bak` | 0.123s | 0.081s | 0.204s |
| `typecoverage_full_compressed.bak` | 0.163s | 0.103s | 0.266s |
| `typed_xml_full.bak` | 0.049s | 0.037s | 0.086s |
| `unicode_codepage_coverage.bak` | 0.078s | 0.045s | 0.123s |
| `utf8_collation_full.bak` | 0.053s | 0.038s | 0.091s |
| `xml_index_full.bak` | 0.066s | 0.038s | 0.104s |
| `xmlcoverage_full.bak` | 0.054s | 0.04s | 0.094s |
| `xmlheap_full.bak` | 0.109s | 0.066s | 0.175s |
| `xtp_checkpoint_straddle_full.bak` | 1.444s | 0.347s | 1.791s |
| `xtp_probe_full.bak` | 0.12s | 0.046s | 0.166s |
| `xtp_rich_full.bak` | 0.11s | 0.049s | 0.159s |
| `xtp_simple_full.bak` | 0.103s | 0.039s | 0.142s |
