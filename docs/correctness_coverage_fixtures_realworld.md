...
| Backup | Wall time |
|--------|-------------|
| `AdventureWorks2008R2.bak` | 45.082s |
| `AdventureWorks2012.bak` | 42.307s |
| `AdventureWorks2014.bak` | 43.961s |
| `AdventureWorks2016.bak` | 43.144s |
| `AdventureWorks2016_EXT.bak` | 150.593s |
| `AdventureWorks2017.bak` | 42.72s |
| `AdventureWorks2019.bak` | 41.434s |
| `AdventureWorks2022.bak` | 40.827s |
| `AdventureWorks2025.bak` | 42.604s |
| `AdventureWorksDW2008R2.bak` | 16.214s |
| `AdventureWorksDW2012.bak` | 40.073s |
| `AdventureWorksDW2014.bak` | 40.691s |
| `AdventureWorksDW2016.bak` | 45.102s |
| `AdventureWorksDW2016_EXT.bak` | 359.914s |
| `AdventureWorksDW2017.bak` | 45.775s |
| `AdventureWorksDW2019.bak` | 39.698s |
| `AdventureWorksDW2022.bak` | 39.204s |
| `AdventureWorksDW2025.bak` | 40.144s |
| `AdventureWorksLT2012.bak` | 0.289s |
| `AdventureWorksLT2014.bak` | 0.309s |
| `AdventureWorksLT2016.bak` | 0.292s |
| `AdventureWorksLT2017.bak` | 0.3s |
| `AdventureWorksLT2019.bak` | 0.313s |
| `AdventureWorksLT2022.bak` | 0.303s |
| `AdventureWorksLT2025.bak` | 0.39s |
| `BaseballData.bak` | 37.267s |
| `Chinook-id-pk.bak` | 0.381s |
| `Chinook.bak` | 0.364s |
| `ContosoRetailDW.bak` | 1241.973s |
| `CreditBackup100.bak` | 45.615s |
| `data.gov.bak` | 4.239s |
| `dba.stackexchange.com.bak` | 71.322s |
| `EmployeeCaseStudySampleDB2012.bak` | 10.332s |
| `GeneralHospital.bak` | 62.653s |
| `IndexInternals2008.bak` | 5.685s |
| `NYCTaxi_Sample.bak` | 63.417s |
| `Pubs.bak` | 0.131s |
| `SalesDB2014.bak` | 55.234s |
| `SalesDBOriginal.bak` | 54.571s |
| `StackOverflowMini.bak` | 185.079s |
| `tpcxbb_1gb.bak` | 291.398s |
| `TutorialDB.bak` | 0.091s |
| `WideWorldImporters-Full.bak` | 116.391s |
| `WideWorldImporters-Full_old.bak` | 111.229s |
| `WideWorldImporters-Standard.bak` | 109.202s |
| `WideWorldImporters-Standard_old.bak` | 108.158s |
| `WideWorldImportersDW-Full.bak` | 77.734s |
| `WideWorldImportersDW-Standard.bak` | 71.518s |

---

_Generated 2026-07-08 · 48 fixtures · 48 pass · 0 xfail · 0 fail_
