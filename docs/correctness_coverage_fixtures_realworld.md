...
| Backup | Wall time |
|--------|-------------|
| `AdventureWorks2008R2.bak` | 40.965s |
| `AdventureWorks2012.bak` | 44.835s |
| `AdventureWorks2014.bak` | 40.984s |
| `AdventureWorks2016.bak` | 43.208s |
| `AdventureWorks2016_EXT.bak` | 150.657s |
| `AdventureWorks2017.bak` | 42.227s |
| `AdventureWorks2019.bak` | 46.753s |
| `AdventureWorks2022.bak` | 39.297s |
| `AdventureWorks2025.bak` | 42.256s |
| `AdventureWorksDW2008R2.bak` | 15.961s |
| `AdventureWorksDW2012.bak` | 39.115s |
| `AdventureWorksDW2014.bak` | 41.209s |
| `AdventureWorksDW2016.bak` | 40.578s |
| `AdventureWorksDW2016_EXT.bak` | 359.952s |
| `AdventureWorksDW2017.bak` | 40.888s |
| `AdventureWorksDW2019.bak` | 45.017s |
| `AdventureWorksDW2022.bak` | 38.233s |
| `AdventureWorksDW2025.bak` | 43.549s |
| `AdventureWorksLT2012.bak` | 0.286s |
| `AdventureWorksLT2014.bak` | 0.315s |
| `AdventureWorksLT2016.bak` | 0.281s |
| `AdventureWorksLT2017.bak` | 0.298s |
| `AdventureWorksLT2019.bak` | 0.307s |
| `AdventureWorksLT2022.bak` | 0.29s |
| `AdventureWorksLT2025.bak` | 0.38s |
| `BaseballData.bak` | 36.502s |
| `Chinook-id-pk.bak` | 0.377s |
| `Chinook.bak` | 0.363s |
| `ContosoRetailDW.bak` | 1212.07s |
| `CreditBackup100.bak` | 43.094s |
| `data.gov.bak` | 4.139s |
| `dba.stackexchange.com.bak` | 67.568s |
| `EmployeeCaseStudySampleDB2012.bak` | 10.073s |
| `GeneralHospital.bak` | 60.612s |
| `IndexInternals2008.bak` | 5.547s |
| `NYCTaxi_Sample.bak` | 60.697s |
| `Pubs.bak` | 0.119s |
| `SalesDB2014.bak` | 52.037s |
| `SalesDBOriginal.bak` | 51.924s |
| `StackOverflowMini.bak` | 185.654s |
| `tpcxbb_1gb.bak` | 294.327s |
| `TutorialDB.bak` | 0.093s |
| `WideWorldImporters-Full.bak` | 114.652s |
| `WideWorldImporters-Full_old.bak` | 108.9s |
| `WideWorldImporters-Standard.bak` | 104.821s |
| `WideWorldImporters-Standard_old.bak` | 105.111s |
| `WideWorldImportersDW-Full.bak` | 72.879s |
| `WideWorldImportersDW-Standard.bak` | 68.322s |

---

_Generated 2026-07-06 · 48 fixtures · 48 pass · 0 xfail · 0 fail_
