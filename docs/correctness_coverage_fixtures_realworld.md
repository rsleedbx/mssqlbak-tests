...
| Backup | Wall time |
|--------|-------------|
| `AdventureWorks2008R2.bak` | 41.963s |
| `AdventureWorks2012.bak` | 47.417s |
| `AdventureWorks2014.bak` | 43.708s |
| `AdventureWorks2016.bak` | 43.773s |
| `AdventureWorks2016_EXT.bak` | 157.932s |
| `AdventureWorks2017.bak` | 43.94s |
| `AdventureWorks2019.bak` | 45.829s |
| `AdventureWorks2022.bak` | 51.852s |
| `AdventureWorks2025.bak` | 47.444s |
| `AdventureWorksDW2008R2.bak` | 17.746s |
| `AdventureWorksDW2012.bak` | 50.352s |
| `AdventureWorksDW2014.bak` | 51.831s |
| `AdventureWorksDW2016.bak` | 41.791s |
| `AdventureWorksDW2016_EXT.bak` | 375.373s |
| `AdventureWorksDW2017.bak` | 43.346s |
| `AdventureWorksDW2019.bak` | 49.902s |
| `AdventureWorksDW2022.bak` | 49.687s |
| `AdventureWorksDW2025.bak` | 51.527s |
| `AdventureWorksLT2012.bak` | 0.388s |
| `AdventureWorksLT2014.bak` | 0.437s |
| `AdventureWorksLT2016.bak` | 0.363s |
| `AdventureWorksLT2017.bak` | 0.386s |
| `AdventureWorksLT2019.bak` | 0.448s |
| `AdventureWorksLT2022.bak` | 0.504s |
| `AdventureWorksLT2025.bak` | 0.527s |
| `BaseballData.bak` | 39.502s |
| `Chinook-id-pk.bak` | 0.427s |
| `Chinook.bak` | 0.442s |
| `ContosoRetailDW.bak` | 1329.316s |
| `CreditBackup100.bak` | 47.239s |
| `data.gov.bak` | 4.77s |
| `dba.stackexchange.com.bak` | 78.168s |
| `EmployeeCaseStudySampleDB2012.bak` | 11.181s |
| `GeneralHospital.bak` | 67.207s |
| `IndexInternals2008.bak` | 6.355s |
| `NYCTaxi_Sample.bak` | 67.838s |
| `Pubs.bak` | 0.178s |
| `SalesDB2014.bak` | 62.4s |
| `SalesDBOriginal.bak` | 60.831s |
| `StackOverflowMini.bak` | 193.055s |
| `tpcxbb_1gb.bak` | 305.686s |
| `TutorialDB.bak` | 0.12s |
| `WideWorldImporters-Full.bak` | 120.812s |
| `WideWorldImporters-Full_old.bak` | 117.722s |
| `WideWorldImporters-Standard.bak` | 113.77s |
| `WideWorldImporters-Standard_old.bak` | 114.893s |
| `WideWorldImportersDW-Full.bak` | 80.868s |
| `WideWorldImportersDW-Standard.bak` | 74.804s |
