...
| `StackOverflowMini.bak` | arrow→pg_dir | 8,097,337 | 61 | 0/8 ⚠ ⚠ (`dbo.Badges`, `dbo.Comments`, `dbo.LinkTypes`, `dbo.PostTypes`, `dbo.Posts`, `dbo.Users`, `dbo.VoteTypes`, `dbo.Votes`) | — | — | 0/8 ⚠ | — | ✗ |
| `StackOverflowMini.bak` | pg_dir→arrow | 8,097,337 | 61 | 1/9 ⚠ ⚠ (`dbo.Badges`, `dbo.Comments`, `dbo.LinkTypes`, `dbo.Posts`, `dbo.PostTypes`, `dbo.Users`, `dbo.Votes`, `dbo.VoteTypes`) | — | — | 1/9 ⚠ | — | ✗ |
...
| `WideWorldImportersDW-Full.bak` | delta→arrow | 922,709 | 50 | **24/24** | **24/24** | **46/46** | **24/24** | 2922/2922 ⚠ | ✗ |
...
| `WideWorldImportersDW-Standard.bak` | delta→arrow | 922,709 | 50 | **24/24** | **24/24** | **46/46** | **24/24** | 2922/2922 ⚠ | ✗ |
...
| Table | Type | Source rows | Row count | Null count | Min/max | Col count | Notes |
|-------|------|------------:|:---------:|:----------:|:-------:|:---------:|-------|
| `dbo.Badges` | rowstore | 444,073 | ✗ | — | — | ✗ | missing from output |
...
| Table | Type | Source rows | Row count | Null count | Min/max | Col count | Notes |
|-------|------|------------:|:---------:|:----------:|:-------:|:---------:|-------|
| `Dimension.City` | rowstore | 116,295 | ✓ | **6/6** | **12/12** | ✓ | cells ✗ () |
| `Dimension.Customer` | rowstore | 403 | ✓ | **2/2** | **4/4** | ✓ | cells ✗ () |
| `Dimension.Date` | rowstore | 1,461 | ✓ | **3/3** | **6/6** | ✓ | cells **2922/2922** ✓ |
| `Dimension.Employee` | rowstore | 213 | ✓ | **2/2** | **2/2** | ✓ | cells ✗ () |
| `Dimension.Supplier` | rowstore | 28 | ✓ | **2/2** | **4/4** | ✓ | cells ✗ () |
| `Fact.Movement` | columnstore | 236,667 | ✓ | **1/1** | **2/2** | ✓ | cells ✗ () |
| `Fact.Order` | columnstore | 231,412 | ✓ | **3/3** | **6/6** | ✓ | cells ✗ () |
| `Fact.Purchase` | columnstore | 8,367 | ✓ | **1/1** | **2/2** | ✓ | cells ✗ () |
| `Fact.Sale` | columnstore | 228,265 | ✓ | **4/4** | **8/8** | ✓ | cells ✗ () |
| `Fact.Transaction` | columnstore | 99,585 | ✓ | — | — | ✓ | cells ✗ () |
| `Integration.City_Staging` | rowstore | 0 | — | — | — | — |  |
| `Integration.Customer_Staging` | memory-optimized | 0 | — | — | — | — |  |
| `Integration.Employee_Staging` | memory-optimized | 0 | — | — | — | — |  |
| `Integration.Lineage` | rowstore | 13 | ✓ | — | — | ✓ | cells ✗ () |
| `Integration.Movement_Staging` | memory-optimized | 0 | — | — | — | — |  |
| `Integration.Order_Staging` | memory-optimized | 0 | — | — | — | — |  |
| `Integration.PaymentMethod_Staging` | memory-optimized | 0 | — | — | — | — |  |
| `Integration.Purchase_Staging` | memory-optimized | 0 | — | — | — | — |  |
...
| `Dimension.Employee` | rowstore | 213 | ✓ | **2/2** | **2/2** | ✓ | cells ✗ () |
| `Dimension.Supplier` | rowstore | 28 | ✓ | **2/2** | **4/4** | ✓ | cells ✗ () |
| `Fact.Movement` | rowstore | 236,667 | ✓ | **1/1** | **2/2** | ✓ | cells ✗ () |
| `Fact.Order` | rowstore | 231,412 | ✓ | **3/3** | **6/6** | ✓ | cells ✗ () |
| `Fact.Purchase` | rowstore | 8,367 | ✓ | **1/1** | **2/2** | ✓ | cells ✗ () |
| `Fact.Sale` | rowstore | 228,265 | ✓ | **4/4** | **8/8** | ✓ | cells ✗ () |
| `Fact.Transaction` | rowstore | 99,585 | ✓ | — | — | ✓ | cells ✗ () |
| `Integration.City_Staging` | rowstore | 0 | — | — | — | — |  |
| `Integration.Customer_Staging` | rowstore | 0 | — | — | — | — |  |
| `Integration.Employee_Staging` | rowstore | 0 | — | — | — | — |  |
| `Integration.Lineage` | rowstore | 13 | ✓ | — | — | ✓ | cells ✗ () |
...
|--------|---------|--------|-----------|
| `AdventureWorks2008R2.bak` | 16.924s | 31.442s | 48.366s |
| `AdventureWorks2012.bak` | 15.993s | 31.467s | 47.46s |
| `AdventureWorks2014.bak` | 15.649s | 32.197s | 47.846s |
| `AdventureWorks2016.bak` | 16.704s | 31.812s | 48.516s |
| `AdventureWorks2016_EXT.bak` | 37.009s | 56.373s | 93.382s |
| `AdventureWorks2017.bak` | 15.817s | 32.064s | 47.881s |
| `AdventureWorks2019.bak` | 15.017s | 31.699s | 46.716s |
| `AdventureWorks2022.bak` | 16.69s | 31.346s | 48.036s |
| `AdventureWorks2025.bak` | 15.884s | 31.106s | 46.99s |
| `AdventureWorksDW2008R2.bak` | 4.134s | 11.392s | 15.526s |
| `AdventureWorksDW2012.bak` | 9.78s | 34.576s | 44.356s |
| `AdventureWorksDW2014.bak` | 10.558s | 34.429s | 44.987s |
| `AdventureWorksDW2016.bak` | 9.874s | 33.992s | 43.866s |
| `AdventureWorksDW2016_EXT.bak` | 652.882s | 549.186s | 1202.068s |
| `AdventureWorksDW2017.bak` | 10.639s | 34.252s | 44.891s |
| `AdventureWorksDW2019.bak` | 10.35s | 34.789s | 45.139s |
| `AdventureWorksDW2022.bak` | 9.589s | 33.957s | 43.546s |
| `AdventureWorksDW2025.bak` | 9.749s | 33.754s | 43.503s |
| `AdventureWorksLT2012.bak` | 0.241s | 0.318s | 0.559s |
| `AdventureWorksLT2014.bak` | 0.239s | 0.325s | 0.564s |
| `AdventureWorksLT2016.bak` | 0.186s | 0.328s | 0.514s |
| `AdventureWorksLT2017.bak` | 0.189s | 0.329s | 0.518s |
| `AdventureWorksLT2019.bak` | 0.224s | 0.33s | 0.554s |
| `AdventureWorksLT2022.bak` | 0.213s | 0.348s | 0.561s |
| `AdventureWorksLT2025.bak` | 0.23s | 0.346s | 0.576s |
| `BaseballData.bak` | 13.426s | 16.589s | 30.015s |
| `Chinook-id-pk.bak` | 0.202s | 0.387s | 0.589s |
| `Chinook.bak` | 0.159s | 0.566s | 0.725s |
| `ContosoRetailDW.bak` | 540.94s | 1426.137s | 1967.077s |
| `CreditBackup100.bak` | 24.498s | 59.043s | 83.541s |
| `data.gov.bak` | 3.616s | 4.59s | 8.206s |
| `dba.stackexchange.com.bak` | 58.61s | 149.227s | 207.837s |
| `EmployeeCaseStudySampleDB2012.bak` | 4.032s | 2.924s | 6.956s |
| `GeneralHospital.bak` | 60.759s | 66.512s | 127.271s |
| `IndexInternals2008.bak` | 2.332s | 2.045s | 4.377s |
| `Northwinds.bak` | 0.166s | 0.282s | 0.448s |
| `NYCTaxi_Sample.bak` | 53.865s | 140.995s | 194.86s |
| `Pubs.bak` | 0.165s | 0.322s | 0.487s |
| `SalesDB2014.bak` | 27.776s | 79.004s | 106.78s |
| `SalesDBOriginal.bak` | 31.113s | 75.947s | 107.06s |
| `StackOverflowMini.bak` | 97.68s | 113.609s | 211.289s |
| `tpcxbb_1gb.bak` | 203.164s | 339.492s | 542.656s |
| `TutorialDB.bak` | 0.061s | 0.138s | 0.199s |
| `WideWorldImporters-Full.bak` | 59.188s | 139.244s | 198.432s |
| `WideWorldImporters-Full_old.bak` | 56.221s | 131.835s | 188.056s |
| `WideWorldImporters-Standard.bak` | 55.698s | 142.437s | 198.135s |
| `WideWorldImporters-Standard_old.bak` | 56.021s | 146.61s | 202.631s |
| `WideWorldImportersDW-Full.bak` | 19.226s | 34.246s | 53.472s |
| `WideWorldImportersDW-Standard.bak` | 16.907s | 33.258s | 50.165s |
...
|--------|-------:| ------: | -------:| ------:|
| `AdventureWorks2008R2.bak` | 1.368s | 0.187s | 6.716s | 4.523s |
| `AdventureWorks2012.bak` | 0.459s | 0.189s | 6.612s | 4.443s |
| `AdventureWorks2014.bak` | 0.438s | 0.188s | 6.38s | 4.615s |
| `AdventureWorks2016.bak` | 0.751s | 0.203s | 6.443s | 4.511s |
| `AdventureWorks2016_EXT.bak` | 1.127s | 0.494s | 12.41s | 9.429s |
| `AdventureWorks2017.bak` | 0.434s | 0.499s | 6.438s | 4.485s |
| `AdventureWorks2019.bak` | 0.434s | 0.164s | 6.436s | 4.562s |
| `AdventureWorks2022.bak` | 0.865s | 0.254s | 6.798s | 4.461s |
| `AdventureWorks2025.bak` | 0.495s | 0.171s | 6.524s | 4.707s |
| `AdventureWorksDW2008R2.bak` | 0.225s | 0.076s | 3.213s | 2.551s |
| `AdventureWorksDW2012.bak` | 0.337s | 0.098s | 8.19s | 6.364s |
| `AdventureWorksDW2014.bak` | 0.42s | 0.278s | 8.881s | 5.987s |
| `AdventureWorksDW2016.bak` | 0.358s | 0.125s | 8.228s | 6.235s |
| `AdventureWorksDW2016_EXT.bak` | 17.752s | 1.612s | 573.549s | 473.995s |
| `AdventureWorksDW2017.bak` | 0.412s | 0.099s | 8.802s | 5.956s |
| `AdventureWorksDW2019.bak` | 0.577s | 0.11s | 8.546s | 6.038s |
| `AdventureWorksDW2022.bak` | 0.362s | 0.245s | 8.344s | 5.889s |
| `AdventureWorksDW2025.bak` | 0.35s | 0.11s | 8.188s | 5.884s |
| `AdventureWorksLT2012.bak` | 0.062s | 0.022s | 0.047s | 0.068s |
| `AdventureWorksLT2014.bak` | 0.065s | 0.021s | 0.046s | 0.067s |
| `AdventureWorksLT2016.bak` | 0.044s | 0.021s | 0.041s | 0.07s |
| `AdventureWorksLT2017.bak` | 0.05s | 0.019s | 0.04s | 0.071s |
| `AdventureWorksLT2019.bak` | 0.07s | 0.026s | 0.047s | 0.067s |
| `AdventureWorksLT2022.bak` | 0.05s | 0.021s | 0.043s | 0.072s |
| `AdventureWorksLT2025.bak` | 0.04s | 0.025s | 0.04s | 0.069s |
| `BaseballData.bak` | 0.276s | 0.074s | 6.4s | 4.016s |
| `Chinook-id-pk.bak` | 0.057s | 0.02s | 0.061s | 0.038s |
| `Chinook.bak` | 0.04s | 0.023s | 0.059s | 0.082s |
| `ContosoRetailDW.bak` | 16.758s | 2.456s | 480.759s | 373.488s |
| `CreditBackup100.bak` | 0.6s | 0.096s | 11.925s | 7.694s |
| `data.gov.bak` | 0.079s | 0.015s | 2.149s | 1.602s |
| `dba.stackexchange.com.bak` | 4.053s | 0.823s | 23.863s | 94.349s |
| `EmployeeCaseStudySampleDB2012.bak` | 0.117s | 0.029s | 1.697s | 1.389s |
| `GeneralHospital.bak` | 3.365s | 0.224s | 32.317s | 23.817s |
| `IndexInternals2008.bak` | 0.069s | 0.024s | 0.957s | 0.769s |
| `Northwinds.bak` | 0.033s | 0.017s | 0.028s | 0.036s |
| `NYCTaxi_Sample.bak` | 1.316s | 0.114s | 37.755s | 26.699s |
| `Pubs.bak` | 0.043s | 0.018s | 0.009s | 0.01s |
| `SalesDB2014.bak` | 1.67s | 0.194s | 24.645s | 18.711s |
| `SalesDBOriginal.bak` | 4.334s | 0.158s | 25.509s | 16.676s |
| `StackOverflowMini.bak` | 6.765s | 0.707s | 60.402s | 3.193s |
| `tpcxbb_1gb.bak` | 3.724s | 0.423s | 150.537s | 115.407s |
| `TutorialDB.bak` | 0.005s | 0.003s | 0.004s | 0.003s |
| `WideWorldImporters-Full.bak` | 1.481s | 0.461s | 37.889s | 25.932s |
| `WideWorldImporters-Full_old.bak` | 1.192s | 0.305s | 36.052s | 24.61s |
| `WideWorldImporters-Standard.bak` | 1.387s | 0.269s | 37.831s | 27.172s |
| `WideWorldImporters-Standard_old.bak` | 1.458s | 0.288s | 37.542s | 25.733s |
| `WideWorldImportersDW-Full.bak` | 0.364s | 0.085s | 12.101s | 8.473s |
| `WideWorldImportersDW-Standard.bak` | 0.344s | 0.081s | 11.893s | 8.417s |
