...
**Generated** by `python -m tools.correctness_coverage tests/fixtures_realworld/NYCTaxi_Sample.bak`.
...
| `dbo.nyctaxi_sample` | 1,703,957 | ✓ | **23/23** | **46/46** | ✓ | cells digest ✓ |
