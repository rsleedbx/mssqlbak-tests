...
| `archive_columnstore_partition_full.bak` | 1.012s | 0.672s | 1.684s |
| `archive_columnstore_types_full.bak` | 0.33s | 0.679s | 1.009s |
| `archive_columnstore_types_random_full.bak` | 0.336s | 0.693s | 1.029s |
| `archive_single_chunk_full.bak` | 0.044s | 0.032s | 0.076s |
| `archive_single_chunk_random_full.bak` | 0.045s | 0.041s | 0.086s |
| `archivenull_full.bak` | 0.13s | 0.212s | 0.342s |
| `backup_blocksize_full.bak` | 0.047s | 0.03s | 0.077s |
| `boundarycoverage_datetime_full.bak` | 0.086s | 0.162s | 0.248s |
| `boundarycoverage_full.bak` | 0.054s | 0.072s | 0.126s |
| `cci_binary_varbinary_compare_full.bak` | 0.048s | 0.039s | 0.087s |
| `cci_bitpack_probe_bigint_full.bak` | 1.299s | 3.84s | 5.139s |
| `cci_bitpack_probe_full.bak` | 0.111s | 0.663s | 0.774s |
| `cci_bitpack_probe_highbase_full.bak` | 0.098s | 0.429s | 0.527s |
| `cci_btree_nci_full.bak` | 0.053s | 0.038s | 0.091s |
| `cci_computed_full.bak` | 0.067s | 0.032s | 0.099s |
| `cci_enc5_largepool_full.bak` | 0.371s | 0.453s | 0.824s |
| `cci_enc5_largepool_matrix_full.bak` | 7.185s | 1.317s | 8.502s |
| `cci_extended_full.bak` | 0.053s | 0.043s | 0.096s |
| `cci_lob_full.bak` | 0.077s | 0.039s | 0.116s |
| `cci_reorganize_full.bak` | 0.066s | 0.037s | 0.103s |
| `cci_string_dict_regression_full.bak` | 0.329s | 0.135s | 0.464s |
| `cci_string_minmax_full.bak` | 0.056s | 0.039s | 0.095s |
| `cci_switch_full.bak` | 0.069s | 0.033s | 0.102s |
| `cci_types_large_full.bak` | 0.055s | 0.043s | 0.098s |
| `cci_varbinary_micro_full.bak` | 0.069s | 0.038s | 0.107s |
| `cci_varbinary_probe_full.bak` | 0.066s | 0.048s | 0.114s |
| `columnstore_minimal.bak` | 0.126s | 0.94s | 1.066s |
| `compressed_nvarchar_full.bak` | 0.041s | 0.03s | 0.071s |
| `compressioncoverage_full.bak` | 0.108s | 0.179s | 0.287s |
| `computedcoverage_full.bak` | 0.042s | 0.033s | 0.075s |
| `constraintcoverage_full.bak` | 0.049s | 0.036s | 0.085s |
| `covering_index_full.bak` | 0.059s | 0.036s | 0.095s |
| `cs_lob_preamble.bak` | 0.098s | 0.06s | 0.158s |
| `delta_rowgroup_full.bak` | 0.047s | 0.034s | 0.081s |
| `dirtycoverage_aborted_xact.bak` | 0.056s | 0.031s | 0.087s |
| `dirtycoverage_addcol.bak` | 0.055s | 0.028s | 0.083s |
| `dirtycoverage_addnotnull.bak` | 0.063s | 0.029s | 0.092s |
| `dirtycoverage_alldirty.bak` | 0.063s | 0.031s | 0.094s |
| `dirtycoverage_altercol.bak` | 0.04s | 0.028s | 0.068s |
| `dirtycoverage_altercol_rewrite.bak` | 0.06s | 0.028s | 0.088s |
| `dirtycoverage_alterdb.bak` | 0.069s | 0.03s | 0.099s |
| `dirtycoverage_cci_delete.bak` | 0.098s | 0.098s | 0.196s |
| `dirtycoverage_cci_update.bak` | 0.097s | 0.099s | 0.196s |
| `dirtycoverage_committed_delete.bak` | 0.044s | 0.033s | 0.077s |
| `dirtycoverage_committed_delete_v2.bak` | 0.045s | 0.031s | 0.076s |
| `dirtycoverage_committed_delete_v3.bak` | 0.056s | 0.058s | 0.114s |
| `dirtycoverage_committed_delete_v4.bak` | 0.158s | 0.072s | 0.23s |
| `dirtycoverage_committed_update.bak` | 0.042s | 0.031s | 0.073s |
| `dirtycoverage_committed_update_v2.bak` | 0.044s | 0.032s | 0.076s |
| `dirtycoverage_committed_update_v3.bak` | 0.057s | 0.068s | 0.125s |
| `dirtycoverage_committed_update_v4.bak` | 0.175s | 0.08s | 0.255s |
| `dirtycoverage_concurrent.bak` | 0.065s | 0.035s | 0.1s |
| `dirtycoverage_createidx.bak` | 0.062s | 0.031s | 0.093s |
| `dirtycoverage_createtable.bak` | 0.063s | 0.029s | 0.092s |
| `dirtycoverage_delete.bak` | 0.06s | 0.029s | 0.089s |
| `dirtycoverage_dropcol.bak` | 0.062s | 0.032s | 0.094s |
| `dirtycoverage_dropidx.bak` | 0.06s | 0.031s | 0.091s |
| `dirtycoverage_droptable.bak` | 0.06s | 0.03s | 0.09s |
| `dirtycoverage_heap_forward.bak` | 0.057s | 0.029s | 0.086s |
| `dirtycoverage_large_dirty.bak` | 0.342s | 0.034s | 0.376s |
| `dirtycoverage_lob_update.bak` | 0.082s | 0.029s | 0.111s |
| `dirtycoverage_maxrow.bak` | 0.042s | 0.028s | 0.07s |
| `dirtycoverage_nchar_delete.bak` | 0.066s | 0.033s | 0.099s |
| `dirtycoverage_nested.bak` | 0.064s | 0.033s | 0.097s |
| `dirtycoverage_null_update.bak` | 0.069s | 0.034s | 0.103s |
| `dirtycoverage_rebuildidx.bak` | 0.057s | 0.028s | 0.085s |
| `dirtycoverage_rich_insert.bak` | 0.067s | 0.032s | 0.099s |
| `dirtycoverage_rich_update.bak` | 0.062s | 0.032s | 0.094s |
| `dirtycoverage_savepoint.bak` | 0.071s | 0.033s | 0.104s |
| `dirtycoverage_snapshot_update.bak` | 0.059s | 0.031s | 0.09s |
| `dirtycoverage_switch.bak` | 0.072s | 0.035s | 0.107s |
| `dirtycoverage_temporal_update.bak` | 0.07s | 0.031s | 0.101s |
| `dirtycoverage_truncate.bak` | 0.058s | 0.035s | 0.093s |
| `dirtycoverage_two_tx.bak` | 0.065s | 0.03s | 0.095s |
| `dirtycoverage_uncommitted.bak` | 0.058s | 0.033s | 0.091s |
| `dirtycoverage_update.bak` | 0.065s | 0.035s | 0.1s |
| `filtered_ncci_full.bak` | 0.066s | 0.036s | 0.102s |
| `float_extreme_full.bak` | 0.039s | 0.028s | 0.067s |
| `forwarded_records_full.bak` | 0.249s | 0.07s | 0.319s |
| `ghost_records_full.bak` | 0.044s | 0.035s | 0.079s |
| `heapcoverage_large.bak` | 0.043s | 0.04s | 0.083s |
| `heapcoverage_large_50000.bak` | 0.199s | 0.316s | 0.515s |
| `hierarchyid_extract_full.bak` | 0.041s | 0.034s | 0.075s |
| `high_slot_density_full.bak` | 0.074s | 0.191s | 0.265s |
| `identity_coverage_full.bak` | 0.06s | 0.036s | 0.096s |
| `incrementalcoverage_diff_01.bak` | 0.042s | 0.01s | 0.052s |
| `incrementalcoverage_diff_02.bak` | 0.042s | 0.011s | 0.053s |
| `incrementalcoverage_diff_03.bak` | 0.043s | 0.01s | 0.053s |
| `incrementalcoverage_diff_04.bak` | 0.042s | 0.01s | 0.052s |
| `incrementalcoverage_diff_05.bak` | 0.04s | 0.011s | 0.051s |
| `incrementalcoverage_diff_06.bak` | 0.043s | 0.011s | 0.054s |
| `incrementalcoverage_full.bak` | 0.042s | 0.034s | 0.076s |
| `layoutcoverage_full.bak` | 0.208s | 0.348s | 0.556s |
| `max_row_width_full.bak` | 0.041s | 0.034s | 0.075s |
| `mixed_collation_full.bak` | 0.045s | 0.028s | 0.073s |
| `multi_rowgroup_full.bak` | 0.048s | 0.04s | 0.088s |
| `ncci_heap_full.bak` | 0.061s | 0.045s | 0.106s |
| `ncci_types_full.bak` | 0.116s | 0.194s | 0.31s |
| `ndfcoverage_full.bak` | 0.043s | 0.03s | 0.073s |
| `nvarchar_max_u21_full.bak` | 0.044s | 0.03s | 0.074s |
| `pagecomp_anchor_full.bak` | 0.137s | 0.113s | 0.25s |
| `pagecomp_long_prefix_full.bak` | 0.04s | 0.029s | 0.069s |
| `pfor_columnstore_full.bak` | 0.126s | 0.821s | 0.947s |
| `pfor_columnstore_random_full.bak` | 0.127s | 0.822s | 0.949s |
| `realworld_numeric_digest_full.bak` | 0.074s | 0.087s | 0.161s |
| `rowboundary_full.bak` | 0.044s | 0.038s | 0.082s |
| `rowstore_hash_pii_full.bak` | 0.04s | 0.047s | 0.087s |
| `rowstore_lob_image_full.bak` | 0.043s | 0.037s | 0.08s |
| `rowstore_lob_markup_full.bak` | 0.042s | 0.034s | 0.076s |
| `rowversion_extract_full.bak` | 0.042s | 0.036s | 0.078s |
| `sparse_full.bak` | 0.093s | 0.084s | 0.177s |
| `spatial_edge_full.bak` | 0.042s | 0.038s | 0.08s |
| `spatial_index_full.bak` | 0.067s | 0.031s | 0.098s |
| `sql_variant_extract_full.bak` | 0.04s | 0.027s | 0.067s |
| `striped_full_1.bak` | 0.046s | 0.017s | 0.063s |
| `striped_single.bak` | 0.075s | 0.046s | 0.121s |
| `surrogate_pairs_full.bak` | 0.041s | 0.03s | 0.071s |
| `tabletype_cci_large_full.bak` | 0.064s | 0.044s | 0.108s |
| `tabletypecoverage_diff.bak` | 0.111s | 0.07s | 0.181s |
| `tabletypecoverage_full.bak` | 0.2s | 0.094s | 0.294s |
| `temporal_hidden_full.bak` | 0.049s | 0.039s | 0.088s |
| `torn_page_full.bak` | 0.05s | 0.034s | 0.084s |
| `typecoverage_full.bak` | 0.118s | 0.076s | 0.194s |
| `typed_xml_full.bak` | 0.041s | 0.029s | 0.07s |
| `unicode_codepage_coverage.bak` | 0.071s | 0.046s | 0.117s |
| `xml_index_full.bak` | 0.058s | 0.036s | 0.094s |
| `xmlcoverage_full.bak` | 0.04s | 0.036s | 0.076s |
| `xmlheap_full.bak` | 0.107s | 0.062s | 0.169s |
| `xtp_checkpoint_straddle_full.bak` | 1.854s | 0.382s | 2.236s |
| `xtp_probe_full.bak` | 0.105s | 0.049s | 0.154s |
| `xtp_rich_full.bak` | 0.082s | 0.039s | 0.121s |
| `xtp_simple_full.bak` | 0.077s | 0.034s | 0.111s |
