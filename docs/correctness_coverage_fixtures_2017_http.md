...
|--------|---------|--------|-----------|
| `alias_types_full.bak` | 0.042s | 0.046s | 0.088s |
| `archive_columnstore_partition_full.bak` | 1.024s | 0.657s | 1.681s |
| `archive_columnstore_types_full.bak` | 0.339s | 0.723s | 1.062s |
| `archive_columnstore_types_random_full.bak` | 0.328s | 0.754s | 1.082s |
| `archive_single_chunk_full.bak` | 0.051s | 0.041s | 0.092s |
| `archive_single_chunk_random_full.bak` | 0.049s | 0.043s | 0.092s |
| `archivenull_full.bak` | 0.129s | 0.226s | 0.355s |
| `backup_blocksize_full.bak` | 0.047s | 0.039s | 0.086s |
| `boundarycoverage_datetime_full.bak` | 0.076s | 0.177s | 0.253s |
| `boundarycoverage_full.bak` | 0.054s | 0.071s | 0.125s |
| `cci_binary_varbinary_compare_full.bak` | 0.048s | 0.045s | 0.093s |
| `cci_bitpack_probe_bigint_full.bak` | 1.294s | 3.879s | 5.173s |
| `cci_bitpack_probe_full.bak` | 0.114s | 0.72s | 0.834s |
| `cci_bitpack_probe_highbase_full.bak` | 0.11s | 0.439s | 0.549s |
| `cci_btree_nci_full.bak` | 0.052s | 0.043s | 0.095s |
| `cci_computed_full.bak` | 0.076s | 0.043s | 0.119s |
| `cci_enc5_largepool_full.bak` | 0.372s | 0.5s | 0.872s |
| `cci_enc5_largepool_matrix_full.bak` | 7.302s | 1.334s | 8.636s |
| `cci_extended_full.bak` | 0.054s | 0.05s | 0.104s |
| `cci_lob_full.bak` | 0.075s | 0.043s | 0.118s |
| `cci_reorganize_full.bak` | 0.063s | 0.042s | 0.105s |
| `cci_string_dict_regression_full.bak` | 0.331s | 0.149s | 0.48s |
| `cci_string_minmax_full.bak` | 0.05s | 0.04s | 0.09s |
| `cci_switch_full.bak` | 0.064s | 0.04s | 0.104s |
| `cci_types_large_full.bak` | 0.064s | 0.046s | 0.11s |
| `cci_varbinary_micro_full.bak` | 0.066s | 0.04s | 0.106s |
| `cci_varbinary_probe_full.bak` | 0.072s | 0.051s | 0.123s |
| `columnstore_minimal.bak` | 0.125s | 0.918s | 1.043s |
| `compressed_nvarchar_full.bak` | 0.041s | 0.036s | 0.077s |
| `compressioncoverage_full.bak` | 0.107s | 0.209s | 0.316s |
| `computedcoverage_full.bak` | 0.045s | 0.039s | 0.084s |
| `constraintcoverage_full.bak` | 0.051s | 0.046s | 0.097s |
| `covering_index_full.bak` | 0.058s | 0.041s | 0.099s |
| `cs_lob_preamble.bak` | 0.097s | 0.063s | 0.16s |
| `delta_rowgroup_full.bak` | 0.046s | 0.041s | 0.087s |
| `dirtycoverage_aborted_xact.bak` | 0.06s | 0.036s | 0.096s |
| `dirtycoverage_addcol.bak` | 0.056s | 0.036s | 0.092s |
| `dirtycoverage_addnotnull.bak` | 0.057s | 0.035s | 0.092s |
| `dirtycoverage_alldirty.bak` | 0.064s | 0.035s | 0.099s |
| `dirtycoverage_altercol.bak` | 0.043s | 0.038s | 0.081s |
| `dirtycoverage_altercol_rewrite.bak` | 0.058s | 0.035s | 0.093s |
| `dirtycoverage_alterdb.bak` | 0.057s | 0.034s | 0.091s |
| `dirtycoverage_cci_delete.bak` | 0.095s | 0.097s | 0.192s |
| `dirtycoverage_cci_update.bak` | 0.098s | 0.1s | 0.198s |
| `dirtycoverage_committed_delete.bak` | 0.044s | 0.036s | 0.08s |
| `dirtycoverage_committed_delete_v2.bak` | 0.048s | 0.038s | 0.086s |
| `dirtycoverage_committed_delete_v3.bak` | 0.049s | 0.062s | 0.111s |
| `dirtycoverage_committed_delete_v4.bak` | 0.159s | 0.072s | 0.231s |
| `dirtycoverage_committed_update.bak` | 0.042s | 0.037s | 0.079s |
| `dirtycoverage_committed_update_v2.bak` | 0.044s | 0.037s | 0.081s |
| `dirtycoverage_committed_update_v3.bak` | 0.063s | 0.071s | 0.134s |
| `dirtycoverage_committed_update_v4.bak` | 0.181s | 0.077s | 0.258s |
| `dirtycoverage_concurrent.bak` | 0.064s | 0.06s | 0.124s |
| `dirtycoverage_createidx.bak` | 0.056s | 0.039s | 0.095s |
| `dirtycoverage_createtable.bak` | 0.058s | 0.037s | 0.095s |
| `dirtycoverage_delete.bak` | 0.062s | 0.04s | 0.102s |
| `dirtycoverage_dropcol.bak` | 0.058s | 0.041s | 0.099s |
| `dirtycoverage_dropidx.bak` | 0.058s | 0.035s | 0.093s |
| `dirtycoverage_droptable.bak` | 0.062s | 0.041s | 0.103s |
| `dirtycoverage_heap_forward.bak` | 0.06s | 0.036s | 0.096s |
| `dirtycoverage_large_dirty.bak` | 0.342s | 0.036s | 0.378s |
| `dirtycoverage_lob_update.bak` | 0.084s | 0.067s | 0.151s |
| `dirtycoverage_maxrow.bak` | 0.04s | 0.038s | 0.078s |
| `dirtycoverage_nchar_delete.bak` | 0.06s | 0.037s | 0.097s |
| `dirtycoverage_nested.bak` | 0.06s | 0.035s | 0.095s |
| `dirtycoverage_null_update.bak` | 0.058s | 0.036s | 0.094s |
| `dirtycoverage_rebuildidx.bak` | 0.057s | 0.035s | 0.092s |
| `dirtycoverage_rich_insert.bak` | 0.061s | 0.037s | 0.098s |
| `dirtycoverage_rich_update.bak` | 0.062s | 0.036s | 0.098s |
| `dirtycoverage_savepoint.bak` | 0.061s | 0.037s | 0.098s |
| `dirtycoverage_snapshot_update.bak` | 0.057s | 0.035s | 0.092s |
| `dirtycoverage_switch.bak` | 0.067s | 0.039s | 0.106s |
| `dirtycoverage_temporal_update.bak` | 0.073s | 0.035s | 0.108s |
| `dirtycoverage_truncate.bak` | 0.057s | 0.037s | 0.094s |
| `dirtycoverage_two_tx.bak` | 0.061s | 0.035s | 0.096s |
| `dirtycoverage_uncommitted.bak` | 0.063s | 0.033s | 0.096s |
| `dirtycoverage_update.bak` | 0.06s | 0.036s | 0.096s |
| `filtered_ncci_full.bak` | 0.063s | 0.042s | 0.105s |
| `float_extreme_full.bak` | 0.052s | 0.039s | 0.091s |
| `forwarded_records_full.bak` | 0.249s | 0.083s | 0.332s |
| `ghost_records_full.bak` | 0.042s | 0.038s | 0.08s |
| `heapcoverage_large.bak` | 0.045s | 0.044s | 0.089s |
| `heapcoverage_large_50000.bak` | 0.203s | 0.324s | 0.527s |
| `hierarchyid_extract_full.bak` | 0.044s | 0.039s | 0.083s |
| `high_slot_density_full.bak` | 0.069s | 0.205s | 0.274s |
| `identity_coverage_full.bak` | 0.063s | 0.04s | 0.103s |
| `incrementalcoverage_diff_01.bak` | 0.044s | 0.017s | 0.061s |
| `incrementalcoverage_diff_02.bak` | 0.043s | 0.016s | 0.059s |
| `incrementalcoverage_diff_03.bak` | 0.045s | 0.019s | 0.064s |
| `incrementalcoverage_diff_04.bak` | 0.044s | 0.019s | 0.063s |
| `incrementalcoverage_diff_05.bak` | 0.042s | 0.015s | 0.057s |
| `incrementalcoverage_diff_06.bak` | 0.044s | 0.015s | 0.059s |
| `incrementalcoverage_full.bak` | 0.043s | 0.038s | 0.081s |
| `layoutcoverage_full.bak` | 0.211s | 0.384s | 0.595s |
| `max_row_width_full.bak` | 0.042s | 0.037s | 0.079s |
| `mixed_collation_full.bak` | 0.041s | 0.039s | 0.08s |
| `multi_rowgroup_full.bak` | 0.048s | 0.043s | 0.091s |
| `ncci_heap_full.bak` | 0.059s | 0.038s | 0.097s |
| `ncci_types_full.bak` | 0.119s | 0.202s | 0.321s |
| `ndfcoverage_full.bak` | 0.045s | 0.039s | 0.084s |
| `nvarchar_max_u21_full.bak` | 0.042s | 0.035s | 0.077s |
| `pagecomp_anchor_full.bak` | 0.136s | 0.097s | 0.233s |
| `pagecomp_long_prefix_full.bak` | 0.04s | 0.036s | 0.076s |
| `pfor_columnstore_full.bak` | 0.127s | 0.879s | 1.006s |
| `pfor_columnstore_random_full.bak` | 0.121s | 0.879s | 1.0s |
| `realworld_numeric_digest_full.bak` | 0.073s | 0.082s | 0.155s |
| `rowboundary_full.bak` | 0.044s | 0.039s | 0.083s |
| `rowstore_hash_pii_full.bak` | 0.044s | 0.037s | 0.081s |
| `rowstore_lob_image_full.bak` | 0.042s | 0.037s | 0.079s |
| `rowstore_lob_markup_full.bak` | 0.045s | 0.037s | 0.082s |
| `rowversion_extract_full.bak` | 0.043s | 0.036s | 0.079s |
| `sparse_full.bak` | 0.097s | 0.092s | 0.189s |
| `spatial_edge_full.bak` | 0.042s | 0.038s | 0.08s |
| `spatial_index_full.bak` | 0.057s | 0.042s | 0.099s |
| `sql_variant_extract_full.bak` | 0.043s | 0.041s | 0.084s |
| `striped_full_1.bak` | 0.051s | 0.02s | 0.071s |
| `striped_single.bak` | 0.107s | 0.05s | 0.157s |
| `surrogate_pairs_full.bak` | 0.041s | 0.038s | 0.079s |
| `tabletype_cci_large_full.bak` | 0.067s | 0.049s | 0.116s |
| `tabletypecoverage_diff.bak` | 0.116s | 0.074s | 0.19s |
| `tabletypecoverage_full.bak` | 0.199s | 0.127s | 0.326s |
| `temporal_hidden_full.bak` | 0.046s | 0.04s | 0.086s |
| `torn_page_full.bak` | 0.042s | 0.036s | 0.078s |
| `typecoverage_full.bak` | 0.119s | 0.074s | 0.193s |
| `typed_xml_full.bak` | 0.043s | 0.038s | 0.081s |
| `unicode_codepage_coverage.bak` | 0.105s | 0.049s | 0.154s |
| `xml_index_full.bak` | 0.06s | 0.039s | 0.099s |
| `xmlcoverage_full.bak` | 0.041s | 0.037s | 0.078s |
| `xmlheap_full.bak` | 0.102s | 0.057s | 0.159s |
| `xtp_checkpoint_straddle_full.bak` | 1.858s | 0.377s | 2.235s |
| `xtp_probe_full.bak` | 0.102s | 0.041s | 0.143s |
| `xtp_rich_full.bak` | 0.083s | 0.041s | 0.124s |
| `xtp_simple_full.bak` | 0.082s | 0.04s | 0.122s |
