...
| Backup | Wall time |
|--------|-------------|
| `alias_types_full.bak` | 0.078s |
| `archive_columnstore_partition_full.bak` | 2.522s |
| `archive_columnstore_types_full.bak` | 1.4s |
| `archive_columnstore_types_random_full.bak` | 1.312s |
| `archive_single_chunk_full.bak` | 0.093s |
| `archive_single_chunk_random_full.bak` | 0.1s |
| `archivenull_full.bak` | 0.441s |
| `backup_blocksize_full.bak` | 0.087s |
| `boundarycoverage_datetime_full.bak` | 0.456s |
| `boundarycoverage_full.bak` | 0.219s |
| `cci_binary_varbinary_compare_full.bak` | 0.087s |
| `cci_bitpack_probe_bigint_full.bak` | 6.321s |
| `cci_bitpack_probe_full.bak` | 0.754s |
| `cci_bitpack_probe_highbase_full.bak` | 0.671s |
| `cci_btree_nci_full.bak` | 0.097s |
| `cci_computed_full.bak` | 0.109s |
| `cci_enc5_largepool_full.bak` | 1.175s |
| `cci_enc5_largepool_matrix_full.bak` | 9.372s |
| `cci_extended_full.bak` | 0.135s |
| `cci_lob_full.bak` | 0.132s |
| `cci_reorganize_full.bak` | 0.117s |
| `cci_string_dict_regression_full.bak` | 0.519s |
| `cci_string_minmax_full.bak` | 0.107s |
| `cci_switch_full.bak` | 0.116s |
| `cci_types_large_full.bak` | 0.123s |
| `cci_varbinary_micro_full.bak` | 0.131s |
| `cci_varbinary_probe_full.bak` | 0.139s |
| `columnstore_minimal.bak` | 1.063s |
| `compressed_nvarchar_full.bak` | 0.108s |
| `compressioncoverage_full.bak` | 0.368s |
| `computedcoverage_full.bak` | 0.107s |
| `constraintcoverage_full.bak` | 0.111s |
| `covering_index_full.bak` | 0.115s |
| `cs_lob_preamble.bak` | 0.168s |
| `delta_rowgroup_full.bak` | 0.098s |
| `dirtycoverage_aborted_xact.bak` | 0.108s |
| `dirtycoverage_addcol.bak` | 0.102s |
| `dirtycoverage_addnotnull.bak` | 0.116s |
| `dirtycoverage_alldirty.bak` | 0.108s |
| `dirtycoverage_altercol.bak` | 0.079s |
| `dirtycoverage_altercol_rewrite.bak` | 0.116s |
| `dirtycoverage_alterdb.bak` | 0.092s |
| `dirtycoverage_cci_delete.bak` | 0.225s |
| `dirtycoverage_cci_update.bak` | 0.235s |
| `dirtycoverage_committed_delete.bak` | 0.113s |
| `dirtycoverage_committed_delete_v2.bak` | 0.092s |
| `dirtycoverage_committed_delete_v3.bak` | 0.142s |
| `dirtycoverage_committed_delete_v4.bak` | 0.342s |
| `dirtycoverage_committed_update.bak` | 0.094s |
| `dirtycoverage_committed_update_v2.bak` | 0.086s |
| `dirtycoverage_committed_update_v3.bak` | 0.174s |
| `dirtycoverage_committed_update_v4.bak` | 0.388s |
| `dirtycoverage_concurrent.bak` | 0.105s |
| `dirtycoverage_createidx.bak` | 0.099s |
| `dirtycoverage_createtable.bak` | 0.097s |
| `dirtycoverage_delete.bak` | 0.1s |
| `dirtycoverage_dropcol.bak` | 0.114s |
| `dirtycoverage_dropidx.bak` | 0.115s |
| `dirtycoverage_droptable.bak` | 0.107s |
| `dirtycoverage_heap_forward.bak` | 0.105s |
| `dirtycoverage_large_dirty.bak` | 0.365s |
| `dirtycoverage_lob_update.bak` | 0.121s |
| `dirtycoverage_maxrow.bak` | 0.083s |
| `dirtycoverage_nchar_delete.bak` | 0.096s |
| `dirtycoverage_nested.bak` | 0.106s |
| `dirtycoverage_null_update.bak` | 0.105s |
| `dirtycoverage_rebuildidx.bak` | 0.105s |
| `dirtycoverage_rich_insert.bak` | 0.1s |
| `dirtycoverage_rich_update.bak` | 0.092s |
| `dirtycoverage_savepoint.bak` | 0.099s |
| `dirtycoverage_snapshot_update.bak` | 0.094s |
| `dirtycoverage_switch.bak` | 0.111s |
| `dirtycoverage_temporal_update.bak` | 0.111s |
| `dirtycoverage_truncate.bak` | 0.102s |
| `dirtycoverage_two_tx.bak` | 0.1s |
| `dirtycoverage_uncommitted.bak` | 0.098s |
| `dirtycoverage_update.bak` | 0.1s |
| `filtered_ncci_full.bak` | 0.114s |
| `float_extreme_full.bak` | 0.076s |
| `forwarded_records_full.bak` | 0.19s |
| `ghost_records_full.bak` | 0.109s |
| `heapcoverage_large.bak` | 0.095s |
| `heapcoverage_large_50000.bak` | 0.98s |
| `hierarchyid_extract_full.bak` | 0.105s |
| `high_slot_density_full.bak` | 0.563s |
| `incrementalcoverage_diff_01.bak` | 0.094s |
| `incrementalcoverage_diff_02.bak` | 0.09s |
| `incrementalcoverage_diff_03.bak` | 0.099s |
| `incrementalcoverage_diff_04.bak` | 0.087s |
| `incrementalcoverage_diff_05.bak` | 0.109s |
| `incrementalcoverage_diff_06.bak` | 0.1s |
| `incrementalcoverage_full.bak` | 0.08s |
| `layoutcoverage_full.bak` | 0.415s |
| `max_row_width_full.bak` | 0.091s |
| `mixed_collation_full.bak` | 0.081s |
| `multi_rowgroup_full.bak` | 0.111s |
| `ncci_heap_full.bak` | 0.107s |
| `ncci_types_full.bak` | 0.557s |
| `ndfcoverage_full.bak` | 0.08s |
| `nvarchar_max_u21_full.bak` | 0.078s |
| `pagecomp_anchor_full.bak` | 0.362s |
| `pagecomp_long_prefix_full.bak` | 0.084s |
| `pfor_columnstore_full.bak` | 2.263s |
| `pfor_columnstore_random_full.bak` | 2.44s |
| `realworld_numeric_digest_full.bak` | 0.228s |
| `rowboundary_full.bak` | 0.088s |
| `rowstore_hash_pii_full.bak` | 0.088s |
| `rowstore_lob_image_full.bak` | 0.078s |
| `rowstore_lob_markup_full.bak` | 0.081s |
| `rowversion_extract_full.bak` | 0.087s |
| `sparse_full.bak` | 0.296s |
| `spatial_edge_full.bak` | 0.081s |
| `spatial_index_full.bak` | 0.142s |
| `sql_variant_extract_full.bak` | 0.081s |
| `striped_full_1.bak` | 0.095s |
| `striped_single.bak` | 0.132s |
| `surrogate_pairs_full.bak` | 0.084s |
| `tabletype_cci_large_full.bak` | 0.11s |
| `tabletypecoverage_diff.bak` | 0.203s |
| `tabletypecoverage_full.bak` | 0.227s |
| `temporal_hidden_full.bak` | 0.091s |
| `torn_page_full.bak` | 0.095s |
| `typecoverage_full.bak` | 0.178s |
| `typed_xml_full.bak` | 0.091s |
| `unicode_codepage_coverage.bak` | 0.123s |
| `xml_index_full.bak` | 0.101s |
| `xmlcoverage_full.bak` | 0.106s |
| `xmlheap_full.bak` | 0.144s |
| `xtp_checkpoint_straddle_full.bak` | 0.413s |
| `xtp_probe_full.bak` | 0.123s |
| `xtp_rich_full.bak` | 0.126s |
