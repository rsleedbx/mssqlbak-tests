...
|--------|---------|--------|-----------|
| `alias_types_full.bak` | 0.04s | 0.029s | 0.069s |
| `archive_columnstore_partition_full.bak` | 0.995s | 0.614s | 1.609s |
| `archive_columnstore_types_full.bak` | 0.327s | 0.698s | 1.025s |
| `archive_columnstore_types_random_full.bak` | 0.338s | 0.692s | 1.03s |
| `archive_single_chunk_full.bak` | 0.046s | 0.032s | 0.078s |
| `archive_single_chunk_random_full.bak` | 0.047s | 0.033s | 0.08s |
| `archivenull_full.bak` | 0.13s | 0.212s | 0.342s |
| `backup_blocksize_full.bak` | 0.045s | 0.032s | 0.077s |
| `boundarycoverage_datetime_full.bak` | 0.076s | 0.151s | 0.227s |
| `boundarycoverage_full.bak` | 0.055s | 0.063s | 0.118s |
| `cci_binary_varbinary_compare_full.bak` | 0.044s | 0.039s | 0.083s |
| `cci_bitpack_probe_bigint_full.bak` | 1.275s | 3.869s | 5.144s |
| `cci_bitpack_probe_full.bak` | 0.112s | 0.651s | 0.763s |
| `cci_bitpack_probe_highbase_full.bak` | 0.105s | 0.43s | 0.535s |
| `cci_btree_nci_full.bak` | 0.057s | 0.039s | 0.096s |
| `cci_computed_full.bak` | 0.063s | 0.032s | 0.095s |
| `cci_enc5_largepool_full.bak` | 0.375s | 0.434s | 0.809s |
| `cci_enc5_largepool_matrix_full.bak` | 7.33s | 1.253s | 8.583s |
| `cci_extended_full.bak` | 0.052s | 0.038s | 0.09s |
| `cci_lob_full.bak` | 0.081s | 0.039s | 0.12s |
| `cci_reorganize_full.bak` | 0.063s | 0.047s | 0.11s |
| `cci_string_dict_regression_full.bak` | 0.326s | 0.139s | 0.465s |
| `cci_string_minmax_full.bak` | 0.054s | 0.043s | 0.097s |
| `cci_switch_full.bak` | 0.061s | 0.034s | 0.095s |
| `cci_types_large_full.bak` | 0.056s | 0.037s | 0.093s |
| `cci_varbinary_micro_full.bak` | 0.066s | 0.031s | 0.097s |
| `cci_varbinary_probe_full.bak` | 0.07s | 0.047s | 0.117s |
| `columnstore_minimal.bak` | 0.134s | 0.899s | 1.033s |
| `compressed_nvarchar_full.bak` | 0.044s | 0.029s | 0.073s |
| `compressioncoverage_full.bak` | 0.115s | 0.193s | 0.308s |
| `computedcoverage_full.bak` | 0.041s | 0.032s | 0.073s |
| `constraintcoverage_full.bak` | 0.048s | 0.036s | 0.084s |
| `covering_index_full.bak` | 0.059s | 0.038s | 0.097s |
| `cs_lob_preamble.bak` | 0.099s | 0.051s | 0.15s |
| `delta_rowgroup_full.bak` | 0.049s | 0.038s | 0.087s |
| `dirtycoverage_aborted_xact.bak` | 0.059s | 0.03s | 0.089s |
| `dirtycoverage_addcol.bak` | 0.056s | 0.029s | 0.085s |
| `dirtycoverage_addnotnull.bak` | 0.066s | 0.034s | 0.1s |
| `dirtycoverage_alldirty.bak` | 0.061s | 0.031s | 0.092s |
| `dirtycoverage_altercol.bak` | 0.042s | 0.036s | 0.078s |
| `dirtycoverage_altercol_rewrite.bak` | 0.067s | 0.029s | 0.096s |
| `dirtycoverage_alterdb.bak` | 0.058s | 0.034s | 0.092s |
| `dirtycoverage_cci_delete.bak` | 0.103s | 0.095s | 0.198s |
| `dirtycoverage_cci_update.bak` | 0.093s | 0.089s | 0.182s |
| `dirtycoverage_committed_delete.bak` | 0.041s | 0.04s | 0.081s |
| `dirtycoverage_committed_delete_v2.bak` | 0.044s | 0.031s | 0.075s |
| `dirtycoverage_committed_delete_v3.bak` | 0.051s | 0.05s | 0.101s |
| `dirtycoverage_committed_delete_v4.bak` | 0.16s | 0.071s | 0.231s |
| `dirtycoverage_committed_update.bak` | 0.045s | 0.039s | 0.084s |
| `dirtycoverage_committed_update_v2.bak` | 0.043s | 0.032s | 0.075s |
| `dirtycoverage_committed_update_v3.bak` | 0.053s | 0.062s | 0.115s |
| `dirtycoverage_committed_update_v4.bak` | 0.176s | 0.075s | 0.251s |
| `dirtycoverage_concurrent.bak` | 0.071s | 0.036s | 0.107s |
| `dirtycoverage_createidx.bak` | 0.067s | 0.034s | 0.101s |
| `dirtycoverage_createtable.bak` | 0.064s | 0.03s | 0.094s |
| `dirtycoverage_delete.bak` | 0.061s | 0.029s | 0.09s |
| `dirtycoverage_dropcol.bak` | 0.067s | 0.036s | 0.103s |
| `dirtycoverage_dropidx.bak` | 0.057s | 0.03s | 0.087s |
| `dirtycoverage_droptable.bak` | 0.06s | 0.038s | 0.098s |
| `dirtycoverage_heap_forward.bak` | 0.059s | 0.029s | 0.088s |
| `dirtycoverage_large_dirty.bak` | 0.336s | 0.032s | 0.368s |
| `dirtycoverage_lob_update.bak` | 0.078s | 0.029s | 0.107s |
| `dirtycoverage_maxrow.bak` | 0.042s | 0.033s | 0.075s |
| `dirtycoverage_nchar_delete.bak` | 0.061s | 0.03s | 0.091s |
| `dirtycoverage_nested.bak` | 0.06s | 0.028s | 0.088s |
| `dirtycoverage_null_update.bak` | 0.06s | 0.038s | 0.098s |
| `dirtycoverage_rebuildidx.bak` | 0.067s | 0.034s | 0.101s |
| `dirtycoverage_rich_insert.bak` | 0.061s | 0.033s | 0.094s |
| `dirtycoverage_rich_update.bak` | 0.058s | 0.03s | 0.088s |
| `dirtycoverage_savepoint.bak` | 0.064s | 0.032s | 0.096s |
| `dirtycoverage_snapshot_update.bak` | 0.067s | 0.035s | 0.102s |
| `dirtycoverage_switch.bak` | 0.066s | 0.035s | 0.101s |
| `dirtycoverage_temporal_update.bak` | 0.063s | 0.033s | 0.096s |
| `dirtycoverage_truncate.bak` | 0.058s | 0.034s | 0.092s |
| `dirtycoverage_two_tx.bak` | 0.062s | 0.029s | 0.091s |
| `dirtycoverage_uncommitted.bak` | 0.059s | 0.03s | 0.089s |
| `dirtycoverage_update.bak` | 0.061s | 0.031s | 0.092s |
| `filtered_ncci_full.bak` | 0.064s | 0.038s | 0.102s |
| `float_extreme_full.bak` | 0.041s | 0.033s | 0.074s |
| `forwarded_records_full.bak` | 0.239s | 0.053s | 0.292s |
| `ghost_records_full.bak` | 0.04s | 0.043s | 0.083s |
| `heapcoverage_large.bak` | 0.044s | 0.04s | 0.084s |
| `heapcoverage_large_50000.bak` | 0.199s | 0.315s | 0.514s |
| `hierarchyid_extract_full.bak` | 0.044s | 0.034s | 0.078s |
| `high_slot_density_full.bak` | 0.068s | 0.189s | 0.257s |
| `identity_coverage_full.bak` | 0.062s | 0.046s | 0.108s |
| `incrementalcoverage_diff_01.bak` | 0.045s | 0.019s | 0.064s |
| `incrementalcoverage_diff_02.bak` | 0.039s | 0.013s | 0.052s |
| `incrementalcoverage_diff_03.bak` | 0.044s | 0.019s | 0.063s |
| `incrementalcoverage_diff_04.bak` | 0.04s | 0.014s | 0.054s |
| `incrementalcoverage_diff_05.bak` | 0.052s | 0.013s | 0.065s |
| `incrementalcoverage_diff_06.bak` | 0.042s | 0.015s | 0.057s |
| `incrementalcoverage_full.bak` | 0.041s | 0.029s | 0.07s |
| `layoutcoverage_full.bak` | 0.209s | 0.326s | 0.535s |
| `max_row_width_full.bak` | 0.043s | 0.031s | 0.074s |
| `mixed_collation_full.bak` | 0.046s | 0.031s | 0.077s |
| `multi_rowgroup_full.bak` | 0.045s | 0.035s | 0.08s |
| `ncci_heap_full.bak` | 0.066s | 0.037s | 0.103s |
| `ncci_types_full.bak` | 0.12s | 0.193s | 0.313s |
| `ndfcoverage_full.bak` | 0.047s | 0.038s | 0.085s |
| `nvarchar_max_u21_full.bak` | 0.04s | 0.037s | 0.077s |
| `pagecomp_anchor_full.bak` | 0.135s | 0.094s | 0.229s |
| `pagecomp_long_prefix_full.bak` | 0.044s | 0.032s | 0.076s |
| `pfor_columnstore_full.bak` | 0.122s | 0.954s | 1.076s |
| `pfor_columnstore_random_full.bak` | 0.128s | 0.949s | 1.077s |
| `realworld_numeric_digest_full.bak` | 0.072s | 0.088s | 0.16s |
| `rowboundary_full.bak` | 0.043s | 0.036s | 0.079s |
| `rowstore_hash_pii_full.bak` | 0.042s | 0.037s | 0.079s |
| `rowstore_lob_image_full.bak` | 0.042s | 0.032s | 0.074s |
| `rowstore_lob_markup_full.bak` | 0.041s | 0.029s | 0.07s |
| `rowversion_extract_full.bak` | 0.042s | 0.03s | 0.072s |
| `sparse_full.bak` | 0.101s | 0.087s | 0.188s |
| `spatial_edge_full.bak` | 0.044s | 0.037s | 0.081s |
| `spatial_index_full.bak` | 0.061s | 0.035s | 0.096s |
| `sql_variant_extract_full.bak` | 0.039s | 0.032s | 0.071s |
| `striped_full_1.bak` | 0.045s | 0.026s | 0.071s |
| `striped_single.bak` | 0.075s | 0.045s | 0.12s |
| `surrogate_pairs_full.bak` | 0.042s | 0.03s | 0.072s |
| `tabletype_cci_large_full.bak` | 0.066s | 0.042s | 0.108s |
| `tabletypecoverage_diff.bak` | 0.108s | 0.062s | 0.17s |
| `tabletypecoverage_full.bak` | 0.2s | 0.079s | 0.279s |
| `temporal_hidden_full.bak` | 0.044s | 0.038s | 0.082s |
| `torn_page_full.bak` | 0.04s | 0.034s | 0.074s |
| `typecoverage_full.bak` | 0.121s | 0.062s | 0.183s |
| `typed_xml_full.bak` | 0.043s | 0.034s | 0.077s |
| `unicode_codepage_coverage.bak` | 0.076s | 0.052s | 0.128s |
| `xml_index_full.bak` | 0.058s | 0.033s | 0.091s |
| `xmlcoverage_full.bak` | 0.041s | 0.032s | 0.073s |
| `xmlheap_full.bak` | 0.102s | 0.068s | 0.17s |
| `xtp_checkpoint_straddle_full.bak` | 1.854s | 0.367s | 2.221s |
| `xtp_probe_full.bak` | 0.1s | 0.034s | 0.134s |
| `xtp_rich_full.bak` | 0.083s | 0.034s | 0.117s |
| `xtp_simple_full.bak` | 0.08s | 0.033s | 0.113s |
