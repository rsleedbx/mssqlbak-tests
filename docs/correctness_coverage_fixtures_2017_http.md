...
| Backup | Wall time |
|--------|-------------|
| `alias_types_full.bak` | 0.08s |
| `archive_columnstore_partition_full.bak` | 2.479s |
| `archive_columnstore_types_full.bak` | 1.405s |
| `archive_columnstore_types_random_full.bak` | 1.342s |
| `archive_single_chunk_full.bak` | 0.104s |
| `archive_single_chunk_random_full.bak` | 0.104s |
| `archivenull_full.bak` | 0.464s |
| `backup_blocksize_full.bak` | 0.095s |
| `boundarycoverage_datetime_full.bak` | 0.406s |
| `boundarycoverage_full.bak` | 0.22s |
| `cci_binary_varbinary_compare_full.bak` | 0.099s |
| `cci_bitpack_probe_bigint_full.bak` | 6.027s |
| `cci_bitpack_probe_full.bak` | 0.706s |
| `cci_bitpack_probe_highbase_full.bak` | 0.664s |
| `cci_btree_nci_full.bak` | 0.115s |
| `cci_computed_full.bak` | 0.164s |
| `cci_enc5_largepool_full.bak` | 1.194s |
| `cci_enc5_largepool_matrix_full.bak` | 9.472s |
| `cci_extended_full.bak` | 0.193s |
| `cci_lob_full.bak` | 0.171s |
| `cci_reorganize_full.bak` | 0.147s |
| `cci_string_dict_regression_full.bak` | 0.526s |
| `cci_string_minmax_full.bak` | 0.168s |
| `cci_switch_full.bak` | 0.135s |
| `cci_types_large_full.bak` | 0.174s |
| `cci_varbinary_micro_full.bak` | 0.147s |
| `cci_varbinary_probe_full.bak` | 0.175s |
| `columnstore_minimal.bak` | 1.127s |
| `compressed_nvarchar_full.bak` | 0.135s |
| `compressioncoverage_full.bak` | 0.365s |
| `computedcoverage_full.bak` | 0.173s |
| `constraintcoverage_full.bak` | 0.121s |
| `covering_index_full.bak` | 0.148s |
| `cs_lob_preamble.bak` | 0.198s |
| `delta_rowgroup_full.bak` | 0.089s |
| `dirtycoverage_aborted_xact.bak` | 0.176s |
| `dirtycoverage_addcol.bak` | 0.1s |
| `dirtycoverage_addnotnull.bak` | 0.116s |
| `dirtycoverage_alldirty.bak` | 0.131s |
| `dirtycoverage_altercol.bak` | 0.076s |
| `dirtycoverage_altercol_rewrite.bak` | 0.117s |
| `dirtycoverage_alterdb.bak` | 0.115s |
| `dirtycoverage_cci_delete.bak` | 0.236s |
| `dirtycoverage_cci_update.bak` | 0.227s |
| `dirtycoverage_committed_delete.bak` | 0.103s |
| `dirtycoverage_committed_delete_v2.bak` | 0.095s |
| `dirtycoverage_committed_delete_v3.bak` | 0.217s |
| `dirtycoverage_committed_delete_v4.bak` | 0.353s |
| `dirtycoverage_committed_update.bak` | 0.088s |
| `dirtycoverage_committed_update_v2.bak` | 0.11s |
| `dirtycoverage_committed_update_v3.bak` | 0.245s |
| `dirtycoverage_committed_update_v4.bak` | 0.402s |
| `dirtycoverage_concurrent.bak` | 0.101s |
| `dirtycoverage_createidx.bak` | 0.109s |
| `dirtycoverage_createtable.bak` | 0.104s |
| `dirtycoverage_delete.bak` | 0.113s |
| `dirtycoverage_dropcol.bak` | 0.134s |
| `dirtycoverage_dropidx.bak` | 0.126s |
| `dirtycoverage_droptable.bak` | 0.181s |
| `dirtycoverage_heap_forward.bak` | 0.106s |
| `dirtycoverage_large_dirty.bak` | 0.385s |
| `dirtycoverage_lob_update.bak` | 0.143s |
| `dirtycoverage_maxrow.bak` | 0.103s |
| `dirtycoverage_nchar_delete.bak` | 0.103s |
| `dirtycoverage_nested.bak` | 0.107s |
| `dirtycoverage_null_update.bak` | 0.106s |
| `dirtycoverage_rebuildidx.bak` | 0.106s |
| `dirtycoverage_rich_insert.bak` | 0.098s |
| `dirtycoverage_rich_update.bak` | 0.096s |
| `dirtycoverage_savepoint.bak` | 0.106s |
| `dirtycoverage_snapshot_update.bak` | 0.098s |
| `dirtycoverage_switch.bak` | 0.141s |
| `dirtycoverage_temporal_update.bak` | 0.134s |
...
| `filtered_ncci_full.bak` | 0.148s |
| `float_extreme_full.bak` | 0.079s |
| `forwarded_records_full.bak` | 0.262s |
| `ghost_records_full.bak` | 0.122s |
| `heapcoverage_large.bak` | 0.116s |
| `heapcoverage_large_50000.bak` | 0.983s |
| `hierarchyid_extract_full.bak` | 0.087s |
| `high_slot_density_full.bak` | 0.586s |
| `incrementalcoverage_diff_01.bak` | 0.1s |
| `incrementalcoverage_diff_02.bak` | 0.099s |
| `incrementalcoverage_diff_03.bak` | 0.094s |
| `incrementalcoverage_diff_04.bak` | 0.1s |
| `incrementalcoverage_diff_05.bak` | 0.157s |
| `incrementalcoverage_diff_06.bak` | 0.096s |
| `incrementalcoverage_full.bak` | 0.072s |
| `layoutcoverage_full.bak` | 0.408s |
| `max_row_width_full.bak` | 0.09s |
| `mixed_collation_full.bak` | 0.085s |
| `multi_rowgroup_full.bak` | 0.155s |
| `ncci_heap_full.bak` | 0.16s |
| `ncci_types_full.bak` | 0.498s |
| `ndfcoverage_full.bak` | 0.081s |
| `nvarchar_max_u21_full.bak` | 0.08s |
| `pagecomp_anchor_full.bak` | 0.385s |
| `pagecomp_long_prefix_full.bak` | 0.091s |
| `pfor_columnstore_full.bak` | 2.312s |
| `pfor_columnstore_random_full.bak` | 2.338s |
...
| `rowstore_lob_markup_full.bak` | 0.08s |
| `rowversion_extract_full.bak` | 0.097s |
| `sparse_full.bak` | 0.306s |
| `spatial_edge_full.bak` | 0.088s |
| `spatial_index_full.bak` | 0.141s |
| `sql_variant_extract_full.bak` | 0.086s |
| `striped_full_1.bak` | 0.109s |
| `striped_single.bak` | 0.142s |
| `surrogate_pairs_full.bak` | 0.105s |
| `tabletype_cci_large_full.bak` | 0.213s |
| `tabletypecoverage_diff.bak` | 2.498s |
| `tabletypecoverage_full.bak` | 0.293s |
| `temporal_hidden_full.bak` | 0.09s |
| `torn_page_full.bak` | 0.093s |
| `typecoverage_full.bak` | 0.245s |
| `typed_xml_full.bak` | 0.089s |
| `unicode_codepage_coverage.bak` | 0.198s |
| `xml_index_full.bak` | 0.115s |
| `xmlcoverage_full.bak` | 0.079s |
| `xmlheap_full.bak` | 0.282s |
| `xtp_checkpoint_straddle_full.bak` | 0.422s |
| `xtp_probe_full.bak` | 0.168s |
| `xtp_rich_full.bak` | 0.195s |
| `xtp_simple_full.bak` | 0.161s |
