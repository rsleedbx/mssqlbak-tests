...
|--------|---------|--------|-----------|
| `alias_types_full.bak` | 0.04s | 0.03s | 0.07s |
| `archive_columnstore_partition_full.bak` | 0.967s | 0.635s | 1.602s |
| `archive_columnstore_types_full.bak` | 0.324s | 0.698s | 1.022s |
| `archive_columnstore_types_random_full.bak` | 0.449s | 0.761s | 1.21s |
| `archive_single_chunk_full.bak` | 0.044s | 0.034s | 0.078s |
| `archive_single_chunk_random_full.bak` | 0.044s | 0.033s | 0.077s |
| `archivenull_full.bak` | 0.127s | 0.21s | 0.337s |
| `backup_blocksize_full.bak` | 0.041s | 0.048s | 0.089s |
| `boundarycoverage_datetime_full.bak` | 0.086s | 0.152s | 0.238s |
| `boundarycoverage_full.bak` | 0.052s | 0.058s | 0.11s |
| `cci_binary_varbinary_compare_full.bak` | 0.045s | 0.046s | 0.091s |
| `cci_bitpack_probe_bigint_full.bak` | 0s | 5.993s | 5.993s |
| `cci_bitpack_probe_full.bak` | 0s | 0.62s | 0.62s |
| `cci_bitpack_probe_highbase_full.bak` | 0s | 0.628s | 0.628s |
| `cci_btree_nci_full.bak` | 0.05s | 0.034s | 0.084s |
| `cci_computed_full.bak` | 0.068s | 0.041s | 0.109s |
| `cci_enc5_largepool_full.bak` | 0.369s | 0.44s | 0.809s |
| `cci_enc5_largepool_matrix_full.bak` | 7.275s | 1.26s | 8.535s |
| `cci_extended_full.bak` | 0.055s | 0.052s | 0.107s |
| `cci_lob_full.bak` | 0.078s | 0.037s | 0.115s |
| `cci_reorganize_full.bak` | 0.067s | 0.037s | 0.104s |
| `cci_string_dict_regression_full.bak` | 0.367s | 0.137s | 0.504s |
| `cci_string_minmax_full.bak` | 0.051s | 0.034s | 0.085s |
| `cci_switch_full.bak` | 0.062s | 0.034s | 0.096s |
| `cci_types_large_full.bak` | 0.057s | 0.043s | 0.1s |
| `cci_varbinary_micro_full.bak` | 0.066s | 0.032s | 0.098s |
| `cci_varbinary_probe_full.bak` | 0.07s | 0.043s | 0.113s |
| `columnstore_minimal.bak` | 0.129s | 0.88s | 1.009s |
| `compressed_nvarchar_full.bak` | 0.039s | 0.029s | 0.068s |
| `compressioncoverage_full.bak` | 0.103s | 0.172s | 0.275s |
| `computedcoverage_full.bak` | 0.04s | 0.03s | 0.07s |
| `constraintcoverage_full.bak` | 0.049s | 0.037s | 0.086s |
| `covering_index_full.bak` | 0.057s | 0.039s | 0.096s |
| `cs_lob_preamble.bak` | 0.098s | 0.056s | 0.154s |
| `delta_rowgroup_full.bak` | 0.044s | 0.03s | 0.074s |
| `dirtycoverage_aborted_xact.bak` | 0.062s | 0.034s | 0.096s |
| `dirtycoverage_addcol.bak` | 0.055s | 0.029s | 0.084s |
| `dirtycoverage_addnotnull.bak` | 0.056s | 0.037s | 0.093s |
| `dirtycoverage_alldirty.bak` | 0.063s | 0.038s | 0.101s |
| `dirtycoverage_altercol.bak` | 0.051s | 0.031s | 0.082s |
| `dirtycoverage_altercol_rewrite.bak` | 0.057s | 0.034s | 0.091s |
| `dirtycoverage_alterdb.bak` | 0.061s | 0.033s | 0.094s |
| `dirtycoverage_cci_delete.bak` | 0.095s | 0.091s | 0.186s |
| `dirtycoverage_cci_update.bak` | 0.094s | 0.092s | 0.186s |
| `dirtycoverage_committed_delete.bak` | 0.042s | 0.03s | 0.072s |
| `dirtycoverage_committed_delete_v2.bak` | 0.043s | 0.04s | 0.083s |
| `dirtycoverage_committed_delete_v3.bak` | 0.051s | 0.061s | 0.112s |
| `dirtycoverage_committed_delete_v4.bak` | 0.157s | 0.066s | 0.223s |
| `dirtycoverage_committed_update.bak` | 0.041s | 0.03s | 0.071s |
| `dirtycoverage_committed_update_v2.bak` | 0.043s | 0.032s | 0.075s |
| `dirtycoverage_committed_update_v3.bak` | 0.059s | 0.068s | 0.127s |
| `dirtycoverage_committed_update_v4.bak` | 0.169s | 0.069s | 0.238s |
| `dirtycoverage_concurrent.bak` | 0.06s | 0.033s | 0.093s |
| `dirtycoverage_createidx.bak` | 0.057s | 0.034s | 0.091s |
| `dirtycoverage_createtable.bak` | 0.059s | 0.037s | 0.096s |
| `dirtycoverage_delete.bak` | 0.06s | 0.036s | 0.096s |
| `dirtycoverage_dropcol.bak` | 0.057s | 0.029s | 0.086s |
| `dirtycoverage_dropidx.bak` | 0.059s | 0.034s | 0.093s |
| `dirtycoverage_droptable.bak` | 0.06s | 0.032s | 0.092s |
| `dirtycoverage_heap_forward.bak` | 0.058s | 0.04s | 0.098s |
| `dirtycoverage_large_dirty.bak` | 0.336s | 0.039s | 0.375s |
| `dirtycoverage_lob_update.bak` | 0.08s | 0.031s | 0.111s |
| `dirtycoverage_maxrow.bak` | 0.041s | 0.03s | 0.071s |
| `dirtycoverage_nchar_delete.bak` | 0.059s | 0.035s | 0.094s |
| `dirtycoverage_nested.bak` | 0.062s | 0.034s | 0.096s |
| `dirtycoverage_null_update.bak` | 0.057s | 0.034s | 0.091s |
| `dirtycoverage_rebuildidx.bak` | 0.057s | 0.033s | 0.09s |
| `dirtycoverage_rich_insert.bak` | 0.063s | 0.037s | 0.1s |
| `dirtycoverage_rich_update.bak` | 0.06s | 0.034s | 0.094s |
| `dirtycoverage_savepoint.bak` | 0.065s | 0.031s | 0.096s |
| `dirtycoverage_snapshot_update.bak` | 0.058s | 0.033s | 0.091s |
| `dirtycoverage_switch.bak` | 0.067s | 0.046s | 0.113s |
| `dirtycoverage_temporal_update.bak` | 0.067s | 0.031s | 0.098s |
| `dirtycoverage_truncate.bak` | 0.059s | 0.033s | 0.092s |
| `dirtycoverage_two_tx.bak` | 0.064s | 0.036s | 0.1s |
| `dirtycoverage_uncommitted.bak` | 0.058s | 0.034s | 0.092s |
| `dirtycoverage_update.bak` | 0.06s | 0.033s | 0.093s |
| `filtered_ncci_full.bak` | 0.069s | 0.042s | 0.111s |
| `float_extreme_full.bak` | 0.042s | 0.035s | 0.077s |
| `forwarded_records_full.bak` | 0.232s | 0.061s | 0.293s |
| `ghost_records_full.bak` | 0.041s | 0.036s | 0.077s |
| `heapcoverage_large.bak` | 0.047s | 0.036s | 0.083s |
| `heapcoverage_large_50000.bak` | 0.2s | 0.317s | 0.517s |
| `hierarchyid_extract_full.bak` | 0.047s | 0.032s | 0.079s |
| `high_slot_density_full.bak` | 0.074s | 0.213s | 0.287s |
| `incrementalcoverage_diff_01.bak` | 0.042s | 0.01s | 0.052s |
| `incrementalcoverage_diff_02.bak` | 0.041s | 0.011s | 0.052s |
| `incrementalcoverage_diff_03.bak` | 0.043s | 0.01s | 0.053s |
| `incrementalcoverage_diff_04.bak` | 0.04s | 0.01s | 0.05s |
| `incrementalcoverage_diff_05.bak` | 0.041s | 0.014s | 0.055s |
| `incrementalcoverage_diff_06.bak` | 0.042s | 0.01s | 0.052s |
| `incrementalcoverage_full.bak` | 0.068s | 0.03s | 0.098s |
| `layoutcoverage_full.bak` | 0.203s | 0.316s | 0.519s |
| `max_row_width_full.bak` | 0.042s | 0.034s | 0.076s |
| `mixed_collation_full.bak` | 0.042s | 0.03s | 0.072s |
| `multi_rowgroup_full.bak` | 0.045s | 0.034s | 0.079s |
| `ncci_heap_full.bak` | 0.061s | 0.037s | 0.098s |
| `ncci_types_full.bak` | 0.115s | 0.183s | 0.298s |
| `ndfcoverage_full.bak` | 0.042s | 0.033s | 0.075s |
| `nvarchar_max_u21_full.bak` | 0.039s | 0.044s | 0.083s |
| `pagecomp_anchor_full.bak` | 0.141s | 0.09s | 0.231s |
| `pagecomp_long_prefix_full.bak` | 0.039s | 0.029s | 0.068s |
| `pfor_columnstore_full.bak` | 0.117s | 0.985s | 1.102s |
| `pfor_columnstore_random_full.bak` | 0.15s | 0.89s | 1.04s |
| `realworld_numeric_digest_full.bak` | 0.078s | 0.079s | 0.157s |
| `rowboundary_full.bak` | 0.044s | 0.048s | 0.092s |
| `rowstore_hash_pii_full.bak` | 0.04s | 0.031s | 0.071s |
| `rowstore_lob_image_full.bak` | 0.041s | 0.03s | 0.071s |
| `rowstore_lob_markup_full.bak` | 0.041s | 0.029s | 0.07s |
| `rowversion_extract_full.bak` | 0.041s | 0.03s | 0.071s |
| `sparse_full.bak` | 0.099s | 0.083s | 0.182s |
| `spatial_edge_full.bak` | 0.045s | 0.031s | 0.076s |
| `spatial_index_full.bak` | 0.064s | 0.047s | 0.111s |
| `sql_variant_extract_full.bak` | 0.04s | 0.036s | 0.076s |
| `striped_full_1.bak` | 0.046s | 0.016s | 0.062s |
| `striped_single.bak` | 0.078s | 0.041s | 0.119s |
| `surrogate_pairs_full.bak` | 0.04s | 0.034s | 0.074s |
| `tabletype_cci_large_full.bak` | 0.064s | 0.049s | 0.113s |
| `tabletypecoverage_diff.bak` | 0.1s | 0.067s | 0.167s |
| `tabletypecoverage_full.bak` | 0.197s | 0.09s | 0.287s |
| `temporal_hidden_full.bak` | 0.045s | 0.034s | 0.079s |
| `torn_page_full.bak` | 0.04s | 0.03s | 0.07s |
| `typecoverage_full.bak` | 0.115s | 0.069s | 0.184s |
| `typed_xml_full.bak` | 0.042s | 0.029s | 0.071s |
| `unicode_codepage_coverage.bak` | 0.098s | 0.045s | 0.143s |
| `xml_index_full.bak` | 0.061s | 0.04s | 0.101s |
| `xmlcoverage_full.bak` | 0.041s | 0.031s | 0.072s |
| `xmlheap_full.bak` | 0.1s | 0.052s | 0.152s |
| `xtp_checkpoint_straddle_full.bak` | 0s | 0.402s | 0.402s |
| `xtp_probe_full.bak` | 0.099s | 0.032s | 0.131s |
| `xtp_rich_full.bak` | 0.079s | 0.037s | 0.116s |
| `xtp_simple_full.bak` | 0.077s | 0.037s | 0.114s |
