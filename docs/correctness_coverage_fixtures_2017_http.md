...
|--------|---------|--------|-----------|
| `alias_types_full.bak` | 0.044s | 0.035s | 0.079s |
| `archive_columnstore_partition_full.bak` | 1.042s | 0.644s | 1.686s |
| `archive_columnstore_types_full.bak` | 0.319s | 0.694s | 1.013s |
| `archive_columnstore_types_random_full.bak` | 0.38s | 0.743s | 1.123s |
| `archive_single_chunk_full.bak` | 0.048s | 0.033s | 0.081s |
| `archive_single_chunk_random_full.bak` | 0.048s | 0.036s | 0.084s |
| `archivenull_full.bak` | 0.127s | 0.211s | 0.338s |
| `backup_blocksize_full.bak` | 0.04s | 0.03s | 0.07s |
| `boundarycoverage_datetime_full.bak` | 0.076s | 0.147s | 0.223s |
| `boundarycoverage_full.bak` | 0.054s | 0.059s | 0.113s |
| `cci_binary_varbinary_compare_full.bak` | 0.044s | 0.031s | 0.075s |
| `cci_bitpack_probe_bigint_full.bak` | 1.286s | 3.849s | 5.135s |
| `cci_bitpack_probe_full.bak` | 0.127s | 0.658s | 0.785s |
| `cci_bitpack_probe_highbase_full.bak` | 0.103s | 0.436s | 0.539s |
| `cci_btree_nci_full.bak` | 0.05s | 0.035s | 0.085s |
| `cci_computed_full.bak` | 0.061s | 0.04s | 0.101s |
| `cci_enc5_largepool_full.bak` | 0.374s | 0.451s | 0.825s |
| `cci_enc5_largepool_matrix_full.bak` | 7.17s | 1.286s | 8.456s |
| `cci_extended_full.bak` | 0.052s | 0.047s | 0.099s |
| `cci_lob_full.bak` | 0.072s | 0.036s | 0.108s |
| `cci_reorganize_full.bak` | 0.061s | 0.033s | 0.094s |
| `cci_string_dict_regression_full.bak` | 0.321s | 0.138s | 0.459s |
| `cci_string_minmax_full.bak` | 0.052s | 0.035s | 0.087s |
| `cci_switch_full.bak` | 0.064s | 0.038s | 0.102s |
| `cci_types_large_full.bak` | 0.054s | 0.039s | 0.093s |
| `cci_varbinary_micro_full.bak` | 0.061s | 0.031s | 0.092s |
| `cci_varbinary_probe_full.bak` | 0.065s | 0.043s | 0.108s |
| `columnstore_minimal.bak` | 0.127s | 1.003s | 1.13s |
| `compressed_nvarchar_full.bak` | 0.04s | 0.037s | 0.077s |
| `compressioncoverage_full.bak` | 0.103s | 0.175s | 0.278s |
| `computedcoverage_full.bak` | 0.04s | 0.034s | 0.074s |
| `constraintcoverage_full.bak` | 0.049s | 0.036s | 0.085s |
| `covering_index_full.bak` | 0.06s | 0.038s | 0.098s |
| `cs_lob_preamble.bak` | 0.102s | 0.05s | 0.152s |
| `delta_rowgroup_full.bak` | 0.046s | 0.03s | 0.076s |
| `dirtycoverage_aborted_xact.bak` | 0.057s | 0.034s | 0.091s |
| `dirtycoverage_addcol.bak` | 0.055s | 0.028s | 0.083s |
| `dirtycoverage_addnotnull.bak` | 0.057s | 0.029s | 0.086s |
| `dirtycoverage_alldirty.bak` | 0.062s | 0.034s | 0.096s |
| `dirtycoverage_altercol.bak` | 0.045s | 0.027s | 0.072s |
| `dirtycoverage_altercol_rewrite.bak` | 0.055s | 0.029s | 0.084s |
| `dirtycoverage_alterdb.bak` | 0.06s | 0.036s | 0.096s |
| `dirtycoverage_cci_delete.bak` | 0.094s | 0.087s | 0.181s |
| `dirtycoverage_cci_update.bak` | 0.096s | 0.091s | 0.187s |
| `dirtycoverage_committed_delete.bak` | 0.043s | 0.034s | 0.077s |
| `dirtycoverage_committed_delete_v2.bak` | 0.045s | 0.03s | 0.075s |
| `dirtycoverage_committed_delete_v3.bak` | 0.055s | 0.057s | 0.112s |
| `dirtycoverage_committed_delete_v4.bak` | 0.163s | 0.066s | 0.229s |
| `dirtycoverage_committed_update.bak` | 0.041s | 0.034s | 0.075s |
| `dirtycoverage_committed_update_v2.bak` | 0.043s | 0.032s | 0.075s |
| `dirtycoverage_committed_update_v3.bak` | 0.052s | 0.074s | 0.126s |
| `dirtycoverage_committed_update_v4.bak` | 0.169s | 0.073s | 0.242s |
| `dirtycoverage_concurrent.bak` | 0.06s | 0.029s | 0.089s |
| `dirtycoverage_createidx.bak` | 0.057s | 0.032s | 0.089s |
| `dirtycoverage_createtable.bak` | 0.057s | 0.029s | 0.086s |
| `dirtycoverage_delete.bak` | 0.059s | 0.031s | 0.09s |
| `dirtycoverage_dropcol.bak` | 0.057s | 0.033s | 0.09s |
| `dirtycoverage_dropidx.bak` | 0.058s | 0.029s | 0.087s |
| `dirtycoverage_droptable.bak` | 0.06s | 0.031s | 0.091s |
| `dirtycoverage_heap_forward.bak` | 0.068s | 0.036s | 0.104s |
| `dirtycoverage_large_dirty.bak` | 0.332s | 0.035s | 0.367s |
| `dirtycoverage_lob_update.bak` | 0.081s | 0.032s | 0.113s |
| `dirtycoverage_maxrow.bak` | 0.044s | 0.034s | 0.078s |
| `dirtycoverage_nchar_delete.bak` | 0.063s | 0.031s | 0.094s |
| `dirtycoverage_nested.bak` | 0.061s | 0.033s | 0.094s |
| `dirtycoverage_null_update.bak` | 0.058s | 0.032s | 0.09s |
| `dirtycoverage_rebuildidx.bak` | 0.057s | 0.029s | 0.086s |
| `dirtycoverage_rich_insert.bak` | 0.063s | 0.038s | 0.101s |
| `dirtycoverage_rich_update.bak` | 0.058s | 0.032s | 0.09s |
| `dirtycoverage_savepoint.bak` | 0.063s | 0.029s | 0.092s |
| `dirtycoverage_snapshot_update.bak` | 0.058s | 0.029s | 0.087s |
| `dirtycoverage_switch.bak` | 0.062s | 0.032s | 0.094s |
| `dirtycoverage_temporal_update.bak` | 0.065s | 0.037s | 0.102s |
| `dirtycoverage_truncate.bak` | 0.058s | 0.03s | 0.088s |
| `dirtycoverage_two_tx.bak` | 0.064s | 0.037s | 0.101s |
| `dirtycoverage_uncommitted.bak` | 0.057s | 0.041s | 0.098s |
| `dirtycoverage_update.bak` | 0.06s | 0.03s | 0.09s |
| `filtered_ncci_full.bak` | 0.062s | 0.035s | 0.097s |
| `float_extreme_full.bak` | 0.039s | 0.035s | 0.074s |
| `forwarded_records_full.bak` | 0.232s | 0.068s | 0.3s |
| `ghost_records_full.bak` | 0.043s | 0.032s | 0.075s |
| `heapcoverage_large.bak` | 0.045s | 0.04s | 0.085s |
| `heapcoverage_large_50000.bak` | 0.204s | 0.317s | 0.521s |
| `hierarchyid_extract_full.bak` | 0.04s | 0.029s | 0.069s |
| `high_slot_density_full.bak` | 0.067s | 0.193s | 0.26s |
| `identity_coverage_full.bak` | 0.064s | 0.041s | 0.105s |
| `incrementalcoverage_diff_01.bak` | 0.044s | 0.018s | 0.062s |
| `incrementalcoverage_diff_02.bak` | 0.044s | 0.014s | 0.058s |
| `incrementalcoverage_diff_03.bak` | 0.043s | 0.016s | 0.059s |
| `incrementalcoverage_diff_04.bak` | 0.043s | 0.017s | 0.06s |
| `incrementalcoverage_diff_05.bak` | 0.041s | 0.015s | 0.056s |
| `incrementalcoverage_diff_06.bak` | 0.045s | 0.014s | 0.059s |
| `incrementalcoverage_full.bak` | 0.041s | 0.029s | 0.07s |
| `layoutcoverage_full.bak` | 0.202s | 0.326s | 0.528s |
| `max_row_width_full.bak` | 0.042s | 0.029s | 0.071s |
| `mixed_collation_full.bak` | 0.043s | 0.031s | 0.074s |
| `multi_rowgroup_full.bak` | 0.046s | 0.036s | 0.082s |
| `ncci_heap_full.bak` | 0.059s | 0.034s | 0.093s |
| `ncci_types_full.bak` | 0.116s | 0.185s | 0.301s |
| `ndfcoverage_full.bak` | 0.044s | 0.032s | 0.076s |
| `nvarchar_max_u21_full.bak` | 0.043s | 0.032s | 0.075s |
| `pagecomp_anchor_full.bak` | 0.129s | 0.092s | 0.221s |
| `pagecomp_long_prefix_full.bak` | 0.041s | 0.033s | 0.074s |
| `pfor_columnstore_full.bak` | 0.119s | 0.817s | 0.936s |
| `pfor_columnstore_random_full.bak` | 0.128s | 0.828s | 0.956s |
| `realworld_numeric_digest_full.bak` | 0.069s | 0.075s | 0.144s |
| `rowboundary_full.bak` | 0.043s | 0.032s | 0.075s |
| `rowstore_hash_pii_full.bak` | 0.043s | 0.035s | 0.078s |
| `rowstore_lob_image_full.bak` | 0.04s | 0.034s | 0.074s |
| `rowstore_lob_markup_full.bak` | 0.04s | 0.032s | 0.072s |
| `rowversion_extract_full.bak` | 0.041s | 0.034s | 0.075s |
| `sparse_full.bak` | 0.097s | 0.092s | 0.189s |
| `spatial_edge_full.bak` | 0.045s | 0.028s | 0.073s |
| `spatial_index_full.bak` | 0.057s | 0.033s | 0.09s |
| `sql_variant_extract_full.bak` | 0.04s | 0.029s | 0.069s |
| `striped_full_1.bak` | 0.046s | 0.016s | 0.062s |
| `striped_single.bak` | 0.075s | 0.041s | 0.116s |
| `surrogate_pairs_full.bak` | 0.039s | 0.028s | 0.067s |
| `tabletype_cci_large_full.bak` | 0.067s | 0.044s | 0.111s |
| `tabletypecoverage_diff.bak` | 0.103s | 0.056s | 0.159s |
| `tabletypecoverage_full.bak` | 0.193s | 0.1s | 0.293s |
| `temporal_hidden_full.bak` | 0.044s | 0.037s | 0.081s |
| `torn_page_full.bak` | 0.055s | 0.036s | 0.091s |
| `typecoverage_full.bak` | 0.113s | 0.065s | 0.178s |
| `typed_xml_full.bak` | 0.045s | 0.035s | 0.08s |
| `unicode_codepage_coverage.bak` | 0.083s | 0.045s | 0.128s |
| `xml_index_full.bak` | 0.058s | 0.036s | 0.094s |
| `xmlcoverage_full.bak` | 0.041s | 0.029s | 0.07s |
| `xmlheap_full.bak` | 0.099s | 0.049s | 0.148s |
| `xtp_checkpoint_straddle_full.bak` | 1.782s | 0.319s | 2.101s |
| `xtp_probe_full.bak` | 0.098s | 0.047s | 0.145s |
| `xtp_rich_full.bak` | 0.078s | 0.035s | 0.113s |
| `xtp_simple_full.bak` | 0.078s | 0.033s | 0.111s |
