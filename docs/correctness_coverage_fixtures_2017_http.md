...
**132 fixtures · 132 pass · 0 xfail (known gap) · 0 fail**

**Tables:** 387/387 pass · **Columns:** 3963/3963 pass
...
| `xtp_checkpoint_straddle_full.bak` | — | — | — | — | — | — | confidence pass · constraints: 11 total · 11 pass · 0 fail | ✓ |
...
_SQL Server  · 41.145 MB_

_confidence pass._

### `cci_bitpack_probe_full.bak` — confidence pass

_SQL Server  · 7.117 MB_
...
### `xtp_checkpoint_straddle_full.bak` — confidence pass

_SQL Server  · 2.52 MB_
...
|--------|---------|--------|-----------|
| `alias_types_full.bak` | 0.042s | 0.03s | 0.072s |
| `archive_columnstore_partition_full.bak` | 0.963s | 0.884s | 1.847s |
| `archive_columnstore_types_full.bak` | 0.326s | 0.651s | 0.977s |
| `archive_columnstore_types_random_full.bak` | 0.329s | 0.661s | 0.99s |
| `archive_single_chunk_full.bak` | 0.046s | 0.033s | 0.079s |
| `archive_single_chunk_random_full.bak` | 0.045s | 0.033s | 0.078s |
| `archivenull_full.bak` | 0.125s | 0.197s | 0.322s |
| `backup_blocksize_full.bak` | 0.043s | 0.033s | 0.076s |
| `boundarycoverage_datetime_full.bak` | 0.082s | 0.164s | 0.246s |
| `boundarycoverage_full.bak` | 0.052s | 0.082s | 0.134s |
| `cci_binary_varbinary_compare_full.bak` | 0.044s | 0.032s | 0.076s |
| `cci_bitpack_probe_bigint_full.bak` | 0s | 5.724s | 5.724s |
| `cci_bitpack_probe_full.bak` | 0s | 0.611s | 0.611s |
| `cci_bitpack_probe_highbase_full.bak` | 0s | 0.554s | 0.554s |
| `cci_btree_nci_full.bak` | 0.048s | 0.049s | 0.097s |
| `cci_computed_full.bak` | 0.063s | 0.033s | 0.096s |
| `cci_enc5_largepool_full.bak` | 0.365s | 0.467s | 0.832s |
| `cci_enc5_largepool_matrix_full.bak` | 7.011s | 1.359s | 8.37s |
| `cci_extended_full.bak` | 0.054s | 0.038s | 0.092s |
| `cci_lob_full.bak` | 0.072s | 0.035s | 0.107s |
| `cci_reorganize_full.bak` | 0.068s | 0.036s | 0.104s |
| `cci_string_dict_regression_full.bak` | 0.317s | 0.131s | 0.448s |
| `cci_string_minmax_full.bak` | 0.05s | 0.042s | 0.092s |
| `cci_switch_full.bak` | 0.062s | 0.035s | 0.097s |
| `cci_types_large_full.bak` | 0.053s | 0.039s | 0.092s |
| `cci_varbinary_micro_full.bak` | 0.064s | 0.03s | 0.094s |
| `cci_varbinary_probe_full.bak` | 0.065s | 0.039s | 0.104s |
| `columnstore_minimal.bak` | 0.132s | 0.782s | 0.914s |
| `compressed_nvarchar_full.bak` | 0.045s | 0.034s | 0.079s |
| `compressioncoverage_full.bak` | 0.105s | 0.179s | 0.284s |
| `computedcoverage_full.bak` | 0.041s | 0.03s | 0.071s |
| `constraintcoverage_full.bak` | 0.046s | 0.035s | 0.081s |
| `covering_index_full.bak` | 0.056s | 0.041s | 0.097s |
| `cs_lob_preamble.bak` | 0.095s | 0.053s | 0.148s |
| `delta_rowgroup_full.bak` | 0.044s | 0.034s | 0.078s |
| `dirtycoverage_aborted_xact.bak` | 0.057s | 0.033s | 0.09s |
| `dirtycoverage_addcol.bak` | 0.055s | 0.029s | 0.084s |
| `dirtycoverage_addnotnull.bak` | 0.058s | 0.029s | 0.087s |
| `dirtycoverage_alldirty.bak` | 0.06s | 0.028s | 0.088s |
| `dirtycoverage_altercol.bak` | 0.043s | 0.034s | 0.077s |
| `dirtycoverage_altercol_rewrite.bak` | 0.056s | 0.029s | 0.085s |
| `dirtycoverage_alterdb.bak` | 0.06s | 0.03s | 0.09s |
| `dirtycoverage_cci_delete.bak` | 0.093s | 0.084s | 0.177s |
| `dirtycoverage_cci_update.bak` | 0.093s | 0.089s | 0.182s |
| `dirtycoverage_committed_delete.bak` | 0.041s | 0.037s | 0.078s |
| `dirtycoverage_committed_delete_v2.bak` | 0.046s | 0.041s | 0.087s |
| `dirtycoverage_committed_delete_v3.bak` | 0.048s | 0.061s | 0.109s |
| `dirtycoverage_committed_delete_v4.bak` | 0.157s | 0.109s | 0.266s |
| `dirtycoverage_committed_update.bak` | 0.043s | 0.035s | 0.078s |
| `dirtycoverage_committed_update_v2.bak` | 0.042s | 0.036s | 0.078s |
| `dirtycoverage_committed_update_v3.bak` | 0.052s | 0.08s | 0.132s |
| `dirtycoverage_committed_update_v4.bak` | 0.169s | 0.127s | 0.296s |
| `dirtycoverage_concurrent.bak` | 0.058s | 0.03s | 0.088s |
| `dirtycoverage_createidx.bak` | 0.055s | 0.03s | 0.085s |
| `dirtycoverage_createtable.bak` | 0.056s | 0.029s | 0.085s |
| `dirtycoverage_delete.bak` | 0.063s | 0.032s | 0.095s |
| `dirtycoverage_dropcol.bak` | 0.062s | 0.03s | 0.092s |
| `dirtycoverage_dropidx.bak` | 0.068s | 0.029s | 0.097s |
| `dirtycoverage_droptable.bak` | 0.057s | 0.034s | 0.091s |
| `dirtycoverage_heap_forward.bak` | 0.058s | 0.039s | 0.097s |
| `dirtycoverage_large_dirty.bak` | 0.343s | 0.063s | 0.406s |
| `dirtycoverage_lob_update.bak` | 0.078s | 0.029s | 0.107s |
| `dirtycoverage_maxrow.bak` | 0.043s | 0.036s | 0.079s |
| `dirtycoverage_nchar_delete.bak` | 0.058s | 0.03s | 0.088s |
| `dirtycoverage_nested.bak` | 0.057s | 0.029s | 0.086s |
| `dirtycoverage_null_update.bak` | 0.057s | 0.034s | 0.091s |
| `dirtycoverage_rebuildidx.bak` | 0.055s | 0.031s | 0.086s |
| `dirtycoverage_rich_insert.bak` | 0.06s | 0.029s | 0.089s |
| `dirtycoverage_rich_update.bak` | 0.056s | 0.029s | 0.085s |
| `dirtycoverage_savepoint.bak` | 0.061s | 0.034s | 0.095s |
| `dirtycoverage_snapshot_update.bak` | 0.057s | 0.03s | 0.087s |
| `dirtycoverage_switch.bak` | 0.062s | 0.031s | 0.093s |
| `dirtycoverage_temporal_update.bak` | 0.063s | 0.037s | 0.1s |
| `dirtycoverage_truncate.bak` | 0.055s | 0.032s | 0.087s |
| `dirtycoverage_two_tx.bak` | 0.06s | 0.029s | 0.089s |
| `dirtycoverage_uncommitted.bak` | 0.061s | 0.031s | 0.092s |
| `dirtycoverage_update.bak` | 0.06s | 0.029s | 0.089s |
| `filtered_ncci_full.bak` | 0.063s | 0.034s | 0.097s |
| `float_extreme_full.bak` | 0.042s | 0.032s | 0.074s |
| `forwarded_records_full.bak` | 0.238s | 0.07s | 0.308s |
| `ghost_records_full.bak` | 0.042s | 0.031s | 0.073s |
| `heapcoverage_large.bak` | 0.042s | 0.039s | 0.081s |
| `heapcoverage_large_50000.bak` | 0.197s | 0.45s | 0.647s |
| `hierarchyid_extract_full.bak` | 0.042s | 0.035s | 0.077s |
| `high_slot_density_full.bak` | 0.068s | 0.237s | 0.305s |
| `incrementalcoverage_diff_01.bak` | 0.042s | 0.017s | 0.059s |
| `incrementalcoverage_diff_02.bak` | 0.043s | 0.017s | 0.06s |
| `incrementalcoverage_diff_03.bak` | 0.042s | 0.016s | 0.058s |
| `incrementalcoverage_diff_04.bak` | 0.043s | 0.014s | 0.057s |
| `incrementalcoverage_diff_05.bak` | 0.042s | 0.015s | 0.057s |
| `incrementalcoverage_diff_06.bak` | 0.042s | 0.017s | 0.059s |
| `incrementalcoverage_full.bak` | 0.041s | 0.036s | 0.077s |
| `layoutcoverage_full.bak` | 0.202s | 0.206s | 0.408s |
| `max_row_width_full.bak` | 0.042s | 0.032s | 0.074s |
| `mixed_collation_full.bak` | 0.041s | 0.032s | 0.073s |
| `multi_rowgroup_full.bak` | 0.045s | 0.037s | 0.082s |
| `ncci_heap_full.bak` | 0.061s | 0.031s | 0.092s |
| `ncci_types_full.bak` | 0.117s | 0.23s | 0.347s |
| `ndfcoverage_full.bak` | 0.05s | 0.032s | 0.082s |
| `nvarchar_max_u21_full.bak` | 0.04s | 0.033s | 0.073s |
| `pagecomp_anchor_full.bak` | 0.133s | 0.14s | 0.273s |
| `pagecomp_long_prefix_full.bak` | 0.042s | 0.028s | 0.07s |
| `pfor_columnstore_full.bak` | 0.121s | 1.078s | 1.199s |
| `pfor_columnstore_random_full.bak` | 0.148s | 1.13s | 1.278s |
| `realworld_numeric_digest_full.bak` | 0.072s | 0.093s | 0.165s |
| `rowboundary_full.bak` | 0.043s | 0.033s | 0.076s |
| `rowstore_hash_pii_full.bak` | 0.04s | 0.04s | 0.08s |
| `rowstore_lob_image_full.bak` | 0.039s | 0.029s | 0.068s |
| `rowstore_lob_markup_full.bak` | 0.04s | 0.034s | 0.074s |
| `rowversion_extract_full.bak` | 0.045s | 0.035s | 0.08s |
| `sparse_full.bak` | 0.091s | 0.133s | 0.224s |
| `spatial_edge_full.bak` | 0.046s | 0.035s | 0.081s |
| `spatial_index_full.bak` | 0.057s | 0.033s | 0.09s |
| `sql_variant_extract_full.bak` | 0.042s | 0.033s | 0.075s |
| `striped_full_1.bak` | 0.048s | 0.017s | 0.065s |
| `striped_single.bak` | 0.076s | 0.04s | 0.116s |
| `surrogate_pairs_full.bak` | 0.04s | 0.036s | 0.076s |
| `tabletype_cci_large_full.bak` | 0.066s | 0.044s | 0.11s |
| `tabletypecoverage_diff.bak` | 0.098s | 0.061s | 0.159s |
| `tabletypecoverage_full.bak` | 0.189s | 0.094s | 0.283s |
| `temporal_hidden_full.bak` | 0.042s | 0.032s | 0.074s |
| `torn_page_full.bak` | 0.042s | 0.031s | 0.073s |
| `typecoverage_full.bak` | 0.112s | 0.074s | 0.186s |
| `typed_xml_full.bak` | 0.043s | 0.033s | 0.076s |
| `unicode_codepage_coverage.bak` | 0.104s | 0.039s | 0.143s |
| `xml_index_full.bak` | 0.057s | 0.032s | 0.089s |
| `xmlcoverage_full.bak` | 0.057s | 0.036s | 0.093s |
| `xmlheap_full.bak` | 0.103s | 0.056s | 0.159s |
| `xtp_checkpoint_straddle_full.bak` | 0s | 0.392s | 0.392s |
| `xtp_probe_full.bak` | 0.1s | 0.033s | 0.133s |
| `xtp_rich_full.bak` | 0.076s | 0.033s | 0.109s |
| `xtp_simple_full.bak` | 0.084s | 0.046s | 0.13s |
...
_Generated 2026-07-11 · 132 fixtures · 132 pass · 0 xfail · 0 fail_
