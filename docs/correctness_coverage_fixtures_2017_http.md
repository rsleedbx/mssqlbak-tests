...
|--------|---------|--------|-----------|
| `alias_types_full.bak` | 0.039s | 0.029s | 0.068s |
| `archive_columnstore_partition_full.bak` | 0.981s | 0.943s | 1.924s |
| `archive_columnstore_types_full.bak` | 0.332s | 0.667s | 0.999s |
| `archive_columnstore_types_random_full.bak` | 0.327s | 0.67s | 0.997s |
| `archive_single_chunk_full.bak` | 0.046s | 0.034s | 0.08s |
| `archive_single_chunk_random_full.bak` | 0.044s | 0.033s | 0.077s |
| `archivenull_full.bak` | 0.131s | 0.205s | 0.336s |
| `backup_blocksize_full.bak` | 0.044s | 0.031s | 0.075s |
| `boundarycoverage_datetime_full.bak` | 0.074s | 0.175s | 0.249s |
| `boundarycoverage_full.bak` | 0.057s | 0.089s | 0.146s |
| `cci_binary_varbinary_compare_full.bak` | 0.052s | 0.033s | 0.085s |
| `cci_bitpack_probe_bigint_full.bak` | 0s | 5.851s | 5.851s |
| `cci_bitpack_probe_full.bak` | 0s | 0.621s | 0.621s |
| `cci_bitpack_probe_highbase_full.bak` | 0s | 0.567s | 0.567s |
| `cci_btree_nci_full.bak` | 0.051s | 0.036s | 0.087s |
| `cci_computed_full.bak` | 0.062s | 0.034s | 0.096s |
| `cci_enc5_largepool_full.bak` | 0.37s | 0.48s | 0.85s |
| `cci_enc5_largepool_matrix_full.bak` | 7.074s | 1.425s | 8.499s |
| `cci_extended_full.bak` | 0.063s | 0.044s | 0.107s |
| `cci_lob_full.bak` | 0.073s | 0.04s | 0.113s |
| `cci_reorganize_full.bak` | 0.072s | 0.035s | 0.107s |
| `cci_string_dict_regression_full.bak` | 0.321s | 0.138s | 0.459s |
| `cci_string_minmax_full.bak` | 0.049s | 0.034s | 0.083s |
| `cci_switch_full.bak` | 0.06s | 0.034s | 0.094s |
| `cci_types_large_full.bak` | 0.056s | 0.038s | 0.094s |
| `cci_varbinary_micro_full.bak` | 0.065s | 0.03s | 0.095s |
| `cci_varbinary_probe_full.bak` | 0.065s | 0.04s | 0.105s |
| `columnstore_minimal.bak` | 0.127s | 0.829s | 0.956s |
| `compressed_nvarchar_full.bak` | 0.043s | 0.029s | 0.072s |
| `compressioncoverage_full.bak` | 0.103s | 0.184s | 0.287s |
| `computedcoverage_full.bak` | 0.041s | 0.047s | 0.088s |
| `constraintcoverage_full.bak` | 0.046s | 0.037s | 0.083s |
| `covering_index_full.bak` | 0.058s | 0.043s | 0.101s |
| `cs_lob_preamble.bak` | 0.098s | 0.055s | 0.153s |
| `delta_rowgroup_full.bak` | 0.045s | 0.032s | 0.077s |
| `dirtycoverage_aborted_xact.bak` | 0.057s | 0.029s | 0.086s |
| `dirtycoverage_addcol.bak` | 0.053s | 0.028s | 0.081s |
| `dirtycoverage_addnotnull.bak` | 0.058s | 0.03s | 0.088s |
| `dirtycoverage_alldirty.bak` | 0.063s | 0.034s | 0.097s |
| `dirtycoverage_altercol.bak` | 0.04s | 0.03s | 0.07s |
| `dirtycoverage_altercol_rewrite.bak` | 0.057s | 0.03s | 0.087s |
| `dirtycoverage_alterdb.bak` | 0.056s | 0.032s | 0.088s |
| `dirtycoverage_cci_delete.bak` | 0.101s | 0.095s | 0.196s |
| `dirtycoverage_cci_update.bak` | 0.095s | 0.091s | 0.186s |
| `dirtycoverage_committed_delete.bak` | 0.04s | 0.032s | 0.072s |
| `dirtycoverage_committed_delete_v2.bak` | 0.042s | 0.035s | 0.077s |
| `dirtycoverage_committed_delete_v3.bak` | 0.051s | 0.062s | 0.113s |
| `dirtycoverage_committed_delete_v4.bak` | 0.167s | 0.114s | 0.281s |
| `dirtycoverage_committed_update.bak` | 0.043s | 0.034s | 0.077s |
| `dirtycoverage_committed_update_v2.bak` | 0.043s | 0.035s | 0.078s |
| `dirtycoverage_committed_update_v3.bak` | 0.054s | 0.084s | 0.138s |
| `dirtycoverage_committed_update_v4.bak` | 0.168s | 0.131s | 0.299s |
| `dirtycoverage_concurrent.bak` | 0.061s | 0.029s | 0.09s |
| `dirtycoverage_createidx.bak` | 0.056s | 0.034s | 0.09s |
| `dirtycoverage_createtable.bak` | 0.054s | 0.035s | 0.089s |
| `dirtycoverage_delete.bak` | 0.07s | 0.033s | 0.103s |
| `dirtycoverage_dropcol.bak` | 0.056s | 0.03s | 0.086s |
| `dirtycoverage_dropidx.bak` | 0.057s | 0.031s | 0.088s |
| `dirtycoverage_droptable.bak` | 0.06s | 0.037s | 0.097s |
| `dirtycoverage_heap_forward.bak` | 0.057s | 0.034s | 0.091s |
| `dirtycoverage_large_dirty.bak` | 0.343s | 0.058s | 0.401s |
| `dirtycoverage_lob_update.bak` | 0.08s | 0.029s | 0.109s |
| `dirtycoverage_maxrow.bak` | 0.042s | 0.029s | 0.071s |
| `dirtycoverage_nchar_delete.bak` | 0.06s | 0.034s | 0.094s |
| `dirtycoverage_nested.bak` | 0.062s | 0.028s | 0.09s |
| `dirtycoverage_null_update.bak` | 0.058s | 0.033s | 0.091s |
| `dirtycoverage_rebuildidx.bak` | 0.056s | 0.031s | 0.087s |
| `dirtycoverage_rich_insert.bak` | 0.06s | 0.033s | 0.093s |
| `dirtycoverage_rich_update.bak` | 0.06s | 0.03s | 0.09s |
| `dirtycoverage_savepoint.bak` | 0.063s | 0.029s | 0.092s |
| `dirtycoverage_snapshot_update.bak` | 0.06s | 0.028s | 0.088s |
| `dirtycoverage_switch.bak` | 0.065s | 0.038s | 0.103s |
| `dirtycoverage_temporal_update.bak` | 0.062s | 0.03s | 0.092s |
| `dirtycoverage_truncate.bak` | 0.056s | 0.031s | 0.087s |
| `dirtycoverage_two_tx.bak` | 0.059s | 0.029s | 0.088s |
| `dirtycoverage_uncommitted.bak` | 0.057s | 0.029s | 0.086s |
| `dirtycoverage_update.bak` | 0.06s | 0.029s | 0.089s |
| `filtered_ncci_full.bak` | 0.066s | 0.034s | 0.1s |
| `float_extreme_full.bak` | 0.042s | 0.03s | 0.072s |
| `forwarded_records_full.bak` | 0.237s | 0.074s | 0.311s |
| `ghost_records_full.bak` | 0.042s | 0.034s | 0.076s |
| `heapcoverage_large.bak` | 0.042s | 0.039s | 0.081s |
| `heapcoverage_large_50000.bak` | 0.195s | 0.465s | 0.66s |
| `hierarchyid_extract_full.bak` | 0.041s | 0.03s | 0.071s |
| `high_slot_density_full.bak` | 0.07s | 0.235s | 0.305s |
| `incrementalcoverage_diff_01.bak` | 0.041s | 0.011s | 0.052s |
| `incrementalcoverage_diff_02.bak` | 0.041s | 0.01s | 0.051s |
| `incrementalcoverage_diff_03.bak` | 0.042s | 0.015s | 0.057s |
| `incrementalcoverage_diff_04.bak` | 0.043s | 0.01s | 0.053s |
| `incrementalcoverage_diff_05.bak` | 0.041s | 0.01s | 0.051s |
| `incrementalcoverage_diff_06.bak` | 0.041s | 0.01s | 0.051s |
| `incrementalcoverage_full.bak` | 0.041s | 0.03s | 0.071s |
| `layoutcoverage_full.bak` | 0.199s | 0.206s | 0.405s |
| `max_row_width_full.bak` | 0.04s | 0.036s | 0.076s |
| `mixed_collation_full.bak` | 0.04s | 0.036s | 0.076s |
| `multi_rowgroup_full.bak` | 0.047s | 0.038s | 0.085s |
| `ncci_heap_full.bak` | 0.06s | 0.03s | 0.09s |
| `ncci_types_full.bak` | 0.118s | 0.219s | 0.337s |
| `ndfcoverage_full.bak` | 0.044s | 0.034s | 0.078s |
| `nvarchar_max_u21_full.bak` | 0.042s | 0.029s | 0.071s |
| `pagecomp_anchor_full.bak` | 0.131s | 0.146s | 0.277s |
| `pagecomp_long_prefix_full.bak` | 0.043s | 0.029s | 0.072s |
| `pfor_columnstore_full.bak` | 0.12s | 1.081s | 1.201s |
| `pfor_columnstore_random_full.bak` | 0.166s | 1.158s | 1.324s |
| `realworld_numeric_digest_full.bak` | 0.078s | 0.101s | 0.179s |
| `rowboundary_full.bak` | 0.044s | 0.031s | 0.075s |
| `rowstore_hash_pii_full.bak` | 0.043s | 0.042s | 0.085s |
| `rowstore_lob_image_full.bak` | 0.042s | 0.03s | 0.072s |
| `rowstore_lob_markup_full.bak` | 0.041s | 0.033s | 0.074s |
| `rowversion_extract_full.bak` | 0.043s | 0.03s | 0.073s |
| `sparse_full.bak` | 0.091s | 0.135s | 0.226s |
| `spatial_edge_full.bak` | 0.042s | 0.031s | 0.073s |
| `spatial_index_full.bak` | 0.058s | 0.032s | 0.09s |
| `sql_variant_extract_full.bak` | 0.041s | 0.033s | 0.074s |
| `striped_full_1.bak` | 0.047s | 0.012s | 0.059s |
| `striped_single.bak` | 0.076s | 0.041s | 0.117s |
| `surrogate_pairs_full.bak` | 0.04s | 0.032s | 0.072s |
| `tabletype_cci_large_full.bak` | 0.064s | 0.053s | 0.117s |
| `tabletypecoverage_diff.bak` | 0.106s | 0.07s | 0.176s |
| `tabletypecoverage_full.bak` | 0.206s | 0.097s | 0.303s |
| `temporal_hidden_full.bak` | 0.045s | 0.033s | 0.078s |
| `torn_page_full.bak` | 0.04s | 0.032s | 0.072s |
| `typecoverage_full.bak` | 0.117s | 0.079s | 0.196s |
| `typed_xml_full.bak` | 0.042s | 0.031s | 0.073s |
| `unicode_codepage_coverage.bak` | 0.079s | 0.042s | 0.121s |
| `xml_index_full.bak` | 0.056s | 0.035s | 0.091s |
| `xmlcoverage_full.bak` | 0.042s | 0.03s | 0.072s |
| `xmlheap_full.bak` | 0.1s | 0.063s | 0.163s |
| `xtp_checkpoint_straddle_full.bak` | 0s | 0.387s | 0.387s |
| `xtp_probe_full.bak` | 0.096s | 0.039s | 0.135s |
| `xtp_rich_full.bak` | 0.076s | 0.034s | 0.11s |
| `xtp_simple_full.bak` | 0.078s | 0.034s | 0.112s |
