...
|--------|---------|--------|-----------|
| `alias_types_full.bak` | 0.046s | 0.034s | 0.08s |
| `archive_columnstore_partition_full.bak` | 1.016s | 0.679s | 1.695s |
| `archive_columnstore_types_full.bak` | 0.327s | 0.717s | 1.044s |
| `archive_columnstore_types_random_full.bak` | 0.333s | 0.726s | 1.059s |
| `archive_single_chunk_full.bak` | 0.047s | 0.033s | 0.08s |
| `archive_single_chunk_random_full.bak` | 0.046s | 0.032s | 0.078s |
| `archivenull_full.bak` | 0.139s | 0.218s | 0.357s |
| `backup_blocksize_full.bak` | 0.041s | 0.03s | 0.071s |
| `boundarycoverage_datetime_full.bak` | 0.094s | 0.161s | 0.255s |
| `boundarycoverage_full.bak` | 0.056s | 0.069s | 0.125s |
| `cci_binary_varbinary_compare_full.bak` | 0.049s | 0.032s | 0.081s |
| `cci_bitpack_probe_bigint_full.bak` | 1.322s | 3.909s | 5.231s |
| `cci_bitpack_probe_full.bak` | 0.117s | 0.681s | 0.798s |
| `cci_bitpack_probe_highbase_full.bak` | 0.113s | 0.434s | 0.547s |
| `cci_btree_nci_full.bak` | 0.053s | 0.044s | 0.097s |
| `cci_computed_full.bak` | 0.07s | 0.036s | 0.106s |
| `cci_enc5_largepool_full.bak` | 0.382s | 0.448s | 0.83s |
| `cci_enc5_largepool_matrix_full.bak` | 7.302s | 1.322s | 8.624s |
| `cci_extended_full.bak` | 0.053s | 0.04s | 0.093s |
| `cci_lob_full.bak` | 0.077s | 0.035s | 0.112s |
| `cci_reorganize_full.bak` | 0.065s | 0.034s | 0.099s |
| `cci_string_dict_regression_full.bak` | 0.331s | 0.151s | 0.482s |
| `cci_string_minmax_full.bak` | 0.054s | 0.033s | 0.087s |
| `cci_switch_full.bak` | 0.065s | 0.034s | 0.099s |
| `cci_types_large_full.bak` | 0.06s | 0.041s | 0.101s |
| `cci_varbinary_micro_full.bak` | 0.068s | 0.032s | 0.1s |
| `cci_varbinary_probe_full.bak` | 0.069s | 0.047s | 0.116s |
| `columnstore_minimal.bak` | 0.132s | 1.007s | 1.139s |
| `compressed_nvarchar_full.bak` | 0.044s | 0.029s | 0.073s |
| `compressioncoverage_full.bak` | 0.109s | 0.199s | 0.308s |
| `computedcoverage_full.bak` | 0.046s | 0.03s | 0.076s |
| `constraintcoverage_full.bak` | 0.049s | 0.035s | 0.084s |
| `covering_index_full.bak` | 0.056s | 0.038s | 0.094s |
| `cs_lob_preamble.bak` | 0.104s | 0.054s | 0.158s |
| `delta_rowgroup_full.bak` | 0.053s | 0.032s | 0.085s |
| `dirtycoverage_aborted_xact.bak` | 0.064s | 0.044s | 0.108s |
| `dirtycoverage_addcol.bak` | 0.063s | 0.043s | 0.106s |
| `dirtycoverage_addnotnull.bak` | 0.061s | 0.03s | 0.091s |
| `dirtycoverage_alldirty.bak` | 0.066s | 0.034s | 0.1s |
| `dirtycoverage_altercol.bak` | 0.089s | 0.036s | 0.125s |
| `dirtycoverage_altercol_rewrite.bak` | 0.06s | 0.031s | 0.091s |
| `dirtycoverage_alterdb.bak` | 0.065s | 0.032s | 0.097s |
| `dirtycoverage_cci_delete.bak` | 0.111s | 0.091s | 0.202s |
| `dirtycoverage_cci_update.bak` | 0.113s | 0.091s | 0.204s |
| `dirtycoverage_committed_delete.bak` | 0.044s | 0.033s | 0.077s |
| `dirtycoverage_committed_delete_v2.bak` | 0.05s | 0.034s | 0.084s |
| `dirtycoverage_committed_delete_v3.bak` | 0.052s | 0.07s | 0.122s |
| `dirtycoverage_committed_delete_v4.bak` | 0.168s | 0.065s | 0.233s |
| `dirtycoverage_committed_update.bak` | 0.044s | 0.031s | 0.075s |
| `dirtycoverage_committed_update_v2.bak` | 0.044s | 0.032s | 0.076s |
| `dirtycoverage_committed_update_v3.bak` | 0.058s | 0.071s | 0.129s |
| `dirtycoverage_committed_update_v4.bak` | 0.179s | 0.071s | 0.25s |
| `dirtycoverage_concurrent.bak` | 0.063s | 0.03s | 0.093s |
| `dirtycoverage_createidx.bak` | 0.06s | 0.03s | 0.09s |
| `dirtycoverage_createtable.bak` | 0.061s | 0.03s | 0.091s |
| `dirtycoverage_delete.bak` | 0.064s | 0.03s | 0.094s |
| `dirtycoverage_dropcol.bak` | 0.062s | 0.029s | 0.091s |
| `dirtycoverage_dropidx.bak` | 0.062s | 0.032s | 0.094s |
| `dirtycoverage_droptable.bak` | 0.124s | 0.041s | 0.165s |
| `dirtycoverage_heap_forward.bak` | 0.069s | 0.032s | 0.101s |
| `dirtycoverage_large_dirty.bak` | 0.339s | 0.031s | 0.37s |
| `dirtycoverage_lob_update.bak` | 0.08s | 0.032s | 0.112s |
| `dirtycoverage_maxrow.bak` | 0.04s | 0.029s | 0.069s |
| `dirtycoverage_nchar_delete.bak` | 0.067s | 0.029s | 0.096s |
| `dirtycoverage_nested.bak` | 0.064s | 0.034s | 0.098s |
| `dirtycoverage_null_update.bak` | 0.06s | 0.029s | 0.089s |
| `dirtycoverage_rebuildidx.bak` | 0.06s | 0.03s | 0.09s |
| `dirtycoverage_rich_insert.bak` | 0.07s | 0.054s | 0.124s |
| `dirtycoverage_rich_update.bak` | 0.063s | 0.039s | 0.102s |
| `dirtycoverage_savepoint.bak` | 0.064s | 0.036s | 0.1s |
| `dirtycoverage_snapshot_update.bak` | 0.058s | 0.033s | 0.091s |
| `dirtycoverage_switch.bak` | 0.067s | 0.031s | 0.098s |
| `dirtycoverage_temporal_update.bak` | 0.068s | 0.03s | 0.098s |
| `dirtycoverage_truncate.bak` | 0.068s | 0.036s | 0.104s |
| `dirtycoverage_two_tx.bak` | 0.064s | 0.036s | 0.1s |
| `dirtycoverage_uncommitted.bak` | 0.062s | 0.038s | 0.1s |
| `dirtycoverage_update.bak` | 0.065s | 0.03s | 0.095s |
| `filtered_ncci_full.bak` | 0.067s | 0.047s | 0.114s |
| `float_extreme_full.bak` | 0.049s | 0.038s | 0.087s |
| `forwarded_records_full.bak` | 0.245s | 0.084s | 0.329s |
| `ghost_records_full.bak` | 0.046s | 0.035s | 0.081s |
| `heapcoverage_large.bak` | 0.045s | 0.037s | 0.082s |
| `heapcoverage_large_50000.bak` | 0.215s | 0.32s | 0.535s |
| `hierarchyid_extract_full.bak` | 0.042s | 0.033s | 0.075s |
| `high_slot_density_full.bak` | 0.076s | 0.202s | 0.278s |
| `identity_coverage_full.bak` | 0.062s | 0.036s | 0.098s |
| `incrementalcoverage_diff_01.bak` | 0.048s | 0.01s | 0.058s |
| `incrementalcoverage_diff_02.bak` | 0.047s | 0.012s | 0.059s |
| `incrementalcoverage_diff_03.bak` | 0.047s | 0.01s | 0.057s |
| `incrementalcoverage_diff_04.bak` | 0.047s | 0.01s | 0.057s |
| `incrementalcoverage_diff_05.bak` | 0.045s | 0.016s | 0.061s |
| `incrementalcoverage_diff_06.bak` | 0.044s | 0.01s | 0.054s |
| `incrementalcoverage_full.bak` | 0.048s | 0.032s | 0.08s |
| `layoutcoverage_full.bak` | 0.208s | 0.372s | 0.58s |
| `max_row_width_full.bak` | 0.04s | 0.033s | 0.073s |
| `mixed_collation_full.bak` | 0.043s | 0.028s | 0.071s |
| `multi_rowgroup_full.bak` | 0.048s | 0.036s | 0.084s |
| `ncci_heap_full.bak` | 0.115s | 0.039s | 0.154s |
| `ncci_types_full.bak` | 0.12s | 0.188s | 0.308s |
| `ndfcoverage_full.bak` | 0.042s | 0.03s | 0.072s |
| `nvarchar_max_u21_full.bak` | 0.043s | 0.039s | 0.082s |
| `pagecomp_anchor_full.bak` | 0.142s | 0.089s | 0.231s |
| `pagecomp_long_prefix_full.bak` | 0.042s | 0.029s | 0.071s |
| `pfor_columnstore_full.bak` | 0.131s | 0.887s | 1.018s |
| `pfor_columnstore_random_full.bak` | 0.13s | 0.872s | 1.002s |
| `realworld_numeric_digest_full.bak` | 0.078s | 0.093s | 0.171s |
| `rowboundary_full.bak` | 0.044s | 0.041s | 0.085s |
| `rowstore_hash_pii_full.bak` | 0.042s | 0.029s | 0.071s |
| `rowstore_lob_image_full.bak` | 0.044s | 0.032s | 0.076s |
| `rowstore_lob_markup_full.bak` | 0.049s | 0.029s | 0.078s |
| `rowversion_extract_full.bak` | 0.042s | 0.031s | 0.073s |
| `sparse_full.bak` | 0.103s | 0.093s | 0.196s |
| `spatial_edge_full.bak` | 0.045s | 0.03s | 0.075s |
| `spatial_index_full.bak` | 0.109s | 0.04s | 0.149s |
| `sql_variant_extract_full.bak` | 0.044s | 0.03s | 0.074s |
| `striped_full_1.bak` | 0.047s | 0.012s | 0.059s |
| `striped_single.bak` | 0.079s | 0.045s | 0.124s |
| `surrogate_pairs_full.bak` | 0.045s | 0.029s | 0.074s |
| `tabletype_cci_large_full.bak` | 0.072s | 0.044s | 0.116s |
| `tabletypecoverage_diff.bak` | 0.121s | 0.075s | 0.196s |
| `tabletypecoverage_full.bak` | 0.204s | 0.113s | 0.317s |
| `temporal_hidden_full.bak` | 0.046s | 0.033s | 0.079s |
| `torn_page_full.bak` | 0.044s | 0.037s | 0.081s |
| `typecoverage_full.bak` | 0.127s | 0.08s | 0.207s |
| `typed_xml_full.bak` | 0.041s | 0.029s | 0.07s |
| `unicode_codepage_coverage.bak` | 0.115s | 0.043s | 0.158s |
| `xml_index_full.bak` | 0.063s | 0.032s | 0.095s |
| `xmlcoverage_full.bak` | 0.047s | 0.029s | 0.076s |
| `xmlheap_full.bak` | 0.112s | 0.061s | 0.173s |
| `xtp_checkpoint_straddle_full.bak` | 1.887s | 0.375s | 2.262s |
| `xtp_probe_full.bak` | 0.104s | 0.038s | 0.142s |
| `xtp_rich_full.bak` | 0.087s | 0.034s | 0.121s |
| `xtp_simple_full.bak` | 0.081s | 0.035s | 0.116s |
