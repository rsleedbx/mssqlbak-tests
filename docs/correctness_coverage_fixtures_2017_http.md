...
|--------|---------|--------|-----------|
| `alias_types_full.bak` | 0.04s | 0.037s | 0.077s |
| `archive_columnstore_partition_full.bak` | 0.977s | 0.648s | 1.625s |
| `archive_columnstore_types_full.bak` | 0.324s | 0.684s | 1.008s |
| `archive_columnstore_types_random_full.bak` | 0.336s | 0.685s | 1.021s |
| `archive_single_chunk_full.bak` | 0.047s | 0.032s | 0.079s |
| `archive_single_chunk_random_full.bak` | 0.046s | 0.031s | 0.077s |
| `archivenull_full.bak` | 0.129s | 0.212s | 0.341s |
| `backup_blocksize_full.bak` | 0.039s | 0.03s | 0.069s |
| `boundarycoverage_datetime_full.bak` | 0.085s | 0.154s | 0.239s |
| `boundarycoverage_full.bak` | 0.058s | 0.062s | 0.12s |
| `cci_binary_varbinary_compare_full.bak` | 0.047s | 0.034s | 0.081s |
| `cci_bitpack_probe_bigint_full.bak` | 1.266s | 3.8s | 5.066s |
| `cci_bitpack_probe_full.bak` | 0.116s | 0.647s | 0.763s |
| `cci_bitpack_probe_highbase_full.bak` | 0.096s | 0.421s | 0.517s |
| `cci_btree_nci_full.bak` | 0.049s | 0.043s | 0.092s |
| `cci_computed_full.bak` | 0.072s | 0.036s | 0.108s |
| `cci_enc5_largepool_full.bak` | 0.365s | 0.441s | 0.806s |
| `cci_enc5_largepool_matrix_full.bak` | 7.208s | 1.28s | 8.488s |
| `cci_extended_full.bak` | 0.061s | 0.046s | 0.107s |
| `cci_lob_full.bak` | 0.08s | 0.044s | 0.124s |
| `cci_reorganize_full.bak` | 0.066s | 0.041s | 0.107s |
| `cci_string_dict_regression_full.bak` | 0.32s | 0.138s | 0.458s |
| `cci_string_minmax_full.bak` | 0.056s | 0.031s | 0.087s |
| `cci_switch_full.bak` | 0.065s | 0.041s | 0.106s |
| `cci_types_large_full.bak` | 0.059s | 0.043s | 0.102s |
| `cci_varbinary_micro_full.bak` | 0.065s | 0.044s | 0.109s |
| `cci_varbinary_probe_full.bak` | 0.073s | 0.045s | 0.118s |
| `columnstore_minimal.bak` | 0.134s | 0.86s | 0.994s |
| `compressed_nvarchar_full.bak` | 0.039s | 0.029s | 0.068s |
| `compressioncoverage_full.bak` | 0.097s | 0.173s | 0.27s |
| `computedcoverage_full.bak` | 0.041s | 0.03s | 0.071s |
| `constraintcoverage_full.bak` | 0.047s | 0.034s | 0.081s |
| `covering_index_full.bak` | 0.064s | 0.034s | 0.098s |
| `cs_lob_preamble.bak` | 0.094s | 0.056s | 0.15s |
| `delta_rowgroup_full.bak` | 0.044s | 0.03s | 0.074s |
| `dirtycoverage_aborted_xact.bak` | 0.116s | 0.044s | 0.16s |
| `dirtycoverage_addcol.bak` | 0.056s | 0.029s | 0.085s |
| `dirtycoverage_addnotnull.bak` | 0.056s | 0.033s | 0.089s |
| `dirtycoverage_alldirty.bak` | 0.062s | 0.03s | 0.092s |
| `dirtycoverage_altercol.bak` | 0.041s | 0.029s | 0.07s |
| `dirtycoverage_altercol_rewrite.bak` | 0.056s | 0.03s | 0.086s |
| `dirtycoverage_alterdb.bak` | 0.056s | 0.032s | 0.088s |
| `dirtycoverage_cci_delete.bak` | 0.101s | 0.092s | 0.193s |
| `dirtycoverage_cci_update.bak` | 0.098s | 0.09s | 0.188s |
| `dirtycoverage_committed_delete.bak` | 0.041s | 0.03s | 0.071s |
| `dirtycoverage_committed_delete_v2.bak` | 0.045s | 0.031s | 0.076s |
| `dirtycoverage_committed_delete_v3.bak` | 0.063s | 0.06s | 0.123s |
| `dirtycoverage_committed_delete_v4.bak` | 0.157s | 0.065s | 0.222s |
| `dirtycoverage_committed_update.bak` | 0.042s | 0.04s | 0.082s |
| `dirtycoverage_committed_update_v2.bak` | 0.043s | 0.031s | 0.074s |
| `dirtycoverage_committed_update_v3.bak` | 0.06s | 0.066s | 0.126s |
| `dirtycoverage_committed_update_v4.bak` | 0.17s | 0.071s | 0.241s |
| `dirtycoverage_concurrent.bak` | 0.064s | 0.048s | 0.112s |
| `dirtycoverage_createidx.bak` | 0.063s | 0.055s | 0.118s |
| `dirtycoverage_createtable.bak` | 0.055s | 0.029s | 0.084s |
| `dirtycoverage_delete.bak` | 0.14s | 0.087s | 0.227s |
| `dirtycoverage_dropcol.bak` | 0.109s | 0.071s | 0.18s |
| `dirtycoverage_dropidx.bak` | 0.055s | 0.03s | 0.085s |
| `dirtycoverage_droptable.bak` | 0.117s | 0.047s | 0.164s |
| `dirtycoverage_heap_forward.bak` | 0.06s | 0.036s | 0.096s |
| `dirtycoverage_large_dirty.bak` | 0.338s | 0.038s | 0.376s |
| `dirtycoverage_lob_update.bak` | 0.081s | 0.031s | 0.112s |
| `dirtycoverage_maxrow.bak` | 0.04s | 0.028s | 0.068s |
| `dirtycoverage_nchar_delete.bak` | 0.063s | 0.037s | 0.1s |
| `dirtycoverage_nested.bak` | 0.058s | 0.034s | 0.092s |
| `dirtycoverage_null_update.bak` | 0.112s | 0.089s | 0.201s |
| `dirtycoverage_rebuildidx.bak` | 0.057s | 0.029s | 0.086s |
| `dirtycoverage_rich_insert.bak` | 0.06s | 0.032s | 0.092s |
| `dirtycoverage_rich_update.bak` | 0.113s | 0.085s | 0.198s |
| `dirtycoverage_savepoint.bak` | 0.063s | 0.045s | 0.108s |
| `dirtycoverage_snapshot_update.bak` | 0.059s | 0.028s | 0.087s |
| `dirtycoverage_switch.bak` | 0.065s | 0.039s | 0.104s |
| `dirtycoverage_temporal_update.bak` | 0.064s | 0.029s | 0.093s |
| `dirtycoverage_truncate.bak` | 0.056s | 0.034s | 0.09s |
| `dirtycoverage_two_tx.bak` | 0.062s | 0.03s | 0.092s |
| `dirtycoverage_uncommitted.bak` | 0.062s | 0.031s | 0.093s |
| `dirtycoverage_update.bak` | 0.076s | 0.068s | 0.144s |
| `filtered_ncci_full.bak` | 0.066s | 0.034s | 0.1s |
| `float_extreme_full.bak` | 0.041s | 0.03s | 0.071s |
| `forwarded_records_full.bak` | 0.238s | 0.071s | 0.309s |
| `ghost_records_full.bak` | 0.04s | 0.031s | 0.071s |
| `heapcoverage_large.bak` | 0.042s | 0.037s | 0.079s |
| `heapcoverage_large_50000.bak` | 0.201s | 0.316s | 0.517s |
| `hierarchyid_extract_full.bak` | 0.041s | 0.029s | 0.07s |
| `high_slot_density_full.bak` | 0.067s | 0.195s | 0.262s |
| `identity_coverage_full.bak` | 0.067s | 0.04s | 0.107s |
| `incrementalcoverage_diff_01.bak` | 0.048s | 0.01s | 0.058s |
| `incrementalcoverage_diff_02.bak` | 0.043s | 0.013s | 0.056s |
| `incrementalcoverage_diff_03.bak` | 0.045s | 0.014s | 0.059s |
| `incrementalcoverage_diff_04.bak` | 0.046s | 0.011s | 0.057s |
| `incrementalcoverage_diff_05.bak` | 0.041s | 0.01s | 0.051s |
| `incrementalcoverage_diff_06.bak` | 0.042s | 0.011s | 0.053s |
| `incrementalcoverage_full.bak` | 0.041s | 0.028s | 0.069s |
| `layoutcoverage_full.bak` | 0.202s | 0.344s | 0.546s |
| `max_row_width_full.bak` | 0.04s | 0.029s | 0.069s |
| `mixed_collation_full.bak` | 0.043s | 0.029s | 0.072s |
| `multi_rowgroup_full.bak` | 0.045s | 0.034s | 0.079s |
| `ncci_heap_full.bak` | 0.063s | 0.041s | 0.104s |
| `ncci_types_full.bak` | 0.115s | 0.183s | 0.298s |
| `ndfcoverage_full.bak` | 0.045s | 0.031s | 0.076s |
| `nvarchar_max_u21_full.bak` | 0.041s | 0.028s | 0.069s |
| `pagecomp_anchor_full.bak` | 0.131s | 0.088s | 0.219s |
| `pagecomp_long_prefix_full.bak` | 0.043s | 0.031s | 0.074s |
| `pfor_columnstore_full.bak` | 0.119s | 0.832s | 0.951s |
| `pfor_columnstore_random_full.bak` | 0.12s | 0.855s | 0.975s |
| `realworld_numeric_digest_full.bak` | 0.074s | 0.074s | 0.148s |
| `rowboundary_full.bak` | 0.043s | 0.032s | 0.075s |
| `rowstore_hash_pii_full.bak` | 0.041s | 0.028s | 0.069s |
| `rowstore_lob_image_full.bak` | 0.042s | 0.032s | 0.074s |
| `rowstore_lob_markup_full.bak` | 0.042s | 0.029s | 0.071s |
| `rowversion_extract_full.bak` | 0.041s | 0.033s | 0.074s |
| `sparse_full.bak` | 0.092s | 0.084s | 0.176s |
| `spatial_edge_full.bak` | 0.04s | 0.035s | 0.075s |
| `spatial_index_full.bak` | 0.079s | 0.037s | 0.116s |
| `sql_variant_extract_full.bak` | 0.042s | 0.029s | 0.071s |
| `striped_full_1.bak` | 0.06s | 0.013s | 0.073s |
| `striped_single.bak` | 0.076s | 0.04s | 0.116s |
| `surrogate_pairs_full.bak` | 0.045s | 0.027s | 0.072s |
| `tabletype_cci_large_full.bak` | 0.065s | 0.045s | 0.11s |
| `tabletypecoverage_diff.bak` | 0.109s | 0.075s | 0.184s |
| `tabletypecoverage_full.bak` | 0.192s | 0.1s | 0.292s |
| `temporal_hidden_full.bak` | 0.043s | 0.031s | 0.074s |
| `torn_page_full.bak` | 0.107s | 0.042s | 0.149s |
| `typecoverage_full.bak` | 0.121s | 0.075s | 0.196s |
| `typed_xml_full.bak` | 0.039s | 0.03s | 0.069s |
| `unicode_codepage_coverage.bak` | 0.076s | 0.044s | 0.12s |
| `xml_index_full.bak` | 0.06s | 0.039s | 0.099s |
| `xmlcoverage_full.bak` | 0.04s | 0.029s | 0.069s |
| `xmlheap_full.bak` | 0.105s | 0.059s | 0.164s |
| `xtp_checkpoint_straddle_full.bak` | 1.818s | 0.371s | 2.189s |
| `xtp_probe_full.bak` | 0.101s | 0.032s | 0.133s |
| `xtp_rich_full.bak` | 0.081s | 0.039s | 0.12s |
| `xtp_simple_full.bak` | 0.086s | 0.041s | 0.127s |
