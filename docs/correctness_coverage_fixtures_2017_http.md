...
|--------|---------|--------|-----------|
| `alias_types_full.bak` | 0.04s | 0.04s | 0.08s |
| `archive_columnstore_partition_full.bak` | 0.982s | 0.65s | 1.632s |
| `archive_columnstore_types_full.bak` | 0.337s | 0.667s | 1.004s |
| `archive_columnstore_types_random_full.bak` | 0.399s | 0.713s | 1.112s |
| `archive_single_chunk_full.bak` | 0.051s | 0.04s | 0.091s |
| `archive_single_chunk_random_full.bak` | 0.048s | 0.036s | 0.084s |
| `archivenull_full.bak` | 0.131s | 0.214s | 0.345s |
| `backup_blocksize_full.bak` | 0.041s | 0.048s | 0.089s |
| `boundarycoverage_datetime_full.bak` | 0.079s | 0.143s | 0.222s |
| `boundarycoverage_full.bak` | 0.055s | 0.062s | 0.117s |
| `cci_binary_varbinary_compare_full.bak` | 0.045s | 0.036s | 0.081s |
| `cci_bitpack_probe_bigint_full.bak` | 1.273s | 3.834s | 5.107s |
| `cci_bitpack_probe_full.bak` | 0.109s | 0.646s | 0.755s |
| `cci_bitpack_probe_highbase_full.bak` | 0.104s | 0.417s | 0.521s |
| `cci_btree_nci_full.bak` | 0.048s | 0.038s | 0.086s |
| `cci_computed_full.bak` | 0.07s | 0.041s | 0.111s |
| `cci_enc5_largepool_full.bak` | 0.36s | 0.436s | 0.796s |
| `cci_enc5_largepool_matrix_full.bak` | 7.139s | 1.273s | 8.412s |
| `cci_extended_full.bak` | 0.056s | 0.044s | 0.1s |
| `cci_lob_full.bak` | 0.077s | 0.041s | 0.118s |
| `cci_reorganize_full.bak` | 0.065s | 0.036s | 0.101s |
| `cci_string_dict_regression_full.bak` | 0.324s | 0.135s | 0.459s |
| `cci_string_minmax_full.bak` | 0.057s | 0.047s | 0.104s |
| `cci_switch_full.bak` | 0.061s | 0.039s | 0.1s |
| `cci_types_large_full.bak` | 0.06s | 0.042s | 0.102s |
| `cci_varbinary_micro_full.bak` | 0.064s | 0.038s | 0.102s |
| `cci_varbinary_probe_full.bak` | 0.066s | 0.047s | 0.113s |
| `columnstore_minimal.bak` | 0.124s | 0.972s | 1.096s |
| `compressed_nvarchar_full.bak` | 0.047s | 0.037s | 0.084s |
| `compressioncoverage_full.bak` | 0.102s | 0.181s | 0.283s |
| `computedcoverage_full.bak` | 0.045s | 0.035s | 0.08s |
| `constraintcoverage_full.bak` | 0.047s | 0.037s | 0.084s |
| `covering_index_full.bak` | 0.058s | 0.041s | 0.099s |
| `cs_lob_preamble.bak` | 0.103s | 0.06s | 0.163s |
| `delta_rowgroup_full.bak` | 0.045s | 0.04s | 0.085s |
| `dirtycoverage_aborted_xact.bak` | 0.06s | 0.035s | 0.095s |
| `dirtycoverage_addcol.bak` | 0.057s | 0.038s | 0.095s |
| `dirtycoverage_addnotnull.bak` | 0.06s | 0.034s | 0.094s |
| `dirtycoverage_alldirty.bak` | 0.064s | 0.029s | 0.093s |
| `dirtycoverage_altercol.bak` | 0.052s | 0.044s | 0.096s |
| `dirtycoverage_altercol_rewrite.bak` | 0.061s | 0.043s | 0.104s |
| `dirtycoverage_alterdb.bak` | 0.074s | 0.037s | 0.111s |
| `dirtycoverage_cci_delete.bak` | 0.098s | 0.095s | 0.193s |
| `dirtycoverage_cci_update.bak` | 0.096s | 0.096s | 0.192s |
| `dirtycoverage_committed_delete.bak` | 0.047s | 0.043s | 0.09s |
| `dirtycoverage_committed_delete_v2.bak` | 0.048s | 0.042s | 0.09s |
| `dirtycoverage_committed_delete_v3.bak` | 0.05s | 0.057s | 0.107s |
| `dirtycoverage_committed_delete_v4.bak` | 0.166s | 0.07s | 0.236s |
| `dirtycoverage_committed_update.bak` | 0.07s | 0.069s | 0.139s |
| `dirtycoverage_committed_update_v2.bak` | 0.055s | 0.045s | 0.1s |
| `dirtycoverage_committed_update_v3.bak` | 0.053s | 0.068s | 0.121s |
| `dirtycoverage_committed_update_v4.bak` | 0.172s | 0.08s | 0.252s |
| `dirtycoverage_concurrent.bak` | 0.058s | 0.034s | 0.092s |
| `dirtycoverage_createidx.bak` | 0.055s | 0.032s | 0.087s |
| `dirtycoverage_createtable.bak` | 0.055s | 0.033s | 0.088s |
| `dirtycoverage_delete.bak` | 0.059s | 0.033s | 0.092s |
| `dirtycoverage_dropcol.bak` | 0.058s | 0.033s | 0.091s |
| `dirtycoverage_dropidx.bak` | 0.063s | 0.041s | 0.104s |
| `dirtycoverage_droptable.bak` | 0.06s | 0.038s | 0.098s |
| `dirtycoverage_heap_forward.bak` | 0.068s | 0.032s | 0.1s |
| `dirtycoverage_large_dirty.bak` | 0.332s | 0.035s | 0.367s |
| `dirtycoverage_lob_update.bak` | 0.08s | 0.033s | 0.113s |
| `dirtycoverage_maxrow.bak` | 0.044s | 0.037s | 0.081s |
| `dirtycoverage_nchar_delete.bak` | 0.058s | 0.034s | 0.092s |
| `dirtycoverage_nested.bak` | 0.063s | 0.042s | 0.105s |
| `dirtycoverage_null_update.bak` | 0.06s | 0.042s | 0.102s |
| `dirtycoverage_rebuildidx.bak` | 0.06s | 0.032s | 0.092s |
| `dirtycoverage_rich_insert.bak` | 0.06s | 0.036s | 0.096s |
| `dirtycoverage_rich_update.bak` | 0.058s | 0.033s | 0.091s |
| `dirtycoverage_savepoint.bak` | 0.061s | 0.033s | 0.094s |
| `dirtycoverage_snapshot_update.bak` | 0.056s | 0.032s | 0.088s |
| `dirtycoverage_switch.bak` | 0.066s | 0.036s | 0.102s |
| `dirtycoverage_temporal_update.bak` | 0.072s | 0.036s | 0.108s |
| `dirtycoverage_truncate.bak` | 0.06s | 0.035s | 0.095s |
| `dirtycoverage_two_tx.bak` | 0.06s | 0.033s | 0.093s |
| `dirtycoverage_uncommitted.bak` | 0.059s | 0.035s | 0.094s |
| `dirtycoverage_update.bak` | 0.061s | 0.034s | 0.095s |
| `filtered_ncci_full.bak` | 0.062s | 0.041s | 0.103s |
| `float_extreme_full.bak` | 0.047s | 0.044s | 0.091s |
| `forwarded_records_full.bak` | 0.245s | 0.074s | 0.319s |
| `ghost_records_full.bak` | 0.048s | 0.042s | 0.09s |
| `heapcoverage_large.bak` | 0.045s | 0.043s | 0.088s |
| `heapcoverage_large_50000.bak` | 0.198s | 0.315s | 0.513s |
| `hierarchyid_extract_full.bak` | 0.05s | 0.04s | 0.09s |
| `high_slot_density_full.bak` | 0.067s | 0.189s | 0.256s |
| `identity_coverage_full.bak` | 0.063s | 0.037s | 0.1s |
| `incrementalcoverage_diff_01.bak` | 0.044s | 0.012s | 0.056s |
| `incrementalcoverage_diff_02.bak` | 0.043s | 0.016s | 0.059s |
| `incrementalcoverage_diff_03.bak` | 0.044s | 0.017s | 0.061s |
| `incrementalcoverage_diff_04.bak` | 0.044s | 0.019s | 0.063s |
| `incrementalcoverage_diff_05.bak` | 0.042s | 0.011s | 0.053s |
| `incrementalcoverage_diff_06.bak` | 0.04s | 0.024s | 0.064s |
| `incrementalcoverage_full.bak` | 0.052s | 0.039s | 0.091s |
| `layoutcoverage_full.bak` | 0.203s | 0.303s | 0.506s |
| `max_row_width_full.bak` | 0.068s | 0.071s | 0.139s |
| `mixed_collation_full.bak` | 0.044s | 0.038s | 0.082s |
| `multi_rowgroup_full.bak` | 0.054s | 0.048s | 0.102s |
| `ncci_heap_full.bak` | 0.061s | 0.036s | 0.097s |
| `ncci_types_full.bak` | 0.114s | 0.187s | 0.301s |
| `ndfcoverage_full.bak` | 0.042s | 0.041s | 0.083s |
| `nvarchar_max_u21_full.bak` | 0.048s | 0.034s | 0.082s |
| `pagecomp_anchor_full.bak` | 0.134s | 0.092s | 0.226s |
| `pagecomp_long_prefix_full.bak` | 0.047s | 0.035s | 0.082s |
| `pfor_columnstore_full.bak` | 0.122s | 0.841s | 0.963s |
| `pfor_columnstore_random_full.bak` | 0.121s | 0.822s | 0.943s |
| `realworld_numeric_digest_full.bak` | 0.073s | 0.082s | 0.155s |
| `rowboundary_full.bak` | 0.052s | 0.048s | 0.1s |
| `rowstore_hash_pii_full.bak` | 0.052s | 0.036s | 0.088s |
| `rowstore_lob_image_full.bak` | 0.073s | 0.066s | 0.139s |
| `rowstore_lob_markup_full.bak` | 0.046s | 0.039s | 0.085s |
| `rowversion_extract_full.bak` | 0.044s | 0.04s | 0.084s |
| `sparse_full.bak` | 0.096s | 0.088s | 0.184s |
| `spatial_edge_full.bak` | 0.072s | 0.07s | 0.142s |
| `spatial_index_full.bak` | 0.06s | 0.039s | 0.099s |
| `sql_variant_extract_full.bak` | 0.049s | 0.042s | 0.091s |
| `striped_full_1.bak` | 0.048s | 0.022s | 0.07s |
| `striped_single.bak` | 0.076s | 0.044s | 0.12s |
| `surrogate_pairs_full.bak` | 0.043s | 0.037s | 0.08s |
| `tabletype_cci_large_full.bak` | 0.067s | 0.046s | 0.113s |
| `tabletypecoverage_diff.bak` | 0.104s | 0.065s | 0.169s |
| `tabletypecoverage_full.bak` | 0.193s | 0.101s | 0.294s |
| `temporal_hidden_full.bak` | 0.048s | 0.041s | 0.089s |
| `torn_page_full.bak` | 0.043s | 0.038s | 0.081s |
| `typecoverage_full.bak` | 0.114s | 0.071s | 0.185s |
| `typed_xml_full.bak` | 0.045s | 0.038s | 0.083s |
| `unicode_codepage_coverage.bak` | 0.102s | 0.049s | 0.151s |
| `xml_index_full.bak` | 0.057s | 0.048s | 0.105s |
| `xmlcoverage_full.bak` | 0.046s | 0.039s | 0.085s |
| `xmlheap_full.bak` | 0.101s | 0.055s | 0.156s |
| `xtp_checkpoint_straddle_full.bak` | 1.884s | 0.371s | 2.255s |
| `xtp_probe_full.bak` | 0.097s | 0.039s | 0.136s |
| `xtp_rich_full.bak` | 0.081s | 0.04s | 0.121s |
| `xtp_simple_full.bak` | 0.082s | 0.038s | 0.12s |
...
_Generated 2026-07-11 · 133 fixtures · 133 pass · 0 xfail · 0 fail_
