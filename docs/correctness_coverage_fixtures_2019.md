...
|--------|---------|--------|-----------|
| `alias_types_full.bak` | 0.03s | 0.033s | 0.063s |
| `archive_columnstore_partition_full.bak` | 0.89s | 0.632s | 1.522s |
| `archive_columnstore_types_full.bak` | 0.341s | 0.766s | 1.107s |
| `archive_columnstore_types_random_full.bak` | 0.321s | 0.738s | 1.059s |
| `archive_single_chunk_full.bak` | 0.04s | 0.034s | 0.074s |
| `archive_single_chunk_random_full.bak` | 0.034s | 0.038s | 0.072s |
| `archivenull_full.bak` | 0.13s | 0.082s | 0.212s |
| `backup_blocksize_full.bak` | 0.033s | 0.031s | 0.064s |
| `boundarycoverage_datetime_full.bak` | 0.056s | 0.144s | 0.2s |
| `boundarycoverage_full.bak` | 0.051s | 0.068s | 0.119s |
| `catalog_ss2019.bak` | 0.029s | 0.032s | 0.061s |
| `cci_binary_varbinary_compare_full.bak` | 0.042s | 0.04s | 0.082s |
| `cci_bitpack_probe_bigint_full.bak` | 0.679s | 3.86s | 4.539s |
| `cci_bitpack_probe_full.bak` | 0.073s | 0.715s | 0.788s |
| `cci_bitpack_probe_highbase_full.bak` | 0.085s | 0.454s | 0.539s |
| `cci_btree_nci_full.bak` | 0.044s | 0.039s | 0.083s |
| `cci_computed_full.bak` | 0.039s | 0.041s | 0.08s |
| `cci_enc5_largepool_full.bak` | 0.309s | 0.429s | 0.738s |
| `cci_enc5_largepool_matrix_full.bak` | 7.201s | 1.315s | 8.516s |
| `cci_extended_full.bak` | 0.048s | 0.044s | 0.092s |
| `cci_lob_full.bak` | 0.044s | 0.044s | 0.088s |
| `cci_reorganize_full.bak` | 0.041s | 0.039s | 0.08s |
| `cci_string_dict_regression_full.bak` | 0.283s | 0.127s | 0.41s |
| `cci_string_minmax_full.bak` | 0.055s | 0.041s | 0.096s |
| `cci_switch_full.bak` | 0.041s | 0.038s | 0.079s |
| `cci_types_large_full.bak` | 0.042s | 0.04s | 0.082s |
| `cci_varbinary_micro_full.bak` | 0.036s | 0.037s | 0.073s |
| `cci_varbinary_probe_full.bak` | 0.042s | 0.048s | 0.09s |
| `columnstore_minimal.bak` | 0.117s | 0.892s | 1.009s |
| `compressed_nvarchar_full.bak` | 0.029s | 0.031s | 0.06s |
| `compressioncoverage_full.bak` | 0.085s | 0.194s | 0.279s |
| `computedcoverage_full.bak` | 0.035s | 0.036s | 0.071s |
| `constraintcoverage_full.bak` | 0.041s | 0.037s | 0.078s |
| `covering_index_full.bak` | 0.042s | 0.041s | 0.083s |
| `cs_lob_preamble.bak` | 0.067s | 0.06s | 0.127s |
| `delta_rowgroup_full.bak` | 0.038s | 0.033s | 0.071s |
| `dirtycoverage_aborted_xact.bak` | 0.057s | 0.031s | 0.088s |
| `dirtycoverage_addcol.bak` | 0.041s | 0.041s | 0.082s |
| `dirtycoverage_addnotnull.bak` | 0.049s | 0.038s | 0.087s |
| `dirtycoverage_alldirty.bak` | 0.056s | 0.029s | 0.085s |
| `dirtycoverage_altercol.bak` | 0.045s | 0.037s | 0.082s |
| `dirtycoverage_altercol_rewrite.bak` | 0.033s | 0.03s | 0.063s |
| `dirtycoverage_alterdb.bak` | 0.035s | 0.032s | 0.067s |
| `dirtycoverage_cci_delete.bak` | 0.085s | 0.085s | 0.17s |
| `dirtycoverage_cci_update.bak` | 0.198s | 0.085s | 0.283s |
| `dirtycoverage_committed_delete.bak` | 0.03s | 0.039s | 0.069s |
| `dirtycoverage_committed_delete_v2.bak` | 0.036s | 0.033s | 0.069s |
| `dirtycoverage_committed_delete_v3.bak` | 0.04s | 0.055s | 0.095s |
| `dirtycoverage_committed_delete_v4.bak` | 0.147s | 0.059s | 0.206s |
| `dirtycoverage_committed_update.bak` | 0.036s | 0.032s | 0.068s |
| `dirtycoverage_committed_update_v2.bak` | 0.041s | 0.041s | 0.082s |
| `dirtycoverage_committed_update_v3.bak` | 0.044s | 0.075s | 0.119s |
| `dirtycoverage_committed_update_v4.bak` | 0.15s | 0.067s | 0.217s |
| `dirtycoverage_concurrent.bak` | 0.042s | 0.036s | 0.078s |
| `dirtycoverage_createidx.bak` | 0.034s | 0.031s | 0.065s |
| `dirtycoverage_createtable.bak` | 0.032s | 0.029s | 0.061s |
| `dirtycoverage_delete.bak` | 0.054s | 0.029s | 0.083s |
| `dirtycoverage_dropcol.bak` | 0.032s | 0.031s | 0.063s |
| `dirtycoverage_dropidx.bak` | 0.034s | 0.033s | 0.067s |
| `dirtycoverage_droptable.bak` | 0.034s | 0.035s | 0.069s |
| `dirtycoverage_heap_forward.bak` | 0.053s | 0.031s | 0.084s |
| `dirtycoverage_large_dirty.bak` | 0.354s | 0.03s | 0.384s |
| `dirtycoverage_lob_update.bak` | 0.078s | 0.033s | 0.111s |
| `dirtycoverage_maxrow.bak` | 0.034s | 0.029s | 0.063s |
| `dirtycoverage_nchar_delete.bak` | 0.059s | 0.031s | 0.09s |
| `dirtycoverage_nested.bak` | 0.063s | 0.034s | 0.097s |
| `dirtycoverage_null_update.bak` | 0.055s | 0.029s | 0.084s |
| `dirtycoverage_rebuildidx.bak` | 0.033s | 0.031s | 0.064s |
| `dirtycoverage_rich_insert.bak` | 0.056s | 0.032s | 0.088s |
| `dirtycoverage_rich_update.bak` | 0.053s | 0.031s | 0.084s |
| `dirtycoverage_savepoint.bak` | 0.056s | 0.031s | 0.087s |
| `dirtycoverage_snapshot_update.bak` | 0.058s | 0.032s | 0.09s |
| `dirtycoverage_switch.bak` | 0.037s | 0.034s | 0.071s |
| `dirtycoverage_temporal_update.bak` | 0.057s | 0.03s | 0.087s |
| `dirtycoverage_truncate.bak` | 0.036s | 0.035s | 0.071s |
| `dirtycoverage_two_tx.bak` | 0.061s | 0.03s | 0.091s |
| `dirtycoverage_uncommitted.bak` | 0.058s | 0.03s | 0.088s |
| `dirtycoverage_update.bak` | 0.06s | 0.041s | 0.101s |
| `filtered_ncci_full.bak` | 0.04s | 0.034s | 0.074s |
| `float_extreme_full.bak` | 0.042s | 0.033s | 0.075s |
| `forwarded_records_full.bak` | 0.075s | 0.071s | 0.146s |
| `ghost_records_full.bak` | 0.03s | 0.045s | 0.075s |
| `heapcoverage_large.bak` | 0.044s | 0.044s | 0.088s |
| `heapcoverage_large_50000.bak` | 0.079s | 0.314s | 0.393s |
| `hierarchyid_extract_full.bak` | 0.032s | 0.032s | 0.064s |
| `high_slot_density_full.bak` | 0.042s | 0.191s | 0.233s |
| `identity_coverage_full.bak` | 0.039s | 0.039s | 0.078s |
| `incrementalcoverage_diff_01.bak` | 0.035s | 0.011s | 0.046s |
| `incrementalcoverage_diff_02.bak` | 0.046s | 0.012s | 0.058s |
| `incrementalcoverage_diff_03.bak` | 0.04s | 0.013s | 0.053s |
| `incrementalcoverage_diff_04.bak` | 0.034s | 0.011s | 0.045s |
| `incrementalcoverage_diff_05.bak` | 0.035s | 0.011s | 0.046s |
| `incrementalcoverage_diff_06.bak` | 0.047s | 0.011s | 0.058s |
| `incrementalcoverage_full.bak` | 0.03s | 0.026s | 0.056s |
| `layoutcoverage_full.bak` | 0.119s | 0.334s | 0.453s |
| `max_row_width_full.bak` | 0.032s | 0.037s | 0.069s |
| `mixed_collation_full.bak` | 0.03s | 0.031s | 0.061s |
| `multi_rowgroup_full.bak` | 0.042s | 0.041s | 0.083s |
| `ncci_heap_full.bak` | 0.04s | 0.032s | 0.072s |
| `ncci_types_full.bak` | 0.061s | 0.179s | 0.24s |
| `ndfcoverage_full.bak` | 0.032s | 0.035s | 0.067s |
| `nvarchar_max_u21_full.bak` | 0.033s | 0.031s | 0.064s |
| `pagecomp_anchor_full.bak` | 0.125s | 0.088s | 0.213s |
| `pagecomp_long_prefix_full.bak` | 0.029s | 0.044s | 0.073s |
| `pfor_columnstore_full.bak` | 0.102s | 0.8s | 0.902s |
| `pfor_columnstore_random_full.bak` | 0.092s | 0.836s | 0.928s |
| `realworld_numeric_digest_full.bak` | 0.048s | 0.088s | 0.136s |
| `rowboundary_full.bak` | 0.035s | 0.039s | 0.074s |
| `rowstore_hash_pii_full.bak` | 0.031s | 0.031s | 0.062s |
| `rowstore_lob_image_full.bak` | 0.033s | 0.033s | 0.066s |
| `rowstore_lob_markup_full.bak` | 0.038s | 0.036s | 0.074s |
| `rowversion_extract_full.bak` | 0.037s | 0.031s | 0.068s |
| `sparse_full.bak` | 0.091s | 0.089s | 0.18s |
| `spatial_edge_full.bak` | 0.036s | 0.035s | 0.071s |
| `spatial_index_full.bak` | 0.035s | 0.034s | 0.069s |
| `sql_variant_extract_full.bak` | 0.044s | 0.037s | 0.081s |
| `striped_full_1.bak` | 0.047s | 0.016s | 0.063s |
| `striped_single.bak` | 0.045s | 0.046s | 0.091s |
| `surrogate_pairs_full.bak` | 0.029s | 0.031s | 0.06s |
| `tabletype_cci_large_full.bak` | 0.048s | 0.054s | 0.102s |
| `tabletypecoverage_diff.bak` | 0.116s | 0.074s | 0.19s |
| `tabletypecoverage_full.bak` | 0.077s | 0.089s | 0.166s |
| `temporal_hidden_full.bak` | 0.031s | 0.035s | 0.066s |
| `torn_page_full.bak` | 0.043s | 0.036s | 0.079s |
| `typecoverage_full.bak` | 0.071s | 0.066s | 0.137s |
| `typed_xml_full.bak` | 0.034s | 0.031s | 0.065s |
| `unicode_codepage_coverage.bak` | 0.051s | 0.042s | 0.093s |
| `utf8_collation_full.bak` | 0.036s | 0.035s | 0.071s |
| `xml_index_full.bak` | 0.038s | 0.041s | 0.079s |
| `xmlcoverage_full.bak` | 0.03s | 0.031s | 0.061s |
| `xmlheap_full.bak` | 0.047s | 0.051s | 0.098s |
