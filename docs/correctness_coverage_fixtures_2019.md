...
| `archive_columnstore_partition_full.bak` | 2.513s |
| `archive_columnstore_types_full.bak` | 1.313s |
| `archive_columnstore_types_random_full.bak` | 1.332s |
| `archive_single_chunk_full.bak` | 0.117s |
| `archive_single_chunk_random_full.bak` | 0.099s |
| `archivenull_full.bak` | 0.275s |
| `backup_blocksize_full.bak` | 0.089s |
| `boundarycoverage_datetime_full.bak` | 0.387s |
| `boundarycoverage_full.bak` | 0.174s |
| `catalog_ss2019.bak` | 0.084s |
| `cci_binary_varbinary_compare_full.bak` | 0.094s |
| `cci_bitpack_probe_bigint_full.bak` | 6.04s |
| `cci_bitpack_probe_full.bak` | 0.702s |
| `cci_bitpack_probe_highbase_full.bak` | 0.66s |
| `cci_btree_nci_full.bak` | 0.097s |
| `cci_computed_full.bak` | 0.116s |
| `cci_enc5_largepool_full.bak` | 1.152s |
| `cci_enc5_largepool_matrix_full.bak` | 9.599s |
| `cci_extended_full.bak` | 0.287s |
| `cci_lob_full.bak` | 0.166s |
| `cci_reorganize_full.bak` | 0.108s |
| `cci_string_dict_regression_full.bak` | 0.513s |
| `cci_string_minmax_full.bak` | 0.117s |
| `cci_switch_full.bak` | 0.104s |
| `cci_types_large_full.bak` | 0.145s |
| `cci_varbinary_micro_full.bak` | 0.116s |
| `cci_varbinary_probe_full.bak` | 0.102s |
| `columnstore_minimal.bak` | 1.014s |
| `compressed_nvarchar_full.bak` | 0.087s |
| `compressioncoverage_full.bak` | 0.338s |
| `computedcoverage_full.bak` | 0.088s |
| `constraintcoverage_full.bak` | 0.111s |
| `covering_index_full.bak` | 0.197s |
| `cs_lob_preamble.bak` | 0.19s |
| `delta_rowgroup_full.bak` | 0.124s |
| `dirtycoverage_aborted_xact.bak` | 0.118s |
| `dirtycoverage_addcol.bak` | 0.126s |
| `dirtycoverage_addnotnull.bak` | 0.184s |
| `dirtycoverage_alldirty.bak` | 0.196s |
| `dirtycoverage_altercol.bak` | 0.082s |
| `dirtycoverage_altercol_rewrite.bak` | 0.081s |
| `dirtycoverage_alterdb.bak` | 0.076s |
| `dirtycoverage_cci_delete.bak` | 0.2s |
| `dirtycoverage_cci_update.bak` | 0.315s |
| `dirtycoverage_committed_delete.bak` | 0.081s |
| `dirtycoverage_committed_delete_v2.bak` | 0.104s |
| `dirtycoverage_committed_delete_v3.bak` | 0.307s |
| `dirtycoverage_committed_delete_v4.bak` | 0.325s |
| `dirtycoverage_committed_update.bak` | 0.121s |
| `dirtycoverage_committed_update_v2.bak` | 0.129s |
| `dirtycoverage_committed_update_v3.bak` | 0.148s |
| `dirtycoverage_committed_update_v4.bak` | 0.38s |
| `dirtycoverage_concurrent.bak` | 0.22s |
| `dirtycoverage_createidx.bak` | 0.078s |
| `dirtycoverage_createtable.bak` | 0.093s |
| `dirtycoverage_delete.bak` | 0.127s |
| `dirtycoverage_dropcol.bak` | 0.079s |
| `dirtycoverage_dropidx.bak` | 0.078s |
| `dirtycoverage_droptable.bak` | 0.096s |
| `dirtycoverage_heap_forward.bak` | 0.114s |
| `dirtycoverage_large_dirty.bak` | 0.395s |
| `dirtycoverage_lob_update.bak` | 0.196s |
| `dirtycoverage_maxrow.bak` | 0.136s |
| `dirtycoverage_nchar_delete.bak` | 0.121s |
| `dirtycoverage_nested.bak` | 0.106s |
| `dirtycoverage_null_update.bak` | 0.121s |
| `dirtycoverage_rebuildidx.bak` | 0.085s |
| `dirtycoverage_rich_insert.bak` | 0.105s |
| `dirtycoverage_rich_update.bak` | 0.13s |
| `dirtycoverage_savepoint.bak` | 0.122s |
| `dirtycoverage_snapshot_update.bak` | 0.128s |
| `dirtycoverage_switch.bak` | 0.11s |
| `dirtycoverage_temporal_update.bak` | 0.118s |
| `dirtycoverage_truncate.bak` | 0.087s |
| `dirtycoverage_two_tx.bak` | 0.13s |
| `dirtycoverage_uncommitted.bak` | 0.101s |
| `dirtycoverage_update.bak` | 0.108s |
| `filtered_ncci_full.bak` | 0.101s |
| `float_extreme_full.bak` | 0.079s |
| `forwarded_records_full.bak` | 0.244s |
| `ghost_records_full.bak` | 0.09s |
| `heapcoverage_large.bak` | 0.12s |
| `heapcoverage_large_50000.bak` | 0.941s |
| `hierarchyid_extract_full.bak` | 0.084s |
| `high_slot_density_full.bak` | 0.582s |
| `incrementalcoverage_diff_01.bak` | 0.061s |
| `incrementalcoverage_diff_02.bak` | 0.091s |
| `incrementalcoverage_diff_03.bak` | 0.063s |
| `incrementalcoverage_diff_04.bak` | 0.05s |
| `incrementalcoverage_diff_05.bak` | 0.058s |
| `incrementalcoverage_diff_06.bak` | 0.061s |
| `incrementalcoverage_full.bak` | 0.071s |
| `layoutcoverage_full.bak` | 0.374s |
| `max_row_width_full.bak` | 0.078s |
| `mixed_collation_full.bak` | 0.074s |
| `multi_rowgroup_full.bak` | 0.124s |
| `ncci_heap_full.bak` | 0.082s |
| `ncci_types_full.bak` | 0.487s |
| `ndfcoverage_full.bak` | 0.085s |
| `nvarchar_max_u21_full.bak` | 0.083s |
| `pagecomp_anchor_full.bak` | 0.36s |
| `pagecomp_long_prefix_full.bak` | 0.08s |
| `pfor_columnstore_full.bak` | 2.254s |
| `pfor_columnstore_random_full.bak` | 2.395s |
| `realworld_numeric_digest_full.bak` | 0.183s |
| `rowboundary_full.bak` | 0.086s |
| `rowstore_hash_pii_full.bak` | 0.072s |
| `rowstore_lob_image_full.bak` | 0.103s |
| `rowstore_lob_markup_full.bak` | 0.083s |
| `rowversion_extract_full.bak` | 0.181s |
| `sparse_full.bak` | 0.29s |
| `spatial_edge_full.bak` | 0.085s |
| `spatial_index_full.bak` | 0.091s |
| `sql_variant_extract_full.bak` | 0.101s |
| `striped_full_1.bak` | 0.076s |
| `striped_single.bak` | 0.124s |
| `surrogate_pairs_full.bak` | 0.089s |
| `tabletype_cci_large_full.bak` | 0.344s |
| `tabletypecoverage_diff.bak` | 18.813s |
| `tabletypecoverage_full.bak` | 15.48s |
| `temporal_hidden_full.bak` | 0.099s |
| `torn_page_full.bak` | 0.079s |
| `typecoverage_full.bak` | 0.289s |
| `typed_xml_full.bak` | 0.086s |
| `unicode_codepage_coverage.bak` | 0.126s |
| `utf8_collation_full.bak` | 0.089s |
| `xml_index_full.bak` | 0.149s |
| `xmlcoverage_full.bak` | 0.073s |
| `xmlheap_full.bak` | 0.268s |
