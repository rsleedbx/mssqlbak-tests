...
|--------|---------|--------|-----------|
| `alias_types_full.bak` | 0.032s | 0.036s | 0.068s |
| `archive_columnstore_partition_full.bak` | 0.858s | 0.595s | 1.453s |
| `archive_columnstore_types_full.bak` | 0.316s | 0.718s | 1.034s |
| `archive_columnstore_types_random_full.bak` | 0.302s | 0.676s | 0.978s |
| `archive_single_chunk_full.bak` | 0.045s | 0.033s | 0.078s |
| `archive_single_chunk_random_full.bak` | 0.041s | 0.035s | 0.076s |
| `archivenull_full.bak` | 0.116s | 0.079s | 0.195s |
| `backup_blocksize_full.bak` | 0.035s | 0.031s | 0.066s |
| `boundarycoverage_datetime_full.bak` | 0.05s | 0.146s | 0.196s |
| `boundarycoverage_full.bak` | 0.043s | 0.052s | 0.095s |
| `catalog_ss2019.bak` | 0.03s | 0.029s | 0.059s |
| `cci_binary_varbinary_compare_full.bak` | 0.032s | 0.032s | 0.064s |
| `cci_bitpack_probe_bigint_full.bak` | 0.647s | 3.681s | 4.328s |
| `cci_bitpack_probe_full.bak` | 0.071s | 0.652s | 0.723s |
| `cci_bitpack_probe_highbase_full.bak` | 0.068s | 0.411s | 0.479s |
| `cci_btree_nci_full.bak` | 0.038s | 0.028s | 0.066s |
| `cci_computed_full.bak` | 0.033s | 0.028s | 0.061s |
| `cci_enc5_largepool_full.bak` | 0.322s | 0.415s | 0.737s |
| `cci_enc5_largepool_matrix_full.bak` | 7.095s | 1.239s | 8.334s |
| `cci_extended_full.bak` | 0.053s | 0.037s | 0.09s |
| `cci_lob_full.bak` | 0.041s | 0.03s | 0.071s |
| `cci_reorganize_full.bak` | 0.04s | 0.028s | 0.068s |
| `cci_string_dict_regression_full.bak` | 0.285s | 0.126s | 0.411s |
| `cci_string_minmax_full.bak` | 0.044s | 0.03s | 0.074s |
| `cci_switch_full.bak` | 0.034s | 0.028s | 0.062s |
| `cci_types_large_full.bak` | 0.042s | 0.032s | 0.074s |
| `cci_varbinary_micro_full.bak` | 0.047s | 0.03s | 0.077s |
| `cci_varbinary_probe_full.bak` | 0.037s | 0.036s | 0.073s |
| `columnstore_minimal.bak` | 0.106s | 1.012s | 1.118s |
| `compressed_nvarchar_full.bak` | 0.028s | 0.036s | 0.064s |
| `compressioncoverage_full.bak` | 0.1s | 0.264s | 0.364s |
| `computedcoverage_full.bak` | 0.036s | 0.03s | 0.066s |
| `constraintcoverage_full.bak` | 0.036s | 0.032s | 0.068s |
| `covering_index_full.bak` | 0.032s | 0.03s | 0.062s |
| `cs_lob_preamble.bak` | 0.068s | 0.054s | 0.122s |
| `delta_rowgroup_full.bak` | 0.042s | 0.029s | 0.071s |
| `dirtycoverage_aborted_xact.bak` | 0.053s | 0.026s | 0.079s |
| `dirtycoverage_addcol.bak` | 0.036s | 0.025s | 0.061s |
| `dirtycoverage_addnotnull.bak` | 0.035s | 0.026s | 0.061s |
| `dirtycoverage_alldirty.bak` | 0.057s | 0.025s | 0.082s |
| `dirtycoverage_altercol.bak` | 0.03s | 0.026s | 0.056s |
| `dirtycoverage_altercol_rewrite.bak` | 0.035s | 0.033s | 0.068s |
| `dirtycoverage_alterdb.bak` | 0.042s | 0.025s | 0.067s |
| `dirtycoverage_cci_delete.bak` | 0.088s | 0.077s | 0.165s |
| `dirtycoverage_cci_update.bak` | 0.259s | 0.105s | 0.364s |
| `dirtycoverage_committed_delete.bak` | 0.034s | 0.026s | 0.06s |
| `dirtycoverage_committed_delete_v2.bak` | 0.032s | 0.026s | 0.058s |
| `dirtycoverage_committed_delete_v3.bak` | 0.048s | 0.05s | 0.098s |
| `dirtycoverage_committed_delete_v4.bak` | 0.142s | 0.059s | 0.201s |
| `dirtycoverage_committed_update.bak` | 0.03s | 0.025s | 0.055s |
| `dirtycoverage_committed_update_v2.bak` | 0.032s | 0.027s | 0.059s |
| `dirtycoverage_committed_update_v3.bak` | 0.045s | 0.056s | 0.101s |
| `dirtycoverage_committed_update_v4.bak` | 0.159s | 0.064s | 0.223s |
| `dirtycoverage_concurrent.bak` | 0.033s | 0.025s | 0.058s |
| `dirtycoverage_createidx.bak` | 0.032s | 0.025s | 0.057s |
| `dirtycoverage_createtable.bak` | 0.033s | 0.037s | 0.07s |
| `dirtycoverage_delete.bak` | 0.053s | 0.025s | 0.078s |
| `dirtycoverage_dropcol.bak` | 0.032s | 0.034s | 0.066s |
| `dirtycoverage_dropidx.bak` | 0.036s | 0.026s | 0.062s |
| `dirtycoverage_droptable.bak` | 0.033s | 0.026s | 0.059s |
| `dirtycoverage_heap_forward.bak` | 0.057s | 0.025s | 0.082s |
| `dirtycoverage_large_dirty.bak` | 0.424s | 0.029s | 0.453s |
| `dirtycoverage_lob_update.bak` | 0.075s | 0.025s | 0.1s |
| `dirtycoverage_maxrow.bak` | 0.029s | 0.032s | 0.061s |
| `dirtycoverage_nchar_delete.bak` | 0.056s | 0.024s | 0.08s |
| `dirtycoverage_nested.bak` | 0.057s | 0.025s | 0.082s |
| `dirtycoverage_null_update.bak` | 0.052s | 0.03s | 0.082s |
| `dirtycoverage_rebuildidx.bak` | 0.034s | 0.03s | 0.064s |
| `dirtycoverage_rich_insert.bak` | 0.054s | 0.03s | 0.084s |
| `dirtycoverage_rich_update.bak` | 0.059s | 0.027s | 0.086s |
| `dirtycoverage_savepoint.bak` | 0.059s | 0.024s | 0.083s |
| `dirtycoverage_snapshot_update.bak` | 0.051s | 0.025s | 0.076s |
| `dirtycoverage_switch.bak` | 0.042s | 0.036s | 0.078s |
| `dirtycoverage_temporal_update.bak` | 0.056s | 0.025s | 0.081s |
| `dirtycoverage_truncate.bak` | 0.037s | 0.033s | 0.07s |
| `dirtycoverage_two_tx.bak` | 0.06s | 0.029s | 0.089s |
| `dirtycoverage_uncommitted.bak` | 0.054s | 0.026s | 0.08s |
| `dirtycoverage_update.bak` | 0.066s | 0.026s | 0.092s |
| `filtered_ncci_full.bak` | 0.038s | 0.036s | 0.074s |
| `float_extreme_full.bak` | 0.033s | 0.026s | 0.059s |
| `forwarded_records_full.bak` | 0.075s | 0.044s | 0.119s |
| `ghost_records_full.bak` | 0.029s | 0.026s | 0.055s |
| `heapcoverage_large.bak` | 0.036s | 0.031s | 0.067s |
| `heapcoverage_large_50000.bak` | 0.081s | 0.338s | 0.419s |
| `hierarchyid_extract_full.bak` | 0.042s | 0.029s | 0.071s |
| `high_slot_density_full.bak` | 0.048s | 0.186s | 0.234s |
| `identity_coverage_full.bak` | 0.034s | 0.028s | 0.062s |
| `incrementalcoverage_diff_01.bak` | 0.034s | 0.01s | 0.044s |
| `incrementalcoverage_diff_02.bak` | 0.044s | 0.014s | 0.058s |
| `incrementalcoverage_diff_03.bak` | 0.036s | 0.011s | 0.047s |
| `incrementalcoverage_diff_04.bak` | 0.034s | 0.01s | 0.044s |
| `incrementalcoverage_diff_05.bak` | 0.038s | 0.01s | 0.048s |
| `incrementalcoverage_diff_06.bak` | 0.045s | 0.011s | 0.056s |
| `incrementalcoverage_full.bak` | 0.028s | 0.027s | 0.055s |
| `layoutcoverage_full.bak` | 0.127s | 0.343s | 0.47s |
| `max_row_width_full.bak` | 0.028s | 0.025s | 0.053s |
| `mixed_collation_full.bak` | 0.03s | 0.031s | 0.061s |
| `multi_rowgroup_full.bak` | 0.035s | 0.029s | 0.064s |
| `ncci_heap_full.bak` | 0.046s | 0.032s | 0.078s |
| `ncci_types_full.bak` | 0.059s | 0.176s | 0.235s |
| `ndfcoverage_full.bak` | 0.032s | 0.026s | 0.058s |
| `nvarchar_max_u21_full.bak` | 0.035s | 0.035s | 0.07s |
| `pagecomp_anchor_full.bak` | 0.124s | 0.096s | 0.22s |
| `pagecomp_long_prefix_full.bak` | 0.032s | 0.03s | 0.062s |
| `pfor_columnstore_full.bak` | 0.09s | 0.855s | 0.945s |
| `pfor_columnstore_random_full.bak` | 0.092s | 0.821s | 0.913s |
| `realworld_numeric_digest_full.bak` | 0.038s | 0.071s | 0.109s |
| `rowboundary_full.bak` | 0.038s | 0.034s | 0.072s |
| `rowstore_hash_pii_full.bak` | 0.033s | 0.029s | 0.062s |
| `rowstore_lob_image_full.bak` | 0.031s | 0.031s | 0.062s |
| `rowstore_lob_markup_full.bak` | 0.036s | 0.03s | 0.066s |
| `rowversion_extract_full.bak` | 0.032s | 0.027s | 0.059s |
| `sparse_full.bak` | 0.084s | 0.081s | 0.165s |
| `spatial_edge_full.bak` | 0.034s | 0.036s | 0.07s |
| `spatial_index_full.bak` | 0.037s | 0.027s | 0.064s |
| `sql_variant_extract_full.bak` | 0.028s | 0.025s | 0.053s |
| `striped_full_1.bak` | 0.043s | 0.014s | 0.057s |
| `striped_single.bak` | 0.045s | 0.045s | 0.09s |
| `surrogate_pairs_full.bak` | 0.029s | 0.034s | 0.063s |
| `tabletype_cci_large_full.bak` | 0.043s | 0.035s | 0.078s |
| `tabletypecoverage_diff.bak` | 0.104s | 0.066s | 0.17s |
| `tabletypecoverage_full.bak` | 0.073s | 0.082s | 0.155s |
| `temporal_hidden_full.bak` | 0.029s | 0.029s | 0.058s |
| `torn_page_full.bak` | 0.027s | 0.028s | 0.055s |
| `typecoverage_full.bak` | 0.06s | 0.054s | 0.114s |
| `typed_xml_full.bak` | 0.03s | 0.025s | 0.055s |
| `unicode_codepage_coverage.bak` | 0.053s | 0.038s | 0.091s |
| `utf8_collation_full.bak` | 0.033s | 0.037s | 0.07s |
| `xml_index_full.bak` | 0.038s | 0.031s | 0.069s |
| `xmlcoverage_full.bak` | 0.031s | 0.03s | 0.061s |
| `xmlheap_full.bak` | 0.049s | 0.042s | 0.091s |
