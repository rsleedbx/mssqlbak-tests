...
| `archive_columnstore_partition_full.bak` | 2.469s |
| `archive_columnstore_types_full.bak` | 1.419s |
| `archive_columnstore_types_random_full.bak` | 1.44s |
| `archive_single_chunk_full.bak` | 0.078s |
| `archive_single_chunk_random_full.bak` | 0.078s |
| `archivenull_full.bak` | 0.323s |
| `backup_blocksize_full.bak` | 0.092s |
| `boundarycoverage_datetime_full.bak` | 0.407s |
| `boundarycoverage_full.bak` | 0.247s |
| `catalog_ss2019.bak` | 0.075s |
| `cci_binary_varbinary_compare_full.bak` | 0.072s |
| `cci_bitpack_probe_bigint_full.bak` | 6.74s |
| `cci_bitpack_probe_full.bak` | 0.764s |
| `cci_bitpack_probe_highbase_full.bak` | 0.692s |
| `cci_btree_nci_full.bak` | 0.088s |
| `cci_computed_full.bak` | 0.081s |
| `cci_enc5_largepool_full.bak` | 1.267s |
| `cci_enc5_largepool_matrix_full.bak` | 9.851s |
| `cci_extended_full.bak` | 0.115s |
| `cci_lob_full.bak` | 0.093s |
| `cci_reorganize_full.bak` | 0.086s |
| `cci_string_dict_regression_full.bak` | 0.531s |
| `cci_string_minmax_full.bak` | 0.087s |
| `cci_switch_full.bak` | 0.081s |
| `cci_types_large_full.bak` | 0.113s |
| `cci_varbinary_micro_full.bak` | 0.08s |
| `cci_varbinary_probe_full.bak` | 0.091s |
| `columnstore_minimal.bak` | 1.208s |
| `compressed_nvarchar_full.bak` | 0.081s |
| `compressioncoverage_full.bak` | 0.338s |
| `computedcoverage_full.bak` | 0.086s |
| `constraintcoverage_full.bak` | 0.076s |
| `covering_index_full.bak` | 0.095s |
| `cs_lob_preamble.bak` | 0.143s |
| `delta_rowgroup_full.bak` | 0.079s |
| `dirtycoverage_aborted_xact.bak` | 0.084s |
| `dirtycoverage_addcol.bak` | 0.088s |
| `dirtycoverage_addnotnull.bak` | 0.084s |
| `dirtycoverage_alldirty.bak` | 0.097s |
| `dirtycoverage_altercol.bak` | 0.072s |
| `dirtycoverage_altercol_rewrite.bak` | 0.066s |
| `dirtycoverage_alterdb.bak` | 0.065s |
| `dirtycoverage_cci_delete.bak` | 0.246s |
| `dirtycoverage_cci_update.bak` | 0.326s |
| `dirtycoverage_committed_delete.bak` | 0.06s |
| `dirtycoverage_committed_delete_v2.bak` | 0.077s |
| `dirtycoverage_committed_delete_v3.bak` | 0.137s |
| `dirtycoverage_committed_delete_v4.bak` | 0.344s |
| `dirtycoverage_committed_update.bak` | 0.078s |
| `dirtycoverage_committed_update_v2.bak` | 0.078s |
| `dirtycoverage_committed_update_v3.bak` | 0.162s |
| `dirtycoverage_committed_update_v4.bak` | 0.372s |
| `dirtycoverage_concurrent.bak` | 0.084s |
| `dirtycoverage_createidx.bak` | 0.066s |
| `dirtycoverage_createtable.bak` | 0.087s |
| `dirtycoverage_delete.bak` | 0.086s |
| `dirtycoverage_dropcol.bak` | 0.09s |
| `dirtycoverage_dropidx.bak` | 0.068s |
| `dirtycoverage_droptable.bak` | 0.078s |
| `dirtycoverage_heap_forward.bak` | 0.086s |
| `dirtycoverage_large_dirty.bak` | 0.379s |
| `dirtycoverage_lob_update.bak` | 0.104s |
| `dirtycoverage_maxrow.bak` | 0.083s |
| `dirtycoverage_nchar_delete.bak` | 0.087s |
| `dirtycoverage_nested.bak` | 0.091s |
| `dirtycoverage_null_update.bak` | 0.086s |
| `dirtycoverage_rebuildidx.bak` | 0.071s |
| `dirtycoverage_rich_insert.bak` | 0.09s |
| `dirtycoverage_rich_update.bak` | 0.085s |
| `dirtycoverage_savepoint.bak` | 0.086s |
| `dirtycoverage_snapshot_update.bak` | 0.087s |
| `dirtycoverage_switch.bak` | 0.088s |
| `dirtycoverage_temporal_update.bak` | 0.089s |
| `dirtycoverage_truncate.bak` | 0.07s |
| `dirtycoverage_two_tx.bak` | 0.088s |
| `dirtycoverage_uncommitted.bak` | 0.091s |
| `dirtycoverage_update.bak` | 0.092s |
| `filtered_ncci_full.bak` | 0.075s |
| `float_extreme_full.bak` | 0.069s |
| `forwarded_records_full.bak` | 0.154s |
| `ghost_records_full.bak` | 0.09s |
| `heapcoverage_large.bak` | 0.081s |
| `heapcoverage_large_50000.bak` | 0.987s |
| `hierarchyid_extract_full.bak` | 0.076s |
| `high_slot_density_full.bak` | 0.588s |
| `incrementalcoverage_diff_01.bak` | 0.045s |
| `incrementalcoverage_diff_02.bak` | 0.054s |
| `incrementalcoverage_diff_03.bak` | 0.051s |
| `incrementalcoverage_diff_04.bak` | 0.045s |
| `incrementalcoverage_diff_05.bak` | 0.046s |
| `incrementalcoverage_diff_06.bak` | 0.052s |
| `incrementalcoverage_full.bak` | 0.091s |
| `layoutcoverage_full.bak` | 0.372s |
| `max_row_width_full.bak` | 0.068s |
| `mixed_collation_full.bak` | 0.07s |
| `multi_rowgroup_full.bak` | 0.086s |
| `ncci_heap_full.bak` | 0.069s |
| `ncci_types_full.bak` | 0.548s |
| `ndfcoverage_full.bak` | 0.066s |
| `nvarchar_max_u21_full.bak` | 0.068s |
| `pagecomp_anchor_full.bak` | 0.364s |
| `pagecomp_long_prefix_full.bak` | 0.062s |
| `pfor_columnstore_full.bak` | 2.379s |
| `pfor_columnstore_random_full.bak` | 2.479s |
| `realworld_numeric_digest_full.bak` | 0.201s |
| `rowboundary_full.bak` | 0.069s |
| `rowstore_hash_pii_full.bak` | 0.064s |
| `rowstore_lob_image_full.bak` | 0.093s |
| `rowstore_lob_markup_full.bak` | 0.074s |
| `rowversion_extract_full.bak` | 0.095s |
| `sparse_full.bak` | 0.29s |
| `spatial_edge_full.bak` | 0.093s |
| `spatial_index_full.bak` | 0.07s |
| `sql_variant_extract_full.bak` | 0.061s |
| `striped_full_1.bak` | 0.061s |
| `striped_single.bak` | 0.09s |
| `surrogate_pairs_full.bak` | 0.085s |
| `tabletype_cci_large_full.bak` | 0.104s |
| `tabletypecoverage_diff.bak` | 0.184s |
| `tabletypecoverage_full.bak` | 0.158s |
| `temporal_hidden_full.bak` | 0.077s |
| `torn_page_full.bak` | 0.063s |
| `typecoverage_full.bak` | 0.143s |
| `typed_xml_full.bak` | 0.073s |
| `unicode_codepage_coverage.bak` | 0.091s |
| `utf8_collation_full.bak` | 0.068s |
| `xml_index_full.bak` | 0.094s |
| `xmlcoverage_full.bak` | 0.066s |
