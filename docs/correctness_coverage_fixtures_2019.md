...
| Backup | Wall time |
|--------|-------------|
| `alias_types_full.bak` | 0.055s |
| `archive_columnstore_partition_full.bak` | 2.55s |
| `archive_columnstore_types_full.bak` | 1.315s |
| `archive_columnstore_types_random_full.bak` | 1.321s |
| `archive_single_chunk_full.bak` | 0.096s |
| `archive_single_chunk_random_full.bak` | 0.071s |
| `archivenull_full.bak` | 0.274s |
| `backup_blocksize_full.bak` | 0.059s |
| `boundarycoverage_datetime_full.bak` | 0.357s |
| `boundarycoverage_full.bak` | 0.189s |
| `catalog_ss2019.bak` | 0.055s |
| `cci_binary_varbinary_compare_full.bak` | 0.065s |
| `cci_bitpack_probe_bigint_full.bak` | 6.209s |
| `cci_bitpack_probe_full.bak` | 0.745s |
| `cci_bitpack_probe_highbase_full.bak` | 0.7s |
| `cci_btree_nci_full.bak` | 0.137s |
| `cci_computed_full.bak` | 0.083s |
| `cci_enc5_largepool_full.bak` | 1.169s |
| `cci_enc5_largepool_matrix_full.bak` | 9.435s |
| `cci_extended_full.bak` | 0.116s |
| `cci_lob_full.bak` | 0.109s |
| `cci_reorganize_full.bak` | 0.092s |
| `cci_string_dict_regression_full.bak` | 0.481s |
| `cci_string_minmax_full.bak` | 0.079s |
| `cci_switch_full.bak` | 0.076s |
| `cci_types_large_full.bak` | 0.111s |
| `cci_varbinary_micro_full.bak` | 0.072s |
| `cci_varbinary_probe_full.bak` | 0.085s |
| `columnstore_minimal.bak` | 0.977s |
| `compressed_nvarchar_full.bak` | 0.055s |
| `compressioncoverage_full.bak` | 0.31s |
| `computedcoverage_full.bak` | 0.066s |
| `constraintcoverage_full.bak` | 0.065s |
| `covering_index_full.bak` | 0.132s |
| `cs_lob_preamble.bak` | 0.128s |
| `delta_rowgroup_full.bak` | 0.072s |
| `dirtycoverage_aborted_xact.bak` | 0.091s |
| `dirtycoverage_addcol.bak` | 0.06s |
| `dirtycoverage_addnotnull.bak` | 0.06s |
| `dirtycoverage_alldirty.bak` | 0.089s |
| `dirtycoverage_altercol.bak` | 0.056s |
| `dirtycoverage_altercol_rewrite.bak` | 0.057s |
| `dirtycoverage_alterdb.bak` | 0.067s |
| `dirtycoverage_cci_delete.bak` | 0.194s |
| `dirtycoverage_cci_update.bak` | 0.316s |
| `dirtycoverage_committed_delete.bak` | 0.058s |
| `dirtycoverage_committed_delete_v2.bak` | 0.081s |
| `dirtycoverage_committed_delete_v3.bak` | 0.124s |
| `dirtycoverage_committed_delete_v4.bak` | 0.318s |
| `dirtycoverage_committed_update.bak` | 0.056s |
| `dirtycoverage_committed_update_v2.bak` | 0.072s |
| `dirtycoverage_committed_update_v3.bak` | 0.152s |
| `dirtycoverage_committed_update_v4.bak` | 0.348s |
| `dirtycoverage_concurrent.bak` | 0.062s |
| `dirtycoverage_createidx.bak` | 0.062s |
| `dirtycoverage_createtable.bak` | 0.061s |
| `dirtycoverage_delete.bak` | 0.126s |
| `dirtycoverage_dropcol.bak` | 0.057s |
| `dirtycoverage_dropidx.bak` | 0.063s |
| `dirtycoverage_droptable.bak` | 0.068s |
| `dirtycoverage_heap_forward.bak` | 0.095s |
| `dirtycoverage_large_dirty.bak` | 0.353s |
| `dirtycoverage_lob_update.bak` | 0.097s |
| `dirtycoverage_maxrow.bak` | 0.055s |
| `dirtycoverage_nchar_delete.bak` | 0.132s |
| `dirtycoverage_nested.bak` | 0.142s |
| `dirtycoverage_null_update.bak` | 0.139s |
| `dirtycoverage_rebuildidx.bak` | 0.063s |
| `dirtycoverage_rich_insert.bak` | 0.081s |
| `dirtycoverage_rich_update.bak` | 0.102s |
| `dirtycoverage_savepoint.bak` | 0.106s |
| `dirtycoverage_snapshot_update.bak` | 0.1s |
| `dirtycoverage_switch.bak` | 0.063s |
| `dirtycoverage_temporal_update.bak` | 0.098s |
| `dirtycoverage_truncate.bak` | 0.065s |
| `dirtycoverage_two_tx.bak` | 0.133s |
| `dirtycoverage_uncommitted.bak` | 0.138s |
| `dirtycoverage_update.bak` | 0.09s |
| `filtered_ncci_full.bak` | 0.076s |
| `float_extreme_full.bak` | 0.058s |
| `forwarded_records_full.bak` | 0.142s |
| `ghost_records_full.bak` | 0.064s |
| `heapcoverage_large.bak` | 0.083s |
| `heapcoverage_large_50000.bak` | 0.936s |
| `hierarchyid_extract_full.bak` | 0.058s |
| `high_slot_density_full.bak` | 0.546s |
| `incrementalcoverage_diff_01.bak` | 0.043s |
| `incrementalcoverage_diff_02.bak` | 0.047s |
| `incrementalcoverage_diff_03.bak` | 0.043s |
| `incrementalcoverage_diff_04.bak` | 0.043s |
| `incrementalcoverage_diff_05.bak` | 0.042s |
| `incrementalcoverage_diff_06.bak` | 0.047s |
| `incrementalcoverage_full.bak` | 0.055s |
| `layoutcoverage_full.bak` | 0.328s |
| `max_row_width_full.bak` | 0.055s |
| `mixed_collation_full.bak` | 0.056s |
| `multi_rowgroup_full.bak` | 0.141s |
| `ncci_heap_full.bak` | 0.068s |
| `ncci_types_full.bak` | 0.428s |
| `ndfcoverage_full.bak` | 0.065s |
| `nvarchar_max_u21_full.bak` | 0.058s |
| `pagecomp_anchor_full.bak` | 0.334s |
| `pagecomp_long_prefix_full.bak` | 0.062s |
| `pfor_columnstore_full.bak` | 2.42s |
| `pfor_columnstore_random_full.bak` | 2.423s |
| `realworld_numeric_digest_full.bak` | 0.174s |
| `rowboundary_full.bak` | 0.065s |
| `rowstore_hash_pii_full.bak` | 0.06s |
| `rowstore_lob_image_full.bak` | 0.063s |
| `rowstore_lob_markup_full.bak` | 0.055s |
| `rowversion_extract_full.bak` | 0.069s |
| `sparse_full.bak` | 0.277s |
| `spatial_edge_full.bak` | 0.073s |
| `spatial_index_full.bak` | 0.066s |
| `sql_variant_extract_full.bak` | 0.055s |
| `striped_full_1.bak` | 0.053s |
| `striped_single.bak` | 0.102s |
| `surrogate_pairs_full.bak` | 0.053s |
| `tabletype_cci_large_full.bak` | 0.088s |
| `tabletypecoverage_diff.bak` | 0.162s |
| `tabletypecoverage_full.bak` | 0.141s |
| `temporal_hidden_full.bak` | 0.059s |
| `torn_page_full.bak` | 0.059s |
| `typecoverage_full.bak` | 0.108s |
| `typed_xml_full.bak` | 0.059s |
| `unicode_codepage_coverage.bak` | 0.085s |
| `utf8_collation_full.bak` | 0.056s |
| `xml_index_full.bak` | 0.063s |
| `xmlcoverage_full.bak` | 0.056s |
| `xmlheap_full.bak` | 0.103s |

---

_Generated 2026-07-06 · 130 fixtures · 130 pass · 0 xfail · 0 fail_
