...
| `archive_columnstore_partition_full.bak` | 0.863s | 0.601s | 1.464s |
| `archive_columnstore_types_full.bak` | 0.298s | 0.683s | 0.981s |
| `archive_columnstore_types_random_full.bak` | 0.299s | 0.674s | 0.973s |
| `archive_single_chunk_full.bak` | 0.032s | 0.039s | 0.071s |
| `archive_single_chunk_random_full.bak` | 0.032s | 0.032s | 0.064s |
| `archivenull_full.bak` | 0.115s | 0.078s | 0.193s |
| `backup_blocksize_full.bak` | 0.031s | 0.029s | 0.06s |
| `boundarycoverage_datetime_full.bak` | 0.051s | 0.136s | 0.187s |
| `boundarycoverage_full.bak` | 0.041s | 0.063s | 0.104s |
| `catalog_ss2019.bak` | 0.027s | 0.029s | 0.056s |
| `cci_binary_varbinary_compare_full.bak` | 0.032s | 0.034s | 0.066s |
| `cci_bitpack_probe_bigint_full.bak` | 0.626s | 3.583s | 4.209s |
| `cci_bitpack_probe_full.bak` | 0.075s | 0.63s | 0.705s |
| `cci_bitpack_probe_highbase_full.bak` | 0.059s | 0.413s | 0.472s |
| `cci_btree_nci_full.bak` | 0.032s | 0.039s | 0.071s |
| `cci_computed_full.bak` | 0.033s | 0.033s | 0.066s |
| `cci_enc5_largepool_full.bak` | 0.306s | 0.428s | 0.734s |
| `cci_enc5_largepool_matrix_full.bak` | 6.869s | 1.246s | 8.115s |
| `cci_extended_full.bak` | 0.053s | 0.045s | 0.098s |
| `cci_lob_full.bak` | 0.042s | 0.036s | 0.078s |
| `cci_reorganize_full.bak` | 0.035s | 0.035s | 0.07s |
| `cci_string_dict_regression_full.bak` | 0.285s | 0.126s | 0.411s |
| `cci_string_minmax_full.bak` | 0.038s | 0.034s | 0.072s |
| `cci_switch_full.bak` | 0.032s | 0.036s | 0.068s |
| `cci_types_large_full.bak` | 0.048s | 0.046s | 0.094s |
| `cci_varbinary_micro_full.bak` | 0.033s | 0.031s | 0.064s |
| `cci_varbinary_probe_full.bak` | 0.036s | 0.043s | 0.079s |
| `columnstore_minimal.bak` | 0.128s | 0.848s | 0.976s |
| `compressed_nvarchar_full.bak` | 0.027s | 0.029s | 0.056s |
| `compressioncoverage_full.bak` | 0.078s | 0.173s | 0.251s |
| `computedcoverage_full.bak` | 0.028s | 0.03s | 0.058s |
| `constraintcoverage_full.bak` | 0.031s | 0.037s | 0.068s |
| `covering_index_full.bak` | 0.032s | 0.034s | 0.066s |
| `cs_lob_preamble.bak` | 0.066s | 0.054s | 0.12s |
| `delta_rowgroup_full.bak` | 0.033s | 0.031s | 0.064s |
| `dirtycoverage_aborted_xact.bak` | 0.052s | 0.029s | 0.081s |
| `dirtycoverage_addcol.bak` | 0.036s | 0.029s | 0.065s |
| `dirtycoverage_addnotnull.bak` | 0.04s | 0.03s | 0.07s |
| `dirtycoverage_alldirty.bak` | 0.054s | 0.029s | 0.083s |
| `dirtycoverage_altercol.bak` | 0.028s | 0.029s | 0.057s |
| `dirtycoverage_altercol_rewrite.bak` | 0.035s | 0.029s | 0.064s |
| `dirtycoverage_alterdb.bak` | 0.031s | 0.028s | 0.059s |
| `dirtycoverage_cci_delete.bak` | 0.088s | 0.086s | 0.174s |
| `dirtycoverage_cci_update.bak` | 0.184s | 0.083s | 0.267s |
| `dirtycoverage_committed_delete.bak` | 0.027s | 0.03s | 0.057s |
| `dirtycoverage_committed_delete_v2.bak` | 0.032s | 0.031s | 0.063s |
| `dirtycoverage_committed_delete_v3.bak` | 0.037s | 0.057s | 0.094s |
| `dirtycoverage_committed_delete_v4.bak` | 0.141s | 0.055s | 0.196s |
| `dirtycoverage_committed_update.bak` | 0.028s | 0.03s | 0.058s |
| `dirtycoverage_committed_update_v2.bak` | 0.039s | 0.032s | 0.071s |
| `dirtycoverage_committed_update_v3.bak` | 0.044s | 0.073s | 0.117s |
| `dirtycoverage_committed_update_v4.bak` | 0.142s | 0.063s | 0.205s |
| `dirtycoverage_concurrent.bak` | 0.036s | 0.029s | 0.065s |
| `dirtycoverage_createidx.bak` | 0.031s | 0.03s | 0.061s |
| `dirtycoverage_createtable.bak` | 0.035s | 0.033s | 0.068s |
| `dirtycoverage_delete.bak` | 0.052s | 0.032s | 0.084s |
| `dirtycoverage_dropcol.bak` | 0.031s | 0.03s | 0.061s |
| `dirtycoverage_dropidx.bak` | 0.031s | 0.029s | 0.06s |
| `dirtycoverage_droptable.bak` | 0.033s | 0.03s | 0.063s |
| `dirtycoverage_heap_forward.bak` | 0.052s | 0.031s | 0.083s |
| `dirtycoverage_large_dirty.bak` | 0.334s | 0.03s | 0.364s |
| `dirtycoverage_lob_update.bak` | 0.071s | 0.03s | 0.101s |
| `dirtycoverage_maxrow.bak` | 0.036s | 0.029s | 0.065s |
| `dirtycoverage_nchar_delete.bak` | 0.053s | 0.029s | 0.082s |
| `dirtycoverage_nested.bak` | 0.053s | 0.029s | 0.082s |
| `dirtycoverage_null_update.bak` | 0.056s | 0.029s | 0.085s |
| `dirtycoverage_rebuildidx.bak` | 0.036s | 0.029s | 0.065s |
| `dirtycoverage_rich_insert.bak` | 0.053s | 0.034s | 0.087s |
| `dirtycoverage_rich_update.bak` | 0.052s | 0.031s | 0.083s |
| `dirtycoverage_savepoint.bak` | 0.055s | 0.028s | 0.083s |
| `dirtycoverage_snapshot_update.bak` | 0.051s | 0.029s | 0.08s |
| `dirtycoverage_switch.bak` | 0.033s | 0.031s | 0.064s |
| `dirtycoverage_temporal_update.bak` | 0.06s | 0.032s | 0.092s |
| `dirtycoverage_truncate.bak` | 0.032s | 0.032s | 0.064s |
| `dirtycoverage_two_tx.bak` | 0.055s | 0.033s | 0.088s |
| `dirtycoverage_uncommitted.bak` | 0.057s | 0.03s | 0.087s |
| `dirtycoverage_update.bak` | 0.054s | 0.029s | 0.083s |
| `filtered_ncci_full.bak` | 0.033s | 0.032s | 0.065s |
| `float_extreme_full.bak` | 0.04s | 0.033s | 0.073s |
| `forwarded_records_full.bak` | 0.064s | 0.068s | 0.132s |
| `ghost_records_full.bak` | 0.027s | 0.033s | 0.06s |
| `heapcoverage_large.bak` | 0.031s | 0.042s | 0.073s |
| `heapcoverage_large_50000.bak` | 0.077s | 0.303s | 0.38s |
| `hierarchyid_extract_full.bak` | 0.03s | 0.029s | 0.059s |
| `high_slot_density_full.bak` | 0.037s | 0.175s | 0.212s |
| `identity_coverage_full.bak` | 0.034s | 0.037s | 0.071s |
| `incrementalcoverage_diff_01.bak` | 0.042s | 0.011s | 0.053s |
| `incrementalcoverage_diff_02.bak` | 0.039s | 0.01s | 0.049s |
| `incrementalcoverage_diff_03.bak` | 0.034s | 0.009s | 0.043s |
| `incrementalcoverage_diff_04.bak` | 0.033s | 0.01s | 0.043s |
| `incrementalcoverage_diff_05.bak` | 0.032s | 0.011s | 0.043s |
| `incrementalcoverage_diff_06.bak` | 0.038s | 0.01s | 0.048s |
| `incrementalcoverage_full.bak` | 0.028s | 0.024s | 0.052s |
| `layoutcoverage_full.bak` | 0.12s | 0.302s | 0.422s |
| `max_row_width_full.bak` | 0.027s | 0.03s | 0.057s |
| `mixed_collation_full.bak` | 0.028s | 0.028s | 0.056s |
| `multi_rowgroup_full.bak` | 0.033s | 0.035s | 0.068s |
| `ncci_heap_full.bak` | 0.033s | 0.032s | 0.065s |
| `ncci_types_full.bak` | 0.061s | 0.162s | 0.223s |
| `ndfcoverage_full.bak` | 0.029s | 0.033s | 0.062s |
| `nvarchar_max_u21_full.bak` | 0.03s | 0.029s | 0.059s |
| `pagecomp_anchor_full.bak` | 0.117s | 0.084s | 0.201s |
| `pagecomp_long_prefix_full.bak` | 0.034s | 0.029s | 0.063s |
| `pfor_columnstore_full.bak` | 0.094s | 0.808s | 0.902s |
| `pfor_columnstore_random_full.bak` | 0.088s | 0.823s | 0.911s |
| `realworld_numeric_digest_full.bak` | 0.041s | 0.083s | 0.124s |
| `rowboundary_full.bak` | 0.033s | 0.031s | 0.064s |
| `rowstore_hash_pii_full.bak` | 0.028s | 0.029s | 0.057s |
| `rowstore_lob_image_full.bak` | 0.031s | 0.03s | 0.061s |
| `rowstore_lob_markup_full.bak` | 0.028s | 0.03s | 0.058s |
| `rowversion_extract_full.bak` | 0.035s | 0.03s | 0.065s |
| `sparse_full.bak` | 0.082s | 0.088s | 0.17s |
| `spatial_edge_full.bak` | 0.029s | 0.03s | 0.059s |
| `spatial_index_full.bak` | 0.034s | 0.03s | 0.064s |
| `sql_variant_extract_full.bak` | 0.029s | 0.029s | 0.058s |
| `striped_full_1.bak` | 0.042s | 0.018s | 0.06s |
| `striped_single.bak` | 0.04s | 0.041s | 0.081s |
| `surrogate_pairs_full.bak` | 0.027s | 0.029s | 0.056s |
| `tabletype_cci_large_full.bak` | 0.05s | 0.054s | 0.104s |
| `tabletypecoverage_diff.bak` | 0.105s | 0.056s | 0.161s |
| `tabletypecoverage_full.bak` | 0.076s | 0.077s | 0.153s |
| `temporal_hidden_full.bak` | 0.029s | 0.032s | 0.061s |
| `torn_page_full.bak` | 0.028s | 0.03s | 0.058s |
| `typecoverage_full.bak` | 0.063s | 0.069s | 0.132s |
| `typed_xml_full.bak` | 0.031s | 0.034s | 0.065s |
| `unicode_codepage_coverage.bak` | 0.045s | 0.04s | 0.085s |
| `utf8_collation_full.bak` | 0.038s | 0.031s | 0.069s |
| `xml_index_full.bak` | 0.033s | 0.033s | 0.066s |
| `xmlcoverage_full.bak` | 0.028s | 0.029s | 0.057s |
| `xmlheap_full.bak` | 0.045s | 0.051s | 0.096s |
