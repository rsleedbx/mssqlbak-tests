...
|--------|---------|--------|-----------|
| `alias_types_full.bak` | 0.027s | 0.032s | 0.059s |
| `archive_columnstore_partition_full.bak` | 0.89s | 0.892s | 1.782s |
| `archive_columnstore_types_full.bak` | 0.304s | 0.646s | 0.95s |
| `archive_columnstore_types_random_full.bak` | 0.295s | 0.652s | 0.947s |
| `archive_single_chunk_full.bak` | 0.035s | 0.035s | 0.07s |
| `archive_single_chunk_random_full.bak` | 0.033s | 0.034s | 0.067s |
| `archivenull_full.bak` | 0.122s | 0.104s | 0.226s |
| `backup_blocksize_full.bak` | 0.032s | 0.031s | 0.063s |
| `boundarycoverage_datetime_full.bak` | 0.081s | 0.256s | 0.337s |
| `boundarycoverage_full.bak` | 0.058s | 0.089s | 0.147s |
| `catalog_ss2019.bak` | 0.035s | 0.028s | 0.063s |
| `cci_binary_varbinary_compare_full.bak` | 0.033s | 0.034s | 0.067s |
| `cci_bitpack_probe_bigint_full.bak` | 0s | 5.811s | 5.811s |
| `cci_bitpack_probe_full.bak` | 0s | 0.633s | 0.633s |
| `cci_bitpack_probe_highbase_full.bak` | 0s | 0.588s | 0.588s |
| `cci_btree_nci_full.bak` | 0.034s | 0.037s | 0.071s |
| `cci_computed_full.bak` | 0.032s | 0.034s | 0.066s |
| `cci_enc5_largepool_full.bak` | 0.314s | 0.463s | 0.777s |
| `cci_enc5_largepool_matrix_full.bak` | 7.072s | 1.632s | 8.704s |
| `cci_extended_full.bak` | 0.082s | 0.07s | 0.152s |
| `cci_lob_full.bak` | 0.044s | 0.046s | 0.09s |
| `cci_reorganize_full.bak` | 0.086s | 0.038s | 0.124s |
| `cci_string_dict_regression_full.bak` | 0.31s | 0.14s | 0.45s |
| `cci_string_minmax_full.bak` | 0.039s | 0.042s | 0.081s |
| `cci_switch_full.bak` | 0.033s | 0.035s | 0.068s |
| `cci_types_large_full.bak` | 0.223s | 0.089s | 0.312s |
| `cci_varbinary_micro_full.bak` | 0.033s | 0.035s | 0.068s |
| `cci_varbinary_probe_full.bak` | 0.043s | 0.041s | 0.084s |
| `columnstore_minimal.bak` | 0.101s | 0.815s | 0.916s |
| `compressed_nvarchar_full.bak` | 0.029s | 0.032s | 0.061s |
| `compressioncoverage_full.bak` | 0.079s | 0.242s | 0.321s |
| `computedcoverage_full.bak` | 0.028s | 0.031s | 0.059s |
| `constraintcoverage_full.bak` | 0.032s | 0.045s | 0.077s |
| `covering_index_full.bak` | 0.175s | 0.083s | 0.258s |
| `cs_lob_preamble.bak` | 0.068s | 0.059s | 0.127s |
| `delta_rowgroup_full.bak` | 0.044s | 0.04s | 0.084s |
| `dirtycoverage_aborted_xact.bak` | 0.055s | 0.032s | 0.087s |
| `dirtycoverage_addcol.bak` | 0.036s | 0.028s | 0.064s |
| `dirtycoverage_addnotnull.bak` | 0.058s | 0.053s | 0.111s |
| `dirtycoverage_alldirty.bak` | 0.054s | 0.032s | 0.086s |
| `dirtycoverage_altercol.bak` | 0.032s | 0.038s | 0.07s |
| `dirtycoverage_altercol_rewrite.bak` | 0.031s | 0.03s | 0.061s |
| `dirtycoverage_alterdb.bak` | 0.048s | 0.047s | 0.095s |
| `dirtycoverage_cci_delete.bak` | 0.137s | 0.093s | 0.23s |
| `dirtycoverage_cci_update.bak` | 0.189s | 0.088s | 0.277s |
| `dirtycoverage_committed_delete.bak` | 0.032s | 0.035s | 0.067s |
| `dirtycoverage_committed_delete_v2.bak` | 0.032s | 0.035s | 0.067s |
| `dirtycoverage_committed_delete_v3.bak` | 0.042s | 0.066s | 0.108s |
| `dirtycoverage_committed_delete_v4.bak` | 0.141s | 0.112s | 0.253s |
| `dirtycoverage_committed_update.bak` | 0.034s | 0.032s | 0.066s |
| `dirtycoverage_committed_update_v2.bak` | 0.042s | 0.041s | 0.083s |
| `dirtycoverage_committed_update_v3.bak` | 0.042s | 0.077s | 0.119s |
| `dirtycoverage_committed_update_v4.bak` | 0.146s | 0.13s | 0.276s |
| `dirtycoverage_concurrent.bak` | 0.036s | 0.031s | 0.067s |
| `dirtycoverage_createidx.bak` | 0.031s | 0.032s | 0.063s |
| `dirtycoverage_createtable.bak` | 0.032s | 0.039s | 0.071s |
| `dirtycoverage_delete.bak` | 0.067s | 0.037s | 0.104s |
| `dirtycoverage_dropcol.bak` | 0.049s | 0.046s | 0.095s |
| `dirtycoverage_dropidx.bak` | 0.032s | 0.031s | 0.063s |
| `dirtycoverage_droptable.bak` | 0.033s | 0.034s | 0.067s |
| `dirtycoverage_heap_forward.bak` | 0.057s | 0.034s | 0.091s |
| `dirtycoverage_large_dirty.bak` | 0.344s | 0.033s | 0.377s |
| `dirtycoverage_lob_update.bak` | 0.104s | 0.037s | 0.141s |
| `dirtycoverage_maxrow.bak` | 0.029s | 0.041s | 0.07s |
| `dirtycoverage_nchar_delete.bak` | 0.072s | 0.033s | 0.105s |
| `dirtycoverage_nested.bak` | 0.054s | 0.03s | 0.084s |
| `dirtycoverage_null_update.bak` | 0.053s | 0.032s | 0.085s |
| `dirtycoverage_rebuildidx.bak` | 0.045s | 0.037s | 0.082s |
| `dirtycoverage_rich_insert.bak` | 0.054s | 0.032s | 0.086s |
| `dirtycoverage_rich_update.bak` | 0.061s | 0.034s | 0.095s |
| `dirtycoverage_savepoint.bak` | 0.065s | 0.031s | 0.096s |
| `dirtycoverage_snapshot_update.bak` | 0.062s | 0.039s | 0.101s |
| `dirtycoverage_switch.bak` | 0.041s | 0.036s | 0.077s |
| `dirtycoverage_temporal_update.bak` | 0.057s | 0.034s | 0.091s |
| `dirtycoverage_truncate.bak` | 0.039s | 0.036s | 0.075s |
| `dirtycoverage_two_tx.bak` | 0.124s | 0.174s | 0.298s |
| `dirtycoverage_uncommitted.bak` | 0.054s | 0.044s | 0.098s |
| `dirtycoverage_update.bak` | 0.055s | 0.038s | 0.093s |
| `filtered_ncci_full.bak` | 0.034s | 0.037s | 0.071s |
| `float_extreme_full.bak` | 0.054s | 0.051s | 0.105s |
| `forwarded_records_full.bak` | 0.066s | 0.084s | 0.15s |
| `ghost_records_full.bak` | 0.044s | 0.063s | 0.107s |
| `heapcoverage_large.bak` | 0.029s | 0.041s | 0.07s |
| `heapcoverage_large_50000.bak` | 0.083s | 0.464s | 0.547s |
| `hierarchyid_extract_full.bak` | 0.031s | 0.033s | 0.064s |
| `high_slot_density_full.bak` | 0.047s | 0.239s | 0.286s |
| `incrementalcoverage_diff_01.bak` | 0.044s | 0.014s | 0.058s |
| `incrementalcoverage_diff_02.bak` | 0.042s | 0.01s | 0.052s |
| `incrementalcoverage_diff_03.bak` | 0.045s | 0.01s | 0.055s |
| `incrementalcoverage_diff_04.bak` | 0.05s | 0.012s | 0.062s |
| `incrementalcoverage_diff_05.bak` | 0.045s | 0.015s | 0.06s |
| `incrementalcoverage_diff_06.bak` | 0.042s | 0.011s | 0.053s |
| `incrementalcoverage_full.bak` | 0.028s | 0.038s | 0.066s |
| `layoutcoverage_full.bak` | 0.124s | 0.231s | 0.355s |
| `max_row_width_full.bak` | 0.078s | 0.058s | 0.136s |
| `mixed_collation_full.bak` | 0.043s | 0.032s | 0.075s |
| `multi_rowgroup_full.bak` | 0.033s | 0.039s | 0.072s |
| `ncci_heap_full.bak` | 0.044s | 0.038s | 0.082s |
| `ncci_types_full.bak` | 0.063s | 0.252s | 0.315s |
| `ndfcoverage_full.bak` | 0.032s | 0.041s | 0.073s |
| `nvarchar_max_u21_full.bak` | 0.083s | 0.045s | 0.128s |
| `pagecomp_anchor_full.bak` | 0.118s | 0.179s | 0.297s |
| `pagecomp_long_prefix_full.bak` | 0.028s | 0.03s | 0.058s |
| `pfor_columnstore_full.bak` | 0.103s | 1.143s | 1.246s |
| `pfor_columnstore_random_full.bak` | 0.092s | 1.087s | 1.179s |
| `realworld_numeric_digest_full.bak` | 0.042s | 0.102s | 0.144s |
| `rowboundary_full.bak` | 0.042s | 0.045s | 0.087s |
| `rowstore_hash_pii_full.bak` | 0.028s | 0.03s | 0.058s |
| `rowstore_lob_image_full.bak` | 0.031s | 0.033s | 0.064s |
| `rowstore_lob_markup_full.bak` | 0.03s | 0.034s | 0.064s |
| `rowversion_extract_full.bak` | 0.032s | 0.03s | 0.062s |
| `sparse_full.bak` | 0.093s | 0.162s | 0.255s |
| `spatial_edge_full.bak` | 0.042s | 0.037s | 0.079s |
| `spatial_index_full.bak` | 0.033s | 0.035s | 0.068s |
| `sql_variant_extract_full.bak` | 0.036s | 0.077s | 0.113s |
| `striped_full_1.bak` | 0.042s | 0.013s | 0.055s |
| `striped_single.bak` | 0.042s | 0.051s | 0.093s |
| `surrogate_pairs_full.bak` | 0.031s | 0.03s | 0.061s |
| `tabletype_cci_large_full.bak` | 0.065s | 0.055s | 0.12s |
| `tabletypecoverage_diff.bak` | 0.168s | 0.081s | 0.249s |
| `tabletypecoverage_full.bak` | 0.073s | 0.082s | 0.155s |
| `temporal_hidden_full.bak` | 0.03s | 0.033s | 0.063s |
| `torn_page_full.bak` | 0.034s | 0.074s | 0.108s |
| `typecoverage_full.bak` | 0.06s | 0.068s | 0.128s |
| `typed_xml_full.bak` | 0.039s | 0.029s | 0.068s |
| `unicode_codepage_coverage.bak` | 0.063s | 0.065s | 0.128s |
| `utf8_collation_full.bak` | 0.049s | 0.056s | 0.105s |
| `xml_index_full.bak` | 0.039s | 0.035s | 0.074s |
| `xmlcoverage_full.bak` | 0.028s | 0.031s | 0.059s |
| `xmlheap_full.bak` | 0.047s | 0.057s | 0.104s |
