...
| `archive_columnstore_partition_full.bak` | 0.865s | 0.623s | 1.488s |
| `archive_columnstore_types_full.bak` | 0.306s | 0.697s | 1.003s |
| `archive_columnstore_types_random_full.bak` | 0.294s | 0.684s | 0.978s |
| `archive_single_chunk_full.bak` | 0.033s | 0.033s | 0.066s |
| `archive_single_chunk_random_full.bak` | 0.034s | 0.038s | 0.072s |
| `archivenull_full.bak` | 0.178s | 0.129s | 0.307s |
| `backup_blocksize_full.bak` | 0.032s | 0.03s | 0.062s |
| `boundarycoverage_datetime_full.bak` | 0.11s | 0.285s | 0.395s |
| `boundarycoverage_full.bak` | 0.044s | 0.071s | 0.115s |
| `catalog_ss2019.bak` | 0.028s | 0.03s | 0.058s |
| `cci_binary_varbinary_compare_full.bak` | 0.043s | 0.035s | 0.078s |
| `cci_bitpack_probe_bigint_full.bak` | 0.635s | 3.701s | 4.336s |
| `cci_bitpack_probe_full.bak` | 0.073s | 0.667s | 0.74s |
| `cci_bitpack_probe_highbase_full.bak` | 0.066s | 0.447s | 0.513s |
| `cci_btree_nci_full.bak` | 0.038s | 0.044s | 0.082s |
| `cci_computed_full.bak` | 0.034s | 0.032s | 0.066s |
| `cci_enc5_largepool_full.bak` | 0.314s | 0.435s | 0.749s |
| `cci_enc5_largepool_matrix_full.bak` | 7.387s | 1.268s | 8.655s |
| `cci_extended_full.bak` | 0.052s | 0.052s | 0.104s |
| `cci_lob_full.bak` | 0.049s | 0.043s | 0.092s |
| `cci_reorganize_full.bak` | 0.041s | 0.039s | 0.08s |
| `cci_string_dict_regression_full.bak` | 0.278s | 0.137s | 0.415s |
| `cci_string_minmax_full.bak` | 0.039s | 0.035s | 0.074s |
| `cci_switch_full.bak` | 0.033s | 0.034s | 0.067s |
| `cci_types_large_full.bak` | 0.051s | 0.039s | 0.09s |
| `cci_varbinary_micro_full.bak` | 0.034s | 0.033s | 0.067s |
| `cci_varbinary_probe_full.bak` | 0.036s | 0.043s | 0.079s |
| `columnstore_minimal.bak` | 0.119s | 1.018s | 1.137s |
| `compressed_nvarchar_full.bak` | 0.029s | 0.03s | 0.059s |
| `compressioncoverage_full.bak` | 0.086s | 0.201s | 0.287s |
| `computedcoverage_full.bak` | 0.032s | 0.035s | 0.067s |
| `constraintcoverage_full.bak` | 0.033s | 0.037s | 0.07s |
...
| `dirtycoverage_aborted_xact.bak` | 0.053s | 0.033s | 0.086s |
| `dirtycoverage_addcol.bak` | 0.037s | 0.031s | 0.068s |
| `dirtycoverage_addnotnull.bak` | 0.032s | 0.031s | 0.063s |
| `dirtycoverage_alldirty.bak` | 0.058s | 0.03s | 0.088s |
| `dirtycoverage_altercol.bak` | 0.029s | 0.029s | 0.058s |
| `dirtycoverage_altercol_rewrite.bak` | 0.032s | 0.032s | 0.064s |
| `dirtycoverage_alterdb.bak` | 0.032s | 0.032s | 0.064s |
| `dirtycoverage_cci_delete.bak` | 0.102s | 0.099s | 0.201s |
| `dirtycoverage_cci_update.bak` | 0.199s | 0.09s | 0.289s |
| `dirtycoverage_committed_delete.bak` | 0.032s | 0.029s | 0.061s |
| `dirtycoverage_committed_delete_v2.bak` | 0.04s | 0.034s | 0.074s |
| `dirtycoverage_committed_delete_v3.bak` | 0.09s | 0.282s | 0.372s |
| `dirtycoverage_committed_delete_v4.bak` | 0.166s | 0.115s | 0.281s |
| `dirtycoverage_committed_update.bak` | 0.032s | 0.031s | 0.063s |
| `dirtycoverage_committed_update_v2.bak` | 0.037s | 0.036s | 0.073s |
| `dirtycoverage_committed_update_v3.bak` | 0.041s | 0.066s | 0.107s |
| `dirtycoverage_committed_update_v4.bak` | 0.312s | 0.149s | 0.461s |
| `dirtycoverage_concurrent.bak` | 0.032s | 0.03s | 0.062s |
| `dirtycoverage_createidx.bak` | 0.037s | 0.031s | 0.068s |
| `dirtycoverage_createtable.bak` | 0.033s | 0.03s | 0.063s |
| `dirtycoverage_delete.bak` | 0.059s | 0.032s | 0.091s |
| `dirtycoverage_dropcol.bak` | 0.031s | 0.032s | 0.063s |
| `dirtycoverage_dropidx.bak` | 0.033s | 0.031s | 0.064s |
| `dirtycoverage_droptable.bak` | 0.036s | 0.032s | 0.068s |
| `dirtycoverage_heap_forward.bak` | 0.053s | 0.032s | 0.085s |
| `dirtycoverage_large_dirty.bak` | 0.338s | 0.036s | 0.374s |
| `dirtycoverage_lob_update.bak` | 0.074s | 0.03s | 0.104s |
| `dirtycoverage_maxrow.bak` | 0.028s | 0.031s | 0.059s |
| `dirtycoverage_nchar_delete.bak` | 0.058s | 0.03s | 0.088s |
| `dirtycoverage_nested.bak` | 0.057s | 0.03s | 0.087s |
| `dirtycoverage_null_update.bak` | 0.054s | 0.032s | 0.086s |
| `dirtycoverage_rebuildidx.bak` | 0.033s | 0.032s | 0.065s |
| `dirtycoverage_rich_insert.bak` | 0.054s | 0.036s | 0.09s |
| `dirtycoverage_rich_update.bak` | 0.052s | 0.033s | 0.085s |
| `dirtycoverage_savepoint.bak` | 0.071s | 0.031s | 0.102s |
| `dirtycoverage_snapshot_update.bak` | 0.052s | 0.03s | 0.082s |
| `dirtycoverage_switch.bak` | 0.037s | 0.032s | 0.069s |
| `dirtycoverage_temporal_update.bak` | 0.056s | 0.031s | 0.087s |
| `dirtycoverage_truncate.bak` | 0.038s | 0.037s | 0.075s |
| `dirtycoverage_two_tx.bak` | 0.07s | 0.039s | 0.109s |
| `dirtycoverage_uncommitted.bak` | 0.055s | 0.029s | 0.084s |
| `dirtycoverage_update.bak` | 0.06s | 0.034s | 0.094s |
| `filtered_ncci_full.bak` | 0.033s | 0.036s | 0.069s |
| `float_extreme_full.bak` | 0.03s | 0.04s | 0.07s |
| `forwarded_records_full.bak` | 0.075s | 0.083s | 0.158s |
| `ghost_records_full.bak` | 0.03s | 0.031s | 0.061s |
| `heapcoverage_large.bak` | 0.03s | 0.038s | 0.068s |
| `heapcoverage_large_50000.bak` | 0.082s | 0.316s | 0.398s |
| `hierarchyid_extract_full.bak` | 0.031s | 0.029s | 0.06s |
| `high_slot_density_full.bak` | 0.043s | 0.232s | 0.275s |
| `identity_coverage_full.bak` | 0.031s | 0.033s | 0.064s |
| `incrementalcoverage_diff_01.bak` | 0.036s | 0.01s | 0.046s |
| `incrementalcoverage_diff_02.bak` | 0.039s | 0.011s | 0.05s |
| `incrementalcoverage_diff_03.bak` | 0.042s | 0.011s | 0.053s |
| `incrementalcoverage_diff_04.bak` | 0.037s | 0.011s | 0.048s |
| `incrementalcoverage_diff_05.bak` | 0.034s | 0.01s | 0.044s |
| `incrementalcoverage_diff_06.bak` | 0.051s | 0.011s | 0.062s |
| `incrementalcoverage_full.bak` | 0.029s | 0.031s | 0.06s |
| `layoutcoverage_full.bak` | 0.123s | 0.354s | 0.477s |
| `max_row_width_full.bak` | 0.028s | 0.029s | 0.057s |
| `mixed_collation_full.bak` | 0.029s | 0.029s | 0.058s |
| `multi_rowgroup_full.bak` | 0.034s | 0.034s | 0.068s |
| `ncci_heap_full.bak` | 0.035s | 0.033s | 0.068s |
| `ncci_types_full.bak` | 0.062s | 0.275s | 0.337s |
| `ndfcoverage_full.bak` | 0.03s | 0.034s | 0.064s |
| `nvarchar_max_u21_full.bak` | 0.046s | 0.035s | 0.081s |
| `pagecomp_anchor_full.bak` | 0.127s | 0.282s | 0.409s |
| `pagecomp_long_prefix_full.bak` | 0.029s | 0.034s | 0.063s |
| `pfor_columnstore_full.bak` | 0.09s | 0.833s | 0.923s |
| `pfor_columnstore_random_full.bak` | 0.094s | 0.829s | 0.923s |
| `realworld_numeric_digest_full.bak` | 0.04s | 0.082s | 0.122s |
| `rowboundary_full.bak` | 0.037s | 0.034s | 0.071s |
| `rowstore_hash_pii_full.bak` | 0.029s | 0.032s | 0.061s |
...
| `sparse_full.bak` | 0.096s | 0.096s | 0.192s |
| `spatial_edge_full.bak` | 0.029s | 0.03s | 0.059s |
| `spatial_index_full.bak` | 0.035s | 0.04s | 0.075s |
| `sql_variant_extract_full.bak` | 0.028s | 0.029s | 0.057s |
| `striped_full_1.bak` | 0.057s | 0.02s | 0.077s |
| `striped_single.bak` | 0.042s | 0.044s | 0.086s |
| `surrogate_pairs_full.bak` | 0.03s | 0.03s | 0.06s |
| `tabletype_cci_large_full.bak` | 0.049s | 0.047s | 0.096s |
| `tabletypecoverage_diff.bak` | 0.138s | 0.079s | 0.217s |
| `tabletypecoverage_full.bak` | 0.083s | 0.089s | 0.172s |
| `temporal_hidden_full.bak` | 0.03s | 0.036s | 0.066s |
| `torn_page_full.bak` | 0.029s | 0.032s | 0.061s |
| `typecoverage_full.bak` | 0.06s | 0.064s | 0.124s |
| `typed_xml_full.bak` | 0.031s | 0.031s | 0.062s |
| `unicode_codepage_coverage.bak` | 0.047s | 0.043s | 0.09s |
| `utf8_collation_full.bak` | 0.028s | 0.03s | 0.058s |
| `xml_index_full.bak` | 0.039s | 0.041s | 0.08s |
| `xmlcoverage_full.bak` | 0.029s | 0.031s | 0.06s |
| `xmlheap_full.bak` | 0.057s | 0.063s | 0.12s |
