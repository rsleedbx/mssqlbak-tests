...
| `archive_columnstore_partition_full.bak` | 0.87s | 0.61s | 1.48s |
| `archive_columnstore_types_full.bak` | 0.303s | 0.69s | 0.993s |
| `archive_columnstore_types_random_full.bak` | 0.302s | 0.707s | 1.009s |
| `archive_single_chunk_full.bak` | 0.033s | 0.037s | 0.07s |
| `archive_single_chunk_random_full.bak` | 0.032s | 0.033s | 0.065s |
| `archivenull_full.bak` | 0.116s | 0.087s | 0.203s |
| `backup_blocksize_full.bak` | 0.032s | 0.037s | 0.069s |
| `boundarycoverage_datetime_full.bak` | 0.05s | 0.156s | 0.206s |
| `boundarycoverage_full.bak` | 0.038s | 0.062s | 0.1s |
| `catalog_ss2019.bak` | 0.028s | 0.034s | 0.062s |
| `cci_binary_varbinary_compare_full.bak` | 0.033s | 0.033s | 0.066s |
| `cci_bitpack_probe_bigint_full.bak` | 0.65s | 3.709s | 4.359s |
| `cci_bitpack_probe_full.bak` | 0.082s | 0.656s | 0.738s |
| `cci_bitpack_probe_highbase_full.bak` | 0.07s | 0.428s | 0.498s |
| `cci_btree_nci_full.bak` | 0.033s | 0.036s | 0.069s |
| `cci_computed_full.bak` | 0.061s | 0.081s | 0.142s |
| `cci_enc5_largepool_full.bak` | 0.316s | 0.44s | 0.756s |
| `cci_enc5_largepool_matrix_full.bak` | 6.896s | 1.366s | 8.262s |
| `cci_extended_full.bak` | 0.047s | 0.042s | 0.089s |
| `cci_lob_full.bak` | 0.034s | 0.043s | 0.077s |
| `cci_reorganize_full.bak` | 0.035s | 0.034s | 0.069s |
| `cci_string_dict_regression_full.bak` | 0.294s | 0.142s | 0.436s |
| `cci_string_minmax_full.bak` | 0.043s | 0.033s | 0.076s |
| `cci_switch_full.bak` | 0.034s | 0.036s | 0.07s |
| `cci_types_large_full.bak` | 0.042s | 0.039s | 0.081s |
| `cci_varbinary_micro_full.bak` | 0.046s | 0.036s | 0.082s |
| `cci_varbinary_probe_full.bak` | 0.036s | 0.048s | 0.084s |
| `columnstore_minimal.bak` | 0.133s | 0.968s | 1.101s |
| `compressed_nvarchar_full.bak` | 0.028s | 0.029s | 0.057s |
| `compressioncoverage_full.bak` | 0.078s | 0.17s | 0.248s |
| `computedcoverage_full.bak` | 0.028s | 0.043s | 0.071s |
| `constraintcoverage_full.bak` | 0.032s | 0.037s | 0.069s |
| `covering_index_full.bak` | 0.032s | 0.036s | 0.068s |
| `cs_lob_preamble.bak` | 0.068s | 0.056s | 0.124s |
| `delta_rowgroup_full.bak` | 0.034s | 0.031s | 0.065s |
| `dirtycoverage_aborted_xact.bak` | 0.052s | 0.029s | 0.081s |
| `dirtycoverage_addcol.bak` | 0.059s | 0.079s | 0.138s |
| `dirtycoverage_addnotnull.bak` | 0.049s | 0.095s | 0.144s |
| `dirtycoverage_alldirty.bak` | 0.054s | 0.029s | 0.083s |
| `dirtycoverage_altercol.bak` | 0.037s | 0.035s | 0.072s |
| `dirtycoverage_altercol_rewrite.bak` | 0.031s | 0.03s | 0.061s |
| `dirtycoverage_alterdb.bak` | 0.031s | 0.029s | 0.06s |
| `dirtycoverage_cci_delete.bak` | 0.082s | 0.084s | 0.166s |
| `dirtycoverage_cci_update.bak` | 0.205s | 0.094s | 0.299s |
| `dirtycoverage_committed_delete.bak` | 0.028s | 0.036s | 0.064s |
| `dirtycoverage_committed_delete_v2.bak` | 0.033s | 0.036s | 0.069s |
| `dirtycoverage_committed_delete_v3.bak` | 0.038s | 0.053s | 0.091s |
| `dirtycoverage_committed_delete_v4.bak` | 0.142s | 0.069s | 0.211s |
| `dirtycoverage_committed_update.bak` | 0.033s | 0.04s | 0.073s |
| `dirtycoverage_committed_update_v2.bak` | 0.033s | 0.032s | 0.065s |
| `dirtycoverage_committed_update_v3.bak` | 0.042s | 0.066s | 0.108s |
| `dirtycoverage_committed_update_v4.bak` | 0.15s | 0.075s | 0.225s |
| `dirtycoverage_concurrent.bak` | 0.032s | 0.036s | 0.068s |
| `dirtycoverage_createidx.bak` | 0.039s | 0.031s | 0.07s |
| `dirtycoverage_createtable.bak` | 0.032s | 0.03s | 0.062s |
| `dirtycoverage_delete.bak` | 0.054s | 0.033s | 0.087s |
| `dirtycoverage_dropcol.bak` | 0.035s | 0.031s | 0.066s |
| `dirtycoverage_dropidx.bak` | 0.034s | 0.029s | 0.063s |
| `dirtycoverage_droptable.bak` | 0.038s | 0.032s | 0.07s |
| `dirtycoverage_heap_forward.bak` | 0.052s | 0.029s | 0.081s |
| `dirtycoverage_large_dirty.bak` | 0.334s | 0.036s | 0.37s |
| `dirtycoverage_lob_update.bak` | 0.07s | 0.03s | 0.1s |
| `dirtycoverage_maxrow.bak` | 0.045s | 0.051s | 0.096s |
| `dirtycoverage_nchar_delete.bak` | 0.057s | 0.03s | 0.087s |
| `dirtycoverage_nested.bak` | 0.055s | 0.03s | 0.085s |
| `dirtycoverage_null_update.bak` | 0.052s | 0.03s | 0.082s |
| `dirtycoverage_rebuildidx.bak` | 0.033s | 0.029s | 0.062s |
| `dirtycoverage_rich_insert.bak` | 0.061s | 0.03s | 0.091s |
| `dirtycoverage_rich_update.bak` | 0.053s | 0.032s | 0.085s |
| `dirtycoverage_savepoint.bak` | 0.055s | 0.029s | 0.084s |
| `dirtycoverage_snapshot_update.bak` | 0.063s | 0.028s | 0.091s |
| `dirtycoverage_switch.bak` | 0.033s | 0.034s | 0.067s |
| `dirtycoverage_temporal_update.bak` | 0.055s | 0.03s | 0.085s |
| `dirtycoverage_truncate.bak` | 0.032s | 0.03s | 0.062s |
| `dirtycoverage_two_tx.bak` | 0.059s | 0.035s | 0.094s |
| `dirtycoverage_uncommitted.bak` | 0.056s | 0.03s | 0.086s |
| `dirtycoverage_update.bak` | 0.058s | 0.03s | 0.088s |
| `filtered_ncci_full.bak` | 0.034s | 0.033s | 0.067s |
| `float_extreme_full.bak` | 0.038s | 0.031s | 0.069s |
| `forwarded_records_full.bak` | 0.065s | 0.068s | 0.133s |
| `ghost_records_full.bak` | 0.036s | 0.033s | 0.069s |
| `heapcoverage_large.bak` | 0.03s | 0.04s | 0.07s |
| `heapcoverage_large_50000.bak` | 0.081s | 0.315s | 0.396s |
| `hierarchyid_extract_full.bak` | 0.035s | 0.033s | 0.068s |
| `high_slot_density_full.bak` | 0.045s | 0.189s | 0.234s |
| `identity_coverage_full.bak` | 0.03s | 0.041s | 0.071s |
| `incrementalcoverage_diff_01.bak` | 0.034s | 0.01s | 0.044s |
| `incrementalcoverage_diff_02.bak` | 0.04s | 0.011s | 0.051s |
| `incrementalcoverage_diff_03.bak` | 0.036s | 0.014s | 0.05s |
| `incrementalcoverage_diff_04.bak` | 0.036s | 0.011s | 0.047s |
| `incrementalcoverage_diff_05.bak` | 0.034s | 0.011s | 0.045s |
| `incrementalcoverage_diff_06.bak` | 0.051s | 0.011s | 0.062s |
| `incrementalcoverage_full.bak` | 0.038s | 0.025s | 0.063s |
| `layoutcoverage_full.bak` | 0.129s | 0.322s | 0.451s |
| `max_row_width_full.bak` | 0.028s | 0.03s | 0.058s |
| `mixed_collation_full.bak` | 0.04s | 0.06s | 0.1s |
| `multi_rowgroup_full.bak` | 0.038s | 0.035s | 0.073s |
| `ncci_heap_full.bak` | 0.038s | 0.037s | 0.075s |
| `ncci_types_full.bak` | 0.066s | 0.175s | 0.241s |
| `ndfcoverage_full.bak` | 0.03s | 0.038s | 0.068s |
| `nvarchar_max_u21_full.bak` | 0.031s | 0.034s | 0.065s |
| `pagecomp_anchor_full.bak` | 0.135s | 0.096s | 0.231s |
| `pagecomp_long_prefix_full.bak` | 0.028s | 0.036s | 0.064s |
| `pfor_columnstore_full.bak` | 0.104s | 0.843s | 0.947s |
| `pfor_columnstore_random_full.bak` | 0.097s | 0.827s | 0.924s |
| `realworld_numeric_digest_full.bak` | 0.039s | 0.075s | 0.114s |
| `rowboundary_full.bak` | 0.034s | 0.032s | 0.066s |
| `rowstore_hash_pii_full.bak` | 0.028s | 0.032s | 0.06s |
| `rowstore_lob_image_full.bak` | 0.068s | 0.039s | 0.107s |
| `rowstore_lob_markup_full.bak` | 0.033s | 0.031s | 0.064s |
| `rowversion_extract_full.bak` | 0.037s | 0.036s | 0.073s |
| `sparse_full.bak` | 0.083s | 0.085s | 0.168s |
| `spatial_edge_full.bak` | 0.031s | 0.029s | 0.06s |
...
| `striped_single.bak` | 0.047s | 0.042s | 0.089s |
| `surrogate_pairs_full.bak` | 0.038s | 0.033s | 0.071s |
| `tabletype_cci_large_full.bak` | 0.045s | 0.048s | 0.093s |
| `tabletypecoverage_diff.bak` | 0.1s | 0.062s | 0.162s |
| `tabletypecoverage_full.bak` | 0.071s | 0.074s | 0.145s |
| `temporal_hidden_full.bak` | 0.03s | 0.038s | 0.068s |
| `torn_page_full.bak` | 0.028s | 0.034s | 0.062s |
| `typecoverage_full.bak` | 0.059s | 0.065s | 0.124s |
| `typed_xml_full.bak` | 0.032s | 0.029s | 0.061s |
| `unicode_codepage_coverage.bak` | 0.051s | 0.034s | 0.085s |
| `utf8_collation_full.bak` | 0.032s | 0.03s | 0.062s |
| `xml_index_full.bak` | 0.035s | 0.034s | 0.069s |
| `xmlcoverage_full.bak` | 0.029s | 0.03s | 0.059s |
