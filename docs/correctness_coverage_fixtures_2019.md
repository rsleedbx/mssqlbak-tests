...
|--------|---------|--------|-----------|
| `alias_types_full.bak` | 0.028s | 0.025s | 0.053s |
| `archive_columnstore_partition_full.bak` | 0.861s | 0.588s | 1.449s |
| `archive_columnstore_types_full.bak` | 0.298s | 0.659s | 0.957s |
| `archive_columnstore_types_random_full.bak` | 0.302s | 0.687s | 0.989s |
| `archive_single_chunk_full.bak` | 0.032s | 0.033s | 0.065s |
| `archive_single_chunk_random_full.bak` | 0.032s | 0.028s | 0.06s |
| `archivenull_full.bak` | 0.114s | 0.081s | 0.195s |
| `backup_blocksize_full.bak` | 0.031s | 0.025s | 0.056s |
| `boundarycoverage_datetime_full.bak` | 0.05s | 0.134s | 0.184s |
| `boundarycoverage_full.bak` | 0.044s | 0.051s | 0.095s |
| `catalog_ss2019.bak` | 0.027s | 0.024s | 0.051s |
| `cci_binary_varbinary_compare_full.bak` | 0.032s | 0.026s | 0.058s |
| `cci_bitpack_probe_bigint_full.bak` | 0.639s | 3.556s | 4.195s |
| `cci_bitpack_probe_full.bak` | 0.069s | 0.655s | 0.724s |
| `cci_bitpack_probe_highbase_full.bak` | 0.059s | 0.422s | 0.481s |
| `cci_btree_nci_full.bak` | 0.043s | 0.028s | 0.071s |
| `cci_computed_full.bak` | 0.032s | 0.028s | 0.06s |
| `cci_enc5_largepool_full.bak` | 0.305s | 0.425s | 0.73s |
| `cci_enc5_largepool_matrix_full.bak` | 6.877s | 1.205s | 8.082s |
| `cci_extended_full.bak` | 0.045s | 0.032s | 0.077s |
| `cci_lob_full.bak` | 0.033s | 0.029s | 0.062s |
| `cci_reorganize_full.bak` | 0.039s | 0.031s | 0.07s |
| `cci_string_dict_regression_full.bak` | 0.289s | 0.124s | 0.413s |
| `cci_string_minmax_full.bak` | 0.038s | 0.027s | 0.065s |
| `cci_switch_full.bak` | 0.045s | 0.028s | 0.073s |
| `cci_types_large_full.bak` | 0.045s | 0.032s | 0.077s |
| `cci_varbinary_micro_full.bak` | 0.035s | 0.029s | 0.064s |
| `cci_varbinary_probe_full.bak` | 0.035s | 0.035s | 0.07s |
| `columnstore_minimal.bak` | 0.112s | 0.955s | 1.067s |
| `compressed_nvarchar_full.bak` | 0.031s | 0.024s | 0.055s |
| `compressioncoverage_full.bak` | 0.068s | 0.159s | 0.227s |
| `computedcoverage_full.bak` | 0.032s | 0.03s | 0.062s |
| `constraintcoverage_full.bak` | 0.031s | 0.031s | 0.062s |
| `covering_index_full.bak` | 0.032s | 0.029s | 0.061s |
| `cs_lob_preamble.bak` | 0.063s | 0.055s | 0.118s |
| `delta_rowgroup_full.bak` | 0.033s | 0.025s | 0.058s |
| `dirtycoverage_aborted_xact.bak` | 0.052s | 0.024s | 0.076s |
| `dirtycoverage_addcol.bak` | 0.031s | 0.024s | 0.055s |
| `dirtycoverage_addnotnull.bak` | 0.031s | 0.025s | 0.056s |
| `dirtycoverage_alldirty.bak` | 0.054s | 0.023s | 0.077s |
| `dirtycoverage_altercol.bak` | 0.031s | 0.025s | 0.056s |
| `dirtycoverage_altercol_rewrite.bak` | 0.03s | 0.025s | 0.055s |
| `dirtycoverage_alterdb.bak` | 0.031s | 0.024s | 0.055s |
| `dirtycoverage_cci_delete.bak` | 0.081s | 0.075s | 0.156s |
| `dirtycoverage_cci_update.bak` | 0.19s | 0.083s | 0.273s |
| `dirtycoverage_committed_delete.bak` | 0.027s | 0.025s | 0.052s |
| `dirtycoverage_committed_delete_v2.bak` | 0.033s | 0.026s | 0.059s |
| `dirtycoverage_committed_delete_v3.bak` | 0.038s | 0.045s | 0.083s |
| `dirtycoverage_committed_delete_v4.bak` | 0.148s | 0.056s | 0.204s |
| `dirtycoverage_committed_update.bak` | 0.028s | 0.024s | 0.052s |
| `dirtycoverage_committed_update_v2.bak` | 0.032s | 0.027s | 0.059s |
| `dirtycoverage_committed_update_v3.bak` | 0.041s | 0.066s | 0.107s |
| `dirtycoverage_committed_update_v4.bak` | 0.143s | 0.062s | 0.205s |
| `dirtycoverage_concurrent.bak` | 0.031s | 0.026s | 0.057s |
| `dirtycoverage_createidx.bak` | 0.031s | 0.025s | 0.056s |
| `dirtycoverage_createtable.bak` | 0.03s | 0.025s | 0.055s |
| `dirtycoverage_delete.bak` | 0.053s | 0.025s | 0.078s |
| `dirtycoverage_dropcol.bak` | 0.03s | 0.024s | 0.054s |
| `dirtycoverage_dropidx.bak` | 0.031s | 0.025s | 0.056s |
| `dirtycoverage_droptable.bak` | 0.032s | 0.026s | 0.058s |
| `dirtycoverage_heap_forward.bak` | 0.06s | 0.024s | 0.084s |
| `dirtycoverage_large_dirty.bak` | 0.329s | 0.026s | 0.355s |
| `dirtycoverage_lob_update.bak` | 0.07s | 0.025s | 0.095s |
| `dirtycoverage_maxrow.bak` | 0.029s | 0.025s | 0.054s |
| `dirtycoverage_nchar_delete.bak` | 0.058s | 0.025s | 0.083s |
| `dirtycoverage_nested.bak` | 0.053s | 0.024s | 0.077s |
| `dirtycoverage_null_update.bak` | 0.052s | 0.025s | 0.077s |
| `dirtycoverage_rebuildidx.bak` | 0.031s | 0.025s | 0.056s |
| `dirtycoverage_rich_insert.bak` | 0.053s | 0.025s | 0.078s |
| `dirtycoverage_rich_update.bak` | 0.054s | 0.037s | 0.091s |
| `dirtycoverage_savepoint.bak` | 0.059s | 0.025s | 0.084s |
| `dirtycoverage_snapshot_update.bak` | 0.056s | 0.026s | 0.082s |
| `dirtycoverage_switch.bak` | 0.033s | 0.025s | 0.058s |
| `dirtycoverage_temporal_update.bak` | 0.055s | 0.025s | 0.08s |
| `dirtycoverage_truncate.bak` | 0.033s | 0.025s | 0.058s |
| `dirtycoverage_two_tx.bak` | 0.055s | 0.025s | 0.08s |
| `dirtycoverage_uncommitted.bak` | 0.053s | 0.029s | 0.082s |
| `dirtycoverage_update.bak` | 0.053s | 0.026s | 0.079s |
| `filtered_ncci_full.bak` | 0.033s | 0.028s | 0.061s |
| `float_extreme_full.bak` | 0.03s | 0.025s | 0.055s |
| `forwarded_records_full.bak` | 0.064s | 0.043s | 0.107s |
| `ghost_records_full.bak` | 0.028s | 0.026s | 0.054s |
| `heapcoverage_large.bak` | 0.028s | 0.031s | 0.059s |
| `heapcoverage_large_50000.bak` | 0.078s | 0.295s | 0.373s |
| `hierarchyid_extract_full.bak` | 0.03s | 0.025s | 0.055s |
| `high_slot_density_full.bak` | 0.037s | 0.174s | 0.211s |
| `identity_coverage_full.bak` | 0.031s | 0.028s | 0.059s |
| `incrementalcoverage_diff_01.bak` | 0.042s | 0.012s | 0.054s |
| `incrementalcoverage_diff_02.bak` | 0.041s | 0.008s | 0.049s |
| `incrementalcoverage_diff_03.bak` | 0.034s | 0.008s | 0.042s |
| `incrementalcoverage_diff_04.bak` | 0.035s | 0.008s | 0.043s |
| `incrementalcoverage_diff_05.bak` | 0.033s | 0.008s | 0.041s |
| `incrementalcoverage_diff_06.bak` | 0.038s | 0.008s | 0.046s |
| `incrementalcoverage_full.bak` | 0.027s | 0.025s | 0.052s |
| `layoutcoverage_full.bak` | 0.119s | 0.304s | 0.423s |
| `max_row_width_full.bak` | 0.028s | 0.025s | 0.053s |
| `mixed_collation_full.bak` | 0.028s | 0.024s | 0.052s |
| `multi_rowgroup_full.bak` | 0.033s | 0.028s | 0.061s |
| `ncci_heap_full.bak` | 0.033s | 0.027s | 0.06s |
| `ncci_types_full.bak` | 0.059s | 0.16s | 0.219s |
| `ndfcoverage_full.bak` | 0.038s | 0.025s | 0.063s |
| `nvarchar_max_u21_full.bak` | 0.037s | 0.024s | 0.061s |
| `pagecomp_anchor_full.bak` | 0.119s | 0.085s | 0.204s |
| `pagecomp_long_prefix_full.bak` | 0.027s | 0.024s | 0.051s |
| `pfor_columnstore_full.bak` | 0.092s | 0.814s | 0.906s |
| `pfor_columnstore_random_full.bak` | 0.097s | 0.829s | 0.926s |
| `realworld_numeric_digest_full.bak` | 0.039s | 0.07s | 0.109s |
| `rowboundary_full.bak` | 0.032s | 0.028s | 0.06s |
| `rowstore_hash_pii_full.bak` | 0.027s | 0.025s | 0.052s |
| `rowstore_lob_image_full.bak` | 0.031s | 0.035s | 0.066s |
| `rowstore_lob_markup_full.bak` | 0.028s | 0.025s | 0.053s |
| `rowversion_extract_full.bak` | 0.031s | 0.026s | 0.057s |
| `sparse_full.bak` | 0.08s | 0.08s | 0.16s |
| `spatial_edge_full.bak` | 0.028s | 0.025s | 0.053s |
| `spatial_index_full.bak` | 0.033s | 0.026s | 0.059s |
| `sql_variant_extract_full.bak` | 0.028s | 0.024s | 0.052s |
| `striped_full_1.bak` | 0.042s | 0.016s | 0.058s |
| `striped_single.bak` | 0.044s | 0.04s | 0.084s |
| `surrogate_pairs_full.bak` | 0.027s | 0.024s | 0.051s |
| `tabletype_cci_large_full.bak` | 0.045s | 0.033s | 0.078s |
| `tabletypecoverage_diff.bak` | 0.111s | 0.053s | 0.164s |
| `tabletypecoverage_full.bak` | 0.073s | 0.081s | 0.154s |
| `temporal_hidden_full.bak` | 0.029s | 0.027s | 0.056s |
| `torn_page_full.bak` | 0.028s | 0.025s | 0.053s |
| `typecoverage_full.bak` | 0.056s | 0.05s | 0.106s |
| `typed_xml_full.bak` | 0.03s | 0.025s | 0.055s |
| `unicode_codepage_coverage.bak` | 0.044s | 0.04s | 0.084s |
| `utf8_collation_full.bak` | 0.027s | 0.026s | 0.053s |
| `xml_index_full.bak` | 0.033s | 0.034s | 0.067s |
| `xmlcoverage_full.bak` | 0.028s | 0.024s | 0.052s |
| `xmlheap_full.bak` | 0.046s | 0.039s | 0.085s |
