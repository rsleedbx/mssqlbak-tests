...
|--------|---------|--------|-----------|
| `alias_types_full.bak` | 0.028s | 0.031s | 0.059s |
| `archive_columnstore_partition_full.bak` | 0.846s | 0.858s | 1.704s |
| `archive_columnstore_types_full.bak` | 0.298s | 0.639s | 0.937s |
| `archive_columnstore_types_random_full.bak` | 0.293s | 0.638s | 0.931s |
| `archive_single_chunk_full.bak` | 0.041s | 0.028s | 0.069s |
| `archive_single_chunk_random_full.bak` | 0.066s | 0.04s | 0.106s |
| `archivenull_full.bak` | 0.119s | 0.096s | 0.215s |
| `backup_blocksize_full.bak` | 0.031s | 0.026s | 0.057s |
| `boundarycoverage_datetime_full.bak` | 0.05s | 0.17s | 0.22s |
| `boundarycoverage_full.bak` | 0.043s | 0.075s | 0.118s |
| `catalog_ss2019.bak` | 0.028s | 0.028s | 0.056s |
| `cci_binary_varbinary_compare_full.bak` | 0.032s | 0.033s | 0.065s |
| `cci_bitpack_probe_bigint_full.bak` | 0s | 5.683s | 5.683s |
| `cci_bitpack_probe_full.bak` | 0s | 0.613s | 0.613s |
| `cci_bitpack_probe_highbase_full.bak` | 0s | 0.555s | 0.555s |
| `cci_btree_nci_full.bak` | 0.039s | 0.029s | 0.068s |
| `cci_computed_full.bak` | 0.033s | 0.027s | 0.06s |
| `cci_enc5_largepool_full.bak` | 0.307s | 0.449s | 0.756s |
| `cci_enc5_largepool_matrix_full.bak` | 6.831s | 1.345s | 8.176s |
| `cci_extended_full.bak` | 0.046s | 0.032s | 0.078s |
| `cci_lob_full.bak` | 0.033s | 0.031s | 0.064s |
| `cci_reorganize_full.bak` | 0.041s | 0.029s | 0.07s |
| `cci_string_dict_regression_full.bak` | 0.282s | 0.127s | 0.409s |
| `cci_string_minmax_full.bak` | 0.039s | 0.029s | 0.068s |
| `cci_switch_full.bak` | 0.051s | 0.036s | 0.087s |
| `cci_types_large_full.bak` | 0.05s | 0.032s | 0.082s |
| `cci_varbinary_micro_full.bak` | 0.041s | 0.032s | 0.073s |
| `cci_varbinary_probe_full.bak` | 0.036s | 0.033s | 0.069s |
| `columnstore_minimal.bak` | 0.098s | 0.768s | 0.866s |
| `compressed_nvarchar_full.bak` | 0.033s | 0.048s | 0.081s |
| `compressioncoverage_full.bak` | 0.068s | 0.171s | 0.239s |
| `computedcoverage_full.bak` | 0.028s | 0.031s | 0.059s |
| `constraintcoverage_full.bak` | 0.043s | 0.043s | 0.086s |
| `covering_index_full.bak` | 0.031s | 0.036s | 0.067s |
| `cs_lob_preamble.bak` | 0.069s | 0.057s | 0.126s |
| `delta_rowgroup_full.bak` | 0.037s | 0.03s | 0.067s |
| `dirtycoverage_aborted_xact.bak` | 0.051s | 0.025s | 0.076s |
| `dirtycoverage_addcol.bak` | 0.032s | 0.03s | 0.062s |
| `dirtycoverage_addnotnull.bak` | 0.032s | 0.032s | 0.064s |
| `dirtycoverage_alldirty.bak` | 0.054s | 0.024s | 0.078s |
| `dirtycoverage_altercol.bak` | 0.028s | 0.03s | 0.058s |
| `dirtycoverage_altercol_rewrite.bak` | 0.055s | 0.041s | 0.096s |
| `dirtycoverage_alterdb.bak` | 0.031s | 0.025s | 0.056s |
| `dirtycoverage_cci_delete.bak` | 0.093s | 0.076s | 0.169s |
| `dirtycoverage_cci_update.bak` | 0.193s | 0.085s | 0.278s |
| `dirtycoverage_committed_delete.bak` | 0.028s | 0.041s | 0.069s |
| `dirtycoverage_committed_delete_v2.bak` | 0.043s | 0.034s | 0.077s |
| `dirtycoverage_committed_delete_v3.bak` | 0.047s | 0.054s | 0.101s |
| `dirtycoverage_committed_delete_v4.bak` | 0.14s | 0.137s | 0.277s |
| `dirtycoverage_committed_update.bak` | 0.028s | 0.031s | 0.059s |
| `dirtycoverage_committed_update_v2.bak` | 0.049s | 0.03s | 0.079s |
| `dirtycoverage_committed_update_v3.bak` | 0.041s | 0.075s | 0.116s |
| `dirtycoverage_committed_update_v4.bak` | 0.146s | 0.125s | 0.271s |
| `dirtycoverage_concurrent.bak` | 0.04s | 0.029s | 0.069s |
| `dirtycoverage_createidx.bak` | 0.032s | 0.031s | 0.063s |
| `dirtycoverage_createtable.bak` | 0.031s | 0.031s | 0.062s |
| `dirtycoverage_delete.bak` | 0.053s | 0.025s | 0.078s |
| `dirtycoverage_dropcol.bak` | 0.037s | 0.025s | 0.062s |
| `dirtycoverage_dropidx.bak` | 0.041s | 0.03s | 0.071s |
| `dirtycoverage_droptable.bak` | 0.032s | 0.029s | 0.061s |
| `dirtycoverage_heap_forward.bak` | 0.051s | 0.026s | 0.077s |
| `dirtycoverage_large_dirty.bak` | 0.331s | 0.029s | 0.36s |
| `dirtycoverage_lob_update.bak` | 0.078s | 0.031s | 0.109s |
| `dirtycoverage_maxrow.bak` | 0.029s | 0.035s | 0.064s |
| `dirtycoverage_nchar_delete.bak` | 0.054s | 0.024s | 0.078s |
| `dirtycoverage_nested.bak` | 0.058s | 0.025s | 0.083s |
| `dirtycoverage_null_update.bak` | 0.052s | 0.024s | 0.076s |
| `dirtycoverage_rebuildidx.bak` | 0.039s | 0.03s | 0.069s |
| `dirtycoverage_rich_insert.bak` | 0.053s | 0.028s | 0.081s |
| `dirtycoverage_rich_update.bak` | 0.052s | 0.026s | 0.078s |
| `dirtycoverage_savepoint.bak` | 0.063s | 0.029s | 0.092s |
| `dirtycoverage_snapshot_update.bak` | 0.05s | 0.025s | 0.075s |
| `dirtycoverage_switch.bak` | 0.047s | 0.06s | 0.107s |
| `dirtycoverage_temporal_update.bak` | 0.055s | 0.025s | 0.08s |
| `dirtycoverage_truncate.bak` | 0.041s | 0.038s | 0.079s |
| `dirtycoverage_two_tx.bak` | 0.059s | 0.036s | 0.095s |
| `dirtycoverage_uncommitted.bak` | 0.055s | 0.025s | 0.08s |
| `dirtycoverage_update.bak` | 0.054s | 0.026s | 0.08s |
| `filtered_ncci_full.bak` | 0.041s | 0.034s | 0.075s |
| `float_extreme_full.bak` | 0.031s | 0.034s | 0.065s |
| `forwarded_records_full.bak` | 0.064s | 0.058s | 0.122s |
| `ghost_records_full.bak` | 0.028s | 0.032s | 0.06s |
| `heapcoverage_large.bak` | 0.037s | 0.045s | 0.082s |
| `heapcoverage_large_50000.bak` | 0.076s | 0.437s | 0.513s |
| `hierarchyid_extract_full.bak` | 0.031s | 0.032s | 0.063s |
| `high_slot_density_full.bak` | 0.037s | 0.22s | 0.257s |
| `incrementalcoverage_diff_01.bak` | 0.035s | 0.011s | 0.046s |
| `incrementalcoverage_diff_02.bak` | 0.039s | 0.011s | 0.05s |
| `incrementalcoverage_diff_03.bak` | 0.036s | 0.009s | 0.045s |
| `incrementalcoverage_diff_04.bak` | 0.037s | 0.01s | 0.047s |
| `incrementalcoverage_diff_05.bak` | 0.032s | 0.011s | 0.043s |
| `incrementalcoverage_diff_06.bak` | 0.039s | 0.011s | 0.05s |
| `incrementalcoverage_full.bak` | 0.027s | 0.034s | 0.061s |
| `layoutcoverage_full.bak` | 0.115s | 0.198s | 0.313s |
| `max_row_width_full.bak` | 0.027s | 0.03s | 0.057s |
| `mixed_collation_full.bak` | 0.028s | 0.031s | 0.059s |
| `multi_rowgroup_full.bak` | 0.041s | 0.034s | 0.075s |
| `ncci_heap_full.bak` | 0.037s | 0.032s | 0.069s |
| `ncci_types_full.bak` | 0.056s | 0.215s | 0.271s |
| `ndfcoverage_full.bak` | 0.03s | 0.032s | 0.062s |
| `nvarchar_max_u21_full.bak` | 0.031s | 0.03s | 0.061s |
| `pagecomp_anchor_full.bak` | 0.119s | 0.14s | 0.259s |
| `pagecomp_long_prefix_full.bak` | 0.028s | 0.03s | 0.058s |
| `pfor_columnstore_full.bak` | 0.103s | 1.08s | 1.183s |
| `pfor_columnstore_random_full.bak` | 0.092s | 1.055s | 1.147s |
| `realworld_numeric_digest_full.bak` | 0.038s | 0.088s | 0.126s |
| `rowboundary_full.bak` | 0.037s | 0.037s | 0.074s |
| `rowstore_hash_pii_full.bak` | 0.028s | 0.03s | 0.058s |
| `rowstore_lob_image_full.bak` | 0.031s | 0.029s | 0.06s |
| `rowstore_lob_markup_full.bak` | 0.032s | 0.029s | 0.061s |
| `rowversion_extract_full.bak` | 0.031s | 0.031s | 0.062s |
| `sparse_full.bak` | 0.081s | 0.13s | 0.211s |
| `spatial_edge_full.bak` | 0.029s | 0.031s | 0.06s |
| `spatial_index_full.bak` | 0.04s | 0.032s | 0.072s |
| `sql_variant_extract_full.bak` | 0.028s | 0.029s | 0.057s |
| `striped_full_1.bak` | 0.043s | 0.013s | 0.056s |
| `striped_single.bak` | 0.04s | 0.041s | 0.081s |
| `surrogate_pairs_full.bak` | 0.028s | 0.03s | 0.058s |
| `tabletype_cci_large_full.bak` | 0.045s | 0.036s | 0.081s |
| `tabletypecoverage_diff.bak` | 0.101s | 0.06s | 0.161s |
| `tabletypecoverage_full.bak` | 0.066s | 0.076s | 0.142s |
| `temporal_hidden_full.bak` | 0.033s | 0.033s | 0.066s |
| `torn_page_full.bak` | 0.028s | 0.032s | 0.06s |
| `typecoverage_full.bak` | 0.062s | 0.062s | 0.124s |
| `typed_xml_full.bak` | 0.032s | 0.03s | 0.062s |
| `unicode_codepage_coverage.bak` | 0.046s | 0.033s | 0.079s |
| `utf8_collation_full.bak` | 0.032s | 0.036s | 0.068s |
| `xml_index_full.bak` | 0.033s | 0.034s | 0.067s |
| `xmlcoverage_full.bak` | 0.028s | 0.031s | 0.059s |
| `xmlheap_full.bak` | 0.049s | 0.045s | 0.094s |
