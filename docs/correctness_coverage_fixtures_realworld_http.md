...
|--------|---------|--------|-----------|
| `AdventureWorks2008R2.bak` | 13.344s | 9.245s | 22.589s |
| `AdventureWorks2012.bak` | 14.81s | 9.951s | 24.761s |
| `AdventureWorks2014.bak` | 14.868s | 9.974s | 24.842s |
| `AdventureWorks2016.bak` | 14.084s | 10.124s | 24.208s |
| `AdventureWorks2016_EXT.bak` | 36.405s | 19.578s | 55.983s |
| `AdventureWorks2017.bak` | 14.313s | 10.193s | 24.506s |
| `AdventureWorks2019.bak` | 13.847s | 9.354s | 23.201s |
| `AdventureWorks2022.bak` | 13.565s | 9.092s | 22.657s |
| `AdventureWorks2025.bak` | 14.013s | 10.292s | 24.305s |
| `AdventureWorksDW2008R2.bak` | 2.133s | 3.011s | 5.144s |
| `AdventureWorksDW2012.bak` | 3.579s | 9.613s | 13.192s |
| `AdventureWorksDW2014.bak` | 3.672s | 9.59s | 13.262s |
| `AdventureWorksDW2016.bak` | 3.798s | 9.46s | 13.258s |
| `AdventureWorksDW2016_EXT.bak` | 94.911s | 31.521s | 126.432s |
| `AdventureWorksDW2017.bak` | 3.976s | 9.969s | 13.945s |
| `AdventureWorksDW2019.bak` | 5.271s | 9.812s | 15.083s |
| `AdventureWorksDW2022.bak` | 3.833s | 9.458s | 13.291s |
| `AdventureWorksDW2025.bak` | 3.892s | 9.571s | 13.463s |
| `AdventureWorksLT2012.bak` | 0.141s | 0.1s | 0.241s |
| `AdventureWorksLT2014.bak` | 0.15s | 0.094s | 0.244s |
| `AdventureWorksLT2016.bak` | 0.139s | 0.095s | 0.234s |
| `AdventureWorksLT2017.bak` | 0.142s | 0.1s | 0.242s |
| `AdventureWorksLT2019.bak` | 0.161s | 0.096s | 0.257s |
| `AdventureWorksLT2022.bak` | 0.165s | 0.118s | 0.283s |
| `AdventureWorksLT2025.bak` | 0.204s | 0.131s | 0.335s |
| `BaseballData.bak` | 9.963s | 4.233s | 14.196s |
| `Chinook-id-pk.bak` | 0.102s | 0.116s | 0.218s |
| `Chinook.bak` | 0.089s | 0.12s | 0.209s |
| `ContosoRetailDW.bak` | 74.323s | 367.038s | 441.361s |
| `CreditBackup100.bak` | 14.131s | 18.037s | 32.168s |
| `data.gov.bak` | 2.273s | 1.542s | 3.815s |
| `dba.stackexchange.com.bak` | 96.393s | 28.236s | 124.629s |
| `EmployeeCaseStudySampleDB2012.bak` | 5.4s | 0.781s | 6.181s |
| `GeneralHospital.bak` | 35.702s | 17.831s | 53.533s |
| `IndexInternals2008.bak` | 4.617s | 0.571s | 5.188s |
| `NYCTaxi_Sample.bak` | 17.172s | 34.762s | 51.934s |
| `Pubs.bak` | 0.102s | 0.069s | 0.171s |
| `SalesDB2014.bak` | 6.47s | 21.651s | 28.121s |
| `SalesDBOriginal.bak` | 5.922s | 19.648s | 25.57s |
| `StackOverflowMini.bak` | 75.086s | 67.432s | 142.518s |
| `tpcxbb_1gb.bak` | 56.279s | 81.94s | 138.219s |
| `TutorialDB.bak` | 0.06s | 0.053s | 0.113s |
| `WideWorldImporters-Full.bak` | 31.832s | 40.388s | 72.22s |
| `WideWorldImporters-Full_old.bak` | 31.168s | 41.304s | 72.472s |
| `WideWorldImporters-Standard.bak` | 35.995s | 38.591s | 74.586s |
| `WideWorldImporters-Standard_old.bak` | 35.718s | 38.864s | 74.582s |
| `WideWorldImportersDW-Full.bak` | 6.554s | 13.537s | 20.091s |
| `WideWorldImportersDW-Standard.bak` | 5.483s | 12.529s | 18.012s |
