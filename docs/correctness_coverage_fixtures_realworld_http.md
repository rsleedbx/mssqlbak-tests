...
| Backup | Wall time |
|--------|-------------|
| `AdventureWorks2008R2.bak` | 41.55s |
| `AdventureWorks2012.bak` | 43.335s |
| `AdventureWorks2014.bak` | 42.142s |
| `AdventureWorks2016.bak` | 43.738s |
| `AdventureWorks2016_EXT.bak` | 153.008s |
| `AdventureWorks2017.bak` | 43.591s |
| `AdventureWorks2019.bak` | 41.67s |
| `AdventureWorks2022.bak` | 39.774s |
| `AdventureWorks2025.bak` | 43.623s |
| `AdventureWorksDW2008R2.bak` | 16.307s |
| `AdventureWorksDW2012.bak` | 40.485s |
| `AdventureWorksDW2014.bak` | 41.124s |
| `AdventureWorksDW2016.bak` | 41.276s |
| `AdventureWorksDW2016_EXT.bak` | 374.368s |
| `AdventureWorksDW2017.bak` | 40.893s |
| `AdventureWorksDW2019.bak` | 38.935s |
| `AdventureWorksDW2022.bak` | 39.084s |
| `AdventureWorksDW2025.bak` | 40.977s |
| `AdventureWorksLT2012.bak` | 0.321s |
| `AdventureWorksLT2014.bak` | 0.334s |
| `AdventureWorksLT2016.bak` | 0.311s |
| `AdventureWorksLT2017.bak` | 0.316s |
| `AdventureWorksLT2019.bak` | 0.323s |
| `AdventureWorksLT2022.bak` | 0.321s |
| `AdventureWorksLT2025.bak` | 0.431s |
| `BaseballData.bak` | 38.229s |
| `Chinook-id-pk.bak` | 0.426s |
| `Chinook.bak` | 0.383s |
| `ContosoRetailDW.bak` | 1260.241s |
| `CreditBackup100.bak` | 47.095s |
| `data.gov.bak` | 4.575s |
| `dba.stackexchange.com.bak` | 97.091s |
| `EmployeeCaseStudySampleDB2012.bak` | 10.648s |
| `GeneralHospital.bak` | 63.417s |
| `IndexInternals2008.bak` | 5.927s |
| `NYCTaxi_Sample.bak` | 63.488s |
| `Pubs.bak` | 0.175s |
| `SalesDB2014.bak` | 56.08s |
| `SalesDBOriginal.bak` | 54.836s |
| `StackOverflowMini.bak` | 205.026s |
| `tpcxbb_1gb.bak` | 300.994s |
| `TutorialDB.bak` | 0.111s |
| `WideWorldImporters-Full.bak` | 124.008s |
| `WideWorldImporters-Full_old.bak` | 125.225s |
| `WideWorldImporters-Standard.bak` | 112.917s |
| `WideWorldImporters-Standard_old.bak` | 115.353s |
| `WideWorldImportersDW-Full.bak` | 78.165s |
| `WideWorldImportersDW-Standard.bak` | 74.952s |
