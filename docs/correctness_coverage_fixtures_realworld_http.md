...
|--------|---------|--------|-----------|
| `AdventureWorks2008R2.bak` | 14.319s | 20.063s | 34.382s |
| `AdventureWorks2012.bak` | 15.097s | 21.685s | 36.782s |
| `AdventureWorks2014.bak` | 15.313s | 21.321s | 36.634s |
| `AdventureWorks2016.bak` | 13.773s | 20.994s | 34.767s |
| `AdventureWorks2016_EXT.bak` | 33.571s | 36.712s | 70.283s |
| `AdventureWorks2017.bak` | 13.906s | 21.196s | 35.102s |
| `AdventureWorks2019.bak` | 14.36s | 20.381s | 34.741s |
| `AdventureWorks2022.bak` | 14.452s | 20.631s | 35.083s |
| `AdventureWorks2025.bak` | 14.382s | 22.1s | 36.482s |
| `AdventureWorksDW2008R2.bak` | 2.182s | 8.855s | 11.037s |
| `AdventureWorksDW2012.bak` | 3.683s | 22.249s | 25.932s |
| `AdventureWorksDW2014.bak` | 3.732s | 23.183s | 26.915s |
| `AdventureWorksDW2016.bak` | 3.709s | 22.658s | 26.367s |
| `AdventureWorksDW2016_EXT.bak` | 94.122s | 47.014s | 141.136s |
| `AdventureWorksDW2017.bak` | 3.775s | 23.095s | 26.87s |
| `AdventureWorksDW2019.bak` | 4.888s | 21.999s | 26.887s |
| `AdventureWorksDW2022.bak` | 3.572s | 22.518s | 26.09s |
| `AdventureWorksDW2025.bak` | 3.377s | 23.037s | 26.414s |
| `AdventureWorksLT2012.bak` | 0.147s | 0.2s | 0.347s |
| `AdventureWorksLT2014.bak` | 0.153s | 0.152s | 0.305s |
| `AdventureWorksLT2016.bak` | 0.141s | 0.152s | 0.293s |
| `AdventureWorksLT2017.bak` | 0.141s | 0.18s | 0.321s |
| `AdventureWorksLT2019.bak` | 0.162s | 0.152s | 0.314s |
| `AdventureWorksLT2022.bak` | 0.174s | 0.156s | 0.33s |
| `AdventureWorksLT2025.bak` | 0.207s | 0.193s | 0.4s |
| `BaseballData.bak` | 10.027s | 16.151s | 26.178s |
| `Chinook-id-pk.bak` | 0.1s | 0.191s | 0.291s |
| `Chinook.bak` | 0.087s | 0.186s | 0.273s |
| `ContosoRetailDW.bak` | 73.816s | 453.084s | 526.9s |
| `CreditBackup100.bak` | 14.195s | 17.339s | 31.534s |
| `data.gov.bak` | 2.268s | 1.877s | 4.145s |
| `dba.stackexchange.com.bak` | 96.955s | 33.099s | 130.054s |
| `EmployeeCaseStudySampleDB2012.bak` | 5.519s | 4.654s | 10.173s |
| `GeneralHospital.bak` | 33.662s | 25.361s | 59.023s |
| `IndexInternals2008.bak` | 4.459s | 2.509s | 6.968s |
| `NYCTaxi_Sample.bak` | 15.236s | 36.647s | 51.883s |
| `Pubs.bak` | 0.102s | 0.072s | 0.174s |
| `SalesDB2014.bak` | 6.828s | 20.23s | 27.058s |
| `SalesDBOriginal.bak` | 6.727s | 18.196s | 24.923s |
| `StackOverflowMini.bak` | 74.311s | 84.051s | 158.362s |
| `tpcxbb_1gb.bak` | 56.138s | 129.061s | 185.199s |
| `TutorialDB.bak` | 0.063s | 0.047s | 0.11s |
| `WideWorldImporters-Full.bak` | 30.548s | 58.422s | 88.97s |
| `WideWorldImporters-Full_old.bak` | 30.677s | 58.718s | 89.395s |
| `WideWorldImporters-Standard.bak` | 34.567s | 59.192s | 93.759s |
| `WideWorldImporters-Standard_old.bak` | 34.81s | 60.275s | 95.085s |
| `WideWorldImportersDW-Full.bak` | 6.393s | 37.22s | 43.613s |
| `WideWorldImportersDW-Standard.bak` | 5.603s | 37.402s | 43.005s |
