...
**Generated** by `python -m tools.correctness_coverage --fixture-dir tests/fixtures_realworld tests/fixtures_realworld/AdventureWorksDW2016_EXT.bak`.
...
|--------|---------|--------|-----------|
| `AdventureWorksDW2016_EXT.bak` | 91.153s | 51.205s | 142.358s |
