...
|--------|---------|--------|-----------|
| `alias_types_full.bak` | 0.034s | 0.036s | 0.07s |
| `archive_columnstore_partition_full.bak` | 0.845s | 0.586s | 1.431s |
| `archive_columnstore_types_full.bak` | 0.312s | 0.676s | 0.988s |
| `archive_columnstore_types_random_full.bak` | 0.315s | 0.661s | 0.976s |
| `archive_single_chunk_full.bak` | 0.041s | 0.037s | 0.078s |
| `archive_single_chunk_random_full.bak` | 0.04s | 0.037s | 0.077s |
| `archivenull_full.bak` | 0.119s | 0.081s | 0.2s |
| `backup_blocksize_full.bak` | 0.035s | 0.034s | 0.069s |
| `boundarycoverage_datetime_full.bak` | 0.057s | 0.138s | 0.195s |
| `boundarycoverage_full.bak` | 0.061s | 0.081s | 0.142s |
| `catalog_ss2022.bak` | 0.036s | 0.034s | 0.07s |
| `cci_binary_varbinary_compare_full.bak` | 0.039s | 0.037s | 0.076s |
| `cci_bitpack_probe_bigint_full.bak` | 0.259s | 3.635s | 3.894s |
| `cci_bitpack_probe_full.bak` | 0.082s | 0.629s | 0.711s |
| `cci_bitpack_probe_highbase_full.bak` | 0.063s | 0.418s | 0.481s |
| `cci_btree_nci_full.bak` | 0.041s | 0.038s | 0.079s |
| `cci_computed_full.bak` | 0.042s | 0.037s | 0.079s |
| `cci_enc5_largepool_full.bak` | 0.312s | 0.414s | 0.726s |
| `cci_enc5_largepool_matrix_full.bak` | 6.825s | 1.22s | 8.045s |
| `cci_extended_full.bak` | 0.065s | 0.053s | 0.118s |
| `cci_lob_full.bak` | 0.044s | 0.042s | 0.086s |
| `cci_reorganize_full.bak` | 0.038s | 0.042s | 0.08s |
| `cci_string_dict_regression_full.bak` | 0.283s | 0.132s | 0.415s |
| `cci_string_minmax_full.bak` | 0.041s | 0.037s | 0.078s |
| `cci_switch_full.bak` | 0.037s | 0.041s | 0.078s |
| `cci_types_large_full.bak` | 0.052s | 0.07s | 0.122s |
| `cci_varbinary_micro_full.bak` | 0.041s | 0.036s | 0.077s |
| `cci_varbinary_probe_full.bak` | 0.036s | 0.045s | 0.081s |
| `columnstore_minimal.bak` | 0.099s | 0.871s | 0.97s |
| `compressed_nvarchar_full.bak` | 0.034s | 0.033s | 0.067s |
| `compressioncoverage_full.bak` | 0.079s | 0.185s | 0.264s |
| `computedcoverage_full.bak` | 0.032s | 0.034s | 0.066s |
| `constraintcoverage_full.bak` | 0.037s | 0.04s | 0.077s |
| `corrupt_metadata_confidence_full.bak` | 0s | 0.001s | 0.001s |
| `covering_index_full.bak` | 0.046s | 0.039s | 0.085s |
| `cs_lob_preamble.bak` | 0.117s | 0.079s | 0.196s |
| `cs_lob_preamble2.bak` | 0.087s | 0.058s | 0.145s |
| `delta_rowgroup_full.bak` | 0.033s | 0.035s | 0.068s |
| `dirtycoverage_aborted_xact.bak` | 0.057s | 0.033s | 0.09s |
| `dirtycoverage_addcol.bak` | 0.034s | 0.034s | 0.068s |
| `dirtycoverage_addnotnull.bak` | 0.035s | 0.034s | 0.069s |
| `dirtycoverage_alldirty.bak` | 0.058s | 0.038s | 0.096s |
| `dirtycoverage_altercol.bak` | 0.035s | 0.033s | 0.068s |
| `dirtycoverage_altercol_rewrite.bak` | 0.034s | 0.039s | 0.073s |
| `dirtycoverage_alterdb.bak` | 0.034s | 0.037s | 0.071s |
| `dirtycoverage_cci_delete.bak` | 0.086s | 0.088s | 0.174s |
| `dirtycoverage_cci_update.bak` | 0.19s | 0.091s | 0.281s |
| `dirtycoverage_committed_delete.bak` | 0.035s | 0.034s | 0.069s |
| `dirtycoverage_committed_delete_v2.bak` | 0.47s | 0.475s | 0.945s |
| `dirtycoverage_committed_delete_v3.bak` | 0.049s | 0.065s | 0.114s |
| `dirtycoverage_committed_delete_v4.bak` | 0.142s | 0.058s | 0.2s |
| `dirtycoverage_committed_update.bak` | 0.031s | 0.032s | 0.063s |
| `dirtycoverage_committed_update_v2.bak` | 8.611s | 0.908s | 9.519s |
| `dirtycoverage_committed_update_v3.bak` | 0.042s | 0.067s | 0.109s |
| `dirtycoverage_committed_update_v4.bak` | 0.099s | 0.072s | 0.171s |
| `dirtycoverage_compress_update.bak` | 0.067s | 0.035s | 0.102s |
| `dirtycoverage_concurrent.bak` | 0.035s | 0.039s | 0.074s |
| `dirtycoverage_createidx.bak` | 0.035s | 0.045s | 0.08s |
| `dirtycoverage_createtable.bak` | 0.035s | 0.035s | 0.07s |
| `dirtycoverage_delete.bak` | 0.063s | 0.038s | 0.101s |
| `dirtycoverage_dropcol.bak` | 0.039s | 0.041s | 0.08s |
| `dirtycoverage_dropidx.bak` | 0.035s | 0.034s | 0.069s |
| `dirtycoverage_droptable.bak` | 0.037s | 0.039s | 0.076s |
| `dirtycoverage_heap_forward.bak` | 0.063s | 0.039s | 0.102s |
| `dirtycoverage_insert_update.bak` | 0.065s | 0.041s | 0.106s |
| `dirtycoverage_large_dirty.bak` | 0.327s | 0.032s | 0.359s |
| `dirtycoverage_lob_update.bak` | 0.076s | 0.038s | 0.114s |
| `dirtycoverage_maxrow.bak` | 0.031s | 0.036s | 0.067s |
| `dirtycoverage_multi_update.bak` | 0.066s | 0.053s | 0.119s |
| `dirtycoverage_nchar_delete.bak` | 0.062s | 0.039s | 0.101s |
| `dirtycoverage_nested.bak` | 0.063s | 0.033s | 0.096s |
| `dirtycoverage_null_update.bak` | 0.062s | 0.037s | 0.099s |
| `dirtycoverage_rebuildidx.bak` | 0.035s | 0.044s | 0.079s |
| `dirtycoverage_rich_insert.bak` | 0.059s | 0.037s | 0.096s |
| `dirtycoverage_rich_update.bak` | 0.063s | 0.038s | 0.101s |
| `dirtycoverage_savepoint.bak` | 0.065s | 0.035s | 0.1s |
| `dirtycoverage_snapshot_update.bak` | 0.06s | 0.033s | 0.093s |
| `dirtycoverage_switch.bak` | 0.036s | 0.036s | 0.072s |
| `dirtycoverage_temporal_update.bak` | 0.066s | 0.034s | 0.1s |
| `dirtycoverage_truncate.bak` | 0.036s | 0.035s | 0.071s |
| `dirtycoverage_two_tx.bak` | 0.058s | 0.033s | 0.091s |
| `dirtycoverage_uncommitted.bak` | 0.063s | 0.037s | 0.1s |
| `dirtycoverage_update.bak` | 0.065s | 0.035s | 0.1s |
| `dirtycoverage_wide.bak` | 0.062s | 0.039s | 0.101s |
| `featurecoverage_full.bak` | 0.105s | 0.056s | 0.161s |
| `filtered_ncci_full.bak` | 0.037s | 0.037s | 0.074s |
| `float_extreme_full.bak` | 0.031s | 0.032s | 0.063s |
| `forwarded_records_full.bak` | 0.074s | 0.082s | 0.156s |
| `geocoverage_full.bak` | 0.042s | 0.047s | 0.089s |
| `geotest.bak` | 0.035s | 0.044s | 0.079s |
| `ghost_records_full.bak` | 0.031s | 0.038s | 0.069s |
| `heapcoverage_large.bak` | 0.033s | 0.038s | 0.071s |
| `heapcoverage_large_50000.bak` | 0.082s | 0.305s | 0.387s |
| `hierarchyid_extract_full.bak` | 0.031s | 0.033s | 0.064s |
| `high_slot_density_full.bak` | 0.041s | 0.184s | 0.225s |
| `identity_coverage_full.bak` | 0.039s | 0.041s | 0.08s |
| `incrementalcoverage_diff_01.bak` | 0.038s | 0.012s | 0.05s |
| `incrementalcoverage_diff_02.bak` | 0.037s | 0.012s | 0.049s |
| `incrementalcoverage_diff_03.bak` | 0.038s | 0.012s | 0.05s |
| `incrementalcoverage_diff_04.bak` | 0.038s | 0.012s | 0.05s |
| `incrementalcoverage_diff_05.bak` | 0.038s | 0.011s | 0.049s |
| `incrementalcoverage_diff_06.bak` | 0.039s | 0.013s | 0.052s |
| `incrementalcoverage_full.bak` | 0.031s | 0.033s | 0.064s |
| `layoutcoverage_full.bak` | 0.125s | 0.304s | 0.429s |
| `legacytext.bak` | 0.046s | 0.056s | 0.102s |
| `max_row_width_full.bak` | 0.031s | 0.032s | 0.063s |
| `mixed_collation_full.bak` | 0.031s | 0.034s | 0.065s |
| `multi_rowgroup_full.bak` | 0.037s | 0.038s | 0.075s |
| `ncci_heap_full.bak` | 0.032s | 0.035s | 0.067s |
| `ncci_types_full.bak` | 0.06s | 0.161s | 0.221s |
| `ndfcoverage_full.bak` | 0.035s | 0.047s | 0.082s |
| `nvarchar_max_u21_full.bak` | 0.031s | 0.031s | 0.062s |
| `ordered_cci_full.bak` | 0.035s | 0.041s | 0.076s |
| `pagecomp_anchor_full.bak` | 0.122s | 0.086s | 0.208s |
| `pagecomp_long_prefix_full.bak` | 0.034s | 0.034s | 0.068s |
| `pfor_columnstore_full.bak` | 0.092s | 0.802s | 0.894s |
| `pfor_columnstore_random_full.bak` | 0.092s | 0.821s | 0.913s |
| `realworld_numeric_digest_full.bak` | 0.046s | 0.102s | 0.148s |
| `rowboundary_full.bak` | 0.034s | 0.036s | 0.07s |
| `rowstore_hash_pii_full.bak` | 0.032s | 0.032s | 0.064s |
| `rowstore_lob_image_full.bak` | 0.031s | 0.034s | 0.065s |
| `rowstore_lob_markup_full.bak` | 0.032s | 0.032s | 0.064s |
| `rowversion_extract_full.bak` | 0.042s | 0.034s | 0.076s |
| `sparse_full.bak` | 0.083s | 0.088s | 0.171s |
| `spatial_edge_full.bak` | 0.035s | 0.036s | 0.071s |
| `spatial_index_full.bak` | 0.038s | 0.036s | 0.074s |
| `sql_variant_extract_full.bak` | 0.034s | 0.034s | 0.068s |
| `striped_full_1.bak` | 0.047s | 0.013s | 0.06s |
| `striped_single.bak` | 0.046s | 0.047s | 0.093s |
| `surrogate_pairs_full.bak` | 0.031s | 0.033s | 0.064s |
| `tabletype_cci_large_full.bak` | 0.05s | 0.049s | 0.099s |
| `tabletypecoverage_diff.bak` | 0.101s | 0.075s | 0.176s |
| `tabletypecoverage_full.bak` | 0.071s | 0.088s | 0.159s |
| `temporal_hidden_full.bak` | 0.037s | 0.039s | 0.076s |
| `torn_page_full.bak` | 0.028s | 0.029s | 0.057s |
| `typecoverage_full.bak` | 0.063s | 0.076s | 0.139s |
| `typecoverage_full_compressed.bak` | 0.087s | 0.098s | 0.185s |
| `typed_xml_full.bak` | 0.034s | 0.035s | 0.069s |
| `unicode_codepage_coverage.bak` | 0.054s | 0.068s | 0.122s |
| `utf8_collation_full.bak` | 0.031s | 0.034s | 0.065s |
| `xml_index_full.bak` | 0.037s | 0.036s | 0.073s |
| `xmlcoverage_full.bak` | 0.034s | 0.035s | 0.069s |
| `xmlheap_full.bak` | 0.05s | 0.078s | 0.128s |
| `xtp_checkpoint_straddle_full.bak` | 1.268s | 0.371s | 1.639s |
| `xtp_probe_full.bak` | 0.101s | 0.051s | 0.152s |
| `xtp_rich_full.bak` | 0.085s | 0.051s | 0.136s |
| `xtp_simple_full.bak` | 0.079s | 0.045s | 0.124s |
