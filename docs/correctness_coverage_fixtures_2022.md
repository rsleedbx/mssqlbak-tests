...
| `archive_columnstore_partition_full.bak` | 0.858s | 0.885s | 1.743s |
| `archive_columnstore_types_full.bak` | 0.301s | 0.626s | 0.927s |
| `archive_columnstore_types_random_full.bak` | 0.336s | 0.637s | 0.973s |
| `archive_single_chunk_full.bak` | 0.051s | 0.039s | 0.09s |
| `archive_single_chunk_random_full.bak` | 0.049s | 0.045s | 0.094s |
| `archivenull_full.bak` | 0.117s | 0.117s | 0.234s |
| `backup_blocksize_full.bak` | 0.035s | 0.035s | 0.07s |
| `boundarycoverage_datetime_full.bak` | 0.054s | 0.194s | 0.248s |
| `boundarycoverage_full.bak` | 0.043s | 0.089s | 0.132s |
| `catalog_ss2022.bak` | 0.031s | 0.033s | 0.064s |
| `cci_binary_varbinary_compare_full.bak` | 0.047s | 0.045s | 0.092s |
| `cci_bitpack_probe_bigint_full.bak` | 0.252s | 3.511s | 3.763s |
| `cci_bitpack_probe_full.bak` | 0.075s | 0.752s | 0.827s |
| `cci_bitpack_probe_highbase_full.bak` | 0.061s | 0.503s | 0.564s |
| `cci_btree_nci_full.bak` | 0.051s | 0.042s | 0.093s |
| `cci_computed_full.bak` | 0.045s | 0.047s | 0.092s |
| `cci_enc5_largepool_full.bak` | 0.307s | 0.451s | 0.758s |
| `cci_enc5_largepool_matrix_full.bak` | 7.007s | 1.342s | 8.349s |
| `cci_extended_full.bak` | 0.052s | 0.046s | 0.098s |
| `cci_lob_full.bak` | 0.043s | 0.045s | 0.088s |
| `cci_reorganize_full.bak` | 0.042s | 0.043s | 0.085s |
| `cci_string_dict_regression_full.bak` | 0.278s | 0.13s | 0.408s |
| `cci_string_minmax_full.bak` | 0.049s | 0.039s | 0.088s |
| `cci_switch_full.bak` | 0.044s | 0.046s | 0.09s |
| `cci_types_large_full.bak` | 0.052s | 0.043s | 0.095s |
| `cci_varbinary_micro_full.bak` | 0.043s | 0.046s | 0.089s |
| `cci_varbinary_probe_full.bak` | 0.046s | 0.045s | 0.091s |
| `columnstore_minimal.bak` | 0.105s | 0.762s | 0.867s |
| `compressed_nvarchar_full.bak` | 0.034s | 0.039s | 0.073s |
| `compressioncoverage_full.bak` | 0.084s | 0.176s | 0.26s |
| `computedcoverage_full.bak` | 0.043s | 0.038s | 0.081s |
| `constraintcoverage_full.bak` | 0.044s | 0.052s | 0.096s |
| `corrupt_metadata_confidence_full.bak` | 0s | 0.001s | 0.001s |
| `covering_index_full.bak` | 0.037s | 0.044s | 0.081s |
| `cs_lob_preamble.bak` | 0.12s | 0.089s | 0.209s |
| `cs_lob_preamble2.bak` | 0.066s | 0.057s | 0.123s |
| `delta_rowgroup_full.bak` | 0.051s | 0.043s | 0.094s |
| `dirtycoverage_aborted_xact.bak` | 0.058s | 0.033s | 0.091s |
| `dirtycoverage_addcol.bak` | 0.04s | 0.048s | 0.088s |
| `dirtycoverage_addnotnull.bak` | 0.036s | 0.048s | 0.084s |
| `dirtycoverage_alldirty.bak` | 0.057s | 0.031s | 0.088s |
| `dirtycoverage_altercol.bak` | 0.035s | 0.046s | 0.081s |
| `dirtycoverage_altercol_rewrite.bak` | 0.046s | 0.038s | 0.084s |
| `dirtycoverage_alterdb.bak` | 0.042s | 0.043s | 0.085s |
| `dirtycoverage_cci_delete.bak` | 0.082s | 0.089s | 0.171s |
| `dirtycoverage_cci_update.bak` | 0.188s | 0.084s | 0.272s |
| `dirtycoverage_committed_delete.bak` | 0.04s | 0.037s | 0.077s |
| `dirtycoverage_committed_delete_v2.bak` | 0.461s | 1.112s | 1.573s |
| `dirtycoverage_committed_delete_v3.bak` | 0.042s | 0.069s | 0.111s |
| `dirtycoverage_committed_delete_v4.bak` | 0.147s | 0.116s | 0.263s |
| `dirtycoverage_committed_update.bak` | 0.032s | 0.048s | 0.08s |
| `dirtycoverage_committed_update_v2.bak` | 8.64s | 1.94s | 10.58s |
| `dirtycoverage_committed_update_v3.bak` | 0.041s | 0.079s | 0.12s |
| `dirtycoverage_committed_update_v4.bak` | 0.1s | 0.135s | 0.235s |
| `dirtycoverage_compress_update.bak` | 0.066s | 0.036s | 0.102s |
| `dirtycoverage_concurrent.bak` | 0.041s | 0.05s | 0.091s |
| `dirtycoverage_createidx.bak` | 0.041s | 0.046s | 0.087s |
| `dirtycoverage_createtable.bak` | 0.047s | 0.056s | 0.103s |
| `dirtycoverage_delete.bak` | 0.063s | 0.035s | 0.098s |
| `dirtycoverage_dropcol.bak` | 0.035s | 0.052s | 0.087s |
| `dirtycoverage_dropidx.bak` | 0.036s | 0.035s | 0.071s |
| `dirtycoverage_droptable.bak` | 0.04s | 0.046s | 0.086s |
| `dirtycoverage_heap_forward.bak` | 0.056s | 0.033s | 0.089s |
| `dirtycoverage_insert_update.bak` | 0.065s | 0.04s | 0.105s |
| `dirtycoverage_large_dirty.bak` | 0.33s | 0.036s | 0.366s |
| `dirtycoverage_lob_update.bak` | 0.078s | 0.036s | 0.114s |
| `dirtycoverage_maxrow.bak` | 0.032s | 0.034s | 0.066s |
| `dirtycoverage_multi_update.bak` | 0.065s | 0.036s | 0.101s |
| `dirtycoverage_nchar_delete.bak` | 0.067s | 0.036s | 0.103s |
| `dirtycoverage_nested.bak` | 0.064s | 0.033s | 0.097s |
| `dirtycoverage_null_update.bak` | 0.061s | 0.033s | 0.094s |
| `dirtycoverage_rebuildidx.bak` | 0.043s | 0.054s | 0.097s |
| `dirtycoverage_rich_insert.bak` | 0.059s | 0.031s | 0.09s |
| `dirtycoverage_rich_update.bak` | 0.063s | 0.033s | 0.096s |
| `dirtycoverage_savepoint.bak` | 0.064s | 0.04s | 0.104s |
| `dirtycoverage_snapshot_update.bak` | 0.06s | 0.033s | 0.093s |
| `dirtycoverage_switch.bak` | 0.042s | 0.044s | 0.086s |
| `dirtycoverage_temporal_update.bak` | 0.059s | 0.035s | 0.094s |
| `dirtycoverage_truncate.bak` | 0.044s | 0.051s | 0.095s |
| `dirtycoverage_two_tx.bak` | 0.058s | 0.032s | 0.09s |
| `dirtycoverage_uncommitted.bak` | 0.071s | 0.034s | 0.105s |
| `dirtycoverage_update.bak` | 0.065s | 0.037s | 0.102s |
| `dirtycoverage_wide.bak` | 0.063s | 0.033s | 0.096s |
| `featurecoverage_full.bak` | 0.095s | 0.063s | 0.158s |
| `filtered_ncci_full.bak` | 0.039s | 0.055s | 0.094s |
| `float_extreme_full.bak` | 0.034s | 0.033s | 0.067s |
| `forwarded_records_full.bak` | 0.079s | 0.086s | 0.165s |
| `geocoverage_full.bak` | 0.043s | 0.045s | 0.088s |
| `geotest.bak` | 0.042s | 0.054s | 0.096s |
| `ghost_records_full.bak` | 0.032s | 0.041s | 0.073s |
| `heapcoverage_large.bak` | 0.042s | 0.051s | 0.093s |
| `heapcoverage_large_50000.bak` | 0.08s | 0.442s | 0.522s |
| `hierarchyid_extract_full.bak` | 0.031s | 0.033s | 0.064s |
| `high_slot_density_full.bak` | 0.042s | 0.235s | 0.277s |
| `incrementalcoverage_diff_01.bak` | 0.037s | 0.013s | 0.05s |
| `incrementalcoverage_diff_02.bak` | 0.039s | 0.013s | 0.052s |
...
| `incrementalcoverage_full.bak` | 0.031s | 0.029s | 0.06s |
| `layoutcoverage_full.bak` | 0.115s | 0.199s | 0.314s |
| `legacytext.bak` | 0.046s | 0.046s | 0.092s |
| `max_row_width_full.bak` | 0.036s | 0.032s | 0.068s |
| `mixed_collation_full.bak` | 0.032s | 0.033s | 0.065s |
| `multi_rowgroup_full.bak` | 0.046s | 0.048s | 0.094s |
| `ncci_heap_full.bak` | 0.032s | 0.038s | 0.07s |
| `ncci_types_full.bak` | 0.062s | 0.219s | 0.281s |
| `ndfcoverage_full.bak` | 0.034s | 0.047s | 0.081s |
| `nvarchar_max_u21_full.bak` | 0.032s | 0.038s | 0.07s |
| `ordered_cci_full.bak` | 0.044s | 0.045s | 0.089s |
| `pagecomp_anchor_full.bak` | 0.124s | 0.146s | 0.27s |
| `pagecomp_long_prefix_full.bak` | 0.043s | 0.042s | 0.085s |
| `pfor_columnstore_full.bak` | 0.097s | 1.067s | 1.164s |
| `pfor_columnstore_random_full.bak` | 0.102s | 1.091s | 1.193s |
| `realworld_numeric_digest_full.bak` | 0.06s | 0.105s | 0.165s |
| `rowboundary_full.bak` | 0.044s | 0.051s | 0.095s |
| `rowstore_hash_pii_full.bak` | 0.031s | 0.038s | 0.069s |
| `rowstore_lob_image_full.bak` | 0.032s | 0.04s | 0.072s |
| `rowstore_lob_markup_full.bak` | 0.032s | 0.035s | 0.067s |
| `rowversion_extract_full.bak` | 0.034s | 0.034s | 0.068s |
| `sparse_full.bak` | 0.085s | 0.144s | 0.229s |
| `spatial_edge_full.bak` | 0.04s | 0.036s | 0.076s |
| `spatial_index_full.bak` | 0.037s | 0.04s | 0.077s |
| `sql_variant_extract_full.bak` | 0.043s | 0.043s | 0.086s |
| `striped_full_1.bak` | 0.047s | 0.016s | 0.063s |
| `striped_single.bak` | 0.046s | 0.046s | 0.092s |
| `surrogate_pairs_full.bak` | 0.031s | 0.035s | 0.066s |
| `tabletype_cci_large_full.bak` | 0.049s | 0.049s | 0.098s |
| `tabletypecoverage_diff.bak` | 0.101s | 0.067s | 0.168s |
| `tabletypecoverage_full.bak` | 0.073s | 0.084s | 0.157s |
| `temporal_hidden_full.bak` | 0.044s | 0.05s | 0.094s |
| `torn_page_full.bak` | 0.028s | 0.032s | 0.06s |
| `typecoverage_full.bak` | 0.06s | 0.082s | 0.142s |
| `typecoverage_full_compressed.bak` | 0.089s | 0.107s | 0.196s |
| `typed_xml_full.bak` | 0.034s | 0.035s | 0.069s |
| `unicode_codepage_coverage.bak` | 0.056s | 0.065s | 0.121s |
| `utf8_collation_full.bak` | 0.032s | 0.034s | 0.066s |
| `xml_index_full.bak` | 0.045s | 0.041s | 0.086s |
| `xmlcoverage_full.bak` | 0.033s | 0.034s | 0.067s |
| `xmlheap_full.bak` | 0.054s | 0.064s | 0.118s |
| `xtp_checkpoint_straddle_full.bak` | 1.232s | 0.393s | 1.625s |
| `xtp_probe_full.bak` | 0.092s | 0.042s | 0.134s |
| `xtp_rich_full.bak` | 0.085s | 0.046s | 0.131s |
| `xtp_simple_full.bak` | 0.079s | 0.047s | 0.126s |
