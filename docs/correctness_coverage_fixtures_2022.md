...
|--------|---------|--------|-----------|
| `alias_types_full.bak` | 0.035s | 0.038s | 0.073s |
| `archive_columnstore_partition_full.bak` | 0.88s | 0.615s | 1.495s |
| `archive_columnstore_types_full.bak` | 0.324s | 0.705s | 1.029s |
| `archive_columnstore_types_random_full.bak` | 0.354s | 0.76s | 1.114s |
| `archive_single_chunk_full.bak` | 0.05s | 0.04s | 0.09s |
| `archive_single_chunk_random_full.bak` | 0.05s | 0.043s | 0.093s |
| `archivenull_full.bak` | 0.13s | 0.102s | 0.232s |
| `backup_blocksize_full.bak` | 0.043s | 0.045s | 0.088s |
| `boundarycoverage_datetime_full.bak` | 0.063s | 0.16s | 0.223s |
| `boundarycoverage_full.bak` | 0.06s | 0.081s | 0.141s |
| `catalog_ss2022.bak` | 0.049s | 0.036s | 0.085s |
| `cci_binary_varbinary_compare_full.bak` | 0.048s | 0.039s | 0.087s |
| `cci_bitpack_probe_bigint_full.bak` | 0.267s | 3.789s | 4.056s |
| `cci_bitpack_probe_full.bak` | 0.078s | 0.674s | 0.752s |
| `cci_bitpack_probe_highbase_full.bak` | 0.066s | 0.444s | 0.51s |
| `cci_btree_nci_full.bak` | 0.043s | 0.051s | 0.094s |
| `cci_computed_full.bak` | 0.116s | 0.11s | 0.226s |
| `cci_enc5_largepool_full.bak` | 0.321s | 0.441s | 0.762s |
| `cci_enc5_largepool_matrix_full.bak` | 7.065s | 1.304s | 8.369s |
| `cci_extended_full.bak` | 0.056s | 0.051s | 0.107s |
| `cci_lob_full.bak` | 0.13s | 0.073s | 0.203s |
| `cci_reorganize_full.bak` | 0.039s | 0.048s | 0.087s |
| `cci_string_dict_regression_full.bak` | 0.291s | 0.152s | 0.443s |
| `cci_string_minmax_full.bak` | 0.041s | 0.045s | 0.086s |
| `cci_switch_full.bak` | 0.049s | 0.037s | 0.086s |
| `cci_types_large_full.bak` | 0.071s | 0.053s | 0.124s |
| `cci_varbinary_micro_full.bak` | 0.037s | 0.044s | 0.081s |
| `cci_varbinary_probe_full.bak` | 0.046s | 0.049s | 0.095s |
| `columnstore_minimal.bak` | 0.111s | 0.964s | 1.075s |
| `compressed_nvarchar_full.bak` | 0.036s | 0.036s | 0.072s |
| `compressioncoverage_full.bak` | 0.085s | 0.201s | 0.286s |
| `computedcoverage_full.bak` | 0.067s | 0.122s | 0.189s |
| `constraintcoverage_full.bak` | 0.036s | 0.049s | 0.085s |
| `corrupt_metadata_confidence_full.bak` | 0s | 0.001s | 0.001s |
| `covering_index_full.bak` | 0.033s | 0.047s | 0.08s |
| `cs_lob_preamble.bak` | 0.129s | 0.076s | 0.205s |
| `cs_lob_preamble2.bak` | 0.095s | 0.075s | 0.17s |
| `delta_rowgroup_full.bak` | 0.042s | 0.042s | 0.084s |
| `dirtycoverage_aborted_xact.bak` | 0.109s | 0.064s | 0.173s |
| `dirtycoverage_addcol.bak` | 0.041s | 0.042s | 0.083s |
| `dirtycoverage_addnotnull.bak` | 0.039s | 0.049s | 0.088s |
| `dirtycoverage_alldirty.bak` | 0.06s | 0.034s | 0.094s |
| `dirtycoverage_altercol.bak` | 0.043s | 0.039s | 0.082s |
| `dirtycoverage_altercol_rewrite.bak` | 0.043s | 0.038s | 0.081s |
| `dirtycoverage_alterdb.bak` | 0.04s | 0.051s | 0.091s |
| `dirtycoverage_cci_delete.bak` | 0.088s | 0.098s | 0.186s |
| `dirtycoverage_cci_update.bak` | 0.21s | 0.102s | 0.312s |
| `dirtycoverage_committed_delete.bak` | 0.034s | 0.036s | 0.07s |
| `dirtycoverage_committed_delete_v2.bak` | 0.489s | 0.557s | 1.046s |
| `dirtycoverage_committed_delete_v3.bak` | 0.05s | 0.07s | 0.12s |
| `dirtycoverage_committed_delete_v4.bak` | 0.146s | 0.072s | 0.218s |
| `dirtycoverage_committed_update.bak` | 0.031s | 0.035s | 0.066s |
| `dirtycoverage_committed_update_v2.bak` | 8.9s | 0.921s | 9.821s |
| `dirtycoverage_committed_update_v3.bak` | 0.056s | 0.089s | 0.145s |
| `dirtycoverage_committed_update_v4.bak` | 0.107s | 0.075s | 0.182s |
| `dirtycoverage_compress_update.bak` | 0.068s | 0.045s | 0.113s |
| `dirtycoverage_concurrent.bak` | 0.045s | 0.041s | 0.086s |
| `dirtycoverage_createidx.bak` | 0.039s | 0.035s | 0.074s |
| `dirtycoverage_createtable.bak` | 0.04s | 0.052s | 0.092s |
| `dirtycoverage_delete.bak` | 0.069s | 0.038s | 0.107s |
| `dirtycoverage_dropcol.bak` | 0.035s | 0.05s | 0.085s |
| `dirtycoverage_dropidx.bak` | 0.04s | 0.047s | 0.087s |
| `dirtycoverage_droptable.bak` | 0.041s | 0.04s | 0.081s |
| `dirtycoverage_heap_forward.bak` | 0.153s | 0.037s | 0.19s |
| `dirtycoverage_insert_update.bak` | 0.138s | 0.051s | 0.189s |
| `dirtycoverage_large_dirty.bak` | 0.36s | 0.05s | 0.41s |
| `dirtycoverage_lob_update.bak` | 0.106s | 0.041s | 0.147s |
| `dirtycoverage_maxrow.bak` | 0.032s | 0.036s | 0.068s |
| `dirtycoverage_multi_update.bak` | 0.073s | 0.049s | 0.122s |
| `dirtycoverage_nchar_delete.bak` | 0.07s | 0.035s | 0.105s |
| `dirtycoverage_nested.bak` | 0.074s | 0.058s | 0.132s |
| `dirtycoverage_null_update.bak` | 0.131s | 0.126s | 0.257s |
| `dirtycoverage_rebuildidx.bak` | 0.037s | 0.048s | 0.085s |
| `dirtycoverage_rich_insert.bak` | 0.072s | 0.044s | 0.116s |
| `dirtycoverage_rich_update.bak` | 0.073s | 0.047s | 0.12s |
| `dirtycoverage_savepoint.bak` | 0.073s | 0.048s | 0.121s |
| `dirtycoverage_snapshot_update.bak` | 0.072s | 0.039s | 0.111s |
| `dirtycoverage_switch.bak` | 0.037s | 0.045s | 0.082s |
| `dirtycoverage_temporal_update.bak` | 0.112s | 0.08s | 0.192s |
| `dirtycoverage_truncate.bak` | 0.044s | 0.037s | 0.081s |
| `dirtycoverage_two_tx.bak` | 0.067s | 0.041s | 0.108s |
| `dirtycoverage_uncommitted.bak` | 0.066s | 0.037s | 0.103s |
| `dirtycoverage_update.bak` | 0.076s | 0.039s | 0.115s |
| `dirtycoverage_wide.bak` | 0.07s | 0.036s | 0.106s |
| `featurecoverage_full.bak` | 0.105s | 0.064s | 0.169s |
| `filtered_ncci_full.bak` | 0.053s | 0.068s | 0.121s |
| `float_extreme_full.bak` | 0.039s | 0.033s | 0.072s |
| `forwarded_records_full.bak` | 0.083s | 0.082s | 0.165s |
| `geocoverage_full.bak` | 0.049s | 0.06s | 0.109s |
| `geotest.bak` | 0.043s | 0.044s | 0.087s |
| `ghost_records_full.bak` | 0.041s | 0.05s | 0.091s |
| `heapcoverage_large.bak` | 0.051s | 0.071s | 0.122s |
| `heapcoverage_large_50000.bak` | 0.11s | 0.343s | 0.453s |
| `hierarchyid_extract_full.bak` | 0.041s | 0.034s | 0.075s |
| `high_slot_density_full.bak` | 0.05s | 0.209s | 0.259s |
| `identity_coverage_full.bak` | 0.043s | 0.047s | 0.09s |
| `incrementalcoverage_diff_01.bak` | 0.039s | 0.013s | 0.052s |
| `incrementalcoverage_diff_02.bak` | 0.037s | 0.012s | 0.049s |
| `incrementalcoverage_diff_03.bak` | 0.043s | 0.015s | 0.058s |
| `incrementalcoverage_diff_04.bak` | 0.038s | 0.013s | 0.051s |
| `incrementalcoverage_diff_05.bak` | 0.04s | 0.014s | 0.054s |
| `incrementalcoverage_diff_06.bak` | 0.044s | 0.013s | 0.057s |
| `incrementalcoverage_full.bak` | 0.035s | 0.041s | 0.076s |
| `layoutcoverage_full.bak` | 0.125s | 0.389s | 0.514s |
| `legacytext.bak` | 0.049s | 0.05s | 0.099s |
| `max_row_width_full.bak` | 0.031s | 0.037s | 0.068s |
| `mixed_collation_full.bak` | 0.033s | 0.037s | 0.07s |
| `multi_rowgroup_full.bak` | 0.038s | 0.045s | 0.083s |
| `ncci_heap_full.bak` | 0.033s | 0.038s | 0.071s |
| `ncci_types_full.bak` | 0.072s | 0.201s | 0.273s |
| `ndfcoverage_full.bak` | 0.045s | 0.048s | 0.093s |
| `nvarchar_max_u21_full.bak` | 0.032s | 0.034s | 0.066s |
| `ordered_cci_full.bak` | 0.036s | 0.051s | 0.087s |
| `pagecomp_anchor_full.bak` | 0.131s | 0.105s | 0.236s |
| `pagecomp_long_prefix_full.bak` | 0.039s | 0.05s | 0.089s |
| `pfor_columnstore_full.bak` | 0.097s | 0.894s | 0.991s |
| `pfor_columnstore_random_full.bak` | 0.098s | 0.849s | 0.947s |
| `realworld_numeric_digest_full.bak` | 0.058s | 0.084s | 0.142s |
| `rowboundary_full.bak` | 0.038s | 0.039s | 0.077s |
| `rowstore_hash_pii_full.bak` | 0.037s | 0.032s | 0.069s |
| `rowstore_lob_image_full.bak` | 0.035s | 0.04s | 0.075s |
| `rowstore_lob_markup_full.bak` | 0.036s | 0.046s | 0.082s |
| `rowversion_extract_full.bak` | 0.036s | 0.048s | 0.084s |
| `sparse_full.bak` | 0.086s | 0.096s | 0.182s |
| `spatial_edge_full.bak` | 0.036s | 0.055s | 0.091s |
| `spatial_index_full.bak` | 0.05s | 0.075s | 0.125s |
| `sql_variant_extract_full.bak` | 0.034s | 0.037s | 0.071s |
| `striped_full_1.bak` | 0.052s | 0.014s | 0.066s |
| `striped_single.bak` | 0.049s | 0.102s | 0.151s |
| `surrogate_pairs_full.bak` | 0.04s | 0.033s | 0.073s |
| `tabletype_cci_large_full.bak` | 0.056s | 0.056s | 0.112s |
| `tabletypecoverage_diff.bak` | 0.102s | 0.08s | 0.182s |
| `tabletypecoverage_full.bak` | 0.079s | 0.124s | 0.203s |
| `temporal_hidden_full.bak` | 0.041s | 0.042s | 0.083s |
| `torn_page_full.bak` | 0.028s | 0.038s | 0.066s |
| `typecoverage_full.bak` | 0.073s | 0.092s | 0.165s |
| `typecoverage_full_compressed.bak` | 0.095s | 0.103s | 0.198s |
| `typed_xml_full.bak` | 0.035s | 0.071s | 0.106s |
| `unicode_codepage_coverage.bak` | 0.071s | 0.054s | 0.125s |
| `utf8_collation_full.bak` | 0.034s | 0.035s | 0.069s |
| `xml_index_full.bak` | 0.039s | 0.086s | 0.125s |
| `xmlcoverage_full.bak` | 0.038s | 0.078s | 0.116s |
| `xmlheap_full.bak` | 0.059s | 0.061s | 0.12s |
| `xtp_checkpoint_straddle_full.bak` | 1.285s | 0.363s | 1.648s |
| `xtp_probe_full.bak` | 0.101s | 0.043s | 0.144s |
| `xtp_rich_full.bak` | 0.097s | 0.058s | 0.155s |
| `xtp_simple_full.bak` | 0.107s | 0.045s | 0.152s |
