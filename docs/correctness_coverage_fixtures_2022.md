...
| Backup | Wall time |
|--------|-------------|
| `alias_types_full.bak` | 0.081s |
| `archive_columnstore_partition_full.bak` | 2.402s |
| `archive_columnstore_types_full.bak` | 1.269s |
| `archive_columnstore_types_random_full.bak` | 1.262s |
| `archive_single_chunk_full.bak` | 0.094s |
| `archive_single_chunk_random_full.bak` | 0.101s |
| `archivenull_full.bak` | 0.283s |
| `backup_blocksize_full.bak` | 0.075s |
| `boundarycoverage_datetime_full.bak` | 0.384s |
| `boundarycoverage_full.bak` | 0.204s |
| `catalog_ss2022.bak` | 0.063s |
| `cci_binary_varbinary_compare_full.bak` | 0.089s |
| `cci_bitpack_probe_bigint_full.bak` | 8.534s |
| `cci_bitpack_probe_full.bak` | 1.7s |
| `cci_bitpack_probe_highbase_full.bak` | 1.24s |
| `cci_btree_nci_full.bak` | 0.094s |
| `cci_computed_full.bak` | 0.091s |
| `cci_enc5_largepool_full.bak` | 1.133s |
| `cci_enc5_largepool_matrix_full.bak` | 9.552s |
| `cci_extended_full.bak` | 0.121s |
| `cci_lob_full.bak` | 0.101s |
| `cci_reorganize_full.bak` | 0.085s |
| `cci_string_dict_regression_full.bak` | 0.494s |
| `cci_string_minmax_full.bak` | 0.098s |
| `cci_switch_full.bak` | 0.089s |
| `cci_types_large_full.bak` | 0.126s |
| `cci_varbinary_micro_full.bak` | 0.091s |
| `cci_varbinary_probe_full.bak` | 0.101s |
| `columnstore_minimal.bak` | 1.009s |
| `compressed_nvarchar_full.bak` | 0.069s |
| `compressioncoverage_full.bak` | 0.323s |
| `computedcoverage_full.bak` | 0.072s |
| `constraintcoverage_full.bak` | 0.084s |
| `corrupt_metadata_confidence_full.bak` | 0.001s |
| `covering_index_full.bak` | 0.095s |
| `cs_lob_preamble.bak` | 0.225s |
| `cs_lob_preamble2.bak` | 0.132s |
| `delta_rowgroup_full.bak` | 0.083s |
| `dirtycoverage_aborted_xact.bak` | 0.093s |
| `dirtycoverage_addcol.bak` | 0.07s |
| `dirtycoverage_addnotnull.bak` | 0.079s |
| `dirtycoverage_alldirty.bak` | 0.107s |
| `dirtycoverage_altercol.bak` | 0.068s |
| `dirtycoverage_altercol_rewrite.bak` | 0.079s |
| `dirtycoverage_alterdb.bak` | 0.07s |
| `dirtycoverage_cci_delete.bak` | 0.209s |
| `dirtycoverage_cci_update.bak` | 0.333s |
| `dirtycoverage_committed_delete.bak` | 0.065s |
| `dirtycoverage_committed_delete_v2.bak` | 2.942s |
| `dirtycoverage_committed_delete_v3.bak` | 0.138s |
| `dirtycoverage_committed_delete_v4.bak` | 0.323s |
| `dirtycoverage_committed_update.bak` | 0.071s |
| `dirtycoverage_committed_update_v2.bak` | 12.862s |
| `dirtycoverage_committed_update_v3.bak` | 0.16s |
| `dirtycoverage_committed_update_v4.bak` | 0.306s |
| `dirtycoverage_compress_update.bak` | 0.097s |
| `dirtycoverage_concurrent.bak` | 0.084s |
| `dirtycoverage_createidx.bak` | 0.085s |
| `dirtycoverage_createtable.bak` | 0.082s |
| `dirtycoverage_delete.bak` | 0.1s |
| `dirtycoverage_dropcol.bak` | 0.083s |
| `dirtycoverage_dropidx.bak` | 0.072s |
| `dirtycoverage_droptable.bak` | 0.078s |
| `dirtycoverage_heap_forward.bak` | 0.087s |
| `dirtycoverage_insert_update.bak` | 0.097s |
| `dirtycoverage_large_dirty.bak` | 0.365s |
| `dirtycoverage_lob_update.bak` | 0.107s |
| `dirtycoverage_maxrow.bak` | 0.063s |
| `dirtycoverage_multi_update.bak` | 0.098s |
| `dirtycoverage_nchar_delete.bak` | 0.093s |
| `dirtycoverage_nested.bak` | 0.095s |
| `dirtycoverage_null_update.bak` | 0.092s |
| `dirtycoverage_rebuildidx.bak` | 0.071s |
| `dirtycoverage_rich_insert.bak` | 0.107s |
| `dirtycoverage_rich_update.bak` | 0.101s |
| `dirtycoverage_savepoint.bak` | 0.106s |
| `dirtycoverage_snapshot_update.bak` | 0.093s |
| `dirtycoverage_switch.bak` | 0.069s |
| `dirtycoverage_temporal_update.bak` | 0.089s |
| `dirtycoverage_truncate.bak` | 0.082s |
| `dirtycoverage_two_tx.bak` | 0.088s |
| `dirtycoverage_uncommitted.bak` | 0.1s |
| `dirtycoverage_update.bak` | 0.106s |
| `dirtycoverage_wide.bak` | 0.096s |
| `featurecoverage_full.bak` | 0.168s |
| `filtered_ncci_full.bak` | 0.09s |
| `float_extreme_full.bak` | 0.061s |
| `forwarded_records_full.bak` | 0.174s |
| `geocoverage_full.bak` | 0.094s |
| `geotest.bak` | 0.085s |
| `ghost_records_full.bak` | 0.066s |
| `heapcoverage_large.bak` | 0.087s |
| `heapcoverage_large_50000.bak` | 0.949s |
| `hierarchyid_extract_full.bak` | 0.062s |
| `high_slot_density_full.bak` | 0.547s |
| `incrementalcoverage_diff_01.bak` | 0.047s |
| `incrementalcoverage_diff_02.bak` | 0.055s |
| `incrementalcoverage_diff_03.bak` | 0.048s |
| `incrementalcoverage_diff_04.bak` | 0.054s |
| `incrementalcoverage_diff_05.bak` | 0.05s |
| `incrementalcoverage_diff_06.bak` | 0.054s |
| `incrementalcoverage_full.bak` | 0.058s |
| `layoutcoverage_full.bak` | 0.332s |
| `legacytext.bak` | 0.096s |
| `max_row_width_full.bak` | 0.073s |
| `mixed_collation_full.bak` | 0.064s |
| `multi_rowgroup_full.bak` | 0.093s |
| `ncci_heap_full.bak` | 0.072s |
| `ncci_types_full.bak` | 0.435s |
| `ndfcoverage_full.bak` | 0.081s |
| `nvarchar_max_u21_full.bak` | 0.066s |
| `ordered_cci_full.bak` | 0.096s |
| `pagecomp_anchor_full.bak` | 0.345s |
| `pagecomp_long_prefix_full.bak` | 0.065s |
| `pfor_columnstore_full.bak` | 2.185s |
| `pfor_columnstore_random_full.bak` | 2.22s |
| `realworld_numeric_digest_full.bak` | 0.186s |
| `rowboundary_full.bak` | 0.07s |
| `rowstore_hash_pii_full.bak` | 0.061s |
| `rowstore_lob_image_full.bak` | 0.069s |
| `rowstore_lob_markup_full.bak` | 0.065s |
| `rowversion_extract_full.bak` | 0.072s |
| `sparse_full.bak` | 0.289s |
| `spatial_edge_full.bak` | 0.079s |
| `spatial_index_full.bak` | 0.08s |
| `sql_variant_extract_full.bak` | 0.064s |
| `striped_full_1.bak` | 0.061s |
| `striped_single.bak` | 0.093s |
| `surrogate_pairs_full.bak` | 0.063s |
| `tabletype_cci_large_full.bak` | 0.097s |
| `tabletypecoverage_diff.bak` | 0.172s |
| `tabletypecoverage_full.bak` | 0.148s |
| `temporal_hidden_full.bak` | 0.071s |
| `torn_page_full.bak` | 0.059s |
| `typecoverage_full.bak` | 0.125s |
| `typecoverage_full_compressed.bak` | 0.188s |
| `typed_xml_full.bak` | 0.076s |
| `unicode_codepage_coverage.bak` | 0.101s |
| `utf8_collation_full.bak` | 0.064s |
| `xml_index_full.bak` | 0.073s |
| `xmlcoverage_full.bak` | 0.071s |
| `xmlheap_full.bak` | 0.112s |
| `xtp_checkpoint_straddle_full.bak` | 2.805s |
| `xtp_probe_full.bak` | 0.127s |
| `xtp_rich_full.bak` | 0.12s |
| `xtp_simple_full.bak` | 0.116s |

---

_Generated 2026-07-06 · 146 fixtures · 145 pass · 0 xfail · 1 fail_
