...
|--------|---------|--------|-----------|
| `alias_types_full.bak` | 0.034s | 0.037s | 0.071s |
| `archive_columnstore_partition_full.bak` | 0.842s | 0.569s | 1.411s |
| `archive_columnstore_types_full.bak` | 0.303s | 0.666s | 0.969s |
| `archive_columnstore_types_random_full.bak` | 0.314s | 0.661s | 0.975s |
| `archive_single_chunk_full.bak` | 0.04s | 0.035s | 0.075s |
| `archive_single_chunk_random_full.bak` | 0.039s | 0.037s | 0.076s |
| `archivenull_full.bak` | 0.116s | 0.086s | 0.202s |
| `backup_blocksize_full.bak` | 0.034s | 0.037s | 0.071s |
| `boundarycoverage_datetime_full.bak` | 0.053s | 0.145s | 0.198s |
| `boundarycoverage_full.bak` | 0.061s | 0.068s | 0.129s |
| `catalog_ss2022.bak` | 0.035s | 0.035s | 0.07s |
| `cci_binary_varbinary_compare_full.bak` | 0.043s | 0.051s | 0.094s |
| `cci_bitpack_probe_bigint_full.bak` | 0.256s | 3.592s | 3.848s |
| `cci_bitpack_probe_full.bak` | 0.075s | 0.638s | 0.713s |
| `cci_bitpack_probe_highbase_full.bak` | 0.065s | 0.41s | 0.475s |
| `cci_btree_nci_full.bak` | 0.048s | 0.039s | 0.087s |
| `cci_computed_full.bak` | 0.037s | 0.042s | 0.079s |
| `cci_enc5_largepool_full.bak` | 0.307s | 0.411s | 0.718s |
| `cci_enc5_largepool_matrix_full.bak` | 6.848s | 1.175s | 8.023s |
| `cci_extended_full.bak` | 0.049s | 0.047s | 0.096s |
| `cci_lob_full.bak` | 0.042s | 0.033s | 0.075s |
| `cci_reorganize_full.bak` | 0.047s | 0.049s | 0.096s |
| `cci_string_dict_regression_full.bak` | 0.284s | 0.13s | 0.414s |
| `cci_string_minmax_full.bak` | 0.042s | 0.042s | 0.084s |
| `cci_switch_full.bak` | 0.038s | 0.045s | 0.083s |
| `cci_types_large_full.bak` | 0.053s | 0.049s | 0.102s |
| `cci_varbinary_micro_full.bak` | 0.04s | 0.035s | 0.075s |
| `cci_varbinary_probe_full.bak` | 0.041s | 0.047s | 0.088s |
| `columnstore_minimal.bak` | 0.116s | 0.834s | 0.95s |
| `compressed_nvarchar_full.bak` | 0.038s | 0.033s | 0.071s |
| `compressioncoverage_full.bak` | 0.087s | 0.171s | 0.258s |
| `computedcoverage_full.bak` | 0.046s | 0.028s | 0.074s |
| `constraintcoverage_full.bak` | 0.035s | 0.049s | 0.084s |
| `corrupt_metadata_confidence_full.bak` | 0s | 0.001s | 0.001s |
| `covering_index_full.bak` | 0.032s | 0.038s | 0.07s |
| `cs_lob_preamble.bak` | 0.116s | 0.071s | 0.187s |
| `cs_lob_preamble2.bak` | 0.071s | 0.057s | 0.128s |
| `delta_rowgroup_full.bak` | 0.033s | 0.033s | 0.066s |
| `dirtycoverage_aborted_xact.bak` | 0.059s | 0.029s | 0.088s |
| `dirtycoverage_addcol.bak` | 0.034s | 0.04s | 0.074s |
| `dirtycoverage_addnotnull.bak` | 0.044s | 0.032s | 0.076s |
| `dirtycoverage_alldirty.bak` | 0.058s | 0.036s | 0.094s |
| `dirtycoverage_altercol.bak` | 0.035s | 0.037s | 0.072s |
| `dirtycoverage_altercol_rewrite.bak` | 0.034s | 0.048s | 0.082s |
| `dirtycoverage_alterdb.bak` | 0.035s | 0.039s | 0.074s |
| `dirtycoverage_cci_delete.bak` | 0.079s | 0.08s | 0.159s |
| `dirtycoverage_cci_update.bak` | 0.196s | 0.093s | 0.289s |
| `dirtycoverage_committed_delete.bak` | 0.038s | 0.037s | 0.075s |
| `dirtycoverage_committed_delete_v2.bak` | 0.5s | 0.423s | 0.923s |
| `dirtycoverage_committed_delete_v3.bak` | 0.041s | 0.063s | 0.104s |
| `dirtycoverage_committed_delete_v4.bak` | 0.142s | 0.062s | 0.204s |
| `dirtycoverage_committed_update.bak` | 0.032s | 0.053s | 0.085s |
| `dirtycoverage_committed_update_v2.bak` | 8.607s | 0.697s | 9.304s |
| `dirtycoverage_committed_update_v3.bak` | 0.04s | 0.068s | 0.108s |
| `dirtycoverage_committed_update_v4.bak` | 0.096s | 0.071s | 0.167s |
| `dirtycoverage_compress_update.bak` | 0.065s | 0.036s | 0.101s |
| `dirtycoverage_concurrent.bak` | 0.036s | 0.038s | 0.074s |
| `dirtycoverage_createidx.bak` | 0.035s | 0.038s | 0.073s |
| `dirtycoverage_createtable.bak` | 0.035s | 0.033s | 0.068s |
| `dirtycoverage_delete.bak` | 0.064s | 0.034s | 0.098s |
| `dirtycoverage_dropcol.bak` | 0.035s | 0.043s | 0.078s |
| `dirtycoverage_dropidx.bak` | 0.044s | 0.042s | 0.086s |
| `dirtycoverage_droptable.bak` | 0.037s | 0.037s | 0.074s |
| `dirtycoverage_heap_forward.bak` | 0.067s | 0.03s | 0.097s |
| `dirtycoverage_insert_update.bak` | 0.065s | 0.032s | 0.097s |
| `dirtycoverage_large_dirty.bak` | 0.335s | 0.03s | 0.365s |
| `dirtycoverage_lob_update.bak` | 0.076s | 0.033s | 0.109s |
| `dirtycoverage_maxrow.bak` | 0.049s | 0.033s | 0.082s |
| `dirtycoverage_multi_update.bak` | 0.068s | 0.034s | 0.102s |
| `dirtycoverage_nchar_delete.bak` | 0.061s | 0.034s | 0.095s |
| `dirtycoverage_nested.bak` | 0.064s | 0.034s | 0.098s |
| `dirtycoverage_null_update.bak` | 0.061s | 0.027s | 0.088s |
| `dirtycoverage_rebuildidx.bak` | 0.035s | 0.043s | 0.078s |
| `dirtycoverage_rich_insert.bak` | 0.058s | 0.037s | 0.095s |
| `dirtycoverage_rich_update.bak` | 0.063s | 0.035s | 0.098s |
| `dirtycoverage_savepoint.bak` | 0.064s | 0.038s | 0.102s |
| `dirtycoverage_snapshot_update.bak` | 0.063s | 0.044s | 0.107s |
| `dirtycoverage_switch.bak` | 0.037s | 0.039s | 0.076s |
| `dirtycoverage_temporal_update.bak` | 0.064s | 0.028s | 0.092s |
| `dirtycoverage_truncate.bak` | 0.036s | 0.037s | 0.073s |
| `dirtycoverage_two_tx.bak` | 0.065s | 0.034s | 0.099s |
| `dirtycoverage_uncommitted.bak` | 0.064s | 0.035s | 0.099s |
| `dirtycoverage_update.bak` | 0.065s | 0.034s | 0.099s |
| `dirtycoverage_wide.bak` | 0.064s | 0.034s | 0.098s |
| `featurecoverage_full.bak` | 0.093s | 0.057s | 0.15s |
| `filtered_ncci_full.bak` | 0.037s | 0.045s | 0.082s |
| `float_extreme_full.bak` | 0.03s | 0.044s | 0.074s |
| `forwarded_records_full.bak` | 0.077s | 0.07s | 0.147s |
| `geocoverage_full.bak` | 0.053s | 0.044s | 0.097s |
| `geotest.bak` | 0.038s | 0.04s | 0.078s |
| `ghost_records_full.bak` | 0.032s | 0.04s | 0.072s |
| `heapcoverage_large.bak` | 0.033s | 0.042s | 0.075s |
| `heapcoverage_large_50000.bak` | 0.084s | 0.305s | 0.389s |
| `hierarchyid_extract_full.bak` | 0.032s | 0.036s | 0.068s |
| `high_slot_density_full.bak` | 0.04s | 0.181s | 0.221s |
| `identity_coverage_full.bak` | 0.041s | 0.041s | 0.082s |
| `incrementalcoverage_diff_01.bak` | 0.04s | 0.011s | 0.051s |
| `incrementalcoverage_diff_02.bak` | 0.04s | 0.012s | 0.052s |
| `incrementalcoverage_diff_03.bak` | 0.037s | 0.013s | 0.05s |
| `incrementalcoverage_diff_04.bak` | 0.038s | 0.012s | 0.05s |
| `incrementalcoverage_diff_05.bak` | 0.038s | 0.011s | 0.049s |
| `incrementalcoverage_diff_06.bak` | 0.038s | 0.014s | 0.052s |
| `incrementalcoverage_full.bak` | 0.032s | 0.044s | 0.076s |
| `layoutcoverage_full.bak` | 0.119s | 0.318s | 0.437s |
| `legacytext.bak` | 0.045s | 0.047s | 0.092s |
| `max_row_width_full.bak` | 0.035s | 0.05s | 0.085s |
| `mixed_collation_full.bak` | 0.033s | 0.041s | 0.074s |
| `multi_rowgroup_full.bak` | 0.037s | 0.041s | 0.078s |
| `ncci_heap_full.bak` | 0.036s | 0.039s | 0.075s |
| `ncci_types_full.bak` | 0.066s | 0.176s | 0.242s |
| `ndfcoverage_full.bak` | 0.033s | 0.042s | 0.075s |
| `nvarchar_max_u21_full.bak` | 0.036s | 0.048s | 0.084s |
| `ordered_cci_full.bak` | 0.033s | 0.048s | 0.081s |
| `pagecomp_anchor_full.bak` | 0.12s | 0.09s | 0.21s |
| `pagecomp_long_prefix_full.bak` | 0.039s | 0.037s | 0.076s |
| `pfor_columnstore_full.bak` | 0.096s | 0.804s | 0.9s |
| `pfor_columnstore_random_full.bak` | 0.096s | 0.805s | 0.901s |
| `realworld_numeric_digest_full.bak` | 0.044s | 0.081s | 0.125s |
| `rowboundary_full.bak` | 0.033s | 0.04s | 0.073s |
| `rowstore_hash_pii_full.bak` | 0.033s | 0.04s | 0.073s |
| `rowstore_lob_image_full.bak` | 0.031s | 0.034s | 0.065s |
| `rowstore_lob_markup_full.bak` | 0.031s | 0.035s | 0.066s |
| `rowversion_extract_full.bak` | 0.038s | 0.037s | 0.075s |
| `sparse_full.bak` | 0.089s | 0.081s | 0.17s |
| `spatial_edge_full.bak` | 0.036s | 0.041s | 0.077s |
| `spatial_index_full.bak` | 0.038s | 0.046s | 0.084s |
| `sql_variant_extract_full.bak` | 0.039s | 0.035s | 0.074s |
| `striped_full_1.bak` | 0.046s | 0.018s | 0.064s |
| `striped_single.bak` | 0.046s | 0.046s | 0.092s |
| `surrogate_pairs_full.bak` | 0.031s | 0.036s | 0.067s |
| `tabletype_cci_large_full.bak` | 0.053s | 0.049s | 0.102s |
| `tabletypecoverage_diff.bak` | 0.102s | 0.056s | 0.158s |
| `tabletypecoverage_full.bak` | 0.073s | 0.085s | 0.158s |
| `temporal_hidden_full.bak` | 0.044s | 0.036s | 0.08s |
| `torn_page_full.bak` | 0.028s | 0.032s | 0.06s |
| `typecoverage_full.bak` | 0.065s | 0.076s | 0.141s |
| `typecoverage_full_compressed.bak` | 0.106s | 0.096s | 0.202s |
| `typed_xml_full.bak` | 0.034s | 0.033s | 0.067s |
| `unicode_codepage_coverage.bak` | 0.053s | 0.05s | 0.103s |
| `utf8_collation_full.bak` | 0.033s | 0.04s | 0.073s |
| `xml_index_full.bak` | 0.036s | 0.038s | 0.074s |
| `xmlcoverage_full.bak` | 0.033s | 0.035s | 0.068s |
| `xmlheap_full.bak` | 0.05s | 0.054s | 0.104s |
| `xtp_checkpoint_straddle_full.bak` | 1.272s | 0.357s | 1.629s |
| `xtp_probe_full.bak` | 0.091s | 0.038s | 0.129s |
| `xtp_rich_full.bak` | 0.08s | 0.04s | 0.12s |
| `xtp_simple_full.bak` | 0.073s | 0.037s | 0.11s |
