...
|--------|---------|--------|-----------|
| `alias_types_full.bak` | 0.034s | 0.038s | 0.072s |
| `archive_columnstore_partition_full.bak` | 0.898s | 0.951s | 1.849s |
| `archive_columnstore_types_full.bak` | 0.314s | 0.65s | 0.964s |
| `archive_columnstore_types_random_full.bak` | 0.325s | 0.656s | 0.981s |
| `archive_single_chunk_full.bak` | 0.064s | 0.043s | 0.107s |
| `archive_single_chunk_random_full.bak` | 0.043s | 0.041s | 0.084s |
| `archivenull_full.bak` | 0.128s | 0.121s | 0.249s |
| `backup_blocksize_full.bak` | 0.041s | 0.048s | 0.089s |
| `boundarycoverage_datetime_full.bak` | 0.066s | 0.197s | 0.263s |
| `boundarycoverage_full.bak` | 0.05s | 0.1s | 0.15s |
| `catalog_ss2022.bak` | 0.035s | 0.054s | 0.089s |
| `cci_binary_varbinary_compare_full.bak` | 0.043s | 0.037s | 0.08s |
| `cci_bitpack_probe_bigint_full.bak` | 0.265s | 4.057s | 4.322s |
| `cci_bitpack_probe_full.bak` | 0.085s | 0.775s | 0.86s |
| `cci_bitpack_probe_highbase_full.bak` | 0.062s | 0.533s | 0.595s |
| `cci_btree_nci_full.bak` | 0.053s | 0.04s | 0.093s |
| `cci_computed_full.bak` | 0.044s | 0.043s | 0.087s |
| `cci_enc5_largepool_full.bak` | 0.315s | 0.47s | 0.785s |
| `cci_enc5_largepool_matrix_full.bak` | 7.28s | 1.388s | 8.668s |
| `cci_extended_full.bak` | 0.059s | 0.053s | 0.112s |
| `cci_lob_full.bak` | 0.058s | 0.044s | 0.102s |
| `cci_reorganize_full.bak` | 0.058s | 0.043s | 0.101s |
| `cci_string_dict_regression_full.bak` | 0.281s | 0.146s | 0.427s |
| `cci_string_minmax_full.bak` | 0.046s | 0.039s | 0.085s |
| `cci_switch_full.bak` | 0.051s | 0.043s | 0.094s |
| `cci_types_large_full.bak` | 0.06s | 0.047s | 0.107s |
| `cci_varbinary_micro_full.bak` | 0.052s | 0.045s | 0.097s |
| `cci_varbinary_probe_full.bak` | 0.049s | 0.058s | 0.107s |
| `columnstore_minimal.bak` | 0.115s | 0.796s | 0.911s |
| `compressed_nvarchar_full.bak` | 0.08s | 0.07s | 0.15s |
| `compressioncoverage_full.bak` | 0.136s | 0.191s | 0.327s |
| `computedcoverage_full.bak` | 0.136s | 0.044s | 0.18s |
| `constraintcoverage_full.bak` | 0.042s | 0.05s | 0.092s |
| `corrupt_metadata_confidence_full.bak` | 0s | 0.003s | 0.003s |
| `covering_index_full.bak` | 0.04s | 0.052s | 0.092s |
| `cs_lob_preamble.bak` | 0.135s | 0.106s | 0.241s |
| `cs_lob_preamble2.bak` | 0.078s | 0.07s | 0.148s |
| `delta_rowgroup_full.bak` | 0.038s | 0.037s | 0.075s |
| `dirtycoverage_aborted_xact.bak` | 0.069s | 0.039s | 0.108s |
| `dirtycoverage_addcol.bak` | 0.045s | 0.041s | 0.086s |
| `dirtycoverage_addnotnull.bak` | 0.125s | 0.067s | 0.192s |
| `dirtycoverage_alldirty.bak` | 0.066s | 0.038s | 0.104s |
| `dirtycoverage_altercol.bak` | 0.037s | 0.037s | 0.074s |
| `dirtycoverage_altercol_rewrite.bak` | 0.04s | 0.039s | 0.079s |
| `dirtycoverage_alterdb.bak` | 0.035s | 0.044s | 0.079s |
| `dirtycoverage_cci_delete.bak` | 0.092s | 0.095s | 0.187s |
| `dirtycoverage_cci_update.bak` | 0.23s | 0.163s | 0.393s |
| `dirtycoverage_committed_delete.bak` | 0.042s | 0.062s | 0.104s |
| `dirtycoverage_committed_delete_v2.bak` | 0.769s | 1.235s | 2.004s |
| `dirtycoverage_committed_delete_v3.bak` | 0.049s | 0.071s | 0.12s |
| `dirtycoverage_committed_delete_v4.bak` | 0.153s | 0.126s | 0.279s |
| `dirtycoverage_committed_update.bak` | 0.071s | 0.101s | 0.172s |
| `dirtycoverage_committed_update_v2.bak` | 9.021s | 2.139s | 11.16s |
| `dirtycoverage_committed_update_v3.bak` | 0.046s | 0.088s | 0.134s |
| `dirtycoverage_committed_update_v4.bak` | 0.108s | 0.147s | 0.255s |
| `dirtycoverage_compress_update.bak` | 0.076s | 0.037s | 0.113s |
| `dirtycoverage_concurrent.bak` | 0.041s | 0.038s | 0.079s |
| `dirtycoverage_createidx.bak` | 0.036s | 0.046s | 0.082s |
| `dirtycoverage_createtable.bak` | 0.035s | 0.039s | 0.074s |
| `dirtycoverage_delete.bak` | 0.07s | 0.049s | 0.119s |
| `dirtycoverage_dropcol.bak` | 0.063s | 0.054s | 0.117s |
| `dirtycoverage_dropidx.bak` | 0.042s | 0.051s | 0.093s |
| `dirtycoverage_droptable.bak` | 0.047s | 0.05s | 0.097s |
| `dirtycoverage_heap_forward.bak` | 0.064s | 0.039s | 0.103s |
| `dirtycoverage_insert_update.bak` | 0.074s | 0.046s | 0.12s |
| `dirtycoverage_large_dirty.bak` | 0.428s | 0.036s | 0.464s |
| `dirtycoverage_lob_update.bak` | 0.085s | 0.038s | 0.123s |
| `dirtycoverage_maxrow.bak` | 0.044s | 0.045s | 0.089s |
| `dirtycoverage_multi_update.bak` | 0.076s | 0.036s | 0.112s |
| `dirtycoverage_nchar_delete.bak` | 0.074s | 0.04s | 0.114s |
| `dirtycoverage_nested.bak` | 0.076s | 0.049s | 0.125s |
| `dirtycoverage_null_update.bak` | 0.063s | 0.042s | 0.105s |
| `dirtycoverage_rebuildidx.bak` | 0.042s | 0.039s | 0.081s |
| `dirtycoverage_rich_insert.bak` | 0.069s | 0.04s | 0.109s |
| `dirtycoverage_rich_update.bak` | 0.074s | 0.044s | 0.118s |
| `dirtycoverage_savepoint.bak` | 0.078s | 0.044s | 0.122s |
| `dirtycoverage_snapshot_update.bak` | 0.07s | 0.047s | 0.117s |
| `dirtycoverage_switch.bak` | 0.049s | 0.04s | 0.089s |
| `dirtycoverage_temporal_update.bak` | 0.071s | 0.042s | 0.113s |
| `dirtycoverage_truncate.bak` | 0.04s | 0.041s | 0.081s |
| `dirtycoverage_two_tx.bak` | 0.069s | 0.051s | 0.12s |
| `dirtycoverage_uncommitted.bak` | 0.07s | 0.047s | 0.117s |
| `dirtycoverage_update.bak` | 0.074s | 0.049s | 0.123s |
| `dirtycoverage_wide.bak` | 0.072s | 0.037s | 0.109s |
| `featurecoverage_full.bak` | 0.104s | 0.075s | 0.179s |
| `filtered_ncci_full.bak` | 0.045s | 0.041s | 0.086s |
| `float_extreme_full.bak` | 0.037s | 0.037s | 0.074s |
| `forwarded_records_full.bak` | 0.101s | 0.097s | 0.198s |
| `geocoverage_full.bak` | 0.047s | 0.051s | 0.098s |
| `geotest.bak` | 0.044s | 0.042s | 0.086s |
| `ghost_records_full.bak` | 0.053s | 0.062s | 0.115s |
| `heapcoverage_large.bak` | 0.05s | 0.051s | 0.101s |
| `heapcoverage_large_50000.bak` | 0.088s | 0.471s | 0.559s |
| `hierarchyid_extract_full.bak` | 0.041s | 0.046s | 0.087s |
| `high_slot_density_full.bak` | 0.041s | 0.281s | 0.322s |
| `incrementalcoverage_diff_01.bak` | 0.046s | 0.014s | 0.06s |
| `incrementalcoverage_diff_02.bak` | 0.059s | 0.018s | 0.077s |
| `incrementalcoverage_diff_03.bak` | 0.047s | 0.014s | 0.061s |
| `incrementalcoverage_diff_04.bak` | 0.058s | 0.02s | 0.078s |
| `incrementalcoverage_diff_05.bak` | 0.06s | 0.022s | 0.082s |
| `incrementalcoverage_diff_06.bak` | 0.058s | 0.025s | 0.083s |
| `incrementalcoverage_full.bak` | 0.042s | 0.043s | 0.085s |
| `layoutcoverage_full.bak` | 0.128s | 0.215s | 0.343s |
| `legacytext.bak` | 0.058s | 0.055s | 0.113s |
| `max_row_width_full.bak` | 0.04s | 0.038s | 0.078s |
| `mixed_collation_full.bak` | 0.039s | 0.043s | 0.082s |
| `multi_rowgroup_full.bak` | 0.043s | 0.052s | 0.095s |
| `ncci_heap_full.bak` | 0.033s | 0.04s | 0.073s |
| `ncci_types_full.bak` | 0.067s | 0.362s | 0.429s |
| `ndfcoverage_full.bak` | 0.043s | 0.045s | 0.088s |
| `nvarchar_max_u21_full.bak` | 0.041s | 0.035s | 0.076s |
| `ordered_cci_full.bak` | 0.044s | 0.048s | 0.092s |
| `pagecomp_anchor_full.bak` | 0.189s | 0.156s | 0.345s |
| `pagecomp_long_prefix_full.bak` | 0.062s | 0.049s | 0.111s |
| `pfor_columnstore_full.bak` | 0.112s | 1.165s | 1.277s |
| `pfor_columnstore_random_full.bak` | 0.119s | 1.175s | 1.294s |
| `realworld_numeric_digest_full.bak` | 0.063s | 0.119s | 0.182s |
| `rowboundary_full.bak` | 0.035s | 0.039s | 0.074s |
| `rowstore_hash_pii_full.bak` | 0.041s | 0.051s | 0.092s |
| `rowstore_lob_image_full.bak` | 0.037s | 0.041s | 0.078s |
| `rowstore_lob_markup_full.bak` | 0.102s | 0.067s | 0.169s |
| `rowversion_extract_full.bak` | 0.074s | 0.106s | 0.18s |
| `sparse_full.bak` | 0.096s | 0.15s | 0.246s |
| `spatial_edge_full.bak` | 0.139s | 0.051s | 0.19s |
| `spatial_index_full.bak` | 0.044s | 0.053s | 0.097s |
| `sql_variant_extract_full.bak` | 0.034s | 0.048s | 0.082s |
| `striped_full_1.bak` | 0.068s | 0.024s | 0.092s |
| `striped_single.bak` | 0.049s | 0.065s | 0.114s |
| `surrogate_pairs_full.bak` | 0.039s | 0.043s | 0.082s |
| `tabletype_cci_large_full.bak` | 0.068s | 0.053s | 0.121s |
| `tabletypecoverage_diff.bak` | 0.123s | 0.078s | 0.201s |
| `tabletypecoverage_full.bak` | 0.08s | 0.112s | 0.192s |
| `temporal_hidden_full.bak` | 0.04s | 0.041s | 0.081s |
| `torn_page_full.bak` | 0.041s | 0.037s | 0.078s |
| `typecoverage_full.bak` | 0.073s | 0.083s | 0.156s |
| `typecoverage_full_compressed.bak` | 0.103s | 0.122s | 0.225s |
| `typed_xml_full.bak` | 0.092s | 0.082s | 0.174s |
| `unicode_codepage_coverage.bak` | 0.062s | 0.047s | 0.109s |
| `utf8_collation_full.bak` | 0.04s | 0.038s | 0.078s |
| `xml_index_full.bak` | 0.05s | 0.043s | 0.093s |
| `xmlcoverage_full.bak` | 0.045s | 0.068s | 0.113s |
| `xmlheap_full.bak` | 0.069s | 0.057s | 0.126s |
| `xtp_checkpoint_straddle_full.bak` | 1.306s | 0.386s | 1.692s |
| `xtp_probe_full.bak` | 0.107s | 0.04s | 0.147s |
| `xtp_rich_full.bak` | 0.084s | 0.046s | 0.13s |
| `xtp_simple_full.bak` | 0.093s | 0.042s | 0.135s |
...
_Generated 2026-07-11 · 146 fixtures · 145 pass · 0 xfail · 1 fail_
