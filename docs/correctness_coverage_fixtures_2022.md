...
| Backup | Wall time |
|--------|-------------|
| `alias_types_full.bak` | 0.07s |
| `archive_columnstore_partition_full.bak` | 2.407s |
| `archive_columnstore_types_full.bak` | 1.338s |
| `archive_columnstore_types_random_full.bak` | 1.349s |
| `archive_single_chunk_full.bak` | 0.089s |
| `archive_single_chunk_random_full.bak` | 0.083s |
| `archivenull_full.bak` | 0.3s |
| `backup_blocksize_full.bak` | 0.082s |
| `boundarycoverage_datetime_full.bak` | 0.361s |
| `boundarycoverage_full.bak` | 0.196s |
| `catalog_ss2022.bak` | 0.081s |
| `cci_binary_varbinary_compare_full.bak` | 0.088s |
| `cci_bitpack_probe_bigint_full.bak` | 8.196s |
| `cci_bitpack_probe_full.bak` | 1.745s |
| `cci_bitpack_probe_highbase_full.bak` | 1.274s |
| `cci_btree_nci_full.bak` | 0.087s |
| `cci_computed_full.bak` | 0.085s |
| `cci_enc5_largepool_full.bak` | 1.299s |
| `cci_enc5_largepool_matrix_full.bak` | 9.364s |
| `cci_extended_full.bak` | 0.122s |
| `cci_lob_full.bak` | 0.107s |
| `cci_reorganize_full.bak` | 0.089s |
| `cci_string_dict_regression_full.bak` | 0.51s |
| `cci_string_minmax_full.bak` | 0.098s |
| `cci_switch_full.bak` | 0.086s |
| `cci_types_large_full.bak` | 0.123s |
| `cci_varbinary_micro_full.bak` | 0.082s |
| `cci_varbinary_probe_full.bak` | 0.085s |
| `columnstore_minimal.bak` | 1.09s |
| `compressed_nvarchar_full.bak` | 0.072s |
| `compressioncoverage_full.bak` | 0.348s |
| `computedcoverage_full.bak` | 0.078s |
| `constraintcoverage_full.bak` | 0.081s |
| `corrupt_metadata_confidence_full.bak` | 0.001s |
| `covering_index_full.bak` | 0.089s |
| `cs_lob_preamble.bak` | 0.258s |
| `cs_lob_preamble2.bak` | 0.143s |
| `delta_rowgroup_full.bak` | 0.079s |
| `dirtycoverage_aborted_xact.bak` | 0.104s |
| `dirtycoverage_addcol.bak` | 0.076s |
| `dirtycoverage_addnotnull.bak` | 0.072s |
| `dirtycoverage_alldirty.bak` | 0.093s |
| `dirtycoverage_altercol.bak` | 0.072s |
| `dirtycoverage_altercol_rewrite.bak` | 0.071s |
| `dirtycoverage_alterdb.bak` | 0.08s |
| `dirtycoverage_cci_delete.bak` | 0.224s |
| `dirtycoverage_cci_update.bak` | 0.335s |
| `dirtycoverage_committed_delete.bak` | 0.069s |
| `dirtycoverage_committed_delete_v2.bak` | 2.617s |
...
| `dirtycoverage_committed_update_v2.bak` | 12.672s |
| `dirtycoverage_committed_update_v3.bak` | 0.179s |
| `dirtycoverage_committed_update_v4.bak` | 0.336s |
| `dirtycoverage_compress_update.bak` | 0.105s |
| `dirtycoverage_concurrent.bak` | 0.079s |
| `dirtycoverage_createidx.bak` | 0.074s |
| `dirtycoverage_createtable.bak` | 0.078s |
| `dirtycoverage_delete.bak` | 0.102s |
| `dirtycoverage_dropcol.bak` | 0.07s |
| `dirtycoverage_dropidx.bak` | 0.077s |
| `dirtycoverage_droptable.bak` | 0.081s |
| `dirtycoverage_heap_forward.bak` | 0.09s |
| `dirtycoverage_insert_update.bak` | 0.106s |
...
| `dirtycoverage_nchar_delete.bak` | 0.109s |
| `dirtycoverage_nested.bak` | 0.122s |
| `dirtycoverage_null_update.bak` | 0.107s |
| `dirtycoverage_rebuildidx.bak` | 0.074s |
| `dirtycoverage_rich_insert.bak` | 0.108s |
| `dirtycoverage_rich_update.bak` | 0.109s |
| `dirtycoverage_savepoint.bak` | 0.107s |
| `dirtycoverage_snapshot_update.bak` | 0.102s |
| `dirtycoverage_switch.bak` | 0.077s |
| `dirtycoverage_temporal_update.bak` | 0.121s |
| `dirtycoverage_truncate.bak` | 0.08s |
| `dirtycoverage_two_tx.bak` | 0.101s |
| `dirtycoverage_uncommitted.bak` | 0.105s |
| `dirtycoverage_update.bak` | 0.108s |
| `dirtycoverage_wide.bak` | 0.109s |
| `featurecoverage_full.bak` | 0.189s |
| `filtered_ncci_full.bak` | 0.092s |
| `float_extreme_full.bak` | 0.08s |
| `forwarded_records_full.bak` | 0.187s |
| `geocoverage_full.bak` | 0.1s |
| `geotest.bak` | 0.083s |
| `ghost_records_full.bak` | 0.069s |
| `heapcoverage_large.bak` | 0.098s |
| `heapcoverage_large_50000.bak` | 1.114s |
| `hierarchyid_extract_full.bak` | 0.072s |
| `high_slot_density_full.bak` | 0.673s |
| `incrementalcoverage_diff_01.bak` | 0.061s |
| `incrementalcoverage_diff_02.bak` | 0.052s |
| `incrementalcoverage_diff_03.bak` | 0.055s |
| `incrementalcoverage_diff_04.bak` | 0.054s |
| `incrementalcoverage_diff_05.bak` | 0.059s |
| `incrementalcoverage_diff_06.bak` | 0.058s |
| `incrementalcoverage_full.bak` | 0.073s |
| `layoutcoverage_full.bak` | 0.375s |
| `legacytext.bak` | 0.117s |
| `max_row_width_full.bak` | 0.072s |
| `mixed_collation_full.bak` | 0.08s |
| `multi_rowgroup_full.bak` | 0.082s |
| `ncci_heap_full.bak` | 0.081s |
| `ncci_types_full.bak` | 0.621s |
| `ndfcoverage_full.bak` | 0.08s |
| `nvarchar_max_u21_full.bak` | 0.075s |
| `ordered_cci_full.bak` | 0.09s |
| `pagecomp_anchor_full.bak` | 0.369s |
| `pagecomp_long_prefix_full.bak` | 0.072s |
| `pfor_columnstore_full.bak` | 2.268s |
| `pfor_columnstore_random_full.bak` | 2.288s |
| `realworld_numeric_digest_full.bak` | 0.207s |
| `rowboundary_full.bak` | 0.078s |
| `rowstore_hash_pii_full.bak` | 0.068s |
| `rowstore_lob_image_full.bak` | 0.077s |
| `rowstore_lob_markup_full.bak` | 0.082s |
| `rowversion_extract_full.bak` | 0.079s |
| `sparse_full.bak` | 0.313s |
| `spatial_edge_full.bak` | 0.083s |
| `spatial_index_full.bak` | 0.08s |
| `sql_variant_extract_full.bak` | 0.069s |
| `striped_full_1.bak` | 0.063s |
| `striped_single.bak` | 0.1s |
| `surrogate_pairs_full.bak` | 0.086s |
| `tabletype_cci_large_full.bak` | 0.121s |
| `tabletypecoverage_diff.bak` | 0.201s |
| `tabletypecoverage_full.bak` | 0.181s |
| `temporal_hidden_full.bak` | 0.077s |
| `torn_page_full.bak` | 0.063s |
| `typecoverage_full.bak` | 0.164s |
| `typecoverage_full_compressed.bak` | 0.219s |
| `typed_xml_full.bak` | 0.075s |
| `unicode_codepage_coverage.bak` | 0.127s |
| `utf8_collation_full.bak` | 0.073s |
| `xml_index_full.bak` | 0.081s |
| `xmlcoverage_full.bak` | 0.074s |
| `xmlheap_full.bak` | 0.138s |
| `xtp_checkpoint_straddle_full.bak` | 2.914s |
| `xtp_probe_full.bak` | 0.146s |
| `xtp_rich_full.bak` | 0.133s |
| `xtp_simple_full.bak` | 0.125s |
