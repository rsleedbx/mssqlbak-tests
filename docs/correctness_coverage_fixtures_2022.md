...
| Backup | Wall time |
|--------|-------------|
| `alias_types_full.bak` | 0.088s |
| `archive_columnstore_partition_full.bak` | 2.485s |
| `archive_columnstore_types_full.bak` | 1.341s |
| `archive_columnstore_types_random_full.bak` | 1.344s |
| `archive_single_chunk_full.bak` | 0.106s |
| `archive_single_chunk_random_full.bak` | 0.092s |
| `archivenull_full.bak` | 0.308s |
| `backup_blocksize_full.bak` | 0.101s |
| `boundarycoverage_datetime_full.bak` | 0.439s |
| `boundarycoverage_full.bak` | 0.212s |
| `catalog_ss2022.bak` | 0.07s |
| `cci_binary_varbinary_compare_full.bak` | 0.105s |
| `cci_bitpack_probe_bigint_full.bak` | 8.952s |
| `cci_bitpack_probe_full.bak` | 1.823s |
| `cci_bitpack_probe_highbase_full.bak` | 1.314s |
| `cci_btree_nci_full.bak` | 0.096s |
| `cci_computed_full.bak` | 0.109s |
| `cci_enc5_largepool_full.bak` | 1.176s |
| `cci_enc5_largepool_matrix_full.bak` | 9.616s |
| `cci_extended_full.bak` | 0.135s |
| `cci_lob_full.bak` | 0.114s |
| `cci_reorganize_full.bak` | 0.108s |
| `cci_string_dict_regression_full.bak` | 0.513s |
| `cci_string_minmax_full.bak` | 0.104s |
| `cci_switch_full.bak` | 0.108s |
| `cci_types_large_full.bak` | 0.132s |
| `cci_varbinary_micro_full.bak` | 0.117s |
| `cci_varbinary_probe_full.bak` | 0.099s |
| `columnstore_minimal.bak` | 1.184s |
| `compressed_nvarchar_full.bak` | 0.075s |
| `compressioncoverage_full.bak` | 0.372s |
| `computedcoverage_full.bak` | 0.078s |
| `constraintcoverage_full.bak` | 0.113s |
| `corrupt_metadata_confidence_full.bak` | 0.0s |
| `covering_index_full.bak` | 0.104s |
| `cs_lob_preamble.bak` | 0.246s |
| `cs_lob_preamble2.bak` | 0.149s |
| `delta_rowgroup_full.bak` | 0.103s |
| `dirtycoverage_aborted_xact.bak` | 0.099s |
| `dirtycoverage_addcol.bak` | 0.087s |
| `dirtycoverage_addnotnull.bak` | 0.086s |
| `dirtycoverage_alldirty.bak` | 0.112s |
| `dirtycoverage_altercol.bak` | 0.087s |
| `dirtycoverage_altercol_rewrite.bak` | 0.088s |
| `dirtycoverage_alterdb.bak` | 0.101s |
| `dirtycoverage_cci_delete.bak` | 0.211s |
| `dirtycoverage_cci_update.bak` | 0.332s |
| `dirtycoverage_committed_delete.bak` | 0.072s |
| `dirtycoverage_committed_delete_v2.bak` | 2.872s |
| `dirtycoverage_committed_delete_v3.bak` | 0.154s |
| `dirtycoverage_committed_delete_v4.bak` | 0.349s |
| `dirtycoverage_committed_update.bak` | 0.074s |
| `dirtycoverage_committed_update_v2.bak` | 13.08s |
| `dirtycoverage_committed_update_v3.bak` | 0.173s |
| `dirtycoverage_committed_update_v4.bak` | 0.322s |
| `dirtycoverage_compress_update.bak` | 0.109s |
| `dirtycoverage_concurrent.bak` | 0.098s |
| `dirtycoverage_createidx.bak` | 0.093s |
| `dirtycoverage_createtable.bak` | 0.109s |
| `dirtycoverage_delete.bak` | 0.111s |
| `dirtycoverage_dropcol.bak` | 0.087s |
| `dirtycoverage_dropidx.bak` | 0.099s |
| `dirtycoverage_droptable.bak` | 0.104s |
| `dirtycoverage_heap_forward.bak` | 0.111s |
| `dirtycoverage_insert_update.bak` | 0.111s |
| `dirtycoverage_large_dirty.bak` | 0.397s |
| `dirtycoverage_lob_update.bak` | 0.147s |
| `dirtycoverage_maxrow.bak` | 0.071s |
| `dirtycoverage_multi_update.bak` | 0.107s |
| `dirtycoverage_nchar_delete.bak` | 0.104s |
| `dirtycoverage_nested.bak` | 0.105s |
| `dirtycoverage_null_update.bak` | 0.105s |
| `dirtycoverage_rebuildidx.bak` | 0.09s |
| `dirtycoverage_rich_insert.bak` | 0.097s |
| `dirtycoverage_rich_update.bak` | 0.11s |
| `dirtycoverage_savepoint.bak` | 0.11s |
| `dirtycoverage_snapshot_update.bak` | 0.127s |
| `dirtycoverage_switch.bak` | 0.093s |
| `dirtycoverage_temporal_update.bak` | 0.122s |
| `dirtycoverage_truncate.bak` | 0.1s |
| `dirtycoverage_two_tx.bak` | 0.109s |
| `dirtycoverage_uncommitted.bak` | 0.113s |
| `dirtycoverage_update.bak` | 0.14s |
| `dirtycoverage_wide.bak` | 0.111s |
| `featurecoverage_full.bak` | 0.189s |
| `filtered_ncci_full.bak` | 0.102s |
| `float_extreme_full.bak` | 0.071s |
| `forwarded_records_full.bak` | 0.184s |
| `geocoverage_full.bak` | 0.117s |
| `geotest.bak` | 0.097s |
| `ghost_records_full.bak` | 0.085s |
| `heapcoverage_large.bak` | 0.117s |
| `heapcoverage_large_50000.bak` | 0.994s |
| `hierarchyid_extract_full.bak` | 0.075s |
| `high_slot_density_full.bak` | 0.587s |
| `incrementalcoverage_diff_01.bak` | 0.05s |
| `incrementalcoverage_diff_02.bak` | 0.05s |
| `incrementalcoverage_diff_03.bak` | 0.051s |
| `incrementalcoverage_diff_04.bak` | 0.052s |
| `incrementalcoverage_diff_05.bak` | 0.077s |
| `incrementalcoverage_diff_06.bak` | 0.067s |
| `incrementalcoverage_full.bak` | 0.147s |
| `layoutcoverage_full.bak` | 0.387s |
| `legacytext.bak` | 0.117s |
| `max_row_width_full.bak` | 0.068s |
| `mixed_collation_full.bak` | 0.071s |
| `multi_rowgroup_full.bak` | 0.112s |
| `ncci_heap_full.bak` | 0.083s |
| `ncci_types_full.bak` | 0.52s |
| `ndfcoverage_full.bak` | 0.098s |
| `nvarchar_max_u21_full.bak` | 0.147s |
| `ordered_cci_full.bak` | 0.111s |
| `pagecomp_anchor_full.bak` | 0.363s |
| `pagecomp_long_prefix_full.bak` | 0.077s |
| `pfor_columnstore_full.bak` | 2.337s |
| `pfor_columnstore_random_full.bak` | 2.33s |
| `realworld_numeric_digest_full.bak` | 0.194s |
| `rowboundary_full.bak` | 0.115s |
| `rowstore_hash_pii_full.bak` | 0.146s |
| `rowstore_lob_image_full.bak` | 0.07s |
| `rowstore_lob_markup_full.bak` | 0.069s |
| `rowversion_extract_full.bak` | 0.079s |
| `sparse_full.bak` | 0.291s |
| `spatial_edge_full.bak` | 0.087s |
| `spatial_index_full.bak` | 0.101s |
| `sql_variant_extract_full.bak` | 0.075s |
| `striped_full_1.bak` | 0.1s |
| `striped_single.bak` | 0.101s |
| `surrogate_pairs_full.bak` | 0.16s |
| `tabletype_cci_large_full.bak` | 0.118s |
| `tabletypecoverage_diff.bak` | 0.182s |
| `tabletypecoverage_full.bak` | 0.175s |
| `temporal_hidden_full.bak` | 0.113s |
| `torn_page_full.bak` | 0.079s |
| `typecoverage_full.bak` | 0.149s |
| `typecoverage_full_compressed.bak` | 0.203s |
| `typed_xml_full.bak` | 0.082s |
| `unicode_codepage_coverage.bak` | 0.128s |
| `utf8_collation_full.bak` | 0.072s |
| `xml_index_full.bak` | 0.108s |
| `xmlcoverage_full.bak` | 0.079s |
| `xmlheap_full.bak` | 0.154s |
| `xtp_checkpoint_straddle_full.bak` | 2.992s |
| `xtp_probe_full.bak` | 0.155s |
