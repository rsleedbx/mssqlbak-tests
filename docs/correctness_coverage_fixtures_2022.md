...
| `archive_columnstore_partition_full.bak` | 0.856s | 0.593s | 1.449s |
| `archive_columnstore_types_full.bak` | 0.372s | 0.697s | 1.069s |
| `archive_columnstore_types_random_full.bak` | 0.332s | 0.716s | 1.048s |
| `archive_single_chunk_full.bak` | 0.048s | 0.044s | 0.092s |
| `archive_single_chunk_random_full.bak` | 0.047s | 0.043s | 0.09s |
| `archivenull_full.bak` | 0.12s | 0.091s | 0.211s |
| `backup_blocksize_full.bak` | 0.037s | 0.034s | 0.071s |
| `boundarycoverage_datetime_full.bak` | 0.069s | 0.191s | 0.26s |
| `boundarycoverage_full.bak` | 0.049s | 0.066s | 0.115s |
| `catalog_ss2022.bak` | 0.035s | 0.034s | 0.069s |
| `cci_binary_varbinary_compare_full.bak` | 0.047s | 0.043s | 0.09s |
| `cci_bitpack_probe_bigint_full.bak` | 0.286s | 4.153s | 4.439s |
| `cci_bitpack_probe_full.bak` | 0.078s | 0.665s | 0.743s |
| `cci_bitpack_probe_highbase_full.bak` | 0.062s | 0.43s | 0.492s |
| `cci_btree_nci_full.bak` | 0.052s | 0.042s | 0.094s |
| `cci_computed_full.bak` | 0.049s | 0.038s | 0.087s |
| `cci_enc5_largepool_full.bak` | 0.313s | 0.433s | 0.746s |
| `cci_enc5_largepool_matrix_full.bak` | 7.419s | 1.376s | 8.795s |
| `cci_extended_full.bak` | 0.05s | 0.048s | 0.098s |
| `cci_lob_full.bak` | 0.05s | 0.051s | 0.101s |
| `cci_reorganize_full.bak` | 0.044s | 0.038s | 0.082s |
| `cci_string_dict_regression_full.bak` | 0.287s | 0.203s | 0.49s |
| `cci_string_minmax_full.bak` | 0.05s | 0.043s | 0.093s |
| `cci_switch_full.bak` | 0.046s | 0.05s | 0.096s |
| `cci_types_large_full.bak` | 0.068s | 0.053s | 0.121s |
| `cci_varbinary_micro_full.bak` | 0.041s | 0.043s | 0.084s |
| `cci_varbinary_probe_full.bak` | 0.044s | 0.05s | 0.094s |
| `columnstore_minimal.bak` | 0.116s | 0.996s | 1.112s |
| `compressed_nvarchar_full.bak` | 0.035s | 0.033s | 0.068s |
| `compressioncoverage_full.bak` | 0.075s | 0.206s | 0.281s |
| `computedcoverage_full.bak` | 0.032s | 0.039s | 0.071s |
| `constraintcoverage_full.bak` | 0.04s | 0.046s | 0.086s |
| `corrupt_metadata_confidence_full.bak` | 0s | 0.001s | 0.001s |
| `covering_index_full.bak` | 0.042s | 0.044s | 0.086s |
| `cs_lob_preamble.bak` | 0.119s | 0.077s | 0.196s |
| `cs_lob_preamble2.bak` | 0.068s | 0.057s | 0.125s |
| `delta_rowgroup_full.bak` | 0.039s | 0.035s | 0.074s |
| `dirtycoverage_aborted_xact.bak` | 0.065s | 0.041s | 0.106s |
| `dirtycoverage_addcol.bak` | 0.04s | 0.034s | 0.074s |
| `dirtycoverage_addnotnull.bak` | 0.035s | 0.033s | 0.068s |
| `dirtycoverage_alldirty.bak` | 0.065s | 0.034s | 0.099s |
| `dirtycoverage_altercol.bak` | 0.038s | 0.042s | 0.08s |
| `dirtycoverage_altercol_rewrite.bak` | 0.045s | 0.039s | 0.084s |
| `dirtycoverage_alterdb.bak` | 0.035s | 0.035s | 0.07s |
| `dirtycoverage_cci_delete.bak` | 0.087s | 0.093s | 0.18s |
| `dirtycoverage_cci_update.bak` | 0.229s | 0.1s | 0.329s |
| `dirtycoverage_committed_delete.bak` | 0.032s | 0.044s | 0.076s |
| `dirtycoverage_committed_delete_v2.bak` | 0.511s | 0.497s | 1.008s |
| `dirtycoverage_committed_delete_v3.bak` | 0.046s | 0.06s | 0.106s |
| `dirtycoverage_committed_delete_v4.bak` | 0.147s | 0.07s | 0.217s |
| `dirtycoverage_committed_update.bak` | 0.032s | 0.047s | 0.079s |
| `dirtycoverage_committed_update_v2.bak` | 9.276s | 0.983s | 10.259s |
| `dirtycoverage_committed_update_v3.bak` | 0.044s | 0.072s | 0.116s |
| `dirtycoverage_committed_update_v4.bak` | 0.095s | 0.076s | 0.171s |
| `dirtycoverage_compress_update.bak` | 0.068s | 0.035s | 0.103s |
| `dirtycoverage_concurrent.bak` | 0.035s | 0.044s | 0.079s |
| `dirtycoverage_createidx.bak` | 0.041s | 0.035s | 0.076s |
| `dirtycoverage_createtable.bak` | 0.035s | 0.037s | 0.072s |
| `dirtycoverage_delete.bak` | 0.067s | 0.034s | 0.101s |
| `dirtycoverage_dropcol.bak` | 0.041s | 0.045s | 0.086s |
| `dirtycoverage_dropidx.bak` | 0.035s | 0.036s | 0.071s |
| `dirtycoverage_droptable.bak` | 0.041s | 0.044s | 0.085s |
| `dirtycoverage_heap_forward.bak` | 0.06s | 0.04s | 0.1s |
| `dirtycoverage_insert_update.bak` | 0.065s | 0.033s | 0.098s |
| `dirtycoverage_large_dirty.bak` | 0.372s | 0.045s | 0.417s |
| `dirtycoverage_lob_update.bak` | 0.081s | 0.038s | 0.119s |
| `dirtycoverage_maxrow.bak` | 0.032s | 0.032s | 0.064s |
| `dirtycoverage_multi_update.bak` | 0.066s | 0.044s | 0.11s |
| `dirtycoverage_nchar_delete.bak` | 0.062s | 0.039s | 0.101s |
| `dirtycoverage_nested.bak` | 0.076s | 0.037s | 0.113s |
| `dirtycoverage_null_update.bak` | 0.069s | 0.041s | 0.11s |
| `dirtycoverage_rebuildidx.bak` | 0.044s | 0.046s | 0.09s |
| `dirtycoverage_rich_insert.bak` | 0.066s | 0.039s | 0.105s |
| `dirtycoverage_rich_update.bak` | 0.064s | 0.037s | 0.101s |
| `dirtycoverage_savepoint.bak` | 0.072s | 0.034s | 0.106s |
| `dirtycoverage_snapshot_update.bak` | 0.063s | 0.037s | 0.1s |
| `dirtycoverage_switch.bak` | 0.037s | 0.045s | 0.082s |
| `dirtycoverage_temporal_update.bak` | 0.07s | 0.042s | 0.112s |
| `dirtycoverage_truncate.bak` | 0.036s | 0.045s | 0.081s |
| `dirtycoverage_two_tx.bak` | 0.067s | 0.039s | 0.106s |
| `dirtycoverage_uncommitted.bak` | 0.076s | 0.039s | 0.115s |
| `dirtycoverage_update.bak` | 0.076s | 0.039s | 0.115s |
| `dirtycoverage_wide.bak` | 0.063s | 0.033s | 0.096s |
| `featurecoverage_full.bak` | 0.103s | 0.057s | 0.16s |
| `filtered_ncci_full.bak` | 0.037s | 0.048s | 0.085s |
| `float_extreme_full.bak` | 0.031s | 0.036s | 0.067s |
| `forwarded_records_full.bak` | 0.081s | 0.08s | 0.161s |
| `geocoverage_full.bak` | 0.05s | 0.051s | 0.101s |
| `geotest.bak` | 0.044s | 0.044s | 0.088s |
| `ghost_records_full.bak` | 0.031s | 0.035s | 0.066s |
| `heapcoverage_large.bak` | 0.041s | 0.051s | 0.092s |
| `heapcoverage_large_50000.bak` | 0.088s | 0.383s | 0.471s |
| `hierarchyid_extract_full.bak` | 0.032s | 0.034s | 0.066s |
| `high_slot_density_full.bak` | 0.045s | 0.187s | 0.232s |
| `identity_coverage_full.bak` | 0.046s | 0.044s | 0.09s |
| `incrementalcoverage_diff_01.bak` | 0.038s | 0.012s | 0.05s |
| `incrementalcoverage_diff_02.bak` | 0.041s | 0.016s | 0.057s |
| `incrementalcoverage_diff_03.bak` | 0.041s | 0.012s | 0.053s |
| `incrementalcoverage_diff_04.bak` | 0.04s | 0.012s | 0.052s |
| `incrementalcoverage_diff_05.bak` | 0.042s | 0.015s | 0.057s |
| `incrementalcoverage_diff_06.bak` | 0.039s | 0.013s | 0.052s |
| `incrementalcoverage_full.bak` | 0.031s | 0.032s | 0.063s |
| `layoutcoverage_full.bak` | 0.119s | 0.32s | 0.439s |
| `legacytext.bak` | 0.049s | 0.048s | 0.097s |
| `max_row_width_full.bak` | 0.034s | 0.036s | 0.07s |
| `mixed_collation_full.bak` | 0.032s | 0.037s | 0.069s |
| `multi_rowgroup_full.bak` | 0.037s | 0.047s | 0.084s |
| `ncci_heap_full.bak` | 0.033s | 0.039s | 0.072s |
| `ncci_types_full.bak` | 0.059s | 0.182s | 0.241s |
| `ndfcoverage_full.bak` | 0.042s | 0.054s | 0.096s |
| `nvarchar_max_u21_full.bak` | 0.033s | 0.034s | 0.067s |
| `ordered_cci_full.bak` | 0.035s | 0.043s | 0.078s |
| `pagecomp_anchor_full.bak` | 0.122s | 0.095s | 0.217s |
| `pagecomp_long_prefix_full.bak` | 0.034s | 0.034s | 0.068s |
| `pfor_columnstore_full.bak` | 0.1s | 0.827s | 0.927s |
| `pfor_columnstore_random_full.bak` | 0.102s | 0.81s | 0.912s |
| `realworld_numeric_digest_full.bak` | 0.05s | 0.088s | 0.138s |
| `rowboundary_full.bak` | 0.033s | 0.036s | 0.069s |
| `rowstore_hash_pii_full.bak` | 0.031s | 0.033s | 0.064s |
| `rowstore_lob_image_full.bak` | 0.036s | 0.033s | 0.069s |
| `rowstore_lob_markup_full.bak` | 0.032s | 0.037s | 0.069s |
| `rowversion_extract_full.bak` | 0.036s | 0.037s | 0.073s |
| `sparse_full.bak` | 0.086s | 0.099s | 0.185s |
| `spatial_edge_full.bak` | 0.036s | 0.043s | 0.079s |
| `spatial_index_full.bak` | 0.038s | 0.039s | 0.077s |
| `sql_variant_extract_full.bak` | 0.034s | 0.033s | 0.067s |
| `striped_full_1.bak` | 0.048s | 0.014s | 0.062s |
| `striped_single.bak` | 0.054s | 0.047s | 0.101s |
| `surrogate_pairs_full.bak` | 0.031s | 0.034s | 0.065s |
| `tabletype_cci_large_full.bak` | 0.06s | 0.054s | 0.114s |
| `tabletypecoverage_diff.bak` | 0.129s | 0.066s | 0.195s |
| `tabletypecoverage_full.bak` | 0.074s | 0.089s | 0.163s |
| `temporal_hidden_full.bak` | 0.037s | 0.041s | 0.078s |
| `torn_page_full.bak` | 0.028s | 0.03s | 0.058s |
| `typecoverage_full.bak` | 0.062s | 0.066s | 0.128s |
| `typecoverage_full_compressed.bak` | 0.107s | 0.114s | 0.221s |
| `typed_xml_full.bak` | 0.035s | 0.032s | 0.067s |
| `unicode_codepage_coverage.bak` | 0.057s | 0.054s | 0.111s |
| `utf8_collation_full.bak` | 0.032s | 0.034s | 0.066s |
| `xml_index_full.bak` | 0.041s | 0.04s | 0.081s |
| `xmlcoverage_full.bak` | 0.039s | 0.036s | 0.075s |
| `xmlheap_full.bak` | 0.054s | 0.059s | 0.113s |
| `xtp_checkpoint_straddle_full.bak` | 1.697s | 0.447s | 2.144s |
| `xtp_probe_full.bak` | 0.096s | 0.052s | 0.148s |
| `xtp_rich_full.bak` | 0.086s | 0.041s | 0.127s |
