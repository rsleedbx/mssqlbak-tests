...
|--------|---------|--------|-----------|
| `alias_types_full.bak` | 0.047s | 0.092s | 0.139s |
| `archive_columnstore_partition_full.bak` | 0.914s | 0.664s | 1.578s |
| `archive_columnstore_types_full.bak` | 0.355s | 0.781s | 1.136s |
| `archive_columnstore_types_random_full.bak` | 0.36s | 0.779s | 1.139s |
| `archive_single_chunk_full.bak` | 0.049s | 0.066s | 0.115s |
| `archive_single_chunk_random_full.bak` | 0.047s | 0.044s | 0.091s |
| `archivenull_full.bak` | 0.144s | 0.1s | 0.244s |
| `backup_blocksize_full.bak` | 0.035s | 0.035s | 0.07s |
| `boundarycoverage_datetime_full.bak` | 0.077s | 0.17s | 0.247s |
| `boundarycoverage_full.bak` | 0.054s | 0.078s | 0.132s |
| `catalog_ss2022.bak` | 0.037s | 0.033s | 0.07s |
| `cci_binary_varbinary_compare_full.bak` | 0.042s | 0.036s | 0.078s |
| `cci_bitpack_probe_bigint_full.bak` | 0.276s | 3.884s | 4.16s |
| `cci_bitpack_probe_full.bak` | 0.105s | 0.684s | 0.789s |
| `cci_bitpack_probe_highbase_full.bak` | 0.074s | 0.452s | 0.526s |
| `cci_btree_nci_full.bak` | 0.053s | 0.082s | 0.135s |
| `cci_computed_full.bak` | 0.042s | 0.04s | 0.082s |
| `cci_enc5_largepool_full.bak` | 0.315s | 0.442s | 0.757s |
| `cci_enc5_largepool_matrix_full.bak` | 6.987s | 1.214s | 8.201s |
| `cci_extended_full.bak` | 0.057s | 0.046s | 0.103s |
| `cci_lob_full.bak` | 0.05s | 0.043s | 0.093s |
| `cci_reorganize_full.bak` | 0.042s | 0.037s | 0.079s |
| `cci_string_dict_regression_full.bak` | 0.284s | 0.151s | 0.435s |
| `cci_string_minmax_full.bak` | 0.041s | 0.039s | 0.08s |
| `cci_switch_full.bak` | 0.037s | 0.036s | 0.073s |
| `cci_types_large_full.bak` | 0.054s | 0.046s | 0.1s |
| `cci_varbinary_micro_full.bak` | 0.043s | 0.035s | 0.078s |
| `cci_varbinary_probe_full.bak` | 0.036s | 0.049s | 0.085s |
| `columnstore_minimal.bak` | 0.104s | 0.975s | 1.079s |
| `compressed_nvarchar_full.bak` | 0.039s | 0.037s | 0.076s |
| `compressioncoverage_full.bak` | 0.084s | 0.226s | 0.31s |
| `computedcoverage_full.bak` | 0.04s | 0.04s | 0.08s |
| `constraintcoverage_full.bak` | 0.046s | 0.052s | 0.098s |
| `corrupt_metadata_confidence_full.bak` | 0s | 0.005s | 0.005s |
| `covering_index_full.bak` | 0.04s | 0.05s | 0.09s |
| `cs_lob_preamble.bak` | 0.133s | 0.082s | 0.215s |
| `cs_lob_preamble2.bak` | 0.072s | 0.062s | 0.134s |
| `delta_rowgroup_full.bak` | 0.038s | 0.051s | 0.089s |
| `dirtycoverage_aborted_xact.bak` | 0.076s | 0.04s | 0.116s |
| `dirtycoverage_addcol.bak` | 0.049s | 0.068s | 0.117s |
| `dirtycoverage_addnotnull.bak` | 0.035s | 0.058s | 0.093s |
| `dirtycoverage_alldirty.bak` | 0.063s | 0.035s | 0.098s |
| `dirtycoverage_altercol.bak` | 0.035s | 0.039s | 0.074s |
| `dirtycoverage_altercol_rewrite.bak` | 0.035s | 0.034s | 0.069s |
| `dirtycoverage_alterdb.bak` | 0.035s | 0.034s | 0.069s |
| `dirtycoverage_cci_delete.bak` | 0.082s | 0.087s | 0.169s |
| `dirtycoverage_cci_update.bak` | 0.191s | 0.094s | 0.285s |
| `dirtycoverage_committed_delete.bak` | 0.039s | 0.037s | 0.076s |
| `dirtycoverage_committed_delete_v2.bak` | 0.493s | 0.583s | 1.076s |
| `dirtycoverage_committed_delete_v3.bak` | 0.051s | 0.065s | 0.116s |
| `dirtycoverage_committed_delete_v4.bak` | 0.143s | 0.067s | 0.21s |
| `dirtycoverage_committed_update.bak` | 0.032s | 0.034s | 0.066s |
| `dirtycoverage_committed_update_v2.bak` | 8.808s | 0.833s | 9.641s |
| `dirtycoverage_committed_update_v3.bak` | 0.053s | 0.081s | 0.134s |
| `dirtycoverage_committed_update_v4.bak` | 0.103s | 0.097s | 0.2s |
| `dirtycoverage_compress_update.bak` | 0.091s | 0.036s | 0.127s |
| `dirtycoverage_concurrent.bak` | 0.038s | 0.04s | 0.078s |
| `dirtycoverage_createidx.bak` | 0.035s | 0.037s | 0.072s |
| `dirtycoverage_createtable.bak` | 0.043s | 0.035s | 0.078s |
| `dirtycoverage_delete.bak` | 0.062s | 0.034s | 0.096s |
| `dirtycoverage_dropcol.bak` | 0.035s | 0.036s | 0.071s |
| `dirtycoverage_dropidx.bak` | 0.039s | 0.041s | 0.08s |
| `dirtycoverage_droptable.bak` | 0.036s | 0.035s | 0.071s |
| `dirtycoverage_heap_forward.bak` | 0.056s | 0.031s | 0.087s |
| `dirtycoverage_insert_update.bak` | 0.064s | 0.033s | 0.097s |
| `dirtycoverage_large_dirty.bak` | 0.334s | 0.033s | 0.367s |
| `dirtycoverage_lob_update.bak` | 0.077s | 0.034s | 0.111s |
| `dirtycoverage_maxrow.bak` | 0.031s | 0.035s | 0.066s |
| `dirtycoverage_multi_update.bak` | 0.065s | 0.033s | 0.098s |
| `dirtycoverage_nchar_delete.bak` | 0.061s | 0.033s | 0.094s |
| `dirtycoverage_nested.bak` | 0.064s | 0.034s | 0.098s |
| `dirtycoverage_null_update.bak` | 0.061s | 0.033s | 0.094s |
| `dirtycoverage_rebuildidx.bak` | 0.035s | 0.034s | 0.069s |
| `dirtycoverage_rich_insert.bak` | 0.068s | 0.034s | 0.102s |
| `dirtycoverage_rich_update.bak` | 0.063s | 0.036s | 0.099s |
| `dirtycoverage_savepoint.bak` | 0.064s | 0.037s | 0.101s |
| `dirtycoverage_snapshot_update.bak` | 0.058s | 0.033s | 0.091s |
| `dirtycoverage_switch.bak` | 0.041s | 0.036s | 0.077s |
| `dirtycoverage_temporal_update.bak` | 0.059s | 0.034s | 0.093s |
| `dirtycoverage_truncate.bak` | 0.039s | 0.033s | 0.072s |
| `dirtycoverage_two_tx.bak` | 0.057s | 0.039s | 0.096s |
| `dirtycoverage_uncommitted.bak` | 0.063s | 0.034s | 0.097s |
| `dirtycoverage_update.bak` | 0.065s | 0.04s | 0.105s |
| `dirtycoverage_wide.bak` | 0.063s | 0.032s | 0.095s |
| `featurecoverage_full.bak` | 0.1s | 0.058s | 0.158s |
| `filtered_ncci_full.bak` | 0.037s | 0.04s | 0.077s |
| `float_extreme_full.bak` | 0.032s | 0.033s | 0.065s |
| `forwarded_records_full.bak` | 0.075s | 0.076s | 0.151s |
| `geocoverage_full.bak` | 0.046s | 0.045s | 0.091s |
| `geotest.bak` | 0.035s | 0.037s | 0.072s |
| `ghost_records_full.bak` | 0.031s | 0.035s | 0.066s |
| `heapcoverage_large.bak` | 0.032s | 0.039s | 0.071s |
| `heapcoverage_large_50000.bak` | 0.097s | 0.317s | 0.414s |
| `hierarchyid_extract_full.bak` | 0.034s | 0.038s | 0.072s |
| `high_slot_density_full.bak` | 0.042s | 0.189s | 0.231s |
| `identity_coverage_full.bak` | 0.042s | 0.037s | 0.079s |
| `incrementalcoverage_diff_01.bak` | 0.037s | 0.013s | 0.05s |
| `incrementalcoverage_diff_02.bak` | 0.036s | 0.012s | 0.048s |
| `incrementalcoverage_diff_03.bak` | 0.042s | 0.013s | 0.055s |
| `incrementalcoverage_diff_04.bak` | 0.041s | 0.012s | 0.053s |
| `incrementalcoverage_diff_05.bak` | 0.038s | 0.011s | 0.049s |
| `incrementalcoverage_diff_06.bak` | 0.038s | 0.013s | 0.051s |
| `incrementalcoverage_full.bak` | 0.031s | 0.039s | 0.07s |
| `layoutcoverage_full.bak` | 0.12s | 0.324s | 0.444s |
| `legacytext.bak` | 0.046s | 0.047s | 0.093s |
| `max_row_width_full.bak` | 0.03s | 0.034s | 0.064s |
| `mixed_collation_full.bak` | 0.034s | 0.033s | 0.067s |
| `multi_rowgroup_full.bak` | 0.037s | 0.038s | 0.075s |
| `ncci_heap_full.bak` | 0.033s | 0.034s | 0.067s |
| `ncci_types_full.bak` | 0.059s | 0.192s | 0.251s |
| `ndfcoverage_full.bak` | 0.035s | 0.038s | 0.073s |
| `nvarchar_max_u21_full.bak` | 0.031s | 0.031s | 0.062s |
| `ordered_cci_full.bak` | 0.038s | 0.037s | 0.075s |
| `pagecomp_anchor_full.bak` | 0.124s | 0.096s | 0.22s |
| `pagecomp_long_prefix_full.bak` | 0.041s | 0.031s | 0.072s |
| `pfor_columnstore_full.bak` | 0.098s | 0.849s | 0.947s |
| `pfor_columnstore_random_full.bak` | 0.103s | 0.852s | 0.955s |
| `realworld_numeric_digest_full.bak` | 0.051s | 0.087s | 0.138s |
| `rowboundary_full.bak` | 0.033s | 0.036s | 0.069s |
| `rowstore_hash_pii_full.bak` | 0.035s | 0.033s | 0.068s |
| `rowstore_lob_image_full.bak` | 0.035s | 0.036s | 0.071s |
| `rowstore_lob_markup_full.bak` | 0.035s | 0.034s | 0.069s |
| `rowversion_extract_full.bak` | 0.034s | 0.045s | 0.079s |
| `sparse_full.bak` | 0.085s | 0.088s | 0.173s |
| `spatial_edge_full.bak` | 0.04s | 0.035s | 0.075s |
| `spatial_index_full.bak` | 0.037s | 0.037s | 0.074s |
| `sql_variant_extract_full.bak` | 0.033s | 0.033s | 0.066s |
| `striped_full_1.bak` | 0.047s | 0.015s | 0.062s |
| `striped_single.bak` | 0.046s | 0.047s | 0.093s |
| `surrogate_pairs_full.bak` | 0.031s | 0.033s | 0.064s |
| `tabletype_cci_large_full.bak` | 0.053s | 0.048s | 0.101s |
| `tabletypecoverage_diff.bak` | 0.114s | 0.081s | 0.195s |
| `tabletypecoverage_full.bak` | 0.083s | 0.103s | 0.186s |
| `temporal_hidden_full.bak` | 0.049s | 0.039s | 0.088s |
| `torn_page_full.bak` | 0.036s | 0.032s | 0.068s |
| `typecoverage_full.bak` | 0.063s | 0.075s | 0.138s |
| `typecoverage_full_compressed.bak` | 0.09s | 0.106s | 0.196s |
| `typed_xml_full.bak` | 0.034s | 0.034s | 0.068s |
| `unicode_codepage_coverage.bak` | 0.096s | 0.051s | 0.147s |
| `utf8_collation_full.bak` | 0.035s | 0.034s | 0.069s |
| `xml_index_full.bak` | 0.039s | 0.039s | 0.078s |
| `xmlcoverage_full.bak` | 0.034s | 0.035s | 0.069s |
| `xmlheap_full.bak` | 0.049s | 0.053s | 0.102s |
| `xtp_checkpoint_straddle_full.bak` | 1.287s | 0.33s | 1.617s |
| `xtp_probe_full.bak` | 0.091s | 0.04s | 0.131s |
| `xtp_rich_full.bak` | 0.084s | 0.04s | 0.124s |
| `xtp_simple_full.bak` | 0.075s | 0.037s | 0.112s |
