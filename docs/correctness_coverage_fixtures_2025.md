...
|--------|---------|--------|-----------|
| `alias_types_full.bak` | 0.047s | 0.039s | 0.086s |
| `archive_columnstore_partition_full.bak` | 0.859s | 0.583s | 1.442s |
| `archive_columnstore_types_full.bak` | 0.331s | 0.671s | 1.002s |
| `archive_columnstore_types_random_full.bak` | 0.313s | 0.674s | 0.987s |
| `archive_single_chunk_full.bak` | 0.063s | 0.034s | 0.097s |
| `archive_single_chunk_random_full.bak` | 0.04s | 0.035s | 0.075s |
| `archivenull_full.bak` | 0.119s | 0.206s | 0.325s |
| `backup_blocksize_full.bak` | 0.04s | 0.045s | 0.085s |
| `boundarycoverage_datetime_full.bak` | 0.054s | 0.138s | 0.192s |
| `boundarycoverage_full.bak` | 0.049s | 0.056s | 0.105s |
| `cci_binary_varbinary_compare_full.bak` | 0.064s | 0.053s | 0.117s |
| `cci_bitpack_probe_bigint_full.bak` | 0.26s | 3.593s | 3.853s |
| `cci_bitpack_probe_full.bak` | 0.074s | 0.689s | 0.763s |
| `cci_bitpack_probe_highbase_full.bak` | 0.062s | 0.406s | 0.468s |
| `cci_btree_nci_full.bak` | 0.051s | 0.034s | 0.085s |
| `cci_computed_full.bak` | 0.051s | 0.077s | 0.128s |
| `cci_enc5_largepool_full.bak` | 0.31s | 0.484s | 0.794s |
| `cci_enc5_largepool_matrix_full.bak` | 6.91s | 1.388s | 8.298s |
| `cci_extended_full.bak` | 0.05s | 0.037s | 0.087s |
| `cci_lob_full.bak` | 0.047s | 0.034s | 0.081s |
| `cci_reorganize_full.bak` | 0.054s | 0.07s | 0.124s |
| `cci_string_dict_regression_full.bak` | 0.288s | 0.132s | 0.42s |
| `cci_string_minmax_full.bak` | 0.043s | 0.036s | 0.079s |
| `cci_switch_full.bak` | 0.089s | 0.08s | 0.169s |
| `cci_types_large_full.bak` | 0.054s | 0.038s | 0.092s |
| `cci_varbinary_micro_full.bak` | 0.044s | 0.063s | 0.107s |
| `cci_varbinary_probe_full.bak` | 0.063s | 0.041s | 0.104s |
| `columnstore_minimal.bak` | 0.11s | 0.892s | 1.002s |
| `compressed_nvarchar_full.bak` | 0.081s | 0.058s | 0.139s |
| `compressioncoverage_full.bak` | 0.072s | 0.165s | 0.237s |
| `computedcoverage_full.bak` | 0.04s | 0.063s | 0.103s |
| `constraintcoverage_full.bak` | 0.041s | 0.036s | 0.077s |
| `covering_index_full.bak` | 0.055s | 0.054s | 0.109s |
| `cs_lob_preamble.bak` | 0.067s | 0.054s | 0.121s |
| `delta_rowgroup_full.bak` | 0.101s | 0.052s | 0.153s |
| `dirtycoverage_aborted_xact.bak` | 0.059s | 0.029s | 0.088s |
| `dirtycoverage_addcol.bak` | 0.053s | 0.041s | 0.094s |
| `dirtycoverage_addnotnull.bak` | 0.043s | 0.049s | 0.092s |
| `dirtycoverage_alldirty.bak` | 0.066s | 0.029s | 0.095s |
| `dirtycoverage_altercol.bak` | 0.089s | 0.061s | 0.15s |
| `dirtycoverage_altercol_rewrite.bak` | 0.042s | 0.047s | 0.089s |
| `dirtycoverage_alterdb.bak` | 0.036s | 0.03s | 0.066s |
| `dirtycoverage_cci_delete.bak` | 0.058s | 0.085s | 0.143s |
| `dirtycoverage_cci_update.bak` | 0.092s | 0.084s | 0.176s |
| `dirtycoverage_committed_delete.bak` | 0.038s | 0.045s | 0.083s |
| `dirtycoverage_committed_delete_v2.bak` | 0.04s | 0.046s | 0.086s |
| `dirtycoverage_committed_delete_v3.bak` | 0.04s | 0.054s | 0.094s |
| `dirtycoverage_committed_delete_v4.bak` | 0.148s | 0.065s | 0.213s |
| `dirtycoverage_committed_update.bak` | 0.061s | 0.042s | 0.103s |
| `dirtycoverage_committed_update_v2.bak` | 0.042s | 0.031s | 0.073s |
| `dirtycoverage_committed_update_v3.bak` | 0.046s | 0.066s | 0.112s |
| `dirtycoverage_committed_update_v4.bak` | 0.045s | 0.067s | 0.112s |
| `dirtycoverage_concurrent.bak` | 0.04s | 0.045s | 0.085s |
| `dirtycoverage_createidx.bak` | 0.056s | 0.105s | 0.161s |
| `dirtycoverage_createtable.bak` | 0.043s | 0.04s | 0.083s |
| `dirtycoverage_delete.bak` | 0.066s | 0.035s | 0.101s |
| `dirtycoverage_dropcol.bak` | 0.044s | 0.044s | 0.088s |
| `dirtycoverage_dropidx.bak` | 0.061s | 0.093s | 0.154s |
| `dirtycoverage_droptable.bak` | 0.044s | 0.058s | 0.102s |
| `dirtycoverage_heap_forward.bak` | 0.059s | 0.029s | 0.088s |
| `dirtycoverage_large_dirty.bak` | 0.335s | 0.034s | 0.369s |
| `dirtycoverage_lob_update.bak` | 0.078s | 0.029s | 0.107s |
| `dirtycoverage_maxrow.bak` | 0.049s | 0.044s | 0.093s |
| `dirtycoverage_nchar_delete.bak` | 0.063s | 0.029s | 0.092s |
| `dirtycoverage_nested.bak` | 0.066s | 0.029s | 0.095s |
| `dirtycoverage_null_update.bak` | 0.066s | 0.03s | 0.096s |
| `dirtycoverage_rebuildidx.bak` | 0.045s | 0.042s | 0.087s |
| `dirtycoverage_rich_insert.bak` | 0.078s | 0.031s | 0.109s |
| `dirtycoverage_rich_update.bak` | 0.065s | 0.036s | 0.101s |
| `dirtycoverage_savepoint.bak` | 0.066s | 0.03s | 0.096s |
| `dirtycoverage_snapshot_update.bak` | 0.059s | 0.029s | 0.088s |
| `dirtycoverage_switch.bak` | 0.069s | 0.051s | 0.12s |
| `dirtycoverage_temporal_update.bak` | 0.074s | 0.03s | 0.104s |
| `dirtycoverage_truncate.bak` | 0.044s | 0.045s | 0.089s |
| `dirtycoverage_two_tx.bak` | 0.073s | 0.029s | 0.102s |
| `dirtycoverage_uncommitted.bak` | 0.069s | 0.03s | 0.099s |
| `dirtycoverage_update.bak` | 0.075s | 0.032s | 0.107s |
| `featurecoverage_full.bak` | 0.112s | 0.048s | 0.16s |
| `filtered_ncci_full.bak` | 0.043s | 0.056s | 0.099s |
| `float_extreme_full.bak` | 0.047s | 0.045s | 0.092s |
| `forwarded_records_full.bak` | 0.072s | 0.048s | 0.12s |
| `ghost_records_full.bak` | 0.062s | 0.042s | 0.104s |
| `heapcoverage_large.bak` | 0.053s | 0.038s | 0.091s |
| `heapcoverage_large_50000.bak` | 0.089s | 0.299s | 0.388s |
| `hierarchyid_extract_full.bak` | 0.039s | 0.045s | 0.084s |
| `high_slot_density_full.bak` | 0.043s | 0.179s | 0.222s |
| `identity_coverage_full.bak` | 0.056s | 0.038s | 0.094s |
| `incrementalcoverage_diff_01.bak` | 0.112s | 0.037s | 0.149s |
| `incrementalcoverage_diff_02.bak` | 0.09s | 0.035s | 0.125s |
| `incrementalcoverage_diff_03.bak` | 0.08s | 0.025s | 0.105s |
| `incrementalcoverage_diff_04.bak` | 0.082s | 0.022s | 0.104s |
| `incrementalcoverage_diff_05.bak` | 0.075s | 0.021s | 0.096s |
| `incrementalcoverage_diff_06.bak` | 0.11s | 0.03s | 0.14s |
| `incrementalcoverage_full.bak` | 0.058s | 0.052s | 0.11s |
| `layoutcoverage_full.bak` | 0.143s | 0.324s | 0.467s |
| `max_row_width_full.bak` | 0.092s | 0.066s | 0.158s |
| `mixed_collation_full.bak` | 0.065s | 0.066s | 0.131s |
| `multi_rowgroup_full.bak` | 0.083s | 0.083s | 0.166s |
| `native_json_full.bak` | 0.038s | 0.046s | 0.084s |
| `ncci_heap_full.bak` | 0.039s | 0.041s | 0.08s |
| `ncci_types_full.bak` | 0.06s | 0.17s | 0.23s |
| `ndfcoverage_full.bak` | 0.06s | 0.052s | 0.112s |
| `nvarchar_max_u21_full.bak` | 0.047s | 0.041s | 0.088s |
| `ordered_cci_full.bak` | 0.083s | 0.047s | 0.13s |
| `pagecomp_anchor_full.bak` | 0.122s | 0.089s | 0.211s |
| `pagecomp_long_prefix_full.bak` | 0.077s | 0.082s | 0.159s |
| `pfor_columnstore_full.bak` | 0.102s | 0.837s | 0.939s |
| `pfor_columnstore_random_full.bak` | 0.101s | 0.86s | 0.961s |
| `realworld_numeric_digest_full.bak` | 0.047s | 0.072s | 0.119s |
| `rowboundary_full.bak` | 0.037s | 0.032s | 0.069s |
| `rowstore_hash_pii_full.bak` | 0.043s | 0.077s | 0.12s |
| `rowstore_lob_image_full.bak` | 0.04s | 0.043s | 0.083s |
| `rowstore_lob_markup_full.bak` | 0.074s | 0.079s | 0.153s |
| `rowversion_extract_full.bak` | 0.042s | 0.041s | 0.083s |
| `sparse_full.bak` | 0.084s | 0.093s | 0.177s |
| `spatial_edge_full.bak` | 0.04s | 0.044s | 0.084s |
| `spatial_index_full.bak` | 0.047s | 0.043s | 0.09s |
| `sql_variant_extract_full.bak` | 0.036s | 0.029s | 0.065s |
| `striped_full_1.bak` | 0.063s | 0.021s | 0.084s |
| `striped_single.bak` | 0.048s | 0.052s | 0.1s |
| `surrogate_pairs_full.bak` | 0.064s | 0.049s | 0.113s |
| `tabletype_cci_large_full.bak` | 0.052s | 0.038s | 0.09s |
| `tabletypecoverage_diff.bak` | 0.1s | 0.058s | 0.158s |
| `tabletypecoverage_full.bak` | 0.08s | 0.082s | 0.162s |
| `temporal_hidden_full.bak` | 0.1s | 0.063s | 0.163s |
| `torn_page_full.bak` | 0.036s | 0.046s | 0.082s |
| `typecoverage_full.bak` | 0.061s | 0.056s | 0.117s |
| `typed_xml_full.bak` | 0.04s | 0.061s | 0.101s |
| `unicode_codepage_coverage.bak` | 0.057s | 0.04s | 0.097s |
| `utf8_collation_full.bak` | 0.038s | 0.045s | 0.083s |
| `vector_full.bak` | 0.053s | 0.08s | 0.133s |
| `xml_index_full.bak` | 0.069s | 0.06s | 0.129s |
| `xmlcoverage_full.bak` | 0.095s | 0.062s | 0.157s |
| `xmlheap_full.bak` | 0.05s | 0.045s | 0.095s |
| `xtp_checkpoint_straddle_full.bak` | 1.711s | 0.36s | 2.071s |
| `xtp_probe_full.bak` | 0.105s | 0.03s | 0.135s |
| `xtp_rich_full.bak` | 0.086s | 0.03s | 0.116s |
| `xtp_simple_full.bak` | 0.086s | 0.03s | 0.116s |
