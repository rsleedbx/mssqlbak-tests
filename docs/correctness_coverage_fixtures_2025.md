...
|--------|---------|--------|-----------|
| `alias_types_full.bak` | 0.036s | 0.035s | 0.071s |
| `archive_columnstore_partition_full.bak` | 0.861s | 0.857s | 1.718s |
| `archive_columnstore_types_full.bak` | 0.311s | 0.655s | 0.966s |
| `archive_columnstore_types_random_full.bak` | 0.306s | 0.733s | 1.039s |
| `archive_single_chunk_full.bak` | 0.04s | 0.043s | 0.083s |
| `archive_single_chunk_random_full.bak` | 0.04s | 0.034s | 0.074s |
| `archivenull_full.bak` | 0.132s | 0.205s | 0.337s |
| `backup_blocksize_full.bak` | 0.037s | 0.036s | 0.073s |
| `boundarycoverage_datetime_full.bak` | 0.062s | 0.172s | 0.234s |
| `boundarycoverage_full.bak` | 0.049s | 0.081s | 0.13s |
| `cci_binary_varbinary_compare_full.bak` | 0.041s | 0.032s | 0.073s |
| `cci_bitpack_probe_bigint_full.bak` | 0.258s | 3.543s | 3.801s |
| `cci_bitpack_probe_full.bak` | 0.08s | 0.88s | 0.96s |
| `cci_bitpack_probe_highbase_full.bak` | 0.061s | 0.549s | 0.61s |
| `cci_btree_nci_full.bak` | 0.053s | 0.034s | 0.087s |
| `cci_computed_full.bak` | 0.041s | 0.038s | 0.079s |
| `cci_enc5_largepool_full.bak` | 0.403s | 0.478s | 0.881s |
| `cci_enc5_largepool_matrix_full.bak` | 7.011s | 1.357s | 8.368s |
| `cci_extended_full.bak` | 0.057s | 0.042s | 0.099s |
| `cci_lob_full.bak` | 0.046s | 0.039s | 0.085s |
| `cci_reorganize_full.bak` | 0.042s | 0.033s | 0.075s |
| `cci_string_dict_regression_full.bak` | 0.287s | 0.134s | 0.421s |
| `cci_string_minmax_full.bak` | 0.043s | 0.033s | 0.076s |
| `cci_switch_full.bak` | 0.043s | 0.032s | 0.075s |
| `cci_types_large_full.bak` | 0.059s | 0.036s | 0.095s |
| `cci_varbinary_micro_full.bak` | 0.038s | 0.036s | 0.074s |
| `cci_varbinary_probe_full.bak` | 0.057s | 0.039s | 0.096s |
| `columnstore_minimal.bak` | 0.107s | 0.773s | 0.88s |
| `compressed_nvarchar_full.bak` | 0.035s | 0.029s | 0.064s |
| `compressioncoverage_full.bak` | 0.076s | 0.171s | 0.247s |
| `computedcoverage_full.bak` | 0.034s | 0.042s | 0.076s |
| `constraintcoverage_full.bak` | 0.041s | 0.034s | 0.075s |
| `covering_index_full.bak` | 0.038s | 0.039s | 0.077s |
| `cs_lob_preamble.bak` | 0.066s | 0.058s | 0.124s |
| `delta_rowgroup_full.bak` | 0.039s | 0.029s | 0.068s |
| `dirtycoverage_aborted_xact.bak` | 0.06s | 0.029s | 0.089s |
| `dirtycoverage_addcol.bak` | 0.036s | 0.03s | 0.066s |
| `dirtycoverage_addnotnull.bak` | 0.037s | 0.031s | 0.068s |
| `dirtycoverage_alldirty.bak` | 0.067s | 0.028s | 0.095s |
| `dirtycoverage_altercol.bak` | 0.036s | 0.035s | 0.071s |
| `dirtycoverage_altercol_rewrite.bak` | 0.036s | 0.036s | 0.072s |
| `dirtycoverage_alterdb.bak` | 0.036s | 0.042s | 0.078s |
| `dirtycoverage_cci_delete.bak` | 0.059s | 0.08s | 0.139s |
| `dirtycoverage_cci_update.bak` | 0.092s | 0.082s | 0.174s |
| `dirtycoverage_committed_delete.bak` | 0.032s | 0.03s | 0.062s |
| `dirtycoverage_committed_delete_v2.bak` | 0.035s | 0.035s | 0.07s |
| `dirtycoverage_committed_delete_v3.bak` | 0.051s | 0.091s | 0.142s |
| `dirtycoverage_committed_delete_v4.bak` | 0.144s | 0.114s | 0.258s |
| `dirtycoverage_committed_update.bak` | 0.033s | 0.035s | 0.068s |
| `dirtycoverage_committed_update_v2.bak` | 0.042s | 0.034s | 0.076s |
| `dirtycoverage_committed_update_v3.bak` | 0.046s | 0.079s | 0.125s |
| `dirtycoverage_committed_update_v4.bak` | 0.043s | 0.126s | 0.169s |
| `dirtycoverage_concurrent.bak` | 0.037s | 0.03s | 0.067s |
| `dirtycoverage_createidx.bak` | 0.039s | 0.031s | 0.07s |
| `dirtycoverage_createtable.bak` | 0.037s | 0.035s | 0.072s |
| `dirtycoverage_delete.bak` | 0.069s | 0.033s | 0.102s |
| `dirtycoverage_dropcol.bak` | 0.035s | 0.03s | 0.065s |
| `dirtycoverage_dropidx.bak` | 0.037s | 0.03s | 0.067s |
| `dirtycoverage_droptable.bak` | 0.042s | 0.033s | 0.075s |
| `dirtycoverage_heap_forward.bak` | 0.059s | 0.03s | 0.089s |
| `dirtycoverage_large_dirty.bak` | 0.342s | 0.034s | 0.376s |
| `dirtycoverage_lob_update.bak` | 0.115s | 0.033s | 0.148s |
| `dirtycoverage_maxrow.bak` | 0.036s | 0.048s | 0.084s |
| `dirtycoverage_nchar_delete.bak` | 0.063s | 0.03s | 0.093s |
| `dirtycoverage_nested.bak` | 0.069s | 0.034s | 0.103s |
| `dirtycoverage_null_update.bak` | 0.074s | 0.033s | 0.107s |
| `dirtycoverage_rebuildidx.bak` | 0.036s | 0.035s | 0.071s |
| `dirtycoverage_rich_insert.bak` | 0.084s | 0.03s | 0.114s |
| `dirtycoverage_rich_update.bak` | 0.069s | 0.036s | 0.105s |
| `dirtycoverage_savepoint.bak` | 0.071s | 0.037s | 0.108s |
| `dirtycoverage_snapshot_update.bak` | 0.058s | 0.029s | 0.087s |
| `dirtycoverage_switch.bak` | 0.046s | 0.031s | 0.077s |
| `dirtycoverage_temporal_update.bak` | 0.066s | 0.03s | 0.096s |
| `dirtycoverage_truncate.bak` | 0.037s | 0.032s | 0.069s |
| `dirtycoverage_two_tx.bak` | 0.083s | 0.034s | 0.117s |
| `dirtycoverage_uncommitted.bak` | 0.081s | 0.032s | 0.113s |
| `dirtycoverage_update.bak` | 0.076s | 0.034s | 0.11s |
| `featurecoverage_full.bak` | 0.102s | 0.048s | 0.15s |
| `filtered_ncci_full.bak` | 0.038s | 0.033s | 0.071s |
| `float_extreme_full.bak` | 0.036s | 0.039s | 0.075s |
| `forwarded_records_full.bak` | 0.072s | 0.055s | 0.127s |
| `ghost_records_full.bak` | 0.034s | 0.031s | 0.065s |
| `heapcoverage_large.bak` | 0.037s | 0.039s | 0.076s |
| `heapcoverage_large_50000.bak` | 0.088s | 0.454s | 0.542s |
| `hierarchyid_extract_full.bak` | 0.036s | 0.036s | 0.072s |
| `high_slot_density_full.bak` | 0.051s | 0.237s | 0.288s |
| `incrementalcoverage_diff_01.bak` | 0.039s | 0.013s | 0.052s |
| `incrementalcoverage_diff_02.bak` | 0.042s | 0.013s | 0.055s |
| `incrementalcoverage_diff_03.bak` | 0.041s | 0.012s | 0.053s |
| `incrementalcoverage_diff_04.bak` | 0.04s | 0.012s | 0.052s |
| `incrementalcoverage_diff_05.bak` | 0.04s | 0.014s | 0.054s |
| `incrementalcoverage_diff_06.bak` | 0.045s | 0.013s | 0.058s |
| `incrementalcoverage_full.bak` | 0.032s | 0.034s | 0.066s |
| `layoutcoverage_full.bak` | 0.152s | 0.207s | 0.359s |
| `max_row_width_full.bak` | 0.039s | 0.035s | 0.074s |
| `mixed_collation_full.bak` | 0.034s | 0.034s | 0.068s |
| `multi_rowgroup_full.bak` | 0.038s | 0.034s | 0.072s |
| `native_json_full.bak` | 0.036s | 0.035s | 0.071s |
| `ncci_heap_full.bak` | 0.037s | 0.03s | 0.067s |
| `ncci_types_full.bak` | 0.074s | 0.214s | 0.288s |
| `ndfcoverage_full.bak` | 0.041s | 0.031s | 0.072s |
| `nvarchar_max_u21_full.bak` | 0.036s | 0.034s | 0.07s |
| `ordered_cci_full.bak` | 0.04s | 0.035s | 0.075s |
| `pagecomp_anchor_full.bak` | 0.131s | 0.147s | 0.278s |
| `pagecomp_long_prefix_full.bak` | 0.04s | 0.031s | 0.071s |
| `pfor_columnstore_full.bak` | 0.101s | 1.124s | 1.225s |
| `pfor_columnstore_random_full.bak` | 0.109s | 1.106s | 1.215s |
| `realworld_numeric_digest_full.bak` | 0.049s | 0.091s | 0.14s |
| `rowboundary_full.bak` | 0.041s | 0.031s | 0.072s |
| `rowstore_hash_pii_full.bak` | 0.036s | 0.034s | 0.07s |
| `rowstore_lob_image_full.bak` | 0.04s | 0.035s | 0.075s |
| `rowstore_lob_markup_full.bak` | 0.037s | 0.029s | 0.066s |
| `rowversion_extract_full.bak` | 0.039s | 0.03s | 0.069s |
| `sparse_full.bak` | 0.089s | 0.14s | 0.229s |
| `spatial_edge_full.bak` | 0.037s | 0.03s | 0.067s |
| `spatial_index_full.bak` | 0.039s | 0.032s | 0.071s |
| `sql_variant_extract_full.bak` | 0.036s | 0.038s | 0.074s |
| `striped_full_1.bak` | 0.05s | 0.014s | 0.064s |
| `striped_single.bak` | 0.061s | 0.087s | 0.148s |
| `surrogate_pairs_full.bak` | 0.032s | 0.035s | 0.067s |
| `tabletype_cci_large_full.bak` | 0.052s | 0.041s | 0.093s |
| `tabletypecoverage_diff.bak` | 0.099s | 0.056s | 0.155s |
| `tabletypecoverage_full.bak` | 0.072s | 0.074s | 0.146s |
| `temporal_hidden_full.bak` | 0.049s | 0.031s | 0.08s |
| `torn_page_full.bak` | 0.036s | 0.037s | 0.073s |
| `typecoverage_full.bak` | 0.061s | 0.058s | 0.119s |
| `typed_xml_full.bak` | 0.037s | 0.037s | 0.074s |
| `unicode_codepage_coverage.bak` | 0.058s | 0.038s | 0.096s |
| `utf8_collation_full.bak` | 0.034s | 0.035s | 0.069s |
| `vector_full.bak` | 0.04s | 0.034s | 0.074s |
| `xml_index_full.bak` | 0.043s | 0.032s | 0.075s |
| `xmlcoverage_full.bak` | 0.033s | 0.034s | 0.067s |
| `xmlheap_full.bak` | 0.059s | 0.052s | 0.111s |
| `xtp_checkpoint_straddle_full.bak` | 1.693s | 0.401s | 2.094s |
| `xtp_probe_full.bak` | 0.101s | 0.034s | 0.135s |
| `xtp_rich_full.bak` | 0.095s | 0.033s | 0.128s |
| `xtp_simple_full.bak` | 0.086s | 0.029s | 0.115s |
