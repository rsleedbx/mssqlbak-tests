...
|--------|---------|--------|-----------|
| `alias_types_full.bak` | 0.044s | 0.047s | 0.091s |
| `archive_columnstore_partition_full.bak` | 0.964s | 1.156s | 2.12s |
| `archive_columnstore_types_full.bak` | 0.373s | 0.741s | 1.114s |
| `archive_columnstore_types_random_full.bak` | 0.463s | 0.949s | 1.412s |
| `archive_single_chunk_full.bak` | 0.045s | 0.044s | 0.089s |
| `archive_single_chunk_random_full.bak` | 0.048s | 0.051s | 0.099s |
| `archivenull_full.bak` | 0.167s | 0.3s | 0.467s |
| `backup_blocksize_full.bak` | 0.045s | 0.045s | 0.09s |
| `boundarycoverage_datetime_full.bak` | 0.071s | 0.191s | 0.262s |
| `boundarycoverage_full.bak` | 0.076s | 0.101s | 0.177s |
| `cci_binary_varbinary_compare_full.bak` | 0.041s | 0.038s | 0.079s |
| `cci_bitpack_probe_bigint_full.bak` | 0.31s | 5.228s | 5.538s |
| `cci_bitpack_probe_full.bak` | 0.106s | 1.228s | 1.334s |
| `cci_bitpack_probe_highbase_full.bak` | 0.091s | 0.699s | 0.79s |
| `cci_btree_nci_full.bak` | 0.059s | 0.058s | 0.117s |
| `cci_computed_full.bak` | 0.044s | 0.053s | 0.097s |
| `cci_enc5_largepool_full.bak` | 0.369s | 0.531s | 0.9s |
| `cci_enc5_largepool_matrix_full.bak` | 8.793s | 1.426s | 10.219s |
| `cci_extended_full.bak` | 0.054s | 0.05s | 0.104s |
| `cci_lob_full.bak` | 0.056s | 0.05s | 0.106s |
| `cci_reorganize_full.bak` | 0.043s | 0.041s | 0.084s |
| `cci_string_dict_regression_full.bak` | 0.455s | 0.161s | 0.616s |
| `cci_string_minmax_full.bak` | 0.05s | 0.049s | 0.099s |
| `cci_switch_full.bak` | 0.049s | 0.041s | 0.09s |
| `cci_types_large_full.bak` | 0.06s | 0.051s | 0.111s |
| `cci_varbinary_micro_full.bak` | 0.051s | 0.04s | 0.091s |
| `cci_varbinary_probe_full.bak` | 0.066s | 0.052s | 0.118s |
| `columnstore_minimal.bak` | 0.128s | 0.949s | 1.077s |
| `compressed_nvarchar_full.bak` | 0.041s | 0.037s | 0.078s |
| `compressioncoverage_full.bak` | 0.083s | 0.2s | 0.283s |
| `computedcoverage_full.bak` | 0.039s | 0.046s | 0.085s |
| `constraintcoverage_full.bak` | 0.043s | 0.048s | 0.091s |
| `covering_index_full.bak` | 0.042s | 0.049s | 0.091s |
| `cs_lob_preamble.bak` | 0.075s | 0.066s | 0.141s |
| `delta_rowgroup_full.bak` | 0.043s | 0.039s | 0.082s |
| `dirtycoverage_aborted_xact.bak` | 0.066s | 0.042s | 0.108s |
| `dirtycoverage_addcol.bak` | 0.041s | 0.044s | 0.085s |
| `dirtycoverage_addnotnull.bak` | 0.053s | 0.036s | 0.089s |
| `dirtycoverage_alldirty.bak` | 0.066s | 0.035s | 0.101s |
| `dirtycoverage_altercol.bak` | 0.038s | 0.04s | 0.078s |
| `dirtycoverage_altercol_rewrite.bak` | 0.042s | 0.042s | 0.084s |
| `dirtycoverage_alterdb.bak` | 0.039s | 0.047s | 0.086s |
| `dirtycoverage_cci_delete.bak` | 0.063s | 0.103s | 0.166s |
| `dirtycoverage_cci_update.bak` | 0.103s | 0.098s | 0.201s |
| `dirtycoverage_committed_delete.bak` | 0.037s | 0.04s | 0.077s |
| `dirtycoverage_committed_delete_v2.bak` | 0.035s | 0.047s | 0.082s |
| `dirtycoverage_committed_delete_v3.bak` | 0.043s | 0.065s | 0.108s |
| `dirtycoverage_committed_delete_v4.bak` | 0.254s | 0.189s | 0.443s |
| `dirtycoverage_committed_update.bak` | 0.038s | 0.043s | 0.081s |
| `dirtycoverage_committed_update_v2.bak` | 0.049s | 0.048s | 0.097s |
| `dirtycoverage_committed_update_v3.bak` | 0.047s | 0.083s | 0.13s |
| `dirtycoverage_committed_update_v4.bak` | 0.054s | 0.141s | 0.195s |
| `dirtycoverage_concurrent.bak` | 0.041s | 0.039s | 0.08s |
| `dirtycoverage_createidx.bak` | 0.048s | 0.044s | 0.092s |
| `dirtycoverage_createtable.bak` | 0.041s | 0.042s | 0.083s |
| `dirtycoverage_delete.bak` | 0.066s | 0.038s | 0.104s |
| `dirtycoverage_dropcol.bak` | 0.049s | 0.051s | 0.1s |
| `dirtycoverage_dropidx.bak` | 0.047s | 0.043s | 0.09s |
| `dirtycoverage_droptable.bak` | 0.038s | 0.043s | 0.081s |
| `dirtycoverage_heap_forward.bak` | 0.059s | 0.036s | 0.095s |
| `dirtycoverage_large_dirty.bak` | 0.353s | 0.043s | 0.396s |
| `dirtycoverage_lob_update.bak` | 0.078s | 0.037s | 0.115s |
| `dirtycoverage_maxrow.bak` | 0.043s | 0.037s | 0.08s |
| `dirtycoverage_nchar_delete.bak` | 0.063s | 0.04s | 0.103s |
| `dirtycoverage_nested.bak` | 0.07s | 0.046s | 0.116s |
| `dirtycoverage_null_update.bak` | 0.067s | 0.034s | 0.101s |
| `dirtycoverage_rebuildidx.bak` | 0.054s | 0.043s | 0.097s |
| `dirtycoverage_rich_insert.bak` | 0.083s | 0.04s | 0.123s |
| `dirtycoverage_rich_update.bak` | 0.061s | 0.04s | 0.101s |
| `dirtycoverage_savepoint.bak` | 0.067s | 0.043s | 0.11s |
| `dirtycoverage_snapshot_update.bak` | 0.063s | 0.038s | 0.101s |
| `dirtycoverage_switch.bak` | 0.038s | 0.054s | 0.092s |
| `dirtycoverage_temporal_update.bak` | 0.066s | 0.038s | 0.104s |
| `dirtycoverage_truncate.bak` | 0.042s | 0.054s | 0.096s |
| `dirtycoverage_two_tx.bak` | 0.078s | 0.035s | 0.113s |
| `dirtycoverage_uncommitted.bak` | 0.072s | 0.042s | 0.114s |
| `dirtycoverage_update.bak` | 0.079s | 0.036s | 0.115s |
| `featurecoverage_full.bak` | 0.112s | 0.084s | 0.196s |
| `filtered_ncci_full.bak` | 0.043s | 0.045s | 0.088s |
| `float_extreme_full.bak` | 0.043s | 0.044s | 0.087s |
| `forwarded_records_full.bak` | 0.076s | 0.091s | 0.167s |
| `ghost_records_full.bak` | 0.051s | 0.046s | 0.097s |
| `heapcoverage_large.bak` | 0.042s | 0.047s | 0.089s |
| `heapcoverage_large_50000.bak` | 0.118s | 0.528s | 0.646s |
| `hierarchyid_extract_full.bak` | 0.043s | 0.037s | 0.08s |
| `high_slot_density_full.bak` | 0.056s | 0.265s | 0.321s |
| `incrementalcoverage_diff_01.bak` | 0.063s | 0.013s | 0.076s |
| `incrementalcoverage_diff_02.bak` | 0.047s | 0.014s | 0.061s |
| `incrementalcoverage_diff_03.bak` | 0.052s | 0.018s | 0.07s |
| `incrementalcoverage_diff_04.bak` | 0.051s | 0.017s | 0.068s |
| `incrementalcoverage_diff_05.bak` | 0.054s | 0.015s | 0.069s |
| `incrementalcoverage_diff_06.bak` | 0.054s | 0.015s | 0.069s |
| `incrementalcoverage_full.bak` | 0.038s | 0.044s | 0.082s |
| `layoutcoverage_full.bak` | 0.182s | 0.26s | 0.442s |
| `max_row_width_full.bak` | 0.036s | 0.046s | 0.082s |
| `mixed_collation_full.bak` | 0.033s | 0.05s | 0.083s |
| `multi_rowgroup_full.bak` | 0.046s | 0.041s | 0.087s |
| `native_json_full.bak` | 0.04s | 0.04s | 0.08s |
| `ncci_heap_full.bak` | 0.046s | 0.036s | 0.082s |
| `ncci_types_full.bak` | 0.075s | 0.446s | 0.521s |
| `ndfcoverage_full.bak` | 0.047s | 0.048s | 0.095s |
| `nvarchar_max_u21_full.bak` | 0.041s | 0.043s | 0.084s |
| `ordered_cci_full.bak` | 0.043s | 0.043s | 0.086s |
| `pagecomp_anchor_full.bak` | 0.28s | 0.189s | 0.469s |
| `pagecomp_long_prefix_full.bak` | 0.046s | 0.044s | 0.09s |
| `pfor_columnstore_full.bak` | 0.122s | 1.505s | 1.627s |
| `pfor_columnstore_random_full.bak` | 0.116s | 1.366s | 1.482s |
| `realworld_numeric_digest_full.bak` | 0.063s | 0.11s | 0.173s |
| `rowboundary_full.bak` | 0.054s | 0.046s | 0.1s |
| `rowstore_hash_pii_full.bak` | 0.04s | 0.034s | 0.074s |
| `rowstore_lob_image_full.bak` | 0.045s | 0.043s | 0.088s |
| `rowstore_lob_markup_full.bak` | 0.042s | 0.045s | 0.087s |
| `rowversion_extract_full.bak` | 0.041s | 0.037s | 0.078s |
| `sparse_full.bak` | 0.094s | 0.144s | 0.238s |
| `spatial_edge_full.bak` | 0.041s | 0.037s | 0.078s |
| `spatial_index_full.bak` | 0.048s | 0.039s | 0.087s |
| `sql_variant_extract_full.bak` | 0.046s | 0.039s | 0.085s |
| `striped_full_1.bak` | 0.053s | 0.021s | 0.074s |
| `striped_single.bak` | 0.055s | 0.05s | 0.105s |
| `surrogate_pairs_full.bak` | 0.051s | 0.041s | 0.092s |
| `tabletype_cci_large_full.bak` | 0.059s | 0.053s | 0.112s |
| `tabletypecoverage_diff.bak` | 0.123s | 0.073s | 0.196s |
| `tabletypecoverage_full.bak` | 0.09s | 0.087s | 0.177s |
| `temporal_hidden_full.bak` | 0.038s | 0.044s | 0.082s |
| `torn_page_full.bak` | 0.045s | 0.041s | 0.086s |
| `typecoverage_full.bak` | 0.072s | 0.098s | 0.17s |
| `typed_xml_full.bak` | 0.039s | 0.039s | 0.078s |
| `unicode_codepage_coverage.bak` | 0.077s | 0.057s | 0.134s |
| `utf8_collation_full.bak` | 0.045s | 0.042s | 0.087s |
| `vector_full.bak` | 0.047s | 0.042s | 0.089s |
| `xml_index_full.bak` | 0.059s | 0.039s | 0.098s |
| `xmlcoverage_full.bak` | 0.039s | 0.047s | 0.086s |
| `xmlheap_full.bak` | 0.049s | 0.068s | 0.117s |
| `xtp_checkpoint_straddle_full.bak` | 2.577s | 0.642s | 3.219s |
| `xtp_probe_full.bak` | 0.11s | 0.041s | 0.151s |
| `xtp_rich_full.bak` | 0.092s | 0.043s | 0.135s |
| `xtp_simple_full.bak` | 0.093s | 0.058s | 0.151s |
