...
|--------|---------|--------|-----------|
| `alias_types_full.bak` | 0.036s | 0.034s | 0.07s |
| `archive_columnstore_partition_full.bak` | 0.881s | 0.604s | 1.485s |
| `archive_columnstore_types_full.bak` | 0.312s | 0.672s | 0.984s |
| `archive_columnstore_types_random_full.bak` | 0.311s | 0.692s | 1.003s |
| `archive_single_chunk_full.bak` | 0.041s | 0.039s | 0.08s |
| `archive_single_chunk_random_full.bak` | 0.046s | 0.039s | 0.085s |
| `archivenull_full.bak` | 0.12s | 0.205s | 0.325s |
| `backup_blocksize_full.bak` | 0.037s | 0.038s | 0.075s |
| `boundarycoverage_datetime_full.bak` | 0.054s | 0.138s | 0.192s |
| `boundarycoverage_full.bak` | 0.052s | 0.067s | 0.119s |
| `cci_binary_varbinary_compare_full.bak` | 0.041s | 0.04s | 0.081s |
| `cci_bitpack_probe_bigint_full.bak` | 0.267s | 3.677s | 3.944s |
| `cci_bitpack_probe_full.bak` | 0.084s | 0.653s | 0.737s |
| `cci_bitpack_probe_highbase_full.bak` | 0.068s | 0.432s | 0.5s |
| `cci_btree_nci_full.bak` | 0.063s | 0.043s | 0.106s |
| `cci_computed_full.bak` | 0.045s | 0.05s | 0.095s |
| `cci_enc5_largepool_full.bak` | 0.328s | 0.434s | 0.762s |
| `cci_enc5_largepool_matrix_full.bak` | 6.981s | 1.218s | 8.199s |
| `cci_extended_full.bak` | 0.06s | 0.052s | 0.112s |
| `cci_lob_full.bak` | 0.059s | 0.054s | 0.113s |
| `cci_reorganize_full.bak` | 0.04s | 0.041s | 0.081s |
| `cci_string_dict_regression_full.bak` | 0.301s | 0.129s | 0.43s |
| `cci_string_minmax_full.bak` | 0.043s | 0.043s | 0.086s |
| `cci_switch_full.bak` | 0.043s | 0.04s | 0.083s |
| `cci_types_large_full.bak` | 0.057s | 0.06s | 0.117s |
| `cci_varbinary_micro_full.bak` | 0.043s | 0.037s | 0.08s |
| `cci_varbinary_probe_full.bak` | 0.062s | 0.051s | 0.113s |
| `columnstore_minimal.bak` | 0.111s | 1.013s | 1.124s |
| `compressed_nvarchar_full.bak` | 0.035s | 0.035s | 0.07s |
| `compressioncoverage_full.bak` | 0.079s | 0.177s | 0.256s |
| `computedcoverage_full.bak` | 0.034s | 0.037s | 0.071s |
| `constraintcoverage_full.bak` | 0.042s | 0.042s | 0.084s |
| `covering_index_full.bak` | 0.043s | 0.055s | 0.098s |
| `cs_lob_preamble.bak` | 0.08s | 0.056s | 0.136s |
| `delta_rowgroup_full.bak` | 0.051s | 0.035s | 0.086s |
| `dirtycoverage_aborted_xact.bak` | 0.061s | 0.048s | 0.109s |
| `dirtycoverage_addcol.bak` | 0.037s | 0.036s | 0.073s |
| `dirtycoverage_addnotnull.bak` | 0.044s | 0.048s | 0.092s |
| `dirtycoverage_alldirty.bak` | 0.075s | 0.035s | 0.11s |
| `dirtycoverage_altercol.bak` | 0.039s | 0.036s | 0.075s |
| `dirtycoverage_altercol_rewrite.bak` | 0.04s | 0.036s | 0.076s |
| `dirtycoverage_alterdb.bak` | 0.037s | 0.037s | 0.074s |
| `dirtycoverage_cci_delete.bak` | 0.067s | 0.088s | 0.155s |
| `dirtycoverage_cci_update.bak` | 0.098s | 0.088s | 0.186s |
| `dirtycoverage_committed_delete.bak` | 0.038s | 0.042s | 0.08s |
| `dirtycoverage_committed_delete_v2.bak` | 0.036s | 0.038s | 0.074s |
| `dirtycoverage_committed_delete_v3.bak` | 0.041s | 0.061s | 0.102s |
| `dirtycoverage_committed_delete_v4.bak` | 0.15s | 0.061s | 0.211s |
| `dirtycoverage_committed_update.bak` | 0.037s | 0.036s | 0.073s |
| `dirtycoverage_committed_update_v2.bak` | 0.044s | 0.038s | 0.082s |
| `dirtycoverage_committed_update_v3.bak` | 0.047s | 0.064s | 0.111s |
| `dirtycoverage_committed_update_v4.bak` | 0.045s | 0.067s | 0.112s |
| `dirtycoverage_concurrent.bak` | 0.037s | 0.038s | 0.075s |
| `dirtycoverage_createidx.bak` | 0.045s | 0.038s | 0.083s |
| `dirtycoverage_createtable.bak` | 0.037s | 0.036s | 0.073s |
| `dirtycoverage_delete.bak` | 0.071s | 0.036s | 0.107s |
| `dirtycoverage_dropcol.bak` | 0.04s | 0.045s | 0.085s |
| `dirtycoverage_dropidx.bak` | 0.039s | 0.036s | 0.075s |
| `dirtycoverage_droptable.bak` | 0.039s | 0.038s | 0.077s |
| `dirtycoverage_heap_forward.bak` | 0.06s | 0.051s | 0.111s |
| `dirtycoverage_large_dirty.bak` | 0.34s | 0.034s | 0.374s |
| `dirtycoverage_lob_update.bak` | 0.081s | 0.028s | 0.109s |
| `dirtycoverage_maxrow.bak` | 0.036s | 0.033s | 0.069s |
| `dirtycoverage_nchar_delete.bak` | 0.068s | 0.044s | 0.112s |
| `dirtycoverage_nested.bak` | 0.07s | 0.044s | 0.114s |
| `dirtycoverage_null_update.bak` | 0.066s | 0.03s | 0.096s |
| `dirtycoverage_rebuildidx.bak` | 0.037s | 0.035s | 0.072s |
| `dirtycoverage_rich_insert.bak` | 0.086s | 0.032s | 0.118s |
| `dirtycoverage_rich_update.bak` | 0.061s | 0.04s | 0.101s |
| `dirtycoverage_savepoint.bak` | 0.071s | 0.036s | 0.107s |
| `dirtycoverage_snapshot_update.bak` | 0.062s | 0.046s | 0.108s |
| `dirtycoverage_switch.bak` | 0.038s | 0.038s | 0.076s |
| `dirtycoverage_temporal_update.bak` | 0.074s | 0.045s | 0.119s |
| `dirtycoverage_truncate.bak` | 0.038s | 0.037s | 0.075s |
| `dirtycoverage_two_tx.bak` | 0.073s | 0.036s | 0.109s |
| `dirtycoverage_uncommitted.bak` | 0.069s | 0.036s | 0.105s |
| `dirtycoverage_update.bak` | 0.067s | 0.03s | 0.097s |
| `featurecoverage_full.bak` | 0.102s | 0.047s | 0.149s |
| `filtered_ncci_full.bak` | 0.047s | 0.039s | 0.086s |
| `float_extreme_full.bak` | 0.039s | 0.035s | 0.074s |
| `forwarded_records_full.bak` | 0.074s | 0.051s | 0.125s |
| `ghost_records_full.bak` | 0.034s | 0.038s | 0.072s |
| `heapcoverage_large.bak` | 0.038s | 0.043s | 0.081s |
| `heapcoverage_large_50000.bak` | 0.092s | 0.306s | 0.398s |
| `hierarchyid_extract_full.bak` | 0.036s | 0.038s | 0.074s |
| `high_slot_density_full.bak` | 0.043s | 0.186s | 0.229s |
| `identity_coverage_full.bak` | 0.044s | 0.041s | 0.085s |
| `incrementalcoverage_diff_01.bak` | 0.038s | 0.013s | 0.051s |
| `incrementalcoverage_diff_02.bak` | 0.041s | 0.012s | 0.053s |
| `incrementalcoverage_diff_03.bak` | 0.04s | 0.013s | 0.053s |
| `incrementalcoverage_diff_04.bak` | 0.041s | 0.012s | 0.053s |
| `incrementalcoverage_diff_05.bak` | 0.04s | 0.015s | 0.055s |
| `incrementalcoverage_diff_06.bak` | 0.043s | 0.014s | 0.057s |
| `incrementalcoverage_full.bak` | 0.032s | 0.037s | 0.069s |
| `layoutcoverage_full.bak` | 0.143s | 0.33s | 0.473s |
| `max_row_width_full.bak` | 0.033s | 0.04s | 0.073s |
| `mixed_collation_full.bak` | 0.04s | 0.036s | 0.076s |
| `multi_rowgroup_full.bak` | 0.041s | 0.044s | 0.085s |
| `native_json_full.bak` | 0.036s | 0.036s | 0.072s |
| `ncci_heap_full.bak` | 0.042s | 0.038s | 0.08s |
| `ncci_types_full.bak` | 0.061s | 0.172s | 0.233s |
| `ndfcoverage_full.bak` | 0.039s | 0.049s | 0.088s |
| `nvarchar_max_u21_full.bak` | 0.037s | 0.035s | 0.072s |
| `ordered_cci_full.bak` | 0.044s | 0.041s | 0.085s |
| `pagecomp_anchor_full.bak` | 0.127s | 0.093s | 0.22s |
| `pagecomp_long_prefix_full.bak` | 0.036s | 0.038s | 0.074s |
| `pfor_columnstore_full.bak` | 0.097s | 0.828s | 0.925s |
| `pfor_columnstore_random_full.bak` | 0.115s | 0.86s | 0.975s |
| `realworld_numeric_digest_full.bak` | 0.052s | 0.075s | 0.127s |
| `rowboundary_full.bak` | 0.043s | 0.048s | 0.091s |
| `rowstore_hash_pii_full.bak` | 0.052s | 0.038s | 0.09s |
| `rowstore_lob_image_full.bak` | 0.04s | 0.036s | 0.076s |
| `rowstore_lob_markup_full.bak` | 0.036s | 0.038s | 0.074s |
| `rowversion_extract_full.bak` | 0.038s | 0.037s | 0.075s |
| `sparse_full.bak` | 0.086s | 0.084s | 0.17s |
| `spatial_edge_full.bak` | 0.037s | 0.04s | 0.077s |
| `spatial_index_full.bak` | 0.043s | 0.044s | 0.087s |
| `sql_variant_extract_full.bak` | 0.036s | 0.039s | 0.075s |
| `striped_full_1.bak` | 0.054s | 0.015s | 0.069s |
| `striped_single.bak` | 0.053s | 0.054s | 0.107s |
| `surrogate_pairs_full.bak` | 0.039s | 0.033s | 0.072s |
| `tabletype_cci_large_full.bak` | 0.057s | 0.063s | 0.12s |
| `tabletypecoverage_diff.bak` | 0.115s | 0.065s | 0.18s |
| `tabletypecoverage_full.bak` | 0.082s | 0.092s | 0.174s |
| `temporal_hidden_full.bak` | 0.038s | 0.039s | 0.077s |
| `torn_page_full.bak` | 0.035s | 0.036s | 0.071s |
| `typecoverage_full.bak` | 0.074s | 0.056s | 0.13s |
| `typed_xml_full.bak` | 0.041s | 0.035s | 0.076s |
| `unicode_codepage_coverage.bak` | 0.06s | 0.059s | 0.119s |
| `utf8_collation_full.bak` | 0.033s | 0.038s | 0.071s |
| `vector_full.bak` | 0.041s | 0.042s | 0.083s |
| `xml_index_full.bak` | 0.044s | 0.039s | 0.083s |
| `xmlcoverage_full.bak` | 0.038s | 0.037s | 0.075s |
| `xmlheap_full.bak` | 0.052s | 0.044s | 0.096s |
| `xtp_checkpoint_straddle_full.bak` | 1.753s | 0.369s | 2.122s |
| `xtp_probe_full.bak` | 0.108s | 0.031s | 0.139s |
| `xtp_rich_full.bak` | 0.088s | 0.03s | 0.118s |
| `xtp_simple_full.bak` | 0.087s | 0.03s | 0.117s |
