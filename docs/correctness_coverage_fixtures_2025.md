...
| Backup | Wall time |
|--------|-------------|
| `alias_types_full.bak` | 0.084s |
| `archive_columnstore_partition_full.bak` | 2.46s |
| `archive_columnstore_types_full.bak` | 1.351s |
| `archive_columnstore_types_random_full.bak` | 1.409s |
| `archive_single_chunk_full.bak` | 0.117s |
| `archive_single_chunk_random_full.bak` | 0.102s |
| `archivenull_full.bak` | 0.454s |
| `backup_blocksize_full.bak` | 0.087s |
| `boundarycoverage_datetime_full.bak` | 0.447s |
| `boundarycoverage_full.bak` | 0.259s |
| `cci_binary_varbinary_compare_full.bak` | 0.105s |
| `cci_bitpack_probe_bigint_full.bak` | 8.882s |
| `cci_bitpack_probe_full.bak` | 1.897s |
| `cci_bitpack_probe_highbase_full.bak` | 1.341s |
| `cci_btree_nci_full.bak` | 0.139s |
| `cci_computed_full.bak` | 0.107s |
| `cci_enc5_largepool_full.bak` | 1.237s |
| `cci_enc5_largepool_matrix_full.bak` | 9.664s |
| `cci_extended_full.bak` | 0.135s |
| `cci_lob_full.bak` | 0.234s |
| `cci_reorganize_full.bak` | 0.118s |
| `cci_string_dict_regression_full.bak` | 0.532s |
| `cci_string_minmax_full.bak` | 0.205s |
| `cci_switch_full.bak` | 0.106s |
| `cci_types_large_full.bak` | 0.138s |
| `cci_varbinary_micro_full.bak` | 0.11s |
| `cci_varbinary_probe_full.bak` | 0.136s |
| `columnstore_minimal.bak` | 1.259s |
| `compressed_nvarchar_full.bak` | 0.094s |
| `compressioncoverage_full.bak` | 0.378s |
| `computedcoverage_full.bak` | 0.082s |
| `constraintcoverage_full.bak` | 0.102s |
| `covering_index_full.bak` | 0.126s |
| `cs_lob_preamble.bak` | 0.157s |
| `delta_rowgroup_full.bak` | 0.103s |
| `dirtycoverage_aborted_xact.bak` | 0.106s |
| `dirtycoverage_addcol.bak` | 0.078s |
| `dirtycoverage_addnotnull.bak` | 0.099s |
| `dirtycoverage_alldirty.bak` | 0.117s |
| `dirtycoverage_altercol.bak` | 0.09s |
| `dirtycoverage_altercol_rewrite.bak` | 0.087s |
| `dirtycoverage_alterdb.bak` | 0.079s |
| `dirtycoverage_cci_delete.bak` | 0.23s |
| `dirtycoverage_cci_update.bak` | 0.245s |
| `dirtycoverage_committed_delete.bak` | 0.074s |
| `dirtycoverage_committed_delete_v2.bak` | 0.096s |
| `dirtycoverage_committed_delete_v3.bak` | 0.142s |
| `dirtycoverage_committed_delete_v4.bak` | 0.364s |
| `dirtycoverage_committed_update.bak` | 0.073s |
| `dirtycoverage_committed_update_v2.bak` | 0.123s |
| `dirtycoverage_committed_update_v3.bak` | 0.188s |
| `dirtycoverage_committed_update_v4.bak` | 0.282s |
| `dirtycoverage_concurrent.bak` | 0.096s |
| `dirtycoverage_createidx.bak` | 0.083s |
| `dirtycoverage_createtable.bak` | 0.098s |
| `dirtycoverage_delete.bak` | 0.127s |
| `dirtycoverage_dropcol.bak` | 0.101s |
| `dirtycoverage_dropidx.bak` | 0.09s |
| `dirtycoverage_droptable.bak` | 0.086s |
| `dirtycoverage_heap_forward.bak` | 0.105s |
| `dirtycoverage_large_dirty.bak` | 0.411s |
| `dirtycoverage_lob_update.bak` | 0.132s |
| `dirtycoverage_maxrow.bak` | 0.089s |
| `dirtycoverage_nchar_delete.bak` | 0.232s |
| `dirtycoverage_nested.bak` | 0.133s |
| `dirtycoverage_null_update.bak` | 0.137s |
| `dirtycoverage_rebuildidx.bak` | 0.095s |
| `dirtycoverage_rich_insert.bak` | 0.131s |
| `dirtycoverage_rich_update.bak` | 0.196s |
| `dirtycoverage_savepoint.bak` | 0.128s |
| `dirtycoverage_snapshot_update.bak` | 0.116s |
| `dirtycoverage_switch.bak` | 0.105s |
| `dirtycoverage_temporal_update.bak` | 0.243s |
| `dirtycoverage_truncate.bak` | 0.082s |
| `dirtycoverage_two_tx.bak` | 0.141s |
| `dirtycoverage_uncommitted.bak` | 0.133s |
| `dirtycoverage_update.bak` | 0.243s |
| `featurecoverage_full.bak` | 0.206s |
| `filtered_ncci_full.bak` | 0.086s |
| `float_extreme_full.bak` | 0.076s |
| `forwarded_records_full.bak` | 0.207s |
| `ghost_records_full.bak` | 0.074s |
| `heapcoverage_large.bak` | 0.11s |
| `heapcoverage_large_50000.bak` | 1.086s |
| `hierarchyid_extract_full.bak` | 0.095s |
| `high_slot_density_full.bak` | 0.598s |
| `incrementalcoverage_diff_01.bak` | 0.071s |
| `incrementalcoverage_diff_02.bak` | 0.067s |
| `incrementalcoverage_diff_03.bak` | 0.066s |
| `incrementalcoverage_diff_04.bak` | 0.062s |
| `incrementalcoverage_diff_05.bak` | 0.071s |
| `incrementalcoverage_diff_06.bak` | 0.068s |
| `incrementalcoverage_full.bak` | 0.121s |
| `layoutcoverage_full.bak` | 0.419s |
| `max_row_width_full.bak` | 0.075s |
| `mixed_collation_full.bak` | 0.072s |
| `multi_rowgroup_full.bak` | 0.113s |
| `native_json_full.bak` | 0.084s |
| `ncci_heap_full.bak` | 0.085s |
| `ncci_types_full.bak` | 0.513s |
| `ndfcoverage_full.bak` | 0.098s |
| `nvarchar_max_u21_full.bak` | 0.085s |
| `ordered_cci_full.bak` | 0.127s |
| `pagecomp_anchor_full.bak` | 0.4s |
| `pagecomp_long_prefix_full.bak` | 0.085s |
| `pfor_columnstore_full.bak` | 2.351s |
| `pfor_columnstore_random_full.bak` | 2.36s |
| `realworld_numeric_digest_full.bak` | 0.236s |
| `rowboundary_full.bak` | 0.097s |
| `rowstore_hash_pii_full.bak` | 0.077s |
| `rowstore_lob_image_full.bak` | 0.075s |
| `rowstore_lob_markup_full.bak` | 0.079s |
| `rowversion_extract_full.bak` | 0.093s |
| `sparse_full.bak` | 0.302s |
| `spatial_edge_full.bak` | 0.099s |
| `spatial_index_full.bak` | 0.101s |
| `sql_variant_extract_full.bak` | 0.075s |
| `striped_full_1.bak` | 0.079s |
| `striped_single.bak` | 0.206s |
| `surrogate_pairs_full.bak` | 0.127s |
| `tabletype_cci_large_full.bak` | 0.222s |
| `tabletypecoverage_diff.bak` | 0.202s |
| `tabletypecoverage_full.bak` | 0.186s |
| `temporal_hidden_full.bak` | 0.093s |
| `torn_page_full.bak` | 0.09s |
| `typecoverage_full.bak` | 0.161s |
| `typed_xml_full.bak` | 0.083s |
| `unicode_codepage_coverage.bak` | 0.119s |
| `utf8_collation_full.bak` | 0.127s |
| `vector_full.bak` | 0.085s |
| `xml_index_full.bak` | 0.101s |
| `xmlcoverage_full.bak` | 0.118s |
| `xmlheap_full.bak` | 0.133s |
| `xtp_checkpoint_straddle_full.bak` | 3.328s |
| `xtp_probe_full.bak` | 0.161s |
| `xtp_rich_full.bak` | 0.141s |
| `xtp_simple_full.bak` | 0.142s |
