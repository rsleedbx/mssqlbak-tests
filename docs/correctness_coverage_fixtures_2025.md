...
|--------|---------|--------|-----------|
| `alias_types_full.bak` | 0.036s | 0.038s | 0.074s |
| `archive_columnstore_partition_full.bak` | 0.888s | 0.631s | 1.519s |
| `archive_columnstore_types_full.bak` | 0.325s | 0.695s | 1.02s |
| `archive_columnstore_types_random_full.bak` | 0.328s | 0.69s | 1.018s |
| `archive_single_chunk_full.bak` | 0.045s | 0.042s | 0.087s |
| `archive_single_chunk_random_full.bak` | 0.049s | 0.055s | 0.104s |
| `archivenull_full.bak` | 0.133s | 0.219s | 0.352s |
| `backup_blocksize_full.bak` | 0.037s | 0.038s | 0.075s |
| `boundarycoverage_datetime_full.bak` | 0.072s | 0.167s | 0.239s |
| `boundarycoverage_full.bak` | 0.051s | 0.075s | 0.126s |
| `cci_binary_varbinary_compare_full.bak` | 0.042s | 0.038s | 0.08s |
| `cci_bitpack_probe_bigint_full.bak` | 0.26s | 3.808s | 4.068s |
| `cci_bitpack_probe_full.bak` | 0.085s | 0.663s | 0.748s |
| `cci_bitpack_probe_highbase_full.bak` | 0.074s | 0.445s | 0.519s |
| `cci_btree_nci_full.bak` | 0.058s | 0.042s | 0.1s |
| `cci_computed_full.bak` | 0.042s | 0.04s | 0.082s |
| `cci_enc5_largepool_full.bak` | 0.321s | 0.449s | 0.77s |
| `cci_enc5_largepool_matrix_full.bak` | 7.183s | 1.267s | 8.45s |
| `cci_extended_full.bak` | 0.056s | 0.057s | 0.113s |
| `cci_lob_full.bak` | 0.052s | 0.05s | 0.102s |
| `cci_reorganize_full.bak` | 0.043s | 0.042s | 0.085s |
| `cci_string_dict_regression_full.bak` | 0.295s | 0.158s | 0.453s |
| `cci_string_minmax_full.bak` | 0.043s | 0.044s | 0.087s |
| `cci_switch_full.bak` | 0.04s | 0.038s | 0.078s |
| `cci_types_large_full.bak` | 0.066s | 0.06s | 0.126s |
| `cci_varbinary_micro_full.bak` | 0.045s | 0.042s | 0.087s |
| `cci_varbinary_probe_full.bak` | 0.062s | 0.054s | 0.116s |
| `columnstore_minimal.bak` | 0.119s | 1.045s | 1.164s |
| `compressed_nvarchar_full.bak` | 0.036s | 0.038s | 0.074s |
| `compressioncoverage_full.bak` | 0.087s | 0.185s | 0.272s |
| `computedcoverage_full.bak` | 0.037s | 0.042s | 0.079s |
| `constraintcoverage_full.bak` | 0.042s | 0.041s | 0.083s |
| `covering_index_full.bak` | 0.039s | 0.04s | 0.079s |
| `cs_lob_preamble.bak` | 0.071s | 0.058s | 0.129s |
| `delta_rowgroup_full.bak` | 0.04s | 0.036s | 0.076s |
| `dirtycoverage_aborted_xact.bak` | 0.066s | 0.042s | 0.108s |
| `dirtycoverage_addcol.bak` | 0.037s | 0.037s | 0.074s |
| `dirtycoverage_addnotnull.bak` | 0.038s | 0.035s | 0.073s |
| `dirtycoverage_alldirty.bak` | 0.076s | 0.04s | 0.116s |
| `dirtycoverage_altercol.bak` | 0.04s | 0.038s | 0.078s |
| `dirtycoverage_altercol_rewrite.bak` | 0.038s | 0.041s | 0.079s |
| `dirtycoverage_alterdb.bak` | 0.037s | 0.036s | 0.073s |
| `dirtycoverage_cci_delete.bak` | 0.064s | 0.101s | 0.165s |
| `dirtycoverage_cci_update.bak` | 0.096s | 0.111s | 0.207s |
| `dirtycoverage_committed_delete.bak` | 0.034s | 0.036s | 0.07s |
| `dirtycoverage_committed_delete_v2.bak` | 0.04s | 0.04s | 0.08s |
| `dirtycoverage_committed_delete_v3.bak` | 0.042s | 0.061s | 0.103s |
| `dirtycoverage_committed_delete_v4.bak` | 0.152s | 0.089s | 0.241s |
| `dirtycoverage_committed_update.bak` | 0.039s | 0.045s | 0.084s |
| `dirtycoverage_committed_update_v2.bak` | 0.052s | 0.038s | 0.09s |
| `dirtycoverage_committed_update_v3.bak` | 0.051s | 0.063s | 0.114s |
| `dirtycoverage_committed_update_v4.bak` | 0.049s | 0.081s | 0.13s |
| `dirtycoverage_concurrent.bak` | 0.037s | 0.037s | 0.074s |
| `dirtycoverage_createidx.bak` | 0.039s | 0.041s | 0.08s |
| `dirtycoverage_createtable.bak` | 0.041s | 0.036s | 0.077s |
| `dirtycoverage_delete.bak` | 0.068s | 0.036s | 0.104s |
| `dirtycoverage_dropcol.bak` | 0.036s | 0.034s | 0.07s |
| `dirtycoverage_dropidx.bak` | 0.037s | 0.039s | 0.076s |
| `dirtycoverage_droptable.bak` | 0.043s | 0.039s | 0.082s |
| `dirtycoverage_heap_forward.bak` | 0.064s | 0.046s | 0.11s |
| `dirtycoverage_large_dirty.bak` | 0.338s | 0.036s | 0.374s |
| `dirtycoverage_lob_update.bak` | 0.081s | 0.042s | 0.123s |
| `dirtycoverage_maxrow.bak` | 0.036s | 0.035s | 0.071s |
| `dirtycoverage_nchar_delete.bak` | 0.069s | 0.035s | 0.104s |
| `dirtycoverage_nested.bak` | 0.067s | 0.038s | 0.105s |
| `dirtycoverage_null_update.bak` | 0.072s | 0.036s | 0.108s |
| `dirtycoverage_rebuildidx.bak` | 0.037s | 0.037s | 0.074s |
| `dirtycoverage_rich_insert.bak` | 0.082s | 0.042s | 0.124s |
| `dirtycoverage_rich_update.bak` | 0.066s | 0.043s | 0.109s |
| `dirtycoverage_savepoint.bak` | 0.073s | 0.039s | 0.112s |
| `dirtycoverage_snapshot_update.bak` | 0.066s | 0.033s | 0.099s |
| `dirtycoverage_switch.bak` | 0.047s | 0.036s | 0.083s |
| `dirtycoverage_temporal_update.bak` | 0.071s | 0.037s | 0.108s |
| `dirtycoverage_truncate.bak` | 0.038s | 0.037s | 0.075s |
| `dirtycoverage_two_tx.bak` | 0.074s | 0.035s | 0.109s |
| `dirtycoverage_uncommitted.bak` | 0.079s | 0.039s | 0.118s |
| `dirtycoverage_update.bak` | 0.068s | 0.038s | 0.106s |
| `featurecoverage_full.bak` | 0.22s | 0.101s | 0.321s |
| `filtered_ncci_full.bak` | 0.043s | 0.041s | 0.084s |
| `float_extreme_full.bak` | 0.038s | 0.033s | 0.071s |
| `forwarded_records_full.bak` | 0.133s | 0.162s | 0.295s |
| `ghost_records_full.bak` | 0.039s | 0.037s | 0.076s |
| `heapcoverage_large.bak` | 0.037s | 0.041s | 0.078s |
| `heapcoverage_large_50000.bak` | 0.095s | 0.335s | 0.43s |
| `hierarchyid_extract_full.bak` | 0.036s | 0.036s | 0.072s |
| `high_slot_density_full.bak` | 0.044s | 0.196s | 0.24s |
| `identity_coverage_full.bak` | 0.045s | 0.045s | 0.09s |
| `incrementalcoverage_diff_01.bak` | 0.045s | 0.012s | 0.057s |
| `incrementalcoverage_diff_02.bak` | 0.041s | 0.012s | 0.053s |
| `incrementalcoverage_diff_03.bak` | 0.043s | 0.012s | 0.055s |
| `incrementalcoverage_diff_04.bak` | 0.041s | 0.012s | 0.053s |
| `incrementalcoverage_diff_05.bak` | 0.041s | 0.012s | 0.053s |
| `incrementalcoverage_diff_06.bak` | 0.048s | 0.014s | 0.062s |
| `incrementalcoverage_full.bak` | 0.037s | 0.036s | 0.073s |
| `layoutcoverage_full.bak` | 0.156s | 0.352s | 0.508s |
| `max_row_width_full.bak` | 0.032s | 0.036s | 0.068s |
| `mixed_collation_full.bak` | 0.034s | 0.034s | 0.068s |
| `multi_rowgroup_full.bak` | 0.049s | 0.048s | 0.097s |
| `native_json_full.bak` | 0.036s | 0.036s | 0.072s |
| `ncci_heap_full.bak` | 0.038s | 0.049s | 0.087s |
| `ncci_types_full.bak` | 0.062s | 0.19s | 0.252s |
| `ndfcoverage_full.bak` | 0.038s | 0.053s | 0.091s |
| `nvarchar_max_u21_full.bak` | 0.045s | 0.034s | 0.079s |
| `ordered_cci_full.bak` | 0.04s | 0.042s | 0.082s |
| `pagecomp_anchor_full.bak` | 0.131s | 0.098s | 0.229s |
| `pagecomp_long_prefix_full.bak` | 0.036s | 0.041s | 0.077s |
| `pfor_columnstore_full.bak` | 0.106s | 0.87s | 0.976s |
| `pfor_columnstore_random_full.bak` | 0.106s | 0.88s | 0.986s |
| `realworld_numeric_digest_full.bak` | 0.054s | 0.085s | 0.139s |
| `rowboundary_full.bak` | 0.038s | 0.041s | 0.079s |
| `rowstore_hash_pii_full.bak` | 0.036s | 0.038s | 0.074s |
| `rowstore_lob_image_full.bak` | 0.037s | 0.036s | 0.073s |
| `rowstore_lob_markup_full.bak` | 0.036s | 0.037s | 0.073s |
| `rowversion_extract_full.bak` | 0.037s | 0.037s | 0.074s |
| `sparse_full.bak` | 0.096s | 0.111s | 0.207s |
| `spatial_edge_full.bak` | 0.038s | 0.041s | 0.079s |
| `spatial_index_full.bak` | 0.039s | 0.039s | 0.078s |
| `sql_variant_extract_full.bak` | 0.04s | 0.04s | 0.08s |
| `striped_full_1.bak` | 0.05s | 0.026s | 0.076s |
| `striped_single.bak` | 0.05s | 0.062s | 0.112s |
| `surrogate_pairs_full.bak` | 0.033s | 0.039s | 0.072s |
| `tabletype_cci_large_full.bak` | 0.057s | 0.055s | 0.112s |
| `tabletypecoverage_diff.bak` | 0.195s | 0.131s | 0.326s |
| `tabletypecoverage_full.bak` | 0.086s | 0.091s | 0.177s |
| `temporal_hidden_full.bak` | 0.039s | 0.037s | 0.076s |
| `torn_page_full.bak` | 0.04s | 0.036s | 0.076s |
| `typecoverage_full.bak` | 0.065s | 0.087s | 0.152s |
| `typed_xml_full.bak` | 0.042s | 0.034s | 0.076s |
| `unicode_codepage_coverage.bak` | 0.06s | 0.055s | 0.115s |
| `utf8_collation_full.bak` | 0.033s | 0.036s | 0.069s |
| `vector_full.bak` | 0.041s | 0.057s | 0.098s |
| `xml_index_full.bak` | 0.045s | 0.038s | 0.083s |
| `xmlcoverage_full.bak` | 0.033s | 0.038s | 0.071s |
| `xmlheap_full.bak` | 0.051s | 0.055s | 0.106s |
| `xtp_checkpoint_straddle_full.bak` | 1.745s | 0.371s | 2.116s |
| `xtp_probe_full.bak` | 0.106s | 0.053s | 0.159s |
| `xtp_rich_full.bak` | 0.093s | 0.042s | 0.135s |
| `xtp_simple_full.bak` | 0.086s | 0.045s | 0.131s |
