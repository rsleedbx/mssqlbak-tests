...
| `archive_columnstore_partition_full.bak` | 0.87s | 0.594s | 1.464s |
| `archive_columnstore_types_full.bak` | 0.315s | 0.69s | 1.005s |
| `archive_columnstore_types_random_full.bak` | 0.315s | 0.679s | 0.994s |
| `archive_single_chunk_full.bak` | 0.04s | 0.038s | 0.078s |
| `archive_single_chunk_random_full.bak` | 0.041s | 0.046s | 0.087s |
| `archivenull_full.bak` | 0.118s | 0.206s | 0.324s |
| `backup_blocksize_full.bak` | 0.037s | 0.034s | 0.071s |
| `boundarycoverage_datetime_full.bak` | 0.065s | 0.138s | 0.203s |
| `boundarycoverage_full.bak` | 0.058s | 0.071s | 0.129s |
| `cci_binary_varbinary_compare_full.bak` | 0.051s | 0.046s | 0.097s |
| `cci_bitpack_probe_bigint_full.bak` | 0.26s | 3.661s | 3.921s |
| `cci_bitpack_probe_full.bak` | 0.078s | 0.645s | 0.723s |
| `cci_bitpack_probe_highbase_full.bak` | 0.066s | 0.408s | 0.474s |
| `cci_btree_nci_full.bak` | 0.053s | 0.043s | 0.096s |
| `cci_computed_full.bak` | 0.037s | 0.032s | 0.069s |
| `cci_enc5_largepool_full.bak` | 0.308s | 0.436s | 0.744s |
| `cci_enc5_largepool_matrix_full.bak` | 6.986s | 1.231s | 8.217s |
| `cci_extended_full.bak` | 0.051s | 0.05s | 0.101s |
| `cci_lob_full.bak` | 0.05s | 0.058s | 0.108s |
| `cci_reorganize_full.bak` | 0.039s | 0.032s | 0.071s |
| `cci_string_dict_regression_full.bak` | 0.29s | 0.132s | 0.422s |
| `cci_string_minmax_full.bak` | 0.052s | 0.046s | 0.098s |
| `cci_switch_full.bak` | 0.039s | 0.031s | 0.07s |
| `cci_types_large_full.bak` | 0.056s | 0.047s | 0.103s |
| `cci_varbinary_micro_full.bak` | 0.037s | 0.037s | 0.074s |
| `cci_varbinary_probe_full.bak` | 0.056s | 0.058s | 0.114s |
| `columnstore_minimal.bak` | 0.122s | 0.939s | 1.061s |
| `compressed_nvarchar_full.bak` | 0.041s | 0.033s | 0.074s |
| `compressioncoverage_full.bak` | 0.073s | 0.172s | 0.245s |
| `computedcoverage_full.bak` | 0.034s | 0.035s | 0.069s |
| `constraintcoverage_full.bak` | 0.043s | 0.052s | 0.095s |
| `covering_index_full.bak` | 0.038s | 0.041s | 0.079s |
| `cs_lob_preamble.bak` | 0.112s | 0.069s | 0.181s |
| `delta_rowgroup_full.bak` | 0.039s | 0.03s | 0.069s |
| `dirtycoverage_aborted_xact.bak` | 0.06s | 0.036s | 0.096s |
| `dirtycoverage_addcol.bak` | 0.036s | 0.039s | 0.075s |
| `dirtycoverage_addnotnull.bak` | 0.038s | 0.038s | 0.076s |
| `dirtycoverage_alldirty.bak` | 0.072s | 0.034s | 0.106s |
| `dirtycoverage_altercol.bak` | 0.036s | 0.029s | 0.065s |
| `dirtycoverage_altercol_rewrite.bak` | 0.038s | 0.036s | 0.074s |
| `dirtycoverage_alterdb.bak` | 0.037s | 0.036s | 0.073s |
| `dirtycoverage_cci_delete.bak` | 0.06s | 0.086s | 0.146s |
| `dirtycoverage_cci_update.bak` | 0.092s | 0.086s | 0.178s |
| `dirtycoverage_committed_delete.bak` | 0.037s | 0.034s | 0.071s |
| `dirtycoverage_committed_delete_v2.bak` | 0.041s | 0.038s | 0.079s |
| `dirtycoverage_committed_delete_v3.bak` | 0.052s | 0.061s | 0.113s |
| `dirtycoverage_committed_delete_v4.bak` | 0.154s | 0.066s | 0.22s |
| `dirtycoverage_committed_update.bak` | 0.033s | 0.034s | 0.067s |
| `dirtycoverage_committed_update_v2.bak` | 0.043s | 0.049s | 0.092s |
| `dirtycoverage_committed_update_v3.bak` | 0.046s | 0.071s | 0.117s |
| `dirtycoverage_committed_update_v4.bak` | 0.045s | 0.082s | 0.127s |
| `dirtycoverage_concurrent.bak` | 0.039s | 0.038s | 0.077s |
| `dirtycoverage_createidx.bak` | 0.046s | 0.03s | 0.076s |
| `dirtycoverage_createtable.bak` | 0.041s | 0.036s | 0.077s |
| `dirtycoverage_delete.bak` | 0.065s | 0.04s | 0.105s |
| `dirtycoverage_dropcol.bak` | 0.036s | 0.034s | 0.07s |
| `dirtycoverage_dropidx.bak` | 0.037s | 0.036s | 0.073s |
| `dirtycoverage_droptable.bak` | 0.039s | 0.038s | 0.077s |
| `dirtycoverage_heap_forward.bak` | 0.063s | 0.035s | 0.098s |
| `dirtycoverage_large_dirty.bak` | 0.334s | 0.035s | 0.369s |
| `dirtycoverage_lob_update.bak` | 0.082s | 0.035s | 0.117s |
| `dirtycoverage_maxrow.bak` | 0.035s | 0.05s | 0.085s |
| `dirtycoverage_nchar_delete.bak` | 0.063s | 0.041s | 0.104s |
| `dirtycoverage_nested.bak` | 0.067s | 0.037s | 0.104s |
| `dirtycoverage_null_update.bak` | 0.07s | 0.037s | 0.107s |
| `dirtycoverage_rebuildidx.bak` | 0.037s | 0.036s | 0.073s |
| `dirtycoverage_rich_insert.bak` | 0.08s | 0.036s | 0.116s |
| `dirtycoverage_rich_update.bak` | 0.062s | 0.04s | 0.102s |
| `dirtycoverage_savepoint.bak` | 0.067s | 0.043s | 0.11s |
| `dirtycoverage_snapshot_update.bak` | 0.06s | 0.037s | 0.097s |
| `dirtycoverage_switch.bak` | 0.038s | 0.03s | 0.068s |
| `dirtycoverage_temporal_update.bak` | 0.066s | 0.037s | 0.103s |
| `dirtycoverage_truncate.bak` | 0.039s | 0.039s | 0.078s |
| `dirtycoverage_two_tx.bak` | 0.073s | 0.038s | 0.111s |
| `dirtycoverage_uncommitted.bak` | 0.068s | 0.037s | 0.105s |
| `dirtycoverage_update.bak` | 0.068s | 0.039s | 0.107s |
| `featurecoverage_full.bak` | 0.109s | 0.047s | 0.156s |
| `filtered_ncci_full.bak` | 0.038s | 0.038s | 0.076s |
| `float_extreme_full.bak` | 0.035s | 0.046s | 0.081s |
| `forwarded_records_full.bak` | 0.102s | 0.103s | 0.205s |
| `ghost_records_full.bak` | 0.034s | 0.038s | 0.072s |
| `heapcoverage_large.bak` | 0.038s | 0.052s | 0.09s |
| `heapcoverage_large_50000.bak` | 0.092s | 0.307s | 0.399s |
| `hierarchyid_extract_full.bak` | 0.038s | 0.034s | 0.072s |
| `high_slot_density_full.bak` | 0.051s | 0.186s | 0.237s |
| `identity_coverage_full.bak` | 0.04s | 0.043s | 0.083s |
| `incrementalcoverage_diff_01.bak` | 0.039s | 0.01s | 0.049s |
| `incrementalcoverage_diff_02.bak` | 0.041s | 0.01s | 0.051s |
| `incrementalcoverage_diff_03.bak` | 0.045s | 0.012s | 0.057s |
| `incrementalcoverage_diff_04.bak` | 0.04s | 0.012s | 0.052s |
| `incrementalcoverage_diff_05.bak` | 0.04s | 0.013s | 0.053s |
| `incrementalcoverage_diff_06.bak` | 0.041s | 0.01s | 0.051s |
| `incrementalcoverage_full.bak` | 0.032s | 0.03s | 0.062s |
| `layoutcoverage_full.bak` | 0.144s | 0.332s | 0.476s |
| `max_row_width_full.bak` | 0.033s | 0.035s | 0.068s |
| `mixed_collation_full.bak` | 0.032s | 0.03s | 0.062s |
| `multi_rowgroup_full.bak` | 0.038s | 0.032s | 0.07s |
| `native_json_full.bak` | 0.036s | 0.037s | 0.073s |
| `ncci_heap_full.bak` | 0.042s | 0.05s | 0.092s |
| `ncci_types_full.bak` | 0.071s | 0.174s | 0.245s |
| `ndfcoverage_full.bak` | 0.046s | 0.04s | 0.086s |
| `nvarchar_max_u21_full.bak` | 0.036s | 0.037s | 0.073s |
| `ordered_cci_full.bak` | 0.04s | 0.033s | 0.073s |
| `pagecomp_anchor_full.bak` | 0.133s | 0.094s | 0.227s |
| `pagecomp_long_prefix_full.bak` | 0.036s | 0.029s | 0.065s |
| `pfor_columnstore_full.bak` | 0.105s | 0.813s | 0.918s |
| `pfor_columnstore_random_full.bak` | 0.096s | 0.838s | 0.934s |
| `realworld_numeric_digest_full.bak` | 0.047s | 0.093s | 0.14s |
| `rowboundary_full.bak` | 0.038s | 0.049s | 0.087s |
| `rowstore_hash_pii_full.bak` | 0.062s | 0.052s | 0.114s |
| `rowstore_lob_image_full.bak` | 0.043s | 0.037s | 0.08s |
| `rowstore_lob_markup_full.bak` | 0.036s | 0.029s | 0.065s |
| `rowversion_extract_full.bak` | 0.042s | 0.038s | 0.08s |
| `sparse_full.bak` | 0.089s | 0.088s | 0.177s |
| `spatial_edge_full.bak` | 0.037s | 0.037s | 0.074s |
| `spatial_index_full.bak` | 0.039s | 0.037s | 0.076s |
| `sql_variant_extract_full.bak` | 0.041s | 0.034s | 0.075s |
| `striped_full_1.bak` | 0.05s | 0.014s | 0.064s |
| `striped_single.bak` | 0.053s | 0.049s | 0.102s |
| `surrogate_pairs_full.bak` | 0.035s | 0.033s | 0.068s |
| `tabletype_cci_large_full.bak` | 0.055s | 0.048s | 0.103s |
| `tabletypecoverage_diff.bak` | 0.101s | 0.056s | 0.157s |
| `tabletypecoverage_full.bak` | 0.077s | 0.08s | 0.157s |
| `temporal_hidden_full.bak` | 0.037s | 0.032s | 0.069s |
| `torn_page_full.bak` | 0.037s | 0.035s | 0.072s |
| `typecoverage_full.bak` | 0.065s | 0.067s | 0.132s |
| `typed_xml_full.bak` | 0.036s | 0.036s | 0.072s |
| `unicode_codepage_coverage.bak` | 0.058s | 0.048s | 0.106s |
| `utf8_collation_full.bak` | 0.033s | 0.036s | 0.069s |
| `vector_full.bak` | 0.036s | 0.03s | 0.066s |
| `xml_index_full.bak` | 0.037s | 0.031s | 0.068s |
| `xmlcoverage_full.bak` | 0.033s | 0.029s | 0.062s |
| `xmlheap_full.bak` | 0.056s | 0.057s | 0.113s |
| `xtp_checkpoint_straddle_full.bak` | 1.744s | 0.358s | 2.102s |
| `xtp_probe_full.bak` | 0.101s | 0.041s | 0.142s |
| `xtp_rich_full.bak` | 0.097s | 0.043s | 0.14s |
| `xtp_simple_full.bak` | 0.089s | 0.041s | 0.13s |
