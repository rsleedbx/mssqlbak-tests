...
|--------|---------|--------|-----------|
| `alias_types_full.bak` | 0.036s | 0.037s | 0.073s |
| `archive_columnstore_partition_full.bak` | 0.963s | 0.584s | 1.547s |
| `archive_columnstore_types_full.bak` | 0.318s | 0.664s | 0.982s |
| `archive_columnstore_types_random_full.bak` | 0.31s | 0.691s | 1.001s |
| `archive_single_chunk_full.bak` | 0.041s | 0.04s | 0.081s |
| `archive_single_chunk_random_full.bak` | 0.041s | 0.048s | 0.089s |
| `archivenull_full.bak` | 0.15s | 0.231s | 0.381s |
| `backup_blocksize_full.bak` | 0.037s | 0.047s | 0.084s |
| `boundarycoverage_datetime_full.bak` | 0.058s | 0.152s | 0.21s |
| `boundarycoverage_full.bak` | 0.051s | 0.057s | 0.108s |
| `cci_binary_varbinary_compare_full.bak` | 0.053s | 0.05s | 0.103s |
| `cci_bitpack_probe_bigint_full.bak` | 0.269s | 3.758s | 4.027s |
| `cci_bitpack_probe_full.bak` | 0.078s | 0.642s | 0.72s |
| `cci_bitpack_probe_highbase_full.bak` | 0.064s | 0.63s | 0.694s |
| `cci_btree_nci_full.bak` | 0.054s | 0.044s | 0.098s |
| `cci_computed_full.bak` | 0.037s | 0.037s | 0.074s |
| `cci_enc5_largepool_full.bak` | 0.322s | 0.656s | 0.978s |
| `cci_enc5_largepool_matrix_full.bak` | 7.315s | 1.227s | 8.542s |
| `cci_extended_full.bak` | 0.056s | 0.036s | 0.092s |
| `cci_lob_full.bak` | 0.048s | 0.052s | 0.1s |
| `cci_reorganize_full.bak` | 0.042s | 0.043s | 0.085s |
| `cci_string_dict_regression_full.bak` | 0.301s | 0.137s | 0.438s |
| `cci_string_minmax_full.bak` | 0.043s | 0.041s | 0.084s |
| `cci_switch_full.bak` | 0.042s | 0.04s | 0.082s |
| `cci_types_large_full.bak` | 0.055s | 0.054s | 0.109s |
| `cci_varbinary_micro_full.bak` | 0.038s | 0.045s | 0.083s |
| `cci_varbinary_probe_full.bak` | 0.068s | 0.045s | 0.113s |
| `columnstore_minimal.bak` | 0.106s | 1.444s | 1.55s |
| `compressed_nvarchar_full.bak` | 0.037s | 0.033s | 0.07s |
| `compressioncoverage_full.bak` | 0.076s | 0.174s | 0.25s |
| `computedcoverage_full.bak` | 0.038s | 0.037s | 0.075s |
| `constraintcoverage_full.bak` | 0.044s | 0.043s | 0.087s |
| `covering_index_full.bak` | 0.047s | 0.042s | 0.089s |
| `cs_lob_preamble.bak` | 0.068s | 0.057s | 0.125s |
| `delta_rowgroup_full.bak` | 0.04s | 0.036s | 0.076s |
| `dirtycoverage_aborted_xact.bak` | 0.064s | 0.036s | 0.1s |
| `dirtycoverage_addcol.bak` | 0.036s | 0.037s | 0.073s |
| `dirtycoverage_addnotnull.bak` | 0.038s | 0.042s | 0.08s |
| `dirtycoverage_alldirty.bak` | 0.068s | 0.033s | 0.101s |
| `dirtycoverage_altercol.bak` | 0.035s | 0.041s | 0.076s |
| `dirtycoverage_altercol_rewrite.bak` | 0.036s | 0.038s | 0.074s |
| `dirtycoverage_alterdb.bak` | 0.045s | 0.049s | 0.094s |
| `dirtycoverage_cci_delete.bak` | 0.06s | 0.087s | 0.147s |
| `dirtycoverage_cci_update.bak` | 0.094s | 0.094s | 0.188s |
| `dirtycoverage_committed_delete.bak` | 0.033s | 0.035s | 0.068s |
| `dirtycoverage_committed_delete_v2.bak` | 0.035s | 0.044s | 0.079s |
| `dirtycoverage_committed_delete_v3.bak` | 0.04s | 0.057s | 0.097s |
| `dirtycoverage_committed_delete_v4.bak` | 0.146s | 0.066s | 0.212s |
| `dirtycoverage_committed_update.bak` | 0.033s | 0.039s | 0.072s |
| `dirtycoverage_committed_update_v2.bak` | 0.043s | 0.039s | 0.082s |
| `dirtycoverage_committed_update_v3.bak` | 0.046s | 0.072s | 0.118s |
| `dirtycoverage_committed_update_v4.bak` | 0.045s | 0.075s | 0.12s |
| `dirtycoverage_concurrent.bak` | 0.038s | 0.038s | 0.076s |
| `dirtycoverage_createidx.bak` | 0.04s | 0.043s | 0.083s |
| `dirtycoverage_createtable.bak` | 0.041s | 0.037s | 0.078s |
| `dirtycoverage_delete.bak` | 0.068s | 0.039s | 0.107s |
| `dirtycoverage_dropcol.bak` | 0.036s | 0.037s | 0.073s |
| `dirtycoverage_dropidx.bak` | 0.037s | 0.041s | 0.078s |
| `dirtycoverage_droptable.bak` | 0.04s | 0.039s | 0.079s |
| `dirtycoverage_heap_forward.bak` | 0.064s | 0.036s | 0.1s |
| `dirtycoverage_large_dirty.bak` | 0.397s | 0.037s | 0.434s |
| `dirtycoverage_lob_update.bak` | 0.079s | 0.033s | 0.112s |
| `dirtycoverage_maxrow.bak` | 0.036s | 0.038s | 0.074s |
| `dirtycoverage_nchar_delete.bak` | 0.064s | 0.04s | 0.104s |
| `dirtycoverage_nested.bak` | 0.065s | 0.03s | 0.095s |
| `dirtycoverage_null_update.bak` | 0.067s | 0.029s | 0.096s |
| `dirtycoverage_rebuildidx.bak` | 0.037s | 0.039s | 0.076s |
| `dirtycoverage_rich_insert.bak` | 0.08s | 0.031s | 0.111s |
| `dirtycoverage_rich_update.bak` | 0.061s | 0.031s | 0.092s |
| `dirtycoverage_savepoint.bak` | 0.069s | 0.03s | 0.099s |
| `dirtycoverage_snapshot_update.bak` | 0.059s | 0.04s | 0.099s |
| `dirtycoverage_switch.bak` | 0.04s | 0.044s | 0.084s |
| `dirtycoverage_temporal_update.bak` | 0.071s | 0.03s | 0.101s |
| `dirtycoverage_truncate.bak` | 0.038s | 0.039s | 0.077s |
| `dirtycoverage_two_tx.bak` | 0.073s | 0.035s | 0.108s |
| `dirtycoverage_uncommitted.bak` | 0.068s | 0.031s | 0.099s |
| `dirtycoverage_update.bak` | 0.068s | 0.03s | 0.098s |
| `featurecoverage_full.bak` | 0.108s | 0.045s | 0.153s |
| `filtered_ncci_full.bak` | 0.042s | 0.042s | 0.084s |
| `float_extreme_full.bak` | 0.037s | 0.037s | 0.074s |
| `forwarded_records_full.bak` | 0.074s | 0.048s | 0.122s |
| `ghost_records_full.bak` | 0.034s | 0.039s | 0.073s |
| `heapcoverage_large.bak` | 0.039s | 0.043s | 0.082s |
| `heapcoverage_large_50000.bak` | 0.093s | 0.324s | 0.417s |
| `hierarchyid_extract_full.bak` | 0.036s | 0.036s | 0.072s |
| `high_slot_density_full.bak` | 0.06s | 0.214s | 0.274s |
| `incrementalcoverage_diff_01.bak` | 0.039s | 0.013s | 0.052s |
| `incrementalcoverage_diff_02.bak` | 0.041s | 0.014s | 0.055s |
| `incrementalcoverage_diff_03.bak` | 0.041s | 0.012s | 0.053s |
| `incrementalcoverage_diff_04.bak` | 0.04s | 0.013s | 0.053s |
| `incrementalcoverage_diff_05.bak` | 0.041s | 0.014s | 0.055s |
| `incrementalcoverage_diff_06.bak` | 0.042s | 0.015s | 0.057s |
| `incrementalcoverage_full.bak` | 0.034s | 0.034s | 0.068s |
| `layoutcoverage_full.bak` | 0.175s | 0.439s | 0.614s |
| `max_row_width_full.bak` | 0.032s | 0.045s | 0.077s |
| `mixed_collation_full.bak` | 0.035s | 0.039s | 0.074s |
| `multi_rowgroup_full.bak` | 0.038s | 0.041s | 0.079s |
| `native_json_full.bak` | 0.04s | 0.036s | 0.076s |
| `ncci_heap_full.bak` | 0.037s | 0.04s | 0.077s |
| `ncci_types_full.bak` | 0.069s | 0.178s | 0.247s |
| `ndfcoverage_full.bak` | 0.045s | 0.044s | 0.089s |
| `nvarchar_max_u21_full.bak` | 0.037s | 0.034s | 0.071s |
| `ordered_cci_full.bak` | 0.04s | 0.046s | 0.086s |
| `pagecomp_anchor_full.bak` | 0.132s | 0.095s | 0.227s |
| `pagecomp_long_prefix_full.bak` | 0.041s | 0.034s | 0.075s |
| `pfor_columnstore_full.bak` | 0.099s | 0.814s | 0.913s |
| `pfor_columnstore_random_full.bak` | 0.114s | 0.823s | 0.937s |
| `realworld_numeric_digest_full.bak` | 0.048s | 0.077s | 0.125s |
| `rowboundary_full.bak` | 0.037s | 0.042s | 0.079s |
| `rowstore_hash_pii_full.bak` | 0.036s | 0.043s | 0.079s |
| `rowstore_lob_image_full.bak` | 0.036s | 0.038s | 0.074s |
| `rowstore_lob_markup_full.bak` | 0.04s | 0.035s | 0.075s |
| `rowversion_extract_full.bak` | 0.037s | 0.037s | 0.074s |
| `sparse_full.bak` | 0.087s | 0.087s | 0.174s |
| `spatial_edge_full.bak` | 0.037s | 0.04s | 0.077s |
| `spatial_index_full.bak` | 0.038s | 0.038s | 0.076s |
| `sql_variant_extract_full.bak` | 0.036s | 0.044s | 0.08s |
| `striped_full_1.bak` | 0.05s | 0.015s | 0.065s |
| `striped_single.bak` | 0.049s | 0.048s | 0.097s |
| `surrogate_pairs_full.bak` | 0.036s | 0.035s | 0.071s |
| `tabletype_cci_large_full.bak` | 0.053s | 0.049s | 0.102s |
| `tabletypecoverage_diff.bak` | 0.104s | 0.054s | 0.158s |
| `tabletypecoverage_full.bak` | 0.073s | 0.082s | 0.155s |
| `temporal_hidden_full.bak` | 0.042s | 0.05s | 0.092s |
| `torn_page_full.bak` | 0.036s | 0.038s | 0.074s |
| `typecoverage_full.bak` | 0.066s | 0.056s | 0.122s |
| `typed_xml_full.bak` | 0.04s | 0.041s | 0.081s |
| `unicode_codepage_coverage.bak` | 0.064s | 0.049s | 0.113s |
| `utf8_collation_full.bak` | 0.045s | 0.035s | 0.08s |
| `vector_full.bak` | 0.042s | 0.06s | 0.102s |
| `xml_index_full.bak` | 0.038s | 0.044s | 0.082s |
| `xmlcoverage_full.bak` | 0.034s | 0.036s | 0.07s |
| `xmlheap_full.bak` | 0.051s | 0.043s | 0.094s |
| `xtp_checkpoint_straddle_full.bak` | 1.785s | 0.371s | 2.156s |
| `xtp_probe_full.bak` | 0.104s | 0.031s | 0.135s |
| `xtp_rich_full.bak` | 0.087s | 0.031s | 0.118s |
| `xtp_simple_full.bak` | 0.086s | 0.031s | 0.117s |
