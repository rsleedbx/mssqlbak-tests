...
| Backup | Wall time |
|--------|-------------|
| `alias_types_full.bak` | 0.107s |
| `archive_columnstore_partition_full.bak` | 2.392s |
| `archive_columnstore_types_full.bak` | 1.341s |
| `archive_columnstore_types_random_full.bak` | 1.327s |
| `archive_single_chunk_full.bak` | 0.151s |
| `archive_single_chunk_random_full.bak` | 0.163s |
| `archivenull_full.bak` | 0.453s |
| `backup_blocksize_full.bak` | 0.513s |
| `boundarycoverage_datetime_full.bak` | 0.376s |
| `boundarycoverage_full.bak` | 0.192s |
| `cci_binary_varbinary_compare_full.bak` | 0.134s |
| `cci_bitpack_probe_bigint_full.bak` | 8.232s |
| `cci_bitpack_probe_full.bak` | 1.755s |
| `cci_bitpack_probe_highbase_full.bak` | 1.279s |
| `cci_btree_nci_full.bak` | 0.193s |
| `cci_computed_full.bak` | 0.129s |
| `cci_enc5_largepool_full.bak` | 1.157s |
| `cci_enc5_largepool_matrix_full.bak` | 9.291s |
| `cci_extended_full.bak` | 0.178s |
| `cci_lob_full.bak` | 0.122s |
| `cci_reorganize_full.bak` | 0.106s |
| `cci_string_dict_regression_full.bak` | 0.53s |
| `cci_string_minmax_full.bak` | 0.089s |
| `cci_switch_full.bak` | 0.136s |
| `cci_types_large_full.bak` | 0.211s |
| `cci_varbinary_micro_full.bak` | 0.139s |
| `cci_varbinary_probe_full.bak` | 0.191s |
| `columnstore_minimal.bak` | 1.101s |
| `compressed_nvarchar_full.bak` | 0.125s |
| `compressioncoverage_full.bak` | 0.337s |
| `computedcoverage_full.bak` | 0.096s |
| `constraintcoverage_full.bak` | 0.137s |
| `covering_index_full.bak` | 0.121s |
| `cs_lob_preamble.bak` | 0.192s |
| `delta_rowgroup_full.bak` | 0.13s |
| `dirtycoverage_aborted_xact.bak` | 0.162s |
| `dirtycoverage_addcol.bak` | 0.103s |
| `dirtycoverage_addnotnull.bak` | 0.207s |
| `dirtycoverage_alldirty.bak` | 0.14s |
| `dirtycoverage_altercol.bak` | 0.136s |
| `dirtycoverage_altercol_rewrite.bak` | 0.246s |
| `dirtycoverage_alterdb.bak` | 0.093s |
| `dirtycoverage_cci_delete.bak` | 0.192s |
| `dirtycoverage_cci_update.bak` | 0.236s |
| `dirtycoverage_committed_delete.bak` | 0.103s |
| `dirtycoverage_committed_delete_v2.bak` | 0.169s |
| `dirtycoverage_committed_delete_v3.bak` | 0.208s |
| `dirtycoverage_committed_delete_v4.bak` | 0.338s |
| `dirtycoverage_committed_update.bak` | 0.097s |
| `dirtycoverage_committed_update_v2.bak` | 0.111s |
| `dirtycoverage_committed_update_v3.bak` | 0.198s |
| `dirtycoverage_committed_update_v4.bak` | 0.266s |
| `dirtycoverage_concurrent.bak` | 0.138s |
| `dirtycoverage_createidx.bak` | 0.153s |
| `dirtycoverage_createtable.bak` | 0.214s |
| `dirtycoverage_delete.bak` | 0.128s |
| `dirtycoverage_dropcol.bak` | 0.11s |
| `dirtycoverage_dropidx.bak` | 0.187s |
| `dirtycoverage_droptable.bak` | 0.175s |
| `dirtycoverage_heap_forward.bak` | 0.133s |
| `dirtycoverage_large_dirty.bak` | 0.39s |
| `dirtycoverage_lob_update.bak` | 0.142s |
| `dirtycoverage_maxrow.bak` | 0.511s |
| `dirtycoverage_nchar_delete.bak` | 0.127s |
| `dirtycoverage_nested.bak` | 0.152s |
| `dirtycoverage_null_update.bak` | 0.181s |
| `dirtycoverage_rebuildidx.bak` | 0.128s |
| `dirtycoverage_rich_insert.bak` | 0.138s |
| `dirtycoverage_rich_update.bak` | 0.115s |
| `dirtycoverage_savepoint.bak` | 0.148s |
| `dirtycoverage_snapshot_update.bak` | 0.157s |
| `dirtycoverage_switch.bak` | 0.106s |
| `dirtycoverage_temporal_update.bak` | 0.111s |
| `dirtycoverage_truncate.bak` | 0.101s |
| `dirtycoverage_two_tx.bak` | 0.169s |
| `dirtycoverage_uncommitted.bak` | 0.149s |
| `dirtycoverage_update.bak` | 0.112s |
| `featurecoverage_full.bak` | 0.201s |
| `filtered_ncci_full.bak` | 0.153s |
| `float_extreme_full.bak` | 0.086s |
| `forwarded_records_full.bak` | 0.189s |
| `ghost_records_full.bak` | 0.1s |
| `heapcoverage_large.bak` | 0.135s |
| `heapcoverage_large_50000.bak` | 0.961s |
| `hierarchyid_extract_full.bak` | 0.117s |
| `high_slot_density_full.bak` | 0.559s |
| `incrementalcoverage_diff_01.bak` | 0.064s |
| `incrementalcoverage_diff_02.bak` | 0.084s |
| `incrementalcoverage_diff_03.bak` | 0.088s |
| `incrementalcoverage_diff_04.bak` | 0.076s |
| `incrementalcoverage_diff_05.bak` | 0.067s |
| `incrementalcoverage_diff_06.bak` | 0.071s |
| `incrementalcoverage_full.bak` | 0.103s |
| `layoutcoverage_full.bak` | 0.418s |
| `max_row_width_full.bak` | 0.089s |
| `mixed_collation_full.bak` | 0.086s |
| `multi_rowgroup_full.bak` | 0.154s |
| `native_json_full.bak` | 0.119s |
| `ncci_heap_full.bak` | 0.155s |
| `ncci_types_full.bak` | 0.508s |
| `ndfcoverage_full.bak` | 0.226s |
| `nvarchar_max_u21_full.bak` | 0.136s |
| `ordered_cci_full.bak` | 0.111s |
| `pagecomp_anchor_full.bak` | 0.376s |
| `pagecomp_long_prefix_full.bak` | 0.175s |
| `pfor_columnstore_full.bak` | 2.312s |
| `pfor_columnstore_random_full.bak` | 2.277s |
| `realworld_numeric_digest_full.bak` | 0.207s |
| `rowboundary_full.bak` | 0.156s |
| `rowstore_hash_pii_full.bak` | 0.086s |
| `rowstore_lob_image_full.bak` | 0.091s |
| `rowstore_lob_markup_full.bak` | 0.087s |
| `rowversion_extract_full.bak` | 0.141s |
| `sparse_full.bak` | 0.294s |
| `spatial_edge_full.bak` | 0.211s |
| `spatial_index_full.bak` | 0.178s |
| `sql_variant_extract_full.bak` | 0.087s |
| `striped_full_1.bak` | 0.087s |
| `striped_single.bak` | 0.102s |
| `surrogate_pairs_full.bak` | 0.096s |
| `tabletype_cci_large_full.bak` | 0.112s |
| `tabletypecoverage_diff.bak` | 19.568s |
| `tabletypecoverage_full.bak` | 15.354s |
| `temporal_hidden_full.bak` | 0.131s |
| `torn_page_full.bak` | 0.306s |
| `typecoverage_full.bak` | 0.235s |
| `typed_xml_full.bak` | 0.099s |
| `unicode_codepage_coverage.bak` | 0.18s |
| `utf8_collation_full.bak` | 0.097s |
| `vector_full.bak` | 0.133s |
| `xml_index_full.bak` | 0.163s |
| `xmlcoverage_full.bak` | 0.087s |
| `xmlheap_full.bak` | 0.155s |
| `xtp_checkpoint_straddle_full.bak` | 3.257s |
| `xtp_probe_full.bak` | 0.217s |
| `xtp_rich_full.bak` | 0.213s |
| `xtp_simple_full.bak` | 0.212s |
