...
**138 fixtures · 138 pass · 0 xfail (known gap) · 0 fail**
...
| `featurecoverage_full.bak` | mssql→arrow | 2,148 | 44 | **11/11** | **32/32** | **64/64** | **11/11** | **3298/3298** | ✓ |
| `featurecoverage_full.bak` | arrow→delta | 2,148 | 44 | **11/11** | **44/44** | **88/88** | **11/11** | — | ✓ |
| `featurecoverage_full.bak` | delta→arrow | 2,148 | 44 | **11/11** | **32/32** | **64/64** | **11/11** | **3298/3298** | ✓ |
| `featurecoverage_full.bak` | arrow→pg_dir | 2,148 | 44 | **11/11** | **44/44** | **88/88** | **11/11** | — | ✓ |
| `featurecoverage_full.bak` | pg_dir→arrow | 2,148 | 44 | **11/11** | **32/32** | **64/64** | **11/11** | **3298/3298** | ✓ |
...
| `layoutcoverage_full.bak` | mssql→arrow | 171 | 2,421 | **57/57** | **2421/2421** | **4834/4834** | **57/57** | **7092/7092** | ✓ |
| `layoutcoverage_full.bak` | arrow→delta | 171 | 2,421 | **57/57** | **2421/2421** | **4842/4842** | **57/57** | — | ✓ |
| `layoutcoverage_full.bak` | delta→arrow | 171 | 2,421 | **57/57** | **2421/2421** | **4834/4834** | **57/57** | **7092/7092** | ✓ |
| `layoutcoverage_full.bak` | arrow→pg_dir | 171 | 2,421 | **57/57** | **2421/2421** | **4842/4842** | **57/57** | — | ✓ |
| `layoutcoverage_full.bak` | pg_dir→arrow | 171 | 2,421 | **57/57** | **2421/2421** | **4834/4834** | **57/57** | **7092/7092** | ✓ |
...
| `native_json_full.bak` | mssql→arrow | 20 | 4 | **2/2** | **4/4** | **2/2** | **2/2** | **20/20** | ✓ |
| `native_json_full.bak` | arrow→delta | 20 | 4 | **2/2** | **4/4** | **8/8** | **2/2** | — | ✓ |
| `native_json_full.bak` | delta→arrow | 20 | 4 | **2/2** | **4/4** | **2/2** | **2/2** | **20/20** | ✓ |
| `native_json_full.bak` | arrow→pg_dir | 20 | 4 | **2/2** | **4/4** | **8/8** | **2/2** | — | ✓ |
| `native_json_full.bak` | pg_dir→arrow | 20 | 4 | **2/2** | **4/4** | **2/2** | **2/2** | **20/20** | ✓ |
...
| `ncci_types_full.bak` | mssql→arrow | 24,057 | 39 | **20/20** | **39/39** | **68/68** | **20/20** | **22857/22857** | ✓ |
| `ncci_types_full.bak` | arrow→delta | 24,057 | 39 | **20/20** | **39/39** | **78/78** | **20/20** | — | ✓ |
| `ncci_types_full.bak` | delta→arrow | 24,057 | 39 | **20/20** | **39/39** | **68/68** | **20/20** | **22857/22857** | ✓ |
| `ncci_types_full.bak` | arrow→pg_dir | 24,057 | 39 | **20/20** | **39/39** | 76/78 ⚠ | **20/20** | — | ✗ |
| `ncci_types_full.bak` | pg_dir→arrow | 24,057 | 39 | **20/20** | **39/39** | **68/68** | **20/20** | **22857/22857** | ✓ |
...
| `vector_full.bak` | mssql→arrow | 20 | 4 | **2/2** | **4/4** | **2/2** | **2/2** | **20/20** | ✓ |
| `vector_full.bak` | arrow→delta | 20 | 4 | **2/2** | **4/4** | **8/8** | **2/2** | — | ✓ |
| `vector_full.bak` | delta→arrow | 20 | 4 | **2/2** | **4/4** | **2/2** | **2/2** | **20/20** | ✓ |
| `vector_full.bak` | arrow→pg_dir | 20 | 4 | **2/2** | **4/4** | **8/8** | **2/2** | — | ✓ |
| `vector_full.bak` | pg_dir→arrow | 20 | 4 | **2/2** | **4/4** | **2/2** | **2/2** | **20/20** | ✓ |
...
| `dbo.json_docs` | rowstore | 10 | ✓ | **3/3** | — | ✓ | cells **20/20** ✓ |
...
| `dbo.ncci_bit` | rowstore | 1,203 | ✓ | **2/2** | — | ✓ | cells **1203/1203** ✓ |
...
| `dbo.ncci_float` | rowstore | 1,203 | ✓ | **2/2** | — | ✓ | cells **1203/1203** ✓ |
...
|-------|------|------------:|:---------:|:----------:|:-------:|:---------:|-------|
| `dbo.fkr__seed` | rowstore | 10 | ✓ | **1/1** | **2/2** | ✓ | cells digest ✓ |
| `dbo.vec_tbl` | rowstore | 10 | ✓ | **3/3** | — | ✓ | cells **20/20** ✓ |
...
|--------|---------|--------|-----------|
| `alias_types_full.bak` | 0.104s | 0.069s | 0.173s |
| `archive_columnstore_partition_full.bak` | 3.017s | 2.448s | 5.465s |
| `archive_columnstore_types_full.bak` | 1.54s | 1.856s | 3.396s |
| `archive_columnstore_types_random_full.bak` | 1.529s | 1.867s | 3.396s |
| `archive_single_chunk_full.bak` | 0.091s | 0.112s | 0.203s |
| `archive_single_chunk_random_full.bak` | 0.1s | 0.093s | 0.193s |
| `archivenull_full.bak` | 0.489s | 0.508s | 0.997s |
| `backup_blocksize_full.bak` | 0.092s | 0.081s | 0.173s |
| `boundarycoverage_datetime_full.bak` | 0.365s | 0.408s | 0.773s |
| `boundarycoverage_full.bak` | 0.177s | 0.215s | 0.392s |
| `cci_binary_varbinary_compare_full.bak` | 0.09s | 0.094s | 0.184s |
| `cci_bitpack_probe_bigint_full.bak` | 10.157s | 11.63s | 21.787s |
| `cci_bitpack_probe_full.bak` | 1.696s | 1.847s | 3.543s |
| `cci_bitpack_probe_highbase_full.bak` | 1.061s | 1.212s | 2.273s |
| `cci_btree_nci_full.bak` | 0.128s | 0.089s | 0.217s |
| `cci_computed_full.bak` | 0.11s | 0.083s | 0.193s |
| `cci_enc5_largepool_full.bak` | 1.079s | 1.073s | 2.152s |
| `cci_enc5_largepool_matrix_full.bak` | 9.185s | 3.443s | 12.628s |
| `cci_extended_full.bak` | 0.129s | 0.155s | 0.284s |
| `cci_lob_full.bak` | 0.135s | 0.129s | 0.264s |
| `cci_reorganize_full.bak` | 0.111s | 0.096s | 0.207s |
| `cci_string_dict_regression_full.bak` | 0.585s | 0.33s | 0.915s |
| `cci_string_minmax_full.bak` | 0.129s | 0.1s | 0.229s |
| `cci_switch_full.bak` | 0.106s | 0.089s | 0.195s |
| `cci_types_large_full.bak` | 0.135s | 0.15s | 0.285s |
| `cci_varbinary_micro_full.bak` | 0.104s | 0.109s | 0.213s |
| `cci_varbinary_probe_full.bak` | 0.148s | 0.117s | 0.265s |
| `columnstore_minimal.bak` | 1.64s | 1.728s | 3.368s |
| `compressed_nvarchar_full.bak` | 0.1s | 0.067s | 0.167s |
| `compressioncoverage_full.bak` | 0.413s | 0.565s | 0.978s |
| `computedcoverage_full.bak` | 0.093s | 0.082s | 0.175s |
| `constraintcoverage_full.bak` | 0.128s | 0.187s | 0.315s |
| `covering_index_full.bak` | 0.108s | 0.1s | 0.208s |
| `cs_lob_preamble.bak` | 0.148s | 0.099s | 0.247s |
| `delta_rowgroup_full.bak` | 0.096s | 0.101s | 0.197s |
| `dirtycoverage_aborted_xact.bak` | 0.125s | 0.071s | 0.196s |
| `dirtycoverage_addcol.bak` | 0.096s | 0.081s | 0.177s |
| `dirtycoverage_addnotnull.bak` | 0.097s | 0.07s | 0.167s |
| `dirtycoverage_alldirty.bak` | 0.094s | 0.048s | 0.142s |
| `dirtycoverage_altercol.bak` | 0.122s | 0.071s | 0.193s |
| `dirtycoverage_altercol_rewrite.bak` | 0.107s | 0.07s | 0.177s |
| `dirtycoverage_alterdb.bak` | 0.095s | 0.062s | 0.157s |
| `dirtycoverage_cci_delete.bak` | 0.223s | 0.211s | 0.434s |
| `dirtycoverage_cci_update.bak` | 0.254s | 0.21s | 0.464s |
| `dirtycoverage_committed_delete.bak` | 0.102s | 0.062s | 0.164s |
| `dirtycoverage_committed_delete_v2.bak` | 0.119s | 0.078s | 0.197s |
| `dirtycoverage_committed_delete_v3.bak` | 0.144s | 0.118s | 0.262s |
| `dirtycoverage_committed_delete_v4.bak` | 0.274s | 0.173s | 0.447s |
| `dirtycoverage_committed_update.bak` | 0.089s | 0.063s | 0.152s |
| `dirtycoverage_committed_update_v2.bak` | 0.106s | 0.073s | 0.179s |
| `dirtycoverage_committed_update_v3.bak` | 0.162s | 0.139s | 0.301s |
| `dirtycoverage_committed_update_v4.bak` | 0.187s | 0.19s | 0.377s |
| `dirtycoverage_concurrent.bak` | 0.11s | 0.074s | 0.184s |
| `dirtycoverage_createidx.bak` | 0.096s | 0.068s | 0.164s |
| `dirtycoverage_createtable.bak` | 0.086s | 0.067s | 0.153s |
| `dirtycoverage_delete.bak` | 0.119s | 0.064s | 0.183s |
| `dirtycoverage_dropcol.bak` | 0.113s | 0.079s | 0.192s |
| `dirtycoverage_dropidx.bak` | 0.094s | 0.059s | 0.153s |
| `dirtycoverage_droptable.bak` | 0.107s | 0.084s | 0.191s |
| `dirtycoverage_heap_forward.bak` | 0.122s | 0.072s | 0.194s |
| `dirtycoverage_large_dirty.bak` | 0.395s | 0.064s | 0.459s |
| `dirtycoverage_lob_update.bak` | 0.13s | 0.057s | 0.187s |
| `dirtycoverage_maxrow.bak` | 0.112s | 0.082s | 0.194s |
| `dirtycoverage_nchar_delete.bak` | 0.12s | 0.071s | 0.191s |
| `dirtycoverage_nested.bak` | 0.126s | 0.067s | 0.193s |
| `dirtycoverage_null_update.bak` | 0.124s | 0.07s | 0.194s |
| `dirtycoverage_rebuildidx.bak` | 0.097s | 0.073s | 0.17s |
| `dirtycoverage_rich_insert.bak` | 0.139s | 0.075s | 0.214s |
| `dirtycoverage_rich_update.bak` | 0.122s | 0.061s | 0.183s |
| `dirtycoverage_savepoint.bak` | 0.123s | 0.064s | 0.187s |
| `dirtycoverage_snapshot_update.bak` | 0.123s | 0.076s | 0.199s |
| `dirtycoverage_switch.bak` | 0.113s | 0.081s | 0.194s |
| `dirtycoverage_temporal_update.bak` | 0.129s | 0.07s | 0.199s |
| `dirtycoverage_truncate.bak` | 0.126s | 0.081s | 0.207s |
| `dirtycoverage_two_tx.bak` | 0.129s | 0.08s | 0.209s |
| `dirtycoverage_uncommitted.bak` | 0.123s | 0.06s | 0.183s |
| `dirtycoverage_update.bak` | 0.135s | 0.068s | 0.203s |
| `featurecoverage_full.bak` | 0.218s | 0.218s | 0.436s |
| `filtered_ncci_full.bak` | 0.107s | 0.098s | 0.205s |
| `float_extreme_full.bak` | 0.111s | 0.091s | 0.202s |
| `forwarded_records_full.bak` | 0.17s | 0.131s | 0.301s |
| `ghost_records_full.bak` | 0.115s | 0.088s | 0.203s |
| `heapcoverage_large.bak` | 0.124s | 0.092s | 0.216s |
| `heapcoverage_large_50000.bak` | 0.672s | 0.818s | 1.49s |
| `hierarchyid_extract_full.bak` | 0.093s | 0.074s | 0.167s |
| `high_slot_density_full.bak` | 0.46s | 0.527s | 0.987s |
| `identity_coverage_full.bak` | 0.133s | 0.153s | 0.286s |
| `incrementalcoverage_diff_01.bak` | 0.105s | 0.044s | 0.149s |
| `incrementalcoverage_diff_02.bak` | 0.106s | 0.056s | 0.162s |
| `incrementalcoverage_diff_03.bak` | 0.162s | 0.048s | 0.21s |
| `incrementalcoverage_diff_04.bak` | 0.133s | 0.074s | 0.207s |
| `incrementalcoverage_diff_05.bak` | 0.113s | 0.062s | 0.175s |
| `incrementalcoverage_diff_06.bak` | 0.161s | 0.041s | 0.202s |
| `incrementalcoverage_full.bak` | 0.097s | 0.083s | 0.18s |
| `layoutcoverage_full.bak` | 0.593s | 1.215s | 1.808s |
| `max_row_width_full.bak` | 0.111s | 0.088s | 0.199s |
| `mixed_collation_full.bak` | 0.091s | 0.066s | 0.157s |
| `multi_rowgroup_full.bak` | 0.116s | 0.088s | 0.204s |
| `native_json_full.bak` | 0.097s | 0.08s | 0.177s |
| `ncci_heap_full.bak` | 0.098s | 0.081s | 0.179s |
| `ncci_types_full.bak` | 0.397s | 0.552s | 0.949s |
| `ndfcoverage_full.bak` | 0.114s | 0.085s | 0.199s |
| `nvarchar_max_u21_full.bak` | 0.147s | 0.078s | 0.225s |
| `ordered_cci_full.bak` | 0.13s | 0.103s | 0.233s |
| `pagecomp_anchor_full.bak` | 0.283s | 0.214s | 0.497s |
| `pagecomp_long_prefix_full.bak` | 0.104s | 0.077s | 0.181s |
| `pfor_columnstore_full.bak` | 2.788s | 2.99s | 5.778s |
| `pfor_columnstore_random_full.bak` | 2.814s | 3.052s | 5.866s |
| `realworld_numeric_digest_full.bak` | 0.192s | 0.222s | 0.414s |
| `rowboundary_full.bak` | 0.105s | 0.097s | 0.202s |
| `rowstore_hash_pii_full.bak` | 0.096s | 0.071s | 0.167s |
| `rowstore_lob_image_full.bak` | 0.097s | 0.08s | 0.177s |
| `rowstore_lob_markup_full.bak` | 0.085s | 0.059s | 0.144s |
| `rowversion_extract_full.bak` | 0.092s | 0.073s | 0.165s |
| `sparse_full.bak` | 0.229s | 0.193s | 0.422s |
| `spatial_edge_full.bak` | 0.094s | 0.082s | 0.176s |
| `spatial_index_full.bak` | 0.106s | 0.082s | 0.188s |
| `sql_variant_extract_full.bak` | 0.104s | 0.076s | 0.18s |
| `striped_full_1.bak` | 0.135s | 0.108s | 0.243s |
| `striped_single.bak` | 0.108s | 0.136s | 0.244s |
| `surrogate_pairs_full.bak` | 0.089s | 0.068s | 0.157s |
| `tabletype_cci_large_full.bak` | 0.13s | 0.191s | 0.321s |
| `tabletypecoverage_diff.bak` | 0.285s | 0.636s | 0.921s |
| `tabletypecoverage_full.bak` | 0.259s | 0.628s | 0.887s |
| `temporal_hidden_full.bak` | 0.111s | 0.111s | 0.222s |
| `torn_page_full.bak` | 0.097s | 0.075s | 0.172s |
| `typecoverage_full.bak` | 0.246s | 0.623s | 0.869s |
| `typed_xml_full.bak` | 0.105s | 0.07s | 0.175s |
| `unicode_codepage_coverage.bak` | 0.163s | 0.244s | 0.407s |
| `utf8_collation_full.bak` | 0.097s | 0.076s | 0.173s |
| `vector_full.bak` | 0.108s | 0.084s | 0.192s |
| `xml_index_full.bak` | 0.1s | 0.073s | 0.173s |
| `xmlcoverage_full.bak` | 0.084s | 0.063s | 0.147s |
| `xmlheap_full.bak` | 0.119s | 0.107s | 0.226s |
| `xtp_checkpoint_straddle_full.bak` | 2.276s | 0.745s | 3.021s |
| `xtp_probe_full.bak` | 0.134s | 0.15s | 0.284s |
| `xtp_rich_full.bak` | 0.116s | 0.108s | 0.224s |
| `xtp_simple_full.bak` | 0.12s | 0.11s | 0.23s |
...
|--------|-------:| ------: | -------:| ------:|
| `alias_types_full.bak` | 0.011s | 0.01s | 0.007s | 0.007s |
| `archive_columnstore_partition_full.bak` | 0.107s | 0.665s | 1.439s | 1.724s |
| `archive_columnstore_types_full.bak` | 0.047s | 0.748s | 0.433s | 1.052s |
| `archive_columnstore_types_random_full.bak` | 0.046s | 0.756s | 0.427s | 1.055s |
| `archive_single_chunk_full.bak` | 0.005s | 0.033s | 0.011s | 0.017s |
| `archive_single_chunk_random_full.bak` | 0.005s | 0.032s | 0.012s | 0.015s |
| `archivenull_full.bak` | 0.012s | 0.184s | 0.13s | 0.274s |
| `backup_blocksize_full.bak` | 0.006s | 0.018s | 0.003s | 0.014s |
| `boundarycoverage_datetime_full.bak` | 0.028s | 0.182s | 0.109s | 0.165s |
| `boundarycoverage_full.bak` | 0.023s | 0.078s | 0.023s | 0.081s |
| `cci_binary_varbinary_compare_full.bak` | 0.005s | 0.031s | 0.005s | 0.013s |
| `cci_bitpack_probe_bigint_full.bak` | 0.266s | 3.876s | 5.717s | 7.667s |
| `cci_bitpack_probe_full.bak` | 0.031s | 0.62s | 0.926s | 1.173s |
| `cci_bitpack_probe_highbase_full.bak` | 0.026s | 0.422s | 0.528s | 0.734s |
| `cci_btree_nci_full.bak` | 0.01s | 0.017s | 0.009s | 0.019s |
| `cci_computed_full.bak` | 0.008s | 0.017s | 0.007s | 0.016s |
| `cci_enc5_largepool_full.bak` | 0.026s | 0.415s | 0.288s | 0.598s |
| `cci_enc5_largepool_matrix_full.bak` | 0.077s | 1.401s | 0.868s | 1.971s |
| `cci_extended_full.bak` | 0.018s | 0.063s | 0.015s | 0.033s |
| `cci_lob_full.bak` | 0.014s | 0.04s | 0.009s | 0.032s |
| `cci_reorganize_full.bak` | 0.01s | 0.029s | 0.008s | 0.02s |
| `cci_string_dict_regression_full.bak` | 0.02s | 0.117s | 0.076s | 0.158s |
| `cci_string_minmax_full.bak` | 0.015s | 0.023s | 0.009s | 0.025s |
| `cci_switch_full.bak` | 0.007s | 0.017s | 0.012s | 0.019s |
| `cci_types_large_full.bak` | 0.016s | 0.06s | 0.016s | 0.037s |
| `cci_varbinary_micro_full.bak` | 0.013s | 0.042s | 0.003s | 0.019s |
| `cci_varbinary_probe_full.bak` | 0.018s | 0.034s | 0.008s | 0.034s |
| `columnstore_minimal.bak` | 0.021s | 0.792s | 0.689s | 0.88s |
| `compressed_nvarchar_full.bak` | 0.008s | 0.011s | 0.004s | 0.006s |
| `compressioncoverage_full.bak` | 0.061s | 0.248s | 0.093s | 0.235s |
| `computedcoverage_full.bak` | 0.01s | 0.016s | 0.003s | 0.013s |
| `constraintcoverage_full.bak` | 0.029s | 0.077s | 0.004s | 0.054s |
| `covering_index_full.bak` | 0.009s | 0.023s | 0.007s | 0.02s |
| `cs_lob_preamble.bak` | 0.008s | 0.01s | 0.006s | 0.01s |
| `delta_rowgroup_full.bak` | 0.01s | 0.038s | 0.003s | 0.01s |
| `dirtycoverage_aborted_xact.bak` | 0.01s | 0.012s | 0.003s | 0.007s |
| `dirtycoverage_addcol.bak` | 0.005s | 0.011s | 0.003s | 0.005s |
| `dirtycoverage_addnotnull.bak` | 0.005s | 0.01s | 0.003s | 0.008s |
| `dirtycoverage_alldirty.bak` | 0.0s | 0.0s | 0.004s | 0.001s |
| `dirtycoverage_altercol.bak` | 0.021s | 0.007s | 0.003s | 0.004s |
| `dirtycoverage_altercol_rewrite.bak` | 0.019s | 0.015s | 0.005s | 0.006s |
| `dirtycoverage_alterdb.bak` | 0.004s | 0.008s | 0.01s | 0.006s |
| `dirtycoverage_cci_delete.bak` | 0.01s | 0.072s | 0.036s | 0.088s |
| `dirtycoverage_cci_update.bak` | 0.009s | 0.07s | 0.034s | 0.089s |
| `dirtycoverage_committed_delete.bak` | 0.016s | 0.009s | 0.007s | 0.005s |
| `dirtycoverage_committed_delete_v2.bak` | 0.005s | 0.014s | 0.016s | 0.013s |
| `dirtycoverage_committed_delete_v3.bak` | 0.006s | 0.032s | 0.024s | 0.034s |
| `dirtycoverage_committed_delete_v4.bak` | 0.01s | 0.05s | 0.038s | 0.067s |
| `dirtycoverage_committed_update.bak` | 0.007s | 0.009s | 0.003s | 0.008s |
| `dirtycoverage_committed_update_v2.bak` | 0.006s | 0.012s | 0.005s | 0.009s |
| `dirtycoverage_committed_update_v3.bak` | 0.006s | 0.043s | 0.03s | 0.047s |
| `dirtycoverage_committed_update_v4.bak` | 0.014s | 0.056s | 0.046s | 0.08s |
| `dirtycoverage_concurrent.bak` | 0.006s | 0.011s | 0.003s | 0.007s |
| `dirtycoverage_createidx.bak` | 0.005s | 0.011s | 0.007s | 0.008s |
| `dirtycoverage_createtable.bak` | 0.005s | 0.009s | 0.003s | 0.007s |
| `dirtycoverage_delete.bak` | 0.009s | 0.009s | 0.003s | 0.006s |
| `dirtycoverage_dropcol.bak` | 0.009s | 0.01s | 0.004s | 0.007s |
| `dirtycoverage_dropidx.bak` | 0.004s | 0.009s | 0.003s | 0.006s |
| `dirtycoverage_droptable.bak` | 0.01s | 0.017s | 0.004s | 0.015s |
| `dirtycoverage_heap_forward.bak` | 0.005s | 0.011s | 0.003s | 0.006s |
| `dirtycoverage_large_dirty.bak` | 0.005s | 0.007s | 0.003s | 0.007s |
| `dirtycoverage_lob_update.bak` | 0.005s | 0.008s | 0.003s | 0.006s |
| `dirtycoverage_maxrow.bak` | 0.022s | 0.009s | 0.003s | 0.009s |
| `dirtycoverage_nchar_delete.bak` | 0.004s | 0.01s | 0.003s | 0.007s |
| `dirtycoverage_nested.bak` | 0.005s | 0.01s | 0.003s | 0.006s |
| `dirtycoverage_null_update.bak` | 0.006s | 0.011s | 0.003s | 0.007s |
| `dirtycoverage_rebuildidx.bak` | 0.006s | 0.01s | 0.003s | 0.008s |
| `dirtycoverage_rich_insert.bak` | 0.005s | 0.016s | 0.003s | 0.008s |
| `dirtycoverage_rich_update.bak` | 0.007s | 0.009s | 0.003s | 0.007s |
| `dirtycoverage_savepoint.bak` | 0.006s | 0.01s | 0.003s | 0.006s |
| `dirtycoverage_snapshot_update.bak` | 0.009s | 0.018s | 0.005s | 0.007s |
| `dirtycoverage_switch.bak` | 0.008s | 0.015s | 0.004s | 0.013s |
| `dirtycoverage_temporal_update.bak` | 0.005s | 0.011s | 0.003s | 0.008s |
| `dirtycoverage_truncate.bak` | 0.024s | 0.01s | 0.007s | 0.01s |
| `dirtycoverage_two_tx.bak` | 0.005s | 0.012s | 0.003s | 0.01s |
| `dirtycoverage_uncommitted.bak` | 0.005s | 0.009s | 0.003s | 0.007s |
| `dirtycoverage_update.bak` | 0.007s | 0.009s | 0.003s | 0.006s |
| `featurecoverage_full.bak` | 0.034s | 0.09s | 0.02s | 0.064s |
| `filtered_ncci_full.bak` | 0.011s | 0.025s | 0.005s | 0.02s |
| `float_extreme_full.bak` | 0.004s | 0.011s | 0.012s | 0.008s |
| `forwarded_records_full.bak` | 0.013s | 0.035s | 0.019s | 0.039s |
| `ghost_records_full.bak` | 0.005s | 0.011s | 0.004s | 0.01s |
| `heapcoverage_large.bak` | 0.015s | 0.022s | 0.009s | 0.02s |
| `heapcoverage_large_50000.bak` | 0.02s | 0.302s | 0.256s | 0.451s |
| `hierarchyid_extract_full.bak` | 0.005s | 0.01s | 0.01s | 0.006s |
| `high_slot_density_full.bak` | 0.012s | 0.179s | 0.194s | 0.293s |
| `identity_coverage_full.bak` | 0.031s | 0.057s | 0.005s | 0.038s |
| `incrementalcoverage_diff_01.bak` | 0.005s | 0.01s | 0.003s | 0.005s |
| `incrementalcoverage_diff_02.bak` | 0.005s | 0.015s | 0.003s | 0.009s |
| `incrementalcoverage_diff_03.bak` | 0.006s | 0.009s | 0.003s | 0.005s |
| `incrementalcoverage_diff_04.bak` | 0.006s | 0.009s | 0.003s | 0.006s |
| `incrementalcoverage_diff_05.bak` | 0.006s | 0.014s | 0.01s | 0.008s |
| `incrementalcoverage_diff_06.bak` | 0.024s | 0.008s | 0.026s | 0.007s |
| `incrementalcoverage_full.bak` | 0.005s | 0.01s | 0.003s | 0.007s |
| `layoutcoverage_full.bak` | 0.177s | 0.601s | 0.03s | 0.454s |
| `max_row_width_full.bak` | 0.005s | 0.011s | 0.013s | 0.008s |
| `mixed_collation_full.bak` | 0.005s | 0.009s | 0.004s | 0.007s |
| `multi_rowgroup_full.bak` | 0.008s | 0.02s | 0.009s | 0.018s |
| `native_json_full.bak` | 0.008s | 0.017s | 0.003s | 0.011s |
| `ncci_heap_full.bak` | 0.012s | 0.015s | 0.004s | 0.011s |
| `ncci_types_full.bak` | 0.053s | 0.246s | 0.117s | 0.237s |
| `ndfcoverage_full.bak` | 0.017s | 0.016s | 0.004s | 0.013s |
| `nvarchar_max_u21_full.bak` | 0.038s | 0.008s | 0.023s | 0.005s |
| `ordered_cci_full.bak` | 0.022s | 0.029s | 0.011s | 0.026s |
| `pagecomp_anchor_full.bak` | 0.006s | 0.068s | 0.042s | 0.09s |
| `pagecomp_long_prefix_full.bak` | 0.004s | 0.01s | 0.003s | 0.006s |
| `pfor_columnstore_full.bak` | 0.04s | 0.956s | 1.683s | 1.973s |
| `pfor_columnstore_random_full.bak` | 0.041s | 0.956s | 1.711s | 2.041s |
| `realworld_numeric_digest_full.bak` | 0.015s | 0.083s | 0.025s | 0.081s |
| `rowboundary_full.bak` | 0.014s | 0.023s | 0.005s | 0.022s |
| `rowstore_hash_pii_full.bak` | 0.006s | 0.012s | 0.003s | 0.01s |
| `rowstore_lob_image_full.bak` | 0.005s | 0.01s | 0.003s | 0.009s |
| `rowstore_lob_markup_full.bak` | 0.005s | 0.008s | 0.002s | 0.007s |
| `rowversion_extract_full.bak` | 0.008s | 0.015s | 0.003s | 0.01s |
| `sparse_full.bak` | 0.007s | 0.065s | 0.036s | 0.083s |
| `spatial_edge_full.bak` | 0.009s | 0.018s | 0.003s | 0.012s |
| `spatial_index_full.bak` | 0.011s | 0.017s | 0.004s | 0.012s |
| `sql_variant_extract_full.bak` | 0.012s | 0.009s | 0.004s | 0.006s |
| `striped_full_1.bak` | 0.005s | 0.009s | 0.003s | 0.006s |
| `striped_single.bak` | 0.006s | 0.01s | 0.004s | 0.006s |
| `surrogate_pairs_full.bak` | 0.005s | 0.01s | 0.003s | 0.005s |
| `tabletype_cci_large_full.bak` | 0.007s | 0.042s | 0.02s | 0.081s |
| `tabletypecoverage_diff.bak` | 0.033s | 0.108s | 0.04s | 0.415s |
| `tabletypecoverage_full.bak` | 0.027s | 0.111s | 0.041s | 0.392s |
| `temporal_hidden_full.bak` | 0.016s | 0.031s | 0.004s | 0.025s |
| `torn_page_full.bak` | 0.005s | 0.013s | 0.004s | 0.008s |
| `typecoverage_full.bak` | 0.081s | 0.264s | 0.018s | 0.258s |
| `typed_xml_full.bak` | 0.016s | 0.009s | 0.006s | 0.007s |
| `unicode_codepage_coverage.bak` | 0.037s | 0.104s | 0.006s | 0.076s |
| `utf8_collation_full.bak` | 0.009s | 0.016s | 0.003s | 0.01s |
| `vector_full.bak` | 0.011s | 0.02s | 0.004s | 0.013s |
| `xml_index_full.bak` | 0.009s | 0.015s | 0.003s | 0.01s |
| `xmlcoverage_full.bak` | 0.008s | 0.009s | 0.003s | 0.006s |
| `xmlheap_full.bak` | 0.006s | 0.023s | 0.008s | 0.025s |
| `xtp_checkpoint_straddle_full.bak` | 0.018s | 0.141s | 0.385s | 0.373s |
| `xtp_probe_full.bak` | 0.016s | 0.068s | 0.004s | 0.026s |
| `xtp_rich_full.bak` | 0.016s | 0.047s | 0.003s | 0.01s |
| `xtp_simple_full.bak` | 0.012s | 0.052s | 0.004s | 0.01s |

_Write and read times are wall-clock estimates (coarse, not exact per-sink isolation)._

---

_Generated 2026-07-14 · 138 fixtures · 138 pass · 0 xfail · 0 fail_
