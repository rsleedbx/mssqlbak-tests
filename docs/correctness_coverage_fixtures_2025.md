...
|--------|---------|--------|-----------|
| `alias_types_full.bak` | 0.04s | 0.035s | 0.075s |
| `archive_columnstore_partition_full.bak` | 0.851s | 0.592s | 1.443s |
| `archive_columnstore_types_full.bak` | 0.305s | 0.663s | 0.968s |
| `archive_columnstore_types_random_full.bak` | 0.324s | 0.665s | 0.989s |
| `archive_single_chunk_full.bak` | 0.045s | 0.04s | 0.085s |
| `archive_single_chunk_random_full.bak` | 0.04s | 0.038s | 0.078s |
| `archivenull_full.bak` | 0.122s | 0.208s | 0.33s |
| `backup_blocksize_full.bak` | 0.041s | 0.042s | 0.083s |
| `boundarycoverage_datetime_full.bak` | 0.058s | 0.143s | 0.201s |
| `boundarycoverage_full.bak` | 0.074s | 0.082s | 0.156s |
| `cci_binary_varbinary_compare_full.bak` | 0.043s | 0.041s | 0.084s |
| `cci_bitpack_probe_bigint_full.bak` | 0.254s | 3.701s | 3.955s |
| `cci_bitpack_probe_full.bak` | 0.079s | 0.622s | 0.701s |
| `cci_bitpack_probe_highbase_full.bak` | 0.061s | 0.409s | 0.47s |
| `cci_btree_nci_full.bak` | 0.052s | 0.044s | 0.096s |
| `cci_computed_full.bak` | 0.04s | 0.04s | 0.08s |
| `cci_enc5_largepool_full.bak` | 0.32s | 0.42s | 0.74s |
| `cci_enc5_largepool_matrix_full.bak` | 6.883s | 1.266s | 8.149s |
| `cci_extended_full.bak` | 0.051s | 0.045s | 0.096s |
| `cci_lob_full.bak` | 0.047s | 0.05s | 0.097s |
| `cci_reorganize_full.bak` | 0.042s | 0.037s | 0.079s |
| `cci_string_dict_regression_full.bak` | 0.294s | 0.13s | 0.424s |
| `cci_string_minmax_full.bak` | 0.043s | 0.042s | 0.085s |
| `cci_switch_full.bak` | 0.047s | 0.037s | 0.084s |
| `cci_types_large_full.bak` | 0.061s | 0.055s | 0.116s |
| `cci_varbinary_micro_full.bak` | 0.037s | 0.036s | 0.073s |
| `cci_varbinary_probe_full.bak` | 0.059s | 0.049s | 0.108s |
| `columnstore_minimal.bak` | 0.119s | 0.967s | 1.086s |
| `compressed_nvarchar_full.bak` | 0.036s | 0.034s | 0.07s |
| `compressioncoverage_full.bak` | 0.074s | 0.18s | 0.254s |
| `computedcoverage_full.bak` | 0.034s | 0.042s | 0.076s |
| `constraintcoverage_full.bak` | 0.04s | 0.051s | 0.091s |
| `covering_index_full.bak` | 0.041s | 0.039s | 0.08s |
| `cs_lob_preamble.bak` | 0.088s | 0.064s | 0.152s |
| `delta_rowgroup_full.bak` | 0.042s | 0.041s | 0.083s |
| `dirtycoverage_aborted_xact.bak` | 0.062s | 0.038s | 0.1s |
| `dirtycoverage_addcol.bak` | 0.036s | 0.034s | 0.07s |
| `dirtycoverage_addnotnull.bak` | 0.042s | 0.045s | 0.087s |
| `dirtycoverage_alldirty.bak` | 0.067s | 0.045s | 0.112s |
| `dirtycoverage_altercol.bak` | 0.04s | 0.037s | 0.077s |
| `dirtycoverage_altercol_rewrite.bak` | 0.039s | 0.037s | 0.076s |
| `dirtycoverage_alterdb.bak` | 0.037s | 0.036s | 0.073s |
| `dirtycoverage_cci_delete.bak` | 0.067s | 0.105s | 0.172s |
| `dirtycoverage_cci_update.bak` | 0.092s | 0.089s | 0.181s |
| `dirtycoverage_committed_delete.bak` | 0.033s | 0.034s | 0.067s |
| `dirtycoverage_committed_delete_v2.bak` | 0.046s | 0.044s | 0.09s |
| `dirtycoverage_committed_delete_v3.bak` | 0.04s | 0.065s | 0.105s |
| `dirtycoverage_committed_delete_v4.bak` | 0.143s | 0.067s | 0.21s |
| `dirtycoverage_committed_update.bak` | 0.032s | 0.035s | 0.067s |
| `dirtycoverage_committed_update_v2.bak` | 0.051s | 0.038s | 0.089s |
| `dirtycoverage_committed_update_v3.bak` | 0.046s | 0.09s | 0.136s |
| `dirtycoverage_committed_update_v4.bak` | 0.054s | 0.083s | 0.137s |
| `dirtycoverage_concurrent.bak` | 0.037s | 0.044s | 0.081s |
| `dirtycoverage_createidx.bak` | 0.039s | 0.037s | 0.076s |
| `dirtycoverage_createtable.bak` | 0.046s | 0.045s | 0.091s |
| `dirtycoverage_delete.bak` | 0.067s | 0.05s | 0.117s |
| `dirtycoverage_dropcol.bak` | 0.035s | 0.036s | 0.071s |
| `dirtycoverage_dropidx.bak` | 0.042s | 0.045s | 0.087s |
| `dirtycoverage_droptable.bak` | 0.047s | 0.042s | 0.089s |
| `dirtycoverage_heap_forward.bak` | 0.059s | 0.038s | 0.097s |
| `dirtycoverage_large_dirty.bak` | 0.346s | 0.038s | 0.384s |
| `dirtycoverage_lob_update.bak` | 0.079s | 0.036s | 0.115s |
| `dirtycoverage_maxrow.bak` | 0.044s | 0.042s | 0.086s |
| `dirtycoverage_nchar_delete.bak` | 0.064s | 0.039s | 0.103s |
| `dirtycoverage_nested.bak` | 0.075s | 0.035s | 0.11s |
| `dirtycoverage_null_update.bak` | 0.067s | 0.034s | 0.101s |
| `dirtycoverage_rebuildidx.bak` | 0.037s | 0.04s | 0.077s |
| `dirtycoverage_rich_insert.bak` | 0.078s | 0.038s | 0.116s |
| `dirtycoverage_rich_update.bak` | 0.064s | 0.036s | 0.1s |
| `dirtycoverage_savepoint.bak` | 0.067s | 0.036s | 0.103s |
| `dirtycoverage_snapshot_update.bak` | 0.058s | 0.035s | 0.093s |
| `dirtycoverage_switch.bak` | 0.038s | 0.04s | 0.078s |
| `dirtycoverage_temporal_update.bak` | 0.068s | 0.035s | 0.103s |
| `dirtycoverage_truncate.bak` | 0.047s | 0.043s | 0.09s |
| `dirtycoverage_two_tx.bak` | 0.078s | 0.04s | 0.118s |
| `dirtycoverage_uncommitted.bak` | 0.068s | 0.038s | 0.106s |
| `dirtycoverage_update.bak` | 0.067s | 0.038s | 0.105s |
| `featurecoverage_full.bak` | 0.115s | 0.074s | 0.189s |
| `filtered_ncci_full.bak` | 0.042s | 0.038s | 0.08s |
| `float_extreme_full.bak` | 0.041s | 0.042s | 0.083s |
| `forwarded_records_full.bak` | 0.098s | 0.085s | 0.183s |
| `ghost_records_full.bak` | 0.033s | 0.038s | 0.071s |
| `heapcoverage_large.bak` | 0.039s | 0.042s | 0.081s |
| `heapcoverage_large_50000.bak` | 0.091s | 0.299s | 0.39s |
| `hierarchyid_extract_full.bak` | 0.036s | 0.035s | 0.071s |
| `high_slot_density_full.bak` | 0.043s | 0.185s | 0.228s |
| `identity_coverage_full.bak` | 0.048s | 0.044s | 0.092s |
| `incrementalcoverage_diff_01.bak` | 0.045s | 0.013s | 0.058s |
| `incrementalcoverage_diff_02.bak` | 0.045s | 0.013s | 0.058s |
| `incrementalcoverage_diff_03.bak` | 0.049s | 0.013s | 0.062s |
| `incrementalcoverage_diff_04.bak` | 0.049s | 0.012s | 0.061s |
| `incrementalcoverage_diff_05.bak` | 0.042s | 0.012s | 0.054s |
| `incrementalcoverage_diff_06.bak` | 0.041s | 0.014s | 0.055s |
| `incrementalcoverage_full.bak` | 0.033s | 0.034s | 0.067s |
| `layoutcoverage_full.bak` | 0.153s | 0.392s | 0.545s |
| `max_row_width_full.bak` | 0.041s | 0.04s | 0.081s |
| `mixed_collation_full.bak` | 0.038s | 0.046s | 0.084s |
| `multi_rowgroup_full.bak` | 0.045s | 0.05s | 0.095s |
| `native_json_full.bak` | 0.036s | 0.034s | 0.07s |
| `ncci_heap_full.bak` | 0.045s | 0.043s | 0.088s |
| `ncci_types_full.bak` | 0.059s | 0.181s | 0.24s |
| `ndfcoverage_full.bak` | 0.038s | 0.039s | 0.077s |
| `nvarchar_max_u21_full.bak` | 0.036s | 0.05s | 0.086s |
| `ordered_cci_full.bak` | 0.046s | 0.041s | 0.087s |
| `pagecomp_anchor_full.bak` | 0.13s | 0.09s | 0.22s |
| `pagecomp_long_prefix_full.bak` | 0.036s | 0.042s | 0.078s |
| `pfor_columnstore_full.bak` | 0.092s | 0.815s | 0.907s |
| `pfor_columnstore_random_full.bak` | 0.094s | 0.801s | 0.895s |
| `realworld_numeric_digest_full.bak` | 0.063s | 0.085s | 0.148s |
| `rowboundary_full.bak` | 0.047s | 0.041s | 0.088s |
| `rowstore_hash_pii_full.bak` | 0.044s | 0.041s | 0.085s |
| `rowstore_lob_image_full.bak` | 0.047s | 0.041s | 0.088s |
| `rowstore_lob_markup_full.bak` | 0.036s | 0.035s | 0.071s |
| `rowversion_extract_full.bak` | 0.041s | 0.042s | 0.083s |
| `sparse_full.bak` | 0.089s | 0.093s | 0.182s |
| `spatial_edge_full.bak` | 0.039s | 0.039s | 0.078s |
| `spatial_index_full.bak` | 0.038s | 0.038s | 0.076s |
| `sql_variant_extract_full.bak` | 0.042s | 0.042s | 0.084s |
| `striped_full_1.bak` | 0.05s | 0.013s | 0.063s |
| `striped_single.bak` | 0.048s | 0.049s | 0.097s |
| `surrogate_pairs_full.bak` | 0.032s | 0.036s | 0.068s |
| `tabletype_cci_large_full.bak` | 0.054s | 0.061s | 0.115s |
| `tabletypecoverage_diff.bak` | 0.107s | 0.076s | 0.183s |
| `tabletypecoverage_full.bak` | 0.078s | 0.101s | 0.179s |
| `temporal_hidden_full.bak` | 0.048s | 0.038s | 0.086s |
| `torn_page_full.bak` | 0.041s | 0.04s | 0.081s |
| `typecoverage_full.bak` | 0.068s | 0.079s | 0.147s |
| `typed_xml_full.bak` | 0.044s | 0.043s | 0.087s |
| `unicode_codepage_coverage.bak` | 0.063s | 0.048s | 0.111s |
| `utf8_collation_full.bak` | 0.04s | 0.041s | 0.081s |
| `vector_full.bak` | 0.036s | 0.041s | 0.077s |
| `xml_index_full.bak` | 0.046s | 0.043s | 0.089s |
| `xmlcoverage_full.bak` | 0.033s | 0.034s | 0.067s |
| `xmlheap_full.bak` | 0.052s | 0.053s | 0.105s |
| `xtp_checkpoint_straddle_full.bak` | 1.707s | 0.37s | 2.077s |
| `xtp_probe_full.bak` | 0.111s | 0.059s | 0.17s |
| `xtp_rich_full.bak` | 0.094s | 0.045s | 0.139s |
| `xtp_simple_full.bak` | 0.089s | 0.044s | 0.133s |
