...
| Backup | Wall time |
|--------|-------------|
| `alias_types_full.bak` | 0.09s |
| `archive_columnstore_partition_full.bak` | 2.53s |
| `archive_columnstore_types_full.bak` | 1.323s |
| `archive_columnstore_types_random_full.bak` | 1.33s |
| `archive_single_chunk_full.bak` | 0.1s |
| `archive_single_chunk_random_full.bak` | 0.086s |
| `archivenull_full.bak` | 0.427s |
| `backup_blocksize_full.bak` | 0.087s |
| `boundarycoverage_datetime_full.bak` | 0.366s |
| `boundarycoverage_full.bak` | 0.209s |
| `cci_binary_varbinary_compare_full.bak` | 0.082s |
| `cci_bitpack_probe_bigint_full.bak` | 8.047s |
| `cci_bitpack_probe_full.bak` | 1.744s |
| `cci_bitpack_probe_highbase_full.bak` | 1.245s |
| `cci_btree_nci_full.bak` | 0.1s |
| `cci_computed_full.bak` | 0.089s |
| `cci_enc5_largepool_full.bak` | 1.177s |
| `cci_enc5_largepool_matrix_full.bak` | 9.329s |
| `cci_extended_full.bak` | 0.118s |
| `cci_lob_full.bak` | 0.102s |
| `cci_reorganize_full.bak` | 0.089s |
| `cci_string_dict_regression_full.bak` | 0.499s |
| `cci_string_minmax_full.bak` | 0.09s |
| `cci_switch_full.bak` | 0.09s |
| `cci_types_large_full.bak` | 0.123s |
| `cci_varbinary_micro_full.bak` | 0.084s |
| `cci_varbinary_probe_full.bak` | 0.12s |
| `columnstore_minimal.bak` | 1.0s |
| `compressed_nvarchar_full.bak` | 0.088s |
| `compressioncoverage_full.bak` | 0.323s |
| `computedcoverage_full.bak` | 0.075s |
| `constraintcoverage_full.bak` | 0.08s |
| `covering_index_full.bak` | 0.091s |
| `cs_lob_preamble.bak` | 0.139s |
| `delta_rowgroup_full.bak` | 0.093s |
| `dirtycoverage_aborted_xact.bak` | 0.093s |
| `dirtycoverage_addcol.bak` | 0.084s |
| `dirtycoverage_addnotnull.bak` | 0.081s |
| `dirtycoverage_alldirty.bak` | 0.098s |
| `dirtycoverage_altercol.bak` | 0.083s |
| `dirtycoverage_altercol_rewrite.bak` | 0.084s |
| `dirtycoverage_alterdb.bak` | 0.072s |
| `dirtycoverage_cci_delete.bak` | 0.193s |
| `dirtycoverage_cci_update.bak` | 0.23s |
| `dirtycoverage_committed_delete.bak` | 0.079s |
| `dirtycoverage_committed_delete_v2.bak` | 0.094s |
| `dirtycoverage_committed_delete_v3.bak` | 0.129s |
| `dirtycoverage_committed_delete_v4.bak` | 0.331s |
| `dirtycoverage_committed_update.bak` | 0.068s |
| `dirtycoverage_committed_update_v2.bak` | 0.089s |
| `dirtycoverage_committed_update_v3.bak` | 0.162s |
| `dirtycoverage_committed_update_v4.bak` | 0.256s |
| `dirtycoverage_concurrent.bak` | 0.074s |
| `dirtycoverage_createidx.bak` | 0.103s |
| `dirtycoverage_createtable.bak` | 0.089s |
| `dirtycoverage_delete.bak` | 0.098s |
| `dirtycoverage_dropcol.bak` | 0.09s |
| `dirtycoverage_dropidx.bak` | 0.082s |
| `dirtycoverage_droptable.bak` | 0.098s |
| `dirtycoverage_heap_forward.bak` | 0.092s |
| `dirtycoverage_large_dirty.bak` | 0.388s |
| `dirtycoverage_lob_update.bak` | 0.114s |
| `dirtycoverage_maxrow.bak` | 0.069s |
| `dirtycoverage_nchar_delete.bak` | 0.096s |
| `dirtycoverage_nested.bak` | 0.099s |
| `dirtycoverage_null_update.bak` | 0.098s |
| `dirtycoverage_rebuildidx.bak` | 0.089s |
| `dirtycoverage_rich_insert.bak` | 0.114s |
| `dirtycoverage_rich_update.bak` | 0.096s |
| `dirtycoverage_savepoint.bak` | 0.103s |
| `dirtycoverage_snapshot_update.bak` | 0.089s |
| `dirtycoverage_switch.bak` | 0.078s |
| `dirtycoverage_temporal_update.bak` | 0.097s |
| `dirtycoverage_truncate.bak` | 0.085s |
| `dirtycoverage_two_tx.bak` | 0.106s |
| `dirtycoverage_uncommitted.bak` | 0.101s |
| `dirtycoverage_update.bak` | 0.101s |
| `featurecoverage_full.bak` | 0.176s |
| `filtered_ncci_full.bak` | 0.078s |
| `float_extreme_full.bak` | 0.078s |
| `forwarded_records_full.bak` | 0.164s |
| `ghost_records_full.bak` | 0.083s |
| `heapcoverage_large.bak` | 0.09s |
| `heapcoverage_large_50000.bak` | 0.965s |
| `hierarchyid_extract_full.bak` | 0.069s |
| `high_slot_density_full.bak` | 0.558s |
| `incrementalcoverage_diff_01.bak` | 0.049s |
| `incrementalcoverage_diff_02.bak` | 0.052s |
| `incrementalcoverage_diff_03.bak` | 0.051s |
| `incrementalcoverage_diff_04.bak` | 0.053s |
| `incrementalcoverage_diff_05.bak` | 0.056s |
| `incrementalcoverage_diff_06.bak` | 0.054s |
| `incrementalcoverage_full.bak` | 0.065s |
| `layoutcoverage_full.bak` | 0.36s |
| `max_row_width_full.bak` | 0.074s |
| `mixed_collation_full.bak` | 0.089s |
| `multi_rowgroup_full.bak` | 0.086s |
| `native_json_full.bak` | 0.086s |
| `ncci_heap_full.bak` | 0.075s |
| `ncci_types_full.bak` | 0.436s |
| `ndfcoverage_full.bak` | 0.08s |
| `nvarchar_max_u21_full.bak` | 0.071s |
| `ordered_cci_full.bak` | 0.093s |
| `pagecomp_anchor_full.bak` | 0.364s |
| `pagecomp_long_prefix_full.bak` | 0.08s |
| `pfor_columnstore_full.bak` | 2.432s |
| `pfor_columnstore_random_full.bak` | 2.421s |
| `realworld_numeric_digest_full.bak` | 0.195s |
| `rowboundary_full.bak` | 0.092s |
| `rowstore_hash_pii_full.bak` | 0.075s |
| `rowstore_lob_image_full.bak` | 0.079s |
| `rowstore_lob_markup_full.bak` | 0.079s |
| `rowversion_extract_full.bak` | 0.076s |
| `sparse_full.bak` | 0.285s |
| `spatial_edge_full.bak` | 0.072s |
| `spatial_index_full.bak` | 0.092s |
| `sql_variant_extract_full.bak` | 0.073s |
| `striped_full_1.bak` | 0.065s |
| `striped_single.bak` | 0.101s |
| `surrogate_pairs_full.bak` | 0.064s |
| `tabletype_cci_large_full.bak` | 0.112s |
| `tabletypecoverage_diff.bak` | 0.164s |
| `tabletypecoverage_full.bak` | 0.159s |
| `temporal_hidden_full.bak` | 0.077s |
| `torn_page_full.bak` | 0.081s |
| `typecoverage_full.bak` | 0.127s |
| `typed_xml_full.bak` | 0.079s |
| `unicode_codepage_coverage.bak` | 0.1s |
| `utf8_collation_full.bak` | 0.068s |
| `vector_full.bak` | 0.085s |
| `xml_index_full.bak` | 0.08s |
| `xmlcoverage_full.bak` | 0.078s |
| `xmlheap_full.bak` | 0.111s |
| `xtp_checkpoint_straddle_full.bak` | 3.174s |
| `xtp_probe_full.bak` | 0.138s |
| `xtp_rich_full.bak` | 0.125s |
| `xtp_simple_full.bak` | 0.122s |

---

_Generated 2026-07-06 · 137 fixtures · 137 pass · 0 xfail · 0 fail_
