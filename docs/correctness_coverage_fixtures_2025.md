...
| Backup | Wall time |
|--------|-------------|
| `alias_types_full.bak` | 0.079s |
| `archive_columnstore_partition_full.bak` | 2.394s |
| `archive_columnstore_types_full.bak` | 1.317s |
| `archive_columnstore_types_random_full.bak` | 1.335s |
| `archive_single_chunk_full.bak` | 0.094s |
| `archive_single_chunk_random_full.bak` | 0.088s |
| `archivenull_full.bak` | 0.451s |
| `backup_blocksize_full.bak` | 0.077s |
| `boundarycoverage_datetime_full.bak` | 0.465s |
| `boundarycoverage_full.bak` | 0.229s |
| `cci_binary_varbinary_compare_full.bak` | 0.082s |
| `cci_bitpack_probe_bigint_full.bak` | 8.462s |
| `cci_bitpack_probe_full.bak` | 1.805s |
| `cci_bitpack_probe_highbase_full.bak` | 1.321s |
| `cci_btree_nci_full.bak` | 0.109s |
| `cci_computed_full.bak` | 0.089s |
| `cci_enc5_largepool_full.bak` | 1.186s |
| `cci_enc5_largepool_matrix_full.bak` | 9.352s |
| `cci_extended_full.bak` | 0.121s |
| `cci_lob_full.bak` | 0.105s |
| `cci_reorganize_full.bak` | 0.089s |
| `cci_string_dict_regression_full.bak` | 0.497s |
| `cci_string_minmax_full.bak` | 0.1s |
| `cci_switch_full.bak` | 0.103s |
| `cci_types_large_full.bak` | 0.13s |
| `cci_varbinary_micro_full.bak` | 0.086s |
| `cci_varbinary_probe_full.bak` | 0.118s |
| `columnstore_minimal.bak` | 1.07s |
| `compressed_nvarchar_full.bak` | 0.074s |
| `compressioncoverage_full.bak` | 0.352s |
| `computedcoverage_full.bak` | 0.069s |
| `constraintcoverage_full.bak` | 0.082s |
| `covering_index_full.bak` | 0.107s |
| `cs_lob_preamble.bak` | 0.141s |
| `delta_rowgroup_full.bak` | 0.087s |
| `dirtycoverage_aborted_xact.bak` | 0.103s |
| `dirtycoverage_addcol.bak` | 0.071s |
| `dirtycoverage_addnotnull.bak` | 0.073s |
| `dirtycoverage_alldirty.bak` | 0.103s |
| `dirtycoverage_altercol.bak` | 0.072s |
| `dirtycoverage_altercol_rewrite.bak` | 0.071s |
| `dirtycoverage_alterdb.bak` | 0.08s |
| `dirtycoverage_cci_delete.bak` | 0.2s |
| `dirtycoverage_cci_update.bak` | 0.272s |
| `dirtycoverage_committed_delete.bak` | 0.069s |
| `dirtycoverage_committed_delete_v2.bak` | 0.082s |
| `dirtycoverage_committed_delete_v3.bak` | 0.139s |
| `dirtycoverage_committed_delete_v4.bak` | 0.367s |
| `dirtycoverage_committed_update.bak` | 0.069s |
| `dirtycoverage_committed_update_v2.bak` | 0.094s |
| `dirtycoverage_committed_update_v3.bak` | 0.178s |
| `dirtycoverage_committed_update_v4.bak` | 0.308s |
| `dirtycoverage_concurrent.bak` | 0.075s |
| `dirtycoverage_createidx.bak` | 0.078s |
| `dirtycoverage_createtable.bak` | 0.074s |
| `dirtycoverage_delete.bak` | 0.102s |
| `dirtycoverage_dropcol.bak` | 0.075s |
| `dirtycoverage_dropidx.bak` | 0.076s |
| `dirtycoverage_droptable.bak` | 0.082s |
| `dirtycoverage_heap_forward.bak` | 0.102s |
| `dirtycoverage_large_dirty.bak` | 0.394s |
| `dirtycoverage_lob_update.bak` | 0.115s |
| `dirtycoverage_maxrow.bak` | 0.073s |
| `dirtycoverage_nchar_delete.bak` | 0.101s |
| `dirtycoverage_nested.bak` | 0.102s |
| `dirtycoverage_null_update.bak` | 0.099s |
| `dirtycoverage_rebuildidx.bak` | 0.073s |
| `dirtycoverage_rich_insert.bak` | 0.116s |
| `dirtycoverage_rich_update.bak` | 0.104s |
| `dirtycoverage_savepoint.bak` | 0.104s |
| `dirtycoverage_snapshot_update.bak` | 0.092s |
| `dirtycoverage_switch.bak` | 0.076s |
| `dirtycoverage_temporal_update.bak` | 0.101s |
| `dirtycoverage_truncate.bak` | 0.082s |
| `dirtycoverage_two_tx.bak` | 0.109s |
| `dirtycoverage_uncommitted.bak` | 0.106s |
| `dirtycoverage_update.bak` | 0.102s |
| `featurecoverage_full.bak` | 0.18s |
| `filtered_ncci_full.bak` | 0.08s |
| `float_extreme_full.bak` | 0.071s |
| `forwarded_records_full.bak` | 0.183s |
| `ghost_records_full.bak` | 0.071s |
| `heapcoverage_large.bak` | 0.094s |
| `heapcoverage_large_50000.bak` | 0.966s |
| `hierarchyid_extract_full.bak` | 0.075s |
| `high_slot_density_full.bak` | 0.558s |
| `incrementalcoverage_diff_01.bak` | 0.062s |
| `incrementalcoverage_diff_02.bak` | 0.052s |
| `incrementalcoverage_diff_03.bak` | 0.051s |
| `incrementalcoverage_diff_04.bak` | 0.052s |
| `incrementalcoverage_diff_05.bak` | 0.057s |
| `incrementalcoverage_diff_06.bak` | 0.055s |
| `incrementalcoverage_full.bak` | 0.067s |
| `layoutcoverage_full.bak` | 0.393s |
| `max_row_width_full.bak` | 0.068s |
| `mixed_collation_full.bak` | 0.068s |
| `multi_rowgroup_full.bak` | 0.089s |
| `native_json_full.bak` | 0.07s |
| `ncci_heap_full.bak` | 0.079s |
| `ncci_types_full.bak` | 0.491s |
| `ndfcoverage_full.bak` | 0.076s |
| `nvarchar_max_u21_full.bak` | 0.073s |
| `ordered_cci_full.bak` | 0.096s |
| `pagecomp_anchor_full.bak` | 0.396s |
| `pagecomp_long_prefix_full.bak` | 0.08s |
| `pfor_columnstore_full.bak` | 2.25s |
| `pfor_columnstore_random_full.bak` | 2.255s |
| `realworld_numeric_digest_full.bak` | 0.21s |
| `rowboundary_full.bak` | 0.078s |
| `rowstore_hash_pii_full.bak` | 0.07s |
| `rowstore_lob_image_full.bak` | 0.071s |
| `rowstore_lob_markup_full.bak` | 0.07s |
| `rowversion_extract_full.bak` | 0.073s |
| `sparse_full.bak` | 0.324s |
| `spatial_edge_full.bak` | 0.076s |
| `spatial_index_full.bak` | 0.09s |
| `sql_variant_extract_full.bak` | 0.071s |
| `striped_full_1.bak` | 0.063s |
| `striped_single.bak` | 0.105s |
| `surrogate_pairs_full.bak` | 0.065s |
| `tabletype_cci_large_full.bak` | 0.105s |
| `tabletypecoverage_diff.bak` | 0.185s |
| `tabletypecoverage_full.bak` | 0.176s |
| `temporal_hidden_full.bak` | 0.073s |
| `torn_page_full.bak` | 0.078s |
| `typecoverage_full.bak` | 0.121s |
| `typed_xml_full.bak` | 0.07s |
| `unicode_codepage_coverage.bak` | 0.103s |
| `utf8_collation_full.bak` | 0.068s |
| `vector_full.bak` | 0.072s |
| `xml_index_full.bak` | 0.075s |
| `xmlcoverage_full.bak` | 0.067s |
| `xmlheap_full.bak` | 0.123s |
| `xtp_checkpoint_straddle_full.bak` | 3.228s |
| `xtp_probe_full.bak` | 0.149s |
| `xtp_rich_full.bak` | 0.131s |
| `xtp_simple_full.bak` | 0.13s |

---

_Generated 2026-07-08 · 137 fixtures · 137 pass · 0 xfail · 0 fail_
