...
|--------|---------|--------|-----------|
| `alias_types_full.bak` | 0.039s | 0.03s | 0.069s |
| `archive_columnstore_partition_full.bak` | 0.884s | 0.599s | 1.483s |
| `archive_columnstore_types_full.bak` | 0.331s | 0.699s | 1.03s |
| `archive_columnstore_types_random_full.bak` | 0.325s | 0.689s | 1.014s |
| `archive_single_chunk_full.bak` | 0.046s | 0.037s | 0.083s |
| `archive_single_chunk_random_full.bak` | 0.041s | 0.042s | 0.083s |
| `archivenull_full.bak` | 0.123s | 0.205s | 0.328s |
| `backup_blocksize_full.bak` | 0.042s | 0.034s | 0.076s |
| `boundarycoverage_datetime_full.bak` | 0.062s | 0.146s | 0.208s |
| `boundarycoverage_full.bak` | 0.049s | 0.056s | 0.105s |
| `cci_binary_varbinary_compare_full.bak` | 0.045s | 0.032s | 0.077s |
| `cci_bitpack_probe_bigint_full.bak` | 0.268s | 3.784s | 4.052s |
| `cci_bitpack_probe_full.bak` | 0.075s | 0.641s | 0.716s |
| `cci_bitpack_probe_highbase_full.bak` | 0.084s | 0.444s | 0.528s |
| `cci_btree_nci_full.bak` | 0.053s | 0.034s | 0.087s |
| `cci_computed_full.bak` | 0.04s | 0.032s | 0.072s |
| `cci_enc5_largepool_full.bak` | 0.317s | 0.431s | 0.748s |
| `cci_enc5_largepool_matrix_full.bak` | 7.074s | 1.25s | 8.324s |
| `cci_extended_full.bak` | 0.05s | 0.036s | 0.086s |
| `cci_lob_full.bak` | 0.052s | 0.034s | 0.086s |
| `cci_reorganize_full.bak` | 0.039s | 0.036s | 0.075s |
| `cci_string_dict_regression_full.bak` | 0.302s | 0.137s | 0.439s |
| `cci_string_minmax_full.bak` | 0.043s | 0.032s | 0.075s |
| `cci_switch_full.bak` | 0.039s | 0.032s | 0.071s |
| `cci_types_large_full.bak` | 0.053s | 0.042s | 0.095s |
| `cci_varbinary_micro_full.bak` | 0.043s | 0.03s | 0.073s |
| `cci_varbinary_probe_full.bak` | 0.059s | 0.042s | 0.101s |
| `columnstore_minimal.bak` | 0.117s | 0.956s | 1.073s |
| `compressed_nvarchar_full.bak` | 0.041s | 0.03s | 0.071s |
| `compressioncoverage_full.bak` | 0.084s | 0.175s | 0.259s |
| `computedcoverage_full.bak` | 0.038s | 0.04s | 0.078s |
| `constraintcoverage_full.bak` | 0.046s | 0.036s | 0.082s |
| `covering_index_full.bak` | 0.047s | 0.039s | 0.086s |
| `cs_lob_preamble.bak` | 0.068s | 0.058s | 0.126s |
| `delta_rowgroup_full.bak` | 0.039s | 0.034s | 0.073s |
| `dirtycoverage_aborted_xact.bak` | 0.06s | 0.029s | 0.089s |
| `dirtycoverage_addcol.bak` | 0.037s | 0.033s | 0.07s |
| `dirtycoverage_addnotnull.bak` | 0.037s | 0.035s | 0.072s |
| `dirtycoverage_alldirty.bak` | 0.067s | 0.032s | 0.099s |
| `dirtycoverage_altercol.bak` | 0.036s | 0.034s | 0.07s |
| `dirtycoverage_altercol_rewrite.bak` | 0.046s | 0.03s | 0.076s |
| `dirtycoverage_alterdb.bak` | 0.041s | 0.034s | 0.075s |
| `dirtycoverage_cci_delete.bak` | 0.064s | 0.086s | 0.15s |
| `dirtycoverage_cci_update.bak` | 0.093s | 0.086s | 0.179s |
| `dirtycoverage_committed_delete.bak` | 0.038s | 0.034s | 0.072s |
| `dirtycoverage_committed_delete_v2.bak` | 0.044s | 0.034s | 0.078s |
| `dirtycoverage_committed_delete_v3.bak` | 0.042s | 0.054s | 0.096s |
| `dirtycoverage_committed_delete_v4.bak` | 0.15s | 0.061s | 0.211s |
| `dirtycoverage_committed_update.bak` | 0.034s | 0.029s | 0.063s |
| `dirtycoverage_committed_update_v2.bak` | 0.043s | 0.031s | 0.074s |
| `dirtycoverage_committed_update_v3.bak` | 0.046s | 0.068s | 0.114s |
| `dirtycoverage_committed_update_v4.bak` | 0.045s | 0.067s | 0.112s |
| `dirtycoverage_concurrent.bak` | 0.042s | 0.036s | 0.078s |
| `dirtycoverage_createidx.bak` | 0.039s | 0.03s | 0.069s |
| `dirtycoverage_createtable.bak` | 0.04s | 0.029s | 0.069s |
| `dirtycoverage_delete.bak` | 0.071s | 0.029s | 0.1s |
| `dirtycoverage_dropcol.bak` | 0.045s | 0.033s | 0.078s |
| `dirtycoverage_dropidx.bak` | 0.043s | 0.031s | 0.074s |
| `dirtycoverage_droptable.bak` | 0.038s | 0.035s | 0.073s |
| `dirtycoverage_heap_forward.bak` | 0.059s | 0.029s | 0.088s |
| `dirtycoverage_large_dirty.bak` | 0.333s | 0.035s | 0.368s |
| `dirtycoverage_lob_update.bak` | 0.079s | 0.03s | 0.109s |
| `dirtycoverage_maxrow.bak` | 0.044s | 0.029s | 0.073s |
| `dirtycoverage_nchar_delete.bak` | 0.063s | 0.034s | 0.097s |
| `dirtycoverage_nested.bak` | 0.067s | 0.03s | 0.097s |
| `dirtycoverage_null_update.bak` | 0.073s | 0.029s | 0.102s |
| `dirtycoverage_rebuildidx.bak` | 0.045s | 0.036s | 0.081s |
| `dirtycoverage_rich_insert.bak` | 0.085s | 0.038s | 0.123s |
| `dirtycoverage_rich_update.bak` | 0.065s | 0.031s | 0.096s |
| `dirtycoverage_savepoint.bak` | 0.069s | 0.03s | 0.099s |
| `dirtycoverage_snapshot_update.bak` | 0.061s | 0.032s | 0.093s |
| `dirtycoverage_switch.bak` | 0.043s | 0.031s | 0.074s |
| `dirtycoverage_temporal_update.bak` | 0.066s | 0.03s | 0.096s |
| `dirtycoverage_truncate.bak` | 0.042s | 0.034s | 0.076s |
| `dirtycoverage_two_tx.bak` | 0.073s | 0.029s | 0.102s |
| `dirtycoverage_uncommitted.bak` | 0.072s | 0.029s | 0.101s |
| `dirtycoverage_update.bak` | 0.075s | 0.036s | 0.111s |
| `featurecoverage_full.bak` | 0.115s | 0.044s | 0.159s |
| `filtered_ncci_full.bak` | 0.041s | 0.032s | 0.073s |
| `float_extreme_full.bak` | 0.046s | 0.034s | 0.08s |
| `forwarded_records_full.bak` | 0.073s | 0.052s | 0.125s |
| `ghost_records_full.bak` | 0.042s | 0.037s | 0.079s |
| `heapcoverage_large.bak` | 0.038s | 0.036s | 0.074s |
| `heapcoverage_large_50000.bak` | 0.092s | 0.313s | 0.405s |
| `hierarchyid_extract_full.bak` | 0.048s | 0.034s | 0.082s |
| `high_slot_density_full.bak` | 0.044s | 0.185s | 0.229s |
| `identity_coverage_full.bak` | 0.048s | 0.037s | 0.085s |
| `incrementalcoverage_diff_01.bak` | 0.039s | 0.01s | 0.049s |
| `incrementalcoverage_diff_02.bak` | 0.042s | 0.01s | 0.052s |
| `incrementalcoverage_diff_03.bak` | 0.041s | 0.009s | 0.05s |
| `incrementalcoverage_diff_04.bak` | 0.046s | 0.009s | 0.055s |
| `incrementalcoverage_diff_05.bak` | 0.045s | 0.011s | 0.056s |
| `incrementalcoverage_diff_06.bak` | 0.045s | 0.01s | 0.055s |
| `incrementalcoverage_full.bak` | 0.038s | 0.029s | 0.067s |
| `layoutcoverage_full.bak` | 0.146s | 0.437s | 0.583s |
| `max_row_width_full.bak` | 0.032s | 0.03s | 0.062s |
| `mixed_collation_full.bak` | 0.035s | 0.03s | 0.065s |
| `multi_rowgroup_full.bak` | 0.043s | 0.034s | 0.077s |
| `native_json_full.bak` | 0.042s | 0.034s | 0.076s |
| `ncci_heap_full.bak` | 0.037s | 0.031s | 0.068s |
| `ncci_types_full.bak` | 0.062s | 0.168s | 0.23s |
| `ndfcoverage_full.bak` | 0.046s | 0.043s | 0.089s |
| `nvarchar_max_u21_full.bak` | 0.05s | 0.034s | 0.084s |
| `ordered_cci_full.bak` | 0.052s | 0.037s | 0.089s |
| `pagecomp_anchor_full.bak` | 0.13s | 0.094s | 0.224s |
| `pagecomp_long_prefix_full.bak` | 0.036s | 0.032s | 0.068s |
| `pfor_columnstore_full.bak` | 0.163s | 0.86s | 1.023s |
| `pfor_columnstore_random_full.bak` | 0.1s | 0.956s | 1.056s |
| `realworld_numeric_digest_full.bak` | 0.049s | 0.079s | 0.128s |
| `rowboundary_full.bak` | 0.057s | 0.032s | 0.089s |
| `rowstore_hash_pii_full.bak` | 0.046s | 0.032s | 0.078s |
| `rowstore_lob_image_full.bak` | 0.046s | 0.035s | 0.081s |
| `rowstore_lob_markup_full.bak` | 0.036s | 0.03s | 0.066s |
| `rowversion_extract_full.bak` | 0.045s | 0.033s | 0.078s |
| `sparse_full.bak` | 0.091s | 0.084s | 0.175s |
| `spatial_edge_full.bak` | 0.044s | 0.034s | 0.078s |
| `spatial_index_full.bak` | 0.04s | 0.032s | 0.072s |
| `sql_variant_extract_full.bak` | 0.037s | 0.029s | 0.066s |
| `striped_full_1.bak` | 0.05s | 0.014s | 0.064s |
| `striped_single.bak` | 0.049s | 0.048s | 0.097s |
| `surrogate_pairs_full.bak` | 0.046s | 0.03s | 0.076s |
| `tabletype_cci_large_full.bak` | 0.055s | 0.043s | 0.098s |
| `tabletypecoverage_diff.bak` | 0.096s | 0.059s | 0.155s |
| `tabletypecoverage_full.bak` | 0.076s | 0.083s | 0.159s |
| `temporal_hidden_full.bak` | 0.038s | 0.032s | 0.07s |
| `torn_page_full.bak` | 0.04s | 0.034s | 0.074s |
| `typecoverage_full.bak` | 0.066s | 0.054s | 0.12s |
| `typed_xml_full.bak` | 0.039s | 0.033s | 0.072s |
| `unicode_codepage_coverage.bak` | 0.057s | 0.039s | 0.096s |
| `utf8_collation_full.bak` | 0.045s | 0.03s | 0.075s |
| `vector_full.bak` | 0.058s | 0.03s | 0.088s |
| `xml_index_full.bak` | 0.038s | 0.031s | 0.069s |
| `xmlcoverage_full.bak` | 0.034s | 0.029s | 0.063s |
| `xmlheap_full.bak` | 0.055s | 0.055s | 0.11s |
| `xtp_checkpoint_straddle_full.bak` | 1.753s | 0.362s | 2.115s |
| `xtp_probe_full.bak` | 0.107s | 0.029s | 0.136s |
| `xtp_rich_full.bak` | 0.092s | 0.029s | 0.121s |
| `xtp_simple_full.bak` | 0.089s | 0.029s | 0.118s |
