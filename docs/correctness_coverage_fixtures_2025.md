...
|--------|---------|--------|-----------|
| `alias_types_full.bak` | 0.035s | 0.03s | 0.065s |
| `archive_columnstore_partition_full.bak` | 0.877s | 0.602s | 1.479s |
| `archive_columnstore_types_full.bak` | 0.337s | 0.664s | 1.001s |
| `archive_columnstore_types_random_full.bak` | 0.312s | 0.668s | 0.98s |
| `archive_single_chunk_full.bak` | 0.041s | 0.032s | 0.073s |
| `archive_single_chunk_random_full.bak` | 0.044s | 0.032s | 0.076s |
| `archivenull_full.bak` | 0.118s | 0.203s | 0.321s |
| `backup_blocksize_full.bak` | 0.036s | 0.03s | 0.066s |
| `boundarycoverage_datetime_full.bak` | 0.054s | 0.144s | 0.198s |
| `boundarycoverage_full.bak` | 0.049s | 0.056s | 0.105s |
| `cci_binary_varbinary_compare_full.bak` | 0.041s | 0.031s | 0.072s |
| `cci_bitpack_probe_bigint_full.bak` | 0.26s | 3.632s | 3.892s |
| `cci_bitpack_probe_full.bak` | 0.073s | 0.62s | 0.693s |
| `cci_bitpack_probe_highbase_full.bak` | 0.062s | 0.408s | 0.47s |
| `cci_btree_nci_full.bak` | 0.058s | 0.034s | 0.092s |
| `cci_computed_full.bak` | 0.037s | 0.034s | 0.071s |
| `cci_enc5_largepool_full.bak` | 0.309s | 0.42s | 0.729s |
| `cci_enc5_largepool_matrix_full.bak` | 6.932s | 1.199s | 8.131s |
| `cci_extended_full.bak` | 0.049s | 0.035s | 0.084s |
| `cci_lob_full.bak` | 0.046s | 0.033s | 0.079s |
| `cci_reorganize_full.bak` | 0.039s | 0.032s | 0.071s |
| `cci_string_dict_regression_full.bak` | 0.284s | 0.127s | 0.411s |
| `cci_string_minmax_full.bak` | 0.047s | 0.042s | 0.089s |
| `cci_switch_full.bak` | 0.039s | 0.032s | 0.071s |
| `cci_types_large_full.bak` | 0.053s | 0.042s | 0.095s |
| `cci_varbinary_micro_full.bak` | 0.037s | 0.03s | 0.067s |
| `cci_varbinary_probe_full.bak` | 0.054s | 0.04s | 0.094s |
| `columnstore_minimal.bak` | 0.109s | 0.946s | 1.055s |
| `compressed_nvarchar_full.bak` | 0.035s | 0.029s | 0.064s |
| `compressioncoverage_full.bak` | 0.08s | 0.178s | 0.258s |
| `computedcoverage_full.bak` | 0.034s | 0.033s | 0.067s |
| `constraintcoverage_full.bak` | 0.042s | 0.035s | 0.077s |
| `covering_index_full.bak` | 0.038s | 0.034s | 0.072s |
| `cs_lob_preamble.bak` | 0.066s | 0.061s | 0.127s |
| `delta_rowgroup_full.bak` | 0.038s | 0.03s | 0.068s |
| `dirtycoverage_aborted_xact.bak` | 0.059s | 0.029s | 0.088s |
| `dirtycoverage_addcol.bak` | 0.036s | 0.029s | 0.065s |
| `dirtycoverage_addnotnull.bak` | 0.037s | 0.03s | 0.067s |
| `dirtycoverage_alldirty.bak` | 0.069s | 0.028s | 0.097s |
| `dirtycoverage_altercol.bak` | 0.036s | 0.028s | 0.064s |
| `dirtycoverage_altercol_rewrite.bak` | 0.036s | 0.029s | 0.065s |
| `dirtycoverage_alterdb.bak` | 0.049s | 0.029s | 0.078s |
| `dirtycoverage_cci_delete.bak` | 0.07s | 0.086s | 0.156s |
| `dirtycoverage_cci_update.bak` | 0.098s | 0.09s | 0.188s |
| `dirtycoverage_committed_delete.bak` | 0.033s | 0.033s | 0.066s |
| `dirtycoverage_committed_delete_v2.bak` | 0.035s | 0.03s | 0.065s |
| `dirtycoverage_committed_delete_v3.bak` | 0.04s | 0.054s | 0.094s |
| `dirtycoverage_committed_delete_v4.bak` | 0.146s | 0.061s | 0.207s |
| `dirtycoverage_committed_update.bak` | 0.032s | 0.03s | 0.062s |
| `dirtycoverage_committed_update_v2.bak` | 0.043s | 0.031s | 0.074s |
| `dirtycoverage_committed_update_v3.bak` | 0.046s | 0.063s | 0.109s |
| `dirtycoverage_committed_update_v4.bak` | 0.048s | 0.073s | 0.121s |
| `dirtycoverage_concurrent.bak` | 0.037s | 0.029s | 0.066s |
| `dirtycoverage_createidx.bak` | 0.039s | 0.03s | 0.069s |
| `dirtycoverage_createtable.bak` | 0.036s | 0.029s | 0.065s |
| `dirtycoverage_delete.bak` | 0.069s | 0.029s | 0.098s |
| `dirtycoverage_dropcol.bak` | 0.036s | 0.029s | 0.065s |
| `dirtycoverage_dropidx.bak` | 0.04s | 0.029s | 0.069s |
| `dirtycoverage_droptable.bak` | 0.038s | 0.031s | 0.069s |
| `dirtycoverage_heap_forward.bak` | 0.059s | 0.029s | 0.088s |
| `dirtycoverage_large_dirty.bak` | 0.334s | 0.035s | 0.369s |
| `dirtycoverage_lob_update.bak` | 0.085s | 0.029s | 0.114s |
| `dirtycoverage_maxrow.bak` | 0.035s | 0.03s | 0.065s |
| `dirtycoverage_nchar_delete.bak` | 0.067s | 0.028s | 0.095s |
| `dirtycoverage_nested.bak` | 0.066s | 0.029s | 0.095s |
| `dirtycoverage_null_update.bak` | 0.066s | 0.029s | 0.095s |
| `dirtycoverage_rebuildidx.bak` | 0.037s | 0.029s | 0.066s |
| `dirtycoverage_rich_insert.bak` | 0.083s | 0.031s | 0.114s |
| `dirtycoverage_rich_update.bak` | 0.062s | 0.03s | 0.092s |
| `dirtycoverage_savepoint.bak` | 0.067s | 0.028s | 0.095s |
| `dirtycoverage_snapshot_update.bak` | 0.058s | 0.029s | 0.087s |
| `dirtycoverage_switch.bak` | 0.038s | 0.03s | 0.068s |
| `dirtycoverage_temporal_update.bak` | 0.065s | 0.029s | 0.094s |
| `dirtycoverage_truncate.bak` | 0.037s | 0.029s | 0.066s |
| `dirtycoverage_two_tx.bak` | 0.082s | 0.029s | 0.111s |
| `dirtycoverage_uncommitted.bak` | 0.067s | 0.03s | 0.097s |
| `dirtycoverage_update.bak` | 0.074s | 0.029s | 0.103s |
| `featurecoverage_full.bak` | 0.103s | 0.043s | 0.146s |
| `filtered_ncci_full.bak` | 0.037s | 0.032s | 0.069s |
| `float_extreme_full.bak` | 0.036s | 0.029s | 0.065s |
| `forwarded_records_full.bak` | 0.072s | 0.048s | 0.12s |
| `ghost_records_full.bak` | 0.037s | 0.031s | 0.068s |
| `heapcoverage_large.bak` | 0.037s | 0.036s | 0.073s |
| `heapcoverage_large_50000.bak` | 0.09s | 0.301s | 0.391s |
| `hierarchyid_extract_full.bak` | 0.036s | 0.03s | 0.066s |
| `high_slot_density_full.bak` | 0.043s | 0.178s | 0.221s |
| `identity_coverage_full.bak` | 0.04s | 0.033s | 0.073s |
| `incrementalcoverage_diff_01.bak` | 0.041s | 0.01s | 0.051s |
| `incrementalcoverage_diff_02.bak` | 0.04s | 0.01s | 0.05s |
| `incrementalcoverage_diff_03.bak` | 0.04s | 0.01s | 0.05s |
| `incrementalcoverage_diff_04.bak` | 0.04s | 0.01s | 0.05s |
| `incrementalcoverage_diff_05.bak` | 0.04s | 0.01s | 0.05s |
| `incrementalcoverage_diff_06.bak` | 0.044s | 0.01s | 0.054s |
| `incrementalcoverage_full.bak` | 0.033s | 0.029s | 0.062s |
| `layoutcoverage_full.bak` | 0.14s | 0.327s | 0.467s |
| `max_row_width_full.bak` | 0.032s | 0.029s | 0.061s |
| `mixed_collation_full.bak` | 0.033s | 0.029s | 0.062s |
| `multi_rowgroup_full.bak` | 0.038s | 0.033s | 0.071s |
| `native_json_full.bak` | 0.036s | 0.03s | 0.066s |
| `ncci_heap_full.bak` | 0.037s | 0.03s | 0.067s |
| `ncci_types_full.bak` | 0.065s | 0.165s | 0.23s |
| `ndfcoverage_full.bak` | 0.038s | 0.031s | 0.069s |
| `nvarchar_max_u21_full.bak` | 0.036s | 0.029s | 0.065s |
| `ordered_cci_full.bak` | 0.04s | 0.033s | 0.073s |
| `pagecomp_anchor_full.bak` | 0.124s | 0.09s | 0.214s |
| `pagecomp_long_prefix_full.bak` | 0.035s | 0.029s | 0.064s |
| `pfor_columnstore_full.bak` | 0.102s | 0.816s | 0.918s |
| `pfor_columnstore_random_full.bak` | 0.094s | 0.817s | 0.911s |
| `realworld_numeric_digest_full.bak` | 0.056s | 0.08s | 0.136s |
| `rowboundary_full.bak` | 0.046s | 0.032s | 0.078s |
| `rowstore_hash_pii_full.bak` | 0.035s | 0.029s | 0.064s |
| `rowstore_lob_image_full.bak` | 0.037s | 0.029s | 0.066s |
| `rowstore_lob_markup_full.bak` | 0.036s | 0.035s | 0.071s |
| `rowversion_extract_full.bak` | 0.036s | 0.03s | 0.066s |
| `sparse_full.bak` | 0.084s | 0.09s | 0.174s |
| `spatial_edge_full.bak` | 0.037s | 0.03s | 0.067s |
| `spatial_index_full.bak` | 0.038s | 0.031s | 0.069s |
| `sql_variant_extract_full.bak` | 0.045s | 0.029s | 0.074s |
| `striped_full_1.bak` | 0.049s | 0.014s | 0.063s |
| `striped_single.bak` | 0.048s | 0.048s | 0.096s |
| `surrogate_pairs_full.bak` | 0.032s | 0.03s | 0.062s |
| `tabletype_cci_large_full.bak` | 0.051s | 0.037s | 0.088s |
| `tabletypecoverage_diff.bak` | 0.095s | 0.055s | 0.15s |
| `tabletypecoverage_full.bak` | 0.072s | 0.084s | 0.156s |
| `temporal_hidden_full.bak` | 0.038s | 0.032s | 0.07s |
| `torn_page_full.bak` | 0.035s | 0.03s | 0.065s |
| `typecoverage_full.bak` | 0.068s | 0.059s | 0.127s |
| `typed_xml_full.bak` | 0.035s | 0.029s | 0.064s |
| `unicode_codepage_coverage.bak` | 0.055s | 0.041s | 0.096s |
| `utf8_collation_full.bak` | 0.033s | 0.03s | 0.063s |
| `vector_full.bak` | 0.037s | 0.035s | 0.072s |
| `xml_index_full.bak` | 0.038s | 0.03s | 0.068s |
| `xmlcoverage_full.bak` | 0.033s | 0.032s | 0.065s |
| `xmlheap_full.bak` | 0.051s | 0.041s | 0.092s |
| `xtp_checkpoint_straddle_full.bak` | 1.75s | 0.365s | 2.115s |
| `xtp_probe_full.bak` | 0.113s | 0.034s | 0.147s |
| `xtp_rich_full.bak` | 0.095s | 0.035s | 0.13s |
| `xtp_simple_full.bak` | 0.097s | 0.036s | 0.133s |
