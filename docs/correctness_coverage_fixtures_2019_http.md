...
|--------|---------|--------|-----------|
| `alias_types_full.bak` | 0.046s | 0.037s | 0.083s |
| `archive_columnstore_partition_full.bak` | 1.033s | 0.66s | 1.693s |
| `archive_columnstore_types_full.bak` | 0.352s | 0.733s | 1.085s |
| `archive_columnstore_types_random_full.bak` | 0.38s | 0.758s | 1.138s |
| `archive_single_chunk_full.bak` | 0.053s | 0.046s | 0.099s |
| `archive_single_chunk_random_full.bak` | 0.051s | 0.036s | 0.087s |
| `archivenull_full.bak` | 0.164s | 0.092s | 0.256s |
| `backup_blocksize_full.bak` | 0.051s | 0.041s | 0.092s |
| `boundarycoverage_datetime_full.bak` | 0.098s | 0.167s | 0.265s |
| `boundarycoverage_full.bak` | 0.065s | 0.06s | 0.125s |
| `catalog_ss2019.bak` | 0.053s | 0.032s | 0.085s |
| `cci_binary_varbinary_compare_full.bak` | 0.047s | 0.035s | 0.082s |
| `cci_bitpack_probe_bigint_full.bak` | 2.335s | 3.899s | 6.234s |
| `cci_bitpack_probe_full.bak` | 0.133s | 0.725s | 0.858s |
| `cci_bitpack_probe_highbase_full.bak` | 0.12s | 0.447s | 0.567s |
| `cci_btree_nci_full.bak` | 0.055s | 0.036s | 0.091s |
| `cci_computed_full.bak` | 0.049s | 0.033s | 0.082s |
| `cci_enc5_largepool_full.bak` | 0.389s | 0.454s | 0.843s |
| `cci_enc5_largepool_matrix_full.bak` | 7.429s | 1.349s | 8.778s |
| `cci_extended_full.bak` | 0.073s | 0.042s | 0.115s |
| `cci_lob_full.bak` | 0.055s | 0.057s | 0.112s |
| `cci_reorganize_full.bak` | 0.058s | 0.038s | 0.096s |
| `cci_string_dict_regression_full.bak` | 0.345s | 0.152s | 0.497s |
| `cci_string_minmax_full.bak` | 0.057s | 0.044s | 0.101s |
| `cci_switch_full.bak` | 0.056s | 0.036s | 0.092s |
| `cci_types_large_full.bak` | 0.065s | 0.04s | 0.105s |
| `cci_varbinary_micro_full.bak` | 0.051s | 0.032s | 0.083s |
| `cci_varbinary_probe_full.bak` | 0.077s | 0.061s | 0.138s |
| `columnstore_minimal.bak` | 0.127s | 0.984s | 1.111s |
| `compressed_nvarchar_full.bak` | 0.045s | 0.037s | 0.082s |
| `compressioncoverage_full.bak` | 0.116s | 0.182s | 0.298s |
| `computedcoverage_full.bak` | 0.042s | 0.041s | 0.083s |
| `constraintcoverage_full.bak` | 0.054s | 0.04s | 0.094s |
| `covering_index_full.bak` | 0.05s | 0.035s | 0.085s |
| `cs_lob_preamble.bak` | 0.104s | 0.063s | 0.167s |
| `delta_rowgroup_full.bak` | 0.053s | 0.037s | 0.09s |
| `dirtycoverage_aborted_xact.bak` | 0.068s | 0.031s | 0.099s |
| `dirtycoverage_addcol.bak` | 0.049s | 0.036s | 0.085s |
| `dirtycoverage_addnotnull.bak` | 0.052s | 0.07s | 0.122s |
| `dirtycoverage_alldirty.bak` | 0.072s | 0.03s | 0.102s |
| `dirtycoverage_altercol.bak` | 0.047s | 0.057s | 0.104s |
| `dirtycoverage_altercol_rewrite.bak` | 0.046s | 0.034s | 0.08s |
| `dirtycoverage_alterdb.bak` | 0.048s | 0.034s | 0.082s |
| `dirtycoverage_cci_delete.bak` | 0.117s | 0.084s | 0.201s |
| `dirtycoverage_cci_update.bak` | 0.221s | 0.097s | 0.318s |
| `dirtycoverage_committed_delete.bak` | 0.046s | 0.033s | 0.079s |
| `dirtycoverage_committed_delete_v2.bak` | 0.05s | 0.054s | 0.104s |
| `dirtycoverage_committed_delete_v3.bak` | 0.058s | 0.06s | 0.118s |
| `dirtycoverage_committed_delete_v4.bak` | 0.192s | 0.08s | 0.272s |
| `dirtycoverage_committed_update.bak` | 0.056s | 0.044s | 0.1s |
| `dirtycoverage_committed_update_v2.bak` | 0.048s | 0.035s | 0.083s |
| `dirtycoverage_committed_update_v3.bak` | 0.061s | 0.071s | 0.132s |
| `dirtycoverage_committed_update_v4.bak` | 0.178s | 0.073s | 0.251s |
| `dirtycoverage_concurrent.bak` | 0.05s | 0.036s | 0.086s |
| `dirtycoverage_createidx.bak` | 0.049s | 0.032s | 0.081s |
| `dirtycoverage_createtable.bak` | 0.044s | 0.034s | 0.078s |
| `dirtycoverage_delete.bak` | 0.088s | 0.03s | 0.118s |
| `dirtycoverage_dropcol.bak` | 0.045s | 0.034s | 0.079s |
| `dirtycoverage_dropidx.bak` | 0.05s | 0.038s | 0.088s |
| `dirtycoverage_droptable.bak` | 0.049s | 0.035s | 0.084s |
| `dirtycoverage_heap_forward.bak` | 0.077s | 0.03s | 0.107s |
| `dirtycoverage_large_dirty.bak` | 0.369s | 0.033s | 0.402s |
| `dirtycoverage_lob_update.bak` | 0.089s | 0.035s | 0.124s |
| `dirtycoverage_maxrow.bak` | 0.043s | 0.034s | 0.077s |
| `dirtycoverage_nchar_delete.bak` | 0.078s | 0.029s | 0.107s |
| `dirtycoverage_nested.bak` | 0.069s | 0.03s | 0.099s |
| `dirtycoverage_null_update.bak` | 0.069s | 0.03s | 0.099s |
| `dirtycoverage_rebuildidx.bak` | 0.049s | 0.036s | 0.085s |
| `dirtycoverage_rich_insert.bak` | 0.071s | 0.03s | 0.101s |
| `dirtycoverage_rich_update.bak` | 0.071s | 0.034s | 0.105s |
| `dirtycoverage_savepoint.bak` | 0.071s | 0.032s | 0.103s |
| `dirtycoverage_snapshot_update.bak` | 0.097s | 0.034s | 0.131s |
| `dirtycoverage_switch.bak` | 0.065s | 0.044s | 0.109s |
| `dirtycoverage_temporal_update.bak` | 0.074s | 0.031s | 0.105s |
| `dirtycoverage_truncate.bak` | 0.048s | 0.036s | 0.084s |
| `dirtycoverage_two_tx.bak` | 0.074s | 0.032s | 0.106s |
| `dirtycoverage_uncommitted.bak` | 0.071s | 0.031s | 0.102s |
| `dirtycoverage_update.bak` | 0.079s | 0.031s | 0.11s |
| `filtered_ncci_full.bak` | 0.052s | 0.034s | 0.086s |
| `float_extreme_full.bak` | 0.051s | 0.037s | 0.088s |
| `forwarded_records_full.bak` | 0.255s | 0.07s | 0.325s |
| `ghost_records_full.bak` | 0.046s | 0.035s | 0.081s |
| `heapcoverage_large.bak` | 0.052s | 0.042s | 0.094s |
| `heapcoverage_large_50000.bak` | 0.219s | 0.334s | 0.553s |
| `hierarchyid_extract_full.bak` | 0.046s | 0.043s | 0.089s |
| `high_slot_density_full.bak` | 0.089s | 0.195s | 0.284s |
| `identity_coverage_full.bak` | 0.051s | 0.042s | 0.093s |
| `incrementalcoverage_diff_01.bak` | 0.045s | 0.011s | 0.056s |
| `incrementalcoverage_diff_02.bak` | 0.052s | 0.014s | 0.066s |
| `incrementalcoverage_diff_03.bak` | 0.047s | 0.014s | 0.061s |
| `incrementalcoverage_diff_04.bak` | 0.044s | 0.011s | 0.055s |
| `incrementalcoverage_diff_05.bak` | 0.045s | 0.012s | 0.057s |
| `incrementalcoverage_diff_06.bak` | 0.052s | 0.01s | 0.062s |
| `incrementalcoverage_full.bak` | 0.041s | 0.035s | 0.076s |
| `layoutcoverage_full.bak` | 0.241s | 0.353s | 0.594s |
| `max_row_width_full.bak` | 0.042s | 0.037s | 0.079s |
| `mixed_collation_full.bak` | 0.05s | 0.037s | 0.087s |
| `multi_rowgroup_full.bak` | 0.059s | 0.037s | 0.096s |
| `ncci_heap_full.bak` | 0.054s | 0.035s | 0.089s |
| `ncci_types_full.bak` | 0.126s | 0.2s | 0.326s |
| `ndfcoverage_full.bak` | 0.051s | 0.044s | 0.095s |
| `nvarchar_max_u21_full.bak` | 0.046s | 0.033s | 0.079s |
| `pagecomp_anchor_full.bak` | 0.145s | 0.096s | 0.241s |
| `pagecomp_long_prefix_full.bak` | 0.045s | 0.034s | 0.079s |
| `pfor_columnstore_full.bak` | 0.135s | 0.848s | 0.983s |
| `pfor_columnstore_random_full.bak` | 0.13s | 0.84s | 0.97s |
| `realworld_numeric_digest_full.bak` | 0.055s | 0.085s | 0.14s |
| `rowboundary_full.bak` | 0.051s | 0.036s | 0.087s |
| `rowstore_hash_pii_full.bak` | 0.043s | 0.036s | 0.079s |
| `rowstore_lob_image_full.bak` | 0.058s | 0.069s | 0.127s |
| `rowstore_lob_markup_full.bak` | 0.048s | 0.032s | 0.08s |
| `rowversion_extract_full.bak` | 0.049s | 0.039s | 0.088s |
| `sparse_full.bak` | 0.102s | 0.086s | 0.188s |
| `spatial_edge_full.bak` | 0.045s | 0.042s | 0.087s |
| `spatial_index_full.bak` | 0.051s | 0.035s | 0.086s |
| `sql_variant_extract_full.bak` | 0.047s | 0.034s | 0.081s |
| `striped_full_1.bak` | 0.052s | 0.014s | 0.066s |
| `striped_single.bak` | 0.077s | 0.044s | 0.121s |
| `surrogate_pairs_full.bak` | 0.046s | 0.033s | 0.079s |
| `tabletype_cci_large_full.bak` | 0.073s | 0.044s | 0.117s |
| `tabletypecoverage_diff.bak` | 0.118s | 0.07s | 0.188s |
| `tabletypecoverage_full.bak` | 0.192s | 0.104s | 0.296s |
| `temporal_hidden_full.bak` | 0.048s | 0.044s | 0.092s |
| `torn_page_full.bak` | 0.043s | 0.036s | 0.079s |
| `typecoverage_full.bak` | 0.129s | 0.068s | 0.197s |
| `typed_xml_full.bak` | 0.046s | 0.036s | 0.082s |
| `unicode_codepage_coverage.bak` | 0.076s | 0.042s | 0.118s |
| `utf8_collation_full.bak` | 0.043s | 0.039s | 0.082s |
| `xml_index_full.bak` | 0.051s | 0.038s | 0.089s |
| `xmlcoverage_full.bak` | 0.049s | 0.036s | 0.085s |
| `xmlheap_full.bak` | 0.111s | 0.048s | 0.159s |
