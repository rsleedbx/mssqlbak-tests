...
|--------|---------|--------|-----------|
| `alias_types_full.bak` | 0.042s | 0.031s | 0.073s |
| `archive_columnstore_partition_full.bak` | 0.964s | 0.613s | 1.577s |
| `archive_columnstore_types_full.bak` | 0.318s | 0.68s | 0.998s |
| `archive_columnstore_types_random_full.bak` | 0.33s | 0.73s | 1.06s |
| `archive_single_chunk_full.bak` | 0.047s | 0.037s | 0.084s |
| `archive_single_chunk_random_full.bak` | 0.047s | 0.033s | 0.08s |
| `archivenull_full.bak` | 0.132s | 0.091s | 0.223s |
| `backup_blocksize_full.bak` | 0.048s | 0.036s | 0.084s |
| `boundarycoverage_datetime_full.bak` | 0.072s | 0.15s | 0.222s |
| `boundarycoverage_full.bak` | 0.062s | 0.073s | 0.135s |
| `catalog_ss2019.bak` | 0.052s | 0.03s | 0.082s |
| `cci_binary_varbinary_compare_full.bak` | 0.048s | 0.051s | 0.099s |
| `cci_bitpack_probe_bigint_full.bak` | 2.278s | 3.901s | 6.179s |
| `cci_bitpack_probe_full.bak` | 0.121s | 0.655s | 0.776s |
| `cci_bitpack_probe_highbase_full.bak` | 0.112s | 0.422s | 0.534s |
| `cci_btree_nci_full.bak` | 0.059s | 0.04s | 0.099s |
| `cci_computed_full.bak` | 0.05s | 0.04s | 0.09s |
| `cci_enc5_largepool_full.bak` | 0.365s | 0.44s | 0.805s |
| `cci_enc5_largepool_matrix_full.bak` | 7.281s | 1.249s | 8.53s |
| `cci_extended_full.bak` | 0.074s | 0.048s | 0.122s |
| `cci_lob_full.bak` | 0.053s | 0.038s | 0.091s |
| `cci_reorganize_full.bak` | 0.05s | 0.035s | 0.085s |
| `cci_string_dict_regression_full.bak` | 0.331s | 0.138s | 0.469s |
| `cci_string_minmax_full.bak` | 0.055s | 0.035s | 0.09s |
| `cci_switch_full.bak` | 0.048s | 0.035s | 0.083s |
| `cci_types_large_full.bak` | 0.063s | 0.049s | 0.112s |
| `cci_varbinary_micro_full.bak` | 0.049s | 0.034s | 0.083s |
| `cci_varbinary_probe_full.bak` | 0.051s | 0.051s | 0.102s |
| `columnstore_minimal.bak` | 0.143s | 0.892s | 1.035s |
| `compressed_nvarchar_full.bak` | 0.043s | 0.033s | 0.076s |
| `compressioncoverage_full.bak` | 0.093s | 0.168s | 0.261s |
| `computedcoverage_full.bak` | 0.042s | 0.031s | 0.073s |
| `constraintcoverage_full.bak` | 0.049s | 0.042s | 0.091s |
| `covering_index_full.bak` | 0.049s | 0.044s | 0.093s |
| `cs_lob_preamble.bak` | 0.109s | 0.063s | 0.172s |
| `delta_rowgroup_full.bak` | 0.051s | 0.032s | 0.083s |
| `dirtycoverage_aborted_xact.bak` | 0.069s | 0.036s | 0.105s |
| `dirtycoverage_addcol.bak` | 0.044s | 0.038s | 0.082s |
| `dirtycoverage_addnotnull.bak` | 0.045s | 0.031s | 0.076s |
...
| `dirtycoverage_alterdb.bak` | 0.045s | 0.032s | 0.077s |
| `dirtycoverage_cci_delete.bak` | 0.103s | 0.081s | 0.184s |
| `dirtycoverage_cci_update.bak` | 0.211s | 0.107s | 0.318s |
| `dirtycoverage_committed_delete.bak` | 0.044s | 0.031s | 0.075s |
| `dirtycoverage_committed_delete_v2.bak` | 0.053s | 0.037s | 0.09s |
| `dirtycoverage_committed_delete_v3.bak` | 0.055s | 0.061s | 0.116s |
| `dirtycoverage_committed_delete_v4.bak` | 0.162s | 0.076s | 0.238s |
| `dirtycoverage_committed_update.bak` | 0.044s | 0.031s | 0.075s |
| `dirtycoverage_committed_update_v2.bak` | 0.046s | 0.037s | 0.083s |
| `dirtycoverage_committed_update_v3.bak` | 0.057s | 0.073s | 0.13s |
| `dirtycoverage_committed_update_v4.bak` | 0.161s | 0.079s | 0.24s |
| `dirtycoverage_concurrent.bak` | 0.046s | 0.031s | 0.077s |
| `dirtycoverage_createidx.bak` | 0.045s | 0.03s | 0.075s |
| `dirtycoverage_createtable.bak` | 0.046s | 0.032s | 0.078s |
| `dirtycoverage_delete.bak` | 0.066s | 0.035s | 0.101s |
| `dirtycoverage_dropcol.bak` | 0.044s | 0.035s | 0.079s |
| `dirtycoverage_dropidx.bak` | 0.046s | 0.031s | 0.077s |
| `dirtycoverage_droptable.bak` | 0.049s | 0.031s | 0.08s |
| `dirtycoverage_heap_forward.bak` | 0.066s | 0.036s | 0.102s |
| `dirtycoverage_large_dirty.bak` | 0.369s | 0.053s | 0.422s |
| `dirtycoverage_lob_update.bak` | 0.083s | 0.03s | 0.113s |
| `dirtycoverage_maxrow.bak` | 0.044s | 0.03s | 0.074s |
| `dirtycoverage_nchar_delete.bak` | 0.069s | 0.037s | 0.106s |
| `dirtycoverage_nested.bak` | 0.071s | 0.035s | 0.106s |
| `dirtycoverage_null_update.bak` | 0.076s | 0.034s | 0.11s |
| `dirtycoverage_rebuildidx.bak` | 0.046s | 0.032s | 0.078s |
| `dirtycoverage_rich_insert.bak` | 0.069s | 0.038s | 0.107s |
| `dirtycoverage_rich_update.bak` | 0.07s | 0.038s | 0.108s |
| `dirtycoverage_savepoint.bak` | 0.068s | 0.031s | 0.099s |
| `dirtycoverage_snapshot_update.bak` | 0.065s | 0.034s | 0.099s |
| `dirtycoverage_switch.bak` | 0.049s | 0.037s | 0.086s |
| `dirtycoverage_temporal_update.bak` | 0.075s | 0.055s | 0.13s |
| `dirtycoverage_truncate.bak` | 0.05s | 0.037s | 0.087s |
| `dirtycoverage_two_tx.bak` | 0.072s | 0.037s | 0.109s |
| `dirtycoverage_uncommitted.bak` | 0.071s | 0.036s | 0.107s |
| `dirtycoverage_update.bak` | 0.074s | 0.032s | 0.106s |
| `filtered_ncci_full.bak` | 0.05s | 0.038s | 0.088s |
| `float_extreme_full.bak` | 0.046s | 0.044s | 0.09s |
| `forwarded_records_full.bak` | 0.259s | 0.087s | 0.346s |
| `ghost_records_full.bak` | 0.041s | 0.032s | 0.073s |
| `heapcoverage_large.bak` | 0.046s | 0.04s | 0.086s |
| `heapcoverage_large_50000.bak` | 0.206s | 0.378s | 0.584s |
| `hierarchyid_extract_full.bak` | 0.044s | 0.036s | 0.08s |
| `high_slot_density_full.bak` | 0.072s | 0.193s | 0.265s |
| `identity_coverage_full.bak` | 0.045s | 0.033s | 0.078s |
| `incrementalcoverage_diff_01.bak` | 0.043s | 0.01s | 0.053s |
| `incrementalcoverage_diff_02.bak` | 0.05s | 0.011s | 0.061s |
| `incrementalcoverage_diff_03.bak` | 0.042s | 0.009s | 0.051s |
| `incrementalcoverage_diff_04.bak` | 0.042s | 0.01s | 0.052s |
| `incrementalcoverage_diff_05.bak` | 0.042s | 0.01s | 0.052s |
| `incrementalcoverage_diff_06.bak` | 0.052s | 0.011s | 0.063s |
| `incrementalcoverage_full.bak` | 0.043s | 0.026s | 0.069s |
| `layoutcoverage_full.bak` | 0.254s | 0.427s | 0.681s |
| `max_row_width_full.bak` | 0.043s | 0.033s | 0.076s |
| `mixed_collation_full.bak` | 0.044s | 0.033s | 0.077s |
| `multi_rowgroup_full.bak` | 0.065s | 0.04s | 0.105s |
| `ncci_heap_full.bak` | 0.049s | 0.038s | 0.087s |
| `ncci_types_full.bak` | 0.109s | 0.175s | 0.284s |
| `ndfcoverage_full.bak` | 0.047s | 0.042s | 0.089s |
| `nvarchar_max_u21_full.bak` | 0.045s | 0.029s | 0.074s |
| `pagecomp_anchor_full.bak` | 0.138s | 0.089s | 0.227s |
| `pagecomp_long_prefix_full.bak` | 0.051s | 0.03s | 0.081s |
| `pfor_columnstore_full.bak` | 0.12s | 0.862s | 0.982s |
| `pfor_columnstore_random_full.bak` | 0.132s | 0.834s | 0.966s |
| `realworld_numeric_digest_full.bak` | 0.057s | 0.086s | 0.143s |
| `rowboundary_full.bak` | 0.052s | 0.037s | 0.089s |
| `rowstore_hash_pii_full.bak` | 0.041s | 0.029s | 0.07s |
| `rowstore_lob_image_full.bak` | 0.044s | 0.031s | 0.075s |
| `rowstore_lob_markup_full.bak` | 0.042s | 0.037s | 0.079s |
| `rowversion_extract_full.bak` | 0.046s | 0.036s | 0.082s |
| `sparse_full.bak` | 0.098s | 0.084s | 0.182s |
| `spatial_edge_full.bak` | 0.043s | 0.033s | 0.076s |
| `spatial_index_full.bak` | 0.053s | 0.047s | 0.1s |
| `sql_variant_extract_full.bak` | 0.04s | 0.034s | 0.074s |
| `striped_full_1.bak` | 0.048s | 0.014s | 0.062s |
| `striped_single.bak` | 0.075s | 0.047s | 0.122s |
| `surrogate_pairs_full.bak` | 0.044s | 0.035s | 0.079s |
| `tabletype_cci_large_full.bak` | 0.076s | 0.048s | 0.124s |
| `tabletypecoverage_diff.bak` | 0.096s | 0.066s | 0.162s |
| `tabletypecoverage_full.bak` | 0.197s | 0.124s | 0.321s |
| `temporal_hidden_full.bak` | 0.044s | 0.037s | 0.081s |
| `torn_page_full.bak` | 0.04s | 0.033s | 0.073s |
| `typecoverage_full.bak` | 0.111s | 0.065s | 0.176s |
| `typed_xml_full.bak` | 0.048s | 0.03s | 0.078s |
| `unicode_codepage_coverage.bak` | 0.072s | 0.048s | 0.12s |
| `utf8_collation_full.bak` | 0.044s | 0.035s | 0.079s |
| `xml_index_full.bak` | 0.051s | 0.037s | 0.088s |
| `xmlcoverage_full.bak` | 0.041s | 0.031s | 0.072s |
| `xmlheap_full.bak` | 0.105s | 0.061s | 0.166s |
