...
| Backup | Wall time |
|--------|-------------|
| `alias_types_full.bak` | 0.086s |
| `archive_columnstore_partition_full.bak` | 2.504s |
| `archive_columnstore_types_full.bak` | 1.349s |
| `archive_columnstore_types_random_full.bak` | 1.36s |
| `archive_single_chunk_full.bak` | 0.108s |
| `archive_single_chunk_random_full.bak` | 0.099s |
| `archivenull_full.bak` | 0.336s |
| `backup_blocksize_full.bak` | 0.089s |
| `boundarycoverage_datetime_full.bak` | 0.459s |
| `boundarycoverage_full.bak` | 0.236s |
| `catalog_ss2019.bak` | 0.094s |
| `cci_binary_varbinary_compare_full.bak` | 0.11s |
| `cci_bitpack_probe_bigint_full.bak` | 6.724s |
| `cci_bitpack_probe_full.bak` | 0.807s |
| `cci_bitpack_probe_highbase_full.bak` | 0.724s |
| `cci_btree_nci_full.bak` | 0.123s |
| `cci_computed_full.bak` | 0.114s |
| `cci_enc5_largepool_full.bak` | 1.248s |
| `cci_enc5_largepool_matrix_full.bak` | 9.858s |
| `cci_extended_full.bak` | 0.171s |
| `cci_lob_full.bak` | 0.115s |
| `cci_reorganize_full.bak` | 0.146s |
| `cci_string_dict_regression_full.bak` | 0.531s |
| `cci_string_minmax_full.bak` | 0.116s |
| `cci_switch_full.bak` | 0.103s |
| `cci_types_large_full.bak` | 0.144s |
| `cci_varbinary_micro_full.bak` | 0.104s |
| `cci_varbinary_probe_full.bak` | 0.128s |
| `columnstore_minimal.bak` | 1.134s |
| `compressed_nvarchar_full.bak` | 0.082s |
| `compressioncoverage_full.bak` | 0.398s |
| `computedcoverage_full.bak` | 0.095s |
| `constraintcoverage_full.bak` | 0.101s |
| `covering_index_full.bak` | 0.114s |
| `cs_lob_preamble.bak` | 0.193s |
| `delta_rowgroup_full.bak` | 0.114s |
| `dirtycoverage_aborted_xact.bak` | 0.109s |
| `dirtycoverage_addcol.bak` | 0.087s |
| `dirtycoverage_addnotnull.bak` | 0.095s |
| `dirtycoverage_alldirty.bak` | 0.116s |
| `dirtycoverage_altercol.bak` | 0.077s |
| `dirtycoverage_altercol_rewrite.bak` | 0.09s |
| `dirtycoverage_alterdb.bak` | 0.088s |
| `dirtycoverage_cci_delete.bak` | 0.307s |
| `dirtycoverage_cci_update.bak` | 0.424s |
| `dirtycoverage_committed_delete.bak` | 0.095s |
| `dirtycoverage_committed_delete_v2.bak` | 0.1s |
| `dirtycoverage_committed_delete_v3.bak` | 0.188s |
| `dirtycoverage_committed_delete_v4.bak` | 0.425s |
| `dirtycoverage_committed_update.bak` | 0.091s |
| `dirtycoverage_committed_update_v2.bak` | 0.113s |
| `dirtycoverage_committed_update_v3.bak` | 0.201s |
| `dirtycoverage_committed_update_v4.bak` | 0.476s |
| `dirtycoverage_concurrent.bak` | 0.092s |
| `dirtycoverage_createidx.bak` | 0.098s |
| `dirtycoverage_createtable.bak` | 0.1s |
| `dirtycoverage_delete.bak` | 0.11s |
| `dirtycoverage_dropcol.bak` | 0.087s |
| `dirtycoverage_dropidx.bak` | 0.088s |
| `dirtycoverage_droptable.bak` | 0.1s |
| `dirtycoverage_heap_forward.bak` | 0.104s |
| `dirtycoverage_large_dirty.bak` | 0.392s |
| `dirtycoverage_lob_update.bak` | 0.135s |
| `dirtycoverage_maxrow.bak` | 0.096s |
| `dirtycoverage_nchar_delete.bak` | 0.121s |
| `dirtycoverage_nested.bak` | 0.124s |
| `dirtycoverage_null_update.bak` | 0.117s |
| `dirtycoverage_rebuildidx.bak` | 0.107s |
| `dirtycoverage_rich_insert.bak` | 0.124s |
| `dirtycoverage_rich_update.bak` | 0.122s |
| `dirtycoverage_savepoint.bak` | 0.122s |
| `dirtycoverage_snapshot_update.bak` | 0.109s |
| `dirtycoverage_switch.bak` | 0.093s |
| `dirtycoverage_temporal_update.bak` | 0.114s |
| `dirtycoverage_truncate.bak` | 0.106s |
| `dirtycoverage_two_tx.bak` | 0.121s |
| `dirtycoverage_uncommitted.bak` | 0.107s |
| `dirtycoverage_update.bak` | 0.123s |
| `filtered_ncci_full.bak` | 0.113s |
| `float_extreme_full.bak` | 0.087s |
| `forwarded_records_full.bak` | 0.199s |
| `ghost_records_full.bak` | 0.083s |
| `heapcoverage_large.bak` | 0.103s |
| `heapcoverage_large_50000.bak` | 1.032s |
| `hierarchyid_extract_full.bak` | 0.08s |
| `high_slot_density_full.bak` | 0.583s |
| `incrementalcoverage_diff_01.bak` | 0.107s |
| `incrementalcoverage_diff_02.bak` | 0.132s |
| `incrementalcoverage_diff_03.bak` | 0.096s |
| `incrementalcoverage_diff_04.bak` | 0.105s |
| `incrementalcoverage_diff_05.bak` | 0.091s |
| `incrementalcoverage_diff_06.bak` | 0.123s |
| `incrementalcoverage_full.bak` | 0.084s |
| `layoutcoverage_full.bak` | 0.397s |
| `max_row_width_full.bak` | 0.075s |
| `mixed_collation_full.bak` | 0.085s |
| `multi_rowgroup_full.bak` | 0.113s |
| `ncci_heap_full.bak` | 0.104s |
| `ncci_types_full.bak` | 0.574s |
| `ndfcoverage_full.bak` | 0.125s |
| `nvarchar_max_u21_full.bak` | 0.093s |
| `pagecomp_anchor_full.bak` | 0.401s |
| `pagecomp_long_prefix_full.bak` | 0.098s |
| `pfor_columnstore_full.bak` | 2.337s |
| `pfor_columnstore_random_full.bak` | 2.386s |
| `realworld_numeric_digest_full.bak` | 0.218s |
| `rowboundary_full.bak` | 0.096s |
| `rowstore_hash_pii_full.bak` | 0.094s |
| `rowstore_lob_image_full.bak` | 0.095s |
| `rowstore_lob_markup_full.bak` | 0.084s |
| `rowversion_extract_full.bak` | 0.089s |
| `sparse_full.bak` | 0.348s |
| `spatial_edge_full.bak` | 0.086s |
| `spatial_index_full.bak` | 0.103s |
| `sql_variant_extract_full.bak` | 0.1s |
| `striped_full_1.bak` | 0.106s |
| `striped_single.bak` | 0.142s |
| `surrogate_pairs_full.bak` | 0.086s |
| `tabletype_cci_large_full.bak` | 0.141s |
| `tabletypecoverage_diff.bak` | 0.238s |
| `tabletypecoverage_full.bak` | 0.21s |
| `temporal_hidden_full.bak` | 0.093s |
| `torn_page_full.bak` | 0.101s |
| `typecoverage_full.bak` | 0.152s |
| `typed_xml_full.bak` | 0.094s |
| `unicode_codepage_coverage.bak` | 0.121s |
| `utf8_collation_full.bak` | 0.091s |
| `xml_index_full.bak` | 0.103s |
| `xmlcoverage_full.bak` | 0.089s |
| `xmlheap_full.bak` | 0.145s |
