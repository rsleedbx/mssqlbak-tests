...
|--------|---------|--------|-----------|
| `alias_types_full.bak` | 0.049s | 0.032s | 0.081s |
| `archive_columnstore_partition_full.bak` | 0.979s | 0.622s | 1.601s |
| `archive_columnstore_types_full.bak` | 0.336s | 0.708s | 1.044s |
| `archive_columnstore_types_random_full.bak` | 0.323s | 0.691s | 1.014s |
| `archive_single_chunk_full.bak` | 0.059s | 0.036s | 0.095s |
| `archive_single_chunk_random_full.bak` | 0.052s | 0.033s | 0.085s |
| `archivenull_full.bak` | 0.138s | 0.091s | 0.229s |
| `backup_blocksize_full.bak` | 0.049s | 0.035s | 0.084s |
| `boundarycoverage_datetime_full.bak` | 0.074s | 0.148s | 0.222s |
| `boundarycoverage_full.bak` | 0.074s | 0.07s | 0.144s |
| `catalog_ss2019.bak` | 0.042s | 0.029s | 0.071s |
| `cci_binary_varbinary_compare_full.bak` | 0.052s | 0.034s | 0.086s |
| `cci_bitpack_probe_bigint_full.bak` | 2.263s | 3.787s | 6.05s |
| `cci_bitpack_probe_full.bak` | 0.13s | 0.654s | 0.784s |
| `cci_bitpack_probe_highbase_full.bak` | 0.11s | 0.423s | 0.533s |
| `cci_btree_nci_full.bak` | 0.055s | 0.038s | 0.093s |
| `cci_computed_full.bak` | 0.049s | 0.037s | 0.086s |
| `cci_enc5_largepool_full.bak` | 0.373s | 0.436s | 0.809s |
| `cci_enc5_largepool_matrix_full.bak` | 7.17s | 1.239s | 8.409s |
| `cci_extended_full.bak` | 0.065s | 0.04s | 0.105s |
| `cci_lob_full.bak` | 0.06s | 0.039s | 0.099s |
| `cci_reorganize_full.bak` | 0.063s | 0.038s | 0.101s |
| `cci_string_dict_regression_full.bak` | 0.334s | 0.142s | 0.476s |
| `cci_string_minmax_full.bak` | 0.055s | 0.034s | 0.089s |
| `cci_switch_full.bak` | 0.057s | 0.037s | 0.094s |
| `cci_types_large_full.bak` | 0.063s | 0.039s | 0.102s |
| `cci_varbinary_micro_full.bak` | 0.053s | 0.033s | 0.086s |
| `cci_varbinary_probe_full.bak` | 0.053s | 0.042s | 0.095s |
| `columnstore_minimal.bak` | 0.167s | 0.877s | 1.044s |
| `compressed_nvarchar_full.bak` | 0.043s | 0.029s | 0.072s |
| `compressioncoverage_full.bak` | 0.093s | 0.17s | 0.263s |
| `computedcoverage_full.bak` | 0.042s | 0.03s | 0.072s |
| `constraintcoverage_full.bak` | 0.052s | 0.05s | 0.102s |
| `covering_index_full.bak` | 0.054s | 0.039s | 0.093s |
| `cs_lob_preamble.bak` | 0.105s | 0.066s | 0.171s |
| `delta_rowgroup_full.bak` | 0.053s | 0.032s | 0.085s |
| `dirtycoverage_aborted_xact.bak` | 0.072s | 0.036s | 0.108s |
| `dirtycoverage_addcol.bak` | 0.047s | 0.038s | 0.085s |
| `dirtycoverage_addnotnull.bak` | 0.045s | 0.03s | 0.075s |
| `dirtycoverage_alldirty.bak` | 0.07s | 0.032s | 0.102s |
| `dirtycoverage_altercol.bak` | 0.041s | 0.033s | 0.074s |
| `dirtycoverage_altercol_rewrite.bak` | 0.045s | 0.029s | 0.074s |
| `dirtycoverage_alterdb.bak` | 0.048s | 0.03s | 0.078s |
| `dirtycoverage_cci_delete.bak` | 0.116s | 0.087s | 0.203s |
| `dirtycoverage_cci_update.bak` | 0.214s | 0.095s | 0.309s |
| `dirtycoverage_committed_delete.bak` | 0.043s | 0.03s | 0.073s |
| `dirtycoverage_committed_delete_v2.bak` | 0.058s | 0.032s | 0.09s |
| `dirtycoverage_committed_delete_v3.bak` | 0.061s | 0.057s | 0.118s |
| `dirtycoverage_committed_delete_v4.bak` | 0.161s | 0.065s | 0.226s |
| `dirtycoverage_committed_update.bak` | 0.041s | 0.029s | 0.07s |
| `dirtycoverage_committed_update_v2.bak` | 0.055s | 0.033s | 0.088s |
| `dirtycoverage_committed_update_v3.bak` | 0.057s | 0.066s | 0.123s |
| `dirtycoverage_committed_update_v4.bak` | 0.161s | 0.074s | 0.235s |
| `dirtycoverage_concurrent.bak` | 0.055s | 0.035s | 0.09s |
| `dirtycoverage_createidx.bak` | 0.046s | 0.031s | 0.077s |
| `dirtycoverage_createtable.bak` | 0.055s | 0.031s | 0.086s |
| `dirtycoverage_delete.bak` | 0.068s | 0.029s | 0.097s |
| `dirtycoverage_dropcol.bak` | 0.044s | 0.034s | 0.078s |
| `dirtycoverage_dropidx.bak` | 0.046s | 0.035s | 0.081s |
| `dirtycoverage_droptable.bak` | 0.053s | 0.035s | 0.088s |
| `dirtycoverage_heap_forward.bak` | 0.073s | 0.033s | 0.106s |
| `dirtycoverage_large_dirty.bak` | 0.352s | 0.035s | 0.387s |
| `dirtycoverage_lob_update.bak` | 0.087s | 0.033s | 0.12s |
| `dirtycoverage_maxrow.bak` | 0.053s | 0.031s | 0.084s |
| `dirtycoverage_nchar_delete.bak` | 0.076s | 0.03s | 0.106s |
| `dirtycoverage_nested.bak` | 0.073s | 0.03s | 0.103s |
| `dirtycoverage_null_update.bak` | 0.072s | 0.03s | 0.102s |
| `dirtycoverage_rebuildidx.bak` | 0.05s | 0.032s | 0.082s |
| `dirtycoverage_rich_insert.bak` | 0.075s | 0.034s | 0.109s |
| `dirtycoverage_rich_update.bak` | 0.07s | 0.035s | 0.105s |
| `dirtycoverage_savepoint.bak` | 0.072s | 0.034s | 0.106s |
| `dirtycoverage_snapshot_update.bak` | 0.074s | 0.03s | 0.104s |
| `dirtycoverage_switch.bak` | 0.058s | 0.031s | 0.089s |
| `dirtycoverage_temporal_update.bak` | 0.07s | 0.034s | 0.104s |
| `dirtycoverage_truncate.bak` | 0.05s | 0.034s | 0.084s |
| `dirtycoverage_two_tx.bak` | 0.074s | 0.036s | 0.11s |
| `dirtycoverage_uncommitted.bak` | 0.075s | 0.031s | 0.106s |
| `dirtycoverage_update.bak` | 0.072s | 0.034s | 0.106s |
| `filtered_ncci_full.bak` | 0.065s | 0.036s | 0.101s |
| `float_extreme_full.bak` | 0.049s | 0.028s | 0.077s |
| `forwarded_records_full.bak` | 0.249s | 0.068s | 0.317s |
| `ghost_records_full.bak` | 0.042s | 0.03s | 0.072s |
| `heapcoverage_large.bak` | 0.052s | 0.037s | 0.089s |
| `heapcoverage_large_50000.bak` | 0.208s | 0.323s | 0.531s |
| `hierarchyid_extract_full.bak` | 0.047s | 0.035s | 0.082s |
| `high_slot_density_full.bak` | 0.071s | 0.182s | 0.253s |
| `identity_coverage_full.bak` | 0.051s | 0.033s | 0.084s |
| `incrementalcoverage_diff_01.bak` | 0.049s | 0.01s | 0.059s |
| `incrementalcoverage_diff_02.bak` | 0.049s | 0.01s | 0.059s |
| `incrementalcoverage_diff_03.bak` | 0.042s | 0.027s | 0.069s |
| `incrementalcoverage_diff_04.bak` | 0.044s | 0.014s | 0.058s |
| `incrementalcoverage_diff_05.bak` | 0.044s | 0.01s | 0.054s |
| `incrementalcoverage_diff_06.bak` | 0.051s | 0.023s | 0.074s |
| `incrementalcoverage_full.bak` | 0.041s | 0.028s | 0.069s |
| `layoutcoverage_full.bak` | 0.185s | 0.337s | 0.522s |
| `max_row_width_full.bak` | 0.044s | 0.028s | 0.072s |
| `mixed_collation_full.bak` | 0.05s | 0.03s | 0.08s |
| `multi_rowgroup_full.bak` | 0.053s | 0.041s | 0.094s |
| `ncci_heap_full.bak` | 0.055s | 0.034s | 0.089s |
| `ncci_types_full.bak` | 0.121s | 0.187s | 0.308s |
| `ndfcoverage_full.bak` | 0.054s | 0.031s | 0.085s |
| `nvarchar_max_u21_full.bak` | 0.048s | 0.036s | 0.084s |
| `pagecomp_anchor_full.bak` | 0.136s | 0.091s | 0.227s |
| `pagecomp_long_prefix_full.bak` | 0.049s | 0.035s | 0.084s |
| `pfor_columnstore_full.bak` | 0.128s | 0.837s | 0.965s |
| `pfor_columnstore_random_full.bak` | 0.13s | 0.828s | 0.958s |
| `realworld_numeric_digest_full.bak` | 0.057s | 0.08s | 0.137s |
| `rowboundary_full.bak` | 0.057s | 0.033s | 0.09s |
| `rowstore_hash_pii_full.bak` | 0.048s | 0.03s | 0.078s |
| `rowstore_lob_image_full.bak` | 0.045s | 0.03s | 0.075s |
| `rowstore_lob_markup_full.bak` | 0.041s | 0.029s | 0.07s |
| `rowversion_extract_full.bak` | 0.047s | 0.032s | 0.079s |
| `sparse_full.bak` | 0.1s | 0.088s | 0.188s |
| `spatial_edge_full.bak` | 0.055s | 0.03s | 0.085s |
| `spatial_index_full.bak` | 0.05s | 0.03s | 0.08s |
| `sql_variant_extract_full.bak` | 0.04s | 0.028s | 0.068s |
| `striped_full_1.bak` | 0.049s | 0.019s | 0.068s |
| `striped_single.bak` | 0.083s | 0.046s | 0.129s |
| `surrogate_pairs_full.bak` | 0.05s | 0.032s | 0.082s |
| `tabletype_cci_large_full.bak` | 0.083s | 0.052s | 0.135s |
| `tabletypecoverage_diff.bak` | 0.107s | 0.071s | 0.178s |
| `tabletypecoverage_full.bak` | 0.184s | 0.093s | 0.277s |
| `temporal_hidden_full.bak` | 0.054s | 0.038s | 0.092s |
| `torn_page_full.bak` | 0.043s | 0.031s | 0.074s |
| `typecoverage_full.bak` | 0.118s | 0.081s | 0.199s |
| `typed_xml_full.bak` | 0.045s | 0.028s | 0.073s |
| `unicode_codepage_coverage.bak` | 0.077s | 0.051s | 0.128s |
| `utf8_collation_full.bak` | 0.044s | 0.03s | 0.074s |
| `xml_index_full.bak` | 0.059s | 0.038s | 0.097s |
| `xmlcoverage_full.bak` | 0.047s | 0.03s | 0.077s |
| `xmlheap_full.bak` | 0.107s | 0.055s | 0.162s |
