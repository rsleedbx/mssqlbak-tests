...
| Backup | Wall time |
|--------|-------------|
| `alias_types_full.bak` | 0.144s |
| `archive_columnstore_partition_full.bak` | 2.727s |
| `archive_columnstore_types_full.bak` | 1.347s |
| `archive_columnstore_types_random_full.bak` | 1.372s |
| `archive_single_chunk_full.bak` | 0.123s |
| `archive_single_chunk_random_full.bak` | 0.128s |
| `archivenull_full.bak` | 0.311s |
| `backup_blocksize_full.bak` | 0.122s |
| `boundarycoverage_datetime_full.bak` | 0.374s |
| `boundarycoverage_full.bak` | 0.205s |
| `catalog_ss2019.bak` | 0.098s |
| `cci_binary_varbinary_compare_full.bak` | 0.106s |
| `cci_bitpack_probe_bigint_full.bak` | 6.187s |
| `cci_bitpack_probe_full.bak` | 0.697s |
| `cci_bitpack_probe_highbase_full.bak` | 0.66s |
| `cci_btree_nci_full.bak` | 0.145s |
| `cci_computed_full.bak` | 0.128s |
| `cci_enc5_largepool_full.bak` | 1.159s |
| `cci_enc5_largepool_matrix_full.bak` | 9.774s |
| `cci_extended_full.bak` | 0.31s |
| `cci_lob_full.bak` | 0.197s |
| `cci_reorganize_full.bak` | 0.136s |
| `cci_string_dict_regression_full.bak` | 0.514s |
| `cci_string_minmax_full.bak` | 0.136s |
| `cci_switch_full.bak` | 0.132s |
| `cci_types_large_full.bak` | 0.115s |
| `cci_varbinary_micro_full.bak` | 0.156s |
| `cci_varbinary_probe_full.bak` | 0.204s |
| `columnstore_minimal.bak` | 1.071s |
| `compressed_nvarchar_full.bak` | 0.113s |
| `compressioncoverage_full.bak` | 0.396s |
| `computedcoverage_full.bak` | 0.189s |
| `constraintcoverage_full.bak` | 0.137s |
| `covering_index_full.bak` | 0.167s |
| `cs_lob_preamble.bak` | 0.229s |
| `delta_rowgroup_full.bak` | 0.145s |
| `dirtycoverage_aborted_xact.bak` | 0.108s |
| `dirtycoverage_addcol.bak` | 0.188s |
| `dirtycoverage_addnotnull.bak` | 0.111s |
| `dirtycoverage_alldirty.bak` | 0.151s |
| `dirtycoverage_altercol.bak` | 0.099s |
| `dirtycoverage_altercol_rewrite.bak` | 0.279s |
| `dirtycoverage_alterdb.bak` | 0.1s |
| `dirtycoverage_cci_delete.bak` | 0.223s |
| `dirtycoverage_cci_update.bak` | 0.351s |
| `dirtycoverage_committed_delete.bak` | 0.12s |
| `dirtycoverage_committed_delete_v2.bak` | 0.123s |
| `dirtycoverage_committed_delete_v3.bak` | 0.306s |
| `dirtycoverage_committed_delete_v4.bak` | 0.378s |
| `dirtycoverage_committed_update.bak` | 0.107s |
| `dirtycoverage_committed_update_v2.bak` | 0.129s |
| `dirtycoverage_committed_update_v3.bak` | 0.244s |
| `dirtycoverage_committed_update_v4.bak` | 0.387s |
| `dirtycoverage_concurrent.bak` | 0.106s |
| `dirtycoverage_createidx.bak` | 0.151s |
| `dirtycoverage_createtable.bak` | 0.1s |
| `dirtycoverage_delete.bak` | 0.174s |
| `dirtycoverage_dropcol.bak` | 0.101s |
| `dirtycoverage_dropidx.bak` | 0.127s |
| `dirtycoverage_droptable.bak` | 0.293s |
| `dirtycoverage_heap_forward.bak` | 0.158s |
| `dirtycoverage_large_dirty.bak` | 0.391s |
| `dirtycoverage_lob_update.bak` | 0.271s |
| `dirtycoverage_maxrow.bak` | 0.109s |
| `dirtycoverage_nchar_delete.bak` | 0.132s |
| `dirtycoverage_nested.bak` | 0.151s |
| `dirtycoverage_null_update.bak` | 0.131s |
| `dirtycoverage_rebuildidx.bak` | 0.11s |
| `dirtycoverage_rich_insert.bak` | 0.217s |
| `dirtycoverage_rich_update.bak` | 0.143s |
| `dirtycoverage_savepoint.bak` | 0.137s |
| `dirtycoverage_snapshot_update.bak` | 0.161s |
| `dirtycoverage_switch.bak` | 0.123s |
| `dirtycoverage_temporal_update.bak` | 0.197s |
| `dirtycoverage_truncate.bak` | 0.115s |
| `dirtycoverage_two_tx.bak` | 0.19s |
| `dirtycoverage_uncommitted.bak` | 0.143s |
| `dirtycoverage_update.bak` | 0.144s |
| `filtered_ncci_full.bak` | 0.127s |
| `float_extreme_full.bak` | 0.296s |
| `forwarded_records_full.bak` | 0.215s |
| `ghost_records_full.bak` | 0.109s |
| `heapcoverage_large.bak` | 0.155s |
| `heapcoverage_large_50000.bak` | 0.981s |
| `hierarchyid_extract_full.bak` | 0.127s |
| `high_slot_density_full.bak` | 0.581s |
| `incrementalcoverage_diff_01.bak` | 0.109s |
| `incrementalcoverage_diff_02.bak` | 0.153s |
| `incrementalcoverage_diff_03.bak` | 0.235s |
| `incrementalcoverage_diff_04.bak` | 0.153s |
| `incrementalcoverage_diff_05.bak` | 0.119s |
| `incrementalcoverage_diff_06.bak` | 0.227s |
| `incrementalcoverage_full.bak` | 0.144s |
| `layoutcoverage_full.bak` | 0.397s |
| `max_row_width_full.bak` | 0.106s |
| `mixed_collation_full.bak` | 0.102s |
| `multi_rowgroup_full.bak` | 0.164s |
| `ncci_heap_full.bak` | 0.12s |
| `ncci_types_full.bak` | 0.48s |
| `ndfcoverage_full.bak` | 0.126s |
| `nvarchar_max_u21_full.bak` | 0.106s |
| `pagecomp_anchor_full.bak` | 0.405s |
| `pagecomp_long_prefix_full.bak` | 0.142s |
| `pfor_columnstore_full.bak` | 2.603s |
| `pfor_columnstore_random_full.bak` | 2.272s |
| `realworld_numeric_digest_full.bak` | 0.235s |
| `rowboundary_full.bak` | 0.17s |
| `rowstore_hash_pii_full.bak` | 0.105s |
| `rowstore_lob_image_full.bak` | 0.118s |
| `rowstore_lob_markup_full.bak` | 0.115s |
| `rowversion_extract_full.bak` | 0.177s |
| `sparse_full.bak` | 0.31s |
| `spatial_edge_full.bak` | 0.126s |
| `spatial_index_full.bak` | 0.129s |
| `sql_variant_extract_full.bak` | 0.115s |
| `striped_full_1.bak` | 0.14s |
| `striped_single.bak` | 0.145s |
| `surrogate_pairs_full.bak` | 0.108s |
| `tabletype_cci_large_full.bak` | 0.121s |
| `tabletypecoverage_diff.bak` | 25.667s |
| `tabletypecoverage_full.bak` | 22.388s |
| `temporal_hidden_full.bak` | 0.181s |
| `torn_page_full.bak` | 0.112s |
| `typecoverage_full.bak` | 0.315s |
| `typed_xml_full.bak` | 0.145s |
| `unicode_codepage_coverage.bak` | 0.365s |
| `utf8_collation_full.bak` | 0.14s |
| `xml_index_full.bak` | 0.118s |
| `xmlcoverage_full.bak` | 0.106s |
| `xmlheap_full.bak` | 0.318s |

---

_Generated 2026-07-09 · 130 fixtures · 130 pass · 0 xfail · 0 fail_
