...
| Backup | Wall time |
|--------|-------------|
| `alias_types_full.bak` | 0.087s |
| `archive_columnstore_partition_full.bak` | 2.44s |
| `archive_columnstore_types_full.bak` | 1.332s |
| `archive_columnstore_types_random_full.bak` | 1.339s |
| `archive_single_chunk_full.bak` | 0.114s |
| `archive_single_chunk_random_full.bak` | 0.099s |
| `archivenull_full.bak` | 0.306s |
| `backup_blocksize_full.bak` | 0.103s |
| `boundarycoverage_datetime_full.bak` | 0.415s |
| `boundarycoverage_full.bak` | 0.221s |
| `catalog_ss2019.bak` | 0.084s |
| `cci_binary_varbinary_compare_full.bak` | 0.099s |
| `cci_bitpack_probe_bigint_full.bak` | 6.681s |
| `cci_bitpack_probe_full.bak` | 0.91s |
| `cci_bitpack_probe_highbase_full.bak` | 0.886s |
| `cci_btree_nci_full.bak` | 0.118s |
| `cci_computed_full.bak` | 0.112s |
| `cci_enc5_largepool_full.bak` | 1.371s |
| `cci_enc5_largepool_matrix_full.bak` | 9.833s |
| `cci_extended_full.bak` | 0.142s |
| `cci_lob_full.bak` | 0.132s |
| `cci_reorganize_full.bak` | 0.114s |
| `cci_string_dict_regression_full.bak` | 0.565s |
| `cci_string_minmax_full.bak` | 0.112s |
| `cci_switch_full.bak` | 0.116s |
| `cci_types_large_full.bak` | 0.26s |
| `cci_varbinary_micro_full.bak` | 0.109s |
| `cci_varbinary_probe_full.bak` | 0.133s |
| `columnstore_minimal.bak` | 1.661s |
| `compressed_nvarchar_full.bak` | 0.094s |
| `compressioncoverage_full.bak` | 0.363s |
| `computedcoverage_full.bak` | 0.091s |
| `constraintcoverage_full.bak` | 0.101s |
| `covering_index_full.bak` | 0.154s |
| `cs_lob_preamble.bak` | 0.178s |
| `delta_rowgroup_full.bak` | 0.11s |
| `dirtycoverage_aborted_xact.bak` | 0.237s |
| `dirtycoverage_addcol.bak` | 0.091s |
| `dirtycoverage_addnotnull.bak` | 0.113s |
...
| `dirtycoverage_cci_delete.bak` | 0.228s |
| `dirtycoverage_cci_update.bak` | 0.34s |
| `dirtycoverage_committed_delete.bak` | 0.082s |
| `dirtycoverage_committed_delete_v2.bak` | 0.102s |
| `dirtycoverage_committed_delete_v3.bak` | 0.146s |
| `dirtycoverage_committed_delete_v4.bak` | 0.35s |
...
| `dirtycoverage_createidx.bak` | 0.09s |
| `dirtycoverage_createtable.bak` | 0.096s |
| `dirtycoverage_delete.bak` | 0.11s |
| `dirtycoverage_dropcol.bak` | 0.085s |
| `dirtycoverage_dropidx.bak` | 0.11s |
| `dirtycoverage_droptable.bak` | 0.105s |
| `dirtycoverage_heap_forward.bak` | 0.113s |
| `dirtycoverage_large_dirty.bak` | 0.388s |
| `dirtycoverage_lob_update.bak` | 0.127s |
| `dirtycoverage_maxrow.bak` | 0.082s |
| `dirtycoverage_nchar_delete.bak` | 0.112s |
| `dirtycoverage_nested.bak` | 0.113s |
| `dirtycoverage_null_update.bak` | 0.115s |
| `dirtycoverage_rebuildidx.bak` | 0.101s |
| `dirtycoverage_rich_insert.bak` | 0.124s |
| `dirtycoverage_rich_update.bak` | 0.118s |
| `dirtycoverage_savepoint.bak` | 0.117s |
| `dirtycoverage_snapshot_update.bak` | 0.12s |
| `dirtycoverage_switch.bak` | 0.095s |
| `dirtycoverage_temporal_update.bak` | 0.124s |
| `dirtycoverage_truncate.bak` | 0.102s |
| `dirtycoverage_two_tx.bak` | 0.11s |
| `dirtycoverage_uncommitted.bak` | 0.117s |
| `dirtycoverage_update.bak` | 0.116s |
| `filtered_ncci_full.bak` | 0.104s |
| `float_extreme_full.bak` | 0.088s |
| `forwarded_records_full.bak` | 0.199s |
| `ghost_records_full.bak` | 0.097s |
| `heapcoverage_large.bak` | 0.109s |
| `heapcoverage_large_50000.bak` | 1.409s |
| `hierarchyid_extract_full.bak` | 0.097s |
| `high_slot_density_full.bak` | 0.581s |
| `incrementalcoverage_diff_01.bak` | 0.096s |
| `incrementalcoverage_diff_02.bak` | 0.105s |
| `incrementalcoverage_diff_03.bak` | 0.088s |
| `incrementalcoverage_diff_04.bak` | 0.105s |
| `incrementalcoverage_diff_05.bak` | 0.106s |
| `incrementalcoverage_diff_06.bak` | 0.125s |
| `incrementalcoverage_full.bak` | 0.087s |
| `layoutcoverage_full.bak` | 0.388s |
| `max_row_width_full.bak` | 0.096s |
| `mixed_collation_full.bak` | 0.085s |
| `multi_rowgroup_full.bak` | 0.119s |
| `ncci_heap_full.bak` | 0.102s |
| `ncci_types_full.bak` | 0.494s |
| `ndfcoverage_full.bak` | 0.101s |
| `nvarchar_max_u21_full.bak` | 0.112s |
| `pagecomp_anchor_full.bak` | 0.366s |
| `pagecomp_long_prefix_full.bak` | 0.087s |
| `pfor_columnstore_full.bak` | 2.302s |
| `pfor_columnstore_random_full.bak` | 2.257s |
| `realworld_numeric_digest_full.bak` | 0.211s |
| `rowboundary_full.bak` | 0.093s |
| `rowstore_hash_pii_full.bak` | 0.081s |
| `rowstore_lob_image_full.bak` | 0.094s |
| `rowstore_lob_markup_full.bak` | 0.08s |
| `rowversion_extract_full.bak` | 0.092s |
| `sparse_full.bak` | 0.306s |
| `spatial_edge_full.bak` | 0.088s |
| `spatial_index_full.bak` | 0.095s |
| `sql_variant_extract_full.bak` | 0.088s |
| `striped_full_1.bak` | 0.107s |
| `striped_single.bak` | 0.215s |
| `surrogate_pairs_full.bak` | 0.082s |
| `tabletype_cci_large_full.bak` | 0.252s |
| `tabletypecoverage_diff.bak` | 0.202s |
| `tabletypecoverage_full.bak` | 0.19s |
| `temporal_hidden_full.bak` | 0.088s |
| `torn_page_full.bak` | 0.104s |
| `typecoverage_full.bak` | 0.153s |
| `typed_xml_full.bak` | 0.084s |
| `unicode_codepage_coverage.bak` | 0.131s |
| `utf8_collation_full.bak` | 0.09s |
| `xml_index_full.bak` | 0.096s |
| `xmlcoverage_full.bak` | 0.082s |
| `xmlheap_full.bak` | 0.126s |
