...
|--------|---------|--------|-----------|
| `alias_types_full.bak` | 0.041s | 0.029s | 0.07s |
| `archive_columnstore_partition_full.bak` | 0.955s | 0.632s | 1.587s |
| `archive_columnstore_types_full.bak` | 0.334s | 0.695s | 1.029s |
| `archive_columnstore_types_random_full.bak` | 0.359s | 0.703s | 1.062s |
| `archive_single_chunk_full.bak` | 0.047s | 0.032s | 0.079s |
| `archive_single_chunk_random_full.bak` | 0.045s | 0.032s | 0.077s |
| `archivenull_full.bak` | 0.127s | 0.085s | 0.212s |
| `backup_blocksize_full.bak` | 0.045s | 0.03s | 0.075s |
| `boundarycoverage_datetime_full.bak` | 0.078s | 0.155s | 0.233s |
| `boundarycoverage_full.bak` | 0.062s | 0.06s | 0.122s |
| `catalog_ss2019.bak` | 0.039s | 0.029s | 0.068s |
| `cci_binary_varbinary_compare_full.bak` | 0.047s | 0.033s | 0.08s |
| `cci_bitpack_probe_bigint_full.bak` | 2.238s | 3.641s | 5.879s |
| `cci_bitpack_probe_full.bak` | 0.119s | 0.645s | 0.764s |
| `cci_bitpack_probe_highbase_full.bak` | 0.107s | 0.419s | 0.526s |
| `cci_btree_nci_full.bak` | 0.051s | 0.036s | 0.087s |
| `cci_computed_full.bak` | 0.046s | 0.033s | 0.079s |
| `cci_enc5_largepool_full.bak` | 0.371s | 0.429s | 0.8s |
| `cci_enc5_largepool_matrix_full.bak` | 7.024s | 1.22s | 8.244s |
| `cci_extended_full.bak` | 0.065s | 0.042s | 0.107s |
| `cci_lob_full.bak` | 0.055s | 0.036s | 0.091s |
| `cci_reorganize_full.bak` | 0.053s | 0.033s | 0.086s |
| `cci_string_dict_regression_full.bak` | 0.327s | 0.148s | 0.475s |
| `cci_string_minmax_full.bak` | 0.063s | 0.033s | 0.096s |
| `cci_switch_full.bak` | 0.048s | 0.033s | 0.081s |
| `cci_types_large_full.bak` | 0.061s | 0.04s | 0.101s |
| `cci_varbinary_micro_full.bak` | 0.057s | 0.031s | 0.088s |
| `cci_varbinary_probe_full.bak` | 0.053s | 0.042s | 0.095s |
| `columnstore_minimal.bak` | 0.119s | 0.868s | 0.987s |
| `compressed_nvarchar_full.bak` | 0.041s | 0.028s | 0.069s |
| `compressioncoverage_full.bak` | 0.098s | 0.168s | 0.266s |
| `computedcoverage_full.bak` | 0.046s | 0.03s | 0.076s |
| `constraintcoverage_full.bak` | 0.049s | 0.034s | 0.083s |
| `covering_index_full.bak` | 0.046s | 0.033s | 0.079s |
| `cs_lob_preamble.bak` | 0.101s | 0.056s | 0.157s |
| `delta_rowgroup_full.bak` | 0.048s | 0.03s | 0.078s |
| `dirtycoverage_aborted_xact.bak` | 0.066s | 0.029s | 0.095s |
| `dirtycoverage_addcol.bak` | 0.043s | 0.029s | 0.072s |
| `dirtycoverage_addnotnull.bak` | 0.045s | 0.03s | 0.075s |
| `dirtycoverage_alldirty.bak` | 0.069s | 0.034s | 0.103s |
| `dirtycoverage_altercol.bak` | 0.04s | 0.029s | 0.069s |
| `dirtycoverage_altercol_rewrite.bak` | 0.042s | 0.029s | 0.071s |
| `dirtycoverage_alterdb.bak` | 0.043s | 0.029s | 0.072s |
| `dirtycoverage_cci_delete.bak` | 0.106s | 0.085s | 0.191s |
| `dirtycoverage_cci_update.bak` | 0.21s | 0.094s | 0.304s |
| `dirtycoverage_committed_delete.bak` | 0.041s | 0.033s | 0.074s |
| `dirtycoverage_committed_delete_v2.bak` | 0.05s | 0.031s | 0.081s |
| `dirtycoverage_committed_delete_v3.bak` | 0.055s | 0.056s | 0.111s |
| `dirtycoverage_committed_delete_v4.bak` | 0.158s | 0.066s | 0.224s |
| `dirtycoverage_committed_update.bak` | 0.063s | 0.039s | 0.102s |
| `dirtycoverage_committed_update_v2.bak` | 0.045s | 0.032s | 0.077s |
| `dirtycoverage_committed_update_v3.bak` | 0.065s | 0.065s | 0.13s |
| `dirtycoverage_committed_update_v4.bak` | 0.171s | 0.071s | 0.242s |
| `dirtycoverage_concurrent.bak` | 0.046s | 0.03s | 0.076s |
| `dirtycoverage_createidx.bak` | 0.067s | 0.03s | 0.097s |
| `dirtycoverage_createtable.bak` | 0.044s | 0.029s | 0.073s |
| `dirtycoverage_delete.bak` | 0.067s | 0.029s | 0.096s |
| `dirtycoverage_dropcol.bak` | 0.042s | 0.029s | 0.071s |
| `dirtycoverage_dropidx.bak` | 0.043s | 0.03s | 0.073s |
| `dirtycoverage_droptable.bak` | 0.045s | 0.03s | 0.075s |
| `dirtycoverage_heap_forward.bak` | 0.067s | 0.029s | 0.096s |
| `dirtycoverage_large_dirty.bak` | 0.338s | 0.036s | 0.374s |
| `dirtycoverage_lob_update.bak` | 0.087s | 0.042s | 0.129s |
| `dirtycoverage_maxrow.bak` | 0.044s | 0.053s | 0.097s |
| `dirtycoverage_nchar_delete.bak` | 0.073s | 0.029s | 0.102s |
| `dirtycoverage_nested.bak` | 0.072s | 0.035s | 0.107s |
| `dirtycoverage_null_update.bak` | 0.067s | 0.034s | 0.101s |
| `dirtycoverage_rebuildidx.bak` | 0.044s | 0.033s | 0.077s |
| `dirtycoverage_rich_insert.bak` | 0.071s | 0.031s | 0.102s |
| `dirtycoverage_rich_update.bak` | 0.068s | 0.03s | 0.098s |
| `dirtycoverage_savepoint.bak` | 0.07s | 0.03s | 0.1s |
| `dirtycoverage_snapshot_update.bak` | 0.065s | 0.029s | 0.094s |
| `dirtycoverage_switch.bak` | 0.05s | 0.031s | 0.081s |
| `dirtycoverage_temporal_update.bak` | 0.078s | 0.03s | 0.108s |
| `dirtycoverage_truncate.bak` | 0.045s | 0.03s | 0.075s |
| `dirtycoverage_two_tx.bak` | 0.067s | 0.029s | 0.096s |
| `dirtycoverage_uncommitted.bak` | 0.07s | 0.029s | 0.099s |
| `dirtycoverage_update.bak` | 0.072s | 0.032s | 0.104s |
| `filtered_ncci_full.bak` | 0.058s | 0.033s | 0.091s |
| `float_extreme_full.bak` | 0.047s | 0.029s | 0.076s |
| `forwarded_records_full.bak` | 0.239s | 0.068s | 0.307s |
| `ghost_records_full.bak` | 0.041s | 0.033s | 0.074s |
| `heapcoverage_large.bak` | 0.05s | 0.035s | 0.085s |
| `heapcoverage_large_50000.bak` | 0.205s | 0.313s | 0.518s |
| `hierarchyid_extract_full.bak` | 0.043s | 0.029s | 0.072s |
| `high_slot_density_full.bak` | 0.077s | 0.189s | 0.266s |
| `identity_coverage_full.bak` | 0.046s | 0.032s | 0.078s |
| `incrementalcoverage_diff_01.bak` | 0.046s | 0.013s | 0.059s |
| `incrementalcoverage_diff_02.bak` | 0.051s | 0.016s | 0.067s |
| `incrementalcoverage_diff_03.bak` | 0.041s | 0.015s | 0.056s |
| `incrementalcoverage_diff_04.bak` | 0.043s | 0.01s | 0.053s |
| `incrementalcoverage_diff_05.bak` | 0.042s | 0.016s | 0.058s |
| `incrementalcoverage_diff_06.bak` | 0.046s | 0.01s | 0.056s |
| `incrementalcoverage_full.bak` | 0.039s | 0.034s | 0.073s |
| `layoutcoverage_full.bak` | 0.172s | 0.311s | 0.483s |
| `max_row_width_full.bak` | 0.047s | 0.028s | 0.075s |
| `mixed_collation_full.bak` | 0.051s | 0.029s | 0.08s |
| `multi_rowgroup_full.bak` | 0.057s | 0.04s | 0.097s |
| `ncci_heap_full.bak` | 0.048s | 0.031s | 0.079s |
| `ncci_types_full.bak` | 0.121s | 0.175s | 0.296s |
| `ndfcoverage_full.bak` | 0.053s | 0.031s | 0.084s |
| `nvarchar_max_u21_full.bak` | 0.048s | 0.03s | 0.078s |
| `pagecomp_anchor_full.bak` | 0.132s | 0.09s | 0.222s |
| `pagecomp_long_prefix_full.bak` | 0.039s | 0.028s | 0.067s |
| `pfor_columnstore_full.bak` | 0.132s | 0.843s | 0.975s |
| `pfor_columnstore_random_full.bak` | 0.126s | 0.847s | 0.973s |
| `realworld_numeric_digest_full.bak` | 0.057s | 0.078s | 0.135s |
| `rowboundary_full.bak` | 0.058s | 0.032s | 0.09s |
| `rowstore_hash_pii_full.bak` | 0.04s | 0.031s | 0.071s |
| `rowstore_lob_image_full.bak` | 0.06s | 0.043s | 0.103s |
| `rowstore_lob_markup_full.bak` | 0.043s | 0.029s | 0.072s |
| `rowversion_extract_full.bak` | 0.045s | 0.032s | 0.077s |
| `sparse_full.bak` | 0.098s | 0.083s | 0.181s |
| `spatial_edge_full.bak` | 0.042s | 0.03s | 0.072s |
| `spatial_index_full.bak` | 0.046s | 0.031s | 0.077s |
| `sql_variant_extract_full.bak` | 0.046s | 0.029s | 0.075s |
| `striped_full_1.bak` | 0.048s | 0.018s | 0.066s |
| `striped_single.bak` | 0.075s | 0.042s | 0.117s |
| `surrogate_pairs_full.bak` | 0.04s | 0.028s | 0.068s |
| `tabletype_cci_large_full.bak` | 0.069s | 0.044s | 0.113s |
| `tabletypecoverage_diff.bak` | 0.094s | 0.066s | 0.16s |
| `tabletypecoverage_full.bak` | 0.181s | 0.089s | 0.27s |
| `temporal_hidden_full.bak` | 0.042s | 0.032s | 0.074s |
| `torn_page_full.bak` | 0.04s | 0.041s | 0.081s |
| `typecoverage_full.bak` | 0.114s | 0.067s | 0.181s |
| `typed_xml_full.bak` | 0.043s | 0.029s | 0.072s |
| `unicode_codepage_coverage.bak` | 0.066s | 0.041s | 0.107s |
| `utf8_collation_full.bak` | 0.044s | 0.03s | 0.074s |
| `xml_index_full.bak` | 0.051s | 0.031s | 0.082s |
| `xmlcoverage_full.bak` | 0.04s | 0.029s | 0.069s |
| `xmlheap_full.bak` | 0.103s | 0.047s | 0.15s |
