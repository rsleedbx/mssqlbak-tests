...
|--------|---------|--------|-----------|
| `alias_types_full.bak` | 0.041s | 0.034s | 0.075s |
| `archive_columnstore_partition_full.bak` | 0.949s | 0.881s | 1.83s |
| `archive_columnstore_types_full.bak` | 0.331s | 0.653s | 0.984s |
| `archive_columnstore_types_random_full.bak` | 0.33s | 0.662s | 0.992s |
| `archive_single_chunk_full.bak` | 0.046s | 0.039s | 0.085s |
| `archive_single_chunk_random_full.bak` | 0.047s | 0.039s | 0.086s |
| `archivenull_full.bak` | 0.13s | 0.108s | 0.238s |
| `backup_blocksize_full.bak` | 0.046s | 0.035s | 0.081s |
| `boundarycoverage_datetime_full.bak` | 0.075s | 0.176s | 0.251s |
| `boundarycoverage_full.bak` | 0.065s | 0.084s | 0.149s |
| `catalog_ss2019.bak` | 0.044s | 0.03s | 0.074s |
| `cci_binary_varbinary_compare_full.bak` | 0.045s | 0.031s | 0.076s |
| `cci_bitpack_probe_bigint_full.bak` | 0s | 5.842s | 5.842s |
| `cci_bitpack_probe_full.bak` | 0s | 0.619s | 0.619s |
| `cci_bitpack_probe_highbase_full.bak` | 0s | 0.555s | 0.555s |
| `cci_btree_nci_full.bak` | 0.049s | 0.043s | 0.092s |
| `cci_computed_full.bak` | 0.049s | 0.041s | 0.09s |
| `cci_enc5_largepool_full.bak` | 0.373s | 0.469s | 0.842s |
| `cci_enc5_largepool_matrix_full.bak` | 7.194s | 1.365s | 8.559s |
| `cci_extended_full.bak` | 0.07s | 0.052s | 0.122s |
| `cci_lob_full.bak` | 0.053s | 0.04s | 0.093s |
| `cci_reorganize_full.bak` | 0.052s | 0.04s | 0.092s |
| `cci_string_dict_regression_full.bak` | 0.341s | 0.152s | 0.493s |
| `cci_string_minmax_full.bak` | 0.054s | 0.035s | 0.089s |
| `cci_switch_full.bak` | 0.047s | 0.038s | 0.085s |
| `cci_types_large_full.bak` | 0.062s | 0.041s | 0.103s |
| `cci_varbinary_micro_full.bak` | 0.059s | 0.033s | 0.092s |
| `cci_varbinary_probe_full.bak` | 0.056s | 0.039s | 0.095s |
| `columnstore_minimal.bak` | 0.119s | 0.775s | 0.894s |
| `compressed_nvarchar_full.bak` | 0.041s | 0.034s | 0.075s |
| `compressioncoverage_full.bak` | 0.1s | 0.173s | 0.273s |
| `computedcoverage_full.bak` | 0.04s | 0.035s | 0.075s |
| `constraintcoverage_full.bak` | 0.057s | 0.042s | 0.099s |
| `covering_index_full.bak` | 0.046s | 0.049s | 0.095s |
| `cs_lob_preamble.bak` | 0.1s | 0.057s | 0.157s |
| `delta_rowgroup_full.bak` | 0.052s | 0.03s | 0.082s |
| `dirtycoverage_aborted_xact.bak` | 0.065s | 0.04s | 0.105s |
| `dirtycoverage_addcol.bak` | 0.055s | 0.034s | 0.089s |
| `dirtycoverage_addnotnull.bak` | 0.044s | 0.034s | 0.078s |
| `dirtycoverage_alldirty.bak` | 0.077s | 0.029s | 0.106s |
| `dirtycoverage_altercol.bak` | 0.042s | 0.033s | 0.075s |
| `dirtycoverage_altercol_rewrite.bak` | 0.047s | 0.029s | 0.076s |
| `dirtycoverage_alterdb.bak` | 0.049s | 0.035s | 0.084s |
| `dirtycoverage_cci_delete.bak` | 0.103s | 0.081s | 0.184s |
| `dirtycoverage_cci_update.bak` | 0.259s | 0.155s | 0.414s |
| `dirtycoverage_committed_delete.bak` | 0.042s | 0.029s | 0.071s |
| `dirtycoverage_committed_delete_v2.bak` | 0.046s | 0.039s | 0.085s |
| `dirtycoverage_committed_delete_v3.bak` | 0.053s | 0.063s | 0.116s |
| `dirtycoverage_committed_delete_v4.bak` | 0.159s | 0.114s | 0.273s |
| `dirtycoverage_committed_update.bak` | 0.045s | 0.029s | 0.074s |
| `dirtycoverage_committed_update_v2.bak` | 0.051s | 0.035s | 0.086s |
| `dirtycoverage_committed_update_v3.bak` | 0.059s | 0.075s | 0.134s |
| `dirtycoverage_committed_update_v4.bak` | 0.157s | 0.129s | 0.286s |
| `dirtycoverage_concurrent.bak` | 0.05s | 0.031s | 0.081s |
| `dirtycoverage_createidx.bak` | 0.049s | 0.038s | 0.087s |
| `dirtycoverage_createtable.bak` | 0.045s | 0.036s | 0.081s |
| `dirtycoverage_delete.bak` | 0.074s | 0.031s | 0.105s |
| `dirtycoverage_dropcol.bak` | 0.044s | 0.034s | 0.078s |
| `dirtycoverage_dropidx.bak` | 0.048s | 0.031s | 0.079s |
| `dirtycoverage_droptable.bak` | 0.047s | 0.032s | 0.079s |
| `dirtycoverage_heap_forward.bak` | 0.072s | 0.031s | 0.103s |
| `dirtycoverage_large_dirty.bak` | 0.504s | 0.039s | 0.543s |
| `dirtycoverage_lob_update.bak` | 0.082s | 0.03s | 0.112s |
| `dirtycoverage_maxrow.bak` | 0.04s | 0.029s | 0.069s |
| `dirtycoverage_nchar_delete.bak` | 0.073s | 0.044s | 0.117s |
| `dirtycoverage_nested.bak` | 0.067s | 0.033s | 0.1s |
| `dirtycoverage_null_update.bak` | 0.067s | 0.029s | 0.096s |
| `dirtycoverage_rebuildidx.bak` | 0.045s | 0.036s | 0.081s |
| `dirtycoverage_rich_insert.bak` | 0.073s | 0.032s | 0.105s |
| `dirtycoverage_rich_update.bak` | 0.066s | 0.037s | 0.103s |
| `dirtycoverage_savepoint.bak` | 0.075s | 0.03s | 0.105s |
| `dirtycoverage_snapshot_update.bak` | 0.07s | 0.035s | 0.105s |
| `dirtycoverage_switch.bak` | 0.047s | 0.037s | 0.084s |
| `dirtycoverage_temporal_update.bak` | 0.069s | 0.03s | 0.099s |
| `dirtycoverage_truncate.bak` | 0.046s | 0.031s | 0.077s |
| `dirtycoverage_two_tx.bak` | 0.083s | 0.046s | 0.129s |
| `dirtycoverage_uncommitted.bak` | 0.066s | 0.031s | 0.097s |
| `dirtycoverage_update.bak` | 0.068s | 0.034s | 0.102s |
| `filtered_ncci_full.bak` | 0.05s | 0.043s | 0.093s |
| `float_extreme_full.bak` | 0.046s | 0.036s | 0.082s |
| `forwarded_records_full.bak` | 0.262s | 0.123s | 0.385s |
| `ghost_records_full.bak` | 0.045s | 0.03s | 0.075s |
| `heapcoverage_large.bak` | 0.049s | 0.043s | 0.092s |
| `heapcoverage_large_50000.bak` | 0.204s | 0.456s | 0.66s |
| `hierarchyid_extract_full.bak` | 0.048s | 0.029s | 0.077s |
| `high_slot_density_full.bak` | 0.067s | 0.238s | 0.305s |
| `incrementalcoverage_diff_01.bak` | 0.041s | 0.01s | 0.051s |
| `incrementalcoverage_diff_02.bak` | 0.049s | 0.011s | 0.06s |
| `incrementalcoverage_diff_03.bak` | 0.046s | 0.01s | 0.056s |
...
| `incrementalcoverage_full.bak` | 0.043s | 0.029s | 0.072s |
| `layoutcoverage_full.bak` | 0.181s | 0.265s | 0.446s |
| `max_row_width_full.bak` | 0.043s | 0.03s | 0.073s |
| `mixed_collation_full.bak` | 0.042s | 0.038s | 0.08s |
| `multi_rowgroup_full.bak` | 0.048s | 0.035s | 0.083s |
| `ncci_heap_full.bak` | 0.051s | 0.037s | 0.088s |
| `ncci_types_full.bak` | 0.134s | 0.264s | 0.398s |
| `ndfcoverage_full.bak` | 0.047s | 0.032s | 0.079s |
| `nvarchar_max_u21_full.bak` | 0.045s | 0.033s | 0.078s |
| `pagecomp_anchor_full.bak` | 0.128s | 0.145s | 0.273s |
| `pagecomp_long_prefix_full.bak` | 0.041s | 0.029s | 0.07s |
| `pfor_columnstore_full.bak` | 0.121s | 1.075s | 1.196s |
| `pfor_columnstore_random_full.bak` | 0.147s | 1.111s | 1.258s |
| `realworld_numeric_digest_full.bak` | 0.052s | 0.102s | 0.154s |
| `rowboundary_full.bak` | 0.048s | 0.038s | 0.086s |
| `rowstore_hash_pii_full.bak` | 0.045s | 0.032s | 0.077s |
| `rowstore_lob_image_full.bak` | 0.046s | 0.029s | 0.075s |
| `rowstore_lob_markup_full.bak` | 0.044s | 0.035s | 0.079s |
| `rowversion_extract_full.bak` | 0.048s | 0.03s | 0.078s |
| `sparse_full.bak` | 0.099s | 0.134s | 0.233s |
| `spatial_edge_full.bak` | 0.043s | 0.031s | 0.074s |
| `spatial_index_full.bak` | 0.048s | 0.037s | 0.085s |
| `sql_variant_extract_full.bak` | 0.039s | 0.029s | 0.068s |
| `striped_full_1.bak` | 0.052s | 0.013s | 0.065s |
| `striped_single.bak` | 0.085s | 0.046s | 0.131s |
| `surrogate_pairs_full.bak` | 0.043s | 0.043s | 0.086s |
| `tabletype_cci_large_full.bak` | 0.073s | 0.047s | 0.12s |
| `tabletypecoverage_diff.bak` | 0.092s | 0.067s | 0.159s |
...
| `typecoverage_full.bak` | 0.112s | 0.07s | 0.182s |
| `typed_xml_full.bak` | 0.043s | 0.03s | 0.073s |
| `unicode_codepage_coverage.bak` | 0.064s | 0.04s | 0.104s |
| `utf8_collation_full.bak` | 0.049s | 0.039s | 0.088s |
| `xml_index_full.bak` | 0.047s | 0.032s | 0.079s |
| `xmlcoverage_full.bak` | 0.042s | 0.035s | 0.077s |
| `xmlheap_full.bak` | 0.099s | 0.059s | 0.158s |
