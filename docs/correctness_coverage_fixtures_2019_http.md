...
| `archive_columnstore_partition_full.bak` | 0.991s | 0.639s | 1.63s |
| `archive_columnstore_types_full.bak` | 0.328s | 0.692s | 1.02s |
| `archive_columnstore_types_random_full.bak` | 0.383s | 0.72s | 1.103s |
| `archive_single_chunk_full.bak` | 0.048s | 0.037s | 0.085s |
| `archive_single_chunk_random_full.bak` | 0.046s | 0.033s | 0.079s |
| `archivenull_full.bak` | 0.143s | 0.091s | 0.234s |
| `backup_blocksize_full.bak` | 0.046s | 0.03s | 0.076s |
| `boundarycoverage_datetime_full.bak` | 0.074s | 0.152s | 0.226s |
| `boundarycoverage_full.bak` | 0.061s | 0.064s | 0.125s |
| `catalog_ss2019.bak` | 0.041s | 0.03s | 0.071s |
| `cci_binary_varbinary_compare_full.bak` | 0.046s | 0.032s | 0.078s |
| `cci_bitpack_probe_bigint_full.bak` | 2.309s | 3.735s | 6.044s |
| `cci_bitpack_probe_full.bak` | 0.128s | 0.641s | 0.769s |
| `cci_bitpack_probe_highbase_full.bak` | 0.124s | 0.418s | 0.542s |
| `cci_btree_nci_full.bak` | 0.058s | 0.063s | 0.121s |
| `cci_computed_full.bak` | 0.047s | 0.033s | 0.08s |
| `cci_enc5_largepool_full.bak` | 0.37s | 0.433s | 0.803s |
| `cci_enc5_largepool_matrix_full.bak` | 7.197s | 1.301s | 8.498s |
| `cci_extended_full.bak` | 0.072s | 0.042s | 0.114s |
| `cci_lob_full.bak` | 0.054s | 0.036s | 0.09s |
| `cci_reorganize_full.bak` | 0.055s | 0.045s | 0.1s |
| `cci_string_dict_regression_full.bak` | 0.348s | 0.15s | 0.498s |
| `cci_string_minmax_full.bak` | 0.057s | 0.033s | 0.09s |
| `cci_switch_full.bak` | 0.051s | 0.034s | 0.085s |
| `cci_types_large_full.bak` | 0.061s | 0.05s | 0.111s |
| `cci_varbinary_micro_full.bak` | 0.09s | 0.053s | 0.143s |
| `cci_varbinary_probe_full.bak` | 0.051s | 0.041s | 0.092s |
| `columnstore_minimal.bak` | 0.126s | 0.961s | 1.087s |
| `compressed_nvarchar_full.bak` | 0.042s | 0.03s | 0.072s |
| `compressioncoverage_full.bak` | 0.097s | 0.17s | 0.267s |
| `computedcoverage_full.bak` | 0.042s | 0.031s | 0.073s |
| `constraintcoverage_full.bak` | 0.049s | 0.035s | 0.084s |
| `covering_index_full.bak` | 0.046s | 0.035s | 0.081s |
| `cs_lob_preamble.bak` | 0.102s | 0.054s | 0.156s |
| `delta_rowgroup_full.bak` | 0.049s | 0.031s | 0.08s |
| `dirtycoverage_aborted_xact.bak` | 0.066s | 0.03s | 0.096s |
| `dirtycoverage_addcol.bak` | 0.044s | 0.03s | 0.074s |
| `dirtycoverage_addnotnull.bak` | 0.056s | 0.03s | 0.086s |
| `dirtycoverage_alldirty.bak` | 0.069s | 0.03s | 0.099s |
| `dirtycoverage_altercol.bak` | 0.042s | 0.029s | 0.071s |
| `dirtycoverage_altercol_rewrite.bak` | 0.045s | 0.029s | 0.074s |
| `dirtycoverage_alterdb.bak` | 0.044s | 0.03s | 0.074s |
| `dirtycoverage_cci_delete.bak` | 0.113s | 0.084s | 0.197s |
| `dirtycoverage_cci_update.bak` | 0.222s | 0.089s | 0.311s |
| `dirtycoverage_committed_delete.bak` | 0.041s | 0.029s | 0.07s |
| `dirtycoverage_committed_delete_v2.bak` | 0.049s | 0.037s | 0.086s |
| `dirtycoverage_committed_delete_v3.bak` | 0.055s | 0.055s | 0.11s |
| `dirtycoverage_committed_delete_v4.bak` | 0.162s | 0.064s | 0.226s |
| `dirtycoverage_committed_update.bak` | 0.048s | 0.04s | 0.088s |
| `dirtycoverage_committed_update_v2.bak` | 0.047s | 0.032s | 0.079s |
| `dirtycoverage_committed_update_v3.bak` | 0.062s | 0.067s | 0.129s |
| `dirtycoverage_committed_update_v4.bak` | 0.168s | 0.068s | 0.236s |
| `dirtycoverage_concurrent.bak` | 0.046s | 0.029s | 0.075s |
| `dirtycoverage_createidx.bak` | 0.051s | 0.032s | 0.083s |
| `dirtycoverage_createtable.bak` | 0.046s | 0.029s | 0.075s |
| `dirtycoverage_delete.bak` | 0.065s | 0.029s | 0.094s |
| `dirtycoverage_dropcol.bak` | 0.047s | 0.03s | 0.077s |
| `dirtycoverage_dropidx.bak` | 0.047s | 0.029s | 0.076s |
| `dirtycoverage_droptable.bak` | 0.048s | 0.034s | 0.082s |
| `dirtycoverage_heap_forward.bak` | 0.068s | 0.03s | 0.098s |
| `dirtycoverage_large_dirty.bak` | 0.364s | 0.04s | 0.404s |
| `dirtycoverage_lob_update.bak` | 0.091s | 0.035s | 0.126s |
| `dirtycoverage_maxrow.bak` | 0.045s | 0.03s | 0.075s |
| `dirtycoverage_nchar_delete.bak` | 0.075s | 0.037s | 0.112s |
| `dirtycoverage_nested.bak` | 0.07s | 0.029s | 0.099s |
| `dirtycoverage_null_update.bak` | 0.071s | 0.037s | 0.108s |
| `dirtycoverage_rebuildidx.bak` | 0.045s | 0.03s | 0.075s |
| `dirtycoverage_rich_insert.bak` | 0.075s | 0.033s | 0.108s |
| `dirtycoverage_rich_update.bak` | 0.071s | 0.033s | 0.104s |
| `dirtycoverage_savepoint.bak` | 0.073s | 0.037s | 0.11s |
| `dirtycoverage_snapshot_update.bak` | 0.065s | 0.029s | 0.094s |
| `dirtycoverage_switch.bak` | 0.051s | 0.037s | 0.088s |
| `dirtycoverage_temporal_update.bak` | 0.074s | 0.03s | 0.104s |
| `dirtycoverage_truncate.bak` | 0.047s | 0.03s | 0.077s |
| `dirtycoverage_two_tx.bak` | 0.071s | 0.029s | 0.1s |
| `dirtycoverage_uncommitted.bak` | 0.071s | 0.031s | 0.102s |
| `dirtycoverage_update.bak` | 0.07s | 0.03s | 0.1s |
| `filtered_ncci_full.bak` | 0.066s | 0.042s | 0.108s |
| `float_extreme_full.bak` | 0.044s | 0.04s | 0.084s |
| `forwarded_records_full.bak` | 0.245s | 0.068s | 0.313s |
| `ghost_records_full.bak` | 0.044s | 0.032s | 0.076s |
| `heapcoverage_large.bak` | 0.046s | 0.038s | 0.084s |
| `heapcoverage_large_50000.bak` | 0.206s | 0.328s | 0.534s |
| `hierarchyid_extract_full.bak` | 0.044s | 0.03s | 0.074s |
| `high_slot_density_full.bak` | 0.076s | 0.185s | 0.261s |
...
| `incrementalcoverage_diff_03.bak` | 0.046s | 0.011s | 0.057s |
| `incrementalcoverage_diff_04.bak` | 0.043s | 0.01s | 0.053s |
| `incrementalcoverage_diff_05.bak` | 0.044s | 0.01s | 0.054s |
| `incrementalcoverage_diff_06.bak` | 0.051s | 0.011s | 0.062s |
| `incrementalcoverage_full.bak` | 0.041s | 0.035s | 0.076s |
| `layoutcoverage_full.bak` | 0.189s | 0.362s | 0.551s |
| `max_row_width_full.bak` | 0.044s | 0.029s | 0.073s |
| `mixed_collation_full.bak` | 0.042s | 0.029s | 0.071s |
| `multi_rowgroup_full.bak` | 0.051s | 0.034s | 0.085s |
| `ncci_heap_full.bak` | 0.049s | 0.032s | 0.081s |
| `ncci_types_full.bak` | 0.12s | 0.189s | 0.309s |
| `ndfcoverage_full.bak` | 0.057s | 0.033s | 0.09s |
| `nvarchar_max_u21_full.bak` | 0.045s | 0.029s | 0.074s |
| `pagecomp_anchor_full.bak` | 0.136s | 0.087s | 0.223s |
| `pagecomp_long_prefix_full.bak` | 0.041s | 0.029s | 0.07s |
| `pfor_columnstore_full.bak` | 0.126s | 0.85s | 0.976s |
| `pfor_columnstore_random_full.bak` | 0.123s | 0.822s | 0.945s |
| `realworld_numeric_digest_full.bak` | 0.058s | 0.081s | 0.139s |
| `rowboundary_full.bak` | 0.081s | 0.042s | 0.123s |
| `rowstore_hash_pii_full.bak` | 0.042s | 0.031s | 0.073s |
| `rowstore_lob_image_full.bak` | 0.049s | 0.038s | 0.087s |
| `rowstore_lob_markup_full.bak` | 0.041s | 0.029s | 0.07s |
| `rowversion_extract_full.bak` | 0.045s | 0.031s | 0.076s |
| `sparse_full.bak` | 0.109s | 0.083s | 0.192s |
| `spatial_edge_full.bak` | 0.042s | 0.031s | 0.073s |
| `spatial_index_full.bak` | 0.049s | 0.032s | 0.081s |
| `sql_variant_extract_full.bak` | 0.041s | 0.029s | 0.07s |
| `striped_full_1.bak` | 0.049s | 0.013s | 0.062s |
| `striped_single.bak` | 0.077s | 0.041s | 0.118s |
| `surrogate_pairs_full.bak` | 0.04s | 0.03s | 0.07s |
| `tabletype_cci_large_full.bak` | 0.072s | 0.043s | 0.115s |
| `tabletypecoverage_diff.bak` | 0.1s | 0.072s | 0.172s |
| `tabletypecoverage_full.bak` | 0.185s | 0.092s | 0.277s |
| `temporal_hidden_full.bak` | 0.045s | 0.033s | 0.078s |
| `torn_page_full.bak` | 0.043s | 0.031s | 0.074s |
| `typecoverage_full.bak` | 0.112s | 0.064s | 0.176s |
| `typed_xml_full.bak` | 0.045s | 0.029s | 0.074s |
| `unicode_codepage_coverage.bak` | 0.076s | 0.041s | 0.117s |
| `utf8_collation_full.bak` | 0.043s | 0.031s | 0.074s |
| `xml_index_full.bak` | 0.049s | 0.032s | 0.081s |
| `xmlcoverage_full.bak` | 0.041s | 0.03s | 0.071s |
| `xmlheap_full.bak` | 0.102s | 0.056s | 0.158s |
