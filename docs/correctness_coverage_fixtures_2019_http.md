...
|--------|---------|--------|-----------|
| `alias_types_full.bak` | 0.045s | 0.038s | 0.083s |
| `archive_columnstore_partition_full.bak` | 0.984s | 0.625s | 1.609s |
| `archive_columnstore_types_full.bak` | 0.337s | 0.719s | 1.056s |
| `archive_columnstore_types_random_full.bak` | 0.368s | 0.728s | 1.096s |
| `archive_single_chunk_full.bak` | 0.047s | 0.034s | 0.081s |
| `archive_single_chunk_random_full.bak` | 0.061s | 0.042s | 0.103s |
| `archivenull_full.bak` | 0.134s | 0.09s | 0.224s |
| `backup_blocksize_full.bak` | 0.047s | 0.035s | 0.082s |
| `boundarycoverage_datetime_full.bak` | 0.074s | 0.147s | 0.221s |
| `boundarycoverage_full.bak` | 0.059s | 0.063s | 0.122s |
| `catalog_ss2019.bak` | 0.043s | 0.032s | 0.075s |
| `cci_binary_varbinary_compare_full.bak` | 0.045s | 0.033s | 0.078s |
| `cci_bitpack_probe_bigint_full.bak` | 2.275s | 3.863s | 6.138s |
| `cci_bitpack_probe_full.bak` | 0.122s | 0.648s | 0.77s |
| `cci_bitpack_probe_highbase_full.bak` | 0.113s | 0.473s | 0.586s |
| `cci_btree_nci_full.bak` | 0.048s | 0.039s | 0.087s |
| `cci_computed_full.bak` | 0.048s | 0.045s | 0.093s |
| `cci_enc5_largepool_full.bak` | 0.374s | 0.442s | 0.816s |
| `cci_enc5_largepool_matrix_full.bak` | 7.221s | 1.242s | 8.463s |
| `cci_extended_full.bak` | 0.067s | 0.042s | 0.109s |
| `cci_lob_full.bak` | 0.056s | 0.041s | 0.097s |
| `cci_reorganize_full.bak` | 0.052s | 0.032s | 0.084s |
| `cci_string_dict_regression_full.bak` | 0.339s | 0.176s | 0.515s |
| `cci_string_minmax_full.bak` | 0.057s | 0.034s | 0.091s |
| `cci_switch_full.bak` | 0.051s | 0.035s | 0.086s |
| `cci_types_large_full.bak` | 0.065s | 0.039s | 0.104s |
| `cci_varbinary_micro_full.bak` | 0.05s | 0.04s | 0.09s |
| `cci_varbinary_probe_full.bak` | 0.058s | 0.042s | 0.1s |
| `columnstore_minimal.bak` | 0.122s | 0.978s | 1.1s |
| `compressed_nvarchar_full.bak` | 0.04s | 0.035s | 0.075s |
| `compressioncoverage_full.bak` | 0.1s | 0.174s | 0.274s |
| `computedcoverage_full.bak` | 0.041s | 0.035s | 0.076s |
| `constraintcoverage_full.bak` | 0.048s | 0.042s | 0.09s |
| `covering_index_full.bak` | 0.046s | 0.038s | 0.084s |
| `cs_lob_preamble.bak` | 0.102s | 0.055s | 0.157s |
| `delta_rowgroup_full.bak` | 0.051s | 0.031s | 0.082s |
| `dirtycoverage_aborted_xact.bak` | 0.074s | 0.03s | 0.104s |
| `dirtycoverage_addcol.bak` | 0.048s | 0.04s | 0.088s |
| `dirtycoverage_addnotnull.bak` | 0.046s | 0.03s | 0.076s |
| `dirtycoverage_alldirty.bak` | 0.068s | 0.033s | 0.101s |
| `dirtycoverage_altercol.bak` | 0.044s | 0.035s | 0.079s |
| `dirtycoverage_altercol_rewrite.bak` | 0.043s | 0.03s | 0.073s |
| `dirtycoverage_alterdb.bak` | 0.048s | 0.034s | 0.082s |
| `dirtycoverage_cci_delete.bak` | 0.113s | 0.083s | 0.196s |
| `dirtycoverage_cci_update.bak` | 0.222s | 0.097s | 0.319s |
| `dirtycoverage_committed_delete.bak` | 0.044s | 0.032s | 0.076s |
| `dirtycoverage_committed_delete_v2.bak` | 0.051s | 0.035s | 0.086s |
| `dirtycoverage_committed_delete_v3.bak` | 0.055s | 0.053s | 0.108s |
| `dirtycoverage_committed_delete_v4.bak` | 0.165s | 0.068s | 0.233s |
| `dirtycoverage_committed_update.bak` | 0.042s | 0.03s | 0.072s |
| `dirtycoverage_committed_update_v2.bak` | 0.048s | 0.032s | 0.08s |
| `dirtycoverage_committed_update_v3.bak` | 0.057s | 0.059s | 0.116s |
| `dirtycoverage_committed_update_v4.bak` | 0.164s | 0.069s | 0.233s |
| `dirtycoverage_concurrent.bak` | 0.046s | 0.036s | 0.082s |
| `dirtycoverage_createidx.bak` | 0.045s | 0.03s | 0.075s |
| `dirtycoverage_createtable.bak` | 0.046s | 0.035s | 0.081s |
| `dirtycoverage_delete.bak` | 0.07s | 0.029s | 0.099s |
| `dirtycoverage_dropcol.bak` | 0.047s | 0.03s | 0.077s |
| `dirtycoverage_dropidx.bak` | 0.05s | 0.031s | 0.081s |
| `dirtycoverage_droptable.bak` | 0.045s | 0.037s | 0.082s |
| `dirtycoverage_heap_forward.bak` | 0.075s | 0.029s | 0.104s |
| `dirtycoverage_large_dirty.bak` | 0.354s | 0.039s | 0.393s |
| `dirtycoverage_lob_update.bak` | 0.086s | 0.03s | 0.116s |
| `dirtycoverage_maxrow.bak` | 0.041s | 0.041s | 0.082s |
| `dirtycoverage_nchar_delete.bak` | 0.068s | 0.029s | 0.097s |
| `dirtycoverage_nested.bak` | 0.071s | 0.03s | 0.101s |
| `dirtycoverage_null_update.bak` | 0.07s | 0.031s | 0.101s |
| `dirtycoverage_rebuildidx.bak` | 0.049s | 0.04s | 0.089s |
| `dirtycoverage_rich_insert.bak` | 0.07s | 0.035s | 0.105s |
| `dirtycoverage_rich_update.bak` | 0.071s | 0.031s | 0.102s |
| `dirtycoverage_savepoint.bak` | 0.067s | 0.034s | 0.101s |
| `dirtycoverage_snapshot_update.bak` | 0.063s | 0.031s | 0.094s |
| `dirtycoverage_switch.bak` | 0.05s | 0.033s | 0.083s |
| `dirtycoverage_temporal_update.bak` | 0.073s | 0.03s | 0.103s |
| `dirtycoverage_truncate.bak` | 0.05s | 0.039s | 0.089s |
| `dirtycoverage_two_tx.bak` | 0.069s | 0.03s | 0.099s |
| `dirtycoverage_uncommitted.bak` | 0.069s | 0.03s | 0.099s |
| `dirtycoverage_update.bak` | 0.072s | 0.03s | 0.102s |
| `filtered_ncci_full.bak` | 0.051s | 0.038s | 0.089s |
| `float_extreme_full.bak` | 0.048s | 0.029s | 0.077s |
| `forwarded_records_full.bak` | 0.258s | 0.082s | 0.34s |
| `ghost_records_full.bak` | 0.043s | 0.032s | 0.075s |
| `heapcoverage_large.bak` | 0.044s | 0.038s | 0.082s |
| `heapcoverage_large_50000.bak` | 0.205s | 0.339s | 0.544s |
| `hierarchyid_extract_full.bak` | 0.045s | 0.031s | 0.076s |
| `high_slot_density_full.bak` | 0.073s | 0.191s | 0.264s |
| `identity_coverage_full.bak` | 0.046s | 0.032s | 0.078s |
| `incrementalcoverage_diff_01.bak` | 0.048s | 0.016s | 0.064s |
| `incrementalcoverage_diff_02.bak` | 0.048s | 0.011s | 0.059s |
| `incrementalcoverage_diff_03.bak` | 0.043s | 0.01s | 0.053s |
| `incrementalcoverage_diff_04.bak` | 0.048s | 0.015s | 0.063s |
| `incrementalcoverage_diff_05.bak` | 0.045s | 0.011s | 0.056s |
| `incrementalcoverage_diff_06.bak` | 0.051s | 0.01s | 0.061s |
| `incrementalcoverage_full.bak` | 0.043s | 0.03s | 0.073s |
| `layoutcoverage_full.bak` | 0.177s | 0.358s | 0.535s |
| `max_row_width_full.bak` | 0.041s | 0.029s | 0.07s |
| `mixed_collation_full.bak` | 0.045s | 0.038s | 0.083s |
| `multi_rowgroup_full.bak` | 0.055s | 0.035s | 0.09s |
| `ncci_heap_full.bak` | 0.049s | 0.032s | 0.081s |
| `ncci_types_full.bak` | 0.136s | 0.206s | 0.342s |
| `ndfcoverage_full.bak` | 0.054s | 0.032s | 0.086s |
| `nvarchar_max_u21_full.bak` | 0.047s | 0.036s | 0.083s |
| `pagecomp_anchor_full.bak` | 0.137s | 0.096s | 0.233s |
| `pagecomp_long_prefix_full.bak` | 0.045s | 0.037s | 0.082s |
| `pfor_columnstore_full.bak` | 0.129s | 0.817s | 0.946s |
| `pfor_columnstore_random_full.bak` | 0.122s | 0.841s | 0.963s |
| `realworld_numeric_digest_full.bak` | 0.063s | 0.077s | 0.14s |
| `rowboundary_full.bak` | 0.054s | 0.044s | 0.098s |
| `rowstore_hash_pii_full.bak` | 0.05s | 0.037s | 0.087s |
| `rowstore_lob_image_full.bak` | 0.048s | 0.031s | 0.079s |
| `rowstore_lob_markup_full.bak` | 0.042s | 0.03s | 0.072s |
| `rowversion_extract_full.bak` | 0.047s | 0.03s | 0.077s |
| `sparse_full.bak` | 0.101s | 0.086s | 0.187s |
| `spatial_edge_full.bak` | 0.047s | 0.037s | 0.084s |
| `spatial_index_full.bak` | 0.05s | 0.037s | 0.087s |
| `sql_variant_extract_full.bak` | 0.043s | 0.03s | 0.073s |
| `striped_full_1.bak` | 0.049s | 0.013s | 0.062s |
| `striped_single.bak` | 0.085s | 0.046s | 0.131s |
| `surrogate_pairs_full.bak` | 0.048s | 0.036s | 0.084s |
| `tabletype_cci_large_full.bak` | 0.072s | 0.049s | 0.121s |
| `tabletypecoverage_diff.bak` | 0.095s | 0.062s | 0.157s |
| `tabletypecoverage_full.bak` | 0.184s | 0.1s | 0.284s |
| `temporal_hidden_full.bak` | 0.047s | 0.035s | 0.082s |
| `torn_page_full.bak` | 0.043s | 0.034s | 0.077s |
| `typecoverage_full.bak` | 0.117s | 0.061s | 0.178s |
| `typed_xml_full.bak` | 0.047s | 0.03s | 0.077s |
| `unicode_codepage_coverage.bak` | 0.069s | 0.049s | 0.118s |
| `utf8_collation_full.bak` | 0.041s | 0.03s | 0.071s |
| `xml_index_full.bak` | 0.052s | 0.033s | 0.085s |
| `xmlcoverage_full.bak` | 0.045s | 0.035s | 0.08s |
| `xmlheap_full.bak` | 0.108s | 0.047s | 0.155s |
...
_Generated 2026-07-13 · 131 fixtures · 131 pass · 0 xfail · 0 fail_
